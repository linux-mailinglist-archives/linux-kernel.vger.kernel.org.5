Return-Path: <linux-kernel+bounces-97870-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A0B548770ED
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Mar 2024 13:01:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 117C9B21153
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Mar 2024 12:01:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 85B6638FA1;
	Sat,  9 Mar 2024 12:00:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="d/+myp+4"
Received: from mail-wr1-f46.google.com (mail-wr1-f46.google.com [209.85.221.46])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D9551381CC
	for <linux-kernel@vger.kernel.org>; Sat,  9 Mar 2024 12:00:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709985654; cv=none; b=K0MASwYggsMvORCezFDr9Bt3lJwPf9twEUpW+qHnq7ksHqcIVNvARKY0Y89MRi/NC7bBdZ4rvTfA5bJtAW6hIbEYw4iVWrvAEVOI3gMQ2KRBEog9uWXsKaQJ1iP7cO4huxN0cXiit4AbUSjL7IcN7fD3Mil8D5IW2ntZT760T6k=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=d/+myp+4; arc=none smtp.client-ip=209.85.221.46
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-wr1-f46.google.com with SMTP id ffacd0b85a97d-33e796cc90dso932435f8f.1
        for <linux-kernel@vger.kernel.org>; Sat, 09 Mar 2024 04:00:52 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8HgyH56g3O3xcj6rBdnw/1tHjvEVGODzmMGuWLLQYrQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWTcWJ/co2KG+AYrcD9UWN9zzpcTZgT5bsMcJZbtodCo/iReJXxRguu9TERjmBofsz+5kUjTPEcB5Vyg9l6M8UIbsJg1nC1EXZI/TY9
X-Gm-Message-State: AOJu0Ywn8VftCoDPOasncR0Eemi63QoIqAxxJPzvrvMSuqIzDLhl6o6I
	sVqNdt/CgoyreQHfI3k/jJgboif3vockfdMm0vhvOUHzjO5BE8uM2A9TJ8TflEs=

Return-Path: <linux-kernel+bounces-167270-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C31F8BA6BF
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 07:53:18 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2B69E281DC4
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 05:53:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 782FA139CE5;
	Fri,  3 May 2024 05:53:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b="dWZDnIKd";
	dkim=pass (1024-bit key) header.d=mediateko365.onmicrosoft.com header.i=@mediateko365.onmicrosoft.com header.b="RgAWSt+8"
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5A2CF139589
	for <linux-kernel@vger.kernel.org>; Fri,  3 May 2024 05:53:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=210.61.82.184
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714715591; cv=fail; b=uVwMpH+/FZcbkIFJKCpiWVNdj2M5b0uzs7wsLR+tsNnRtMnvKAoap4X4GE71uuUDnSwevYdCnqlPhY5dTdkC2S1V7ylDfg798DGKUEdilKmxpHr0+ls11mzxC3pIjwfkpSc46YeZ4CgkpQ83IWjHO5K/t5kjGSQt7nhKJnhWxV8=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714715591; c=relaxed/simple;
	bh=o7j/p6r/qTaAOXNwmIJBeCC6/8BlOGBMouBK4dxZic8=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=KdK0mAYPPrHLwihG2htmFBCWgHHBljhpHweEJvm9+ZF7cuWPBAXgH5L1OFBv5oPZNGeQrivpxuEEN7vr8BEBfGs8KSMYHYJC3JxmOZE21W4n+B2f/gmVGYytiAyHZzmtCarIVUCn8h6cabLa2TG8oVB1Dhzbcf6I7m7GakyeNMA=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com; spf=pass smtp.mailfrom=mediatek.com; dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b=dWZDnIKd; dkim=pass (1024-bit key) header.d=mediateko365.onmicrosoft.com header.i=@mediateko365.onmicrosoft.com header.b=RgAWSt+8; arc=fail smtp.client-ip=210.61.82.184
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mediatek.com
X-UUID: 66b0e5e8091111ef8065b7b53f7091ad-20240503
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
	h=MIME-Version:Content-Transfer-Encoding:Content-ID:Content-Type:In-Reply-To:References:Message-ID:Date:Subject:CC:To:From; bh=o7j/p6r/qTaAOXNwmIJBeCC6/8BlOGBMouBK4dxZic8=;
	b=dWZDnIKdao0PBkAqlVNMR+d2DZ69RvD1LZZk6ENLLKmtQzP4WwLB4j7OoD8hrzmiGjWyLjUvlfAs77PMlukwXVwptzJs2BJ2D5cXuzwnRIs7yYOmWwhpVz2LX+zMP7lc7hd7Wq/Dd5QzErj0kqZt7iXlsJuuik2ldniTeXbD+bU=;
X-CID-CACHE: Type:Local,Time:202405031329+08,HitQuantity:1
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.38,REQID:16318fe7-2f38-4272-9760-743750f90951,IP:0,U
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 03 May 2024 05:52:57.1939
 (UTC)
...
X-TM-SNTS-SMTP:
	0FEB5B98F18F183639D773FC6EF7CAF8331F06947C51B92F68371ADA5E6BA75C2000:8

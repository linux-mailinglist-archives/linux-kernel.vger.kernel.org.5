Return-Path: <linux-kernel+bounces-51417-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6813C848AFD
	for <lists+linux-kernel@lfdr.de>; Sun,  4 Feb 2024 05:23:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E513628740E
	for <lists+linux-kernel@lfdr.de>; Sun,  4 Feb 2024 04:23:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2927F79D2;
	Sun,  4 Feb 2024 04:22:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="BirDRneg"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 32FFF6FBD
	for <linux-kernel@vger.kernel.org>; Sun,  4 Feb 2024 04:22:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707020573; cv=none; b=e2WGtPp61APQujXIn/kcbhjmeina6C/ZOSMTZQxmIWG49oOVfJ69++7n4a8F1d0WgRV92wz6B1G8mFuIAgzpTlYH7iY8WrAxZKvk8+erVAsvJ2eee4lVD3Kb25ju7QmFlyeo6/yXw0a3fUwV3Ym2SSBIzzEA3WVvFo5DsuSMOcQ=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=BirDRneg; arc=none smtp.client-ip=170.10.129.124
...
Received: from mail-pf1-f198.google.com (mail-pf1-f198.google.com
 ...
 us-mta-65-DLpBWhItMkS3bQegMqOoLQ-1; Sat, 03 Feb 2024 23:22:48 -0500
X-MC-Unique: DLpBWhItMkS3bQegMqOoLQ-1
Received: by mail-pf1-f198.google.com with SMTP id d2e1a72fcca58-6e03d38022dso30739b3a.1
        for <linux-kernel@vger.kernel.org>; Sat, 03 Feb 2024 20:22:47 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=PyNa0NcWlAeyikPHcWl9Ahg0XOk5KDcxMhCNpLB7tmE=;
        b=
X-Forwarded-Encrypted: i=0; AJvYcCXhFQdHaBThOnvfoxGT562eHdJzCOKJrMvjn3+Sx/S8KNxDJMRh3wXa1wORvyO2+81PveTmYX4bZrauxjSnYFVDzV4X1VyFYIc+0Ift
X-Gm-Message-State: AOJu0YwMpuRuu7RjiVXubbR91cCk9beconm1JYiQhWkYFDl2gECOFEJ1
	j246BLH5sr81w3NHDr3aEoq9mhjbRFmPAKdZw0LuDB2XRrGdu4e1V8Iyl7jFl9s/4SgLNVvSo8+
	utTILDrozWU9ndPjVtDVTzS8YP1ZeMq806dxwGJP4TJIZUZBwdlQofpOEbV6pDg==
X-Received: by 2002:a05:6a00:1d0a:b0:6e0:289e:e182 with SMTP id a10-20020a056a001d0a00b006e0289ee182mr3350618pfx.0.1707020567009;

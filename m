Return-Path: <linux-kernel+bounces-54190-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 8725784AC17
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 03:15:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 07B821F24701
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 02:15:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE46857312;
	Tue,  6 Feb 2024 02:15:09 +0000 (UTC)
Received: from szxga01-in.huawei.com (szxga01-in.huawei.com [45.249.212.187])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EE1C657300;
	Tue,  6 Feb 2024 02:15:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.187
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707185709; cv=none; b=vAn28OtLvqsWM2G7VoUF3mRvw8eOpuduPTI3tQwQLaGcVUzrpXkKxgPWKMKkU7iMk0fNCQp7ZdioIWVr60P0t9iRlkWF8LClG3tvefUtQh22rgB57SEiVPEJnkdPWzDZ/ja2VNPXhYZIQBpZ5Y5bXhzcVxpo8nRyPtW3ML/+Nus=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707185709; c=relaxed/simple;
	bh=xnUfh5tNvpXi9BR+N3yxZpocjCbyoo7Gh9VK7eqqUzI=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=DvUVHCRMytV41oi7y/MLUOiyIyKzXMPKynCSqrRS2VZ7rzcnKFtWRyxVXQfEAQw8t9QAlkqZbPYOtqD3dGWvwu2VmkH8R2v5K5kS/j7dYbKzQEoDbg1/4+Rh+3q6n5a6tiGWSbEeYQ9gbV4016ZAylpxtg3mdJiX/oIsIscuZmw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.187
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.88.105])
	by szxga01-in.huawei.com (SkyGuard) with ESMTP id 4TTRcF2BnCzvVMv;
	Tue,  6 Feb 2024 10:13:17 +0800 (CST)
Received: from kwepemd100002.china.huawei.com (unknown [7.221.188.184])
	by mail.maildlp.com (Postfix) with ESMTPS id 291901400DA;
	Tue,  6 Feb 2024 10:15:03 +0800 (CST)
Received: from M910t.huawei.com (10.110.54.157) by
 kwepemd100002.china.huawei.com (7.221.188.184) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.2.1258.28; Tue, 6 Feb 2024 10:15:01 +0800
...
Subject: [PATCH v6 1/5] perf: build: introduce the libcapstone
Date: Tue, 6 Feb 2024 10:14:34 +0800
Message-ID: <20240206021438.768731-2-changbin.du@huawei.com>

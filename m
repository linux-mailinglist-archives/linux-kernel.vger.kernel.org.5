Return-Path: <linux-kernel+bounces-149996-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 333578A98E5
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Apr 2024 13:46:30 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 570E21C2253E
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Apr 2024 11:46:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B527D15E80E;
	Thu, 18 Apr 2024 11:46:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="snTaMkS4"
Received: from mail-lj1-f179.google.com (mail-lj1-f179.google.com [209.85.208.179])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 536DE15E7F1
	for <linux-kernel@vger.kernel.org>; Thu, 18 Apr 2024 11:46:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.179
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713440786; cv=none; b=KhL6HKcGUwRm1vS3leTzKUKaKsXo0HVFy5nnSqg4mMSzXZ05Om0pS8/qOQI3EO/kERYudnv8sEWZElyikW0uUEE/OYtRvVOQYWYgcw5PrtY0lGfXc5Ge+yA+DrTY/UGcTlLvloaaLzfwNncdGOt6Ox+j6O5wP/A29wG7TVS6Q8A=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713440786; c=relaxed/simple;
	bh=iBG0vX9yUUnSc7xJLa95UFSBEe7L8q4kvAMhXz/Ogj8=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=Y4cttziJWupjijeI/2AJILSNz/brkBX5OB++9t4BUJxaXbQJV0tb2pTLaQOn94j6Tq31HbNEPuvdqvK7ouUMs5RCi3Xq6Y6xZIhS/tnp2cq/WFGExhs6ed7tbiMLkVObxueCyTqbccjGMM+3FL8wbrKbknnZe1DaJ0AIpX7EQNc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=snTaMkS4; arc=none smtp.client-ip=209.85.208.179
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-lj1-f179.google.com with SMTP id 38308e7fff4ca-2d895e2c6efso9824711fa.0
        for <linux-kernel@vger.kernel.org>; Thu, 18 Apr 2024 04:46:22 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=kdwIu52RYxxnxQn1jup15BiJTAHdx+Mu7Xc73+wxa64=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXs2qzhoJqQJfruOojYEAEsA5VhmklK/20a+XIW9xdALnUwE9PFwN84PTmCPOlP1+L/QQ+qnoEDCqAJ+5BXygVhFtzlu7AALAlDuLOM
X-Gm-Message-State: AOJu0YwnwNr+sxmFdxye7yp9V8JdCFvZaALUdaINoO471iHmyBWBIJss
	PA07mpLIGIgVGbCdq4ppzgYSbZREjVkniCG88JBFjZyI0xBOH1Qq5N12w9MDuXo=

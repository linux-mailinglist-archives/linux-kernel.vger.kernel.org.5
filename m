Return-Path: <linux-kernel+bounces-136691-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 228AB89D727
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 12:41:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A134D1F23CFB
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 10:41:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1BC9781725;
	Tue,  9 Apr 2024 10:40:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=wolfvision.net header.i=@wolfvision.net header.b="CiR/MquU"
Received: from EUR04-HE1-obe.outbound.protection.outlook.com (mail-he1eur04on2124.outbound.protection.outlook.com [40.107.7.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3881655E55
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 10:40:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.7.124
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712659256; cv=fail; b=D3e38yFGq6ba5xDnWp8jWsUehTHtVc09HL6fiPxfpveQvLhTWT5qKY3qL/kpavEjFWhpiJ6OXlsAna0/kMq4ioZUrFfJ8rmTlLO1HO3chDtCTfuBi3RPitdvP4BODf4Ndn1+HxmX+dughMwsbo/VRvlBAxs5Feuyvr1trOmyny0=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712659256; c=relaxed/simple;
	bh=89NU/HOUVxRsB9hO7/oyFknA7930S9CGc8u97ipy/Bw=;
	h=From:Subject:Date:Message-Id:Content-Type:To:Cc:MIME-Version; b=ooTK3aSCpSg2DzeO1d1A+Po1KPDQDLFfAB0I+S4URQpz+zQy4p4s0yIuJvWV5zzYEMg3V33kOMsiwQF6CL6HJh6hdKdfdoAmT+ma39uaU7xdy3pteywlQK5frPSKolKZ0Lwny/NP1zw99BV/l+NimNmpq4RWQnPJ8T97YyT/IVQ=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=wolfvision.net; spf=pass smtp.mailfrom=wolfvision.net; dkim=pass (1024-bit key) header.d=wolfvision.net header.i=@wolfvision.net header.b=CiR/MquU; arc=fail smtp.client-ip=40.107.7.124
...
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:VI1PR08MB4544.eurprd08.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(366007)(52116005)(376005)(1800799015)(7416005)(38350700005);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?SzBEaGN1Rk9hUDRJNU1lZjF5NWlydUswRnZaaTlwQTh1R3dYTDNYRnlSTXN5?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Apr 2024 10:40:51.1076
 (UTC)

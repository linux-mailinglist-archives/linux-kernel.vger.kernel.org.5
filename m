Return-Path: <linux-kernel+bounces-166705-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 207FF8B9E61
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 18:20:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4D24B1C20EF5
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 16:20:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 95A7715E1FB;
	Thu,  2 May 2024 16:19:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="B1t8xayq"
Received: from mail-qk1-f171.google.com (mail-qk1-f171.google.com [209.85.222.171])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2229B15B12F
	for <linux-kernel@vger.kernel.org>; Thu,  2 May 2024 16:19:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.222.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714666789; cv=none; b=Xrq8rdfqpXSav7mMkahCO3O7OQWlu25L+6j/mE9cEYLr/Fuf4XO1EcE0zytMIBAPJZT6Xx1WIFaauCZRTBcdQq+2rahnM7Z+zwdI7g3EAmi2ZEj7wCgfRDSk+vcnAVK2l4enG9XX6j9UsfntDfGbxUYp4wj2dk3xzV7hnjPnKHw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714666789; c=relaxed/simple;
	bh=2ueN3KFc29WxSp2ztT8YmX62QGZxZl1t8uvTlKhjL08=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=WZ+6EburXXqlmJjyYq3qf9i32KAXKYE3sTeX+qdV0A/bXS68YqON+0aIHAhV8wRsx2RfxgNrpe9A+XcBP1kfZuTyqr74ohD8nPqm4JC+fLxoxpZ0xxt0CRoj9kPP72FMBcD6TX1am5FaA1/A7tNwjR9674GhR+saEUY2fVxkOVQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com; spf=fail smtp.mailfrom=broadcom.com; dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b=B1t8xayq; arc=none smtp.client-ip=209.85.222.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-qk1-f171.google.com with SMTP id af79cd13be357-78edc3e80e6so627770385a.2
        for <linux-kernel@vger.kernel.org>; Thu, 02 May 2024 09:19:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1714666787; x=1715271587; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=SIkBwmRr5uCHFheBYDLWZUaqLePveaDBbMzLq5q2DsM=;
        b=B1t8xayqVTjH4cEfQ/pIaexM0/qpF8qHPBYUlG9eJzuAYbNX3m22OuNuoZ6zGk7grh
         7FRJ9Y6dNnc7fm9JYINHwcqRnC6qZVTRzKs9+CIVafzA136AE3LV6jdLMvbrHz7sYiIR
         7dmeEju3qLtnFfZ6T10qMRUkRn/RbPOmiWLZc=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=SIkBwmRr5uCHFheBYDLWZUaqLePveaDBbMzLq5q2DsM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVNkVMtF/yYRFDSTZJ2/tW/4aQ3n0Lh7ALkVPxuawQ8WsSUVoDcS0VG+ygouCUGb1T7yLnPaxzH160C01fiCRklCM6960bDKmL/wCS0
X-Gm-Message-State: AOJu0Yz7PXGPqEEAUyIJQmiIdJ+IvSjwqtLqOB3jHWPilBCVO+iXzuXg
	p2DvVPAgEto7MQ7uatAekWCj8Nn4osBh45gmUyHWMg80BGlPA6k5q7ogwFQJoQ==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000c3c22d06177af8df"

--000000000000c3c22d06177af8df

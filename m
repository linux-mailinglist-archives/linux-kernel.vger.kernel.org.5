Return-Path: <linux-kernel+bounces-93705-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DD30873395
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 11:07:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 91BFC1C2407E
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 10:07:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B44DA5F566;
	Wed,  6 Mar 2024 10:07:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="WchucNV2"
Received: from NAM11-DM6-obe.outbound.protection.outlook.com (mail-dm6nam11on2046.outbound.protection.outlook.com [40.107.223.46])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A17E15EE6D
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 10:07:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.223.46
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709719632; cv=fail; b=uMVTSFEf33A+WEbBNSiEesuFgYOVZ30+UJiU9Ka9mTYLDlgTCMnLC661DoQfRWCWcnT+Z5F+Z3wwHLRJBwP3IL37EFywNAjOMn7dIaA/cjK64HopkeByg0WXc82Pq7441Zdax9pcFGgiv62+LxqmGk99WZS1oE8Pj3BQmiu6WyY=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709719632; c=relaxed/simple;
	bh=6gyIPewOzAVyOz8arEwFRkIspJbM3uiEPj2NxfkimiQ=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=bWF874k5bXIZ3RzcgiG3GyBEatEbJ9Ybu+6Dtr6m/hcLqxZ4GSvvHQ/tCFd2G8ZXNK6MOGhm6DaaPeytw4+5OpgFvk5/AOw6IJCNsmybcKyqZJC4eUGFFctEBvCv36Gauevsq5abpQIPHUc9WJ73jOTmbU8efB7MFXcRob59IAE=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=WchucNV2; arc=fail smtp.client-ip=40.107.223.46
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?aE10SCtsVktDUk9iZ04yVjg1WFNDSkFNNVhIYnJqVEViWmdlSUVYbnVtZEJM?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Mar 2024 10:07:07.7007
 (UTC)

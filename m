Return-Path: <linux-kernel+bounces-104445-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 15E6387CDFE
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Mar 2024 14:18:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3934C1C20CEB
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Mar 2024 13:18:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE6C02E653;
	Fri, 15 Mar 2024 13:18:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="iL4VYFvk"
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (mail-bn8nam12on2070.outbound.protection.outlook.com [40.107.237.70])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 485C42575B
	for <linux-kernel@vger.kernel.org>; Fri, 15 Mar 2024 13:18:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.237.70
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710508687; cv=fail; b=ZeXPUqZKepLiokYo13iX7jPEmPkG9e9+lPrjtHMqwXk7oHTcJW4llnUbnEb97xABuy2XjxhUcD3FLmA66tavh8u6VswKZ3IzaJvxm/HEykvz7p+I0ADFydnP5RYSVAZTflWa0gnalXpCyYBKehCRndM+N7DqxVDvn7oAG1e+B5A=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710508687; c=relaxed/simple;
	bh=Wy3SD3JHlF5ASr52XvC41qIdTVAwID4NeaonmgK0NN4=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=GQeLa9eqJNlJMEKaeu6+vtDu6EzWU3eOPQLV8xTiGTLl2+umYbjzcOYic2XFsIv7NfXL9gT2Qgvhskl5KZAXfHOBXCAefwzOg40H7iPN5CJBtU2uvsd2+2gU+2ek8m/CDsi3Mt2g0jIQkRQvmPnCdWEVA1cwK8HtRlA9tj5DwgY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=iL4VYFvk; arc=fail smtp.client-ip=40.107.237.70
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?RzVlRmN6MG9idlBLNFkwa2tzbFNWTU43OFpNQld5ZnFkVDE3VnFtaHJISmVy?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 15 Mar 2024 13:18:02.4100
 (UTC)

Return-Path: <linux-kernel+bounces-60734-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 89E07850913
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 13:32:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 890BCB23CFC
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 12:32:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 34B5F5D469;
	Sun, 11 Feb 2024 12:30:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="FKNY0s/U"
Received: from mail-lf1-f51.google.com (mail-lf1-f51.google.com [209.85.167.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B58EE5A7A4
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 12:30:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707654624; cv=none; b=RvkylQKT/x0FmFZ4bmk2+zmmKAU5FXIWuu0NDXu4/sMYDvyacRKOR0Wo4x7dB5iE5vSxyXTDt68pRWfrwKHpREZtjUYrOglDuc5id1lISBujiy+7gtR8A2M/PTVptXI1pKr56bcuW+oqey15HX08K4G3cpMgO0IOdCONAIDXusA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707654624; c=relaxed/simple;
	bh=Dhs2mryK6cjxcDEq3cmas8fOBOA4lHx6v+C0m71m3Ps=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=UalPVJxCbbbsMhgayNxp3k4COE085MvH6pQWHs1l9PNn5GlYYDmfWZAFil4UQvbzHPDg7r270LFiymdTV0E63rV55rFETxV05kgqHYrm3yaOfBTMtm8BdTsx8uqX4xip0aTjb66J+wfDg0EiyviTVI2rGRuN4how4NkamsPvBpo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=FKNY0s/U; arc=none smtp.client-ip=209.85.167.51
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-lf1-f51.google.com with SMTP id 2adb3069b0e04-511531f03f6so2739901e87.0
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=x+5/xFpwJe8P4woTgG6Er9CpKudFsvlzPLgw6cSgIo8=;
        b=
X-Gm-Message-State: AOJu0YxjnIC4BJT+urO+nPK9igme5ykPVuwX7asbmuGOWapSD47xhv+Z
	oyN2VMvYvDk0Jez7iC2+I4kA18q00C4jZbMVDoqtlG4c/yWk3Bcrn9hxy5mSuoVFvbAdykNg1eI
	I
X-Google-Smtp-Source: AGHT+IFAlb1zA2JYRljzw3SLRwNfz6oqa2FIKICtM0/0ocKslhIJXNPqF2Ox39wDvgbdLh1QyvNF7A==
X-Received: by 2002:a05:6512:21c7:b0:511:8cb2:2f80 with SMTP id d7-20020a05651221c700b005118cb22f80mr496508lft.43.1707654612802;
        Sun, 11 Feb 2024 04:30:12 -0800 (PST)
...
Subject: [PATCH v3 03/35] include: reduce header dependencies by using "*_types.h"
Date: Sun, 11 Feb 2024 13:29:28 +0100
Message-Id: <20240211123000.3359365-4-max.kellermann@ionos.com>

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3F9FA77CB8D
	for <lists+linux-kernel@lfdr.de>; Tue, 15 Aug 2023 13:17:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236679AbjHOLRF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 15 Aug 2023 07:17:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41556 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236678AbjHOLQZ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 15 Aug 2023 07:16:25 -0400
Received: from szxga03-in.huawei.com (szxga03-in.huawei.com [45.249.212.189])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 48ADA107
        for <linux-kernel@vger.kernel.org>; Tue, 15 Aug 2023 04:16:23 -0700 (PDT)
Received: from canpemm500009.china.huawei.com (unknown [172.30.72.54])
        by szxga03-in.huawei.com (SkyGuard) with ESMTP id 4RQ7tC5j7tzFqdm;
        Tue, 15 Aug 2023 19:13:23 +0800 (CST)
Received: from [10.67.102.169] (10.67.102.169) by
 canpemm500009.china.huawei.com (7.192.105.203) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.31; Tue, 15 Aug 2023 19:16:17 +0800
CC:     <yangyicong@hisilicon.com>, <rostedt@goodmis.org>,
        ...
        <dietmar.eggemann@arm.com>, <yu.c.chen@intel.com>,
        <tim.c.chen@linux.intel.com>, <gautham.shenoy@amd.com>,
        <mgorman@suse.de>, <vschneid@redhat.com>,
        <linux-kernel@vger.kernel.org>,
        <linux-arm-kernel@lists.infradead.org>, <mingo@redhat.com>
Subject: Re: [PATCH v9 0/2] sched/fair: Scan cluster before scanning LLC in
 wake-up path
To:     <peterz@infradead.org>
References: <20230719092838.2302-1-yangyicong@huawei.com>
From:   Yicong Yang <yangyicong@huawei.com>
Message-ID: <f8ab9995-72a3-4367-68bf-a74423167daf@huawei.com>
Date:   Tue, 15 Aug 2023 19:16:17 +0800

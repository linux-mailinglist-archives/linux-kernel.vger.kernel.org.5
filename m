...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 66384794561
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Sep 2023 23:48:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244870AbjIFVsh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Sep 2023 17:48:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35084 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244848AbjIFVsf (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Sep 2023 17:48:35 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A7FA019B3
        for <linux-kernel@vger.kernel.org>; Wed,  6 Sep 2023 14:47:54 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        b=TXD19EKfdpPPErGvNYwRBO5Y3GIGnvfjXMg0LPm6ldEKWPTN7z4ncohG1A1Zwi8o9fzMx+
        Pc0BAD33qUcu0A2sTG9xiIltIIVc8vKS2c2FMTjiqebMyWUGiYVW0wsfWzZL49U76+kCPw
        DEUnbyKEixXdgkIiIOjQ+G1sDgz7JIQ=
Received: from mail-lf1-f69.google.com (mail-lf1-f69.google.com
 [209.85.167.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-644-4KYXSOTJMBGNkfw_IbP_Xw-1; Wed, 06 Sep 2023 17:47:52 -0400
X-MC-Unique: 4KYXSOTJMBGNkfw_IbP_Xw-1
Received: by mail-lf1-f69.google.com with SMTP id 2adb3069b0e04-500c67585acso214446e87.2
        for <linux-kernel@vger.kernel.org>; Wed, 06 Sep 2023 14:47:52 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=NVruo8+WaL18PY/f/PQckwTskKI4OUDG24U8LY+9fDU=;
        b=
X-Gm-Message-State: AOJu0YxCV6nQAO/XZ904NgTlT1WIaFwN+nuse3ZCB2zUyT1/b48xCotu
        +F4rR7GmYJmxZOQ5a9LOdr4GhZWZI68Xb6A9kl3BF6zs+X+tH8cdEu9e3dvjpWrjJkwsGf9MTwQ
        vGTVPFk+9yGFunQlTQQu2K89V
X-Received: by 2002:ac2:4c13:0:b0:4f8:e4e9:499e with SMTP id t19-20020ac24c13000000b004f8e4e9499emr2967976lfq.12.1694036870755;
...
X-Received: by 2002:ac2:4c13:0:b0:4f8:e4e9:499e with SMTP id t19-20020ac24c13000000b004f8e4e9499emr2967973lfq.12.1694036870396;
        Wed, 06 Sep 2023 14:47:50 -0700 (PDT)
Received: from cassiopeiae.. ([2a02:810d:4b3f:de9c:642:1aff:fe31:a19f])
        by smtp.gmail.com with ESMTPSA id o21-20020a1709062e9500b009a13fdc139fsm9547503eji.183.2023.09.06.14.47.49
...
Subject: [PATCH drm-misc-next v2 6/7] drm/gpuvm: generalize dma_resv/extobj handling and GEM validation

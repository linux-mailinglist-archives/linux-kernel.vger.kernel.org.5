...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3D03C783482
	for <lists+linux-kernel@lfdr.de>; Mon, 21 Aug 2023 23:05:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231574AbjHUVAv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 21 Aug 2023 17:00:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44998 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229542AbjHUVAu (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 21 Aug 2023 17:00:50 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 68DB2CE
        for <linux-kernel@vger.kernel.org>; Mon, 21 Aug 2023 14:00:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1692651648; x=1724187648;
  h=message-id:date:subject:to:cc:references:from:
   in-reply-to:content-transfer-encoding:mime-version;
  bh=OSyTeOS3ez8DIVkawUU7fua+Y/UHF8ZaZjWMyHVegTM=;
  b=MJ8JU2xiOQAF77Vcom0dq3KXhBr5gczqnPy0wSd3Bm/Wi5KFH7/UiJQs
   vKSA3eRlu5F6jxUWuecDz7xZ9nJuS8q7WamOgyCEIxgITBXCpkgJWCLvJ
   SzXLPbikMgWy1EH5gpGoW1cNVRXmXFKpG72+xXgELBJrZ7on+GBPVs0PS
   EOAKTSkivUHXsFAHgWHSXH08caVby+b+5b8NuoXsQ4kWlK/93FjIpUD4D
   1FG46rYI1e/KD3NTWZVywk7pW1BovUbQ7MhunI2MT0xm+3iaHXHY9HHJR
   LJzPXyYcypRVyDI8bSH66QyDbat57ws0kyWa/NUZKp1NtGFdbv2XetoKq
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10809"; a="353273847"
X-IronPort-AV: E=Sophos;i="6.01,191,1684825200"; 
   d="scan'208";a="353273847"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Aug 2023 14:00:48 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.01,202,1684825200"; 
   d="scan'208";a="879662978"
...
To:     Jani Nikula <jani.nikula@linux.intel.com>,
        ...
        <daniel@ffwll.ch>, <John.C.Harrison@Intel.com>,
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH7PR11MB7605.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(396003)(376002)(136003)(346002)(39860400002)(366004)(186009)(1800799009)(451199024)(66476007)(66556008)(316002)(66946007)(6512007)(82960400001)(110136005)(8676002)(8936002)(2616005)(4326008)(36756003)(41300700001)(921005)(478600001)(6666004)(38100700002)(53546011)(6506007)(6486002)(83380400001)(2906002)(7416002)(86362001)(31686004)(31696002)(5660300002)(26005)(45980500001)(43740500002);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 21 Aug 2023 21:00:44.3947
 (UTC)

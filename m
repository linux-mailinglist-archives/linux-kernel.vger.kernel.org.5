Return-Path: <linux-kernel+bounces-60735-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D17D850910
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 13:32:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E7D46281DD6
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 12:32:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE6C35C917;
	Sun, 11 Feb 2024 12:30:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="EksCxhPC"
Received: from mail-ed1-f49.google.com (mail-ed1-f49.google.com [209.85.208.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5B2175B200
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 12:30:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707654627; cv=none; b=hSq7bmSLUNvBpq7hWyu7YCAFO7ww6iSlo34f7hABko61C8dSq32ZFAozd071Q8VkXsCU3GA1TsWXabALDXEfwho/gv2/7PsKBxJ9bMsyId4xF6s6XANMm+BamPfN9oDTO/gv2siyBeugW/BrJK638xYVE+oW2EvuPq6U1ggfs8Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707654627; c=relaxed/simple;
	bh=EINUZJwko3Gf0QbcPfi08L73aK5jL2hMEANq2ElpqNc=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=Ww7qc4QtiefQyYLNnWgpmNGhPV1cEHM2iZ61f5qRLRxWasis0nNg/jbFim5SAQQZB2WvKyH2HyAjmjKoxchGxiSciVlYkrbEv9RYrFZTjDzCgFKZAziJFXr8DFTtYaRvQBgxtB1BI4zhvQdF5h6ylrQeeI160MYP25U2G4sKKS4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=EksCxhPC; arc=none smtp.client-ip=209.85.208.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ed1-f49.google.com with SMTP id 4fb4d7f45d1cf-55fe4534e9bso3019346a12.0
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 04:30:20 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707654618; x=1708259418; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ejWZEi7TYL5VXPc1nXDBB2l6mB09poQCjbbGA7dNR0M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707654618; x=1708259418;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=ejWZEi7TYL5VXPc1nXDBB2l6mB09poQCjbbGA7dNR0M=;
        b=
X-Gm-Message-State: AOJu0Yw4axU9QS1WDE/5uxa+5T7t7ABz32qrRVTVrJJwkbTjU4rmwSGD
	xEntBikR4RzcosVtWTI8Z6i52zOIaoni0mtg58RGDlIpcetzcx8djqoJFkUAf8hICee/LAbA1XW
	a
X-Google-Smtp-Source: AGHT+IFRc63EIsZP7ahnvOiiCsXuEgeA7bsTMe0SrwsrQNgbHI4it1XZG+o+tL7aM2TCkjXzHxo9tw==
X-Received: by 2002:a05:6402:1493:b0:561:2711:9585 with SMTP id e19-20020a056402149300b0056127119585mr2442607edv.32.1707654617465;
        Sun, 11 Feb 2024 04:30:17 -0800 (PST)
Received: from raven.intern.cm-ag (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id fj18-20020a0564022b9200b0056187ca4120sm1024611edb.10.2024.02.11.04.30.14
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 04:30:14 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v3 05/35] kref.h: move declarations to kref_types.h
Date: Sun, 11 Feb 2024 13:29:30 +0100
Message-Id: <20240211123000.3359365-6-max.kellermann@ionos.com>

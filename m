Return-Path: <linux-kernel+bounces-50909-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B4738480C4
	for <lists+linux-kernel@lfdr.de>; Sat,  3 Feb 2024 05:13:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B7F2028B68B
	for <lists+linux-kernel@lfdr.de>; Sat,  3 Feb 2024 04:13:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A9DBD18651;
	Sat,  3 Feb 2024 04:10:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="XuIR0pyV"
Received: from mail-ed1-f49.google.com (mail-ed1-f49.google.com [209.85.208.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5E611182C3
	for <linux-kernel@vger.kernel.org>; Sat,  3 Feb 2024 04:10:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706933435; cv=none; b=Fp0Ga0cFGs3Xx2GY1xaiBkOy3puy3OEgXVlAve9ZT12B8KSP7IKAc+VTraA03nWOgbbk0nMwsNQANLEoKzJzrBumMGRR4+o4Kz7WAQf4tdhP6XiVkvnyam5N0ISk3w6WDakE1AeUutqpIxzsvrd4Aufi23J1pBEIdHDWvZIjYxg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706933435; c=relaxed/simple;
	bh=cxD3dK0k1NAuLxkjKpABpgcHrf05A0JfRnaouKn9lNs=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=ZNKvkmpTJtuNXsik7t7NDyaegSzGEliXCd7TDqA3hHy+BQAqhq6aDPIz0mrn9kZ+46Pm2gZlLipsM2st7Su+PUJiBchbo04733ORW5iMR3Yk4PBdm5wu6nVNSeOOG49UfESspOeubGHoYKlENLoyrBts5c+OG9eyuGpZ6hDZEu8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=XuIR0pyV; arc=none smtp.client-ip=209.85.208.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-ed1-f49.google.com with SMTP id 4fb4d7f45d1cf-55f63fd3dd8so5028a12.0
        for <linux-kernel@vger.kernel.org>; Fri, 02 Feb 2024 20:10:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1706933430; x=1707538230; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=B/9sO6SCRuxqV7c1WhSb4QO0JpG+QqzVWdl11FiXxIo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=B/9sO6SCRuxqV7c1WhSb4QO0JpG+QqzVWdl11FiXxIo=;
        b=
X-Gm-Message-State: AOJu0Yx9YJVzBqVWxfHiRCopD7dxTwDysOJgWyGExBPeB/KvPdCsR+iW
	RG/S3nod2ZK46li9U5gCBBes8SY3KCuCbY4omU+TIzMEtB/XSz1rxYw85RAw5K5uNJSOHovKknh
	pLEaKBSQqQHhianvuj3D9Z5+p958wHdspL4CJ
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000cd8506061072684b"

--000000000000cd8506061072684b

Return-Path: <linux-kernel+bounces-153396-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C8A48ACD9D
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 15:00:05 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 99F891C20A20
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 13:00:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8F97014A4C4;
	Mon, 22 Apr 2024 12:59:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="VrG9amHW"
Received: from NAM11-DM6-obe.outbound.protection.outlook.com (mail-dm6nam11on2084.outbound.protection.outlook.com [40.107.223.84])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DFC0A746E
	for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 12:59:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.223.84
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713790798; cv=fail; b=O3sIzisWy333BXeMJ3nlSxKHKHtNwcHQhnNIovWz10lZ3DxzVCxtpepnRTunY2Y1bz8DqmUKIIeElT/8roAcrvyaz2UqgR7UL76YcU0WCRASYUACTLNaYKXQS7EB7ZB4YClIpvXlOuC0/CHDmM/nan2IKvJcyt/KiagFBh0CwXA=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713790798; c=relaxed/simple;
	bh=0uz/aVjv4L3tLeFCixbmrGIYXLOJ/x7Zb1zoooyIGuw=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=k2GTlTocLGUuCSm+KTKJnZ8llN+ukGq7nqmJUEJdxWctT1Bp2BGS1QjrLtVb3K7JI8sxdl/NULBn+56AG4PFLR1pI4kSDeiFB0RGntKNvgslb0IixOxbhRdW3j7TT3MZfkrZ/gCAPLal1dWr889D2mN/bLijSfLSPvtVRxuZLOY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=VrG9amHW; arc=fail smtp.client-ip=40.107.223.84
...
X-Microsoft-Antispam-Message-Info:
	=?utf-8?B?dTN3M1I2aG1qTkJETDJwMVFjN1hiUlNuTlRRcy96MWszQzBTcWRLVVVOZTlO?=
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?eWxVcmF3VnNZT2VBSVZORGV1QUhXSks5Um1xMFIxT29ib3N1L1RySStsUThF?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Apr 2024 12:59:54.4206
 (UTC)

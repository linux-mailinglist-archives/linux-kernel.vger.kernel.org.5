...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D1B6A77D8D4
	for <lists+linux-kernel@lfdr.de>; Wed, 16 Aug 2023 05:07:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241494AbjHPDHN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 15 Aug 2023 23:07:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56608 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241507AbjHPDGy (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 15 Aug 2023 23:06:54 -0400
Received: from mail.loongson.cn (mail.loongson.cn [114.242.206.163])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 4A9F42136;
        Tue, 15 Aug 2023 20:06:49 -0700 (PDT)
Received: from loongson.cn (unknown [112.20.109.245])
        by gateway (Coremail) with SMTP id _____8BxuOhEPdxkePwYAA--.15629S3;
        Wed, 16 Aug 2023 11:06:44 +0800 (CST)
Received: from [192.168.100.8] (unknown [112.20.109.245])
        by localhost.localdomain (Coremail) with SMTP id AQAAf8DxzM44PdxklqZbAA--.28643S3;
        Wed, 16 Aug 2023 11:06:34 +0800 (CST)
Message-ID: <24cf55ad-e40c-4d7c-9007-2906b26d74c2@loongson.cn>
Date:   Wed, 16 Aug 2023 11:06:32 +0800
MIME-Version: 1.0
...
X-CM-TRANSID: AQAAf8DxzM44PdxklqZbAA--.28643S3
X-CM-SenderInfo: pvl1t0pwhqwqxorr0wxvrqhubq/
X-Coremail-Antispam: 1Uk129KBj9fXoWkGrWfGw15uw1kXrW8JF43Arc_yoWkXFW8Wo
        WY9ryfCr18Xw15J3W7Jw4kJ3W5Ga1DWrnrAa45KrsxGFWjk3Z0yr1DXr15Ww45CrW5GF15
        J3WfJr1YyF1jqF13l-sFpf9Il3svdjkaLaAFLSUrUUUUrb8apTn2vfkv8UJUUUU8wcxFpf
...
>>> +       }
>>> +
>>> +在没有显式编译器屏障的情况下，两个���支只写不同的值才不会被提取公共子表达式，例如：
>>> +
>>> +       q = READ_ONCE(a);
>>> +       if (q) {
>>> +               WRITE_ONCE(b, 1);
...
>>> +
>>> + (*) 在循环内，强制编译器在每次通过��循环时读该循环条件中使用的变量。
>>> +
...
>>> +可能依赖于其目标系统的特定行为，以尽可能���量地实现同步。对于打算在多个架构和总线实现之间

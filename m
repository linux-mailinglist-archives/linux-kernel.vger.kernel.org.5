...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A09AD7F7D8D
	for <lists+linux-kernel@lfdr.de>; Fri, 24 Nov 2023 19:25:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345407AbjKXSZd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 24 Nov 2023 13:25:33 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56870 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230104AbjKXSZb (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 24 Nov 2023 13:25:31 -0500
Received: from mail-lj1-x22c.google.com (mail-lj1-x22c.google.com [IPv6:2a00:1450:4864:20::22c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 42ED31BC0
        for <linux-kernel@vger.kernel.org>; Fri, 24 Nov 2023 10:25:36 -0800 (PST)
Received: by mail-lj1-x22c.google.com with SMTP id 38308e7fff4ca-2c873cf9f74so28938261fa.0
        for <linux-kernel@vger.kernel.org>; Fri, 24 Nov 2023 10:25:36 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google; t=1700850334; x=1701455134; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=a5tyUkUoxbGaUidRH547AqcSjEXGKaEFazZSRMHkqTA=;
        b=h7+YEzg9PVswuz2DkEnriYFPEqiBrHdrKQu89r8xf/1WjSF8RAJkBUmgqoeTp6KXqe
         +X/HK6vquzpO0TBrQFZIWgn1VUN05H2oZNCgRcnrmnuXrdloqRy78Ibs1/VI06V2TF/s
         V7eeKiUw8B6XxmmdPPuwCumjlbmu7KsdvGTV0=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1700850334; x=1701455134;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=a5tyUkUoxbGaUidRH547AqcSjEXGKaEFazZSRMHkqTA=;
        b=
X-Gm-Message-State: AOJu0YyDi0l3cCv6jwcFkIrLwJcuLFvIq7hLpRDhP+L8QAfMlL2PD7Ns
        w1JpdocPjzGU2XP6234RjbttWJc94ru8cJSWO/phDg==
X-Google-Smtp-Source: AGHT+IGWUE9GAMrdA24FPcV1dX0uA/LtgBheeACxjcxkg/0EwR+U7SUONKCVVT7PShyfVTd8xXT3lw==
X-Received: by 2002:a2e:9c92:0:b0:2c0:21b6:e82e with SMTP id x18-20020a2e9c92000000b002c021b6e82emr3118967lji.4.1700850333977;
        Fri, 24 Nov 2023 10:25:33 -0800 (PST)
Received: from mail-ed1-f54.google.com (mail-ed1-f54.google.com. [209.85.208.54])
        by smtp.gmail.com with ESMTPSA id x22-20020a1709060a5600b009c3827134e5sm2342564ejf.117.2023.11.24.10.25.33
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 24 Nov 2023 10:25:33 -0800 (PST)
Received: by mail-ed1-f54.google.com with SMTP id 4fb4d7f45d1cf-54acdd65c88so1617352a12.2
        for <linux-kernel@vger.kernel.org>; Fri, 24 Nov 2023 10:25:33 -0800 (PST)

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7CE3D778446
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Aug 2023 01:46:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230175AbjHJXqb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 10 Aug 2023 19:46:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40384 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229629AbjHJXq3 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 10 Aug 2023 19:46:29 -0400
Received: from mail-lj1-x234.google.com (mail-lj1-x234.google.com [IPv6:2a00:1450:4864:20::234])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D1507273C
        for <linux-kernel@vger.kernel.org>; Thu, 10 Aug 2023 16:46:28 -0700 (PDT)
Received: by mail-lj1-x234.google.com with SMTP id 38308e7fff4ca-2b9a828c920so22309941fa.1
        for <linux-kernel@vger.kernel.org>; Thu, 10 Aug 2023 16:46:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20221208; t=1691711187; x=1692315987;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=99b76k6CbqTH31IxPeJKA2CgGmhxrmaFp9DL0ktag84=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1691711187; x=1692315987;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=99b76k6CbqTH31IxPeJKA2CgGmhxrmaFp9DL0ktag84=;
        b=
X-Gm-Message-State: AOJu0YyVYyx+aw4DXoFZqv+ZPbknSMtbMqe956djbROP7x/anHOGtmRO
        xf2zPv2xZDqOvNf5fuI3f6whVX+z/gBVzDFzW0fH7Q==
X-Google-Smtp-Source: AGHT+IH5RHc6E6gGJ5fTOVow2UXuKlTH5TSJinTQzKV/yi/t/o1D2iGvhxrP+vtIWp2/THtyZMwOjw/pgdmzUCKSCRc=
X-Received: by 2002:a2e:9214:0:b0:2b6:9ed5:bf15 with SMTP id
 k20-20020a2e9214000000b002b69ed5bf15mr338347ljg.23.1691711186833; Thu, 10 Aug
...
Date:   Thu, 10 Aug 2023 16:45:50 -0700
Message-ID: <CAJD7tka17GHTgu9JZNW8-CCsH2OR67oj31h53oa-oPTTVnkQQQ@mail.gmail.com>
...
>
> On Thu, Aug 10, 2023 at 5:31=E2=80=AFPM Yin, Fengwei <fengwei.yin@intel.c=
om> wrote:
> >
> >
> >

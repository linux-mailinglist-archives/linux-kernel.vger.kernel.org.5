Return-Path: <linux-kernel+bounces-123327-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E6F889069F
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 18:03:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B740DB26DFF
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 17:03:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E9D3B137926;
	Thu, 28 Mar 2024 17:00:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ZRH0iR5j"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 70F0453387
	for <linux-kernel@vger.kernel.org>; Thu, 28 Mar 2024 17:00:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711645217; cv=none; b=jkAML1+cvyUujspQBrQGcU8kXVyuOyGJOc/IIkoIffWfIlLMIujVNfEx1llesqOgAcqnXchMJu/abSmSr/w1vH+iRwkut0bzHPMJvMypx8XgWmwCA7nvpkSnIhRobevKUBOqgLNk3oQ/BAyOa8T0GJLE8LHlYqtTkWB/rVUpBzw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711645217; c=relaxed/simple;
	bh=Q4NYs8avKCbELFNJ69BnmvUy9TV7IxgEZ3hwwqqqCK4=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=r3dZwo4UNqCZObQnqUzqWA7YBjBP8Gm5gq5tCttkS9LT1dwVOWiQxIOx3ifGzF+3dA4VzHQs43a070PO7ftebgp7c6eH6bOubepV+OqSE4m9IUvWBmr5V13IfNcnzpMYJ7q6IHF3nDbFQJQhpiHJMIY09ppyO5ll2zzxHwIEMP0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ZRH0iR5j; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	C2VGA7lplT89fRioqbvCgu6FAphWMQ8SR6RYZieOCpFvsUmmBzaODZzfMVY0qRZJ4rkBBk
	fRGcTU/aMsb/sAg0Uz8dyld2JdcXDGc=

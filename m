Return-Path: <linux-kernel+bounces-94179-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B2A1873AF5
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 16:43:02 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 05130284B2D
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 15:43:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 20EC2135408;
	Wed,  6 Mar 2024 15:42:55 +0000 (UTC)
...
Received: from omta40.uswest2.a.cloudfilter.net (omta40.uswest2.a.cloudfilter.net [35.89.44.39])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E6E6C1353F4
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 15:42:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=35.89.44.39
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709739774; cv=none; b=gKGpeXIZtXIJ0pcO3QsLAXE6ko51VGZFgLiQRgM9EwXhXYdBHyJ+EN7ItIfJsI2Wdjnm4wU8UEbLfOh5aj2yFig0Y7y8tYc/0pGO+IoloPdw6wemTJ7a3BLpqfIw03YbzHNFo6Uj22zURRE0QL6wNCsaaON/Jq+rJW8zX6xOerY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709739774; c=relaxed/simple;
	bh=L6NtDTi6IxuJr2HEz9+NlQdI/czBfiDG2fLUsEkz3Ws=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=VhCBrQr6xW9dXMz2fes482byFT+yoO1QuWuCNlJImLI1JKTrBYTllB8FhGfiiA/nb8IUiY2OE8Iu0Q313vdW3n1J/7DnK/ptd/JXZXLL7wOSIR97JABflI/99tQ3gPs/BqiM2pzKowXuyZVjBhjCxFaob6Tj/S4iyrEQfqzPYOk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=embeddedor.com; spf=pass smtp.mailfrom=embeddedor.com; dkim=pass (2048-bit key) header.d=embeddedor.com header.i=@embeddedor.com header.b=po9PMpUb; arc=none smtp.client-ip=35.89.44.39
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=embeddedor.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=embeddedor.com
Received: from eig-obgw-5007a.ext.cloudfilter.net ([10.0.29.141])
	by cmsmtp with ESMTPS
	id hsGJrdNMMPM1hhtPwrQVlW; Wed, 06 Mar 2024 15:42:52 +0000
Received: from gator4166.hostgator.com ([108.167.133.22])
	by cmsmtp with ESMTPS
	id htPvrsQdWwM25htPwr7Vsj; Wed, 06 Mar 2024 15:42:52 +0000
X-Authority-Analysis: v=2.4 cv=ZP7Rm27b c=1 sm=1 tr=0 ts=65e88efc
...
X-Local-Domain: yes
X-CMAE-Envelope: MS4xfFtxVcf9kTbbstU7V2B4omcDsrF2sFJ2rMc9OC/8fMaFg4lQBrsVFsRDDngeu2hPfFNmagMajYrSA3f1MhQCBowG3a8+2TTTiWTVcpZ8UKXOqvYJTfBn
 zI9IDV0TEl3CU1arB2YfrlE5Dj0YZN2F0IdZNjZ9+H7EgKXeHYdLEid6rD6QQeLtlNWbIlqKblzhYTXUbFSOQSdV5RckOU8O/Z7gvvwFfVEX+DceGs3XYozQ

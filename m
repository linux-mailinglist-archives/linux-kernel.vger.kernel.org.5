Return-Path: <linux-kernel+bounces-168132-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 6127A8BB40E
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 21:32:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 15E6F287388
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 19:32:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 274DC158D6D;
	Fri,  3 May 2024 19:29:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="MRp8DMCK"
Received: from out-189.mta1.migadu.com (out-189.mta1.migadu.com [95.215.58.189])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EDA8B15990E
	for <linux-kernel@vger.kernel.org>; Fri,  3 May 2024 19:29:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.189
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714764594; cv=none; b=gVNu3jw5jpsk84LKNyyfkiI0v2hrbe/h+Id/WAHMgdIjD9KQjGD4byOIPMhLxMsN4wEJPRFpByjYKvGQD8QpJv37laJrsURHHErCqLgBmvxo+plCPvF1rF6S9i7qIsL7CrQFUbvDyUEhR8uAtQvOPuIJ8Tkw4rmYMLojuv9Vf4M=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714764594; c=relaxed/simple;
	bh=5jUECwUsGmXm+m9HgbZsWV7SBRR3GSxp/qk05ajULn0=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=EdWSuAATHHiELL/r5PSk7cZcZoSPZI0t4QHEHoRRb1sU+JeuvMma4tBxjpCPJsmEgJrmnMkt8djYFD2gv6bGuRbykCLPtTP8QXXiFqCZp1JB50ZAfyBSvpH2UmFxAAKC4te1sYLLkCx3f2Bee3i/jHjCAJENqjO5WL2O7d/aVjk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=MRp8DMCK; arc=none smtp.client-ip=95.215.58.189
...
Subject: [PATCH v5 10/10] drm: zynqmp_dp: Add debugfs interface for compliance testing

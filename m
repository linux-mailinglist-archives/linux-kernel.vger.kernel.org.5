Return-Path: <linux-kernel+bounces-97719-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id A46A8876E63
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Mar 2024 02:10:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id E5C4D1F21967
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Mar 2024 01:10:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3F49A134BC;
	Sat,  9 Mar 2024 01:09:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="c3vCCYZs"
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1C8B0C120
	for <linux-kernel@vger.kernel.org>; Sat,  9 Mar 2024 01:09:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709946581; cv=none; b=exZTqjTMOpkrZLA1jAQRGQoCPb0mQ89UOCsi0fHjFi+t6Ka6vl0aqktGTWsdbSYHIop6zthSgone569FR10onaXtaCLi1fUzd/K6PJlOee9hHnQ6U+CRBfGJ6Bu53AXcDxAH47hxo5xZz8NmWJ8geUTTMpH4I43svx3jeaF/ZVI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709946581; c=relaxed/simple;
	bh=BkxXb1PJT45SPB5f2ZRw63TbVdgcv8zNrWS8Wmbb0WA=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=S3p5x32KrksjyNg+/CNlT7rNMlIf+smhBnSuI/gumaYxZOn711b0dHfQWTtnmRNMdIzhufc483uzVRVzBquCEimqdwkFh/7gJa9RCokWcQP72Yn3tULVcSlKXyYBwTohIlVX8oFLc2/f+3fQD9nxsxkDhh4SxGEoOWZXOuwd5QU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--seanjc.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=c3vCCYZs; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--seanjc.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-5f38d676cecso45772297b3.0
        for <linux-kernel@vger.kernel.org>; Fri, 08 Mar 2024 17:09:38 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         ...
         :reply-to;
        bh=khI6vPx6zVNT1jQysQZ4ukuRubebUHrypQhqEYEiMM8=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWyi7v3SXy8JsANtcRzNqau1/Y8llhnIXIBn/UbSlk8Hcz+LG1u/m4NjtQVSipbFSY6sBBa85jcwiO7ha9oYsOxOD7B5qrjrk1VwKhN
X-Gm-Message-State: AOJu0YwsY0AjxQUl1HiNNHTRSIb8CfZAOnDOdGdp6o4JAMs6ZIy1QAg7
	SLALDArTaYAs/8qtyPOuaVPxjML06hjfxW88cB89TUDxy53voOv02KVkVr98YoDBahlrIX4OG/E
	ymA==

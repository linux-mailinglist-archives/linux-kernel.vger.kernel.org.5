Return-Path: <linux-kernel+bounces-74083-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8DF7985CFC2
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 06:36:42 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 41080282DCD
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 05:36:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AB81B39FC7;
	Wed, 21 Feb 2024 05:36:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b="F2MV1Klf"
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.154.123])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 681AB22F0C
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 05:36:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=68.232.154.123
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708493788; cv=none; b=VHYt+IlRlHolxrQYq+CkMmbaS7ips2kqHNkxfFxMgjev1oIuRgwCNdf5Qi4akHJ2t3dbyQ1FQfU38w5TJWiifRmJQoOcQvBRiBQqmF4sPtxsM2UBpMhuTJiGHFYxWsM5I6OTYWipQHRqL5p3312GJxlVVXOGsKR9TQzwAUoaF+4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708493788; c=relaxed/simple;
	bh=riyvpOm2+vGVi57KzBfvKkOI4spZgAGZS9l41e40hZI=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=t02ET183XDOsmB/7No7zSk1vIlPrHDB+HPSD9ILYKssQJHMchXTtfhswCMP6LXP8XGEVdLgaAmEnmCFiKYC/HVQnx8KMPNjT0MWRFofVgqevcW/f8zugLY1Or6b/tZxuRkhdBX3JcWNcXgUqa1QdpQZ4raXlyWvN8SfKhNgI2XM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=microchip.com; spf=pass smtp.mailfrom=microchip.com; dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b=F2MV1Klf; arc=none smtp.client-ip=68.232.154.123
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=F2MV1KlfwBBdnM8KQXsaCQ8VuAE9llQ/JV7w2R7zGcDrxEAQS6iBBg3X
   ...
   utXxPFt1PYLr0+8u3PNxTuOKpAhBvxBNwfdO22lER6vcLXEPng4lvEASg
   w==;

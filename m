...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 39DC57BC00F
	for <lists+linux-kernel@lfdr.de>; Fri,  6 Oct 2023 22:11:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233429AbjJFULF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 Oct 2023 16:11:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34416 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233410AbjJFULD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 Oct 2023 16:11:03 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3E70612A
        for <linux-kernel@vger.kernel.org>; Fri,  6 Oct 2023 13:10:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1696623034; x=1728159034;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=k/B6ba6+KS7otmaFOzpuH/jF1QS/AFG3jTa3Dh+IQxQ=;
  b=SSzJAiPhOogcqvnR0xiqeFod0R2AVvD1y/0O4MPhKsP5eVFs3KbmZ4m9
   ul4hD89keBcu6vB9zef+A2FEwyNZnCLrzE9DBCJG4q0ZRs5p7KocBsKC0
   Q6Xb9dukixOQ+ZZPt9H/i/7g/RwgPNDniZs0sKgc0OA10C3djUQc/2gYe
   +4PyKaV7jbw5lKg+HLW8chZyjlC1kmSIr0kbSI4LiFYduYdDvEs3WhWDz
   HmDI6VKmZgYWiTns9ktZ3aFrZ+6OsI2/5H5Ng5bxoldM/c1I6dKdJxZjD
   44s3TlXyH2AOSYzJQWqpdCZOHxdNbjtW+zbJOV6neFTggSRlE8pCmhAaK
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10855"; a="414820357"
X-IronPort-AV: E=Sophos;i="6.03,204,1694761200"; 
   d="scan'208";a="414820357"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Oct 2023 13:10:33 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10855"; a="926069192"
X-IronPort-AV: E=Sophos;i="6.03,204,1694761200"; 
   d="scan'208";a="926069192"
Received: from lkp-server01.sh.intel.com (HELO 8a3a91ad4240) ([10.239.97.150])
  by orsmga005.jf.intel.com with ESMTP; 06 Oct 2023 13:10:31 -0700
Received: from kbuild by 8a3a91ad4240 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qor9Y-0003bL-36;
        Fri, 06 Oct 2023 20:10:28 +0000
Date:   Sat, 7 Oct 2023 04:09:56 +0800
...
Message-ID: <202310070327.tlkIwubD-lkp@intel.com>
MIME-Version: 1.0
...
date:   5 months ago
config: x86_64-defconfig (https://download.01.org/0day-ci/archive/20231007/202310070327.tlkIwubD-lkp@intel.com/config)
compiler: gcc-12 (Debian 12.2.0-14) 12.2.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231007/202310070327.tlkIwubD-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202310070327.tlkIwubD-lkp@intel.com/

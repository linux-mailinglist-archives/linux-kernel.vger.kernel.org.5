Return-Path: <linux-kernel+bounces-116971-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 64D2D88B0D3
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 21:05:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id C0337CC0C73
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 15:02:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C8E8979CD;
	Mon, 25 Mar 2024 12:11:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b="rhSNa67c"
Received: from madrid.collaboradmins.com (madrid.collaboradmins.com [46.235.227.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B50B71494CE
	for <linux-kernel@vger.kernel.org>; Mon, 25 Mar 2024 12:05:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=46.235.227.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711368349; cv=none; b=hGn5vPybATnEa0K551ZoFidrd/6yyMNmAf2XG4K9KtNfuQO5kRbD+GJtMUri9tVjWCVv/4hNnIyrGvwQOEVA9/qoHEX0O5AxD02ZPSgXSh2Hy1anojAboYiqQjMwIzFfX1UNDtaP7CtTNNUWvqVesSxxocFfptT+uUmNWbDAvGc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711368349; c=relaxed/simple;
	bh=K01HEaDiD6y1aoBKX9TsqwEwflbrBF563ZiJ+fzSf1s=;
	h=Date:From:To:Cc:Subject:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=YmE/aXwGMbLp1D2Sla5ItcWcoTvvNOVNN9o8ie7HpH3FwwsFCDgKJ6XHBrvaEbgIZOVMd+2FfDD32EXsYmJYqew1aSlQRcZhXHjprdCAJePJZrRN6STWUu2FaExoPRMfIKShhO/W7bzs8S3TKEYunfviz/K/RNQscvG8N9ulas0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=collabora.com; spf=pass smtp.mailfrom=collabora.com; dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b=rhSNa67c; arc=none smtp.client-ip=46.235.227.194

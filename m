...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2986177CB6E
	for <lists+linux-kernel@lfdr.de>; Tue, 15 Aug 2023 13:03:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236618AbjHOLDE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 15 Aug 2023 07:03:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50024 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236564AbjHOLCi (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 15 Aug 2023 07:02:38 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 896B8B3
        for <linux-kernel@vger.kernel.org>; Tue, 15 Aug 2023 04:02:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1692097356; x=1723633356;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=mgdHKMdY17RRP3Xz/RQdfc5exF7KlHM8HjyxP9C80sY=;
  b=X0bpE2RqH1coWoHmPue3VauLVQsM4f9zKsvz6cRRHUlVScxbqRO4PZUE
   g3pCQEH8MGX+FCBm2bgpcGR7Yget8b7+PIEV9WVWaxBKrDSsJGNLN3PKE
   LuKGuEB7LvH71w0N3LGLrwm5q8R20zs9/CBVtzPo8+muL/SCkhyjejS03
   wkd/8KU7MNZ1Ci5+Ow6CRuIH8gb1v7DxDlnJO157wdkR2dpYPfPbROPeL
   L6sWSIZvzH1lgmLgHiSd2cHgR3Ue2CzEL4kMMDLv5Lk71DabrRUUXFPSX
   vYC0tB1RUxkosPhvtojzVU+cvaeNW6+0pvI9DGo1IMCNVFEsu9Zwc/Wbi
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10802"; a="436148307"
X-IronPort-AV: E=Sophos;i="6.01,174,1684825200"; 
   d="scan'208";a="436148307"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Aug 2023 04:02:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10802"; a="763236143"
X-IronPort-AV: E=Sophos;i="6.01,174,1684825200"; 
   d="scan'208";a="763236143"
Received: from fwafula-mobl.amr.corp.intel.com (HELO khuang2-desk.gar.corp.intel.com) ([10.212.73.197])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Aug 2023 04:02:32 -0700
...
Subject: [PATCH v4 05/12] x86/tdx: Pass TDCALL/SEAMCALL input/output registers via a structure
Date:   Tue, 15 Aug 2023 23:01:59 +1200
Message-ID: <483616c1762d85eb3a3c3035a7de061cfacf2f14.1692096753.git.kai.huang@intel.com>
...
v3 -> v4:
 - Also use R10/R11 as input registers. - Kirill
...
---
 ...
 arch/x86/virt/vmx/tdx/tdxcall.S   | 97 +++++++++++++------------------

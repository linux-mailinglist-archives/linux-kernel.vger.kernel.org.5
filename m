Return-Path: <linux-kernel+bounces-55373-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A373484BBE1
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 18:28:57 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 98A9FB22460
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 17:28:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 349CEE56C;
	Tue,  6 Feb 2024 17:28:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="AXkiw7Lk"
Received: from out-170.mta1.migadu.com (out-170.mta1.migadu.com [95.215.58.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 91FBDDDCF
	for <linux-kernel@vger.kernel.org>; Tue,  6 Feb 2024 17:28:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707240504; cv=none; b=WSPqEPlRDUJFlNVNfqWy9magI/QpjluexMHtLx8Cbj3QmF1ZhM0fqdoZrG+IaG6A48mgcf6ycc/RCMYH9gpHvFaoigqbKslozE0iKHEfg7v3jdmuLeWp53/7EfeFjGwetW1bEeDldIq+YaLERazG2xWo4h9iUaX2Rdz79VsxgPk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707240504; c=relaxed/simple;
	bh=xdcil5/20PO+KeGbybqbjvkgcj4h6betK4pcVEN+kEQ=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=KP3pKew4RdML4ghKgAxCnl18JoffupjAj+6V7iTgx5GG2AQI69cjz+ZXWL4bxLCNvm68ASw1ulnVxDQk1YXEfhEfMosGJInD3PeC2Q2PorursT4NUK0O1GMHt+J6ovPtr0fnmSI1rTkaPEs/VQp4qsK7H30CWH340QdSWcT4+/s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=AXkiw7Lk; arc=none smtp.client-ip=95.215.58.170

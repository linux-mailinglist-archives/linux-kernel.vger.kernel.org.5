Return-Path: <linux-kernel+bounces-45055-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E9CE4842B2C
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 18:48:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 619321F2495C
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 17:48:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B0C0D14D42F;
	Tue, 30 Jan 2024 17:48:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=samsung.com header.i=@samsung.com header.b="sqq6EHgB"
Received: from mailout2.w1.samsung.com (mailout2.w1.samsung.com [210.118.77.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BDD0B129A81
	for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 17:48:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.118.77.12
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706636897; cv=none; b=nVm+HtOLCtriVw+PiikidODxwE25CalKJ7T6syUBAbafPQRI5hssvT9/UQ7nha8UQq1WlZn7yzCbfWfldirG+P46VnL84t7DhO6eAAY1r5kXgZz+MmCNuHcDDoSMQmtrbLMjzLoop6E8XnM0I2p+YOuEpuaMysIezBiDQCVazdY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706636897; c=relaxed/simple;
	bh=z0m6c/7NAcTfRpVPVOjfTSthJusKCaTbiThtUGdY0No=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:From:In-Reply-To:
	 Content-Type:References; b=FuR8RBwL67UDDl+HGuJqYQdsYmRk7A6zk9jAtCEzbHn9elEFpiNJop0H64ZmCafZKKVPdiASS/+slPSt7aELS6GGrdnQXRdVhKUotf2p5Ce1LXVgY8MqWYQESSChql7TJpY+cjbEvPkxeXlVY4/0hmTz1DfBDcdJuYsoB0YfIEU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com; spf=pass smtp.mailfrom=samsung.com; dkim=pass (1024-bit key) header.d=samsung.com header.i=@samsung.com header.b=sqq6EHgB; arc=none smtp.client-ip=210.118.77.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=samsung.com
Received: from eucas1p2.samsung.com (unknown [182.198.249.207])
	by mailout2.w1.samsung.com (KnoxPortal) with ESMTP id 20240130174812euoutp024cac2684ce3974efa02e8ae83600c7aa~vMTY5DuXv2205322053euoutp02F
	for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 17:48:12 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout2.w1.samsung.com 20240130174812euoutp024cac2684ce3974efa02e8ae83600c7aa~vMTY5DuXv2205322053euoutp02F

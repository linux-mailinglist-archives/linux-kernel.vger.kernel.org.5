Return-Path: <linux-kernel+bounces-33030-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id CD272836387
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 13:42:58 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 92FD2B2A0DA
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 12:39:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CE30A3D0A8;
	Mon, 22 Jan 2024 12:39:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="cJDET7P5"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D11993C6BC
	for <linux-kernel@vger.kernel.org>; Mon, 22 Jan 2024 12:38:58 +0000 (UTC)
...
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	...
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=IQj5T6xb3FyqKPChDMz74T1oxH3PuIZn1xHQ8R+OAh7sOuAlCqDz6wC1WhaEkgHtlgdFw+sATtNh6zWj+R3ggOiccjYK3gQJWRI/Tq5UCGbop1aOE8KLyf7dUqxUKS1Zy8C5YHIQK3bzYzLMiBFr5tBMiPmIr3MWzw3fs5YsNU4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=cJDET7P5; arc=none smtp.client-ip=170.10.133.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=cJDET7P5GQPohtpMaRPBWAQjJfInhrq4HkiuUbYfe6aND2E2UMr9j3R9L3qeOo1DQcTfi+
	fEv1wIcYH+9MJyge6cS+KiyVA40HgJjM0o6BexkRQ+lBdHwbRjbJZNNL3raSOXa8qTkj1y
	kofz9tNoC/31P9ksynOoBsFoNXP1JIk=

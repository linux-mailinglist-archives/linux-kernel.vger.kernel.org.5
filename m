...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B1A55750E93
	for <lists+linux-kernel@lfdr.de>; Wed, 12 Jul 2023 18:29:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232943AbjGLQ32 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 12 Jul 2023 12:29:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33984 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232625AbjGLQ3G (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 12 Jul 2023 12:29:06 -0400
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DFA711BC5
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=hghdd2aj4BLvnkciEMq3ztmAfBe57Up2xreWQ1GlfwTE7Y7oBXDk+9rj
   v1ACyDSJe1yV6T0dLD6TVhL1M3809G+Kx+vZn+q62pO56Bd0UujIcFQjr
   DQBSHfH69wx0tAoHSonh0wx9vljGqZch4EpYTLUuwgWz2c8y9GQ+mzeEC
   oGwB51QmgPxaBD7++H1j9SUq10Wjia9wfnIWKgodzd9GRcQEc7ub1g2I9
   C8MGy4ksgAMC3ukMGDeakHVDOm5sBT4b0u2SJdAGy07HJiABhfHPeR/b9
   fmS7qPvajQGBhK1B2W2cBbNoF5q2gOPJBr8uEHMnExiK6o1zRtJp4V/Lu
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10769"; a="431072766"
X-IronPort-AV: E=Sophos;i="6.01,200,1684825200"; 
   d="scan'208";a="431072766"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Jul 2023 09:29:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10769"; a="715639052"
X-IronPort-AV: E=Sophos;i="6.01,200,1684825200"; 
   d="scan'208";a="715639052"
...
Subject: [PATCH v10 7/7] dmaengine/idxd: Re-enable kernel workqueue under DMA API
Date:   Wed, 12 Jul 2023 09:33:55 -0700
Message-Id: <20230712163355.3177511-8-jacob.jun.pan@linux.intel.com>

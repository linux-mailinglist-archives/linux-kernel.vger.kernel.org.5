Return-Path: <linux-kernel+bounces-106906-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D473F87F534
	for <lists+linux-kernel@lfdr.de>; Tue, 19 Mar 2024 02:59:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C2F1C1C21592
	for <lists+linux-kernel@lfdr.de>; Tue, 19 Mar 2024 01:59:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B250B64CE8;
	Tue, 19 Mar 2024 01:59:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="R186QgiS"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 570ED8F72
	for <linux-kernel@vger.kernel.org>; Tue, 19 Mar 2024 01:59:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710813589; cv=none; b=kAvhUTJYi1ePgIt9zm+mUI3QnvVCk4qR3d/u/WiZ4mkk1q4zUH2E2p89Vj/06Y1xNYdUMoiPWXEtkFF8FIXUVW1JyjNwAQum+pYl4wMb7KHbQQCa6H5ZHLDZqybdrgieSQb2ZbxESL6ubyAQUvDLYBXziOimByxR9ZuY6KqdFoQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710813589; c=relaxed/simple;
	bh=CrU/Cwre7xTqRqjznA4QIa9/2HuanGH1l5uIkHkVvYg=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=uo+M9WXagmUN3Tocyszwsw/0OzxpyBa/z8Cj6CwMB3haK1RhYuVqCtAzz2L8bmeRVH9ohKD18sk63fNSsvR/lTA5CQ/P/TOGxy+7E97T3AK2XJ2B1PJ+9rgE17NQn+6wlMl9W2Xb1EvBF6yRpZX40s1MZgg1ySwKjtXsk1LIV7E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=R186QgiS; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1710813586;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=7X522NAprrB0Et70jJtQ2h1vyvJ6jC6lJc+IVJnxhf4=;
	b=R186QgiSCNjkpDJWye03SD0H8uTp0F3zKMkLqJJAUIwMc3S25e1g1H/Nqfp/lPPki8dQhU
	bGqU1T/8l/CmrJrU4b+Pyfc2X5/Z+k9vQqruXnpTbyIcl9ZB6z8EWk0TYb02bv9bH0Uf1F
	M0n3AwkSuxXGw81VZ/CFdY2a4ZAtcuU=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-262-d5SGTvZ_ObCXFg0bQ1aOhA-1; Mon, 18 Mar 2024 21:59:40 -0400
X-MC-Unique: d5SGTvZ_ObCXFg0bQ1aOhA-1
Received: from smtp.corp.redhat.com (int-mx09.intmail.prod.int.rdu2.redhat.com [10.11.54.9])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 1A52185CBAB;
	Tue, 19 Mar 2024 01:59:40 +0000 (UTC)
Received: from [10.22.34.80] (unknown [10.22.34.80])
	by smtp.corp.redhat.com (Postfix) with ESMTP id 9E8CA492BC8;
	Tue, 19 Mar 2024 01:59:39 +0000 (UTC)
Message-ID: <d63dfa33-f194-4368-ab9a-3be27c4cd893@redhat.com>
Date: Mon, 18 Mar 2024 21:59:35 -0400
Precedence: bulk

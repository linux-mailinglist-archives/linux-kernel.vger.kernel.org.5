...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3BB1D798E69
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Sep 2023 20:51:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243335AbjIHSv5 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Sep 2023 14:51:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57488 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241747AbjIHSvz (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Sep 2023 14:51:55 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6F49B1BC1
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=cBog/17jG1mTArwU5kOIIQv+uQFxg8laxa+tevZYKXU=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=cBog/17jG1mTArwU5kOIIQv+uQFxg8laxa+tevZYKXU=;
        b=FP0ziImASuXGnDdmQ5oBsds9eXFeeq1dtsD+aOspXmpHxkvyBxj+fsBk+hNMPeAAzFPBXX
        BjXmEpKq7UrxNcAw==
...
Subject: [PATCH printk v4 1/8] printk: Add non-BKL (nbcon) console basic infrastructure
Date:   Fri,  8 Sep 2023 20:56:01 +0206
Message-Id: <20230908185008.468566-2-john.ogness@linutronix.de>

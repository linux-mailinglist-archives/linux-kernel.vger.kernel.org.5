Return-Path: <linux-kernel+bounces-60983-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id F14AF850C26
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 00:15:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 74455282057
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 23:15:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 286671773E;
	Sun, 11 Feb 2024 23:15:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="bJtOVpKb"
Received: from mail-ed1-f45.google.com (mail-ed1-f45.google.com [209.85.208.45])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0EECD17542
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 23:15:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.45
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707693337; cv=none; b=oF56kgwCFjJGrstly/qpH45g47JYzk+/ejd1c7fh2f2SBBoVjEfTgeEGa749IuqWgSjKyMoEoXIIupzFQv+lh2TUSdJSXFZ+/UzmtFIvaXESOUVI/XU9UXGZclXZXHKfOOSIy+XmEUxzO68TOb1wPznr1vlmotFYR+t/MN5gq4k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707693337; c=relaxed/simple;
	bh=Oj/Sc799EYOeafhpR1FrkrBtmCYkPlAz/EoBkpGYuZs=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=auYd6GnMH60C0rIpSAUZQloQH1+o3EHXIh90JXv6YcZzdwFaqBtKGaXUKp8wOo2SHPqVsjAxCo7cV2tnpPvtDP/5S2yq3v2bdUv/7qQwJvZhvyRSePbMNmEgFH15o11l2H+tQr+SsNS9hHgayoN1luWekqEXY0PxkfnjTIIsXLY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=bJtOVpKb; arc=none smtp.client-ip=209.85.208.45
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ed1-f45.google.com with SMTP id 4fb4d7f45d1cf-55790581457so4037601a12.3
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 15:15:31 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707693330; x=1708298130; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Chmz2d81B5ktJTwSj+Bw5JcMJXbPq5H0gPIAaWeBEOQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707693330; x=1708298130;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Chmz2d81B5ktJTwSj+Bw5JcMJXbPq5H0gPIAaWeBEOQ=;
        b=
X-Gm-Message-State: AOJu0YyHE78ejOyTuCwKgeOcqIE5WYUv51YmriHcI5YBMinIHDigHeK+
	hx761kkyHRrPdze9a1xhAWZ3YzCvmcWNTkrPjfmowLdpPApI6pYHB0ULKT568SdmRoG0nNu2b/Z
	9
X-Google-Smtp-Source: AGHT+IFmj04peuR8la8KC/1gltS29TFkHbdzsbXGqgFEIvjvnMHDaA5TEvh+QNvwn11EvyuZNZHF8Q==
X-Received: by 2002:a05:6402:1b08:b0:561:1917:eb9e with SMTP id by8-20020a0564021b0800b005611917eb9emr3841007edb.35.1707693329251;
        Sun, 11 Feb 2024 15:15:29 -0800 (PST)
Received: from raven.blarg.de (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id et13-20020a056402378d00b0055d19c9daf2sm2170180edb.15.2024.02.11.15.15.28
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 15:15:28 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v4 02/35] include: remove unnecessary #include directives
Date: Mon, 12 Feb 2024 00:14:45 +0100
Message-Id: <20240211231518.349442-3-max.kellermann@ionos.com>

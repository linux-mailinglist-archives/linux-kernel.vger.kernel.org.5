Return-Path: <linux-kernel+bounces-88346-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 13B2E86E056
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 12:30:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 213B61C20896
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 11:30:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 837B96D52D;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DC2AC6CDD8
	for <linux-kernel@vger.kernel.org>; Fri,  1 Mar 2024 11:30:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709292620; cv=none; b=L1jTsqACXhlcgSNdkyAiB6B/rypBaitW6q1lQvAPx+/FI4cKr4vNBqfPFhQqzwbqwakt/WF1q2/8UF+RKz+3UK+wAFZUP+/C6oSTy7lM3pcENeElDz9+PyU41cJCXvjGR15aXRltYni68wsusuL9ZEbdDf6oA82RAgUPX/O/Oyo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709292620; c=relaxed/simple;
	bh=GMy3Qn2d2gF2LMVBACUDqhuteqT3p8D1gDWNKRnREb0=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=PKfstu7xTIG4aU7Moldj3r1rRu220N1tZJqWvTstR3BkiDs3qm+bOpU/+cZX8QtT05wYz8mzV/3zojJYlxNfr1j/8pEq7dLg8VzgrGVjYi5w0pHPguYPM/LSMuGPmpInXH9MW17PnhMFrOBcRiXDnWkxV5pIpZixQHrM0T0bGko=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=IlahilxM; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-ua1-f71.google.com (mail-ua1-f71.google.com
 ...
 us-mta-298-SFgnWlWtM26_nt_YmW8sLg-1; Fri, 01 Mar 2024 06:30:15 -0500
X-MC-Unique: SFgnWlWtM26_nt_YmW8sLg-1
Received: by mail-ua1-f71.google.com with SMTP id a1e0cc1a2514c-7dae230b1b5so137873241.0
        for <linux-kernel@vger.kernel.org>; Fri, 01 Mar 2024 03:30:15 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xCFPJagLzKx22WqKKTHp8qRZXi4Io4yhhz4S1+ryYYo=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXXEeEFYzeYV5KrG+Vkr87kwHX9XyZvMmUhx0sYLPfkehYNfvgvdVICGNjCq/pWhcjatUsmOVIbB4DK7RI4iLt2lCYPBox0MTxoVJBl
X-Gm-Message-State: AOJu0YysolmrQ9fOaiwzzOYKaVKx133RaYh+IAh26n6mU+wZe+Ml2R+X
	owiQF9Rfz7n4StZO2aEMT79mzzb+0SenG3JoSlhnAkgl/5FDrwaTknJuu8ibJBeOfeeJpjgCuIG
	PgGNZC01cKge3Qd0tbhfc6lmyJqojKKtf5QF6x6FE0YeAOaZZhV5QpNAiM9R1dQ==
X-Received: by 2002:a05:6102:2a44:b0:472:60f4:b7e4 with SMTP id gt4-20020a0561022a4400b0047260f4b7e4mr691230vsb.2.1709292614344;

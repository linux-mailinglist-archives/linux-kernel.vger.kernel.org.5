...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 14FDC7E75CB
	for <lists+linux-kernel@lfdr.de>; Fri, 10 Nov 2023 01:17:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345457AbjKJARf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 9 Nov 2023 19:17:35 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39322 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229572AbjKJARe (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 9 Nov 2023 19:17:34 -0500
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6C85F4681
        for <linux-kernel@vger.kernel.org>; Thu,  9 Nov 2023 16:16:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1699575406;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding;
        bh=LJiuFuhs9j6OVrViDTLUQW94ykawjuK3gx8ofbQQdCM=;
        b=ZPD2EjeTLZOnRjPuMLSvLFumpBYf0YwisbNZ22v81ozcgOmSpvsAyYSi88kJdTr1DkCC/J
        W7mV+ZuUBKsKHtoK3LNmJiWsfzfgsZH3lVJrcwldSU5mmf6CZbkvv3xGQLWXraBBKUmhQ3
        kNW8ee+d4pkdlXcmfiDGT6utvFGOBcY=
Received: from mail-wr1-f70.google.com (mail-wr1-f70.google.com
 [209.85.221.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-620-Uvp0Zq4nPaGcHBq6VUKBsw-1; Thu, 09 Nov 2023 19:16:45 -0500
X-MC-Unique: Uvp0Zq4nPaGcHBq6VUKBsw-1
Received: by mail-wr1-f70.google.com with SMTP id ffacd0b85a97d-32dceab634dso683521f8f.2
        for <linux-kernel@vger.kernel.org>; Thu, 09 Nov 2023 16:16:45 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=LJiuFuhs9j6OVrViDTLUQW94ykawjuK3gx8ofbQQdCM=;
        b=
X-Gm-Message-State: AOJu0YwjC/qu0uHEAW633KHb2/PUspMUb+Og7m2wf6NRT6YN5noJ0gaE
        01SQtrdRNWLVWHWrQOZAqUb6mfux17qya/a5Z0t4Ci/HgVK8VNxwlU1GX0APOiSRPccKzI2T0DO
        wnLYJzfojyuBsADB1aISF/tRGYu2Jn2Y7
X-Received: by 2002:a5d:44c7:0:b0:32d:885e:633 with SMTP id z7-20020a5d44c7000000b0032d885e0633mr5381408wrr.19.1699575403310;
...
X-Received: by 2002:a5d:44c7:0:b0:32d:885e:633 with SMTP id z7-20020a5d44c7000000b0032d885e0633mr5381390wrr.19.1699575402809;
        Thu, 09 Nov 2023 16:16:42 -0800 (PST)
Received: from cassiopeiae.. ([2a02:810d:4b3f:de9c:642:1aff:fe31:a19f])
        by smtp.gmail.com with ESMTPSA id do12-20020a0560000c4c00b0032ddf2804ccsm752286wrb.83.2023.11.09.16.16.41

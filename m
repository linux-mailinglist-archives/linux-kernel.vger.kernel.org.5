Return-Path: <linux-kernel+bounces-6922-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C55E819F5C
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 13:55:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1A1F41F22EA4
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 12:55:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 42AAB25545;
	Wed, 20 Dec 2023 12:55:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="CMD19GKX"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 720E924B4C
	for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 12:55:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703076905;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=5EzlJsi0dZtBxnnHimhpFGwSMfH4YSJP5ttKUoO8KF8=;
	b=CMD19GKXAUdxp1q0hpJf6z+78AiIu5gxmcU1gsUxcXj8/QVf/zljn7qI3CD0KLwEXnARav
	IIpzpegXSj2psNyKFA8fw+ZXaHJP62o1stDXzkd1tJcR5HjJrYIOG5lRX+7wm9hnuQq0q7
	BA8u2ws6s7lkGYx2yHfv9nQWltA1UoA=
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 [209.85.128.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-35-qtgoSZV7ONiyQCblJZeAHQ-1; Wed, 20 Dec 2023 07:55:03 -0500
X-MC-Unique: qtgoSZV7ONiyQCblJZeAHQ-1
Received: by mail-wm1-f71.google.com with SMTP id 5b1f17b1804b1-40c58a71b7cso48259825e9.2
        for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 04:55:03 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703076903; x=1703681703;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=5EzlJsi0dZtBxnnHimhpFGwSMfH4YSJP5ttKUoO8KF8=;
        b=
X-Gm-Message-State: AOJu0YzopoZwB3Tg+Oub4o7TaosUBm7k1PVgv2vn2RFG0ho3POzD51Xg
	/h1DI/5V7CRj48BSe0YHiOFoU5GPFb5UImeQYOu5kc0Tp1cvfroqr67CtcouhmABJVKIpj8bF01
	Rl2ADC2VAuVPihQFjw8c61pKI
X-Received: by 2002:a05:600c:1c0f:b0:40b:5e21:dd16 with SMTP id j15-20020a05600c1c0f00b0040b5e21dd16mr11714809wms.68.1703076902538;
        Wed, 20 Dec 2023 04:55:02 -0800 (PST)
X-Google-Smtp-Source: AGHT+IGD4+GpjaA6rRGnqlzfD4MApaCEn7+/BusygtI57+L0ws12JNDh8iSqyVJ+MNpEpW5QJ9ufmg==
X-Received: by 2002:a05:600c:1c0f:b0:40b:5e21:dd16 with SMTP id j15-20020a05600c1c0f00b0040b5e21dd16mr11714792wms.68.1703076902019;
        Wed, 20 Dec 2023 04:55:02 -0800 (PST)
Received: from ?IPV6:2003:cb:c73b:eb00:8e25:6953:927:1802? (p200300cbc73beb008e25695309271802.dip0.t-ipconnect.de. [2003:cb:c73b:eb00:8e25:6953:927:1802])
        by smtp.gmail.com with ESMTPSA id h21-20020a05600c351500b0040d378623b1sm2037929wmq.22.2023.12.20.04.55.00
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 20 Dec 2023 04:55:01 -0800 (PST)

Return-Path: <linux-kernel+bounces-57720-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A6C084DCB8
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 10:22:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 04E041C22C38
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 09:22:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 186B56BFA6;
	Thu,  8 Feb 2024 09:21:02 +0000 (UTC)
Received: from esa2.ltts.com (unknown [14.140.155.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B00B66D1DA
	for <linux-kernel@vger.kernel.org>; Thu,  8 Feb 2024 09:20:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=14.140.155.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707384060; cv=none; b=k9dyiKGyasdyY6dAI0z52srsRfVkKrcBNHg8umC1/HPDfBNxvBSoeXfqZiZWVz7cJ1Z6/8VLNJrd/DO4oFA5fv/G87KZuEeqSe+rauxx4Zgs4eDRZ/WSlT3jT82EOG5FZ2dj6a05u6YpvN2bluUS7/7VStBcrj4nNTw/cLJaQe0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707384060; c=relaxed/simple;
	bh=Jgaf/jzHy8p2sB9+IkC8dt0TVv03n32g24J6ahx08+A=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=gEKLce68WPSHzHgP0BMyOdUSpI8oz6sHuxUF7fLNcr11l1Us+OSAsrgK2d1ucICF34v+P4qTPhWK9BgyHFRWPT2+cu6gGCpdiLhm+N0bm+HLiqJ6AlcmnpA/H96ccDXsUgIubSEEamRwZI0VIblBwQT5RHcMjt3mEBSCxI2leWw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ltts.com; spf=pass smtp.mailfrom=ltts.com; arc=none smtp.client-ip=14.140.155.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ltts.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ltts.com
IronPort-SDR: 0oZFran+bbkAqDURSimZJyZx15XjcKGh1nfYd9pugc7zKF9tI/SEIl1ousDGhhWQ2364Eoh2Fz
 d0cLq/S1Q+0A==
...
Cc: m.nirmaladevi@ltts.com,
	lee@kernel.org
Subject: [PATCH v1 01/13] mfd: tps6594: Add register definitions for TI TPS65224 PMIC
Date: Thu,  8 Feb 2024 14:49:21 +0530
Message-Id: <20240208091922.1206916-2-bhargav.r@ltts.com>

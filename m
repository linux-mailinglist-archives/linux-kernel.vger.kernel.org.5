Return-Path: <linux-kernel+bounces-121478-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 7965B88E877
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 16:21:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1B20B1F3234E
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 15:21:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F20F61411FA;
	Wed, 27 Mar 2024 15:04:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="fhtQa1MZ"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E2084140E22
	for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 15:04:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711551858; cv=none; b=g9OVh2FbvC/sZDtAa+Ez2CDALWp9y+TLIV6JhEHd1pJOc1xleON2kTfmLlPeB14nBnMnA0CMsjjxI0rXIEwvYD09S1ffXeHMrtJiCAj7ZE4tciI14xDd+0nZjOo0hyxTrXI1+QmuqXXo+HNTwGkL/UUEaepB3Xnzbfydw3dB+9g=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711551858; c=relaxed/simple;
	bh=lKYcHiXaapYY9EDdipb2qGnG72rc4km3T4CzGt+fgpQ=;
	h=From:To:cc:Subject:MIME-Version:Content-Type:Date:Message-ID; b=GjynQw8kGZDwbTfvg1gD19wnfxWF2/rf7t3ok5PqMVcNSKwavdfkZTlwBGxLCgzTF62gaGG0EfEgryGNH6veibxU8V08pNXb55mxfk3QAGEsm0GUZLuDmAZd/J44ucQlI6Q22qt0YAeodG79lpFossBa0oBFgLukTwdb1yp3fjc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=fhtQa1MZ; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1711551854;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding;
	bh=bWNSBg8at2ybCmMWCY4Y8Gsbxal/bw2ZagDjU70FTzA=;
	b=fhtQa1MZE5MFF4DFrkYi1+oGPseHD7OgNdJ0VGbLRP5+s/MePkz391r9FoKilSdyEDhN9z
	haWh2pcYAcEP1gcqrTRyfftG8olbxOgHqEJiCRRnX7zKkiP3FcNj8UMObolhd66nNek/qh
	eCV2EJAF9Wbop2YDxuYmFAqw64rCd5s=

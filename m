...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7785B81081C
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Dec 2023 03:19:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1378347AbjLMCT1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Dec 2023 21:19:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54412 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1378303AbjLMCTU (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Dec 2023 21:19:20 -0500
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C432AE8
        for <linux-kernel@vger.kernel.org>; Tue, 12 Dec 2023 18:19:25 -0800 (PST)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 53EB4C433CB;
        Wed, 13 Dec 2023 02:19:25 +0000 (UTC)
Received: from rostedt by gandalf with local (Exim 4.97)
        (envelope-from <rostedt@goodmis.org>)
        id 1rDEr3-00000002TmD-0LM0;
        Tue, 12 Dec 2023 21:20:09 -0500
Message-ID: <20231213022008.868252922@goodmis.org>
User-Agent: quilt/0.67
Date:   Tue, 12 Dec 2023 21:19:17 -0500
...
Subject: [PATCH v2 03/15] ring-buffer: Add interface for configuring trace sub buffer size
...
index 7b10ade68561..4ac9da316f68 100644
--- a/kernel/trace/trace.c
+++ b/kernel/trace/trace.c
@@ -9351,6 +9351,51 @@ static const struct file_operations buffer_percent_fops = {
...
+
 ...
 static void
@@ -9817,6 +9862,9 @@ init_tracer_tracefs(struct trace_array *tr, struct dentry *d_tracer)

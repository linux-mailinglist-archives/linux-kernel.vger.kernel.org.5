Return-Path: <linux-kernel+bounces-3979-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F70581764A
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 16:50:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2EBB7281DC7
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 15:50:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C584E7144B;
	Mon, 18 Dec 2023 15:46:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="bOrQnX1t"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2667949897
	for <linux-kernel@vger.kernel.org>; Mon, 18 Dec 2023 15:46:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702914392; x=1734450392;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=pwS0tMmZgeBSev+BsC15iKvwbQsHz+F53J1apjtLORE=;
  b=bOrQnX1tqo5cR/P71zcasqPe2KmtopQGjfd8jcB5b0G4PeqhyfGHhyVA
   rEEXj8tuWNJh/LSUNS4EAjh9WqmMzQKKHzNYBlEzjQL/NGjAuJ77ALYG0
   5XaMf4cnj0YHdYPg02bWPMsiq7hhZksY2f+8L921fpEAWrUsYjm8PPqL2
   arjHVF0tHTJAV2Qmif1UubVsz4MedYtPdMy5TzuYK6hmanHDoTON6vz9W
   nxtbh/R5O2YBbkdBjNXrrRU/mOYz73wZ0/PM7Qxd5WEuyHsbR8/RtUChW
   5VYwom/ojwCnKWFz0qUenRYTlJuM3aPiaB3Srv4GUTnOt3+jN6Df0Lru4
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="14208862"
X-IronPort-AV: E=Sophos;i="6.04,286,1695711600"; 
   d="scan'208";a="14208862"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Dec 2023 07:46:32 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="768876043"
X-IronPort-AV: E=Sophos;i="6.04,286,1695711600"; 
   d="scan'208";a="768876043"
Received: from lkp-server02.sh.intel.com (HELO b07ab15da5fe) ([10.239.97.151])
  by orsmga007.jf.intel.com with ESMTP; 18 Dec 2023 07:46:29 -0800
Received: from kbuild by b07ab15da5fe with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1rFFp5-0004Fg-1t;
	Mon, 18 Dec 2023 15:46:27 +0000
Date: Mon, 18 Dec 2023 23:46:02 +0800
...
Message-ID: <202312182311.9tyU4FnU-lkp@intel.com>
Precedence: bulk
...
config: arm64-randconfig-001-20231218 (https://download.01.org/0day-ci/archive/20231218/202312182311.9tyU4FnU-lkp@intel.com/config)
compiler: aarch64-linux-gcc (GCC) 13.2.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231218/202312182311.9tyU4FnU-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202312182311.9tyU4FnU-lkp@intel.com/

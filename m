Return-Path: <linux-kernel+bounces-76343-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 13D2C85F5DE
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 11:37:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4C2291F228AE
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 10:37:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7EF4E3C47E;
	Thu, 22 Feb 2024 10:37:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="jHgAohgM";
	dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="Luxomf0C"
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A1C3AF51B
	for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 10:37:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=193.142.43.55
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708598242; cv=none; b=GbeND7rR5dw++JodKa0hHs9QiXRXTl/4ozW4+WWvQzHfKh7CUFJbUKEEvr5xe88TVhYaoMkZWb/ouAheABX0tpmR9ER8JVTyyjc7N+piKkCZq2mzCbTKj26dMTfXK77dMMkD8TcGuM3Yi5eIrxf/iwFDskajt3f8TEi121+A/fM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708598242; c=relaxed/simple;
	bh=Ee9dNQGeF4e5p7r+L0lBwfpguGn6tXkEPlL0w26M9ds=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=YQinprrBRSlfxCGDWbPHhH6Y4tvuaNIHlq202HmEZ8UOLFY5Z5jx/gqe8dZ0mjtmDG1E91TvBKsTI1PdFXa3yhjmvs0X04anqWO+0a9BsLoLeW3R5aux8EZDshsbB01dLij/xAeGZh5Ps7BqEMtAnM1hb1D1FQ2wXsDVD4Apk3w=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linutronix.de; spf=pass smtp.mailfrom=linutronix.de; dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=jHgAohgM; dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=Luxomf0C; arc=none smtp.client-ip=193.142.43.55
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
	...
	bh=fbe1rJBQgondi74Q8zyKkKtF9BMN2EJebggKE4PkdeU=;
	b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
	s=2020e; t=1708598237;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=fbe1rJBQgondi74Q8zyKkKtF9BMN2EJebggKE4PkdeU=;
	b=Luxomf0CJHeZTEM0sMflFnPGFZXzhNtAfNfp3kzp1LwafquwkLqKxgmtgrVCHib6pO5pAQ
	bOD9alXNplw0uSBg==
...
Subject: [PATCH v11b 18/20] timers: Implement the hierarchical pull model
Date: Thu, 22 Feb 2024 11:37:10 +0100
Message-Id: <20240222103710.32582-1-anna-maria@linutronix.de>
...
---
v11b:
  - Fix whitespace damages and add a comment (checkpatch fallout)

v11a:
  - Drop unused 'leftmost_change' variable

v11:
  - Memory barriers for reading the group and child states
  - Fix handling of 'check' member of struct tmigr_walk when executing
    tmigr_requires_handle_remote()
  - Fix race when updating events by holding the lock when reading the
    group and child states
  - hand in next event as argument of tmigr_quick_check() to make sure
    first global timer of CPU is also taken into account when doing the
    forecast
  - fix race against failed CPU hotplug in tmigr_quick_check() by walking
    the hierarchy instead of relying on the per level hlist
  - Update missing and outdated comments
  - Drop return value of tmigr_handle_remote_cpu() as group->next_expiry is
    updated and can be used
  - Frederics fix: Rework corner case, when last active CPU goes offline.
...
index 3f618ee39763..0339273f9365 100644
...
@@ -2124,6 +2125,64 @@ bool timer_base_is_idle(void)
 {
...
@@ -2132,7 +2191,7 @@ static inline u64 __get_next_timer_interrupt(unsigned long basej, u64 basem,
...
@@ -2153,6 +2212,22 @@ static inline u64 __get_next_timer_interrupt(unsigned long basej, u64 basem,
...
+
 	 ...
 	 * base.
@@ -2165,7 +2240,10 @@ static inline u64 __get_next_timer_interrupt(unsigned long basej, u64 basem,
 	 */
 	if (idle) {
 		/*
...
@@ -2178,14 +2256,23 @@ static inline u64 __get_next_timer_interrupt(unsigned long basej, u64 basem,
...
+	return cmp_next_hrtimer_event(basem, tevt.local);
 ...
 /**
@@ -2193,8 +2280,11 @@ static inline u64 __get_next_timer_interrupt(unsigned long basej, u64 basem,
...
+ * event is taken into account.
 ...
 {
@@ -2236,6 +2326,9 @@ void timer_clear_idle(void)
...
@@ -2305,6 +2398,9 @@ static __latent_entropy void run_timer_softirq(struct softirq_action *h)
...
@@ -2319,7 +2415,8 @@ static void run_local_timers(void)
...
index 000000000000..0825ccdcfae4
--- /dev/null

Return-Path: <linux-kernel+bounces-144600-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BCC08A4841
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 08:39:27 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A028F1F22440
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 06:39:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5CDD33BBCA;
	Mon, 15 Apr 2024 06:36:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="Vl6fmYIM"
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 626403A8E4
	for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 06:36:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713163016; cv=none; b=qT/33qIp8pvJJB1xOiN68nfvxNDI0xBKoKsHfUROq3XwKFwUIIiwnDgWX4ZKkkGvQvatqNC54YgRAe4ao/l8m+D49xtHcXRVIO+j9HuDawdaXH1PKzFOGYIYSGdOEw9iViG/HutBWi4OKMWwqmW0LLQuhvYUBZjuW6CVecqs5fM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713163016; c=relaxed/simple;
	bh=w65gh5BACvoXwLzkxFuRBokMMG+4qUIFVzfW25iKCgQ=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=RJa2pWZ2qEYPqbTn7zUyJEEpqTYAQ7cm79ZYo02dPmZWCTxGlK+CWMx5RhVZsy4tstpp/LvRjPjPs1RnK1cHtyyAVDKphT/BedvHyFGXoo/TsOkIidMzoRlLUiQV0qUMoC2lAbkBjQ/EyV2zy1EmRndOwYQGH5qlXqXU/8dRm1E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=Vl6fmYIM; arc=none smtp.client-ip=209.85.219.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-ddaf165a8d9so4495521276.1
        for <linux-kernel@vger.kernel.org>; Sun, 14 Apr 2024 23:36:53 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=C2zYz2p9SuP23YkC/Puz1S5ccaK/qlF1ObCAaC2jTYw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU9XFpFw+JYIV/l9M2zuej3hcpGea5lcwguztm4hq7gujl0iEJ+/25HOZI3lADE6IcthCvo2nPTmHiMcGWnQIYPe7iOmZ7S1HBPXHl1
X-Gm-Message-State: AOJu0YypxNoyh/aNx8spxyZcBtKQdkHj6ucizH+srM5d5DDy2UHb09xJ
	ELCngIKedmbPHxJv4JaqSEaWuDg062Ijvgkh7C0r1AZADNKbPy7T6qvg49HXGBMS6Y3I74rpNxb
	Vt7IzuQ==

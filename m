Return-Path: <linux-kernel+bounces-16039-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id B2EB2823751
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 22:55:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 4907B2884D3
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 21:55:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 226D51DA39;
	Wed,  3 Jan 2024 21:55:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux-foundation.org header.i=@linux-foundation.org header.b="ETQSWmIZ"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-ed1-f43.google.com (mail-ed1-f43.google.com [209.85.208.43])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A66941DA28
	for <linux-kernel@vger.kernel.org>; Wed,  3 Jan 2024 21:54:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=linux-foundation.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linuxfoundation.org
Received: by mail-ed1-f43.google.com with SMTP id 4fb4d7f45d1cf-5569472f775so2404870a12.2
        for <linux-kernel@vger.kernel.org>; Wed, 03 Jan 2024 13:54:57 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google; t=1704318895; x=1704923695; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=n/TvqoF7ldfcuD+idD2xG95uQQkyuBCue6/M91Hiat8=;
        b=ETQSWmIZmBddJvV1vskWdz6euakYf3RNWyzVF5cL6HTfqOemF+JAZEfpGdt50cz2hI
         MUyHuB0PTJAGROh7OT0dv/WV3NkSetNmkj+ePe7aDUni41ya84zvQUAaS9cCsM+RhqtX
         txlbXKaguwk2e0PU1PhssHzbMY5Smib5pQIw8=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704318895; x=1704923695;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=n/TvqoF7ldfcuD+idD2xG95uQQkyuBCue6/M91Hiat8=;
        b=
X-Gm-Message-State: AOJu0Yy4lf9d+6X40cGU681nkqwSHYcAqM7BNSLswRs5Rk00k5He2gRh
	yarGdhlTjQJTBerzKSkSXTKT1XF2GhLSxD8kdk/WkVKZM8QQhIuz
X-Google-Smtp-Source: AGHT+IHHGhY7F7tPd6JouPcglUBhXrB1TnbI14EmehmP/q1Nwm/KtoyErD3FmxTBCoBFHMrZZTyyLw==
X-Received: by 2002:a50:9318:0:b0:554:e4e:ba38 with SMTP id m24-20020a509318000000b005540e4eba38mr10543047eda.17.1704318895710;
        Wed, 03 Jan 2024 13:54:55 -0800 (PST)
Received: from mail-ej1-f48.google.com (mail-ej1-f48.google.com. [209.85.218.48])
        by smtp.gmail.com with ESMTPSA id ek20-20020a056402371400b00555f49e7080sm6522835edb.56.2024.01.03.13.54.54
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 03 Jan 2024 13:54:54 -0800 (PST)
Received: by mail-ej1-f48.google.com with SMTP id a640c23a62f3a-a271a28aeb4so712638666b.2
        for <linux-kernel@vger.kernel.org>; Wed, 03 Jan 2024 13:54:54 -0800 (PST)

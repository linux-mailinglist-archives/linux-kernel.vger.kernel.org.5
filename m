...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0FF84753BA9
	for <lists+linux-kernel@lfdr.de>; Fri, 14 Jul 2023 15:21:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235292AbjGNNVd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 14 Jul 2023 09:21:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35298 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234861AbjGNNVb (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 14 Jul 2023 09:21:31 -0400
Received: from mail.loongson.cn (mail.loongson.cn [114.242.206.163])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 175491B6
        for <linux-kernel@vger.kernel.org>; Fri, 14 Jul 2023 06:21:25 -0700 (PDT)
Received: from loongson.cn (unknown [36.161.89.232])
        by gateway (Coremail) with SMTP id _____8AxEvDTS7Fkp+IEAA--.12579S3;
        Fri, 14 Jul 2023 21:21:23 +0800 (CST)
Received: from localhost.localdomain (unknown [36.161.89.232])
        by localhost.localdomain (Coremail) with SMTP id AQAAf8CxbSPRS7Fk5zEuAA--.14510S2;
        Fri, 14 Jul 2023 21:21:22 +0800 (CST)
...
Subject: [PATCH v3] LoongArch: Add LBT extensions support
Date:   Fri, 14 Jul 2023 21:21:21 +0800
Message-ID: <20230714132121.107045-1-huqi@loongson.cn>
X-Mailer: git-send-email 2.41.0
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-CM-TRANSID: AQAAf8CxbSPRS7Fk5zEuAA--.14510S2
X-CM-SenderInfo: pkxtxqxorr0wxvrqhubq/1tbiAQAMCWSwyy0H6wAWsM
X-Coremail-Antispam: 1Uk129KBj9fXoWfXryrCryDtF15tw1rWr4rZwc_yoW5CFWxWo
        WftF48KF18Gr429F13KwnxJa4Fqrn0gr43Z3y3ZanxWa1xA34FqrWjkw13ta43Jr93CrWr
        u3yfXws7X34xtrn3l-sFpf9Il3svdjkaLaAFLSUrUUUUjb8apTn2vfkv8UJUUUU8wcxFpf
...
---
v2->v3:
* Inline the '_{save,restore}_lbt_context'.
* Some problems with code style.
...
---
 ...
 arch/loongarch/include/asm/lbt.h             | 111 +++++++++++
 ...
 arch/loongarch/kernel/lbt.S                  | 148 ++++++++++++++
...
index 79e1d53fea89..95a8a34e303f 100644
...
index 000000000000..b8616d7fdb24
--- /dev/null
...
new file mode 100644
index 000000000000..18c1550d1a8b
--- /dev/null

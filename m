Return-Path: <linux-kernel+bounces-155284-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E2F448AE830
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Apr 2024 15:30:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 5B11E1F2206D
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Apr 2024 13:30:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DFE7A136657;
	Tue, 23 Apr 2024 13:30:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b="A9N/00xH"
Received: from madrid.collaboradmins.com (madrid.collaboradmins.com [46.235.227.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D867C135A6C
	for <linux-kernel@vger.kernel.org>; Tue, 23 Apr 2024 13:30:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=46.235.227.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713879012; cv=none; b=o3KtfLz/Ok9LoOsuglSkgroI5eVusdDtGIJK4kYfrsM3vsnoRX8VgAnFz1fG3mKmnD35JaKop0DQh9ivjSQoajWU1udHFGmm7jt6rd7C0CBVPhtJUSOHudkDT2VOHA/YG0yHadNr2QjtEHx/OVEibpW/HRaIJ/A2rRSNMHdHcLs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713879012; c=relaxed/simple;
	bh=ruMTP2I/pC5dW35z/5uCVwpk0VQNtJqujZBT/QxGijY=;
	h=Date:From:To:Cc:Subject:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=MJWXFMY/ctZYg2iN4KQ4sryPjveZz2qn1fAkt5/SgQ+gOG/3lk/tnAavfUcDY+np+BrQWHuQ7Qoun0tZ/oChpiZ6JXa1reOAbRcRWiqa6ovUnGUNcjKtOKkhxDQnah3hgn1KpOH6BDot+sETFWSiU5hc0usMn1PUinutbL8BXbw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=collabora.com; spf=pass smtp.mailfrom=collabora.com; dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b=A9N/00xH; arc=none smtp.client-ip=46.235.227.194
...
Subject: Re: [PATCH v6 15/17] drm/vkms: Create KUnit tests for YUV
 conversions

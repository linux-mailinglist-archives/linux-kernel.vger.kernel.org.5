...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F17D97DD801
	for <lists+linux-kernel@lfdr.de>; Tue, 31 Oct 2023 23:02:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344901AbjJaWCV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 31 Oct 2023 18:02:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50038 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229785AbjJaWCT (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 31 Oct 2023 18:02:19 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8209BEA
        for <linux-kernel@vger.kernel.org>; Tue, 31 Oct 2023 15:02:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1698789735; x=1730325735;
  h=date:from:to:cc:subject:message-id:references:
   content-transfer-encoding:in-reply-to:mime-version;
  bh=sFBpTVH/U4oDmmMdkBfuJPH1pmgMKF0e52L8ENsCqR4=;
  b=ZVIkDmXxaqEWa9tEoG8YVYmQzEH81N6BQGp1GElJkHgKdIY4uqf95uD+
   Dm58XyBdSMCa4Vu9SPhS5WYt+60W2MI/7/Vihop+B4xI0Ke77ZpeLveaX
   c7x5xgHsiKQUgMHiACnrm/SfDvrXakTFm5zBGm0zQlmotrIkZ2dHDXfkZ
   m2rwTfoOJA7rZCCNxSYCjvejjLCw0oQVuuEQ5WVlcSSaJdjXi6NdRMrXg
   BHySrfaSeNZR22ghPz+qUI7wNOzbgxJmC1ETgKwyf9loCDdramoDB/uzo
   G/lq4NVnYp/kByIqNHQ8mGHSmzcXiulG4kvOikMQuxMIb1vfJGx66KKj6
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10880"; a="391250920"
X-IronPort-AV: E=Sophos;i="6.03,266,1694761200"; 
   d="scan'208";a="391250920"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 31 Oct 2023 15:02:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.03,266,1694761200"; 
   d="scan'208";a="8456323"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
  by orviesa001.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 31 Oct 2023 15:02:13 -0700
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 31 Oct 2023 22:01:49.4934
 (UTC)

Return-Path: <linux-kernel+bounces-90830-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1CFAE870588
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 16:32:44 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3F7001C20D66
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 15:32:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A31B554794;
	Mon,  4 Mar 2024 15:29:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="JCkcFhxf"
Received: from relay5-d.mail.gandi.net (relay5-d.mail.gandi.net [217.70.183.197])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8D45B4F8A1
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 15:29:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.197
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709566174; cv=none; b=tAcdrftX1J7VC1v23vseITtghb/FfW7gnALF0gK6RMq8RB0FKXU6WGwianWyKuC6x9tTw7nrF6xTZgYFaj4behmDttUMeMwBXIZyjanM2jji6uKJT4anqwPIgVaFLLL6/rv2K3dXT8MxG0j+eMmCRNrGrH/2Gc5M5XUM6du3ERk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709566174; c=relaxed/simple;
	bh=y/uBgYeisBqlVkvVAsYBdVe5eI8RGMb3SKWshH7JFL8=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=qB8sqaoi0aUHzltcoUfut0I5MAmlvyoxg7knDq9KesyOTNKMAhhKI6yUq6yiKbwCP38PmNpoUlPFnzrp3OJixf7p3W1MKf1lQ6pdEQXMoNNTCaMiluIYZ12QxPAS6yoIi20knTyp844juB0DZY5fsZof/fcIt3YBhjVi2SbKKq8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=JCkcFhxf; arc=none smtp.client-ip=217.70.183.197

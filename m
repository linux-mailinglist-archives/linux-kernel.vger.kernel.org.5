...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9532F7B1664
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Sep 2023 10:48:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231365AbjI1Is1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 28 Sep 2023 04:48:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38742 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231494AbjI1IsS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 28 Sep 2023 04:48:18 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D872B196
        for <linux-kernel@vger.kernel.org>; Thu, 28 Sep 2023 01:48:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1695890887; x=1727426887;
  h=date:from:to:cc:subject:message-id;
  bh=PCrlSUFB074znOBhUpQfhuZfWh39RHPdKRTHuzUYzjE=;
  b=ZKQBL+qJ4u0AjZxcatKONvB5ZoTAmYlhUIsM8WTmd69ak+k9UEYgZE0w
   aNlYhNgOrc9wCVYXk+YouH3INnrZmk/2gTIY0GPcEDY7ZE3At9l8X8kbv
   AmtOBCuSbb60R7k2cPM1sl+S871ZYCBVJL8rWcsRb0MUMoir6sf0wWywh
   eJI75Aiaj1z8wtnTDsKInxtMzoWousGDnXE0d48eMLcCu/2qnnRoTg98m
   yxNcakJkMm1V2rWeg2GL/xuXLf2rSGkmi9ipmpVkX9fCqCi9NEVTWjSpN
   gFIqPNHjiRd6T0QpkCadoDxCKNXFFT6LDfpbf1fILTU9vlOVUvdqqpHw/
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10846"; a="468299772"
X-IronPort-AV: E=Sophos;i="6.03,183,1694761200"; 
   d="scan'208";a="468299772"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Sep 2023 01:48:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10846"; a="784622387"
X-IronPort-AV: E=Sophos;i="6.03,183,1694761200"; 
   d="scan'208";a="784622387"
Received: from lkp-server02.sh.intel.com (HELO c3b01524d57c) ([10.239.97.151])
  by orsmga001.jf.intel.com with ESMTP; 28 Sep 2023 01:48:05 -0700
Received: from kbuild by c3b01524d57c with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qlmgk-0001Hv-3C;
        Thu, 28 Sep 2023 08:48:02 +0000
Date:   Thu, 28 Sep 2023 16:47:14 +0800
From:   kernel test robot <lkp@intel.com>
To:     "x86-ml" <x86@kernel.org>
Cc:     linux-kernel@vger.kernel.org
Subject: [tip:x86/asm] BUILD SUCCESS
 1882366217757d3549e48a833bf9a5799b172251
Message-ID: <202309281612.Caoq5mwh-lkp@intel.com>
...
branch HEAD: 1882366217757d3549e48a833bf9a5799b172251  x86/entry: Fix typos in comments

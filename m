Return-Path: <linux-kernel+bounces-59813-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6EA3B84FC15
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 19:40:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 8FEA71C244C8
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 18:40:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1E0881292E1;
	Fri,  9 Feb 2024 18:37:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="YhShFgov"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A3F5F80C07
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 18:37:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707503872; cv=none; b=c/cC9WnEnemwKyVET4p53UDeEU7gcWOFdDC5CV7uE1TjIypMXOtPu3ei4a4om5q9Q05GLbT7K6DB2mxnD3V4zpu5g/pUXowaSwNlxo7dgwPfU6QEG6GzTmLrrb9tM+gGjebhd12pODEL9OZC0IAR1yGxyQbXDF5kYO1rsrlrzEE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707503872; c=relaxed/simple;
	bh=p9XbuM+3mx1bbe8WFegD4GtDeDLMjPkGkOvBs6sIf6U=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version:Content-Type; b=V/h2eJPSxg/fk+55+hjfn4vz2PxqSeAcI4aGh2Ue/SOX2hKo4LqHruwUO/mTi2Vl5R9H5USpPBKT+cxQOylbIVsGC8yD6KiGVAF4WWsaPWq//SUj0rhSI6cD9PANHNelCMPnma0k5K8w/U8mApoXij5L2hV9AzFnEjTwgENU/Js=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=YhShFgov; arc=none smtp.client-ip=170.10.133.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=YhShFgova7yHvjs6t4rx0M5x+n1D57sa/kgFjKlea5ZMbhPwDmvUi+YlJ3SydbuXDT7vXa
	WSiA9CpU6NconHvPQfcyKPFyZxtulp6P2NGs2xRJOHMKNzaieG1YX36oo5E4WfRQrzUvWQ
	cSSRmYMcO8CXzzTXpXoJ+cm4utNq6z0=

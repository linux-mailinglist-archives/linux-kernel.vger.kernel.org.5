Return-Path: <linux-kernel+bounces-74614-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 87A0D85D6D8
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 12:29:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 3E401284E50
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 11:29:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5360C3FE3D;
	Wed, 21 Feb 2024 11:29:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="kKB4l2+6"
Received: from mail-ed1-f52.google.com (mail-ed1-f52.google.com [209.85.208.52])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B5E4E3FB3C
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 11:28:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.52
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708514940; cv=none; b=YrIKRyp3zogGZLVKhUyiG7KUTfR0ghwYlyftwoFSPV6loi3vOhP/JfPnyRiFYZSNXLYpLfDlF8HOk9OmdptWwS2xdCq7XkQ2uDe6xGpFp5PeMoUZIHUcxZB2ff5EFiUytEs3Lqz7YXO0+MpXm+bZCKZfEImbQJK3nW6Sa93xPs0=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=kKB4l2+6; arc=none smtp.client-ip=209.85.208.52
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-ed1-f52.google.com with SMTP id 4fb4d7f45d1cf-55c2cf644f3so8889458a12.1
        for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 03:28:58 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=2uGxM6/2SBSUObOeQvfq+UUzJjduE352bGJGnjX6fsE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWZUMCH5l676TIMZz4Sf4fTNfoMzSYXBjOTRzrLA9UflTXxS8kBxRCpee/xV/bAhzdlLYM41PZpdRhtIBwrFeZ9XsWuScpElZacHyK5
X-Gm-Message-State: AOJu0YxzlCmH71qqJQ2+tlnI0fvLDGWCprcPjkeZa/pcPhx6RjjUWpJm
	sxY/bvH6I8se8E8uUhoGR8xf8AIUbbMos86nV2T22TWfxydxOMspTtvQzDl1fTE=

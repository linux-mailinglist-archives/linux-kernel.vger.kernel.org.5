Return-Path: <linux-kernel+bounces-78247-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id BAA0C8610B6
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 12:46:37 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 32BD7B22398
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 11:46:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1924B7A722;
	Fri, 23 Feb 2024 11:46:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="o8NUzKQV";
...
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EE13B664D7
	for <linux-kernel@vger.kernel.org>; Fri, 23 Feb 2024 11:46:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.135.223.131
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708688787; cv=none; b=iHG7ZVIZDOgfytbgGjGGeq4GPVavP+8kdx+FBlbolx/i9SUYRwzG29nvMXZY4/dA6ROiDrS+DavYdudIIbOjOCiAiWRcTYrOLyxSpkCLOB+I2DesruGY6FSk5zzfN45ueJ569Bj+u5ls7zzArhRvz/jT57qEargw5+1LnWLkRkE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708688787; c=relaxed/simple;
	bh=sk52ENeAPAylRdaOeygsSET8o+0RBfOolZyUSuwOlrA=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=mSKDpnj5HHY8u8VO59OKNyGBffxnl62Pjd00C9zbopmY+gVp67vK/qXT1WS4+8Dt/FPA8uYyrr6xzyyj94zxYsMqE0xJudJkdiwjzO4lBiC7NO+hSRW90adwpAobxKSgm8hFUe78x6CFGn8qRwVUrDUyQC0S64wXUyVz6QCfmZk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=suse.de; spf=pass smtp.mailfrom=suse.de; dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b=o8NUzKQV; dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b=B2gBiYXQ; dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b=bMl4K6kj; dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b=uSUCBM76; arc=none smtp.client-ip=195.135.223.131

Return-Path: <linux-kernel+bounces-31594-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BE8F8833080
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 22:54:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id E393A1C20A74
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 21:54:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1BF4758237;
	Fri, 19 Jan 2024 21:54:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="fUKU00Ah"
Received: from NAM02-DM3-obe.outbound.protection.outlook.com (mail-dm3nam02on2061.outbound.protection.outlook.com [40.107.95.61])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 30E2958132
	for <linux-kernel@vger.kernel.org>; Fri, 19 Jan 2024 21:54:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.95.61
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705701269; cv=fail; b=tadoq2g7H+fJsAvVmhT5a6FMMa+LYO8Yizt5bax2D5Cx9in4ca/jIdIZlLgN+GuUunD601UzOPE94cyQB7fAAZzGcR57UuXLkoHFLlnm2qT4WjzVcNsGYAKOFXXTlzcXkUzDi/yboZ0J3j+xLtmtopVmjjUg7zPia6YAXg/1gsk=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705701269; c=relaxed/simple;
	bh=LI2998x0UTwKoMy8VmC95T5+japhZlzL9xFnUt/W8+o=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=uI/SzUk8p7Sj5PBB1rmhrc3JWNS11Ch7DIvgKiRxJw5MwllAwLMK8INe+wakweEdFzwesJW5UTDBInUS+RKNRUWmMUN6ksgKDx+Nd4oxJksmKIx6fsMzHApTe2WJm0Jh8XH+ji8iuFyysyozgVipDkYLaPY9BzdRxZRCPd/r/E4=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=fUKU00Ah; arc=fail smtp.client-ip=40.107.95.61
...
Message-ID:
 <MW4PR12MB7165ED01A69DDBA1F6A40DA8E6702@MW4PR12MB7165.namprd12.prod.outlook.com>
...
x-microsoft-antispam-message-info:
 
x-forefront-antispam-report:
 CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MW4PR12MB7165.namprd12.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(376002)(39860400002)(346002)(396003)(136003)(366004)(230273577357003)(230922051799003)(230173577357003)(451199024)(1800799012)(186009)(64100799003)(2906002)(7416002)(5660300002)(52536014)(8936002)(55016003)(8676002)(4326008)(6916009)(316002)(64756008)(66946007)(66476007)(76116006)(66446008)(54906003)(66556008)(41300700001)(38070700009)(26005)(71200400001)(478600001)(6506007)(7696005)(53546011)(9686003)(38100700002)(122000001)(83380400001)(86362001)(33656002);DIR:OUT;SFP:1101;
x-ms-exchange-antispam-messagedata-chunkcount: 1
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?V3RmNWJ4eUlMeU9ld1A5cjgzK3Rmcm5sRnkwK1Zpc3FQVFFKU0I4ZU8ybzNY?=
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 19 Jan 2024 21:54:24.5647
 (UTC)

Return-Path: <linux-kernel+bounces-20225-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B637827C31
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Jan 2024 01:45:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 42581B22212
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Jan 2024 00:45:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9DFAB39E;
	Tue,  9 Jan 2024 00:45:14 +0000 (UTC)
Received: from mail.stoffel.org (mail.stoffel.org [172.104.24.175])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 71F78623
	for <linux-kernel@vger.kernel.org>; Tue,  9 Jan 2024 00:44:47 +0000 (UTC)
...
Received: from quad.stoffel.org (097-095-183-072.res.spectrum.com [97.95.183.72])
	...
	(No client certificate requested)
	by mail.stoffel.org (Postfix) with ESMTPSA id DE55D1E12E;
	Mon,  8 Jan 2024 19:39:15 -0500 (EST)
Received: by quad.stoffel.org (Postfix, from userid 1000)
	id 797C2A8E12; Mon,  8 Jan 2024 19:39:14 -0500 (EST)
Date: Mon, 8 Jan 2024 19:39:14 -0500
...
Subject: Re: [PATCH next v4 0/5] minmax: Relax type checks in min() and
 max().[C
Message-ID: <ZZyVsrQx-G0hGjDc@quad.stoffel.home>
...
On Mon, Jan 08, 2024 at 01:11:12PM -0800, Linus Torvalds wrote:
...
I just did this using a git branch for v6.7 without and with your
patch applied.  The system is an older AMD Ryzen 5700G running Debian
12 using a self-compiled kernel v6.5.13.  The volume I built the
kernel in a volume in a mirrored pair of NVMe disks (mirrored using
LVM, then added into a disk group) which should keep HDs from
impacting this performance.  Gotta figure out which disk(s) holds my
/scratch volume I used for my testing.

Here are my build time results:

   time make -j 32 modules bzImage
   ...
   real    34m57.581s
   user    491m18.659s
   sys     50m54.396s
...
So a drop in user and sys, but not a huge drop, and not a big drop in
wall time at all.  But I'm also not a speed daemon system, but it's
certainly plenty fast enough for me.

Happy to try and run more tests.  I've appended my .config of the build.  

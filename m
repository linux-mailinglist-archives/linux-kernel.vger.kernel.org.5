Return-Path: <linux-kernel+bounces-93136-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 38344872B79
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 01:07:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 117761C218AC
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 00:07:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C0152173;
	Wed,  6 Mar 2024 00:07:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="cl1oa70r"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B11E52594
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 00:07:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709683631; cv=none; b=GvgqLNSWnERPky0EARGmqwc4KXCnA/etiLkloodN3KAFE62/j8ztwAdVmJ7ED129UzYKvsQX8o9/VWQfwaoVJkkR5kAOQKyhEzHyFSg+fT2W9D+PJAQj3jHX5rjEJturVS3utFM1XzcpNob7Z1Qwh4Izrqx9vHkup7ouhHzRWTk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709683631; c=relaxed/simple;
	bh=JYhx7DIciqCb/UTDwB/y/lo8NilCfgSTvNbJk+2L6qw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=k+7CDzv+h9ATdqrgLRphNaCHaXyffq7BRqKWYAOjIgUC8imHwQDpcCaolaFepH8WZzoCOW2UlY1exdLtnlEpSiLaLj7RTZl9yiTOIMHfscxvj9E5q9l1OK8MlVJUN5RJIH3EKvlFV8zol0WeARvcqmk/4tWV6UTGImEtb2JjTjM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=cl1oa70r; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709683628;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=iOtV4ZQuN/A4A5dBF0j3j04MO7mqMmmSLmh55RKub28=;
	b=cl1oa70rT738TJG7TxpGkz7sbUa/5//F0xycMZunHuhe8Vz8+gKGxBVsW+2Vr1REj9kNBH
	KBn81mAYYUI5yOtUL1SQXoFgOy7WBjoPwI35I2Zwnu8tNEsGmaWyZfpwSVlGkpg4cAu5Ah
	jAMx0ymIqerpLfdbFaYCtGoIss2cOpI=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 83A31785283
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Aug 2023 10:16:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233962AbjHWIQF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 23 Aug 2023 04:16:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44186 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233683AbjHWIK2 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 23 Aug 2023 04:10:28 -0400
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CF1291703
        for <linux-kernel@vger.kernel.org>; Wed, 23 Aug 2023 01:08:57 -0700 (PDT)
Received: by mail-yb1-xb49.google.com with SMTP id 3f1490d57ef6-d749c6d767dso3916295276.2
        for <linux-kernel@vger.kernel.org>; Wed, 23 Aug 2023 01:08:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20221208; t=1692778137; x=1693382937;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=rJLqtuSY8Q4JsOIrhkva4qpZ1COUpzJk5YEmlnu3Qe4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1692778137; x=1693382937;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=rJLqtuSY8Q4JsOIrhkva4qpZ1COUpzJk5YEmlnu3Qe4=;
        b=
X-Gm-Message-State: AOJu0Yxitout+ee0+CLlGdf4Fx0k3A8KVN5OGKgwzvSG1JmIaSY/hhgG
        ZQRaOIsx7u69iQ91xOhaOXvBH6FnjrCF
X-Google-Smtp-Source: AGHT+IHmLzhXx9Fa4GUjdjoBS4SOnjJQephaFXFqJF/u+jn8YmcxQnmuCxXSlSF/g+QGzs/TzD14WZwnWRzv
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:3971:e84:f508:9a36])
 (user=irogers job=sendgmr) by 2002:a25:aea3:0:b0:d77:d91b:f477 with SMTP id
 b35-20020a25aea3000000b00d77d91bf477mr9631ybj.13.1692778137108; Wed, 23 Aug
 2023 01:08:57 -0700 (PDT)
Date:   Wed, 23 Aug 2023 01:08:13 -0700
In-Reply-To: <20230823080828.1460376-1-irogers@google.com>
Message-Id: <20230823080828.1460376-11-irogers@google.com>
Mime-Version: 1.0
References: <20230823080828.1460376-1-irogers@google.com>
X-Mailer: git-send-email 2.42.0.rc1.204.g551eb34607-goog
Subject: [PATCH v1 10/25] perf pmu: Abstract alias/event struct

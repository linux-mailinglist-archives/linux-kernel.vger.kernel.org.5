Return-Path: <linux-kernel+bounces-143934-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E6FEC8A3FDA
	for <lists+linux-kernel@lfdr.de>; Sun, 14 Apr 2024 03:46:16 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D3E751C20A97
	for <lists+linux-kernel@lfdr.de>; Sun, 14 Apr 2024 01:46:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 33C7A12E71;
...
Received: from mail-pl1-f175.google.com (mail-pl1-f175.google.com [209.85.214.175])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 18AB511718
	for <linux-kernel@vger.kernel.org>; Sun, 14 Apr 2024 01:46:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.175
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713059169; cv=none; b=vEpU1ODTT21dUhAVbRGVTvXbzJmGmk2nqbFnArm9w1Ud7gEehUuOqW0qYHWzJbPF7sY6Kf3B7UR/WRkrZpK6NwyF5iv/FHDdiHyPkgYDwCm5BjtjXmtOS4n3QOmmHMlVbM9DPqcHkQ3gvtZYO/l4i66I8Mzu1uR20azNrend76k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713059169; c=relaxed/simple;
	bh=+8tdVAHdyRe586JIf5zkE3LSCRnS6emafZYVjF4wESM=;
	h=From:Message-Id:Content-Type:Mime-Version:Subject:Date:
	 In-Reply-To:Cc:To:References; b=nvhCQCJahBDcmdOnsjG2P7nSsecPoi6X01HKkIA5HLeY+sROwrNhQdOFd3UwN0K/DAmBIDuxstV1Bd+wEnBkQIOGNxuYCo2+wkUzs+ME7Y5sjyHlfxwqQpF3zKnYIO8oGcbWJ3oeLW8vHKxtRv1npUOrRPhJ8CdMJuPhAdCHXLo=
...
Received: by mail-pl1-f175.google.com with SMTP id d9443c01a7336-1e5715a9ebdso16631525ad.2
        for <linux-kernel@vger.kernel.org>; Sat, 13 Apr 2024 18:46:06 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=jK3qiz2r/OxwhMERN3JhjvI7Srg7jJofsmQrWbh37ew=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW/tlupbAi7xSITK+51djJL5iLczE2LyBYLYczHMTUg7hDCxc+q0/vMxVnrnhwRb9e/GnR85U443TJMeDORuG/4OXytgXWEdgNPHHH7
X-Gm-Message-State: AOJu0YyMrkMeDZMzB15WPDWi9rHMphvATskvZYA6wB9iQ5FTrL7BoM/W
	CCmMynq1Pk1zQ66BpR64XbwdOnx2dMZsaoGHyaFenoBIzklSa9Q84bjp42Q+JEU=

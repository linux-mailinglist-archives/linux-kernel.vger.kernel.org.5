Return-Path: <linux-kernel+bounces-87918-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BA5486DB0F
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 06:27:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id F24F6B23A20
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 05:27:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 33D6152F92;
	Fri,  1 Mar 2024 05:26:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b="ACLJvfjM"
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.154.123])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D56B952F81
	for <linux-kernel@vger.kernel.org>; Fri,  1 Mar 2024 05:26:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=68.232.154.123
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709270801; cv=none; b=K4Ew39DfLr4Xyfo1DOGrfFF7/p9zK++/kVbdz5SvydpxjgS2hY2lcweqxGPHngH3MIcCnUZyAvkV2EDA1GtHJJ1G1La9/02/NFjCb3pAiooRA8DDMIU9arNqstnA2EiIkPRkjPp4akAwxoWdf4dH4FWC1FWGe5zNJV/6vJHAwGI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709270801; c=relaxed/simple;
	bh=W15DX1vzmEuLdvo8sZzgPuPPK8bNTP+YobWeDLc/9Cg=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=kdklZVAyBIGqSDd5zjQyQwmIhn6zSxdHnehsAcHhakP7yJCBAF8nUTPzuib2Rn33twSBLVUoXHpR5MU29LNwvR7RXEtzx1ZuMgkqxv6WKTA1I6FZx67uukmRr1PRKv+ctArFXEY9NnNpob70f4I/+5B/+Q17ZGRKz3OYmNXB8V8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=microchip.com; spf=pass smtp.mailfrom=microchip.com; dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b=ACLJvfjM; arc=none smtp.client-ip=68.232.154.123
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=ACLJvfjMTa+vV9Y9ppxuffUmcJ10l5zw+eEl0ow+7Pfnm3bih5qXJ+So
   ...
   upwp99zqi2rDFO7jfNfC7/01z/zRCeZ5gFA/DSzu8KLpSr/HtzD4vPZOO
   w==;
...
X-IronPort-AV: E=Sophos;i="6.06,195,1705388400"; 
   d="scan'208";a="184324707"
X-Amp-Result: SKIPPED(no attachment in message)
Received: from unknown (HELO email.microchip.com) ([170.129.1.10])
  by esa6.microchip.iphmx.com with ESMTP/TLS/ECDHE-RSA-AES128-GCM-SHA256; 29 Feb 2024 22:26:37 -0700
...
Subject: [PATCH v9 4/8] drm: atmel_hlcdc: Add support for XLCDC using IP specific driver ops

Return-Path: <linux-kernel+bounces-134170-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id ED4CF89AE93
	for <lists+linux-kernel@lfdr.de>; Sun,  7 Apr 2024 06:45:54 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 60FCF1F2350A
	for <lists+linux-kernel@lfdr.de>; Sun,  7 Apr 2024 04:45:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EAC9628F7;
	Sun,  7 Apr 2024 04:45:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=ventanamicro.com header.i=@ventanamicro.com header.b="KlnhA/+2"
Received: from mail-lj1-f171.google.com (mail-lj1-f171.google.com [209.85.208.171])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F0588EDC
	for <linux-kernel@vger.kernel.org>; Sun,  7 Apr 2024 04:45:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712465147; cv=none; b=R7fcuFWGiY3dVp5823yzYTdTf6JgKCoZplk869XHDooinvPoEr+w3L366mMpC+drH3tfdjEjRBrdzrXbImH1Sg0KIbH5Gu4oSpParFX+kbZ07WEbr3wCtWVyX8Kaz6OM6FNelYvs1qdJvOBlHd06vPILnvVfBOgCKW1ATd/kS3g=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712465147; c=relaxed/simple;
	bh=INxIervR3VDxQw8sARKqwRWBD00LGNPMY+fDGaAjOdw=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=e4EG78RudR0WZgiEuUs9PBSo+7aSkn63qsDGG/0JzQZGkNVAej6IXCPZzuI8qQReY9zpM1K9bEvGl55suFPHOeKIaM45qCrrHJdOu53k/rSpr8QJP8dkhD+83DkuKGNiILxSb2nXVe/ypH49qbCcNdKa2k6/OZ/9HcBE/CL8tc8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ventanamicro.com; spf=pass smtp.mailfrom=ventanamicro.com; dkim=pass (2048-bit key) header.d=ventanamicro.com header.i=@ventanamicro.com header.b=KlnhA/+2; arc=none smtp.client-ip=209.85.208.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ventanamicro.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ventanamicro.com
Received: by mail-lj1-f171.google.com with SMTP id 38308e7fff4ca-2d88a869ce6so187991fa.3
        for <linux-kernel@vger.kernel.org>; Sat, 06 Apr 2024 21:45:44 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=+Wx+tvzf/dqR7g3UekoPgNpWDOrGKteh8fMPAcmqeh0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUO3g7c1SNMIIJzcytszGBCW5NCJpq9G16GCEZMTLbwrciurM9PgP/U4G3E76GiWYtpnf7Hy2Iwe4LpGpfMKlnCuHkz4N5afZ9UtX8K
X-Gm-Message-State: AOJu0Yw07fwgrwZVT3tBm4ALfePnLUZG9G17Yo7wvlOhzQsDDuVvg+yX
	W8JMWdaQ2u0XyXt7PZ9qugL3slksROB+Pjv608tNXqFXbegYYjDS62K5ny6B6hvOj7b0FnyaXre
	E87cRlsNQPMqxza0R6T131oPm5dQyFKTeKaBilg==

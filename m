Return-Path: <linux-kernel+bounces-15160-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 17B5A8227EA
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 06:07:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 0E9461C22E4B
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 05:07:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BA2E2179B0;
	Wed,  3 Jan 2024 05:06:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="wfq8tILL"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-yw1-f201.google.com (mail-yw1-f201.google.com [209.85.128.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5309F171C8
	for <linux-kernel@vger.kernel.org>; Wed,  3 Jan 2024 05:06:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f201.google.com with SMTP id 00721157ae682-5e6fe91c706so168098357b3.2
        for <linux-kernel@vger.kernel.org>; Tue, 02 Jan 2024 21:06:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1704258409; x=1704863209; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=KOKdEkjLeRBQo7zj7I/kmtWzdgHbtaYdcUs8CygEMbU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704258409; x=1704863209;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=KOKdEkjLeRBQo7zj7I/kmtWzdgHbtaYdcUs8CygEMbU=;
        b=
X-Gm-Message-State: AOJu0Yw1e0kAn/DQKFBRh1FrOM4kQcSYtYEWXeJ6JsQbAmWjpAPC0uom
	gD7MT9KE/igcWwJ/QTH1sJNAjKaVBLjFLUIUcv8=
X-Google-Smtp-Source: AGHT+IGZ90eKzPvghY86Uv2wppiexoz7YroSiIVBKR7HD+TeAM8/Pqve3sB74ZTnjxbxRxAg70QlQ2hMfzcg
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:e2bd:f1f6:8ea6:8d6c])
 (user=irogers job=sendgmr) by 2002:a05:690c:4445:b0:5de:9c9f:3ee4 with SMTP
 id gq5-20020a05690c444500b005de9c9f3ee4mr9829222ywb.6.1704258409331; Tue, 02
 Jan 2024 21:06:49 -0800 (PST)
Date: Tue,  2 Jan 2024 21:06:11 -0800
In-Reply-To: <20240103050635.391888-1-irogers@google.com>
Message-Id: <20240103050635.391888-2-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v7 01/25] perf maps: Switch from rbtree to lazily sorted array
 for addresses

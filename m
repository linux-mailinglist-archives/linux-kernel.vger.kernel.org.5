...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5A3C279E6D8
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Sep 2023 13:33:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240438AbjIMLdh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Sep 2023 07:33:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36152 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240383AbjIMLdW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Sep 2023 07:33:22 -0400
Received: from smtp76.iad3a.emailsrvr.com (smtp76.iad3a.emailsrvr.com [173.203.187.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6672E19B6
        for <linux-kernel@vger.kernel.org>; Wed, 13 Sep 2023 04:33:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mev.co.uk;
        s=20221208-6x11dpa4; t=1694604797;
        bh=x5etE6hQat85RKwGFWa9VifsFJ9wpy5aUmUk22feDXQ=;
        h=From:To:Subject:Date:From;
        b=ViWS6DQCImwQ9HDJdVZ3EOMgzeH4MMI4oG0kyo/XIY3bLNxfT3+OT/byNKGoXSazt
         uATp1Z6Fj+3JEVZloNwoZSmmBFU6wm0tDQlkmBstitw1dRbjeFJI9ZI/bXMPhUiBwy
         a3n9iNL9oaDV8+Jg65oWVbfQe4tD5QQ327JlPNEI=
X-Auth-ID: abbotti@mev.co.uk
Received: by smtp26.relay.iad3a.emailsrvr.com (Authenticated sender: abbotti-AT-mev.co.uk) with ESMTPSA id AFEC34245;
        Wed, 13 Sep 2023 07:33:16 -0400 (EDT)
...
Date:   Wed, 13 Sep 2023 12:32:42 +0100
Message-Id: <20230913113247.91749-9-abbotti@mev.co.uk>
X-Mailer: git-send-email 2.40.1
In-Reply-To: <20230913113247.91749-1-abbotti@mev.co.uk>
References: <20230913113247.91749-1-abbotti@mev.co.uk>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Classification-ID: 007ec4bd-2574-475a-9bbd-5a4f93b29aec-9-1
Precedence: bulk

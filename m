Return-Path: <linux-kernel+bounces-73582-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 37ACF85C479
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 20:16:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E23EF2848CF
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 19:16:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9C8F276030;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A418B1353E2
	for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 19:15:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708456544; cv=none; b=GH+XZOVHW61Mn+N1MAKjtFLrbRY8opjl+no5aou/laZNuVFrA9RLZjoSvk6u9oU+cqScb+InmXVxAMAUkyDFnQViPmyK96PPIbr+4v/odvx1C2ZtqbwpjXPGp+ZPoa+8Iz/K94K117S8Ui3RMohLsFouwtfeWXulxBShUtUGBGs=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=dNQLK6a3; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-lf1-f69.google.com (mail-lf1-f69.google.com
 ...
 us-mta-78-KhgCjmn4N26yCkEJOpJj_g-1; Tue, 20 Feb 2024 14:15:39 -0500
X-MC-Unique: KhgCjmn4N26yCkEJOpJj_g-1
Received: by mail-lf1-f69.google.com with SMTP id 2adb3069b0e04-512bed4e08cso1506573e87.1
        for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 11:15:39 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ZbYHQyJEJ73mSk/R9gEn8hmKc8A4snzJLSWzAxj1WSI=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX7lKcoCt80LXZulHpBXCRslq0nEdWvATS6XRp6M+iDtx6Jsx5URjZyC9D+wCNjQ2RVaaQ4lmIoQUUL4ithFoT6gOfzkuGU7oT4um+3
X-Gm-Message-State: AOJu0YxPGNb9mQcl0YHhDX6b5LB0V08D4+PLFTqo/Bm+C8HkMAn+Dc/c
	LBncuiDtgFV1OWR5/5CtrR4Y9tyV6TQmXBOMt4WbKcr/7niCREHrApy01zGPMpXSl45B8ZvGVU8
	wQFaEzpCW6fGyNVZWraYbSSvEUhbUkQ/y3FUTtBB9pXc8crUrTvVAkPUoNeM6OQ==
X-Received: by 2002:ac2:414c:0:b0:512:b6b4:739c with SMTP id c12-20020ac2414c000000b00512b6b4739cmr3922163lfi.60.1708456538151;

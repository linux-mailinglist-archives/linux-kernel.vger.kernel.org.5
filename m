Return-Path: <linux-kernel+bounces-84714-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C6E2486AA9D
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 09:59:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id EA86A1C223E7
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 08:59:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AC07B2D610;
	Wed, 28 Feb 2024 08:59:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="BjM0nDcf"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1D9772D05B
	for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 08:59:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709110778; cv=none; b=JcuhmABBFNbwLOtWKe5pk/gg9qfW7hyNV2l7yYIz1VukolNwtVV4JTfMw6oDKZZ8HzrGInBkgPir38F4aihegwjek8l2pg+/dQO7VAzC717S2pPMLcDt06RgWjY4Sh7nJYw4wwCyu2hHdnrhwBHPLVk+UKQubk1B3Zqc/l7HCrU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709110778; c=relaxed/simple;
	bh=f2B3aYaDOG/4YEYRwL/yNRcKHh4/69gUqq0LGGxmgGg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Hh621CJ6bcWt2N3+S9OKingOg5/oOAXt8TYJeF7m3slps0a6zuf3Z/TatYwozSgoUSq3i+u951AsNR4IcZnMnrxwMs1ECXGgL0aQzRbM5Apq+VBm311GrLTLVReR/TOUvta7OIwOgneTtbrbM50HEyBAM8w89p7KzZsZ+MZJh+Q=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=BjM0nDcf; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709110774;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=9H8os75ac9Jvux0cXj/+8cv0eYr9fiP6ek7CbQ62ymE=;
	b=BjM0nDcfWQQz2drXnqWKHEEL/spiDw8aTLe85D7qEOIoXPIWcRTPwVh/K0LoRPfvmVYJ1p
	UxiUPXYlHTLI1lFw9dsjCX2Nwfa8onzg5IAeYOyBPxVmIFD39KPPnFf7/IjITKUVKP4SUf
	iSXGwPABas/icz8Y5nZ4s+BzOkrEKco=

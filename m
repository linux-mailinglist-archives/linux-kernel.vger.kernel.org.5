...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9E6AA80DE21
	for <lists+linux-kernel@lfdr.de>; Mon, 11 Dec 2023 23:26:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345605AbjLKWJ6 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 11 Dec 2023 17:09:58 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39122 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345577AbjLKWJv (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 11 Dec 2023 17:09:51 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B5A2192
        for <linux-kernel@vger.kernel.org>; Mon, 11 Dec 2023 14:09:57 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702332597; x=1733868597;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:content-transfer-encoding:mime-version;
  bh=/ymKimFLSiDeo/NVNz3x/mTKycmLWMpbqiCB7S8EMV4=;
  b=EgITCuyGUBL3/Bgy1IRDlobgb9smYFGvJwDeENmcNOsHLeq2VwMOfO7c
   YHeYv26O2rfGvyo5uCKoD8+MIKRlEQMaCkRiJx6hnKnN9Lt81eWHiqIdT
   GcyQpjxQuXlFvuWKlzPnkIBGbV+pVF/7+c1cio6tKComtOmxGaBQmGn1z
   62sSAy8f9vVQT8LrC4cR/4cJq1vXUT58PctQV5aVGkW+M1oy6FfVpgI75
   XekU+Wcl5sgSH0Ob1vnFXcjZKqoF1xb82feXjuKD18hrUlo8CXhlfhPdA
   p6q5ZItH5VeSFNIpStVj75jdjSF+ArQG4B80scwwdmbnHcH/iNkN+rOeJ
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10921"; a="1865665"
X-IronPort-AV: E=Sophos;i="6.04,268,1695711600"; 
   d="scan'208";a="1865665"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Dec 2023 14:09:57 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10921"; a="776826861"
X-IronPort-AV: E=Sophos;i="6.04,268,1695711600"; 
   d="scan'208";a="776826861"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
  by fmsmga007.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 11 Dec 2023 14:09:57 -0800
...
Subject: [PATCH v3 2/3] drm/tests: managed: Extract device initialization into test init
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Dec 2023 22:09:53.1685
 (UTC)

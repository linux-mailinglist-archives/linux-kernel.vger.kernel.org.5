Return-Path: <linux-kernel+bounces-28950-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 66443830511
	for <lists+linux-kernel@lfdr.de>; Wed, 17 Jan 2024 13:18:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id D4747B21328
	for <lists+linux-kernel@lfdr.de>; Wed, 17 Jan 2024 12:18:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CC2A61DFE4;
	Wed, 17 Jan 2024 12:18:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=NXP1.onmicrosoft.com header.i=@NXP1.onmicrosoft.com header.b="SH6Nqn/x"
Received: from EUR05-VI1-obe.outbound.protection.outlook.com (mail-vi1eur05on2044.outbound.protection.outlook.com [40.107.21.44])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BFD4C1DFCD
	for <linux-kernel@vger.kernel.org>; Wed, 17 Jan 2024 12:18:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.21.44
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705493920; cv=fail; b=dxwMJ6YwPm5Ej82LmivNyOowzWB53QJXD6DxNiodAScjiZoxEpvcof+IzhBEKKym1XDT9gnSc/Zehnp8m/RAMkyXUWIY7g0AcxEUHC3J0/FUOkO+vHMgaO24z0KoihLBgc6goKFagwmO7fDAX0LIVn6qSDytk02xgQkw1QH5s4I=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705493920; c=relaxed/simple;
	bh=2fW8OlSOk66qitKTITHUwyoXzxUrUHaM+NbMMl86c8s=;
	h=ARC-Message-Signature:ARC-Authentication-Results:DKIM-Signature:
	 ...
	 X-MS-Exchange-Transport-CrossTenantHeadersStamped; b=JP+uLi306sfzIGAAOawAd97gFLtWtbj3z88ZxrcpnCITyoOkBZ/Gyw6n+6FFgqhxzTGGX4t98t0KSOVisnxmby3yYAJBTaBdtAtKCf6pKKtbc4g7doPDJPwZMjH1wR8h/f8WaUTI7m6F5BZkW1884O7F0TP8L8lDvZMu6f9Xlrs=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=oss.nxp.com; spf=pass smtp.mailfrom=oss.nxp.com; dkim=pass (1024-bit key) header.d=NXP1.onmicrosoft.com header.i=@NXP1.onmicrosoft.com header.b=SH6Nqn/x; arc=fail smtp.client-ip=40.107.21.44
...
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:AM6PR04MB5333.eurprd04.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(396003)(136003)(346002)(39860400002)(366004)(376002)(230922051799003)(64100799003)(451199024)(186009)(1800799012)(6666004)(2906002)(41300700001)(86362001)(38100700002)(6506007)(6916009)(54906003)(9686003)(66946007)(316002)(6512007)(6486002)(26005)(66476007)(83380400001)(478600001)(7416002)(8676002)(5660300002)(4326008)(44832011)(1076003)(8936002)(66556008);DIR:OUT;SFP:1101;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	=?us-ascii?Q?E8pUvjL45MMwzj0e9sx/MK1I/J2aXmJK9UrsKMYLbJx0BU1HuzveidGn6G0Z?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 17 Jan 2024 12:18:35.3814
 (UTC)

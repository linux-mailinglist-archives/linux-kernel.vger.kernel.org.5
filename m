Return-Path: <linux-kernel+bounces-130651-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 865B6897AF8
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 23:44:16 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A99BD1C2191B
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 21:44:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4859D156888;
	Wed,  3 Apr 2024 21:44:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="IPTADyD+"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4A91218AF9
	for <linux-kernel@vger.kernel.org>; Wed,  3 Apr 2024 21:44:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712180642; cv=none; b=AzAF+puNYZ82TkzyvIcx5mdky7H5YnM1YUcrCZyWLxDWsF2Mz197q4RVxfcUBiP9kpKc3lmw6vaLpw0O5h0EBacwG4tKaCUrnE2DuQYFrMZLdqr2Akd6jxVBSYu7Wk/N4PmfXpRtjc1hm4qZjcMQhFC7mGsL02vomUIp/Lb/tys=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=IPTADyD+; arc=none smtp.client-ip=170.10.129.124
...
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 ...
 us-mta-461-TKTkfv1hPHOXIBCAll1AJA-1; Wed, 03 Apr 2024 17:43:58 -0400
X-MC-Unique: TKTkfv1hPHOXIBCAll1AJA-1
Received: by mail-wr1-f71.google.com with SMTP id ffacd0b85a97d-3435b7d66c3so119885f8f.3
        for <linux-kernel@vger.kernel.org>; Wed, 03 Apr 2024 14:43:57 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DR1VRM2YOLBnde8LCoWidizffjEaSuWiF6q/aH62up0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW4H3uk61cy7pjZG6kcQTRiGmcLkrJHiRvhXrWTEXP++4c7xrkPRXs1H3mGVoC3YOd5ZMfseEH8kDFEngwSQe6gvSeFkhNRbaEFTTRP
X-Gm-Message-State: AOJu0YwiYdq9z+TATiZjGwzM5NBzrCAun9olBoXaD6OiiKlYkSzZCKYK
	0EF7fmxm+9M3irLJIZKfKCSzJnGsnhXN1Y3gwOuTr5suqv/UkjjVyJG/DmjbLYaG9Rz0Yw0SmUJ
	Aw8EttP6Mjydh12kNqaoSQChd1VK0gRcheMZyojJ14at0pzoJ3Fld/Jfl2SnE2w==
X-Received: by 2002:adf:f144:0:b0:343:7ed6:765b with SMTP id y4-20020adff144000000b003437ed6765bmr526511wro.39.1712180636810;

Return-Path: <linux-kernel+bounces-16071-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id DB8E9823832
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 23:29:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 51D9EB23CB7
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 22:29:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7E3E220327;
	Wed,  3 Jan 2024 22:25:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="Dg/ZI1fy"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-qk1-f180.google.com (mail-qk1-f180.google.com [209.85.222.180])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1F72A2032A
	for <linux-kernel@vger.kernel.org>; Wed,  3 Jan 2024 22:25:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-qk1-f180.google.com with SMTP id af79cd13be357-78117e97becso712858785a.3
        for <linux-kernel@vger.kernel.org>; Wed, 03 Jan 2024 14:25:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1704320725; x=1704925525; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=pvdCefuqeD1M1vvktVY3dMHSvMdGsyjSHgAnJ7o2QHg=;
        b=Dg/ZI1fy12EZWa3Dg97cMdw4z86/DEo6tVzKiv06cCAweGJQoab//OpA0eMTGplpKe
         QjAVh3od4tRPWpyCTT4zstoLsZrzKKpKVnfAqLovAru/zLE18Cg95tXConvVWuS3/saG
         9rMnQ+3lirbYq9CWB1Yc+6XK0g03FpXJ9B2zY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=pvdCefuqeD1M1vvktVY3dMHSvMdGsyjSHgAnJ7o2QHg=;
        b=
X-Gm-Message-State: AOJu0Yyvqk2ZLGXa64FlfsdenZoeQUAorj5chc9XdaZ/dPHNDKgej1P1
	1wKb80pZSvK44LCPIRKwmlNimZ2cfgJt
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="0000000000006a9a31060e1217e3"

--0000000000006a9a31060e1217e3

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5E5C97FAD3A
	for <lists+linux-kernel@lfdr.de>; Mon, 27 Nov 2023 23:16:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233404AbjK0WQr (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 27 Nov 2023 17:16:47 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43996 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233711AbjK0WKV (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 27 Nov 2023 17:10:21 -0500
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C00281FE7
        for <linux-kernel@vger.kernel.org>; Mon, 27 Nov 2023 14:09:59 -0800 (PST)
Received: by mail-yb1-xb49.google.com with SMTP id 3f1490d57ef6-daed1e15daeso5780295276.1
        for <linux-kernel@vger.kernel.org>; Mon, 27 Nov 2023 14:09:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1701122999; x=1701727799; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=CftX/1r0rIaPLpzJmFDw1qiY7uQQ2dJF/l5A87og7iU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1701122999; x=1701727799;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=CftX/1r0rIaPLpzJmFDw1qiY7uQQ2dJF/l5A87og7iU=;
        b=
X-Gm-Message-State: AOJu0Yzco3LqEzLFy9AtROdbNx+iFJEGHrpRaDdNHx0obFE4HTl1e5Qd
        VdJyBM/gntzblRFCB47CxWOyZLJHgkFy
X-Google-Smtp-Source: AGHT+IF4dXaRo+/kWdzxB7L7hJU49KFfZCB8PmZOi7bzt/sXgBhb7HF28yKgKScWa8gTXQliE9YKmZLxEmfP
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:829:6e77:9093:f39b])
 (user=irogers job=sendgmr) by 2002:a5b:f0b:0:b0:db4:5eed:8907 with SMTP id
 x11-20020a5b0f0b000000b00db45eed8907mr374977ybr.8.1701122998686; Mon, 27 Nov
 2023 14:09:58 -0800 (PST)
Date:   Mon, 27 Nov 2023 14:08:27 -0800
In-Reply-To: <20231127220902.1315692-1-irogers@google.com>
Message-Id: <20231127220902.1315692-16-irogers@google.com>
Mime-Version: 1.0
References: <20231127220902.1315692-1-irogers@google.com>
X-Mailer: git-send-email 2.43.0.rc1.413.gea7ed67945-goog
Subject: [PATCH v5 15/50] perf maps: Add maps__for_each_map to call a function
 on each entry

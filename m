Return-Path: <linux-kernel+bounces-69812-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 36439858EDC
	for <lists+linux-kernel@lfdr.de>; Sat, 17 Feb 2024 11:56:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CFABD282378
	for <lists+linux-kernel@lfdr.de>; Sat, 17 Feb 2024 10:56:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CDDBC58AAB;
	Sat, 17 Feb 2024 10:56:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (4096-bit key) header.d=alien8.de header.i=@alien8.de header.b="FcYYcDzy"
Received: from mail.alien8.de (mail.alien8.de [65.109.113.108])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B3F035576D
	for <linux-kernel@vger.kernel.org>; Sat, 17 Feb 2024 10:56:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=65.109.113.108
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708167387; cv=none; b=UM/GnwRutCEZzJ72PSOCw4SkD2006V7YHrK68w7Z6rzeFMLPEOAgJcILtHFUE0VYcts09yqe0VtEB5jLiKMG5b87IAIZgMPZFr98jJayzenWsmUJT92WUyCueT5k8rj12PkX3zwUEJZPPSufvJXGCFzOKUnaitSIGLGE3wGtghc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708167387; c=relaxed/simple;
	bh=/GPWLbUKOEpsGMsWC30JOVRBpAvCc793Y+hSitmuDIM=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=n5QKiN2oqMPBDfQyN64duSH/em/OuCJJnKVZXBe7XQizhQeZl8GU4S9w9Wa6T9JCiBK0UIZ9lNNyhuf66ZUS+n+1OtObydkR/IIhYFHXDstYVfqDuZ0tZOo2VVwI/S/Wagm9j1jVLTEm4mOC0fx9MycfLry1jxKBAGelnHTcMXo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=alien8.de; spf=pass smtp.mailfrom=alien8.de; dkim=pass (4096-bit key) header.d=alien8.de header.i=@alien8.de header.b=FcYYcDzy; arc=none smtp.client-ip=65.109.113.108
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=alien8.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=alien8.de
Received: from localhost (localhost.localdomain [127.0.0.1])
	by mail.alien8.de (SuperMail on ZX Spectrum 128k) with ESMTP id EAC2040E0196;
	Sat, 17 Feb 2024 10:56:14 +0000 (UTC)
X-Virus-Scanned: Debian amavisd-new at mail.alien8.de
Authentication-Results: mail.alien8.de (amavisd-new); dkim=pass (4096-bit key)
	header.d=alien8.de
Received: from mail.alien8.de ([127.0.0.1])
	by localhost (mail.alien8.de [127.0.0.1]) (amavisd-new, port 10026)
	with ESMTP id KjCH_bc9jZbK; Sat, 17 Feb 2024 10:56:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=alien8.de; s=alien8;
	t=1708167371; bh=SgPUoAjoaqIpnj+Zx5HDlESoeDJj0Am6etPEREuP1JI=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=
Received: from zn.tnic (pd953021b.dip0.t-ipconnect.de [217.83.2.27])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange ECDHE (P-256) server-signature ECDSA (P-256) server-digest SHA256)
	(No client certificate requested)
	by mail.alien8.de (SuperMail on ZX Spectrum 128k) with ESMTPSA id 0DB4040E00B2;
	Sat, 17 Feb 2024 10:55:49 +0000 (UTC)
Date: Sat, 17 Feb 2024 11:55:43 +0100
...
Message-ID: <20240217105543.GAZdCQr_nosDP4tGuO@fat_crate.local>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="CjagdcG4nq1oojV+"
...
Content-Disposition: attachment;
	filename="00-14-04-randconfig-x86_64-26892.cfg"

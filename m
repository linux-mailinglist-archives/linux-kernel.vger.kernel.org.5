...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7B9C976B240
	for <lists+linux-kernel@lfdr.de>; Tue,  1 Aug 2023 12:49:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233806AbjHAKtO (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 1 Aug 2023 06:49:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56844 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233553AbjHAKsN (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 1 Aug 2023 06:48:13 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 96DDE2D7B
        for <linux-kernel@vger.kernel.org>; Tue,  1 Aug 2023 03:47:24 -0700 (PDT)
Message-ID: <20230801103816.692336580@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1690886836;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=O00kb3ANDLPAWttSm0Yl7DwanzSJODjrzlZY67TMPn8=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1690886836;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=O00kb3ANDLPAWttSm0Yl7DwanzSJODjrzlZY67TMPn8=;
        b=LkvIB8qtIguA612odVwGu7nJYjleC1Ou/Yy4NJRnMHtM94erB2N2hL7KLPiHgPh77/btEK
        VkYN8AYiDGu0mJAQ==
...
Subject: [patch V3 28/60] x86/apic: Nuke empty init_apic_ldr() callbacks
References: <20230801103042.936020332@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Tue,  1 Aug 2023 12:47:15 +0200 (CEST)

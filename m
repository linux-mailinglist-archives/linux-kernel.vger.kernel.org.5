Return-Path: <linux-kernel+bounces-84708-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id C0A3386AA80
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 09:54:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 35F911F24799
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 08:54:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2D9E6364BF;
	Wed, 28 Feb 2024 08:54:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="XTLeJ4iP"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2656E364A7
	for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 08:54:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709110472; cv=none; b=uYlXMY6ld16bW3KBdLzMOM8VxgWB6Tw9QLLIjphy5iiWkG0xy+GZCN3/Kr+8KH/tKQrbpfSroU7PkmvvTXHVrpeAlBwn5x4O4yDHROXCnrDiewDo059JOanJ/sinBi4KGUacEPeBdG32ONTVpJlcLddwI3ctPSlQMMkrmKxfgDA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709110472; c=relaxed/simple;
	bh=k9xQ9gyFBqM0jOPNTgkk2dohGIFubZOnUiZ6ybrNQGA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=GQWot3NHxeJ50zuCKMaphXRRllgmhGU7Bx+BaYDnUS2KjH1Jp7z4jNzyitEO/MZdWpEak4N0iJZIvwOWjgl6iyJcFy32/grvKH9ahQYAUvZnoG/QI1lG2TeDU+8gi9jTkggH2XfVlhthqGj4AL4pcrrKYZH9KYPO19O8XlgjlJE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=XTLeJ4iP; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709110469;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=Og4a52RoUuRZscj3oOT0GdN/Kljq91RnUZKsUguMxu0=;
	b=XTLeJ4iPK9cIogKRKVl1f7xNUJ2c7z6Vqm/uAZUke9sS2x+iQT+NgUVHktKHu2KU6FnCfV
	BV+YmIg8p79a60sctWOllKCx8VEGJ4/XNn9MiYMqt3fbF1LceNhq/5Gc8y2fvf0IQQke4L
	CwrYuxGr2V4P1ZwfchMFXp/vz8njOGg=

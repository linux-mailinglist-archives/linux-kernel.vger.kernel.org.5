Return-Path: <linux-kernel+bounces-133326-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 05ED489A241
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 18:15:28 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B06F7283563
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 16:15:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C61D917109C;
	Fri,  5 Apr 2024 16:15:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="HFAeheJu"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 539CE171075
	for <linux-kernel@vger.kernel.org>; Fri,  5 Apr 2024 16:15:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712333715; cv=none; b=Xo9xhp26x6bbM8jEryVld3dhaJWa7YqwYrsqLvK3EipZkqkoFOPg+Qs6ULVUePoICl48c7p/aYGJEUa4t6ebp45sBibb1mTK1RCQve8Nyu2kR256VAnz0JC9vmD1tfRI59LM1jwyqYrulbuAbPEyzlWGWvVqYqWu4HNbUlbuyHI=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=HFAeheJu; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1712333713;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=e3uyJWTox08bgDQO6QMdhD99Thi4BOyEc7+yAlbzlMM=;
	b=HFAeheJuwQnDbUCoPvckCwh2PvcRZVlGgSy2O+sbco2GucBHVkdzGbkDzrIv48ClK3nXeH
	A1aXn+kFB22dDBvBGiDU4EgDSROoAxdBb5MtlhGhLZJAeqBOMjr24gfFB/GwHwoBYkzaRO
	Md7ogCA0MV+uRduByTVr20nLCH3R0Ug=
Received: from mail-wr1-f72.google.com (mail-wr1-f72.google.com
 [209.85.221.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-209-sTbET7-QM0Gg6pSyTBBwng-1; Fri, 05 Apr 2024 12:15:11 -0400
X-MC-Unique: sTbET7-QM0Gg6pSyTBBwng-1
Received: by mail-wr1-f72.google.com with SMTP id ffacd0b85a97d-343c8e87a74so1159273f8f.0
        for <linux-kernel@vger.kernel.org>; Fri, 05 Apr 2024 09:15:11 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:from
         ...
         :message-id:reply-to;
        bh=e3uyJWTox08bgDQO6QMdhD99Thi4BOyEc7+yAlbzlMM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX5l/6Jg/o4ZniuE4JpLDr2IKYjCBVxbjj2dp40lulfHqRQ3r7FyDG2FFAck0txJfV//PoXjkiSUZyDV9flXSI5JWt9TUXOgibzjnSh
X-Gm-Message-State: AOJu0YzRB/sT6mXsS+pvhkk8iijMQquT0CjOFvT71xyqiKPFMRZ6FUQm
	hAddCK8kUJfDXznJmBHVvbR7ytG5AI4GwcUEEnBBGHG3giflSK+iAeLSMvJ5KOhn5DfBvfAMi3d
	f8OKLtJ78PBjE+hy/khEwntVF7D1tkGLRp1SdQrX+3abhX/c6LR0daCdcgS9DAOtFtcpSgw==
X-Received: by 2002:adf:fd91:0:b0:343:a8cb:7990 with SMTP id d17-20020adffd91000000b00343a8cb7990mr1723880wrr.29.1712333709172;

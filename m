Return-Path: <linux-kernel+bounces-79350-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B362862111
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 01:13:42 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5F2061C21015
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 00:13:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5E24EC133;
	Sat, 24 Feb 2024 00:12:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="RkyT7ftZ"
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 29FB78C1E
	for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 00:12:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708733538; cv=none; b=QO18nLxROFIcY11Xk6ITBbOtVQ2MaKxV1bOgH4027i87WmT3J7wUTqfW14lyuMQdElvF7fuhijRiPPxolSoSRUcW7VMTW2ax1SItSx9hcC1PlgMxom/cQXRLC1/05MOpFTjqMHs1ZbWNeutnpovqBpWH6bXXZkJLpMqf9u+fKT8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708733538; c=relaxed/simple;
	bh=cDru6YFwiqSwGLPb6WM8HxrZU5IasRlJDey6XS2L7mA=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=Rv9GIB7OcLN9taMXBAUt+AUR5GUTsmrLY3i9ThKZd8YiLj3I6430jiM5xiatrVNjR5ihK4q/oOxYjuVdrNp+zwXzPK/5EXjeAcs146swyBkwBW0JP9sucm+B1NoUJKlw9eqv6Mzu6HcxE/rHkKQRfvcLaxZZ/LzBVbEA2aPZyE0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--jstultz.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=RkyT7ftZ; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--jstultz.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-6047fed0132so21201347b3.1
        for <linux-kernel@vger.kernel.org>; Fri, 23 Feb 2024 16:12:15 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1708733535; x=1709338335; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=HLDw6CquW3kHDltZofc4BI/Dj8EvwP77wlptMXHUSkI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1708733535; x=1709338335;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=HLDw6CquW3kHDltZofc4BI/Dj8EvwP77wlptMXHUSkI=;
        b=
X-Gm-Message-State: AOJu0YxQ75V84Q7QJN0QgWwPPTjxlOWnW3sQfZmMfshH9oi25n9yHvKJ
	9SBbA46pY60nxO4X/NNLq3h0x8pUfIoeyPh7+LC1aUzMKfjM+HtMtlGXgQURnenFuFut6h6G6a5
	e835HRZHzg3nawOnHfgKPIpAYJ/p2uP36+ml2kmAhQO9YY26PUo2yDiPoPD2uP53ppmltFMn4sK
	tqg62EPYjfAw6TE8RygPeGTBkYs9Jy5dTr0giwvb7X6k16
X-Google-Smtp-Source: AGHT+IH/f3b741b2mK/lFxGGiydJLg2VPo8pYAWeE58VAqW6JRJsmHtud7UUOfKb4ZmjTQ7p7w29ZYN5RiG6
X-Received: from jstultz-noogler2.c.googlers.com ([fda3:e722:ac3:cc00:24:72f4:c0a8:600])
 (user=jstultz job=sendgmr) by 2002:a81:9e13:0:b0:607:83bd:bea3 with SMTP id
 m19-20020a819e13000000b0060783bdbea3mr271468ywj.10.1708733535092; Fri, 23 Feb
 2024 16:12:15 -0800 (PST)
Date: Fri, 23 Feb 2024 16:11:47 -0800
...
Message-ID: <20240224001153.2584030-8-jstultz@google.com>

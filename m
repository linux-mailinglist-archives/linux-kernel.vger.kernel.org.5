Return-Path: <linux-kernel+bounces-31081-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3A0C3832891
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 12:13:44 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id DF5AE28864C
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 11:13:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BBB574C617;
...
Received: from mail-wr1-f54.google.com (mail-wr1-f54.google.com [209.85.221.54])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3E16F4D58B
	for <linux-kernel@vger.kernel.org>; Fri, 19 Jan 2024 11:11:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.54
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705662718; cv=none; b=gtyE/ewSd4ywNgk4Na+wZYYhJ+M3wXh2Ei49rUAeiz+rnjbSyEeOz5/ue8Xg4nvpeCD2lOs72ihZWXKagQlzE+k1IMal26GIeur2KVMzfTX84TQQZFvHJSRRo8l1ugjwaCRPLUp+2Ir02kW43FWSkCy8GZaw3HVrXAKDneAYf3g=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=Bsax9cj5; arc=none smtp.client-ip=209.85.221.54
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-wr1-f54.google.com with SMTP id ffacd0b85a97d-336c8ab0b20so568398f8f.1
        for <linux-kernel@vger.kernel.org>; Fri, 19 Jan 2024 03:11:56 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=tDx9IJeu4q4vg7sxnjP3+o90/kYREKpXEiMwOte9XSc=;
        b=
X-Gm-Message-State: AOJu0YwUnp3C19fdHAIFa6xAaj5lfxN9+1C4yYonFHQ11QR3Z6rLC5RZ
	0eWPFjUmz3O/mM2pEeckOc3bbEk7K+W6vMp1Of7dITnjJmzgeI9ZtkNJiVPTAlE=

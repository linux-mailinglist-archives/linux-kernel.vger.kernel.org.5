Return-Path: <linux-kernel+bounces-34967-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F1FD8389FB
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 10:10:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9E346B215DF
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 09:10:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EE1DC57878;
...
Received: from mail-wr1-f54.google.com (mail-wr1-f54.google.com [209.85.221.54])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B4406EEC2
	for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 09:10:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.54
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706001003; cv=none; b=L120kCeKLhT+QGBVa/v7evmSZTDjCtrEXfUAMzGxGlE63UssDto6u8sqKdujDxCvsVs8rXYAA/lpfu3pmvuQ6Ht9bLUL4dt/iCa6IOqTLZHq30CdmeWTcEwYktyzetG9BiaVHCUTuokg5ESMxdRkvIE6j+cbIcoFUPqxfEBFrbk=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=TRxKOzwk; arc=none smtp.client-ip=209.85.221.54
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-wr1-f54.google.com with SMTP id ffacd0b85a97d-33922d2cb92so3641088f8f.1
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 01:10:01 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=G/HqiW9cuoCgRPzOrcA9BJqfZ68FEkgWUe/8BGsgIpk=;
        b=
X-Gm-Message-State: AOJu0YyUf01BuBEs9C3CBZbqz0Z5MONLJzLmz8PCCifH1hh0jHfdjqJY
	qXRFKV8lOdpJsPfIvhogZoJhFWbuGjA1JbXe8Rr7Jz21JgjWQsx2aFppWuKVlA8=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CB4967A6ADB
	for <lists+linux-kernel@lfdr.de>; Tue, 19 Sep 2023 20:48:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232413AbjISSsZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 19 Sep 2023 14:48:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34976 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232084AbjISSsY (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 19 Sep 2023 14:48:24 -0400
Received: from mx0a-00069f02.pphosted.com (mx0a-00069f02.pphosted.com [205.220.165.32])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D622F9E
        for <linux-kernel@vger.kernel.org>; Tue, 19 Sep 2023 11:48:12 -0700 (PDT)
Received: from pps.filterd (m0246627.ppops.net [127.0.0.1])
        by mx0b-00069f02.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 38JHxJqa030302;
        Tue, 19 Sep 2023 18:47:46 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=date : from : to : cc
 : subject : message-id : references : content-type : in-reply-to :
 mime-version; s=corp-2023-03-30;
 bh=c+29SgSbG4a4Yz36+irk8/TzITImhExZqInmdTtY/FU=;
 b= 4Q== 
Received: from phxpaimrmta03.imrmtpd1.prodappphxaev1.oraclevcn.com (phxpaimrmta03.appoci.oracle.com [138.1.37.129])
        by mx0b-00069f02.pphosted.com (PPS) with ESMTPS id 3t52y1wq92-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 19 Sep 2023 18:47:45 +0000
Received: from pps.filterd (phxpaimrmta03.imrmtpd1.prodappphxaev1.oraclevcn.com [127.0.0.1])
        by phxpaimrmta03.imrmtpd1.prodappphxaev1.oraclevcn.com (8.17.1.19/8.17.1.19) with ESMTP id 38JHS61Y027037;
        Tue, 19 Sep 2023 18:47:45 GMT
Received: from nam04-bn8-obe.outbound.protection.outlook.com (mail-bn8nam04lp2040.outbound.protection.outlook.com [104.47.74.40])
        by phxpaimrmta03.imrmtpd1.prodappphxaev1.oraclevcn.com (PPS) with ESMTPS id 3t52t6aq5q-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 19 Sep 2023 18:47:44 +0000
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=c+29SgSbG4a4Yz36+irk8/TzITImhExZqInmdTtY/FU=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=c+29SgSbG4a4Yz36+irk8/TzITImhExZqInmdTtY/FU=;
 b=i6XhKgZvBSUdqxK+UR4EKidVY5OFUVpVGoGVpVOLNvV0a7To7oRfBFB14WYZP5tdrVVGCzaZNW77wvqV+PfeSsyq8s39csm1REJBF5d+WE0CF1vRisaO/xON8eyZSQ8FXaTrgJMxE3A9gv8qQ+1u0z/gUQmB0xRSdSxnioBXdDs=
...
Content-Type: multipart/mixed; boundary="2oPkYGMTbURfIGF4"
...
X-MS-TrafficTypeDiagnostic: BY5PR10MB4196:EE_|PH0PR10MB4550:EE_
X-MS-Office365-Filtering-Correlation-Id: a0ba1596-f536-47af-e489-08dbb940e321
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BY5PR10MB4196.namprd10.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(7916004)(346002)(376002)(396003)(39860400002)(366004)(136003)(186009)(451199024)(1800799009)(54906003)(316002)(66476007)(110136005)(66556008)(66946007)(478600001)(45080400002)(38100700002)(2906002)(30864003)(8936002)(8676002)(4326008)(41300700001)(235185007)(86362001)(5660300002)(83380400001)(44832011)(9686003)(6512007)(44144004)(6666004)(53546011)(6486002)(6506007)(1076003)(26005)(33716001)(33656002)(2700100001);DIR:OUT;SFP:1101;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?us-ascii?Q?S0fX5NY0XDJg1SrDAdPPhgJ6cfKr7vFz9IIQ7vLWTIcqKG4/Cgb6zYWKYXcK?=
 =?us-ascii?Q?Fvr+G5YGunyhlRtncgtVDR/SO/TcKCe/x9j45PROeMEFAwjMqjviU70M5KDT?=
 =?us-ascii?Q?53F7b2yRUoMaUSzyKqcVMFe4jeCV8SDwJDqDCHn6QcgSRSlbEVnN59wyf/m7?=
 =?us-ascii?Q?9+EDP60Irf5se3dWqZ/GDh2voLWK4bEQeIp8UUqohXilE4bqD8z8Q70Yu2JY?=
 =?us-ascii?Q?C4PbFaap2TE5aYKcfactUfy6H7aKzyz6rPwoLxkAlsomfCi5js5Z+uUS5nLI?=
 =?us-ascii?Q?B/FG+JboDcncqmj7l9vB91GqMEhY1wJiDX2eTvSCBgRsqvVkAgzOU5Xg+9yw?=
 =?us-ascii?Q?DMXLmSizukgUc94fPYC1/SeJMENXSSTaNlptPXJ9/Eo6Mfk6h16bJjgx95qP?=
 =?us-ascii?Q?aNkOpa6/Y3pqF7H/xfyCbC2wLQcRIPWBBuFjB7/NEjG2aOsk3F4AI62rB6FI?=
 =?us-ascii?Q?24tuy7co3ghL2ZdF8wS9hCEF9Mqkh5Q+ZIjC8JqW5TpFxVBfAuFwZG1yqsRb?=
 =?us-ascii?Q?lsmtMm6WQWxj8jBkpBoEAfqSK3pKvHndX5WuvuFpYJb41/hdE5oATWH7Wxcp?=
 =?us-ascii?Q?eRGR+0apIQGXyQDXv+OLLK+ulfaAWY+PF10ITeeCAuUObNemoyUcXprOtwoZ?=
 =?us-ascii?Q?9eWFuxxItHi0LgrEnFYD1XeY5xWRLzetyVe1Phl5hdMnGzsJ7j/UzNCvAGJZ?=
 =?us-ascii?Q?uch+0qlsgXk2lWf6/4O6u34Ho0FM/Zu+PdeGEiEkDoFQ+9LPOwMUo2YpGCoj?=
 =?us-ascii?Q?J3itS0gUp/ZEnFvX8MS3+Kl490N+xm6Oe/hDnIYQGuncMzJGvQSlCMn8qnhE?=
 =?us-ascii?Q?kbdeXCEI+KX2hKeFWAYAoix8i0TEZu2fPWL1lpdOoG7JqLFJ8yPI8clJsk63?=
 =?us-ascii?Q?IsdHFKnNT3flgUuYq3Ws9W3IUqKUMzHvoDaduT+Xyx4gdKMr/vWqK3ExboV1?=
 =?us-ascii?Q?uQN9+gU9zyIvLCUQjwzbAp1xxPhIItxdHvBug2Si2wLRzVWHOdMnzd0gwl+W?=
 =?us-ascii?Q?0Yl1klRNJjBjoFsCJjL7AWm8Bob5ofaL33YvhJCQCOsWIYV6mMe1v+xkcf8U?=
 =?us-ascii?Q?K6AKnsFEPvwwtcIIjg3Qis5xbTi/q90I2JwMwmcsQUQ1khcSU9xMI3VLfvh4?=
 =?us-ascii?Q?usiAy5UVjKZwLQ/Qr0q4cCdi4vN13HDnuuE3xO+MCM0Zd+K1n66Y+4pq2SFU?=
 =?us-ascii?Q?bNVTl7AdbtcAFaM46oZ8vxVYumiXJ7Po8IbOkxLg0iQ6BDuh29T5yiyWDL+s?=
 =?us-ascii?Q?1cvNmKx9lddIvNZWqrRrjLyyfwKZZSoA5qNNgjZtLFbA+X/bU+d595eIcpM5?=
 =?us-ascii?Q?hbBQG2lzHJf0Rioa/u6WX0UZUxLEpSEfTVDrdbPDWvgYFySaOliNJiTZ6NoG?=
 =?us-ascii?Q?wLldFUHs14OZ4ZnojDBBkHG9DCVSSamP+VnkFZByLduDvoMTC61dAgTpytLU?=
 =?us-ascii?Q?WmsoMAA0rHjY2U+9LXJ5eD60q9k0pSwE6doi8M8yjZM/7+eAuo5d3XO80x8t?=
 =?us-ascii?Q?pfLbuF5gICvZfg5PqcUaty6edEmSHFNhKasky8+9LLk3t1pyTjXO9ANeMlJN?=
 =?us-ascii?Q?BLzMRxPWG8ksW6ocxh8GiJXZQqKXNj5fvVxEYwz7fd9inY7VbuzEIPBYYFY8?=
 =?us-ascii?Q?2g=3D=3D?=
X-MS-Exchange-AntiSpam-ExternalHop-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-ExternalHop-MessageData-0: =?us-ascii?Q?vRoZWXnqbtK9mtWxRLP+rio/nEoPyPtmJWEAbSDyqMzyLC5kwz7nMy/c90LP?=
 =?us-ascii?Q?80lChViqD4BUAUyeyUZpZuhI4dIhizQP8USJwwJ3RvQZiQttWV4ho3EfAywK?=
 =?us-ascii?Q?4sgbtEvPUvygV3kXNnQXi27+JC/8XPIwb6oAFxMUSkz5INTB+XSeL0RgOGk6?=
 =?us-ascii?Q?2yWF+iHJssiTD+D2HcAUoCkwikUKK0r7la6GdcRuq6Jsde3FWJ/koQJMwi/Y?=
 =?us-ascii?Q?+WAEczKeXzcTshD/uXu7DeFr/5LgLndB4r7KOEd0ynxmB7WnhwyfRKR3bvF4?=
 =?us-ascii?Q?b6b5iuuja2VS1GaXDjmDm4/v2eoMy5PQg9vuxiWwOuKtfuztkIS3i8C3xXrb?=
 =?us-ascii?Q?XuxEQxyGc6ZJ1zfYzFMM4qwDlQMnHHisVwj+XgR137mEQI67p2TXq2p0huIi?=
 =?us-ascii?Q?a4zd1wuPSYlLYNfbDK2nfrMSUBd5wtb1tp58oRAeFuQP84+UVIEhRa/a+FTb?=
 =?us-ascii?Q?WRVjwGs91Z9aeOC+KDbk6iEuFWahCaCIBbVfGG1LAj9c3z45YFefO82p+cyQ?=
 =?us-ascii?Q?mNixxTcYnJF29+CkA68FimMcW6HWFCOHWMVsLYewrklFcEzzt3UnY8neqHRY?=
 =?us-ascii?Q?17IxdjuSR7PMEyf18HnZCPOSRMmLTyNMAR4/680OTSqwGCShGLipLb27LbQD?=
 =?us-ascii?Q?QqctlefPP/WIlCxozqDQXFDJ80q5lTbw0T9T/xwYNo3RFBuy/ANoa2HL0fbc?=
 =?us-ascii?Q?1gm5uljoM2JPgB0R7JEt62fov+VQHgR7Syckh+CQv3sWrNcCCsww1lCUHj0Z?=
 =?us-ascii?Q?dj6cKSdtKWgqy8V5TeOhc+0ELpZ8crMnx7qAXG9P1GutfuQAGmYlE6rZuIf0?=
 =?us-ascii?Q?rZhsg3AxRWiodDILsbO6B9jo4sULLKMWNTKXZclv6d+d6YoexdoDnGlL5Sau?=
 =?us-ascii?Q?ILDfpMui8a2ZwpbEwzX5VNnpYGzEkk8mVa3s3FRtLhIavG5kCAIiOGfXXbG8?=
 =?us-ascii?Q?G4AOraX5hYZJO7dmpMSfPieWH812/DeyX2B+GkMFuzr6wZWljHTsL2FlncYH?=
 =?us-ascii?Q?S343?=
X-OriginatorOrg: oracle.com
X-MS-Exchange-CrossTenant-Network-Message-Id: a0ba1596-f536-47af-e489-08dbb940e321
X-MS-Exchange-CrossTenant-AuthSource: BY5PR10MB4196.namprd10.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 19 Sep 2023 18:47:35.7814
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 4e2c6054-71cb-48f1-bd6c-3a9705aca71b
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: GXl3tiuvsFrju3L9RMfPSb8VmxE86t4ph5C2Q9XL9taflnQ0egFZN8X0gY9x3cHwFUn2K7/IjGlgSUHykbzB0w==
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 suspectscore=0 spamscore=0
 ...
 engine=8.12.0-2308100000 definitions=main-2309190161
X-Proofpoint-GUID: pbFGbdQaCX8EPKDdh-IJ21sHc7cFxPsC
X-Proofpoint-ORIG-GUID: pbFGbdQaCX8EPKDdh-IJ21sHc7cFxPsC
...
--2oPkYGMTbURfIGF4
Content-Type: text/plain; charset=us-ascii
Content-Disposition: attachment; filename="mike.config"

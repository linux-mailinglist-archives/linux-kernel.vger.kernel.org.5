Return-Path: <linux-kernel+bounces-42441-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 34E03840167
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 10:26:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5A2ED1C21E01
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 09:26:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B0BE758211;
	Mon, 29 Jan 2024 09:25:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b="CIr3rydu"
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.153.233])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B368E56770
	for <linux-kernel@vger.kernel.org>; Mon, 29 Jan 2024 09:25:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=68.232.153.233
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706520303; cv=none; b=AaQb6bC9cRF7gTwB0SvbjutaBrm341cuZilpHyT87a08opRMmsL8Fpu+uo7LmTTtGVtuGJGT1IkmofSaEU3MzBQoQlL6PRAj1b6B0W7SaeaqYfdlAnnqDAI5Gn2pSrMawDndkDbz2W2TkrJ58hIXAZvE6JsSLwcr1/sWlI2CHAE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706520303; c=relaxed/simple;
	bh=bMLH8QPee/+gM2VeIcB/JqpqJ+1vYWPcOSAtFvz7oJM=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=cZVw8ndgZKkZdMzl8SLhjjG3I16eD6qJySo21Xr/QsWZbxtrXHBeB4HzjFXS2n5FUiIlBXbJjLsgGMOibBpt5xagYosOGKQoMMcoQdPW7myPcfJ3H+5uuXMGQZrfKN6Ga7rLL7IssG0w2Oznymye2Y2r3c3FkUOD7W9tXCixCaM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=microchip.com; spf=pass smtp.mailfrom=microchip.com; dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b=CIr3rydu; arc=none smtp.client-ip=68.232.153.233
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=microchip.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=microchip.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1706520301; x=1738056301;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=bMLH8QPee/+gM2VeIcB/JqpqJ+1vYWPcOSAtFvz7oJM=;
  b=CIr3ryduNnBtmbP05k6vapn2MC3BnKsaSWW1iq1lIfOQQp2ZHrAxt7g9
   4VA1lG+0mQ92HMpW6exb5M1R7wrCQo+KlKSRcemtQAM43kt/GuEt+KaCN
   Dh8k+G7KFLaZTnteHqCoOANS6OlkDyVFQLA7qVGx6N4QPr5WxejHV0p1E
   i3LrrctJ+delPy9T00MhvdycIozUhQvF+Tbmg1NOPwL8QBz6aUikvntyI
   Uj9z3gVs1+VyceDpbuYCYbyimc50NgX1oJMRdHDv+W1WNtueUlqSQDg2i
   2KkFB5DMJP5RrTAjgpx3ew4S8pP5p4YNbbf56hT/4qgDV/p4fDtz05gXd
   Q==;
...
Subject: [PATCH RESEND v7 4/7] drm: atmel_hlcdc: Add support for XLCDC in atmel LCD driver

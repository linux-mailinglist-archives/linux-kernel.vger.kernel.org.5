...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AEDE77E1A34
	for <lists+linux-kernel@lfdr.de>; Mon,  6 Nov 2023 07:23:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230446AbjKFGXS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 6 Nov 2023 01:23:18 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43492 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230319AbjKFGXQ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 6 Nov 2023 01:23:16 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A2DD3136
        for <linux-kernel@vger.kernel.org>; Sun,  5 Nov 2023 22:23:08 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1699251787; x=1730787787;
  h=date:from:to:cc:subject:message-id:
   content-transfer-encoding:in-reply-to:mime-version;
  bh=Y9wXs47ojbfgR1SAYOfTEtpsRPseCJkNCh9UMDe4Oho=;
  b=Nwnjv29HtzcjxZ2c7s2q9aQn5diM9wXYOFTSo1ChCmh0pbOHOqTZiHYL
   C3SSVlzjRQUbXI0ZS0N5S12y9qyl+pAiEKrkCwhdTKbQ/hpjEc+6kICTd
   RbaLLcVoDwgVkM/4al+hnWmCrO+h8PWAZgdxekIMTLaSLkBNK5bZ6bSlH
   A2OyAwyQlw558sEdKd6IVNRJ35XflcJDqgDT32TyLNLVutGQu1xHP16iD
   jGhY7LoEDFE2gDkjkw0TNDcZQEOoK+V66nbtO3LCi45rl3+6orhfRRLQo
   +HqvXA6RpC/7/kfX/+w2yBFgeewPTaoqv6JlbvGBB3kA2cKyHdr2rKaMI
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="388097450"
X-IronPort-AV: E=Sophos;i="6.03,280,1694761200"; 
   d="scan'208";a="388097450"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Nov 2023 22:23:06 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10885"; a="832626601"
X-IronPort-AV: E=Sophos;i="6.03,280,1694761200"; 
   d="scan'208";a="832626601"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
  by fmsmga004.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 05 Nov 2023 22:23:06 -0800
Received: from orsmsx602.amr.corp.intel.com (10.22.229.15) by
 ORSMSX602.amr.corp.intel.com (10.22.229.15) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.34; Sun, 5 Nov 2023 22:23:06 -0800
Received: from ORSEDG601.ED.cps.intel.com (10.7.248.6) by
 orsmsx602.amr.corp.intel.com (10.22.229.15) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.34 via Frontend Transport; Sun, 5 Nov 2023 22:23:06 -0800
Received: from NAM11-CO1-obe.outbound.protection.outlook.com (104.47.56.168)
 by edgegateway.intel.com (134.134.137.102) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.34; Sun, 5 Nov 2023 22:23:05 -0800
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=8Q+XZBebLnIBxkm3q++eI41FCzpxFgLY2CPrVI0Vt98=;
 b=
...
Received: from PH8PR11MB6779.namprd11.prod.outlook.com
 ...
 ([fe80::b8:30e8:1502:b2a7%4]) with mapi id 15.20.6954.028; Mon, 6 Nov 2023
 06:23:01 +0000
Date:   Mon, 6 Nov 2023 14:22:50 +0800
...
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?VFotFRmk34RsDx9kDPAyOzQNbhNcswUjpxJKMYsG1WlYbMotF8uk9jFYbi?=
 =?iso-8859-1?Q?QhGuC4HSKo5h1N4H++N+Wijm4DaeavfV6zkDbIK2vO0nb5ezPxyFueXFQM?=
 =?iso-8859-1?Q?lnRyZSs1ivQ9yicldE/XxdyOPw/h+n9eo8mHWONwlDM0uCsPvcPBUH0NLI?=
 =?iso-8859-1?Q?y6aBrO0WhYKfnXZ+ry7XfUW6nrx1jv7ucgcDDkn4jAKsXhiOVUMSMtcZaa?=
 =?iso-8859-1?Q?+Rw2s4XRZCG6YyU7DchdUEHKbyJndXBRgDXKI2PGge+OnSLuxt7M9vcwAL?=
 =?iso-8859-1?Q?BwUDivEMCYAi680bJz9btKi0z7RXcH80cdXE4vFDRu1zvnHhgsIs9aWBWw?=
 =?iso-8859-1?Q?IJm9MC3iEGMuE7RMmcP2My7bohi3d/3cI7cOLaW1xNR/QaxirDsuRlwg2r?=
 =?iso-8859-1?Q?bfySgax4IT2/nr+qpxOs2faj7pDReAvjwYhFZW9LwqkNWPKcA89sAR40AY?=
 =?iso-8859-1?Q?6/LfP92DogRnWEiY9fB0didxvI9MPieuHC2TsWjqEX6VHmRHYER/U1Pwit?=
 =?iso-8859-1?Q?Ayc9rPdFj6LGPnJYcFmBSkNwiz4qzlCyNFIXHBP7SfVWeL9g6pq4+A4nDM?=
 =?iso-8859-1?Q?0z3WN4WG76R8wgpdLpNuFaMXroSSwvzDtspGB9J60+4b+CtwdNTDkpUOj1?=
 =?iso-8859-1?Q?1fdnlnp4Z1dfW+xEsi6Db+RSOAIVrt9b0R3Bw0yLD5R+/VUxBEM5dBh0+Z?=
 =?iso-8859-1?Q?V3gEx0l87EMqHrBIyEyXBCavOqoMtL4e9c9jC83hbwUoTfpmwe8P9WKAMC?=
 =?iso-8859-1?Q?x4et2OS+Ndg08R1o27VTJYeZwhuy5L2pHkQeT8QvHQeYgG6D/od8lkhE+v?=
 =?iso-8859-1?Q?gm9GznB1Z40ElRq5f1Z3QBKXzcpwxyyOaHd9FGrT9iOoSrHb78s/cfKEj8?=
 =?iso-8859-1?Q?eMQp5uRGXS/sTsqQSSd0pXN6wy+nFfg8AFK8YVyVpYCtxzI8K07Fo1GRrK?=
 =?iso-8859-1?Q?xvd0vyfQVY0c0lHeulUziePJ3ZFjg9jPUUKJoLjzHPgOv/7TTM6DNyFAfg?=
 =?iso-8859-1?Q?ElrvlEFo7fjcgjmiHsYGyAfhQLJ2oSJp8OEVKpgjl/H15NJeL2v2aRYOiy?=
 =?iso-8859-1?Q?yCMCx4u6lA1QAwvOum/rpMcMzXmyvvbJtuNuxklXb8Lb04/XdasV/8oHFp?=
 =?iso-8859-1?Q?G3KCBWLEBPHpO4UKIR86tedOwl0MBIQpR9ihAOF/B8D4uV3PEfaGLfCLFm?=
 =?iso-8859-1?Q?JeXKiyPjsupBbCpMOHsKiMRUrMJ0wJIENYoJxwYVnfFPS+lHsjT5zVNs3s?=
 =?iso-8859-1?Q?bLiOQMv9LIHRkuyKfbfqQisS11vlHYTsa4bZHCOSArWfORZMsZdWBfjoG/?=
 =?iso-8859-1?Q?dIh2oFzRJQAk2dyBRBMA9B52z0MRqSkXR9TcTU0YTSuLy6fM0U27fyx9pw?=
 =?iso-8859-1?Q?KALktngcV+D9J2DxwOchRRdhi2MWWVrwfZbPE1vpdJ/JedmaN8fZz4NMef?=
 =?iso-8859-1?Q?tbzerirAp74tsLr9VSXsyMisLpj/P/PynmVxrG0MRGyAIAzkdL01MSIPHS?=
 =?iso-8859-1?Q?jyZPsTfaFvQnDM8CJIzQAhP3n1JaKpysI8iDSrkdV5wZJWIXZuRhyFw0hx?=
 =?iso-8859-1?Q?RWXkdYO+JlpEcNcNv9C+MwL4rwRVnDn+BH9F5PZqgPbkeFb9nHxihfzOuw?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Nov 2023 06:23:01.1155
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: b4Wl9BAOGK55lMDxlvUFNBrNUmLZSM7uCkMImc02HFGeW1gqsurPscJ8lp8nTtQKhpRLRyxUb5WBHqp0B1ZPUw==

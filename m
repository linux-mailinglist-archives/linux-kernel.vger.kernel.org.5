Return-Path: <linux-kernel+bounces-102302-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id D05D487B076
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 19:55:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A05C0B2CB1A
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 18:50:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 935541350D7;
	Wed, 13 Mar 2024 17:45:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="bTGmTw1O"
Received: from relay2-d.mail.gandi.net (relay2-d.mail.gandi.net [217.70.183.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8FCC3664C7
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 17:45:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710351940; cv=none; b=sffF6oFNx3TcwLsKDNcyuw6XVVrchS110GTOmEqcA126DInc9KojZjlIqzcaWmWk0TwUDQ7q3x/FqNlYs1aU+2p9srgum0pKkrfwyT4mzyXpyfNls2aQcT2UpSsDiSrGaZ6IvCSANP4kqCAZdY2/2EBMbKa1ElWLOaoK/EwTtpc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710351940; c=relaxed/simple;
	bh=dDvKDmwpWlMF3/Em7Xq7bMNZ5mUHFg8sV7wJ4MAkcB8=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=OXX21B+zeq8Dpz6HhP6x1Ix7I6hvOp/oayeAPpH0TrAkXXimASaoa0BwLzGBXe4lnF1sQXVyXaUGARLfP14zYTEIovIPVxAxYkVwJgXAJr4ybSP7zybGXNgMl69YmINT8WkYSubtlkOl9XL7U5M9/hcVQ8e30F6U9tuwFzob/9s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=bTGmTw1O; arc=none smtp.client-ip=217.70.183.194

Return-Path: <linux-kernel+bounces-89734-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 35D8B86F4D5
	for <lists+linux-kernel@lfdr.de>; Sun,  3 Mar 2024 13:24:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 797711F21EF9
	for <lists+linux-kernel@lfdr.de>; Sun,  3 Mar 2024 12:24:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 204FEBE68;
	Sun,  3 Mar 2024 12:24:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=tuxon.dev header.i=@tuxon.dev header.b="CIwZZjFB"
Received: from mail-wr1-f50.google.com (mail-wr1-f50.google.com [209.85.221.50])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E9A86BA27
	for <linux-kernel@vger.kernel.org>; Sun,  3 Mar 2024 12:24:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.50
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709468649; cv=none; b=NCTOvT5QCE91rK+JhFtEOlWFeaMJmsz93jF+Tf/HWFSUrBeH2TZSyrmk8T1BXoGqADa73BZEXexhWjSCMZKOvmhLQiN3zAVL9EH4WAElFjQMXAFwoCsc2EyGS+WJQ4r5t4T1rgAcY0qrYJItJHSxJ4ZJwhux7ORa8UsTuEDx6B4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709468649; c=relaxed/simple;
	bh=Krj7t1eFkrsdNJRMPNMN0SFP/M9cbGGbz4Od5Lbpolo=;
	h=Message-ID:Date:MIME-Version:Subject:To:References:From:
	 In-Reply-To:Content-Type; b=YZIffl9q3Ae08uOV6R3ohNxGL5u7UBJAmsuZDSYdpbK91QKbniWg3oIXW083xBzaE6k1Oed0gA66Rxtg9m2xhAEU23V5F6QpZorj38ZWertilRQlLX/ukmLJvtXkp3sgLOlnkcAhJlUP/HtQ8WDI0839PLap+5d36Vjqw/f7FHc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=tuxon.dev; spf=pass smtp.mailfrom=tuxon.dev; dkim=pass (2048-bit key) header.d=tuxon.dev header.i=@tuxon.dev header.b=CIwZZjFB; arc=none smtp.client-ip=209.85.221.50
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=tuxon.dev
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=tuxon.dev
Received: by mail-wr1-f50.google.com with SMTP id ffacd0b85a97d-33d32f74833so2020008f8f.3
        for <linux-kernel@vger.kernel.org>; Sun, 03 Mar 2024 04:24:06 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=yOvuOrCGoorg+CLMunrjWj6rXzDND7pM9NZyVmrSkmw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWo06eEO/838Is+Pfa/qPF0oshcdeYMtk/lII1WR3/61fESFvrtpUcv8C6ksb2PW4uPx65d3HW0NIp/lB2BvCoZwkqvni+fQtPoKyb/
X-Gm-Message-State: AOJu0YxmKvzDzXaDOmAFWqYKlH2yS02CBsfOg+tcBYFEhPF6GnUL76U0
	LZCG3NGxg3jUtdDuV7yWAsGMx7scFk7pTd2RJJ3TXACAgG9OHdDS4vbTrdMH4NwYGbc5ObPvzfV
	p

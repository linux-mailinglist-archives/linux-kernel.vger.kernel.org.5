Return-Path: <linux-kernel+bounces-128035-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 74CC189553F
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 15:23:06 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 29EB11F21D03
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 13:23:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3946A84A35;
	Tue,  2 Apr 2024 13:22:51 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ABA5383CCD
	for <linux-kernel@vger.kernel.org>; Tue,  2 Apr 2024 13:22:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.140.110.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712064170; cv=none; b=g5yQMkPEl1jCtNWvtEAkz9mp88qx+ggrX8m1Bfw+7G5M824LV5wECZ8ESt85JjtlP3R67mcrLFrH4vnekcGES4hIecDZf5spApKGtqOwQe6WWpRY6SXRcTIiHHZfNO8yIeSQq9l8YXUZAFpEU9j03+PO5yAL3l5V9SJ3/X+dueo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712064170; c=relaxed/simple;
	bh=XrfJSTjm4r29iHY8a+jXlQqBx+JfDME8GkZEPPSzEmw=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:Cc:References:
	 In-Reply-To:Content-Type; b=CHArMKSSe9sD9HHIRzNlRLWtiAogweDb0LChiFvGB60bSfXZX1B+fDW9x4jeE+KsBsAME0SMN5LjXgCWrAg7dwl2SKLpjK5KdE3T7egYqycuCquZAM0MidngwjNX796gX2acFW++3e0rLg1kZtnRiP6edI7ZwNlMfkMpgw9cbI8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com; spf=pass smtp.mailfrom=arm.com; arc=none smtp.client-ip=217.140.110.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 8B5BC1007;
	Tue,  2 Apr 2024 06:23:19 -0700 (PDT)
Received: from [10.1.38.163] (XHFQ2J9959.cambridge.arm.com [10.1.38.163])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id EB8EE3F766;
	Tue,  2 Apr 2024 06:22:45 -0700 (PDT)
Message-ID: <47fa11db-3c26-48a6-bb7e-5ea59739b691@arm.com>
Date: Tue, 2 Apr 2024 14:22:44 +0100
Precedence: bulk

Return-Path: <linux-kernel+bounces-58702-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 638CA84EA2C
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 22:17:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id BB396B27070
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 21:17:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B26D84F1EE;
	Thu,  8 Feb 2024 21:17:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="Ka0b/hC2"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A2BE34F1E8
	for <linux-kernel@vger.kernel.org>; Thu,  8 Feb 2024 21:17:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.11
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707427035; cv=fail; b=mtqbkHdMCvFCy+je75CtvJs5xb8lyLR5GwQgYdiXvnFbSxbXBF1N64SjHbKC2wNd25v16kYyJ/ZRnc9SYtATgZA9hMf/6shDPH6IO0mlQeb47oZuTfdFGZo8hUwMRWEzRoKITLeLc0NEZIwYBlXYr96BBQYMqX3ZiezgyTau/gA=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707427035; c=relaxed/simple;
	bh=Wg66Pd47I15VI7LWyfB1wBB78k82Rc+Svvd1Uor1UxU=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=H/y1PDh+mY3CdEasnZY0MQd5JY+5EV4Qdqy6lA6XRbrWxup9TJmgjDZ18gn1wtWtXBsXVBEAKHQkzAoWRqv/sgEEEfSL7BFlS0bJ+dbglhuYa0Lv3Eps7RN5Tpxx+5Ahr67jatIU3DULhJBLZA3ZS9GJae0r3q1udkHkzQ3C9hg=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=Ka0b/hC2; arc=fail smtp.client-ip=192.198.163.11
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=Ka0b/hC2kNCdJ82hFFLt8j/UfFXUdMtKG8vCeuwhoCYdPayWrrL/myhD
   ...
   fRKyBEnNNyZOyaYOmaR6L8OET49KVVudfuRJR9PvjrFTl/DB8jkfKmUFj
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10978"; a="11967429"
X-IronPort-AV: E=Sophos;i="6.05,254,1701158400"; 
   d="scan'208";a="11967429"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmvoesa105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Feb 2024 13:17:12 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10978"; a="910510721"
X-IronPort-AV: E=Sophos;i="6.05,254,1701158400"; 
   d="scan'208";a="910510721"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
  by fmsmga002.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 08 Feb 2024 13:17:12 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Feb 2024 21:17:09.1879
 (UTC)

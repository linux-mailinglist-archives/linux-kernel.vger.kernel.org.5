Return-Path: <linux-kernel+bounces-89255-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id B9B7486ED44
	for <lists+linux-kernel@lfdr.de>; Sat,  2 Mar 2024 01:16:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 5056C284303
	for <lists+linux-kernel@lfdr.de>; Sat,  2 Mar 2024 00:13:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 55965EBE;
	Sat,  2 Mar 2024 00:12:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="Y+1qJGy5"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0A41828F8;
	Sat,  2 Mar 2024 00:11:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.16
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709338318; cv=none; b=QEyj09KocnSul7ZCQYpLz4orrjHN+JqYs9ikm/55ek+j1FqSyHJQ5RLms795/uQFX2xgHwo2R998bnhSiSskKKsMX5hb6xlXSYxSTpVzA2DmZYMrIVIZUMDe6jm+lZbenc0WRXc/ArJONIc+8RGCKhebScC2bMOwL4wJ62U4Yjw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709338318; c=relaxed/simple;
	bh=/wlUN9tZrva3SpTc1Wp4ug4zYLcv12oakkKKSqhppyI=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=mycV4O9XbHl2H0zw1c6HTUqERVE/f5Z3q1SyFqd4+y2teQm7gt2OjptIgT8bUrn9iGP5tADK2S2Oe9R/sbZH3gLaZq+hsMBdSEKzGy8f3A4hP/W0wzzTK3HiVjzmk9IYdQQT70sFq0p7EMMuZVaqfPRC+vnVLInhr4XM8YNrGJM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=Y+1qJGy5; arc=none smtp.client-ip=192.198.163.16
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=/wlUN9tZrva3SpTc1Wp4ug4zYLcv12oakkKKSqhppyI=;
  b=Y+1qJGy5ryiS0SZL5LQ3+qauZsbyBFxfDyFIl54+NS3e41krMGGUiuM3
   SfSrlneeWPpvu9nCtUxtxjdwXEhRsadXiS0GrGc+RWg987lUa0I8jf33g
   cr0Ew6oY/uTqXOKLodJogSM6Nx82tjfeJcZnUBwOh9KW+ltzrmEVLovh9
   sCiyB2cVAIu09pRrPh0RNnt8uah5aXhAheYy0U/7PHahxeUKiA6yJOwf4
   dvS/pS6dA3x2EH4kcrh4/nQokkfOCNCcX2+VHRw5FpIgWpi2nfFTIlZp2
   x5EmcO94d9/N8r8e6rcl7pYgtXpYtrBhZ/qE6Yaxrd+zftt6WWsifUwa2
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11000"; a="4476160"
X-IronPort-AV: E=Sophos;i="6.06,197,1705392000"; 
   d="scan'208";a="4476160"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
  by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Mar 2024 16:11:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,197,1705392000"; 
   d="scan'208";a="13054654"
...
Subject: [RFC PATCH v3 6/6] perf vendor events intel: Add MTL metric json files
Date: Fri,  1 Mar 2024 19:11:38 -0500
Message-ID: <20240302001139.604829-7-weilin.wang@intel.com>
...
new file mode 100644
index 000000000000..aa13e1ce563c
--- /dev/null

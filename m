Return-Path: <linux-kernel+bounces-136083-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 7080A89CFD7
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 03:31:26 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id DB9F31F22AA1
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 01:31:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E4BED50A68;
	Tue,  9 Apr 2024 01:30:09 +0000 (UTC)
Received: from szxga01-in.huawei.com (szxga01-in.huawei.com [45.249.212.187])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5782B4F1E0
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 01:30:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.187
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712626208; cv=none; b=QVJYMvK1qj2A665CH0vVCfMkWyQ627ap/DNIdWS64LaaqCDXou/FPhbaljMaU6sk87Xe6QbjX+oAhkXEB44DnN5hgttb1v7q+ksAL+MeOkPPmgKsNFlgSrVQJF6NMucbNafQm2sgPSpuBTO4qJd9wYlA+6SiBwFuPxyVr6tnaaE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712626208; c=relaxed/simple;
	bh=93ZY6fAk+/FoiMTXqVJsHI9FbD2ZdEAVGbJ8j10VmQE=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=Ug4oEnL3GiQ5lonUvNKy1HHRT0XVgiuRPlq7WgRpnRicjWNGXvHjmjI0hMfPmW/zKbG4upALSTzY3rY+7Sp58iSt0X5Jsn+Q/oNNQv/mfRFFCVZBAyCUjLUw+3uE8ErG1bQP2txZDn6iworo4o0n5BKU0WKbF90XSLsictfxYJg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.187
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.163.174])
	by szxga01-in.huawei.com (SkyGuard) with ESMTP id 4VD7bx6q1hzwRN6;
	Tue,  9 Apr 2024 09:27:09 +0800 (CST)
Received: from kwepemd200013.china.huawei.com (unknown [7.221.188.133])
	by mail.maildlp.com (Postfix) with ESMTPS id DD1EA14059C;
	Tue,  9 Apr 2024 09:30:03 +0800 (CST)
...
Subject: [PATCH 7/9] arm64: Unify exception masking at entry and exit of exception
Date: Tue, 9 Apr 2024 01:23:42 +0000
Message-ID: <20240409012344.3194724-8-liaochang1@huawei.com>

Return-Path: <linux-kernel+bounces-17109-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 6730482486A
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Jan 2024 19:52:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9F1C31F24F87
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Jan 2024 18:52:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B9D052C6A5;
	Thu,  4 Jan 2024 18:51:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b="A6CE8nof"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-pj1-f53.google.com (mail-pj1-f53.google.com [209.85.216.53])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 324E72C19A
	for <linux-kernel@vger.kernel.org>; Thu,  4 Jan 2024 18:51:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-pj1-f53.google.com with SMTP id 98e67ed59e1d1-28d0052beb0so112611a91.0
        for <linux-kernel@vger.kernel.org>; Thu, 04 Jan 2024 10:51:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google; t=1704394310; x=1704999110; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=OWuhkl8pCZdLJoAuzpBn1RnRtX4NEkthif8YJxtCbYM=;
        b=A6CE8noffACnrJPHAbBRdaZPVkPuJw4vT9cXK1yDMuiJOU8lI10vznU8FaXieLNKz/
         ltl5mt3mvZjj8cm3r080zi0miO6zF2HIRVEwSKIWXKhC2B0V+8zIq+n5QTY0aT43aQIv
         Cs3ViKoahLekpXyhcBtJcgO4mEadyY9CxjJ60=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704394310; x=1704999110;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=OWuhkl8pCZdLJoAuzpBn1RnRtX4NEkthif8YJxtCbYM=;
        b=
X-Gm-Message-State: AOJu0YwfJONP4FyZP8u47cXuhwP04hs6bnnheIaW+1pBbUFpH72Qowge
	upTqtphMC/tKXVBQg7bwcbh6tLt7yoYW

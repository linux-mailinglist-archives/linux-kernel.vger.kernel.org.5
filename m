Return-Path: <linux-kernel+bounces-35014-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B07D6838A81
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 10:43:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 609F628828E
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 09:43:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7D5A75A10B;
	Tue, 23 Jan 2024 09:43:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="4nOkLjla"
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (mail-dm6nam12on2068.outbound.protection.outlook.com [40.107.243.68])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0C9D65A0EB
	for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 09:43:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.243.68
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706002995; cv=fail; b=WqgD3krTHkK8sW0qVnOaQxaZ6tIP3RbfGqqzo/M+cLCYu5kdBdr6YSrFnNf1GR9H3VFYuK4zC7QrOzqCfMLEZ0hKpTPsauWQ7+tDL+Ji63XPDfTWQWXpHihXx1MWUazRUp8LX6AFBRL9i+8HjLWXX7Rl0O5Xb/+vQy+hD5iYpAk=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706002995; c=relaxed/simple;
	bh=uBcn+eC68aUt1L/a1QzFskGusJ846BCtKNLKb4K5Zs0=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=KzJw9qg//NH0LkiKhaaCizWzB18p1ZkH3ZK1ybMvox5N0VfzQJiS1HEn7B1Ca/+82FOa5rQH/yNFTTNFkrPC1eG9cIGpy+fi1pMjARIPNjnojyJ92Wc/v5wAVlMOheC5AqEAks1IoDqW7arHwfF36P3YI0tB/8H0BoOn6wV2510=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=4nOkLjla; arc=fail smtp.client-ip=40.107.243.68
...
Cc: "Bhardwaj, Rajneesh" <rajneesh.bhardwaj@amd.com>,
 ...
 LKML <linux-kernel@vger.kernel.org>, Felix Kuehling
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 23 Jan 2024 09:43:09.8769
 (UTC)

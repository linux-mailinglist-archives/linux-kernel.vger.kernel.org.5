...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E8D2F7BB9A1
	for <lists+linux-kernel@lfdr.de>; Fri,  6 Oct 2023 15:46:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232517AbjJFNqV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 6 Oct 2023 09:46:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60670 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232618AbjJFNp5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 6 Oct 2023 09:45:57 -0400
Received: from mail-wm1-x349.google.com (mail-wm1-x349.google.com [IPv6:2a00:1450:4864:20::349])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 270CBD58
        for <linux-kernel@vger.kernel.org>; Fri,  6 Oct 2023 06:45:43 -0700 (PDT)
Received: by mail-wm1-x349.google.com with SMTP id 5b1f17b1804b1-40570ccc497so15874485e9.3
        for <linux-kernel@vger.kernel.org>; Fri, 06 Oct 2023 06:45:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1696599941; x=1697204741; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=EUuowLQEHtueWkSmI3PIONUYZaGpPfHdjQmX4c0/CJc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1696599941; x=1697204741;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=EUuowLQEHtueWkSmI3PIONUYZaGpPfHdjQmX4c0/CJc=;
        b=
X-Gm-Message-State: AOJu0YyW5t2EK5N/0r3iKatuC9+I0pgRS+o9WZPXBTJrYqLizll+luxr
        mmIPvo/881z/s3l5/umC7iEyOW0vWx4=
X-Google-Smtp-Source: AGHT+IFfATN2Ik4nApP28KALdhp1SWh8eqTJ+8nMNyXf+BjMRUW7RXsjGh5qe++CJf06aFI9ygAjfF+xwoc=
X-Received: from glider.muc.corp.google.com ([2a00:79e0:9c:201:2691:23e9:f01f:964])
 (user=glider job=sendgmr) by 2002:adf:ab01:0:b0:329:6a1e:4b79 with SMTP id
 q1-20020adfab01000000b003296a1e4b79mr12203wrc.7.1696599941507; Fri, 06 Oct
 2023 06:45:41 -0700 (PDT)
Date:   Fri,  6 Oct 2023 15:45:27 +0200
In-Reply-To: <20231006134529.2816540-1-glider@google.com>
Mime-Version: 1.0
References: <20231006134529.2816540-1-glider@google.com>
X-Mailer: git-send-email 2.42.0.609.gbb76f46606-goog
Message-ID: <20231006134529.2816540-4-glider@google.com>
Subject: [PATCH v6 3/5] arm64: mte: implement CONFIG_ARM64_MTE_COMP

Return-Path: <linux-kernel+bounces-59622-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 275B084F9E3
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 17:45:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6DD091F26A3E
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 16:45:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0900512838F;
	Fri,  9 Feb 2024 16:41:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="Rs8/sgp+"
Received: from mail-ej1-f42.google.com (mail-ej1-f42.google.com [209.85.218.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 184157AE7C
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 16:40:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707496853; cv=none; b=m8YlDbqgtwX3cB+E1SU0o/IMwjC1LvpmfA9korrH/di/9/yXWRBBHduulo4VZmuWfGvje1m3ptbhegtbkZQEOrkOv5GGv7chmE/taa0KPG+ZNi8c0fSYgS0bVRHpMMxJ8lA7PfPIPclaswbrLFHaPFUDepm9W+FOV2UoAsR1jPE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707496853; c=relaxed/simple;
	bh=UOG7LcW3XLx4ReoQb3dFdRw3M9hk0MxWLBhm6af+il8=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=QRqrwmSyIiIkDMNCa1cEMbcKAQgBC4rCeyVt47mbkeF3iC97U8UkjBC7LzMwl+RXVSI+9Cgdg0N1KSWJfEfjJz4MJa1Z9CdS2Y65HBpqSE26Zw3VXB/Qw/hZ1tEGHrg1VEdrSAgBEvgFxeJxvnAZX1ozXbL7eJkweWygmsdL+Xc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=Rs8/sgp+; arc=none smtp.client-ip=209.85.218.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ej1-f42.google.com with SMTP id a640c23a62f3a-a389ea940f1so130505066b.3
        for <linux-kernel@vger.kernel.org>; Fri, 09 Feb 2024 08:40:39 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707496838; x=1708101638; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:from:to:cc:subject:date:message-id:reply-to;
        bh=Lje2HIL9z/HF2aXfMyLonIGhF4ejh1AOxWorPqz3UfE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707496838; x=1708101638;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Lje2HIL9z/HF2aXfMyLonIGhF4ejh1AOxWorPqz3UfE=;
        b=
X-Gm-Message-State: AOJu0YxVM5J0NiHRrq8omczlpp5lLNWPGaGTXn5Eg0g9dCs53H4Dwtti
	EKAlqXKyrol1OE08N9y9GGYcdYcirJiVNcGfwmNQSCPJ9j6b73ep9RfJdX5Tm86yQC1+oh5ZfFO
	U
X-Google-Smtp-Source: AGHT+IGznBEr1t9CWBUmrIRrXcM9JoZyqJ0yCOK0jMXD0BRClFKDkPaPU5+TigyzgiRP2hQJfDlZuw==
X-Received: by 2002:a17:906:528d:b0:a38:89a9:4206 with SMTP id c13-20020a170906528d00b00a3889a94206mr1704097ejm.75.1707496837141;
        Fri, 09 Feb 2024 08:40:37 -0800 (PST)
Received: from raven.intern.cm-ag (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id tl27-20020a170907c31b00b00a3bfe97fe27sm477724ejc.218.2024.02.09.08.40.35
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 09 Feb 2024 08:40:36 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v2 00/35] Fast kernel headers: reduce header dependencies
Date: Fri,  9 Feb 2024 17:39:52 +0100
Message-Id: <20240209164027.2582906-1-max.kellermann@ionos.com>
...
Max Kellermann (35):
 ...
 virt/kvm/vfio.c                               |   1 +
 7553 files changed, 12611 insertions(+), 3217 deletions(-)

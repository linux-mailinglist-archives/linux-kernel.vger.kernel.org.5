Return-Path: <linux-kernel+bounces-128978-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id EFF1989629D
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 04:37:44 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1F32C1C22949
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 02:37:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0AFD01B950;
	Wed,  3 Apr 2024 02:37:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="gFkVB1/I"
Received: from mail-lj1-f179.google.com (mail-lj1-f179.google.com [209.85.208.179])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DC05F1C68A
	for <linux-kernel@vger.kernel.org>; Wed,  3 Apr 2024 02:37:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.179
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712111855; cv=none; b=opVAFD+wRYXatnuURmakpC5vuSwmGOvN0Dy2Bwn8VuR+6cueesx8FrzaLQX5NTWh11CcM2keiELz3wd9F//NpNXHb+OKQCOSbBhKcSRJC9xayOmn+mwPctnvmbzK4LNwsmlFI17kZHnbFCyKMNZ9Ui1y2yPyqlh0SExF+T9iEyc=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=gFkVB1/I; arc=none smtp.client-ip=209.85.208.179
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-lj1-f179.google.com with SMTP id 38308e7fff4ca-2d82713f473so29021311fa.3
        for <linux-kernel@vger.kernel.org>; Tue, 02 Apr 2024 19:37:32 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=dwUhQJCTiwA6K703L8j80vU3/B/zOGBbqsDy8+0IuWQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVQeYIx04yAAG7vtZgHVroNOfrsIVSb0VKElH2RAoWGOAh7Vz3lIbvJhGawJO1/3zX6HAUH4znWlblgQjJfJkfDqivPeJ4zu8zIBTZu
X-Gm-Message-State: AOJu0YwPXePjP2KNDoVUrCtCFKyx+tatrHZE08TVGmWZTRws8NUj1RKB
	L9k4zxUUcagfN1bls2WDzFiQEDONrQiEABbOvUU/uVXsF/n13fofp6KrGeizWP8=

Return-Path: <linux-kernel+bounces-61463-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EB398512BA
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 12:56:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 43AAAB265E4
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 11:56:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8469939FEB;
	Mon, 12 Feb 2024 11:55:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="MYRO2aTL"
Received: from mail-lf1-f41.google.com (mail-lf1-f41.google.com [209.85.167.41])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 727B039AC3
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 11:55:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707738922; cv=none; b=Wy2wVoFC2VRN6iLLMiP1CVOX9quQH0YJfmAziV7o84YsE2HG2fb0cqeMoInz6tZ8bW98nyBfYA+qrVy/nYk3fEG9wTdkeOrt/PmNMRjtJoPW99ySoySNPnyb9UghBTGzeC0q6gkqZefSq1vS/4t06GN3e8URuLnkGAwXjZnlG0c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707738922; c=relaxed/simple;
	bh=c2ZOgoKCYnJZPyfJK+l9PwWcJN+FvuJ1ZBE89O9jBZI=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=fW33pRIFebDOHxjS/+Hq/AaVZFzkGkqkvSY+j4uGEhCsJcBmSGfPqmumUv8Fjei9gOrWKMXrxUaBKcjt0ROIVeTdwsDO6QvmOOIMvzXgiOHBZMnE/tB9euDlqIE9X4Y6YL0MN9Y6Zkj0DV6UYIbRQn8hAWTg9iK41opL7zBXUmc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=MYRO2aTL; arc=none smtp.client-ip=209.85.167.41
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-lf1-f41.google.com with SMTP id 2adb3069b0e04-51165a488baso4038693e87.2
        for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 03:55:16 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707738914; x=1708343714; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ZEgjgcGwG6vg93BMNolXtyPYUYpb5mGwlIRgyCpJJJM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707738914; x=1708343714;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=ZEgjgcGwG6vg93BMNolXtyPYUYpb5mGwlIRgyCpJJJM=;
        b=
X-Gm-Message-State: AOJu0YwFAgQOomV7TIS20WsYkLlWUPYHHajRuIbVL3P5sKwybKfJEMFO
	c47mNS7fkalLKlQHEzrivhqzARKlfczglcK5E6kbA4kuLB8KqVn9qr9iFp1han3BgO2HMjzdvjz
	x
X-Google-Smtp-Source: AGHT+IGjyVvhDDlTvF9S93pMACXrgzVBhv0pobAgbubi6HW3KwOuoVEQTdhb44EzQKC+jpykMnpCLw==
X-Received: by 2002:ac2:41c4:0:b0:511:7a72:6524 with SMTP id d4-20020ac241c4000000b005117a726524mr4254934lfi.15.1707738913134;
        Mon, 12 Feb 2024 03:55:13 -0800 (PST)
Received: from raven.blarg.de (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id m1-20020a17090607c100b00a36c3e2e52dsm139203ejc.61.2024.02.12.03.55.12
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 12 Feb 2024 03:55:12 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v5 02/35] include: remove unnecessary #include directives
Date: Mon, 12 Feb 2024 12:54:27 +0100
Message-Id: <20240212115500.2078463-3-max.kellermann@ionos.com>
...
index a5687f7f38dd..3db97eebf6dc 100644
...
index 2cb15fe4fe12..6b60fbab48a5 100644
...
index df2d52b8a245..e8be39d0ea1b 100644
...
index 770755df852f..a98fc87ae02b 100644
...
index c0cf19366ed4..03f440e379f2 100644
...
index 8141a37556d5..36165e4492d5 100644
...
index 810912b1518b..7866342eda72 100644
...
index 2249cdb5957a..90bb08c15a58 100644

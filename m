...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3D7247D5E50
	for <lists+linux-kernel@lfdr.de>; Wed, 25 Oct 2023 00:37:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344690AbjJXWhZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 24 Oct 2023 18:37:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39838 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344686AbjJXWhC (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 24 Oct 2023 18:37:02 -0400
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E6E5530DC
        for <linux-kernel@vger.kernel.org>; Tue, 24 Oct 2023 15:25:39 -0700 (PDT)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-5a7e4745acdso94128837b3.3
        for <linux-kernel@vger.kernel.org>; Tue, 24 Oct 2023 15:25:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698186338; x=1698791138; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=ry9FibHp4SMjVK/4XATvJ2DfFWHqLnxdLvRYM3t/z84=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698186338; x=1698791138;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=ry9FibHp4SMjVK/4XATvJ2DfFWHqLnxdLvRYM3t/z84=;
        b=
X-Gm-Message-State: AOJu0YzksOmgiXptZp3cltCETE/UxAWIsX8BpJ50bJqHC2orlEbpti3L
        VpD3Rq6GlvDVLCUrCdMQUcV2sgTSGmp+
X-Google-Smtp-Source: AGHT+IFe3WW1cjmbc/QlJzxzG2mogThg3ezcIFg2u2q62Kv4uDjQGcvRFKzR8VD594Fn3LPMs/u6wxnt2CBK
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:93d2:18cc:4d63:45ba])
 (user=irogers job=sendgmr) by 2002:a05:6902:4aa:b0:d9a:4421:6ec5 with SMTP id
 r10-20020a05690204aa00b00d9a44216ec5mr251544ybs.3.1698186338281; Tue, 24 Oct
 2023 15:25:38 -0700 (PDT)
Date:   Tue, 24 Oct 2023 15:23:41 -0700
In-Reply-To: <20231024222353.3024098-1-irogers@google.com>
Message-Id: <20231024222353.3024098-39-irogers@google.com>
Mime-Version: 1.0
References: <20231024222353.3024098-1-irogers@google.com>
X-Mailer: git-send-email 2.42.0.758.gaed0368e0e-goog
Subject: [PATCH v3 38/50] perf maps: Switch from rbtree to lazily sorted array
 for addresses

Return-Path: <linux-kernel+bounces-128748-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id DB690895EEC
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 23:47:17 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id E70BA1F23B59
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 21:47:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C896515E5DB;
	Tue,  2 Apr 2024 21:46:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="MN1NjJnK"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8080F15EFC1;
	Tue,  2 Apr 2024 21:46:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.9
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712094387; cv=none; b=Y/BqKC2yRpt1pHyNGlRtElU6PWqXJtb+NQ+IjMwDXaieD8bg1h+ZvGZC2R8b/lgoLXv92weitzZCHHK3YCciW2FBGOYB2e4Jinder+FLpD32Up8evsnmRvJOpIMx0UK8Atk1xEEvGmAaFmK+gNtGrYTKCwT17Kt6PylkqcRWZfc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712094387; c=relaxed/simple;
	bh=lxtbA8P/vMcU2Ec0gl0RbIB/RpJr9gnDLwa6uD7Ou4c=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=JsF5om99UI7kzVLckk14ajrsSS6NX+s89IxlmpgI8DXBVGi8atpJbrqAj8A8Xsw4ueFCD6eczG9+3/6y69r6LjNI1UtEd++pRNu+XeltAAyMv9H1zxI47pJzCy03mPqQjW3SuENnSJk2myD8h4tZLAb9Mt23kkvqMMJb6c9YNYg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=MN1NjJnK; arc=none smtp.client-ip=192.198.163.9
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1712094379; x=1743630379;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=lxtbA8P/vMcU2Ec0gl0RbIB/RpJr9gnDLwa6uD7Ou4c=;
  b=MN1NjJnKwakTO40zZrH+y6eFtr6kABco53fwaL8Sb/vYTSofAHJ2js77
   i/9UCz7+BpVm54QDCuKDIqjasBzoqV9D3zJTl6aWpEyMjOcHAa+vmJ69B
   FJ1KttOOtCixv0lQpY53h98Bu5xsyfxnT7r2BV47F9y9g4Z2nL6VgYUs0
   RIWsyrmckZ065EJ9WGRrKa0lVzlidQrWr3BEVQ85GseUHcwKAQLB0KxBM
   PJxBhUeP1DuGLQNUkxgbwMtJeC+9Gs/nxVlAzxrE4xf8DHvAKcfBVh1lO
   4+fc8sAcFiz1GqReeziXIfHF1b04NKz2Q/KJuiiCGLbKUMQ4itmD2Tupw
   g==;
X-CSE-ConnectionGUID: 21mfaZ9lQ+uY5YbHJN5iWA==
X-CSE-MsgGUID: bkOpOd0qTWuSopuuHrNB5A==
X-IronPort-AV: E=McAfee;i="6600,9927,11032"; a="18020033"
X-IronPort-AV: E=Sophos;i="6.07,176,1708416000"; 
   d="scan'208";a="18020033"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
  by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Apr 2024 14:45:07 -0700
X-CSE-ConnectionGUID: ZaC0Mvc/Rl6SKev5NRg3Aw==
X-CSE-MsgGUID: RXlONGBbRBCS9MY92DmhTw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,176,1708416000"; 
   d="scan'208";a="22849095"
Received: from fl31ca102ks0602.deacluster.intel.com (HELO gnr-bkc.deacluster.intel.com) ([10.75.133.163])
  by fmviesa004.fm.intel.com with ESMTP; 02 Apr 2024 14:45:05 -0700
...
Subject: [RFC PATCH v7 6/6] perf vendor events intel: Add MTL metric json files
Date: Tue,  2 Apr 2024 17:44:36 -0400
Message-ID: <20240402214436.1409476-7-weilin.wang@intel.com>

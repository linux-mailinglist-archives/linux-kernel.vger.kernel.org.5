Return-Path: <linux-kernel+bounces-10669-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 0AA0381D879
	for <lists+linux-kernel@lfdr.de>; Sun, 24 Dec 2023 10:03:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 731501F219A3
	for <lists+linux-kernel@lfdr.de>; Sun, 24 Dec 2023 09:03:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2F1F21FD6;
	Sun, 24 Dec 2023 09:03:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="hFCA2v7+"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-wr1-f45.google.com (mail-wr1-f45.google.com [209.85.221.45])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 667BA15C2
	for <linux-kernel@vger.kernel.org>; Sun, 24 Dec 2023 09:03:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-wr1-f45.google.com with SMTP id ffacd0b85a97d-33694bf8835so1795954f8f.3
        for <linux-kernel@vger.kernel.org>; Sun, 24 Dec 2023 01:03:11 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1703408589; x=1704013389; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=M7LwwQqvZbE68Ju9LSrwuLARVEO5UMoGDfrb5EQDjrY=;
        b=hFCA2v7+JFdED5AFbsEcAZF31BL5xjEOY4rjrXQibdZJ3/oRy1+XqAvr7qT/rc+XTu
         4NTUVI9Ol3F9hLLazrLIXjDyi85PgDYI8OvG1t4QKwaFs0/+9Rk+wJ8qJl35T53fx0ST
         Ltx3UfyeRJrhc767SFhHpewQmRpYSVA3PIhTI=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=M7LwwQqvZbE68Ju9LSrwuLARVEO5UMoGDfrb5EQDjrY=;
        b=
X-Gm-Message-State: AOJu0YzFpiPWMPfj/t6218e0aNTQvtvIzdz0ie+z5crKIpI9OAnrBKji
	6XGooTRDWqzGbFaShu1RU4+IOcEt7cWd
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000e94a9d060d3db789"

--000000000000e94a9d060d3db789

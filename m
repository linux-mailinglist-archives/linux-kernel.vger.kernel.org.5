Return-Path: <linux-kernel+bounces-38408-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 2781783BF23
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 11:42:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CD4D92862D9
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 10:42:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EBFA11CD18;
	Thu, 25 Jan 2024 10:42:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b="k/+LJO1N"
Received: from FRA01-MR2-obe.outbound.protection.outlook.com (mail-mr2fra01on2052.outbound.protection.outlook.com [40.107.9.52])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1FDCA7489
	for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 10:41:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.9.52
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706179321; cv=fail; b=a8pL6/SgwhXskk48OCCC11zJy7dyZFSI8Ayr/zkvQ2tFvFZq57hE7h4l+dGdJO2gTDMtitanMdjnPbGs1dV3RLhROm23JQegbLMNPLxzmvSURCrR+bklVh9TKOqaWRT1oCbhymso5CE8iL/Cq9SlefyzKQ2zFnwSR3eqisXp94U=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706179321; c=relaxed/simple;
	bh=iAFhSsazWfn8SAXeABWl56exsHQ4M00CWWHOc41M0/8=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=upIA27zQbw1AXsK1yj5UiFfSi5MeIh4Grd0e7O33OucbEh6bPRB7wq/sK5uVsGpJL605kPRwyb6m5nOhLmILLPrCGoPsUnyqMUJ3lU46f80uZXuboZRzIxFdE/CaxXROg4PmjMXeeldxrmpPp3oHfM7mvI4qSFd43H06Us4fhEc=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=csgroup.eu; spf=pass smtp.mailfrom=csgroup.eu; dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b=k/+LJO1N; arc=fail smtp.client-ip=40.107.9.52
...
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?dlcrdEhGODgxNUMwUnZINnJlNWRWRTRkblZNUDZSdXJtUkdtQWt3d0tJUW1X?=

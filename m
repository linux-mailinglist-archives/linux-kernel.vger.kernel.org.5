Return-Path: <linux-kernel+bounces-152610-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4629B8AC123
	for <lists+linux-kernel@lfdr.de>; Sun, 21 Apr 2024 21:57:53 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 4C00FB20B72
	for <lists+linux-kernel@lfdr.de>; Sun, 21 Apr 2024 19:57:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CE3963DB9A;
	Sun, 21 Apr 2024 19:57:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="B9Yg3k2a"
Received: from mail-wr1-f41.google.com (mail-wr1-f41.google.com [209.85.221.41])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 81A53524C
	for <linux-kernel@vger.kernel.org>; Sun, 21 Apr 2024 19:57:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713729447; cv=none; b=Mi6kp9b5rmAir47wHc/ogHRfcCd4v+JS4wQM/YoS3y+yYiAeZXNps8haKtLDd/92t5BSDzrdtY2nVWtiXQmSI196N5TeR5U/WROCLkPXeHOQe2v7JFEFoQeOJHhkbhEW5NzBWVqXu8UTYnRN9AtmGPna9LsirkGPUtxyPftoGNc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713729447; c=relaxed/simple;
	bh=o9ci1oDdVXIUQcuHu8jy5qUG9bVfcrkiPPR235Dqn9U=;
	h=Date:From:To:Subject:Message-ID:MIME-Version:Content-Type:
	 Content-Disposition; b=rAm5n73wcRPimKTxauA0/GOiUaBMb5wr0U9vBDEpbWJdiVeSBfD45UqA2bIWWbmOld2mbg1GkWgzmCxoO7SRCDAJKvDgUHGr1ZY60dywnlI1eK16elGfuORWt/cmGV0HREaPWE8hPW24yV9rWrUW/FO4i/GYLEOHbVNWz9yXUbI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=B9Yg3k2a; arc=none smtp.client-ip=209.85.221.41
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-wr1-f41.google.com with SMTP id ffacd0b85a97d-34aa836b948so257677f8f.3
        for <linux-kernel@vger.kernel.org>; Sun, 21 Apr 2024 12:57:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1713729441; x=1714334241; darn=vger.kernel.org;
        h=content-disposition:mime-version:message-id:subject:to:from:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=WIm8uwpvia9GK/4yKmzUvTZ/+gvH+k5bsEXIByHEKVE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1713729441; x=1714334241;
        h=content-disposition:mime-version:message-id:subject:to:from:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=WIm8uwpvia9GK/4yKmzUvTZ/+gvH+k5bsEXIByHEKVE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVot4Lit5Nq51BMet7lKhy2UaTS5H5I19qUr848HbVbo0F1ZEkZAhkXVBK8280KtDiYkKs8lJAFXV1ue2ETVIj+0aeDPp2KSNlPG0QO
X-Gm-Message-State: AOJu0Yws92CyVME5P9kN1Bsp+cZ9q0SDXHpGVswS4qSHdq1sjwDrVRZa
	I/s+i+2umNYF2fIHfKS/xhXQpEJBcX89c+seQhGm62vSNuWdcO/edWfOX/D8
X-Google-Smtp-Source: AGHT+IHeVDfTr/G3eDdzx0jSBw+bJs03GqwVSSprp06pjJ7MT+byOCn/MC2+c3HOfHRHTmZ6RM0jSg==
X-Received: by 2002:a5d:64c9:0:b0:34a:8c33:ca9 with SMTP id f9-20020a5d64c9000000b0034a8c330ca9mr4664256wri.7.1713729439657;
        Sun, 21 Apr 2024 12:57:19 -0700 (PDT)
Received: from matrix-ESPRIMO-P710 (p57935690.dip0.t-ipconnect.de. [87.147.86.144])
        by smtp.gmail.com with ESMTPSA id k11-20020a17090632cb00b00a46a2779475sm4849414ejk.101.2024.04.21.12.57.18
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 21 Apr 2024 12:57:19 -0700 (PDT)
Date: Sun, 21 Apr 2024 21:57:17 +0200
...
Subject: [PATCH] staging: pi433: Remove unused driver
Message-ID: <20240421195717.GA10943@matrix-ESPRIMO-P710>
Precedence: bulk

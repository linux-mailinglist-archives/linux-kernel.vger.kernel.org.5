Return-Path: <linux-kernel+bounces-61315-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B59B8510E9
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 11:32:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 11F15B246AF
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 10:32:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6C4C51A5A2;
	Mon, 12 Feb 2024 10:31:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="T1e6zcaX"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2822A383BF
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 10:31:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707733903; cv=none; b=JHVR4yQ0HEc54fRbaKCg26u+qK7yoOVX4ydUwYDVd8cMaaxYDxGa128N3e7EtTQMtFxqDQ1VRNVRIcCnxWYCzGf5qbKPGNg5Ji5gD/M3CeLAMM0wLmQ7jsGdHcpkgOZT4OthtOLOndSdfd2fYA3s+IyoV/sixfftqg8Ea/b0FC0=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=T1e6zcaX; arc=none smtp.client-ip=170.10.129.124
...
Received: from mail-ua1-f71.google.com (mail-ua1-f71.google.com
 ...
 us-mta-281-n8_p2_3MNtmVXpZsUK13nA-1; Mon, 12 Feb 2024 05:31:38 -0500
X-MC-Unique: n8_p2_3MNtmVXpZsUK13nA-1
Received: by mail-ua1-f71.google.com with SMTP id a1e0cc1a2514c-7d2dfe84153so1947439241.3
        for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 02:31:38 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1t318SRTxLpDaLWn2G/SymzKj/FNZHT6EAXxG8/aWeU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW+pNB1Ivwo1bw0993XjaEadptx06A88piPbq1gsWfC3Tc8OIH2lx/XuS91LWq7sdfQP8fJ4odqqcLfpP6kRAmuPyaHIgxj0pzXsppE
X-Gm-Message-State: AOJu0YyxwtguGh2dpP66rZkYMzy5BomdAOPqNiUa+Xbmm/u4VQ4EauUB
	E5f+AbY7eO9Isx/Q+BKeN4hP9T3FDy9106bjulDFMlRcDO//XB/qwV/conHKkmI5cfYXpYN91Mk
	Q4qXEjYkPkhqgoImBkW6iaNXgxbuTnI5jxfDDVlUw/9YEnWjPntwjm8LC2DvxyHJJIveuNed5QB
	mAWW+4cR3Bfbp4q0+9HTYfWvWJ1uvROKeI7gPK
X-Received: by 2002:a05:6102:3161:b0:46d:240d:438c with SMTP id l1-20020a056102316100b0046d240d438cmr4076021vsm.27.1707733898455;

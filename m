Return-Path: <linux-kernel+bounces-136814-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 303FF89D890
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 13:53:27 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id AF6061F2361B
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 11:53:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BAF8512C552;
...
Received: from mail-wm1-f53.google.com (mail-wm1-f53.google.com [209.85.128.53])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 040F712AAF0
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 11:53:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.53
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712663587; cv=none; b=MEhg8rmwSqlRubU4aGhW/mVURiAdbyyB/oCEjvurVzuoe/0RfT14tcFiMTtKbGfogPVhZ+uCUGoCQUD7LSIAjb5dRQ+AYBbM63viKKDMKaTP8UaouhycpnbjvdNJYkE+oE4EizbIp0yQeBUibZV1Ojcx0/WadpJfHDG/l9a62b4=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=mX1cfYfE; arc=none smtp.client-ip=209.85.128.53
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-wm1-f53.google.com with SMTP id 5b1f17b1804b1-4167fce0a41so9981165e9.0
        for <linux-kernel@vger.kernel.org>; Tue, 09 Apr 2024 04:53:05 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:from
         ...
         :message-id:reply-to;
        bh=mwibmhabQtaTTaSfxj4uJT6v1DFOIACmKb5/eqDC61c=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVuhtlqUD/keONSSiiuHY7F7ORicKdWUBM5he98pcir9v9i6ZNXGq6WEIoApqIjp3vtu5I/7nF31XGuo9sa0CgSXbnlKIZmppnPouUB
X-Gm-Message-State: AOJu0YzVePbh1l6ZD9IuK83xYomH/QGg5Bj+Sq7L7emcWDt5VqHEviZ4
	j271QCRn5vQBqEr9oeQ7G93mQSmBfPNLZES68TSWxHJM2b5amjxcInNTdl7VS/8=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 03CC377B4D1
	for <lists+linux-kernel@lfdr.de>; Mon, 14 Aug 2023 10:56:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235324AbjHNIzj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Aug 2023 04:55:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47644 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234982AbjHNIyL (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Aug 2023 04:54:11 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7C8B010B
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 01:54:10 -0700 (PDT)
Message-ID: <20230814085113.353191313@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1692003249;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=gfUTIPblkGwpIS64sQCM323mDciLTw/qUO5rOF9RNNw=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1692003249;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=gfUTIPblkGwpIS64sQCM323mDciLTw/qUO5rOF9RNNw=;
        b=w5vLvANhXTr2/wnHK5MAoq3iMaabpBZwNoUvYH530HZzoZMaLZRBXsSPXFnxzmXTF3ZjEq
        mhZJn6J/Wk5g26Dw==
...
Subject: [patch V4 22/41] x86/cpu: Provide debug interface
References: <20230814085006.593997112@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Mon, 14 Aug 2023 10:54:08 +0200 (CEST)

Return-Path: <linux-kernel+bounces-64742-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 507E2854229
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Feb 2024 05:55:57 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 74BC41C23731
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Feb 2024 04:55:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 675BA12B92;
	Wed, 14 Feb 2024 04:54:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="ACbHuTxZ"
Received: from mail-yb1-f202.google.com (mail-yb1-f202.google.com [209.85.219.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 919D612B60
	for <linux-kernel@vger.kernel.org>; Wed, 14 Feb 2024 04:54:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707886488; cv=none; b=tVyAMaQ05xeqht6AvOy2PW5IdSmchgRNO8kJI+g2ULDZcq0gCF3ZC3sgyF4hOHpVilE53lPQ5qaz+GqiMgt24E692fbCILcmjmqxCowZqiPEipwi7Kt4Gy5ay5WI6c8TFyZWXbDCWoHPmTZBk4oCFA5ZBCcOGTAJt3tDKYpHNVw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707886488; c=relaxed/simple;
	bh=pokSEbOrag3uWdO1RhTKTOPvPSFp8ZMJI6bQo7DbnNA=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=l37XI9jufytinyp5ogtWh3U56l7/X4gmBnpf6YD/srZWZxGbpRMIzv3MziKK1CP28n5CobLNkqihn9WlSeaWR6AX83lsWaaidrsilyWv3tWuhJ184Xgwxu34OyKTvH0sxXbTgYoXhkZy37koRTJqTgCukfwYN9BltkQkyeZwL5U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=ACbHuTxZ; arc=none smtp.client-ip=209.85.219.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f202.google.com with SMTP id 3f1490d57ef6-dcd703b721dso1231488276.1
        for <linux-kernel@vger.kernel.org>; Tue, 13 Feb 2024 20:54:46 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1707886485; x=1708491285; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=mEeFv0uon5WQC9cFYvgD6Kwx90gDUxQUuXbCDfN9dJU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707886485; x=1708491285;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=mEeFv0uon5WQC9cFYvgD6Kwx90gDUxQUuXbCDfN9dJU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU9a4dVXnzfjvM6rvodiztwPfA5+ykQ9FITOmpCntr2+hHpoUYME1J5p8heubfQnMNZt4c3rhABIKUHL34bLkUXf4MGZ3FFa+GacihH
X-Gm-Message-State: AOJu0YwNsEgXQzCRVTg7uumZo7EvxCyAguxA6cOUzymeN/KhitEgoQLm
	QHm/+OspL9rVlIY6ivhxMbqAFqR2EGC0y8Vx4N6wIVCpuvzRKIt+EhUbRR+LDRWkTRiDUY0NH5C
	LMGmzdw==
X-Google-Smtp-Source: AGHT+IHSet7A96qWebh2Ep2XW2Sl/AHHnGwI4zz+x2s/cywd8H/BYo3Mbauk3ICX2IgxKf7iHq+hE3T25yGQ
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:6d92:85eb:9adc:66dd])
 (user=irogers job=sendgmr) by 2002:a25:2e4c:0:b0:dc6:44d4:bee0 with SMTP id
 b12-20020a252e4c000000b00dc644d4bee0mr74284ybn.7.1707886485640; Tue, 13 Feb
 2024 20:54:45 -0800 (PST)
Date: Tue, 13 Feb 2024 20:53:54 -0800
In-Reply-To: <20240214045356.748330-1-irogers@google.com>
Message-Id: <20240214045356.748330-7-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v4 6/8] perf tests: Use scandirat for shell script finding

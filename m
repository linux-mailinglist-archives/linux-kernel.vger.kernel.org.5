...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A7DDD774763
	for <lists+linux-kernel@lfdr.de>; Tue,  8 Aug 2023 21:14:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235386AbjHHTO2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Aug 2023 15:14:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60586 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235215AbjHHTOB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Aug 2023 15:14:01 -0400
Received: from mail-qk1-x72d.google.com (mail-qk1-x72d.google.com [IPv6:2607:f8b0:4864:20::72d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5BF563685F
        for <linux-kernel@vger.kernel.org>; Tue,  8 Aug 2023 09:36:54 -0700 (PDT)
Received: by mail-qk1-x72d.google.com with SMTP id af79cd13be357-76d072daea2so163009385a.1
        for <linux-kernel@vger.kernel.org>; Tue, 08 Aug 2023 09:36:54 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1691512579; x=1692117379;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=j0RzJQAr5/kNOKYngiXXsvKideAjXsCxiaoCKiIEbe4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1691512579; x=1692117379;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=j0RzJQAr5/kNOKYngiXXsvKideAjXsCxiaoCKiIEbe4=;
        b=
X-Gm-Message-State: AOJu0YzRsweTIJsucEHZwoiU4k0yeHiKQaHG64HJIH2CFXaTx8aisyde
        zmjdtu6WxUeVJyzxoXKSF6Gd2w/la7uq07LgAEbJJO4kdrPw7DAopiE=

Return-Path: <linux-kernel+bounces-60739-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id AE265850915
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 13:32:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 754041F212DF
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 12:32:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1BA605D487;
	Sun, 11 Feb 2024 12:30:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="GCofcNEK"
Received: from mail-ed1-f45.google.com (mail-ed1-f45.google.com [209.85.208.45])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 55D6626AFA
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 12:30:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.45
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707654630; cv=none; b=uCknGMJWv/zYTgW+p5O1VcaZ04BjUrTnoV1juo1cqVASEQXQ2TLJwvEugaqyOkB8rO0DkkQO1FzKWQruksBzA2zh5D26rshyX0S6p9UZIp8VsqZkfx6DC6izz96M9IGL/Gs9VOBce8Cc+tNqMrgvqjpCXrCYS04tgpWmsIh9f0A=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707654630; c=relaxed/simple;
	bh=liDxdnGi0VxEh4RjE/Dk2wkmMdIq8rkf3AAOj1MYkS8=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=C0UnYNcDpTJJ3B+SmEv8FYhPewjnK9LEdvw80SAN/i11KjDcdhkHJSjY9IJBAiiRLCfUbek+b/J4BQmSvgZmbm54WUUu4e+ZlbR+p9A1sai7IdFgyUx52tReKWoVBNs5CjnJTpt+HYLoV3oaskrs3ncbfsJlayB5LqS4q1wYgd0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=GCofcNEK; arc=none smtp.client-ip=209.85.208.45
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ed1-f45.google.com with SMTP id 4fb4d7f45d1cf-5610b9855a8so5666994a12.0
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 04:30:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707654619; x=1708259419; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ZMCsnzVZo/kxSsTnZ5adWRd3uURplacvAAxO/uYutbE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707654619; x=1708259419;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=ZMCsnzVZo/kxSsTnZ5adWRd3uURplacvAAxO/uYutbE=;
        b=
X-Gm-Message-State: AOJu0YxO7ZO1hrEDA6iQrXNyeFVjGCSHmbpASyz6Hy/uMn+K1cd9E4n/
	Ca3WjkLc93JNi/AJCuqsmyMGznFkZ00+xYIxnwVgImiLva3SLmZfGGK9mwkNcHrRtFMNy1EOc1n
	8
X-Google-Smtp-Source: AGHT+IFywSnEce0fiHsQRy9wWKgRdoI/UPqtyGlisVWR4NSEJmagED0+ikwB7lUQxEYqlJlLvqxhQg==
X-Received: by 2002:a17:906:830f:b0:a3c:8a88:c583 with SMTP id j15-20020a170906830f00b00a3c8a88c583mr654652ejx.3.1707654618199;
        Sun, 11 Feb 2024 04:30:18 -0800 (PST)
Received: from raven.intern.cm-ag (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id fj18-20020a0564022b9200b0056187ca4120sm1024611edb.10.2024.02.11.04.30.17
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 04:30:17 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v3 06/35] kobject.h: move declarations to kobject_types.h
Date: Sun, 11 Feb 2024 13:29:31 +0100
Message-Id: <20240211123000.3359365-7-max.kellermann@ionos.com>

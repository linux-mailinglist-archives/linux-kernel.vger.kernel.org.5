Return-Path: <linux-kernel+bounces-112063-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 46B078874C8
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 23:15:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id AF9DC1F23CB2
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 22:15:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5A77881ABB;
	Fri, 22 Mar 2024 22:15:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="KgJHGQg+"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CF2E180C03
	for <linux-kernel@vger.kernel.org>; Fri, 22 Mar 2024 22:15:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711145733; cv=none; b=GXR820rfKeqCB+sAhjPVweheC2vOsgZuqVM7p8ea7tPvvnA00aUykxF4TthKDMYrjEKdnL8QRyaYzTQwGTcSIF//udz3APNlpi7DeNO2WLjIaSs3619ssIMkTpWsQf4AxGP5FbR10OGlvNPjCN19E3YbokqC39TPFODWdXOdOac=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711145733; c=relaxed/simple;
	bh=4FQrD/PKlZmioXiyS7CRLYTmYpgx2OB+RwGofa2SKWU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Z9LToFRPL+26AEBDs2h8Gh1oDjuveB3G9GWoWJkoSKEauwNqxbfvdkKfk8JlwAfpDSccLZU9wDKULuWGQGnA1YuTkpbSoDb8TAttmrd5/Ll3J5Qk+uac5v3xbJeuGhE0kKko5SJWtnJWN6UdNAPpcLxCXnf5JEG58BRj+bdHpAk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=KgJHGQg+; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1711145729;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=/2rbFK3Zkwkpa0zSjV5S8wegkn2R9j6nsE8sHWQ00u4=;
	b=KgJHGQg+JcLRjwekim9ZJvlLUh0/Gl4eW+Lre94UDz6NVYMcvYmQa6HrximFbeAUxBLUfl
	Yin3SPf6MzL6bCTdAushcoXHnOWtjTXfait6haJ44hpM0BH1FqfpFZjPsx9bL4CdFe1pw9
	pEzonSLJhyyVo846BrJD8vm3ZdUzd7Q=

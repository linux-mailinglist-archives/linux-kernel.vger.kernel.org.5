Return-Path: <linux-kernel+bounces-47351-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 31C7A844CC2
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Feb 2024 00:29:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3BBF31C2520B
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 23:29:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 28E0E4D580;
	Wed, 31 Jan 2024 23:11:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="uUjLqIMD"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5E9394CE17
	for <linux-kernel@vger.kernel.org>; Wed, 31 Jan 2024 23:11:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706742702; cv=none; b=qk10eZy8rYMhxYoYKtt2rHREgWbxSBs3T+GJfFT/fLZ4QWol2Ld6WusAZXl2dplffBtKGJRIymwjqp/eQZXfR1yGfRdGR71IpgsiAYiucuaPROr5aBb9AV9ND1dyKbSJJvMqRVAzuJ//NoG25HlcahtMsHGSjeUHnXuKSTLIePs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706742702; c=relaxed/simple;
	bh=VeKB2CcnfxaMa74jOXPT020xZoApnn0QOwGRqmxYQ/I=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=HJMCbkL9FcCTBmvLA58S2LSatitbMh1dOiB5iZADHPRtlPritsv3du3BU+/6uy9hecvpPsoooZ413ZJ0k6uCN0Bo0OO8MVUU+6p0jSoMTZRAW68gzuqeh7AWk/0hqAnzrtAVoa+MUGa3sXvjMjd+/sKECS6tBwUaXpkZ1akuE0w=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=uUjLqIMD; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 0F997C433C7;
	Wed, 31 Jan 2024 23:11:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1706742701;
	bh=VeKB2CcnfxaMa74jOXPT020xZoApnn0QOwGRqmxYQ/I=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Date: Thu,  1 Feb 2024 00:11:12 +0100
Message-ID: <20240131231120.12006-8-frederic@kernel.org>

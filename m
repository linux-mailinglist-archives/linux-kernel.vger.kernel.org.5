Return-Path: <linux-kernel+bounces-110187-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 67A75885B48
	for <lists+linux-kernel@lfdr.de>; Thu, 21 Mar 2024 16:00:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B565E2850F9
	for <lists+linux-kernel@lfdr.de>; Thu, 21 Mar 2024 15:00:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8BAFB85C7B;
	Thu, 21 Mar 2024 15:00:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="cCMnKNNS"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B88268595C
	for <linux-kernel@vger.kernel.org>; Thu, 21 Mar 2024 15:00:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711033222; cv=none; b=TGPhHvPZDWJUxkUxCRqQ7trQ8i4AAlkTZinGTiN5OCSnv4cGLty2BJnl9E/c6yX4a9u7WeOH8G1hQ5kY4HN8MHbrCBj4CJ6g1ZpQwrp+Y7UVZxS5Kh0MP62CXo4UQJ+XpCuP7zcbCo5P3a5HrK0Nc6tpmYhRZYlGR/PcgpNY1m4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711033222; c=relaxed/simple;
	bh=WCiVePd3QqKF+DdCIwvV1oNxrx4byfzyt9IeWKvVDXg=;
	h=Content-Type:Mime-Version:Subject:From:In-Reply-To:Date:Cc:
	 Message-Id:References:To; b=TRSuI3syAbvY+TtF2c4qZ3C+Qp4lcp8iNSNZdGEJWN2fnlrmgCFTWQJaVwnXlOH1o1/s+un1Gc12MEBzaDs3rzT9YguuyqSGZaXDuthg/WAYYV2EAOrLS7a6AstI+G88wjI4LTubUk+8lmqmj2YBXVAc5YtzipD6XPcy5DIrtQY=
...
Received: from mail-pl1-f200.google.com (mail-pl1-f200.google.com
 ...
 us-mta-30-a5rWe0-oOS26ojBOHfXCaw-1; Thu, 21 Mar 2024 11:00:16 -0400
X-MC-Unique: a5rWe0-oOS26ojBOHfXCaw-1
Received: by mail-pl1-f200.google.com with SMTP id d9443c01a7336-1e0310bb981so10505175ad.3
        for <linux-kernel@vger.kernel.org>; Thu, 21 Mar 2024 08:00:16 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=m0q/xukp+HK2n2qb38JTdm8WelCgNmtQ3QKlXESyN2k=;
        b=
X-Gm-Message-State: AOJu0Yw6nHCuY0/HNshTIYLtsEc1lD657k1yaS5Z3cCnvHWcW8Z50igl
	HYmBPnfzFyuVO95NbKdtO5RlT+KyhRz5Oeqp4Lmh3HkcqqZDEAcXYqQ7z2ZlqNinPSaJH+ciwG1
	D/o2EIBacCjIC8D+XJG74SF3a+9ttcvkYeTa+CVFj48T5E6Ris5KFKYJTB6SQWA==
X-Received: by 2002:a17:902:f60d:b0:1dd:7485:b4c9 with SMTP id n13-20020a170902f60d00b001dd7485b4c9mr2692606plg.22.1711033215518;

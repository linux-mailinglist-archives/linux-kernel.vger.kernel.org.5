...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D497D768A16
	for <lists+linux-kernel@lfdr.de>; Mon, 31 Jul 2023 04:40:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229676AbjGaCkh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 30 Jul 2023 22:40:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40904 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229781AbjGaCkf (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 30 Jul 2023 22:40:35 -0400
Received: from mgamail.intel.com (unknown [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 95EF018D
        for <linux-kernel@vger.kernel.org>; Sun, 30 Jul 2023 19:40:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1690771233; x=1722307233;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=ZPWYgcQc4dgi/nu6ZU+MetmWHlSNtN8g+j8duyEaKgM=;
  b=G0UGesvvo05qrWlKqJGDFaY/iDXEb8HT+2Zyfgt/jUm23HB5IU7l7Wgz
   DLWjPReYk0EV0yN5oq7VcElrGGbMDbILOKFJyP7Yt0DXNXYdKlNoXPAM2
   d4xfoY4+0Se6F8VFgjeAtXn98nKP9BvwnxJb2qA0GYUcGyU7M7IUcBB03
   Tkl4gQW9eMIJm/D6YlHyORVFkO+jlJbhQLf70Zti+E7UJKLPSkHJjacZw
   fiH5ATW1iL2aDCHpELdKFfOwGM7oR72+ImZofxmD+IYatVKEGQRwNA8g2
   RH0yQCOc3yiKyhcPhnAuEoK7lrjmS2zgAtrW7mzMJtn4zmJaTldPiauJe
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10787"; a="349206007"
X-IronPort-AV: E=Sophos;i="6.01,243,1684825200"; 
   d="scan'208";a="349206007"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Jul 2023 19:40:33 -0700
X-ExtLoop1: 1
...
Subject: [PATCH v4 1/1] ASoC: Intel: maxim-common: get codec number from ACPI table

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0FC517DE85A
	for <lists+linux-kernel@lfdr.de>; Wed,  1 Nov 2023 23:52:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1347343AbjKAWwh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 1 Nov 2023 18:52:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36380 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233267AbjKAWwd (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 1 Nov 2023 18:52:33 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 22303122;
        Wed,  1 Nov 2023 15:52:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1698879148; x=1730415148;
  h=from:date:subject:mime-version:content-transfer-encoding:
   message-id:references:in-reply-to:to:cc;
  bh=f/IKjiX0oUHcikJLOo2W8JK83pAYKKgmZaVVmd3uHXA=;
  b=VrgsRHCcYKWqDXKwOvfAPtnw8FxsFGigQBV921wSnFV6meLbQmqobCMU
   kR1I0mFEmA83BTZ1/py6klfHD9kjST+yktGO0XKTUnbdQeQv83RHe1688
   5L/24uJg84wgn89tSD3l/ka2RAd0dOFI/n/3btsPnD5AFFw9w7h3+iPAd
   Q5EH5Lgi1nI4mpVeQ0WUF4tgVf6b5trSWE9XVTnDV00OgszRzimPy6WaN
   rU2ISIN69Aa1fLqeDZSJ2gwtv8uydkzw5G3GyuEdXc6OTuucoC/+XTb0a
   o6dlmEFVPAy76vN5aQJkvs10YKG8+9Asv03wR2PU6l4MB+i354RAP8VAH
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10881"; a="10133629"
X-IronPort-AV: E=Sophos;i="6.03,269,1694761200"; 
   d="scan'208";a="10133629"

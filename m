Return-Path: <linux-kernel+bounces-80669-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 62E02866B10
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 08:39:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D7DD0288AE2
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 07:39:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 145EA1C692;
	Mon, 26 Feb 2024 07:31:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="SjO7AwKT"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0EEC41EB56
	for <linux-kernel@vger.kernel.org>; Mon, 26 Feb 2024 07:31:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708932685; cv=none; b=fSKTHEsulppBCG+QhpwmQl3NyJMA5W97aVOC5zbV7d2dfmMJueBAMKnvWaaLaZFuiFJKSCiSY1UYXWQ/weqQZULESHY1Ru0/MOHOoSFH1P7JncnUR6ZCJ31h7D77O/ke1mLBxju0wmNN/RyWk3Y7wDwCqEiPlVkm3fjO0EhG0hw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708932685; c=relaxed/simple;
	bh=8mb83CW2lbuHwSVT/r4dUWiQFfxT8qKnT5AWwVA0sLw=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=Z3+uO2MJu6mJbvxXJa5moMUi+/VYhgBIWctdFHIIt3HXSnq5TgW4ZmlMT7sPB2fI0TJ2Nc6LO9bhlhsDidaHnAqsXz3QGUJ8vvJ/LB8c8m/1nzZxx1Wo7VsGYVHLkTSR/hMHMJWtTnidyv5KTPgQw/AW3GkpWCR57GQmuHTCaKs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=SjO7AwKT; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id EF35FC32789;
	Mon, 26 Feb 2024 07:31:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1708932684;
	bh=8mb83CW2lbuHwSVT/r4dUWiQFfxT8qKnT5AWwVA0sLw=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id D91F8C48BF6;
	Mon, 26 Feb 2024 07:31:23 +0000 (UTC)
From:
 Nikita Shubin via B4 Relay <devnull+nikita.shubin.maquefel.me@kernel.org>
Date: Mon, 26 Feb 2024 10:30:31 +0300
Subject: [PATCH v8 35/38] ARM: ep93xx: delete all boardfiles
Precedence: bulk
...
Message-Id: <20240226-ep93xx-v8-35-3136dca7238f@maquefel.me>
...
X-Developer-Signature: v=1; a=ed25519-sha256; t=1708932678; l=119092;
 i=nikita.shubin@maquefel.me; s=20230718; h=from:subject:message-id;
 bh=uhR66EhODWXKQFvJ7MBRo1kFgxp24yqu7CHAcAnWRvE=; =?utf-8?q?b=3DF8J2uEpulk0u?=
 =?utf-8?q?y7FO23cHBSQcVmlecT7kWj4ht+8pr6lTKfOissn32BqeZhlRcXS1O14k32i8vR1O?=
 ejIoMSbtBQC8I+s4ZLSLew6AvC1Gght8WCrM0E20RKpAqvdo0DYo

Return-Path: <linux-kernel+bounces-72340-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FC2A85B230
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 06:14:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id DA76A281CBE
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 05:14:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2A80656B85;
	Tue, 20 Feb 2024 05:14:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="iDxDp+ff"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 57DA356B7E
	for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 05:14:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.7
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708406046; cv=fail; b=Y+N8oR1A03KrvclkketY6kO7fn0npo0F19278ZHL79Xy2pmDX+R8FQGBX/g+OHBk9g9kLONQA95kaMQ+HmMtkoLyCU70BIaF5opOf2OIIx4Yo4OR1E7ht14OPIUi09idsH5HOdCa1nrlDsnlKyNAMkLfOZgmQdF5xbcSqVj3p2w=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708406046; c=relaxed/simple;
	bh=I1wJYg+v97OLjw/6JHtLMZblieyCR1A1nBdExpC27ms=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=VbDUmEOo3l/dQJaraO+FCkBu/4G+BxKMSAMONhLohBrtI934o/ePCKRCpa7F2EpCkZVFTysFBjdekILbMuJsRmEs9HSe+IzsuR33cHho/d07jsGBxfFjq2RyuNJ3ul3rTB1/mOGKA52P2RRAs74PLWlwb3oMIUEDW2e4m7dpDew=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=iDxDp+ff; arc=fail smtp.client-ip=192.198.163.7
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=iDxDp+ff59mAZ9QmBg42/Iv6/iXeOPmL4Tnfarph4eQwKgw9kQk5wJm4
   ...
   Xfq9fU2y81DeFCydpQFJfXWDHz8ty7WfVfd0haebaJEYX4M0YkVd/fhr1
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10989"; a="27938351"
X-IronPort-AV: E=Sophos;i="6.06,171,1705392000"; 
   d="scan'208";a="27938351"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
  by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Feb 2024 21:14:03 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,171,1705392000"; 
   d="scan'208";a="5040811"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
  by orviesa008.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 19 Feb 2024 21:14:03 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 20 Feb 2024 05:13:59.8098
 (UTC)

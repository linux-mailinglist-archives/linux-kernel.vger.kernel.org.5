Return-Path: <linux-kernel+bounces-61661-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B248851512
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 14:29:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 75900B24AC7
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 13:29:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4708253805;
	Mon, 12 Feb 2024 13:15:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="h/mzq9iC"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 89CA3535D3
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 13:15:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707743710; cv=none; b=hRVOcxw2fFkYSBv1JUj8dV8V8Rox4xuPUSjbJeZ7sPzd5UDR4YgHIPzLJRveUXPjcW6CuzkQfjg5L7tTCZ6QMvw2GGBE0sM+RUdlij2b5AwzA7GIfhMBNrVpVJZntpoZsTf2+kkdC7vD0Ud6wHva6K1JZTNMgy3CCHpmvJCsRb0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707743710; c=relaxed/simple;
	bh=edg48hCxUUsafxeXxN8gUXSfDiG+GzQwBNH1uurcdqc=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=izAymprt9g9y739Z6qT0voh0EHmPYr64XWz6t9jAVnvZrG46LIhJuUNcVBMW2UZtjFVTBk777uVabBcRDzse5EFWYxYMkZe9NBjRUVfKmmeTFL3oMSXXmY76yiz6i/yhW8RvA07m8RWqHeWUjsfcrcQJixK0CgyWN0SLHaecXow=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=h/mzq9iC; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 ...
 us-mta-84-bYn63aOXOJa5VV9zaxI7zw-1; Mon, 12 Feb 2024 08:15:06 -0500
X-MC-Unique: bYn63aOXOJa5VV9zaxI7zw-1
Received: by mail-wm1-f72.google.com with SMTP id 5b1f17b1804b1-410bce883a3so6801615e9.2
        for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 05:15:05 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=qLa1enao/eBHrJt4n5b2gdRWxVNxxplXI5t3v+HwRWc=;
        b=
X-Gm-Message-State: AOJu0YzenJpMg/9P6Lfs8g4k1Qnl6K3dM3Rzdamu5JKhMakhmxONnHu6
	yRA0/AElFGQWLT9xFIHwMNCVx3i3yAZdF5zfXmXCaOVzf84HOEemOjz/dpPnm5/N9J5xhs0CfvS
	rg3HDqCUWAu/cuzwax1nRbgLJ2ANMvvxFzD0ryjEhMPGJMaMSEdDUBfbpMWxx6g==
X-Received: by 2002:a05:600c:5112:b0:410:cf4f:68e9 with SMTP id o18-20020a05600c511200b00410cf4f68e9mr2207256wms.3.1707743704888;

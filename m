Return-Path: <linux-kernel+bounces-166366-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B232E8B9991
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 13:02:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 58D21B2196C
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 11:02:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1BF125FB95;
	Thu,  2 May 2024 11:00:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="CEy/xFin"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5D6D35F874;
	Thu,  2 May 2024 10:59:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.14
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714647598; cv=none; b=Q0VEkfsfp9JQev9ZQM/Nn5Q753aveKrLW1ppMcl8bZp8J+Wd8pQJ8WubtsJ7L4794dtPdZW3OPNmWEOQ840FT+/hbacc4B2tL6SMZFXyGrgD2m5cbMi9vybdBOjK2LdzNeASxhFxTmqlsP+gw+USdql3glrWZf/43zgYaOV5qkc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714647598; c=relaxed/simple;
	bh=wKbpNUXTHD3GSI339WEJmlYlloRWrppiWpCQqbVZF6c=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=CPjH4Txm+SUWpbDj8IeWkHRoALuhQbr8mJnEAv5lxLL/MYfM1r/oE+PvBhPkwWW11NCEpgb8O+zjNfsNql2vS3nyN3+Y6dWtuIZDmU7AMlTxiF2hOgbOA17yslpvLVf8Qkeu9t/egBmKvUj6g+RwqIoLGMxrV71Dr39d5Ilr1UY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=CEy/xFin; arc=none smtp.client-ip=198.175.65.14
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1714647593; x=1746183593;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=wKbpNUXTHD3GSI339WEJmlYlloRWrppiWpCQqbVZF6c=;
  b=CEy/xFin4acoFCMckhKejdvk4Ul/30B658tWfWuMMN0dO6XNyBRpSQnW
   EqoZsgF2rMgLZEFp6IhUjmkW6l87+ajfc5cksXiTEHDeMeu3QsqzVq+wg
   TkF8SR/mRjrNoh1Gq7taaaSyVxjuhUZ+kQ2AO6lX92IHgwy0B0pxC/Rc7
   pxK3UuyAn7ARz5AvaG4OKiPQmJfSYCF8URQ7lzOvAHReHLFCb1tvDaGcp
   Knzbb0vMW7AJoFwMPwgGu3yW5eiZgmZpNCsBq8e97eiBKlHrjG6ApjESe
   HxNx1v6vM7r3dJEE0PvjeiWmuLiwKIir8b2abyLH23R6mtZU0NQ6iTDcL
   w==;
X-CSE-ConnectionGUID: g3MK8SJTT4yrNhb/hVqY7A==
X-CSE-MsgGUID: isYNYw3yR4+Wt6Zg9mTTAw==
X-IronPort-AV: E=McAfee;i="6600,9927,11061"; a="14228699"
X-IronPort-AV: E=Sophos;i="6.07,247,1708416000"; 
   d="scan'208";a="14228699"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
  by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 May 2024 03:59:52 -0700
X-CSE-ConnectionGUID: azzpAPJqTT+DRvUS6dSBPg==
X-CSE-MsgGUID: IC6DJFVrQ5ugbL0RfV8O7w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,247,1708416000"; 
   d="scan'208";a="50279023"
Received: from ahunter6-mobl1.ger.corp.intel.com (HELO ahunter-VirtualBox.home\044ger.corp.intel.com) ([10.251.208.210])
  by fmviesa002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 May 2024 03:59:48 -0700
...
Message-Id: <20240502105853.5338-11-adrian.hunter@intel.com>

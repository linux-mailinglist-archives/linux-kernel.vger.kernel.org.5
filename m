Return-Path: <linux-kernel+bounces-118674-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 8CE7388BDED
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 10:36:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 87610B27AE2
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 09:36:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BDC231304AB;
	Tue, 26 Mar 2024 09:21:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="TIUVvDcG"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C675273539
	for <linux-kernel@vger.kernel.org>; Tue, 26 Mar 2024 09:20:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711444843; cv=none; b=GtXJ5EvkktXaJaOnC9vWGrHT4MQMj0QwJ6LPve2Bx5KEDB1c0jutqGGkOz3eLSSl0dX4xGs7t9v9GJLWMOIbeT1qzPHm12tch4mgEalqw/L7AvfXbAbyRU3LqmmRYLMhyUUrAF7EQ4iakoa7WGtCUe5Fl1MRyfrxVF7X+6etYpk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711444843; c=relaxed/simple;
	bh=8mb83CW2lbuHwSVT/r4dUWiQFfxT8qKnT5AWwVA0sLw=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=s5GCT93cOsGensDhxJcTibFwFxZfkg8+G+0fDpThDYKsynmM3I03+rkaCl+16uRrHGjahQ33XcxU/7S/xJKRE3rj6XpFtMJi4n1ly+czW0AyFNHRyGe7MrWihbIYv4hlWIt5D31uJ4BwObjcl+m3C90gtIvJASL5v01ZtlUlH2c=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=TIUVvDcG; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id E820FC4E688;
	Tue, 26 Mar 2024 09:20:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1711444842;
	bh=8mb83CW2lbuHwSVT/r4dUWiQFfxT8qKnT5AWwVA0sLw=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id DAEDCCD1284;
	Tue, 26 Mar 2024 09:20:42 +0000 (UTC)
From: Nikita Shubin via B4 Relay <devnull+nikita.shubin.maquefel.me@kernel.org>
Date: Tue, 26 Mar 2024 12:19:02 +0300
Subject: [PATCH v9 35/38] ARM: ep93xx: delete all boardfiles
Precedence: bulk
...
Message-Id: <20240326-ep93xx-v9-35-156e2ae5dfc8@maquefel.me>
...
X-Developer-Signature: v=1; a=ed25519-sha256; t=1711444837; l=119092;
 i=nikita.shubin@maquefel.me; s=20230718; h=from:subject:message-id;
 bh=uhR66EhODWXKQFvJ7MBRo1kFgxp24yqu7CHAcAnWRvE=;
 b=1mWNGcqIpr0OPD0hwYiB8RHyfnNcX6UjXICMyem8qi19W8K5Dryfpayn4ifsNiaHqI79DzgHLhYW
 oSgcLzUBBrwbCncW3laMhHTwcdWkiWDipgVffcYoQN5TSEBM3KpA

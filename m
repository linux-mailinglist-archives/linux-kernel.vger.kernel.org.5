Return-Path: <linux-kernel+bounces-87814-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A881486D958
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 03:04:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id CC3261C229B3
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 02:04:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C9DF138DE7;
	Fri,  1 Mar 2024 02:04:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="djvWg/JS"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A353E39AC9
	for <linux-kernel@vger.kernel.org>; Fri,  1 Mar 2024 02:04:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709258658; cv=none; b=jIXwVc9D/tqkeym7dOO1tq3/gzIecD1gBmB48Q5X/h40nrviuLOVKz89zbATiy/ryMboSNeIR6HfVt7GvbHDrfu9XqN3USSL1EXeK40fD9HsnM1HmxhpP0rBr7ofgDM7SUSVTgF+rDYlSUVSEQZmMeZLPiBtX3mivbRr30Wa7gY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709258658; c=relaxed/simple;
	bh=kxHqXJk1Dc8BgPCHVYO9lDy9yiyPRyxcxQAylPa7dIQ=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=O7kBchH1ar3sxyandr45XKBFiN0nw6V8BXWJ4KtxBhLRl91UbLqnWYhFzuizNPuE/1OoUy3lkEwP/6rwtYWMrzkQv4oFc9gcSXqL+9mxa5++zu4ZH3UWRqDiOPNfxTBzZfle0odRBBG3vrXqlGnFkTQUMWultZ1A71UJRvo+42s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=djvWg/JS; arc=none smtp.client-ip=10.30.226.201

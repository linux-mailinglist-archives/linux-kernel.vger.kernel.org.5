Return-Path: <linux-kernel+bounces-164101-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1BF0C8B7902
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 16:21:11 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3C3551C22AA1
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 14:21:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8B254180A92;
	Tue, 30 Apr 2024 14:09:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="JZ454VSx"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8A58B176FDF
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 14:09:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714486192; cv=none; b=qxjQNq6zUirGeZ+UJ3sYOS+pWsuLAAbMctxlibKcHAHGe5Ybjk/EfqmlgFxHW/GmNLqi0o4/7tFa1j87JrKrVMNanVLkdlIAFLK9iisKD25rDPzcgW8E+zMhKYUxVb7wJHIXlHFfAtu6dKBf25G+bqTxxfZdbIAC0it2SVwD2O8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714486192; c=relaxed/simple;
	bh=15kbpOfSJHafA12h1+t3U1yK6pKlGDUNqiTTEnHiVBw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=JHIxdBc/bxER+JvFNWem9j+wkNTIcPfHxrZ2+C2Aqa1/BcDMOKlszus5ZLMFXROCB/uqfAomDjwAywyMMSihfWjjFi8arSzhpJk/6D8keN7ygkDmqHDQehdxDlEC4jWT3tUkOWMqZpRzVYhBKYdfy7OhKDMX3azbPNnnlCIrDiY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=JZ454VSx; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=JZ454VSxPGnIc4vFaEaNesn/+IjJ/WNpJKs08FqdlGjwdWoJPAeS1dpQOXNLubK9Aiz05O
	VQneYObqueTTb9wj61fKRhSBmuKmN5OD38Irl0eZMYp2359vyCQev3PYmGSD7ZTjbPD6E9
	06sVyZ2ZjEIPAg4IRd4YVyIItYpzzgE=

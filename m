...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 415607544EA
	for <lists+linux-kernel@lfdr.de>; Sat, 15 Jul 2023 00:26:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229872AbjGNW0N (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 14 Jul 2023 18:26:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58784 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229437AbjGNW0L (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 14 Jul 2023 18:26:11 -0400
Received: from mail-il1-x12d.google.com (mail-il1-x12d.google.com [IPv6:2607:f8b0:4864:20::12d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 69DAF273B
        for <linux-kernel@vger.kernel.org>; Fri, 14 Jul 2023 15:26:07 -0700 (PDT)
Received: by mail-il1-x12d.google.com with SMTP id e9e14a558f8ab-346129c9512so5538695ab.1
        for <linux-kernel@vger.kernel.org>; Fri, 14 Jul 2023 15:26:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1689373567; x=1691965567;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=QCde0c3Uo4ARQGj1NvtiCweu8yHvVmucKQezX4fcijM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689373567; x=1691965567;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=QCde0c3Uo4ARQGj1NvtiCweu8yHvVmucKQezX4fcijM=;
        b=
X-Gm-Message-State: ABy/qLZ6mPHo9x1ZK1sBsGTUW6cuoqbHsFVo6xg4DXxuUBSvOAv4nC2L
        iGzErRBccIupQ6vcprut8v+1AyrvUSVuPGxvxsJky/okDUA=
X-Google-Smtp-Source: APBJJlE7Af+pZwHgYHTKpAdeuIZRRvNn5/R6tFOFFrJkerNO3p3jnXa1nKPPpcPXlu1XMIG9+sA0tl9MZIvzT9/P3K4=
X-Received: by 2002:a05:6e02:1043:b0:342:558c:d88e with SMTP id
 p3-20020a056e02104300b00342558cd88emr2509420ilj.11.1689373565794; Fri, 14 Jul
 2023 15:26:05 -0700 (PDT)
MIME-Version: 1.0
References: <20230714194610.828210-1-hannes@cmpxchg.org>
In-Reply-To: <20230714194610.828210-1-hannes@cmpxchg.org>
From:   Nhat Pham <nphamcs@gmail.com>
Date:   Fri, 14 Jul 2023 15:25:54 -0700
Message-ID: <CAKEwX=PB=q_Y=QtemFwrLAGxco1arfUrFfnqgYgP+vDHmOyMvA@mail.gmail.com>
...
On Fri, Jul 14, 2023 at 12:46=E2=80=AFPM Johannes Weiner <hannes@cmpxchg.or=
g> wrote:
>

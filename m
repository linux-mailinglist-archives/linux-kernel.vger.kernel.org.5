Return-Path: <linux-kernel+bounces-160796-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 9EB778B42F8
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 02:00:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B3E2F1F25AAA
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 00:00:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B458D4AED1;
	Fri, 26 Apr 2024 23:59:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b="XNLK0MSs"
Received: from mail-pg1-f179.google.com (mail-pg1-f179.google.com [209.85.215.179])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 76C8847F65
	for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 23:59:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.215.179
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714175967; cv=none; b=Wpn1FCZfPqcDyrXDGjIvTAMSLDg9Y5Fq/KtyTVutqa/BBbF54L7julMpmLiGHncqn7GqSGIAen/UF0dKVv6eFkq5b0MttrDFaOIAz0x57AOxle5eEqJf59bHu7EXJIboOA3X4V+m+UT7+Z6KJ4kf0wFP4CdT6qcMMJ5HFxSQ0MQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714175967; c=relaxed/simple;
	bh=Ymkg2Y4zLkJQYeRI3xYMLeWRXgn8akx60R2PPSsy7GE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=TZXcWYXPNb/fLJcDHM8awNslisqgS2fs9Zgiy7xWGowQfhl9dtYfyNIPA4OqYY+S2dewdMaBCfAGYYd9VaiZYG7uz9TyvPdmT5br9NZ+ksNoNX24KHIK6ZrVl3wlK1nVHqSzXrp6lLW9l9is8RjRdOmXT6gSgxF2jMLQzmc2nJc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=XNLK0MSs; arc=none smtp.client-ip=209.85.215.179
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-pg1-f179.google.com with SMTP id 41be03b00d2f7-5c6bd3100fcso1860985a12.3
        for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 16:59:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google; t=1714175962; x=1714780762; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=6dlue2iwDfflC7NvkUReEv0gDm2tpEeiUAwYd6UUu6I=;
        b=XNLK0MSsi4bi8Me43W9/EYlQsRNfYgRH4aUUa58z+dr4BDwdJAFE0pb2NbqggxoS+j
         h4+4uAW/aFWbrCJXMcifSV2XsdXEQfD7qeaXUljvzXRDPuH27X78Hip6zq3mhvMbKgdz
         CZSY+sYTRMTgpczkhJIACjH6O9qLf24+7GiNw=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=6dlue2iwDfflC7NvkUReEv0gDm2tpEeiUAwYd6UUu6I=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW0GWPN8hku87oRCOnu9DDqwQLZ7MRUg2Z2kVqjOQcP6ouWfCtuNU89Dxu8PXtruIP+nSnOTr04PCQiYjcXIRfcB978Gp0mvUcnhS28
X-Gm-Message-State: AOJu0Yz5sD1cAr0D8ZeKCS7/3Z/35bbdwcCMngjoc3PAdvMM+oFhMmMH
	NFIRcmLb4OGYBIWdvQ38zc1FLUggxGb83L2aY7/p69pGDdycmI2nBB9/0I3v9Q==
X-Google-Smtp-Source: AGHT+IGIK7O0ZshRwZbd9y5mAZjepQZqZoTBToQrEtL+VDbotdTYwJxQ5LO5oNXZfRLFhyCNRHSjeg==
X-Received: by 2002:a17:90b:4ac8:b0:2a2:dd53:828b with SMTP id mh8-20020a17090b4ac800b002a2dd53828bmr3989707pjb.43.1714175960467;
        Fri, 26 Apr 2024 16:59:20 -0700 (PDT)
Received: from dianders.sjc.corp.google.com ([2620:15c:9d:2:fca:3ae2:20e6:82bb])
        by smtp.gmail.com with ESMTPSA id n4-20020a17090aab8400b002af41bd563esm5111939pjq.33.2024.04.26.16.59.18
...
Subject: [PATCH v2 7/8] drm/panel: boe-tv101wum-nl6: Don't use a table for initting commands

Return-Path: <linux-kernel+bounces-154096-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 05F468AD75B
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Apr 2024 00:37:49 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A367D284880
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 22:37:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 91D6A2137F;
	Mon, 22 Apr 2024 22:37:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="PIWkvXu2"
Received: from mail-lj1-f173.google.com (mail-lj1-f173.google.com [209.85.208.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DF36D21353
	for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 22:37:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713825440; cv=none; b=JqfLnnbDo1GskNo95yoy275JpvY+GSdYOhFzqKbwDwoMW31wiQOXZBvUhzm23+6gp4f5DpSr1qRFE+k5azzlcmFJnOa22Rq/rJbA8sJutuTiMfIebJNAQk4iNYRlbiPAh2AHzrEaZThX/eOuiJyZYEihcW/UskWn5RKEe/lUi3g=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713825440; c=relaxed/simple;
	bh=r44CN+ESjmYktPaczYpD0+pSSkOdxrCr0U/bsMu2p78=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=kMA8ko6ulvxJg71IGjWaje7clFJjHnfzOO0Y9Ec15IFQ1gPiZSo9cwHJajZOozoE6qzRS6h2aoUHzTcUkuX7MxuJXADqDmZBmMRtBNhf8wZ+ANoLGzLQeRuihoTwid0y0/XXIUMjIp0p4MUrSxq9UnC87KwPp8IwjHalhyur+0U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=PIWkvXu2; arc=none smtp.client-ip=209.85.208.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-lj1-f173.google.com with SMTP id 38308e7fff4ca-2d895138ce6so70579951fa.0
        for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 15:37:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1713825433; x=1714430233; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=1psqzR1FIFL0yrKv5AWqgD2Hj1JRQaPdQ5A3gMMZVLg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1psqzR1FIFL0yrKv5AWqgD2Hj1JRQaPdQ5A3gMMZVLg=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVkU6mxopdO0ri/Y51+u8zM/IxJVE/Avz8QcRuHHyO3MnHWu0TwRtFAeGIeSeOV0/M83b7AbIPAmlaIwGeXX7/xSOAFHfrwk7iF0WCF
X-Gm-Message-State: AOJu0Yzczhyme5od5fNaNgLJ81It6kuupgeHEzz24dbjBZWYGhaQjqSU
	VztezpLM0deYisqh6JWpEZbXX2+5viubQMy6w8fS7KuLzfND46viiJTYjMban7g=

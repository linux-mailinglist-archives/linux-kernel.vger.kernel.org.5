Return-Path: <linux-kernel+bounces-79557-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 7BAB186241C
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 11:16:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 9E3561C2184A
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 10:16:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 452101B96E;
	Sat, 24 Feb 2024 10:15:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="JAAQG0mE"
Received: from mail-ej1-f42.google.com (mail-ej1-f42.google.com [209.85.218.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 893E73BB3A
	for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 10:15:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708769723; cv=none; b=BimSMsD/teAK0Jyp9nPrDKklVT85bzM0b1emOvl9uswFGLtLqwNcxc4vvgjH42IBYxja5gCDh729ROiBdFJcht8bdCpX0Kb4tgLAZntwLH9+jaha4mybBOwjNixtSu6IgGyklwEUi8Bx+8Gsx06exBRvLr5pAN3YjUFqIqmTYnw=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=JAAQG0mE; arc=none smtp.client-ip=209.85.218.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-ej1-f42.google.com with SMTP id a640c23a62f3a-a3e4765c86eso169160266b.0
        for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 02:15:21 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=KXbAugNEprUKrZcZOHEuG4q3QGFsm893pRwYxVtSKSo=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUUm+xM/YU9L6ckfshRVv+5peq1xDd3SnJ6Joum8A3ZwGQbD2G9nHS83PPEHjCn98FBl5Tj9Hv2mZZkOQ0pEs+o6uNzd2QdjwHw1Kqh
X-Gm-Message-State: AOJu0Yyz3ROxeZH//pcybDtigdCGRZ7qZrJ0u+DlEf/UeZ6inWEVPHXY
	8ZuZI78u0Ktxp0rlJIeqXCLhj4ZvwJjyBG3jinpCAFH6e3gaX29IKKsh+wvvsGc=

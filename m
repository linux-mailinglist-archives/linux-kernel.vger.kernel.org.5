Return-Path: <linux-kernel+bounces-85301-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id BE98186B3B0
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 16:50:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 36F261F2CFAD
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 15:50:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ACF8515D5CC;
	Wed, 28 Feb 2024 15:50:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=samsung.com header.i=@samsung.com header.b="GeNE0TGA"
Received: from mailout2.w1.samsung.com (mailout2.w1.samsung.com [210.118.77.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A7F1024B39
	for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 15:50:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.118.77.12
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709135421; cv=none; b=Fnd456Ms7u/lZk3t9AvS4dlBepS72jU8GK8UE5GkQENHts4tBzwBQyiYbuyYRdwWu0YDLydEqi8MiK/D/ZLgLDCoe5XFDAKzAhTFWUeZnKF+oxJYXEa6/tXvlIsAaWcF2WMgejPQh9zlHY0KNCBSx9K7MdVghgpWQnQe9jZWIco=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709135421; c=relaxed/simple;
	bh=87JHNQZaA9y17Sa7HpJjvpiSvH9z/gQYfQrrCqUQphA=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:Content-Type:
	 MIME-Version:References; b=SBZpqyEcigTptgLB/whZtMLv4Nr+Sp/LcaHhjcoA+9EBEsYXXCj4lKtFIPqChvxz4L+S5Z1+cssB9pPWdsSHkE8AmODoOKbtX7fQTOob6vQlp2ZTpYEXTdoTTe3uVcm19kQq3bPbPBIf+B9c0gqKUlXdXgacUj8h1kQHmV5rFxg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com; spf=pass smtp.mailfrom=samsung.com; dkim=pass (1024-bit key) header.d=samsung.com header.i=@samsung.com header.b=GeNE0TGA; arc=none smtp.client-ip=210.118.77.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=samsung.com
Received: from eucas1p1.samsung.com (unknown [182.198.249.206])
	by mailout2.w1.samsung.com (KnoxPortal) with ESMTP id 20240228155011euoutp02556d2f9be5b28d044a7bd26894ea23a5~4EZnmKvt-0436204362euoutp02E
	for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 15:50:11 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout2.w1.samsung.com 20240228155011euoutp02556d2f9be5b28d044a7bd26894ea23a5~4EZnmKvt-0436204362euoutp02E

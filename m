Return-Path: <linux-kernel+bounces-138881-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EF5A89FBDC
	for <lists+linux-kernel@lfdr.de>; Wed, 10 Apr 2024 17:41:30 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 14867B2E87A
	for <lists+linux-kernel@lfdr.de>; Wed, 10 Apr 2024 15:31:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B6A5A16F0D7;
	Wed, 10 Apr 2024 15:31:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b="LpdqUZvy"
Received: from PR0P264CU014.outbound.protection.outlook.com (mail-francecentralazon11022019.outbound.protection.outlook.com [52.101.167.19])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0043B16EC15
	for <linux-kernel@vger.kernel.org>; Wed, 10 Apr 2024 15:31:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=52.101.167.19
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712763080; cv=fail; b=ESLvtundN9QUwDxyjG8oX/8T27I5WVZ82H/cjRPS4jt6bXp2CV11HrIF7vjD4OonxEx7EoIILIap8THaAs0/38oFvobVXdhKBS6RUJUpAVJ8vi8rV4IPqMkULqv5nkrfy2yxiqFRZO+/b73bfczPNfP+kMmFt8o9/z8D2OgPn1A=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712763080; c=relaxed/simple;
	bh=qtsa9byHKfIuT4apTnJPxiVL47VLLSsX5+Gox16Jap0=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=JHHqA/AG2FvXYAXI072tf6C/dNkqHXryoZk9I84y2VsVxrcY+2cEbzF3lTU3/2kGyKGJIFF7Ue+OWkFVDObPq1Kt1XI+HyXFPW1zlR7m76699IfmB1hfZaApfyJd5Kg39/UbSsC1TZNN4sSNxN3TN+ZLNILI3tHqkZL8uWyQ6BM=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=csgroup.eu; spf=pass smtp.mailfrom=csgroup.eu; dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b=LpdqUZvy; arc=fail smtp.client-ip=52.101.167.19
...
CC: "linux-kernel@vger.kernel.org" <linux-kernel@vger.kernel.org>, Michael
 Ellerman <mpe@ellerman.id.au>, Nicholas Piggin <npiggin@gmail.com>, "Naveen
 N. Rao" <naveen.n.rao@linux.ibm.com>, Benjamin Gray <bgray@linux.ibm.com>,
...
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?dFA2NkRnVnl1YTE1K1JFaThlMXN1dUlrMU0wVWFOWmV0dnJEanlUblVQbGRx?=

Return-Path: <linux-kernel+bounces-37927-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id C957983B85B
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 04:35:51 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id EF2541C2334B
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 03:35:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CFF02D287;
	Thu, 25 Jan 2024 03:34:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="R7EM/R36"
Received: from mail-pj1-f41.google.com (mail-pj1-f41.google.com [209.85.216.41])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1AAF98826
	for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 03:34:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.216.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706153684; cv=none; b=q6opbwcbANScOSNWqKUwEB8Ee5mfhsUgigmDevmzCqd9t5WDLPEl2Z6NjA4ppUSpwaRoPDUoNzo1ooBDm8aTtvEvUO+pVRn9dmrtSu2bUoymlrYgqemq50pLlznu84xm9OqeVJWDui7d6orh3trHMNIsYEl7niJHCtYGLTDMdcc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706153684; c=relaxed/simple;
	bh=DEocBoLdz8CoqgSH6gVOZkL3WPdRp/r0QSiZ5G4JxRI=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=TbnotopXwibYhAxZImoCUA2DLS8xQUZK+896wZoDyZ4pxD3GEJZYCHkZ/7g+V9sAvy6uP58awyA5hfPmyXwa6Ol8hdG1TwCqPqHrAypPSFKb9BYi+o41TmmJ+P4C9Tp1exCZsTBGJxfNq0BxGF32mhApvTlslamqm9NUmm1v+UU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com; spf=fail smtp.mailfrom=broadcom.com; dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b=R7EM/R36; arc=none smtp.client-ip=209.85.216.41
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-pj1-f41.google.com with SMTP id 98e67ed59e1d1-29026523507so4723929a91.0
        for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 19:34:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1706153682; x=1706758482; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=VScl9iVwttmBxre50mE2dwWfIbvy9RRgI/UKF9iWx9o=;
        b=R7EM/R36uOvpEjnB4enSXMgtqg8LaAmE7jEHCN8B01oERvFkCDn1i9XzAeSiZHCRli
         j5bQHCw7OtcdJP7B8Npzq2dRzruQzWzSCP1WXyBULpmrTCh8U6a6DM9KUeUl+huybrGz
         A3Q21Wkg37dA2GFhWnQt5uxs2EFRwxpB9vivo=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=VScl9iVwttmBxre50mE2dwWfIbvy9RRgI/UKF9iWx9o=;
        b=
X-Gm-Message-State: AOJu0Yy+wXmJGBbIrh87Pt811x9vTcHtDgMcySckgLva/zkQtrLPBlEx
	Iy6qz4ZWZojnYyVzf+nzNVJNjuTMciHlA2qWgrwQWskfyuJutyZvmKKQn/I/dQ==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000302767060fbcdcd2"

--000000000000302767060fbcdcd2

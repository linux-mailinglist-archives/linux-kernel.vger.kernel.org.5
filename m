...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0009F7E0361
	for <lists+linux-kernel@lfdr.de>; Fri,  3 Nov 2023 14:10:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377470AbjKCNKf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 3 Nov 2023 09:10:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48764 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377096AbjKCNK1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 3 Nov 2023 09:10:27 -0400
Received: from mail-lj1-x22a.google.com (mail-lj1-x22a.google.com [IPv6:2a00:1450:4864:20::22a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E7AE21BC
        for <linux-kernel@vger.kernel.org>; Fri,  3 Nov 2023 06:10:19 -0700 (PDT)
Received: by mail-lj1-x22a.google.com with SMTP id 38308e7fff4ca-2c50305c5c4so28980371fa.1
        for <linux-kernel@vger.kernel.org>; Fri, 03 Nov 2023 06:10:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=semihalf.com; s=google; t=1699017018; x=1699621818; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Ct2b7qLLtnf8Wqvv6t/AwVn4yO4VWwiciLhACuMIYEU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1699017018; x=1699621818;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Ct2b7qLLtnf8Wqvv6t/AwVn4yO4VWwiciLhACuMIYEU=;
        b=
X-Gm-Message-State: AOJu0YyhGNbp/6BLHVlzbY+kYAgrx7xUTYzEsZvF6GlYBGMQQCSOUd9I
        HbFod3GizTbdZKqz8cWhY+ob
X-Google-Smtp-Source: AGHT+IGee3fv2eUtrFH8YXMTw/8aeFYkce320CklKRvnm3HsaZ5iKDuzZL1sIdt6xbpHTJaDYPlrgQ==
X-Received: by 2002:a05:6512:688:b0:507:9a13:27bd with SMTP id t8-20020a056512068800b005079a1327bdmr20841877lfe.7.1699017018231;
        Fri, 03 Nov 2023 06:10:18 -0700 (PDT)
Received: from ukaszb-l.wifi.semihalf.net ([83.142.187.85])
        by smtp.gmail.com with ESMTPSA id f21-20020ac25335000000b00507a69a4799sm216336lfh.270.2023.11.03.06.10.17
...
Date:   Fri,  3 Nov 2023 14:10:02 +0100
Message-Id: <20231103131011.1316396-4-lb@semihalf.com>

Return-Path: <linux-kernel+bounces-36545-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BCBAF83A2DE
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 08:26:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6B3682833F7
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 07:26:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B2715168BC;
	Wed, 24 Jan 2024 07:25:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="JDUKMgx/"
Received: from mail-ed1-f48.google.com (mail-ed1-f48.google.com [209.85.208.48])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 28F4E1643A
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 07:25:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.48
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706081152; cv=none; b=d+pk0O9CIQZfyfKrL0aRo+rWI+vvCY8WHLy1a5ZHOs61eB1qHOLE1ZN5n4xmgFK1JmefQHDcmsAaCPfuEmX78mZnP4O3aT2NvZCQs+CRuNIZ39cHSn7dM9jW+WRegP+RYP9ES6g1187q0JZxl9lABNVAJ57SyjaOsbbO5KEDb1s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706081152; c=relaxed/simple;
	bh=GG/HcPO1DQSgv4DAl0mZWYwShCYfcCY7QJyxV8qBaVs=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=uPp7OqNikphjcJLBrp0CV3Ef1Dd2LMRcQoTBEw6ktS8uBTcg+uqcNAg2AX33dsoDMjMuweXkeKBmVcmCaQUx/1f1rjhO9l8evhgjhBd8NHq8EALm6E5OPRdyQNNf54vG5misdkLOs7MrUAYeDYa6qBVP2wozqyJQv8/EnoVs16Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=JDUKMgx/; arc=none smtp.client-ip=209.85.208.48
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-ed1-f48.google.com with SMTP id 4fb4d7f45d1cf-55c24a32bf4so8286a12.0
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 23:25:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1706081148; x=1706685948; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=2LyJOTuCyMjVu1tci5XqwgmTLOr8NoaB/EbjE6umPgM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=2LyJOTuCyMjVu1tci5XqwgmTLOr8NoaB/EbjE6umPgM=;
        b=
X-Gm-Message-State: AOJu0YwKTs8wtSHa76hdOij8s8hCPdOjOQQH1oXNV+I6fNjSJfDOyeqK
	l5eQH/WnMx1Q+oCPupy+pYqfVBlxbgIiJUegF7Ze8B6LofgtYHq4X5a3anTWIrISYOo70H18LDf
	D9qR6QasjrvALRj18HjUjKDbx9HQiqDpmTC28
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000d19e54060fabf8c0"

--000000000000d19e54060fabf8c0

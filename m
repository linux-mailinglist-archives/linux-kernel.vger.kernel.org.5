Return-Path: <linux-kernel+bounces-59967-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id DBF2584FDF9
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 21:51:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8D20C28AF81
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 20:51:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4CE0717BC8;
	Fri,  9 Feb 2024 20:51:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ZeuL9StI"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 29E6E6AB6
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 20:50:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707511865; cv=none; b=OS5Ezr9sEO29CfXgYvG0hy4JW9VETWO8m0yl/V2Ol4+CSNGsDDmSdBVNvgm1ixa1kZepYEukw3D0l6RqXE4RovXKhiENNPyZcs7DBKbChMQgscWvM81uxFNuF2eYUjtlkmMh9v7ANOLJca+ze2M7DpcVCLQpli4ZbW62WiR2ScU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707511865; c=relaxed/simple;
	bh=x1H3BxWyekgMHQiQR4IPk2BLGxdEIvocdS/b+TyGwP8=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=cXPVxb0bHoW7ARsdOJBVygf84PAZBDr2AeClzVyRU4xWqBHj3n+nOqIaf4Skkn2mGwucSP8ZchRS62HdEEZPmKe7hMO0Wf0pn8NbIAoUzvrVAZSCQL9fGdNbDd3B7l/0wpNx94l6XqGdu34K0ZJtxQhpmanl+WmsH1OzxsHjZPE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ZeuL9StI; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1707511854;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=Wg6/WxUSjxqOXwO8dHQJDlZcuHs3E9IcvX3XS0+j5b0=;
	b=ZeuL9StI38KzZI17LzPOe6kSIblJ41Ijog87EyaH69w+xyqprwEVh2CecRZJAEfOf5LPGU
	afHxqtgWLNQA56GzLi/bZivlLmvzYU4IGoAff+CV1w3mb8PZug2+fdOr697d7veNnYQLfW
	MC/24FuoMlEUtt3w79Dkq1yctF2ZAIM=
Received: from mail-qv1-f71.google.com (mail-qv1-f71.google.com
 [209.85.219.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-48-RYwW5C9qOxu9r0b6JAfZGg-1; Fri, 09 Feb 2024 15:50:49 -0500
X-MC-Unique: RYwW5C9qOxu9r0b6JAfZGg-1
Received: by mail-qv1-f71.google.com with SMTP id 6a1803df08f44-6800e52d47aso51825346d6.1
        for <linux-kernel@vger.kernel.org>; Fri, 09 Feb 2024 12:50:49 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707511849; x=1708116649;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Wg6/WxUSjxqOXwO8dHQJDlZcuHs3E9IcvX3XS0+j5b0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU1mSv+CiXwDw/xNCkx3r4g2ITkLSW5NSHNF52pRuvH29PxQv36WZ42IsJQmgNfKg+mdk4MT6X6PoHJpA9lracFghrYJK9rJnVhZDo4
X-Gm-Message-State: AOJu0YxKj+uPqGU3TG6BwJ2XFShKZEvuKjtS7d/onR4p1WeIx10xAJ5N
	go6HT8KAKlkN2GJ0RyMcVaN9BHKG0IJ89x6TAf8Zu7hoR6zle5Nf+bZi/6mf+f+yePCWFNhILAG
	S8i4ycS2iOtvjgLMGVJGEGPqvLFn9ZxYr16OzTSCPjyATuowO3gGteWeCC4qfKw==
X-Received: by 2002:a05:6214:5a07:b0:68c:8218:30a2 with SMTP id lu7-20020a0562145a0700b0068c821830a2mr3569997qvb.0.1707511847627;
        Fri, 09 Feb 2024 12:50:47 -0800 (PST)
X-Google-Smtp-Source: AGHT+IFPnzjZ1LFzmfS1Qk6urB1CH/BKfVXewy+OZNAcM6nIA4drMJ+zsU06SChUvyT+6XZqSun48g==
X-Received: by 2002:a05:6214:5a07:b0:68c:8218:30a2 with SMTP id lu7-20020a0562145a0700b0068c821830a2mr3569955qvb.0.1707511846416;
        Fri, 09 Feb 2024 12:50:46 -0800 (PST)
X-Forwarded-Encrypted: i=1; 
Received: from thinkpad2021 ([71.217.33.204])
        by smtp.gmail.com with ESMTPSA id b23-20020ac844d7000000b0042be6d99d22sm993604qto.59.2024.02.09.12.50.44
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 09 Feb 2024 12:50:45 -0800 (PST)
Date: Fri, 9 Feb 2024 15:50:43 -0500
...
Message-ID: <ZcaQI8l1dcBx2feC@thinkpad2021>
...
I made a note of that. Will try to use those in the future.

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 315557A9A9F
	for <lists+linux-kernel@lfdr.de>; Thu, 21 Sep 2023 20:46:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229586AbjIUSqo (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 21 Sep 2023 14:46:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46296 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229493AbjIUSql (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 21 Sep 2023 14:46:41 -0400
Received: from mail-ed1-x52c.google.com (mail-ed1-x52c.google.com [IPv6:2a00:1450:4864:20::52c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A1820EE5BD
        for <linux-kernel@vger.kernel.org>; Thu, 21 Sep 2023 11:46:22 -0700 (PDT)
Received: by mail-ed1-x52c.google.com with SMTP id 4fb4d7f45d1cf-53136a13cd4so1538399a12.1
        for <linux-kernel@vger.kernel.org>; Thu, 21 Sep 2023 11:46:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google; t=1695321979; x=1695926779; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ozcv+tNcrjJTNVnx50veCSyyrwlXIHAIqy4hJ7iqZd4=;
        b=PdPD1QlVs15jhXTeDojbldVMm1gapUjEecI6NDpgul6yHF4IHyo1hpkHV3C3IbmpQU
         W0cbdrmNU6td1pJcOBYLLi8WXgJeJ+T8idJYvwaEFnVE8yM5nZz7EkrATS/eYct5it6+
         79shpPqDulv3buSE98QTLo+NywwQcLuu+Dbqg=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ozcv+tNcrjJTNVnx50veCSyyrwlXIHAIqy4hJ7iqZd4=;
        b=
X-Gm-Message-State: AOJu0YxJt5HSEEhX+8K17WbZiD+X0YIC5T+TcJkPb9IOePu3ARvhuPUj
        OzFX+pXrDtWMkp4Wya5TgW/z70dDsGkOtz5GSmnEIw==
X-Google-Smtp-Source: AGHT+IHzSf/nXw9tRI32QSfblNyEbqHVYpdayxRZA1c4DBUx1gJoHUEynWz+jPpoTSG/0kE3egfDnw==
X-Received: by 2002:a17:906:53d9:b0:9ae:513d:de22 with SMTP id p25-20020a17090653d900b009ae513dde22mr4059885ejo.56.1695321979440;
        Thu, 21 Sep 2023 11:46:19 -0700 (PDT)
Received: from mail-wm1-f49.google.com (mail-wm1-f49.google.com. [209.85.128.49])
        by smtp.gmail.com with ESMTPSA id y9-20020a170906558900b009ad854daea6sm1419821ejp.132.2023.09.21.11.46.18
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 21 Sep 2023 11:46:19 -0700 (PDT)
Received: by mail-wm1-f49.google.com with SMTP id 5b1f17b1804b1-4009fdc224dso20175e9.1
        for <linux-kernel@vger.kernel.org>; Thu, 21 Sep 2023 11:46:18 -0700 (PDT)
...
References: <20230901234202.566951-1-dianders@chromium.org>
 ...
 <CAD=FV=WSdp=5DnJinELOSncX=eqrN9y27kw=VFDHowzgnTS6Qg@mail.gmail.com> <ZQtAuKBwo+ue8QQQ@shell.armlinux.org.uk>

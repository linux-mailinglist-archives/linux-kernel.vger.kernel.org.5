Return-Path: <linux-kernel+bounces-119405-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 754B488C84F
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 16:58:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2A7572A5F2A
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 15:58:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2A80C13CC6C;
	Tue, 26 Mar 2024 15:57:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="N895UDzr"
Received: from relay7-d.mail.gandi.net (relay7-d.mail.gandi.net [217.70.183.200])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6B5BF13C9AE
	for <linux-kernel@vger.kernel.org>; Tue, 26 Mar 2024 15:57:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.200
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711468630; cv=none; b=vA+OmiL69FBkTWw8BgCSAVTB3LP/XHahFQOTPVtjc53kAkXc/YwNJX6FhbruoEejm5iTK+2D4fEpcwD/YSakyENqZSuKAOcJqqxJucVmBBo0ywWo5xBq03b6xAvo3wAGtXTOD3sn1uV6xuZjZRm4nMGlTfgc84HFAFUxp3FuNzI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711468630; c=relaxed/simple;
	bh=+OrOWBHLZ66bSbCyi0qcv6E4qKvbvNF79ErvlcUC578=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=pyCUZ/c5dq5al7vZFDE6/1i3B2vpiH0Al2ZkpO2UFHfXNjvYfmIjYzuiDlekHcetTatz8amv4BO46K7Cq8newi3Ybf0+Zk0VomVHWM/4uVisqZimVcF0jmC4momBh+2d2mdjAckVp+hWE3excsGR1BlfHi/ZJ5Cg/1eVx61OfSs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=N895UDzr; arc=none smtp.client-ip=217.70.183.200

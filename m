Return-Path: <linux-kernel+bounces-134055-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id D2BF489AC97
	for <lists+linux-kernel@lfdr.de>; Sat,  6 Apr 2024 19:57:47 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 4ABAB2828E3
	for <lists+linux-kernel@lfdr.de>; Sat,  6 Apr 2024 17:57:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0892A45959;
	Sat,  6 Apr 2024 17:57:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="OdffbgDd"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BB5723EA86
	for <linux-kernel@vger.kernel.org>; Sat,  6 Apr 2024 17:57:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712426260; cv=none; b=BURfFa9q0VctL/DzF3KuC/620gE+FkEBFWu2rYCIWyOWJW9WcwIrHB4ZKeZZqF/hUMd35/AQBzFp7nMF41QJHK0JRBhNh8J0uydL/avha9qAz2yNqQa89vhzdul59PRnGE2pWc1fBsbwhD//v04zKpuQYmbsdZ+nePgXkjr8aXw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712426260; c=relaxed/simple;
	bh=QCupe60Wi+dfmZCvC412Qmcmr7ZevvaEiPxSMLn4g/4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=ofCe43EhUkZ+S1GF7S3BnnnEsvj6H2ex8dHjKsREK9I1CqwFSQmyGJJqeZCQmnWzQhmYgIMoh2nU3mRfM19bZ7xtjyuSaWUblmngGnLA0cOnjqP0TT60oJDRmlbgCGJIiKlvM1J3HjczG8Dp+L4Gv8iMgSy2zeT3nLWV3diQzuI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=OdffbgDd; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1712426257;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=GReCWnFPjN08AjP0bPCM7WpKp2nC3psJcp83CUkmhh4=;
	b=OdffbgDd80GTn2AyeG8h+fk3Vgd6P9tjNDP+hyvn2avKL1G+Qmm9joLMtVdHf0QrUA/opl
	0E0zzmknH56/4wo1JANzfdpQ1HEmucMBAbie+HvV2NbtI/EQF5eBzfcNaBTrdHzgbKfSeZ
	jIWCA1TX1IslSbufJ37pjw35CiotYmM=

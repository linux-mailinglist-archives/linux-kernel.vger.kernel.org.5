...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7F26377B4C7
	for <lists+linux-kernel@lfdr.de>; Mon, 14 Aug 2023 10:55:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232986AbjHNIyo (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Aug 2023 04:54:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49246 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234922AbjHNIx5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Aug 2023 04:53:57 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4AAE191
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 01:53:56 -0700 (PDT)
Message-ID: <20230814085112.803864641@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1692003235;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=YEUGY/VnQEggbRIpLvCb5kRW081uPfIIdruq26+YjFk=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1692003235;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=YEUGY/VnQEggbRIpLvCb5kRW081uPfIIdruq26+YjFk=;
        b=8E7Bkmr3c+zE2L1zNPcpmrFQFRwqyhjusjR8ZWm9WBe4ucmwv9LG93Awgq3x8pIq71Xsux
        5NHZbNnwZUgLNUDA==
...
Subject: [patch V4 13/41] x86/cpu: Move cpu_l[l2]c_id into topology info
References: <20230814085006.593997112@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Mon, 14 Aug 2023 10:53:54 +0200 (CEST)
...
@@ -396,8 +396,6 @@ static void legacy_fixup_core_id(struct
  */
...
-
 	...
 	if (boot_cpu_has(X86_FEATURE_TOPOEXT)) {
 		int err;
@@ -425,15 +423,14 @@ static void amd_get_topology(struct cpui
 		if (!err)
...
@@ -450,7 +447,6 @@ static void amd_get_topology(struct cpui
...
@@ -458,7 +454,7 @@ static void amd_detect_cmp(struct cpuinf
...
@@ -476,7 +472,7 @@ static void srat_detect_node(struct cpui
...
-
 	...
 	if (boot_cpu_has(X86_FEATURE_TOPOEXT)) {
 		int err;
@@ -94,14 +92,13 @@ static void hygon_get_topology(struct cp
...
@@ -116,15 +113,14 @@ static void hygon_get_topology(struct cp
...
@@ -136,7 +132,7 @@ static void srat_detect_node(struct cpui

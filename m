Return-Path: <linux-kernel+bounces-118937-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id E51B688C18F
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 13:06:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 58088B21E7B
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 12:06:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F1F2C6FE2F;
	Tue, 26 Mar 2024 12:06:16 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4B2B21848
	for <linux-kernel@vger.kernel.org>; Tue, 26 Mar 2024 12:06:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.140.110.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711454776; cv=none; b=Vhhbou4fXOLwelTEkzsPpG9vg4N7f+Te38lVHJIpVsoIJV+xHXKGxPv9EthWYuKJ/LYP5Dh9k6W9Zt8LYfDj3wGaRpk1RFR/M3D11y86/bEvyVTrr1BFqCfeyE6QoCh0UIYlvo3E6GESVl9V7erXaBVt6AJ/fNEViYlZSMpSEL4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711454776; c=relaxed/simple;
	bh=v0uf5GrWsHyZm/0Bj5GWJXfRRxuPFhvK7S79fvE7I5o=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=BUSs892XOULiLScceVIsgWI20KlSkG39zKpi4vxyAbQ+bQLtZK4/aPrPDqGbGT9OfgBcad95AAPU37ws81+xkEvnDCUwjG4QE1W+76xDi3kuGBKRfqkZmMZF+0NYxJ5OF12rbF/8NqbKgQs61e2GrTMW8qPITjZr/tOKAdRzU6U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com; spf=pass smtp.mailfrom=arm.com; arc=none smtp.client-ip=217.140.110.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id F3E712F4;
	Tue, 26 Mar 2024 05:06:46 -0700 (PDT)
Received: from bogus (e103737-lin.cambridge.arm.com [10.1.197.49])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id DE3483F64C;
	Tue, 26 Mar 2024 05:06:12 -0700 (PDT)

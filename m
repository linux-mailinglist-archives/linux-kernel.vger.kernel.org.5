Return-Path: <linux-kernel+bounces-126963-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 75D8B894507
	for <lists+linux-kernel@lfdr.de>; Mon,  1 Apr 2024 20:53:37 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id D05D91F21BDF
	for <lists+linux-kernel@lfdr.de>; Mon,  1 Apr 2024 18:53:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E4BC229CFA;
	Mon,  1 Apr 2024 18:53:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="OaRiiBOJ"
Received: from out-170.mta0.migadu.com (out-170.mta0.migadu.com [91.218.175.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1FEC6F9DF
	for <linux-kernel@vger.kernel.org>; Mon,  1 Apr 2024 18:53:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711997605; cv=none; b=ikWRSQC7DgWdwIQ9yeMUAM0vvKuQB1xttUTWK41sobfAaeUYib+uxDo8pb8FiRDVGx7PSE7tQ7TojGH2bRO0AlIrvKVB7x8EdH/PDZhF9m7PMZFoFWJjEgPWfyLAkiPd4fyGnj7s677XLiVkBTI6sqkuVaGkG5FCMNCVh/3t4bM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711997605; c=relaxed/simple;
	bh=yV8aLM1BNUJXdq5Dblt4rHJNCh3gARz7lOjjZ2L1VFY=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=aVDlCVYMQ60pDTAsbuO0goz6JR1AOrpAVuRkHzslmfqSp5CFuSgaMH79USLKuNcSwHn0S+i7WOHa/C2hmfgSwtMF+y557saaYM+AIJW1jc4qJE+7aXgf+7WoKU03Gq3JeMU5Y79lsMHp0oTn3EfErFeN82HfbbC9H8cMGbzFu2Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=OaRiiBOJ; arc=none smtp.client-ip=91.218.175.170

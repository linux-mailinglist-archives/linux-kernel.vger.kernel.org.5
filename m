Return-Path: <linux-kernel+bounces-45932-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 50635843800
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 08:38:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4CFCE1C25628
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 07:38:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D59B154BD8;
...
Received: from mail-yw1-f176.google.com (mail-yw1-f176.google.com [209.85.128.176])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7993951C59
	for <linux-kernel@vger.kernel.org>; Wed, 31 Jan 2024 07:37:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706686676; cv=none; b=nTHHO6CFlyNZ/Yzt+549uvNwNk/zHduvlGU87iy7drg/xTT2DZD1nJ8jTvW8fj1wQT5bxwUJheQmJUMduG/AXTeokJdUPKAEkY0A8EFGQg6UwkMkxCphw0HZPhumHO0jiKUeLbSbSeq/jkChU35idPRjoovq658/H8LlSdtIKs4=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=qugRA3lU; arc=none smtp.client-ip=209.85.128.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-yw1-f176.google.com with SMTP id 00721157ae682-5ff821b9acfso46316777b3.1
        for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 23:37:53 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=TmG+rznpqqyErX4zfSJ54u90o8JuQXslthwDpqEjAiI=;
        b=
X-Gm-Message-State: AOJu0YxoP/hEzuyRGiVcvaakd5kbMjm8LueBsMCVleapSCIH8Hq9M2ZI
	ofkt1wLsO1AwFf99yUdVE34abgv0anQbqYaX1QAJl2BJAhTN2126CQ5P6psdI3Izis+ya0WNalG
	zBTv22rNX+u8LxEv82F9pOPa3w+RzhdDxzPN/Zg==

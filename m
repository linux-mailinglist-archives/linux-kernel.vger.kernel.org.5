Return-Path: <linux-kernel+bounces-32603-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 0353E835DCF
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 10:14:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 27F9B1C2429D
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 09:14:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0DCF43A1C0;
	Mon, 22 Jan 2024 09:12:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="GYrGHRpr"
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AB1763A1AF
	for <linux-kernel@vger.kernel.org>; Mon, 22 Jan 2024 09:12:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705914777; cv=none; b=HjPne+aV0GbHSrWv8cyFJKMBBZiCg7kZKb+aGcvh6LC+xZ4Wv4Df3qN46TD7EG3IUvjpbkRDpLmWPZMYE4BppSA4bPRzF29wOAM7EcH9nX0NytzSTd4wfzdOtxuo+FkayA9pCK8Yu7crE5fftnXpAuu8oux9W6j8QnZOqlnQ9VA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705914777; c=relaxed/simple;
	bh=WtGP1AHer5Q1wc5J6xuAlLFLTWrN4iBoK96MPonlw1U=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=WMHI7VHDS92cLdTf4VJaX4rAPRPduN3ZpbXjbGXK33fKdudM1bTdL2zt3P7EWlU8zxwPjouQVcHXj3PTlK4tVjDzwmesNBCpb3VvxDL97WAXKYykH5TdMnqmZOMKrlFetHn/1wY3fDxtFwvfapIU/wnlFatZUlwlIZcn/5nein8=
...
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-dc24de01bd9so4937125276.1
        for <linux-kernel@vger.kernel.org>; Mon, 22 Jan 2024 01:12:55 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=V3ieii7F07e2BhjymXZdDcuN6ywdVvzt+lwy6/7RWUY=;
        b=
X-Gm-Message-State: AOJu0YwqfwqOxDDJPbRMfpxiNIzrjMKGp3JoCk1ZXq5SMCZEMLRUYQhp
	Xbl9kbz6ALvgsOp0D79f7ZF/tS+XiNEObkYfNODphIzwx2BCuxcH7C0itYL7rHJ/4MMkcCDYPRJ
	BpeCF5QEjjFxtJRWfjY+JXJC9o1vksynUXu55VXLwmXTL3kiPqa26YVOJUg3tQVqUiH0I9xji6Q
	eFAQ4Y7583cz7BkeNrYXqEC//GRrCZTw==

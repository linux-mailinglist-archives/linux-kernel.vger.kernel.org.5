...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 129507B51EA
	for <lists+linux-kernel@lfdr.de>; Mon,  2 Oct 2023 13:59:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231338AbjJBL7q (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 2 Oct 2023 07:59:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60702 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236833AbjJBL7m (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 2 Oct 2023 07:59:42 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 99E42C6
        for <linux-kernel@vger.kernel.org>; Mon,  2 Oct 2023 04:59:37 -0700 (PDT)
Message-ID: <20231002115902.096543357@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1696247975;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=b9icZ312K2wzs7HqQwN4x/Zs/AsYDehC0Dvj7D8ghOo=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1696247975;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=b9icZ312K2wzs7HqQwN4x/Zs/AsYDehC0Dvj7D8ghOo=;
        b=8+vhkpQHPzIXZRonRNhrNVU/tU7FzBy58vfqojg6zi1GtS8EHr7YQZGHtmqQrclz+9eErU
        Zq0dvwnlY4h93vBQ==
...
Subject: [patch V4 01/30] x86/microcode/32: Move early loading after paging
 enable
References: <20231002115506.217091296@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Mon,  2 Oct 2023 13:59:35 +0200 (CEST)
...
---
V3: Remove the early arguments - Chang

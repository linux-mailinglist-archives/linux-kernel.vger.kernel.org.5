Return-Path: <linux-kernel+bounces-91923-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B4C9187187E
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Mar 2024 09:45:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 2B4FBB21CBF
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Mar 2024 08:45:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D03C44D9FF;
	Tue,  5 Mar 2024 08:45:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b="gc40iHC7"
Received: from fllv0015.ext.ti.com (fllv0015.ext.ti.com [198.47.19.141])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 07FE21EF1A
	for <linux-kernel@vger.kernel.org>; Tue,  5 Mar 2024 08:45:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.47.19.141
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709628307; cv=none; b=phztareadLovLKMtEFyWFCLtNnXpV8dtwWh4imrP8HbpASeT6whORca9Rf0wOjel/ZSbvIHkzDvm6GfLpvXPuSgfO2l2oC44bWFXvwjukX+OpRYhy5NcZ1LQjWI3JS8RAAJaihKrd5yLl0rmc52kGh8mWwuLZ42dN0ybh/+ZB8I=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709628307; c=relaxed/simple;
	bh=0tdJUOl56Poi/y2qsMVEhywBJxZaUCrF42rcyJMnxGU=;
	h=From:To:CC:Subject:Date:Message-ID:MIME-Version:Content-Type; b=gPTbsXrpHsEv1j6lY1EPdVW1r+x+kZPbR8SelanCAW+uoXaM7JhTRX0jDbUGfwUWCjQSz9H5kRtv2o5Gpq7ynWpZpp1o1hleN24QjnoZaB8l1G2Sg9cQjIxFjcnYHYXUvl1k667SULDCGgp51bxC6j3IU1YTuE3XLCamaD6htKA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ti.com; spf=pass smtp.mailfrom=ti.com; dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b=gc40iHC7; arc=none smtp.client-ip=198.47.19.141

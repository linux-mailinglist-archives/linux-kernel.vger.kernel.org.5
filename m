Return-Path: <linux-kernel+bounces-49123-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E5EA84661B
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 03:57:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id BA7E028F4AF
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 02:57:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 203F6F9C2;
	Fri,  2 Feb 2024 02:57:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="GUVnlgHz"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5A729C2CD
	for <linux-kernel@vger.kernel.org>; Fri,  2 Feb 2024 02:57:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706842633; cv=none; b=TUilhCUhJgQqpgqnmk2SqwivOA7bCZjriSzG3Yema1B8bJcqbIWttnvU2VlMbH7vTDNPFhEmaWJwhgJ3tXHwZ+OhiNPXH5WwOk4I5fUopHjsGVpj92lt0PpzOmrWXIZ+z1YcnCjM1gwo4Nyy1t2xa1v5x4Gyx1Byimfmcv/RV3c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706842633; c=relaxed/simple;
	bh=m6Jy8TWSzeKI9yN1zhysIwjlOM1FhG3uhakCLeJ0idc=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=OMtcEk50SYfLiNkNvU1C0b4cvqBKu3Nch5nWu+gaqPI4iXTQTaU1hOSTa/Dusp+rSzW0rHTGx2flqjIGfjIZuNBZv/ZiOq17KG4YXLlYRSFmfE8m9Rz+YS0rn6AYLOw7J+6WY24WtW4KA4pDdGchb7ss8CGJCSOl4/F1ZDL9x+E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=GUVnlgHz; arc=none smtp.client-ip=170.10.133.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=GUVnlgHzDbzgNfwoP/JZ+GOza3FdYyXxrSXZYwtA+8bmvNOrB9MLK4SemlrpDr7yL1NY1C
	q2xMOfKS4KDpB6fh76kfkc2gG+/YPjp+WvI4uBXpMI94odcGaQ4H8yFywznze+faDQoVGm
	kQuDtBnWvOFMrATJEGflaj9BXgRRphE=

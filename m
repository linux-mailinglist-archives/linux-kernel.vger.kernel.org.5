Return-Path: <linux-kernel+bounces-122553-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 5279388F956
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 09:01:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B9DBE1F2D2C0
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 08:01:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B708554BCB;
	Thu, 28 Mar 2024 08:00:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=armchina.partner.onmschina.cn header.i=@armchina.partner.onmschina.cn header.b="PjDzdWN5"
Received: from CHN02-SH0-obe.outbound.protection.partner.outlook.cn (mail-sh0chn02on2091.outbound.protection.partner.outlook.cn [139.219.146.91])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C13AA42A8E
	for <linux-kernel@vger.kernel.org>; Thu, 28 Mar 2024 08:00:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=139.219.146.91
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711612856; cv=fail; b=Js2btP6zL8nkjqmDiMreEv4D9gtPx0p6q5Iil67jmB9QR4TWSXffduPJBEoJ91ql/r2aLYkchMKoVuR4gXfsYVfzb0qDJPVMA7H85XwDOgXV9ENvtWC98ESGcoEuNAyhT+knnffpCuLmBLuhkTa6f5Sfq7jb3+ftOU8IeFxK/Jw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711612856; c=relaxed/simple;
	bh=P5CswhA92Vv80GZMTOdEUx7apL9G7IOC9R8i4daW8lo=;
	h=From:To:CC:Subject:Date:Message-ID:Content-Type:MIME-Version; b=sIUYwsKrxAZYPgKc+KupTTcXaj0j3L3DKSMperEXWGE6VYbKi+bE9fxI2r+jN8EztMhOCNtDWuPHoZvdUMKvhJJh4p5ISOoaQWrQloIAd7QnkvvCCJSS91uo/VUWWolyPPCiQztOmuXHnxCmL88C6Pgt4KsUk6ozShwSKFFjxoM=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=armchina.com; spf=pass smtp.mailfrom=armchina.com; dkim=pass (1024-bit key) header.d=armchina.partner.onmschina.cn header.i=@armchina.partner.onmschina.cn header.b=PjDzdWN5; arc=fail smtp.client-ip=139.219.146.91
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 28 Mar 2024 07:46:01.5082
 (UTC)

Return-Path: <linux-kernel+bounces-166027-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id DBF118B94ED
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 08:56:50 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 9A9F3283500
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 06:56:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9A762225D7;
	Thu,  2 May 2024 06:56:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="CsrYsXqj"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 375351CAB7
	for <linux-kernel@vger.kernel.org>; Thu,  2 May 2024 06:56:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714632995; cv=none; b=nHCgVh6Cmp6JveL8VZK6//sPoAldB4M4qBD6UEvq92mw8qebY6f8RpYmlyfTrstZEymXDSeQtVY/yYO3l37WQwzkQXidvJnTMGM2zWi4RKmgFEYer57Ykf9D1uLBNVwZrop2o/AfJ7XCySGKw3POHr9i+dapj/Wgz7UbaGZjW8Y=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=CsrYsXqj; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1714632993;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=a98A7PArdae3xZyGNJJv71/CegQfWFJVRXHCuxa9iGU=;
	b=CsrYsXqjj8eDo7o9kQywOPu3Uj4tXqadLI8O6nKc+jfBFOwXivxHslyYhc4bCmOvvW5gmu
	7b7vTUCHgyF6GM/MyGYYrZBbRiU00o7PqTEP7GoyJ4bkCbB0WBdxOwwJNcLEXHTgnPl/d7
	SHKPmG/Vo/v4Ht59Aza72Jth13Cbm9c=
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 [209.85.128.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-321-aVo2aOLXMYWIHLSHLdBoxw-1; Thu, 02 May 2024 02:56:31 -0400
X-MC-Unique: aVo2aOLXMYWIHLSHLdBoxw-1
Received: by mail-wm1-f70.google.com with SMTP id 5b1f17b1804b1-417fb8195d7so34147555e9.0
        for <linux-kernel@vger.kernel.org>; Wed, 01 May 2024 23:56:31 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=a98A7PArdae3xZyGNJJv71/CegQfWFJVRXHCuxa9iGU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXe1WgcnJsT+chqRxmtcZBKh4WybOw6DGOHSzfBi3YkF8gnUtpI9sBV7JZRdUYeeHRVFEAEB6Qi3fF29j90eaNQNIvS18JFGWq4IVwl
X-Gm-Message-State: AOJu0YweNnd4Dvrw6QYkHcBzV9obdhNyN1+4IRsbWxoUDWdvrMjfUUl7
	uh22/4RyZ0YdZ9UgUhayguZcNPGt+EipWy81TABEMNczAxQ0ffagFMpn2u5F1MxY0lKYtDjz+yy
	2IQeR2KRVso7VeVWyfe8jF+nUu4f9oRMBJZ3PhebM89hFtqzHcgf/UFNung9xFA==
X-Received: by 2002:a05:600c:a46:b0:41b:f116:8c22 with SMTP id c6-20020a05600c0a4600b0041bf1168c22mr928810wmq.14.1714632990383;

Return-Path: <linux-kernel+bounces-100148-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E6A50879292
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 11:57:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id AA6F4B20EDA
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 10:57:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A672478691;
	Tue, 12 Mar 2024 10:57:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b="k1DFSX2o"
Received: from mx0b-0016f401.pphosted.com (mx0a-0016f401.pphosted.com [67.231.148.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AA627AD53
	for <linux-kernel@vger.kernel.org>; Tue, 12 Mar 2024 10:57:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=67.231.148.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710241042; cv=none; b=LgjxNI0vj3nn0Szg2ZPShnGFhHIKDY/g9WdpnkjUJfKp4PDF8CWcNLbcTkX2xNx9oNyCkf2Nm1JbMbU/eNydnXGObzOWB9yjmcweTut+erAFF2eJ6g79kDrcTxBHmnksULOaNkbOTfrvMurXRgDnyjaBtYu2ExK1JUhEiowNM1g=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710241042; c=relaxed/simple;
	bh=OHBGfdcAeHec314KHO6CZDAiyz+ZeYSk3EUAsXlD9Ks=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=OnCBv6gmynEJlZvDbzXflTDhMZdbRZxcyZyP5ETYGL3dBLokvJsCoeYjVDM+S3akl/ht9cCewm5PzbN31RyJPORktoQaucmpVP8K9Z8/eb+7XhBjHD8tLxnnKqZA0I7Gurw1x1CS/w05G6A64NlS0SGCiVwKXl/EGxvK3RUS/gA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=marvell.com; spf=pass smtp.mailfrom=marvell.com; dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b=k1DFSX2o; arc=none smtp.client-ip=67.231.148.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=marvell.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=marvell.com
Received: from pps.filterd (m0045849.ppops.net [127.0.0.1])
	by mx0a-0016f401.pphosted.com (8.17.1.24/8.17.1.24) with ESMTP id 42C7GrcF007698;
	Tue, 12 Mar 2024 03:57:14 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=
	from:to:cc:subject:date:message-id:in-reply-to:references
	:mime-version:content-transfer-encoding:content-type; s=
	pfpt0220; bh=VblwjGqR/nEmQe0zaZyxLOF6jlUvRSDyYSr5f4uxods=; b=k1D
	
Received: from dc5-exch05.marvell.com ([199.233.59.128])
	by mx0a-0016f401.pphosted.com (PPS) with ESMTPS id 3wt54n2w85-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Tue, 12 Mar 2024 03:57:14 -0700 (PDT)
Received: from DC5-EXCH05.marvell.com (10.69.176.209) by
 DC5-EXCH05.marvell.com (10.69.176.209) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1258.12; Tue, 12 Mar 2024 03:57:13 -0700
Received: from maili.marvell.com (10.69.176.80) by DC5-EXCH05.marvell.com
 (10.69.176.209) with Microsoft SMTP Server id 15.2.1258.12 via Frontend
 Transport; Tue, 12 Mar 2024 03:57:13 -0700
Received: from localhost.localdomain (unknown [10.28.36.156])
	by maili.marvell.com (Postfix) with ESMTP id A30F73F7045;
	Tue, 12 Mar 2024 03:57:11 -0700 (PDT)
...
Date: Tue, 12 Mar 2024 03:56:57 -0700
Message-ID: <20240312105657.1589333-1-vattunuru@marvell.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <MW4PR18MB5244191AE625EE04141DAE2BA6272@MW4PR18MB5244.namprd18.prod.outlook.com>
...
X-Proofpoint-ORIG-GUID: daz5Dop8YfQ4tIMCgTUXmPcJLwdHp6Ep
X-Proofpoint-GUID: daz5Dop8YfQ4tIMCgTUXmPcJLwdHp6Ep

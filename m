Return-Path: <linux-kernel+bounces-101090-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 7639687A22E
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 05:07:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A58551F22269
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 04:07:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BCB5C10A24;
	Wed, 13 Mar 2024 04:07:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="f2wbWJ5L"
Received: from mail-ej1-f41.google.com (mail-ej1-f41.google.com [209.85.218.41])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C391410958
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 04:07:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710302835; cv=none; b=TIEDMIN3GllwbKh3TGxUO9iQR3ZqaLvXO9jECVDJ4oteXnk4N/+C2eCjCfYg2qtPCBd2DukUgJWrWI6vqo3eWjqsMZZpknEqUg2b+zKDI8ejPG+qlF5fQ/JMiVdg7MeK31NCyNqs0vAooYaetmZn/ksL6CJ1lrsDLOVkvmzCT1k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710302835; c=relaxed/simple;
	bh=J+PCO9n/0vKoN4bF+t2ZFjtfPSE197riBnI+eQd7H64=;
	h=MIME-Version:From:Date:Message-ID:Subject:To:Cc:Content-Type; b=WL3/DAGvmBdlBDNnqcqLfoTWUS/Pgw+ZrXqRdB9MpkWRNFdRApait9r9WDb1Wd1lE5ff5ZgQ5xjFDbXU2eenUYvc0nfEH7tc85ejQak73UwIqAooBE84WvT5wGqxKJMarUDgtLvhMMADLV8yCkoL7K2JhTqoTmBhSddpR3m6ObE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=f2wbWJ5L; arc=none smtp.client-ip=209.85.218.41
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-ej1-f41.google.com with SMTP id a640c23a62f3a-a4499ef8b5aso479796766b.0
        for <linux-kernel@vger.kernel.org>; Tue, 12 Mar 2024 21:07:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1710302826; x=1710907626; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=U8qf2uv8IEVUo44AuVh2HZVm71BtdU6JcVuntlWgc6E=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         ...
         :reply-to;
        bh=U8qf2uv8IEVUo44AuVh2HZVm71BtdU6JcVuntlWgc6E=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWXfBvIPn6duVRkhYoYRJsQQej0SMB3HVcaM9SkH8Bk6NgU+iZHUj4YMrVPtGTxSm9UU2naLTfITjptpV2S3MEigMBUUXBKBTzgkpDx
X-Gm-Message-State: AOJu0Yy+L+LBxK71RPMyRP85Gq95GtGDuzJ3wQcKKSeC5ARXFVkWVQM9
	eutKcOk2t+mDdjjjNbRw/ClR/oP1Kq33a7czQ70E814Plgu7QU5jyKa7LzKmOaH6nKdt3UW0vDU
	Eh+j0flrzYhl0UtF0qWd8DcdfRKs=

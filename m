...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A3D327CB4FA
	for <lists+linux-kernel@lfdr.de>; Mon, 16 Oct 2023 22:59:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232365AbjJPU7X (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 16 Oct 2023 16:59:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60298 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233854AbjJPU7U (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 16 Oct 2023 16:59:20 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 42DFC95
        for <linux-kernel@vger.kernel.org>; Mon, 16 Oct 2023 13:58:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1697489911;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=1ZRdM6WFiBmMyXqWLqF+1u9ysulMXi8v6V1ZYIo/a58=;
        b=HbRrKEsZiA69nKnh95id0UCqTxoChz+mHC/NWNANjXiVgP2OjrBxLV+LZV1JC1gDXqqKjJ
        YrmhHOxeNl5z7Js8TQhyix2mctfXvLhIaaSYGhUfThdkV7vC/ol9H/Z3MhI1gR6f88UIC7
        HiKbu2Bt+mhUY+BJame/w/vxHoeZhaM=
Received: from mail-pl1-f200.google.com (mail-pl1-f200.google.com
 [209.85.214.200]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-297-_s-C8w-UNbKtPBTsS_X0og-1; Mon, 16 Oct 2023 16:58:29 -0400
X-MC-Unique: _s-C8w-UNbKtPBTsS_X0og-1
Received: by mail-pl1-f200.google.com with SMTP id d9443c01a7336-1c9b15b2481so38047115ad.3
        for <linux-kernel@vger.kernel.org>; Mon, 16 Oct 2023 13:58:29 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1697489908; x=1698094708;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=1ZRdM6WFiBmMyXqWLqF+1u9ysulMXi8v6V1ZYIo/a58=;
        b=
X-Gm-Message-State: AOJu0Yw92PauniTek2Bd2cZIKSGiIgbLPrP2LroiQTOBcNdvRAwy0jIX
        r0PMaE1Ral7t/6FKNP8pPhC2r1YCIa77+vKBKUlE+HxzUbaJYuoaGGZlaq8T1FMbej2Cu/CcVcn
        be1CKBEPicPHQ20fjHaTu7qdk
X-Received: by 2002:a17:902:db0b:b0:1ca:87a1:cdf1 with SMTP id m11-20020a170902db0b00b001ca87a1cdf1mr512571plx.27.1697489908689;
        Mon, 16 Oct 2023 13:58:28 -0700 (PDT)
X-Google-Smtp-Source: AGHT+IGyBawC4KHCYBPRoaT4M2esHq4x/Y7zbAOGiLVZVcwwjf4YI50US+vrTyPaoAKFAgOkC1+VJw==
X-Received: by 2002:a17:902:db0b:b0:1ca:87a1:cdf1 with SMTP id m11-20020a170902db0b00b001ca87a1cdf1mr512556plx.27.1697489908330;
        Mon, 16 Oct 2023 13:58:28 -0700 (PDT)
Received: from redhat.com ([2804:431:c7ec:9c76:b19a:d6e9:6ff5:e6ec])
        by smtp.gmail.com with ESMTPSA id a7-20020a170902b58700b001ca4c20003dsm63287pls.69.2023.10.16.13.58.25
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 16 Oct 2023 13:58:27 -0700 (PDT)
Date:   Mon, 16 Oct 2023 17:58:23 -0300
...
Subject: Re: [PATCH smp,csd] Throw an error if a CSD lock is stuck for too
 long
Message-ID: <ZS2j73BWypYk-S1u@redhat.com>

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D0BCD776C1A
	for <lists+linux-kernel@lfdr.de>; Thu, 10 Aug 2023 00:19:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230521AbjHIWTQ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 9 Aug 2023 18:19:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53530 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229525AbjHIWTO (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 9 Aug 2023 18:19:14 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0992CB2
        for <linux-kernel@vger.kernel.org>; Wed,  9 Aug 2023 15:18:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1691619504;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding;
        bh=4swX8dMl/TijHGT/PyStaDlhL4BvYkXkrr8Mth8YW8U=;
        b=OQz+fCOO4NlwVhzUZ/HM+WZV+dmiIj6+Ou2BK+/sUe7IM8wuMNYGUdVjbOVNgQrtrpoDa+
        s4ZYcy9BSsbCzwtFwmIGYG+h+u9UbfzD2G24L1pTb3Y9QmPt4HjC+QRoUaWcjJirljZVhw
        //f+G8YoPVgxyN/F9zbPLTTDg7Hcfis=
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 [209.85.128.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-499-VHJdY4LlMzWDbei_MnIarA-1; Wed, 09 Aug 2023 18:18:22 -0400
X-MC-Unique: VHJdY4LlMzWDbei_MnIarA-1
Received: by mail-wm1-f70.google.com with SMTP id 5b1f17b1804b1-3fe13881511so1620875e9.3
        for <linux-kernel@vger.kernel.org>; Wed, 09 Aug 2023 15:18:22 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=4swX8dMl/TijHGT/PyStaDlhL4BvYkXkrr8Mth8YW8U=;
        b=
X-Gm-Message-State: AOJu0Yy5hNw6+A4EhRBeRwfdj/SBXMLMPPqR7twjF5AeJkfjvnlLuaxt
        Vj7mKXayZlfnICDw2RN6AyyrF8CvVPL3puu0dtfKzPgFzZ2WUhZw58EhxrFhz8nVPSuchnJEKeU
        CC6TIsfjl1mK24f0HpeGLCRfw
X-Received: by 2002:adf:fc92:0:b0:314:475:bc47 with SMTP id g18-20020adffc92000000b003140475bc47mr509155wrr.69.1691619501250;
...
X-Received: by 2002:adf:fc92:0:b0:314:475:bc47 with SMTP id g18-20020adffc92000000b003140475bc47mr509133wrr.69.1691619500835;
        Wed, 09 Aug 2023 15:18:20 -0700 (PDT)
Received: from cassiopeiae.. ([2a02:810d:4b3f:de9c:642:1aff:fe31:a19f])
        by smtp.gmail.com with ESMTPSA id n4-20020a05640206c400b00523372c86e7sm30683edy.24.2023.08.09.15.18.19
...
Subject: [PATCH drm-misc-next] drm/sched: support multiple rings per gpu_scheduler

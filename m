...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ADF597B3D16
	for <lists+linux-kernel@lfdr.de>; Sat, 30 Sep 2023 01:58:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233887AbjI2X6O (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 29 Sep 2023 19:58:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38058 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233885AbjI2X6L (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 29 Sep 2023 19:58:11 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 59DCC1A5
        for <linux-kernel@vger.kernel.org>; Fri, 29 Sep 2023 16:58:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1696031889; x=1727567889;
  h=date:from:to:cc:subject:message-id;
  bh=3a6X5jE3cvBc+9qTFfyI4pLu4ltqb3patv/u4xUX+N0=;
  b=d8wL07BgX0YhDGnamhv/Dvh7fo/6aHIXSWEo/ckcXSSFtNKKMh4BbTLB
   1bt0/4kdMwTzJYXicVCVcrXZJRhckkz4Cw1Pwsk255ocqg5Y8G47S8X1D
   CY4oluMcz5bxyQMzZA0uGzGRRtcYAM/tX2kCU0s+3lq/IwKKEJc2x5CUw
   oVSTNkD8w1OWSyUSIhRNb011i+jkoi1DF0oF/W4bWwPaE6i1saVx2VSra
   IsNHu0z+chiffP2kMShhxLGP4WZzyETCDCenHJMxZ84aWyE0xPlRDFezN
   dHVh5dVDnLINfPNs1x+SdHcdjFy+nwtLxGk8cD8soIV+075KqiDgyIcRl
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10848"; a="367461300"
X-IronPort-AV: E=Sophos;i="6.03,188,1694761200"; 
   d="scan'208";a="367461300"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Sep 2023 16:58:09 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10848"; a="726738722"
X-IronPort-AV: E=Sophos;i="6.03,188,1694761200"; 
   d="scan'208";a="726738722"
Received: from lkp-server02.sh.intel.com (HELO c3b01524d57c) ([10.239.97.151])
  by orsmga006.jf.intel.com with ESMTP; 29 Sep 2023 16:58:07 -0700
Received: from kbuild by c3b01524d57c with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qmNMz-0003RG-1a;
        Fri, 29 Sep 2023 23:58:05 +0000
Date:   Sat, 30 Sep 2023 07:57:29 +0800
From:   kernel test robot <lkp@intel.com>
To:     "x86-ml" <x86@kernel.org>
Cc:     linux-kernel@vger.kernel.org
Subject: [tip:x86/urgent] BUILD SUCCESS
 c6c2adcba50c2622ed25ba5d5e7f05f584711358
Message-ID: <202309300727.b0wHoGJ3-lkp@intel.com>
...
branch HEAD: c6c2adcba50c2622ed25ba5d5e7f05f584711358  x86/sgx: Resolves SECS reclaim vs. page fault for EAUG race

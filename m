Return-Path: <linux-kernel+bounces-64796-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 870C88542F1
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Feb 2024 07:38:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id D9FD0B290BF
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Feb 2024 06:38:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0D72512B60;
	Wed, 14 Feb 2024 06:37:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="ClilPw9h"
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 02FC511CAD
	for <linux-kernel@vger.kernel.org>; Wed, 14 Feb 2024 06:37:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707892645; cv=none; b=s4Un6K6wHiSYI9K0c1XwBL1uM6esAFYdfodt0fjXvu6LwpaSe/4BJmnNLe9WNkCw6QRBl/fHGX/B8obFTkp5YW/wQ17uOO6C8iPZrYLAPZ06uKTf1p/3UGrZaXb5BKM4G5q9XJ3ndul5g5gN1Z9ysFPcAT30ZgfS4RC7zj+uZX4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707892645; c=relaxed/simple;
	bh=Xx+uvA43OduUIzjEu9tCr6C0ALQ8vcobIRZz2sQGsbI=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=p6Xz/bilSQvCIW8krviq+LDuEdTThxRxOsm7XkFGL9kvMcPFhL4w2lSOdUb7WKm1Jcthdd9bw3REQjGHL595e4u865cpbHbsTwz38VQ+YTZj5XqhtWR1o8Md4FX/aE5oYw9etGeYD4vgQNs6baxaV4lgXoapMqQ+62LiXfRGSWs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=ClilPw9h; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-604832bcbd0so112577597b3.0
        for <linux-kernel@vger.kernel.org>; Tue, 13 Feb 2024 22:37:23 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=rEAosGoN+Ps3V+fA/yuGNTVNjMqltIfkWiaUJr2st/A=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXYZ/Bd78iP0M7q0iQ3UdcKO37hplW6qM5uWcQcWsRgSaxzqQ/B7PzB/EHjO5cGZZXOGYxuP/cF9xQ6tSMN8zX053Kl5UuFv2JapqG3
X-Gm-Message-State: AOJu0YxTqWaRkkffsUMJ6OeJNT8fDEoXF4QvLND1yBwo/xaD9jO2OajF
	7PVxHpzDitpEx9KEeb23eXS57+KOjv3jD6sRzvrnFmPwLWni/awOL4zwH7wPhJGxLeI/MaioKcW
	MBRTs/g==

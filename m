Return-Path: <linux-kernel+bounces-68525-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E0EB4857BBF
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 12:32:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 5AD901F2624C
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 11:32:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 24FD577F20;
	Fri, 16 Feb 2024 11:31:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="K5Lv258E"
Received: from mail-pl1-f171.google.com (mail-pl1-f171.google.com [209.85.214.171])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5363477F04
	for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 11:31:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708083118; cv=none; b=LQZKh3+Igl+9pGGVRciXS2iDxxeKvmpeNcpNwDwemyx5KWgECWuRllINueWbtudIv1Hsvg4WgBUf7oACJ6oNjGICd8zajEwobbHZy83pVz7RM86n0MbKLPxqoUeVvxv4MQtrdKzgQPUywH8e9UkWJu1OGB9I3pazG/vi5KOlQA8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708083118; c=relaxed/simple;
	bh=UwV6PP9Dy4l/PHEko/rhazRk7bZ5pWgavF2GNsY4jB4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=lrtQkccBCvvxvZwL5GWY7gVUIpVVzoHDqSlKD99LiEHZKdyw8nRlgR/bngDvuVhHVP+4pqNYOxAyL3aoeOgJcyF4YhVYBT0l24aE+TzBH45X28YO+EGBZSD9b3610I+quTzAvlyCRNlGyhMZgg68kHDQ2/yHhDi7OYHKJFod5OE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=K5Lv258E; arc=none smtp.client-ip=209.85.214.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pl1-f171.google.com with SMTP id d9443c01a7336-1dbae7b8ff2so1677955ad.3
        for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 03:31:55 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=yTLg2p9rvSPRXvNKR+Iv16WduzUd8WzxwmsQxSSHbjw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX3QX+U/nwkM49cBdXA3vuHCS6UQ7U701gJ+fHXypfrXVyr2gxCHBOGq890ypFrlbZ/0b7glrXA7lPSqN9gdFRc5Ky9ALZByORdhaMZ
X-Gm-Message-State: AOJu0YxFc/SIl32vBbR3Om7yj8g8gE31qu0Oc8UIuH8geqMheF/AFiO7
	tQeZYSg7a44X7cZw96AOhHV7zoYyn2LVlfkPmKArHZNCL70t8gnun0WGedaRxQ==

Return-Path: <linux-kernel+bounces-123283-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A8F88905F0
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 17:44:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A94C91F269DB
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 16:44:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0171513B5BC;
	Thu, 28 Mar 2024 16:38:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="GiLtrGp0"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 912DD13B7BC
	for <linux-kernel@vger.kernel.org>; Thu, 28 Mar 2024 16:38:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711643893; cv=none; b=WDRRLy15tabJ7u2QaovISDQ76AE+kpx/pTCF2yUD9dBuUbCmZ5P8YFQfws4OA5fNMg753k+BiATvHnXnsONpdvVHtZVppE2nloZ8rYEZEPtySh18/aYTQANAJstt76pR4RvdVsvkBCTi7Bqn8vMAj4isyrCUKAsLnG9Ux0usH1o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711643893; c=relaxed/simple;
	bh=nhc5rvuZJ1+r04+ZDNGXMdd1gVMPrAcfjn/g3l1m4dw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=iFasm0lAYFidP/xcrktQpBBlzevb1/hXIXyc/BkdSz9IWno9VHJNG8uxWJpcAvF5mitDljxvucTTIvp2a6HE8C9iPx7dBVbEZ+INQpQTOIFH8AB2Ed22C0yYEtbe6ckD6/B+WDuOwVhwfu0rHRqVjHeHBP/A1/SlErENHiNCrAI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=GiLtrGp0; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1711643890;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=JI9PX3u9k9FTrB5i0WWXWgMwPBin4UAr3u+00DhFGiU=;
	b=GiLtrGp0/e9lmReNbTYdr0AN9fe7ndSXPt3RTPa/GEboqjpgCjYd+mW8IT83PhlgRiZAGY
	tOCaQ9AFnUWyDCJVds6c+hfxTdbbiZiN/nxRCxyQHVI4Z9v8bdXCynbeYNLeiDzriVCs+u
	G5MFuzFhi/2QL1Q58B3aVRyfLDa0cXA=

Return-Path: <linux-kernel+bounces-136692-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 589D089D72B
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 12:41:16 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9E0E6B2311F
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 10:41:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B7EDB55E55;
	Tue,  9 Apr 2024 10:41:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=wolfvision.net header.i=@wolfvision.net header.b="INWx2i37"
Received: from EUR02-VI1-obe.outbound.protection.outlook.com (mail-vi1eur02on2110.outbound.protection.outlook.com [40.107.241.110])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3B25782D7F
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 10:40:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.241.110
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712659259; cv=fail; b=DJFMx1fRlxxL+uNqzGxugjJSnQx/qFfL0CPRo170zFsBaL8aDhjIgVROdeikSyeHG3opAMI+qvohhtoJw7XJQ8AM0rtQIRfqRlP+iITsxaIKqaVqt0SFYsP+qaisApTfNwK4AWLJaZtwDpezQVAI9x/IwhDRurL/q9AL+y4X0wA=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712659259; c=relaxed/simple;
	bh=7iARjiADrdPjTmt5PCj4o6fziLM4cv3Jg7R3sLbVu1Q=;
	h=From:Date:Subject:Content-Type:Message-Id:References:In-Reply-To:
	 To:Cc:MIME-Version; b=SJE8i/+pR6MNDMcY7upPxyTgLrem7HdM6oUQfrqMMGlgkGZt+tArRGEyLt7uRYELAPLZmV+SBzJ5p1NdqMcJZer+BPVfpJyuI4T8368QBRf0Yf/BDJIssDlaFG9O/FT1NhaQnqCqLi04ddDOY22BXid7zPxDPi221Ypm9InfLU8=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=wolfvision.net; spf=pass smtp.mailfrom=wolfvision.net; dkim=pass (1024-bit key) header.d=wolfvision.net header.i=@wolfvision.net header.b=INWx2i37; arc=fail smtp.client-ip=40.107.241.110
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?ZXVlYk1BZkUrNFg4WllvMlBzeU9OM1R5TnVvY2daMk1iajlmUzh4eStIellU?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Apr 2024 10:40:51.4716
 (UTC)

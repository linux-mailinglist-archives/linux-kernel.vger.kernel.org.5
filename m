Return-Path: <linux-kernel+bounces-101207-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id B32A287A3FC
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 09:16:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6C2CB1F21706
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 08:16:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ACE0E224DB;
	Wed, 13 Mar 2024 08:15:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="R+fhjGga"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6ACF31CF87
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 08:15:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710317719; cv=none; b=C0Ji9uXcWxhwzyT17gNtEAi475Ur6O+3KbssEPKqOLBpNk2dcW7HBLd7n6YX9DL21X1OG7dTBWNVYjqTv3TJVderHGN/BkXLPE0mKma2WThGnC5NWuEzhzm+cxNzNVsDfjyBPTYVBHC1rwz1Ws2QExtH4xns3Nkjg3mac8uPgXQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710317719; c=relaxed/simple;
	bh=2JhikHnvZA+K8h+nUpROY6IhHBbfBTTzo4tCnXSdzbs=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=mwc/oI41BYzlZqsS1TWIKt/kMPMTj2a20louGsAXOaKfKjuR/jbYdvCASzkRd7bZy7YdkpKIQX6BdLhfPBoK6kRrfvQ7vYSPkeyvXjNTWYXiI2B2HVQAvhlYXEonawq12rdS96zdNzUPyCJ5YI4i5FK/AUlIqj6YKO9oksgz6H4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=R+fhjGga; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1710317716;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=91bNCNkvqiMRdaqnUe2NMNtpy4+Y+1Q/++18wDtAqbY=;
	b=R+fhjGgaakgnZPgfClSpNEfkS2uLQ3/cToLVjp+muVbgsx4VRtRKgsAimGNi6ZfVHrB9E3
	mjtNpeKTJyaUtq5+FmAoqdCVpgot0ddQBjqZaJldIbuHVw0AmhPxfUs8u+V2uCfRiWZlJA
	JF15IONQlqdHWgKX7VeROfarJGCI5Hk=

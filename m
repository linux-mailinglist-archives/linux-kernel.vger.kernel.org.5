Return-Path: <linux-kernel+bounces-158002-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 82B2B8B1A00
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Apr 2024 06:42:08 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A97D8B22B7F
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Apr 2024 04:42:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0DA5E39AEB;
	Thu, 25 Apr 2024 04:42:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b="z0Xjwj7f";
	dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b="RbEEYWJQ"
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.153.233])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B14992C19B
	for <linux-kernel@vger.kernel.org>; Thu, 25 Apr 2024 04:41:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=68.232.153.233
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714020119; cv=fail; b=aQ2G2G9nH1/2u5/Wma/WoRDQuvxsufkuDBdH6KgIPz+pz6wL3kNO42VOfxARbwZB7c8VRUohGH5Oqp+5Ij89kUvR+53oHfR9bhPz994v8iMxb5m184knjMaK7lfZPD9o0ZN+l3hPm8h0Ma7kYUT3bK6GJZCZmvqs/CluC3HneSY=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714020119; c=relaxed/simple;
	bh=KDEeTQ0togEzHO8BK2gY2RivJIUoRN24dRmSkJ8KXkI=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=GvJbE5oRftqyYp6INIYghp4dzu3HrEiTvwh0ld6hNfAKstIGhZ8K0o/Yoao1nC5TB+xmrMmGCbdwulgMEAp63In79dS2z9CWd5E5BCYy8vtZdLRqdQx6FLU1auI4i/GBxSsGcyld6+kQp3FOGgwaQJfyhqckA3vhEBIhiTcABxA=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=microchip.com; spf=pass smtp.mailfrom=microchip.com; dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b=z0Xjwj7f; dkim=pass (2048-bit key) header.d=microchip.com header.i=@microchip.com header.b=RbEEYWJQ; arc=fail smtp.client-ip=68.232.153.233
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=z0Xjwj7fMGAZ1ffSihFHirEUOdEWWG+FXDZ7ZUEpOGKOA3wtuUQRYfoR
   ...
   MZcm1uUjKFle9C1KFBRbQWk4OK44v/7O/4Avt/vtUk1xWvyfch5arHDRn
   A==;
...
X-IronPort-AV: E=Sophos;i="6.07,228,1708412400"; 
   d="scan'208";a="22574513"
X-Amp-Result: SKIPPED(no attachment in message)
Received: from unknown (HELO email.microchip.com) ([170.129.1.10])
  by esa3.microchip.iphmx.com with ESMTP/TLS/ECDHE-RSA-AES128-GCM-SHA256; 24 Apr 2024 21:41:55 -0700
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH7PR11MB6451.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(366007)(7416005)(1800799015)(376005)(921011)(38070700009);DIR:OUT;SFP:1101;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 25 Apr 2024 04:41:12.5815
 (UTC)

Return-Path: <linux-kernel+bounces-129783-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 742BD896FE0
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 15:08:12 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 946011C2577E
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 13:08:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 79CB1147C66;
	Wed,  3 Apr 2024 13:08:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=Nvidia.com header.i=@Nvidia.com header.b="EZsUjcmo"
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (mail-bn8nam12on2127.outbound.protection.outlook.com [40.107.237.127])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C760758112
	for <linux-kernel@vger.kernel.org>; Wed,  3 Apr 2024 13:08:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.237.127
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712149686; cv=fail; b=Y+yV+1BgbRZ50dWf1HzDYQOnHa3rfYpBafyT/Ux6+HpmpZcONglAJBwzVJzWYkbJPNyAGz4QeyMYJmwYv7w9wWBCT8jW2PBlpjd2Ad78Xt5j0o9tAMZQqzjlfLu/bPk9U0GqRovqJpPlbCWuucXqLjuYYGCzvTGIINV/Mnd2M4c=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712149686; c=relaxed/simple;
	bh=MzGPXBvbU3OqD5pgX8xsXafMi4TEN6TTqeXDnXMqqxM=;
	h=Date:From:To:Cc:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=UTiXQXhWiKbB4IF7eD8VjJ4Wl3MjMuCRjPupjswtodk+8eOXCotgTFJ63Z4dLzNyGc/mIoctgoegFEGZHVuxdmMHKN2n6m6AAgjk0lxYuqqbaftrvWoKQZKSv5/BCGtO9YESZal/1qmYz74W1qI8ArdlgxVWWVl5EZPB8pV+uA0=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=nvidia.com; spf=fail smtp.mailfrom=nvidia.com; dkim=pass (2048-bit key) header.d=Nvidia.com header.i=@Nvidia.com header.b=EZsUjcmo; arc=fail smtp.client-ip=40.107.237.127
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?MVB3NkR4ckdtWHhEcVRyZVA0RWpoWFIzTjZkOWZLSUREb1Mxck95Kzh6dVdT?=

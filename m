...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E55E776D960
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Aug 2023 23:19:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232873AbjHBVTy (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Aug 2023 17:19:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57852 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232457AbjHBVT2 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Aug 2023 17:19:28 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6DEC62137
        for <linux-kernel@vger.kernel.org>; Wed,  2 Aug 2023 14:19:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1691011167; x=1722547167;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=WQVAwM5gjbF92AC0tCCjzkTm5eWGQ/hWXl9qdbb0/w0=;
  b=CXDjBqj4ahcXBzl5IPNnpSfJONBnnuBUS5ki/QQsnXDJ2umKOEcmxeFo
   ywtFN2M8R4kPKJ3XeQnQgbJu8usqU1bUV9aZAKyGH4NQR74OXnlZ3zScS
   cfpjYkXbVCPtDYeoee0Vvwy5ziNiTEtHjJajKJXaNdJ8cLyd5vleBGeFY
   iMPOdD4mfNvJ2zsoNaXX0a0wXRLdd8BdWyPRelnG5XwIFpwLuzsBx6tmJ
   5COisANVDG9Tt/73nCmqmsu4chuZusdA2NuDIKB2q9JvUHDjEHFKuGt2r
   8KP44olYuQPxNW6hlZtiPr8l2oHKc15ygtl9grHYPZabtc5b30ohHHBPU
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10790"; a="372436178"
X-IronPort-AV: E=Sophos;i="6.01,250,1684825200"; 
   d="scan'208";a="372436178"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Aug 2023 14:19:23 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10790"; a="729290800"
X-IronPort-AV: E=Sophos;i="6.01,250,1684825200"; 
   d="scan'208";a="729290800"
...
Subject: [PATCH v12 7/8] iommu/vt-d: Add set_dev_pasid callback for dma domain
Date:   Wed,  2 Aug 2023 14:24:26 -0700
Message-Id: <20230802212427.1497170-8-jacob.jun.pan@linux.intel.com>

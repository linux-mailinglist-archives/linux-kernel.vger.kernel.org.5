Return-Path: <linux-kernel+bounces-37393-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id BBFC183AF33
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 18:08:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id E0F4F1C236D6
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 17:08:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9C20D1292C7;
	Wed, 24 Jan 2024 17:05:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="kojVIWxt"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CFF22128399
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 17:05:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706115942; cv=none; b=U6jAA5H9kzoaCbaUt6TGGiqxmz/BnknmbnQUEu4mHFG0+7BL+gcaIwq8ITZsIBVgYR6FEqW5J4aK6taJlpSUO/NGbsHBtrnzd0JNvf8RcRM+VU7Ixq01KM3GMeV4WZV7QlfCh1fwHhMyijd177AU0PzD7Cz+Cxe+nY8VbzupYW4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706115942; c=relaxed/simple;
	bh=eSXm80QnH1JhZdpRmNd1upMtxM0h6BzQ1w/ftFOWWPc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Q/uyLFzjyV0ub05OamzbTyijWRtzFJzdy0o7MCrieyxfbHA4lRTm6eraBormJ6BhSc4UQ3Hz7YBge4xum8I9UiWG5DYM8ZL/Kh0nEBW1uGpdnbFXajmKW50yklB+alue8DVVHGJgXzIjFa2TfNX6AOCGb0LlLRnj+18KcjZL4ro=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=kojVIWxt; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 75272C433F1;
	Wed, 24 Jan 2024 17:05:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1706115942;
	bh=eSXm80QnH1JhZdpRmNd1upMtxM0h6BzQ1w/ftFOWWPc=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Message-ID: <20240124170459.24850-15-frederic@kernel.org>

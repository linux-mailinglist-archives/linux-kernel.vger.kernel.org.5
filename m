Return-Path: <linux-kernel+bounces-39212-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 8403983CCD6
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 20:50:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A94551C23D54
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 19:50:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CA5A6135A5B;
	Thu, 25 Jan 2024 19:50:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="S1LzMd8H"
Received: from mail-pj1-f44.google.com (mail-pj1-f44.google.com [209.85.216.44])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E18E01350D7
	for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 19:50:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.216.44
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706212222; cv=none; b=Fw1osgGjgmlm6A4aGOIjFg4NWEUzQ+++Cdr/luGw2Efr58ZuJQ7hbL/l+dWB+7OcKdfHSuohh5lDosAFgQEzfAotkhq1pFzQcCNgTVYGbVDZD4FQhdED/0UFqoAb85/JarTpmyfTmisv87a53CNygDg1hmFwkq0aUex31ijK1mQ=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=S1LzMd8H; arc=none smtp.client-ip=209.85.216.44
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pj1-f44.google.com with SMTP id 98e67ed59e1d1-290d59df3f0so2573136a91.2
        for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 11:50:20 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=JR7r6jZyM2WV2rpiG2kKeOnVSmGmuFbZSyqr0yy7yWw=;
        b=
X-Gm-Message-State: AOJu0YygkeGdkXd3RW5Jt7zbaBVouuEA45jh+/+0EjMDSUk/ZneYSYKO
	C6r0BWDCV95mLUG1iC0GnVN+Ezspqt6mDE/3DXAgPKOgkbxQie5NvSMl5MbFjLgfUH/uz6OAh87
	z//JHRytsZSsXgeFylO9cjY3lIO/Wg86kqI6kQA==

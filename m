Return-Path: <linux-kernel+bounces-60987-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 861F0850C2F
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 00:17:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 832F31F21157
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 23:16:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 74E8A18627;
	Sun, 11 Feb 2024 23:15:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="VgFxXJaS"
Received: from mail-ed1-f44.google.com (mail-ed1-f44.google.com [209.85.208.44])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BD67917545
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 23:15:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.44
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707693344; cv=none; b=at1UFGhS1jkwm8uqonRsDlofevfqOApIDEv7CAGkm4NTYkvSCAG78UtEY19cyHHjha+nAr9O2iKBf+tFdHy42hBknkT+oHyd6KwknwumXPhrl3jQyUCYROvZSVGc0LNzHy/1UNcGoWuEm0/nn+SAimGRXdRa0aZOZjZTLxEU6G4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707693344; c=relaxed/simple;
	bh=Dhs2mryK6cjxcDEq3cmas8fOBOA4lHx6v+C0m71m3Ps=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=uZLXRHt5BoC83bUksOxt309+R6J5+93oy/6UD6KRXJu0h4+cvO6nBdmnU/N0A85v3RrGAojbWoxKgjDBS+7SGA4thNkf7emZuC5CQ5DC1Z3mCRPHt79ao/KIn7/uf7nHU2GZBIWHHoHCU29YC1OqV9uP64pQMXywlZ0D3JRxVnc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=VgFxXJaS; arc=none smtp.client-ip=209.85.208.44
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ed1-f44.google.com with SMTP id 4fb4d7f45d1cf-561c29afb6eso87690a12.2
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 15:15:35 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=x+5/xFpwJe8P4woTgG6Er9CpKudFsvlzPLgw6cSgIo8=;
        b=
X-Gm-Message-State: AOJu0Yz4wf8mWEpNMYZLjsqloBiTujPgagGfkKheX1pn4CfctnjJpEMZ
	WM4Y1tEDyBcXRHTvk9FZQCZZywTxHBPYtfgDxvXBPsJJ4FbIrXqnMNFRZIHAQZdbD65ElSGK9NV
	r
X-Google-Smtp-Source: AGHT+IHxYuBN2rmApzTtxYiLu799BGOV1vjlRkIUcMQBmgq0dJfwXMlP7oC8TmRaVCdJ7GymRRE3SA==
X-Received: by 2002:aa7:d4cf:0:b0:561:3480:443 with SMTP id t15-20020aa7d4cf000000b0056134800443mr3408921edr.36.1707693332416;
        Sun, 11 Feb 2024 15:15:32 -0800 (PST)
Received: from raven.blarg.de (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id et13-20020a056402378d00b0055d19c9daf2sm2170180edb.15.2024.02.11.15.15.29
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 15:15:29 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v4 03/35] include: reduce header dependencies by using "*_types.h"
Date: Mon, 12 Feb 2024 00:14:46 +0100
Message-Id: <20240211231518.349442-4-max.kellermann@ionos.com>

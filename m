Return-Path: <linux-kernel+bounces-75033-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3629285E1F5
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 16:53:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id DF4362830ED
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 15:53:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9C83481726;
	Wed, 21 Feb 2024 15:52:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ziepe.ca header.i=@ziepe.ca header.b="j8KJjF+c"
Received: from mail-qt1-f176.google.com (mail-qt1-f176.google.com [209.85.160.176])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0CF3C81202
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 15:52:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708530776; cv=none; b=AN/QczAPB7qGMHMNrXMkLDqjr09XCSZL6Xi58i3YdDTskvlfGJFSkftZbAD1Rzf0O0kwaZ2HHH/30EDt1Z8pkTV6jDpK2luaQebLY9HtI8lRVAxikV9DOKNazc4df8Shar0Ks2u3pfDe2g/Vlk3J2Mm/kUEaNfvYYqcVeedKpYE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708530776; c=relaxed/simple;
	bh=coBFWklfp35Z+JdM7euyFOYo+eFWVoqEv4dPHniFQKc=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=VK37Q3cdmU7KJtND2PGjy0Sd1IY0BWMH+gCMCHbg3/xprJFmKKhBLUwLLTG+JpWD39ZCCaCpMnofBOxpuH+T+S8UEH+lAyCvLiH+rPfTAeNQLI3jp5COaq54OPy2zpKcFfEEfc0sOhwS80tdF4f1sgf6dTPJOmNNYw0H6SFqX0Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca; spf=pass smtp.mailfrom=ziepe.ca; dkim=pass (2048-bit key) header.d=ziepe.ca header.i=@ziepe.ca header.b=j8KJjF+c; arc=none smtp.client-ip=209.85.160.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ziepe.ca
Received: by mail-qt1-f176.google.com with SMTP id d75a77b69052e-42e2947a940so9511361cf.0
        for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 07:52:50 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=s5xm/gfWVf+yQyyplDkQQ3yLQGTBRkbE8RnRBTOW/pY=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWxVm225s4V6AEYBRvj7KIXMeHMzrz6m/Z+iwFsrg5IHwffJ0WfumQ/jYYQo5pqFliWp2yJu+QXuucqRytuNgpttfypRKKfIhZZ3Nfv
X-Gm-Message-State: AOJu0YwrJT0Urf8Ogjvo+ZIxTM9BijEbsVjCk7PmAFwyJtfDVcrw50fB
	G35kyaHhiRvZDctC4uYKXAhl7WGRNCMCiqrGnI7n2aKgBHdQikar4AY9DFR9ZiQQ0i0n2s3MgnN
	H

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5C48375FB09
	for <lists+linux-kernel@lfdr.de>; Mon, 24 Jul 2023 17:42:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229873AbjGXPmW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 24 Jul 2023 11:42:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56758 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230241AbjGXPmS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 24 Jul 2023 11:42:18 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DBF5510FD
        for <linux-kernel@vger.kernel.org>; Mon, 24 Jul 2023 08:42:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1690213336; x=1721749336;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=Mqn4bDVneT2yfURezIC5Jd9fQPUEX5jKgvlzjg7BeGw=;
  b=G73gGaQPJPpdqVhoncgzsaa/9nNu/kAwtYmYhQQZFfGX9DTJ3OYTJ4ao
   xTJjr2ypS9Q8dnRlI116JoZIjS2XPf/wSAwR2al+QbNoQr6TaVqokw4Tq
   BSYgFMzAgIwYHE9SwBAyipyRiK1gPBz4dkPO5XaN/exsEJcdVKKE3jNqR
   HYNt7G6JNR0Jjn8XfDW5u5huBKz4QTXECO7qDd+R5psKrPikVLRr3TqA0
   fE4h/AYLBSEo/Ycbcw17KyoNUq7mtN+ltp2cZ0mUeVqn/i6L75RfFkRfl
   GeI//znlHUE/zLt2DWovpM1r5LH3cCiBCadh3hg06vNv60fGHFByFWxq3
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="347751173"
X-IronPort-AV: E=Sophos;i="6.01,228,1684825200"; 
   d="scan'208";a="347751173"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jul 2023 08:42:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="1056461737"
X-IronPort-AV: E=Sophos;i="6.01,228,1684825200"; 
   d="scan'208";a="1056461737"
Received: from lkp-server02.sh.intel.com (HELO 36946fcf73d7) ([10.239.97.151])
  by fmsmga005.fm.intel.com with ESMTP; 24 Jul 2023 08:42:13 -0700
Received: from kbuild by 36946fcf73d7 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qNxhM-0009pK-2K;
        Mon, 24 Jul 2023 15:42:12 +0000
Date:   Mon, 24 Jul 2023 23:41:22 +0800
...
Subject: drivers/iommu/ipmmu-vmsa.c:946:34: warning: unused variable
 'ipmmu_of_ids'
Message-ID: <202307242342.Qqpnmi9E-lkp@intel.com>
MIME-Version: 1.0
...
date:   11 months ago
config: s390-randconfig-r014-20230724 (https://download.01.org/0day-ci/archive/20230724/202307242342.Qqpnmi9E-lkp@intel.com/config)
compiler: clang version 17.0.0 (https://github.com/llvm/llvm-project.git 4a5ac14ee968ff0ad5d2cc1ffa0299048db4c88a)
reproduce: (https://download.01.org/0day-ci/archive/20230724/202307242342.Qqpnmi9E-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202307242342.Qqpnmi9E-lkp@intel.com/

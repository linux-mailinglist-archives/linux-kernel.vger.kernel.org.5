...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B0E567A1496
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Sep 2023 05:50:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231944AbjIODuF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 14 Sep 2023 23:50:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49928 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231802AbjIODtv (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 14 Sep 2023 23:49:51 -0400
Received: from mail-pj1-x102f.google.com (mail-pj1-x102f.google.com [IPv6:2607:f8b0:4864:20::102f])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DF384270C
        for <linux-kernel@vger.kernel.org>; Thu, 14 Sep 2023 20:49:46 -0700 (PDT)
Received: by mail-pj1-x102f.google.com with SMTP id 98e67ed59e1d1-273fa877befso1253237a91.2
        for <linux-kernel@vger.kernel.org>; Thu, 14 Sep 2023 20:49:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1694749786; x=1695354586; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Rm+krVlt9ChUT98kjdiSzvBUDynfUvRDdSDScJNQWcs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1694749786; x=1695354586;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Rm+krVlt9ChUT98kjdiSzvBUDynfUvRDdSDScJNQWcs=;
        b=
X-Gm-Message-State: AOJu0YzwDDS0EpUKydPiN9DngXOG6bK0ohXon6oDNpN1KIXhQozu10R8
        dsVQ+FcNUt3qf5SHDxJ/C4/xgro45oHn9Oj3jT0=
X-Google-Smtp-Source: AGHT+IGq0TPP9N7jFduwoQ5J/UonVhnB3RLAi+M5zaycqKBsj8X/kfu6UPzu2mv85Jpp9LXCeJjRIw==
X-Received: by 2002:a17:90a:5aa3:b0:262:ecd9:ed09 with SMTP id n32-20020a17090a5aa300b00262ecd9ed09mr338989pji.33.1694749785878;
        Thu, 14 Sep 2023 20:49:45 -0700 (PDT)
Received: from charlie.ba.rivosinc.com ([66.220.2.162])
        by smtp.gmail.com with ESMTPSA id g5-20020a17090adac500b002739282db53sm3881409pjx.32.2023.09.14.20.49.44
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 14 Sep 2023 20:49:45 -0700 (PDT)
From:   Charlie Jenkins <charlie@rivosinc.com>
Date:   Thu, 14 Sep 2023 20:49:40 -0700
Subject: [PATCH v5 4/4] riscv: Test checksum functions
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230914-optimize_checksum-v5-4-c95b82a2757e@rivosinc.com>

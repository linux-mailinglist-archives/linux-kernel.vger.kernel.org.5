...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 97F8F785534
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Aug 2023 12:17:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233237AbjHWKR3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 23 Aug 2023 06:17:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42688 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232834AbjHWKRY (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 23 Aug 2023 06:17:24 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 12619170C
        for <linux-kernel@vger.kernel.org>; Wed, 23 Aug 2023 03:16:53 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=4aF4ld0tDDW7omndHzdLCWs/P3tkUZd6sk7eOgJWuQI=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1692785793;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=4aF4ld0tDDW7omndHzdLCWs/P3tkUZd6sk7eOgJWuQI=;
        b=Xs41ttvmsl6JG1Km1FAGW83nriQs+23AW6sms7RRMrM7bcgt6UU3/05hq1dmxg1GaZdtAn
        FOavPdQ7il3AttDg==
...
Subject: [patch V2 1/2] x86/microcode/32: Move early loading after paging
 enable
...
Message-ID: <87edjudpxb.ffs@tglx>
MIME-Version: 1.0
...
---
V2: Include the fixup for cpu/common.c which was lost on the test system.
---
...
@@ -226,40 +226,31 @@ static int __init save_microcode_in_init
 	return ret;
 }
...
@@ -270,23 +261,10 @@ struct cpio_data find_microcode_in_initr

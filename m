...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1AEC877CB71
	for <lists+linux-kernel@lfdr.de>; Tue, 15 Aug 2023 13:03:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236633AbjHOLDM (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 15 Aug 2023 07:03:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45624 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235059AbjHOLCr (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 15 Aug 2023 07:02:47 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B1F06E6B
        for <linux-kernel@vger.kernel.org>; Tue, 15 Aug 2023 04:02:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1692097366; x=1723633366;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=oIhEb8tGo0P/PlCuFOOOG6wjRMHQNz83TNd/+flu/TU=;
  b=FP5YRG8/9gZO1XjZEFvHVyioVB71jIhSOisX5iJgqQMyyFvFc5v1eOMl
   8hvSHTdDnFdO7AyVn25rZlna9kk73rb9wgEgfbgcwLsU4kSfjs36i76on
   pAjxH1Ziywo/Xo2+pLNHgq2HG+sOYRZHyTw3HCEpePIW3NnhKYma45PWf
   /k2dZ7OZwst48oiM864FMb1+jo2La/ehOCVj5ovKF/Vtw+JGQrmxE9sqK
   HC0dKjxg3PyJLuwuyO/Gk5sKw20A13OV1+zKiD/fX7TjaadHgYPQg3Nq/
   uDyjYBgY28VNmd1l0ibEY0Yao4RnSqwR7H4K1W15xwKDPkvAcXEud5jEI
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10802"; a="436148346"
X-IronPort-AV: E=Sophos;i="6.01,174,1684825200"; 
   d="scan'208";a="436148346"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Aug 2023 04:02:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10802"; a="763236170"
X-IronPort-AV: E=Sophos;i="6.01,174,1684825200"; 
   d="scan'208";a="763236170"
Received: from fwafula-mobl.amr.corp.intel.com (HELO khuang2-desk.gar.corp.intel.com) ([10.212.73.197])
  by orsmga008-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Aug 2023 04:02:43 -0700
...
Subject: [PATCH v4 08/12] x86/tdx: Reimplement __tdx_hypercall() using TDX_MODULE_CALL asm
Date:   Tue, 15 Aug 2023 23:02:02 +1200
Message-ID: <e68a2473fb6f5bcd78b078cae7510e9d0753b3df.1692096753.git.kai.huang@intel.com>

Return-Path: <linux-kernel+bounces-74544-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E799A85D5BA
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 11:37:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 97679281B12
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 10:37:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BA5811EB45;
	Wed, 21 Feb 2024 10:37:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="0ew9Qfgd";
	dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="Pnd196Sx"
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 92DF6F9E4
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 10:37:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=193.142.43.55
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708511853; cv=none; b=lUbWl9IKLnRuTK0vtBlnUIBA31FZ2oUK0RLdSpzs1fCY+ohGPvRPwIttZzRAG+u/zxZGcGDhTR/Rv4jiIdWay0nyMXe7NhTlFPjcYt7jy8qWuis2mr2ySONwp+Ns6RAfsI5hGoUhAcLDq4tXavk+7f2E1DIYh4MYWJ1cMmEW8pM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708511853; c=relaxed/simple;
	bh=hW1LdDBH4XPEOAamwO63n3lrsQxT1RAZQsL2liVtcJ0=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=YVkP0bVJlY4Y/a9HpYdddKpGkQG+EiZpo1MegtF8Hh1dLw4WJ/eLkE/xck2hvpL4Un9Jyt2+dYOnFeGqbKFTXk2Fejr6S8EAfKWsiuMmzutK++NwpANS3jPxIL6uQs9LH4bQeyVn27qoZT8lLN7OHhZbrXW781oSE2vO3PKAdqY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linutronix.de; spf=pass smtp.mailfrom=linutronix.de; dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=0ew9Qfgd; dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=Pnd196Sx; arc=none smtp.client-ip=193.142.43.55
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
	...
	bh=zWRvyTsUh/B3+75W/GeTr6pY25S0dBHg5iBTa+7ecog=;
	b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
	s=2020e; t=1708511847;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=zWRvyTsUh/B3+75W/GeTr6pY25S0dBHg5iBTa+7ecog=;
	b=Pnd196SxsDv5WuYSHNRPK7PIDKdP1VjrFtApfbUw24y4+22dwz5v/LDb86vfqovYukzvlA
	4DVuG3SCpPQ3aHCA==
...
Subject: [PATCH v11a] timers: Implement the hierarchical pull model
Date: Wed, 21 Feb 2024 11:37:04 +0100
Message-Id: <20240221103704.50640-1-anna-maria@linutronix.de>
...
---
 ...
 kernel/time/timer_migration.c | 1743 +++++++++++++++++++++++++++++++++
 kernel/time/timer_migration.h |  140 +++
 6 files changed, 1993 insertions(+), 8 deletions(-)
...
index 000000000000..ab2fd8868d11
--- /dev/null

Return-Path: <linux-kernel+bounces-20384-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id A36C2827DF2
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Jan 2024 05:46:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 36DB51F23747
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Jan 2024 04:46:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C98F3A5C;
	Tue,  9 Jan 2024 04:46:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="UE4INkBP"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 57B9639B
	for <linux-kernel@vger.kernel.org>; Tue,  9 Jan 2024 04:46:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1704775575; x=1736311575;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=EnlPrg19H/3aDxAA9XEwMjHwlnUeSkqx71EoSY6uxrc=;
  b=UE4INkBPCaM2c548uKvGaSJFArCsmeqvm51TqKkOpb2INcdlpxQXAv+W
   6u7JsBdW9YiGUIA8htluWH9y5/feV5HQ0pDbfjdybzf/LI/SkHSO637eu
   hgw6yQeyEYxPb73RvwdRRidnJ2xON4CujbKdArEl0M31SRs2khVf4I0pJ
   h9IYMedaYBE4z6C5ErepN5fv1GgtrBaWP9NnOqXxYBiFV5aYX+9e74XuJ
   hPpdAxKwGxCBE/EQklhjJAHbdfeen2H1RM1FgbBABm2/Rq0zF5tjZjbaf
   pc4+8gu287mb5SYQN17RYn3C23ZgSnHkN4MNNUHRoCZjvxwO3wD0bcTfs
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10947"; a="5449487"
X-IronPort-AV: E=Sophos;i="6.04,181,1695711600"; 
   d="scan'208";a="5449487"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Jan 2024 20:46:15 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10947"; a="1112945348"
X-IronPort-AV: E=Sophos;i="6.04,181,1695711600"; 
   d="scan'208";a="1112945348"
Received: from lkp-server02.sh.intel.com (HELO b07ab15da5fe) ([10.239.97.151])
  by fmsmga005.fm.intel.com with ESMTP; 08 Jan 2024 20:46:13 -0800
Received: from kbuild by b07ab15da5fe with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1rN40B-0005TW-0o;
	Tue, 09 Jan 2024 04:46:11 +0000
Date: Tue, 9 Jan 2024 12:45:14 +0800
From: kernel test robot <lkp@intel.com>
To: Jens Axboe <axboe@kernel.dk>
Cc: oe-kbuild-all@lists.linux.dev, linux-kernel@vger.kernel.org
Subject: fs/eventpoll.c:526:9: sparse: sparse: restricted __poll_t degrades
 to integer
Message-ID: <202401091221.cupISW8z-lkp@intel.com>
Precedence: bulk

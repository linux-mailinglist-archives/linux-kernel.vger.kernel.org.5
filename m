Return-Path: <linux-kernel+bounces-111918-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FADF8872A5
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 19:09:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1717C1F229C8
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 18:09:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 58BCE626C4;
	Fri, 22 Mar 2024 18:09:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="i2M4bAgB"
Received: from mail-pg1-f173.google.com (mail-pg1-f173.google.com [209.85.215.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 16EB2626C0
	for <linux-kernel@vger.kernel.org>; Fri, 22 Mar 2024 18:09:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.215.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711130952; cv=none; b=cTTURGc+3zee4JIQH5dPbcWzGd8sttPMPAIJxFNMr4G2e4GPDsUYys5AUUPg/cpJ41QdCOxQOOwHqpMasbFFIKQeZ5NuRVmYIKfm3Ck2GOAR9vI/oWlFoBWf9nEspiFghUHtkw6nj3sdKl1mUUSwwAOXSHDby3Y34fwnZU9xprU=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=i2M4bAgB; arc=none smtp.client-ip=209.85.215.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pg1-f173.google.com with SMTP id 41be03b00d2f7-5ce07cf1e5dso1433010a12.2
        for <linux-kernel@vger.kernel.org>; Fri, 22 Mar 2024 11:09:09 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=zIDjLYOAoTtitEy2EbjJ+uIGL56wEX/Yq/x0rNRFB3U=;
        b=
X-Gm-Message-State: AOJu0Ywx35chkdXH9A9AWcnLfweZsQzuKzP7iQBvNYaRXyBqPeA1NQ0q
	+sYhNU9T8oyPFeLpeFZTmNRggXaed9SmMXYCCYMW5Nlfao6ye7r+se3VgbhiyxctvbT2DMNxeP1
	V//S8fhDU9vMoBk8/nPaKZFk9hBXiKArORe4/cg==

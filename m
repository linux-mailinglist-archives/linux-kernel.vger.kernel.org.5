Return-Path: <linux-kernel+bounces-75601-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 88F0185EBCC
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 23:26:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2E97F284CB1
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 22:26:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CDF2812A169;
	Wed, 21 Feb 2024 22:26:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b="ALJlKaZV"
Received: from mail-pg1-f170.google.com (mail-pg1-f170.google.com [209.85.215.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 77A92128824
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 22:26:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.215.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708554392; cv=none; b=FcSOiPN3zwS8Xv3aj7wDCNX45Cy5tuTPO1HRc0bxIqMJAidLV0cEUxeJ73/lirM8BjakH9mfD0IOZEqu5y3a7chB/urKq3rLcgUWNRMvmwzkrQV9Yer0AsEimteZhH4x9Y/tSe/18Co8OgMtcNwbCQoGTWCZ6PYv4zQO1kgKTdg=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=ALJlKaZV; arc=none smtp.client-ip=209.85.215.170
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-pg1-f170.google.com with SMTP id 41be03b00d2f7-5ca29c131ebso806691a12.0
        for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 14:26:30 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=txLjvpHfcPOAvCzm7tKc5Hfer4Q6fREWgHUslS9S6CQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWQMbCuSaj86qWmp7JxjIzMWT2N4v9I/ynoru3isHztmnjlDRDn4+qK9wE0ynqACCYofyhvcPvJzS/ZdqNCa0KVBEFE+bDRq5QB/RdU
X-Gm-Message-State: AOJu0YySc/3vk/AE3NmsXIgSHeCb+eAyDJYMNtTEGgr+029ro0L/8osa
	lLnudk2KmEiQTy+7bGzevr1v6q2zt6JMTXJFov6LsecZ1LkkiKHW7aidXQuVnQ==

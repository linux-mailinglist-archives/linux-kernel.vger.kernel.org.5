Return-Path: <linux-kernel+bounces-60744-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 20B36850916
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 13:33:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 44A3D1C20B01
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 12:33:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EC8ED5DF08;
	Sun, 11 Feb 2024 12:30:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="VeEnDtYj"
Received: from mail-lj1-f172.google.com (mail-lj1-f172.google.com [209.85.208.172])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6C6775C5FE
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 12:30:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707654635; cv=none; b=Wj911cPeU07yOTath9xaMPS8VkqfW8cOcjm5ISsWUeUW2GkMufDldhQx7COBtWQTArl/CnfIuInpDdoo3dwFlW7aEHDGsVn+fo8jVl2HompCbfi0nNTdZ4qxzhAW+1q2qKdILMteVMbV8NdZZpYEZ3fgkmWE7M68+WR9YRjDjVk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707654635; c=relaxed/simple;
	bh=DFtkYlLlNabbshH9GwA9kiSm8fKyjyUMYUieRVNx8fg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=Fd1mrOdGuY2WDmIbYMiW/ZXbcu5Ztek/iPPO/Yjjsy2pLXUuLX4AYMhoHH9ipnMpShVKdZ9tQx7BEa7Zuzdx/nEpDu5WBcJ+mA1sgsQW5j65mWsL6EajnelDUbpKSeSrTqQl2DjmEAn8o2x3I347GmpR6M8g5ayDJ+PD0Rl0PYU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=VeEnDtYj; arc=none smtp.client-ip=209.85.208.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-lj1-f172.google.com with SMTP id 38308e7fff4ca-2d0e2c90f84so18625831fa.2
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 04:30:31 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707654629; x=1708259429; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=/J9uDdEO2uVwAKDurDnR1+NlqV3E98caoyDJWoT9R94=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707654629; x=1708259429;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=/J9uDdEO2uVwAKDurDnR1+NlqV3E98caoyDJWoT9R94=;
        b=
X-Gm-Message-State: AOJu0YyovgxDuuyj1Fh0DuYlaP7x0x1Thu74C37ZXdueazIlNme2JnYA
	FYf7EIVmWeTDaXwpaAT/30ZrmabAuZOQX6N1+w+FB1GrTGk5vDX6GXchySkfjUI1kzRiXIotnTy
	n
X-Google-Smtp-Source: AGHT+IGdbDdN3Bks70p7UMpS/Zjs2NPRDD84amU8LGbFvqJF3VjnijUrCneK7og79qkE4PIQ8PCbUA==
X-Received: by 2002:a2e:8847:0:b0:2d0:d75e:54e7 with SMTP id z7-20020a2e8847000000b002d0d75e54e7mr2531126ljj.17.1707654628959;
        Sun, 11 Feb 2024 04:30:28 -0800 (PST)
...
Subject: [PATCH v3 15/35] completion.h: move declarations to completion_types.h
Date: Sun, 11 Feb 2024 13:29:40 +0100
Message-Id: <20240211123000.3359365-16-max.kellermann@ionos.com>

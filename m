...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AEA837BE6A9
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Oct 2023 18:38:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377640AbjJIQiQ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 Oct 2023 12:38:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39492 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377245AbjJIQiO (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Oct 2023 12:38:14 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D42B5B9
        for <linux-kernel@vger.kernel.org>; Mon,  9 Oct 2023 09:38:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1696869492; x=1728405492;
  h=date:from:to:cc:subject:message-id:references:
   content-transfer-encoding:in-reply-to:mime-version;
  bh=vOVdywe+73U6renY6kpDc7fi1ouPeTCaX3AfNcE0RwY=;
  b=FW20NZhyfOjCdYdF3mX8CCuBFdZIp2fqgC25KttK+4xnHjVOcySRzv6v
   ZMDHCdH2QeBDE+Ha1rW8you7120dSBv7s5TyE1Zop4/toXsQyTFjrfDhL
   TQ95KudkANHuyc+9ftEHnMMpkX8g6gXL7XSh67YgaL+E67cjjzPZYPSSN
   QGii9IoBuEm53KE/YOO6F1fv90BmKVbJ3d9/5Fmol7nXJ/kQJ3PZRUDRg
   MCYLq2xkJikp48TIxYo9ielkDLrDNZ6ZNIRikyKtgXMTrOdoM4dgJWmhf
   d1N2NVFlOQEB93Ai/56Bkr60LR5InSSPwXsH1Aw+F2M121t9Bh5tPIyX/
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="415177563"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; 
   d="scan'208";a="415177563"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Oct 2023 09:38:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="746740006"
X-IronPort-AV: E=Sophos;i="6.03,210,1694761200"; 
   d="scan'208";a="746740006"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
  by orsmga007.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 09 Oct 2023 09:38:11 -0700
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Oct 2023 16:38:08.4412
 (UTC)

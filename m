...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3C35F7DF989
	for <lists+linux-kernel@lfdr.de>; Thu,  2 Nov 2023 19:05:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235599AbjKBSES (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 2 Nov 2023 14:04:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56112 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377227AbjKBSD7 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 2 Nov 2023 14:03:59 -0400
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5035C2705
        for <linux-kernel@vger.kernel.org>; Thu,  2 Nov 2023 10:59:52 -0700 (PDT)
Received: by mail-yb1-xb49.google.com with SMTP id 3f1490d57ef6-d9a5a3f2d4fso1438046276.3
        for <linux-kernel@vger.kernel.org>; Thu, 02 Nov 2023 10:59:52 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698947991; x=1699552791; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=VldR5z4r88rv+DMtp8hXhtPgmqCeMt1b298/ScQLf0U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698947991; x=1699552791;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=VldR5z4r88rv+DMtp8hXhtPgmqCeMt1b298/ScQLf0U=;
        b=
X-Gm-Message-State: AOJu0YxlUkwyG/fSJhWRpShR2UVtY0F5dIf8OCcI3ZMP52npF4PAmDEy
        QAhW7PdxJPMHZI5kutX3dgK/WnhGQjDS
X-Google-Smtp-Source: AGHT+IElVRusdXlHnpNKZ9kn6sUu8dma+PsWh5SDRSwGxzCgXUUarpuCDzXY9bla4lN4Hg2+7xHRIg1bJSiB
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:bb34:df9c:836c:afca])
 (user=irogers job=sendgmr) by 2002:a25:abe2:0:b0:da0:48e1:5f46 with SMTP id
 v89-20020a25abe2000000b00da048e15f46mr366011ybi.9.1698947990735; Thu, 02 Nov
 2023 10:59:50 -0700 (PDT)
Date:   Thu,  2 Nov 2023 10:57:32 -0700
In-Reply-To: <20231102175735.2272696-1-irogers@google.com>
Message-Id: <20231102175735.2272696-51-irogers@google.com>
Mime-Version: 1.0
References: <20231102175735.2272696-1-irogers@google.com>
X-Mailer: git-send-email 2.42.0.869.gea05f2083d-goog
Subject: [PATCH v4 50/53] perf dso: Add reference count checking and accessor functions

Return-Path: <linux-kernel+bounces-6945-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A5AB819F9C
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 14:13:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 75BA3B21D7D
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 13:13:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8C8232CCB8;
	Wed, 20 Dec 2023 13:13:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Gwl5bYSG"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D5DBF2557B
	for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 13:13:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703078014;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=gC06Iuhld4gGWQeiYLjfNCaTKjF5LPO2upvpHoucK9c=;
	b=Gwl5bYSGYZlkUkoX/nMyBHD2jCEIqWsE8Y62FqCSzwWRGQM/oNiH17bSVT2yS0IazeOBXi
	zJmX/UJWrKKMH2siqoeZFzvFJNUvreJ4+peffnPwS2/YCmjQhSVG13XtriPGi4c3jsGPhD
	ALz4H7IIQmqB190v/A5Hj9gpGJ0fmV8=
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 [209.85.128.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-73-ohjbsNb4O3-rOP0Y0FX6-Q-1; Wed, 20 Dec 2023 08:13:33 -0500
X-MC-Unique: ohjbsNb4O3-rOP0Y0FX6-Q-1
Received: by mail-wm1-f71.google.com with SMTP id 5b1f17b1804b1-40d2fa6b23eso11143245e9.2
        for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 05:13:33 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703078012; x=1703682812;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=gC06Iuhld4gGWQeiYLjfNCaTKjF5LPO2upvpHoucK9c=;
        b=
X-Gm-Message-State: AOJu0YzRt0g9ltQ/cHsfkmU1PZQK8yVgpLGFjj0F0ZDw9wF5noVlV5dw
	k9hYEuCJZ0W8poBp3NFCR66CkFUOYB0i8q7ZxGkkN5H8mAA27pl+c0C/aPUeO/znpIJgO27LUvU
	w9cyVftz1JDH2EaUG85M8CgVJ
X-Received: by 2002:a05:600c:2942:b0:40c:357e:27b with SMTP id n2-20020a05600c294200b0040c357e027bmr7023046wmd.162.1703078012058;
        Wed, 20 Dec 2023 05:13:32 -0800 (PST)
X-Google-Smtp-Source: AGHT+IFQ+Kryyn6gbLsJd0wE9UKgRQiPhWai9agolcmWS+yuTRZjiWWZPCk5LfTTRj9qqONCXq8xtA==
X-Received: by 2002:a05:600c:2942:b0:40c:357e:27b with SMTP id n2-20020a05600c294200b0040c357e027bmr7023028wmd.162.1703078011516;
        Wed, 20 Dec 2023 05:13:31 -0800 (PST)
Received: from ?IPV6:2003:cb:c73b:eb00:8e25:6953:927:1802? (p200300cbc73beb008e25695309271802.dip0.t-ipconnect.de. [2003:cb:c73b:eb00:8e25:6953:927:1802])
        by smtp.gmail.com with ESMTPSA id x12-20020a5d650c000000b003366c058509sm2194735wru.23.2023.12.20.05.13.30
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 20 Dec 2023 05:13:31 -0800 (PST)
Message-ID: <c244707c-8c0c-4593-ab45-d8f165dbc5ee@redhat.com>
Date: Wed, 20 Dec 2023 14:13:30 +0100
Precedence: bulk
...
In-Reply-To: <c1913fa2-d313-4f05-a649-da69b6d31d2a@arm.com>

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EFEC37B421D
	for <lists+linux-kernel@lfdr.de>; Sat, 30 Sep 2023 18:26:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234507AbjI3Q0Y (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 30 Sep 2023 12:26:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54444 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232221AbjI3Q0V (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 30 Sep 2023 12:26:21 -0400
Received: from mail-oo1-xc32.google.com (mail-oo1-xc32.google.com [IPv6:2607:f8b0:4864:20::c32])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 80C13A4
        for <linux-kernel@vger.kernel.org>; Sat, 30 Sep 2023 09:26:15 -0700 (PDT)
Received: by mail-oo1-xc32.google.com with SMTP id 006d021491bc7-57b9231e91dso7181192eaf.2
        for <linux-kernel@vger.kernel.org>; Sat, 30 Sep 2023 09:26:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1696091175; x=1696695975; darn=vger.kernel.org;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
        bh=6adUP00tdcHtXGpxNjhzLCuAOeDqmIY6/m/LqO7Lmuo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1696091175; x=1696695975;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=6adUP00tdcHtXGpxNjhzLCuAOeDqmIY6/m/LqO7Lmuo=;
        b=
X-Gm-Message-State: AOJu0Yy1HB3A9oJipV2zCEI4APc5VOo0KzzO517OTPZouLR8TtbSetRo
        E6oxn0UzDbmPHXZphGRGUYg=
X-Google-Smtp-Source: AGHT+IHDD3aAg3gJGMwf4g1Yrcqvj3FWparMjOdqoAMluT7k6Bdod6pZ3DDSrw26SCADGC345GFOjA==
X-Received: by 2002:a05:6358:e49e:b0:14c:d9d1:7ac4 with SMTP id by30-20020a056358e49e00b0014cd9d17ac4mr7840680rwb.6.1696091173890;
        Sat, 30 Sep 2023 09:26:13 -0700 (PDT)
Received: from fedora ([114.29.91.56])
        by smtp.gmail.com with ESMTPSA id x6-20020aa793a6000000b0068c006dd5c1sm5211402pff.115.2023.09.30.09.26.07
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 30 Sep 2023 09:26:11 -0700 (PDT)
...
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>,
        ...
        x86@kernel.org, 42.hyeyoo@gmail.com
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="43pNwtEx5xMEzfod"
...
CONFIG_BUILD_SALT="6.4.12-200.fc38.x86_64"

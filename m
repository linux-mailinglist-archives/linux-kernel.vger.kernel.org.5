Return-Path: <linux-kernel+bounces-60988-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 8151D850C29
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 00:16:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 96D721C20F08
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 23:16:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0D60E17BCA;
	Sun, 11 Feb 2024 23:15:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="MTfmD2ex"
Received: from mail-lj1-f182.google.com (mail-lj1-f182.google.com [209.85.208.182])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 007CE17557
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 23:15:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707693344; cv=none; b=Z/o+b/h3w5bmxHH3ScUIwoFiRdH65+FJAJmMhIxl4LI0TpC5DQXYEDI67dAHrr3mldZRm6hxS+XN3JAxikDR+Z2qJSPgbnuOu0iX2KPiKgbvKIQBf11AYswTXMZ+OexLubwKnEcVTl3qwkvHDWMKWNMvuWWbJSD8ui8khnPpTvs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707693344; c=relaxed/simple;
	bh=liDxdnGi0VxEh4RjE/Dk2wkmMdIq8rkf3AAOj1MYkS8=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=j/FiW1AalfeL/FNo/Lsneo9GsSc6/RMB3cclK5JzjG5Ho/7s1zStNe6Xe5B3QocFigV0TYWV4C6cnSnYnZOWSU5VstxxQw/J53mH3nmpBYYgP8Ut/jnvvj3skT7zBt18x/WWdJIWaC9gbgM8uUL2LoEj/HENV/pZrvmQ45MWvzY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=MTfmD2ex; arc=none smtp.client-ip=209.85.208.182
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-lj1-f182.google.com with SMTP id 38308e7fff4ca-2d0b4ea773eso34913671fa.0
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 15:15:38 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707693336; x=1708298136; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ZMCsnzVZo/kxSsTnZ5adWRd3uURplacvAAxO/uYutbE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707693336; x=1708298136;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=ZMCsnzVZo/kxSsTnZ5adWRd3uURplacvAAxO/uYutbE=;
        b=
X-Gm-Message-State: AOJu0Yz3rX+OlEXtSAW9TACLnXJ+Z86J+k4JM8SfqwEE9if9MPo0Bd5x
	5dIEkVehqkuIN4v7VCvqVYLegW6n5qHpiVazMGZj4pjrVH+woSIy+9obnm90YUyZu6Pt3rB6T1N
	l
X-Google-Smtp-Source: AGHT+IGA4vv5WGIP/kBHIxCIiVz6qaFLzEUIMyNg3rDVYrdKtNrnoUOWXZp5isZc5zZnKVI6YRFBSg==
X-Received: by 2002:a2e:a0d5:0:b0:2d0:e055:7254 with SMTP id f21-20020a2ea0d5000000b002d0e0557254mr2984528ljm.34.1707693335788;
        Sun, 11 Feb 2024 15:15:35 -0800 (PST)
Received: from raven.blarg.de (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id et13-20020a056402378d00b0055d19c9daf2sm2170180edb.15.2024.02.11.15.15.34
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 15:15:35 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v4 06/35] kobject.h: move declarations to kobject_types.h
Date: Mon, 12 Feb 2024 00:14:49 +0100
Message-Id: <20240211231518.349442-7-max.kellermann@ionos.com>

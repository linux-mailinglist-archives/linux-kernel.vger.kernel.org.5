...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EF7257E89A2
	for <lists+linux-kernel@lfdr.de>; Sat, 11 Nov 2023 08:43:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229991AbjKKHhh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 11 Nov 2023 02:37:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55324 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229537AbjKKHhg (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 11 Nov 2023 02:37:36 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CCF3D3C19
        for <linux-kernel@vger.kernel.org>; Fri, 10 Nov 2023 23:37:31 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1699688251; x=1731224251;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=+rhEesG7Q/XkFgCLVk42/r6Idipiswys5HH/r6cqY2Q=;
  b=f2L1A+4MvOsRhNzCFAJylTEBEsKNDtzap2meGGKmVekLU0YRv98pOwTS
   BF9rQbXW3PLWGVOIIj9DSJF5OAYShPkez2Wv6PHahSMvQimslq14K+2n0
   NXp1L9QkprcgTNb+6Bm6urLic2rY3c8ODjfvAEF28WfB4CRP7z6TQU7Oi
   CSlULlHfbf1yERIypfrPgb5F3TKMRmRjArG8gqeIGjmh6mnty6HbY9N63
   n07VQv25mmBw7POo7mcL4Tze1KHqqU9uPElYV0B6SVZxjQ1isQ3SzZGP4
   U5817u89JRSJTYR7E+7XQPrA6IG82+v/jt2HBmlTLUZv40wADNXuKeR9w
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10890"; a="387426293"
X-IronPort-AV: E=Sophos;i="6.03,294,1694761200"; 
   d="scan'208";a="387426293"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Nov 2023 23:37:31 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10890"; a="834304854"
X-IronPort-AV: E=Sophos;i="6.03,294,1694761200"; 
   d="scan'208";a="834304854"
Received: from lkp-server01.sh.intel.com (HELO 17d9e85e5079) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 10 Nov 2023 23:37:30 -0800
Received: from kbuild by 17d9e85e5079 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1r1iYZ-000AIc-2m;
        Sat, 11 Nov 2023 07:37:27 +0000
Date:   Sat, 11 Nov 2023 15:36:55 +0800
...
Message-ID: <202311111512.IuUi0ceL-lkp@intel.com>
MIME-Version: 1.0
...
date:   11 months ago
config: loongarch-randconfig-r133-20231107 (https://download.01.org/0day-ci/archive/20231111/202311111512.IuUi0ceL-lkp@intel.com/config)
compiler: loongarch64-linux-gcc (GCC) 13.2.0
reproduce: (https://download.01.org/0day-ci/archive/20231111/202311111512.IuUi0ceL-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202311111512.IuUi0ceL-lkp@intel.com/

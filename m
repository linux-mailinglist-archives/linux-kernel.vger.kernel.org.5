Return-Path: <linux-kernel+bounces-72671-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B090185B6FA
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 10:16:35 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 9A1BB286AFC
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 09:16:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4BDF665BD3;
	Tue, 20 Feb 2024 09:12:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="kS1+pgiJ"
Received: from mail-pl1-f172.google.com (mail-pl1-f172.google.com [209.85.214.172])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 68A5965BCB
	for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 09:12:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708420371; cv=none; b=kaFfycbKpNIyoJUyyhOmB8NsVdjk3LXhw5DkasRM0H3QFETlWep5BrAEGKKHa2/HfQf84cC+Y90VMuvB84g8VmCNltwr6+xsddt6//TlQ2QWF3gaKUrz2JSwcIZwschYenlGLILQ7MWzKr1QjUz3zHzb/vSctQzyl4boY6UFzsM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708420371; c=relaxed/simple;
	bh=Ol5Ntm2yNP3DjW38QkTke/uS3FGgRZ4X7MiIrRAKNz0=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=Jr3DNkWA8Mkf0N4GJB5Nf+gmAaG9SkETfje4boeyiQaKO6yM72kHU/LO9J+vacI/4LWYJygITBk1j9Sbeg2YQkkqt2d+LbWHGdEBljgnMKj3KmYItCWY5HIflA2PvxVZqfQidDuhEywsxwq0CK5Tqz1H+SEdCv5sxslL/5BNptc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=kS1+pgiJ; arc=none smtp.client-ip=209.85.214.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pl1-f172.google.com with SMTP id d9443c01a7336-1db6e0996ceso37948945ad.2
        for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 01:12:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1708420368; x=1709025168; darn=vger.kernel.org;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
        bh=mmTXmA4IxXbLRuO1okQR2E8a98QtHuQeh51nR+DHemo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=mmTXmA4IxXbLRuO1okQR2E8a98QtHuQeh51nR+DHemo=;
        b=
X-Gm-Message-State: AOJu0YweCly7nJn94Gf4sDBQTUUH2ST8BdzOnt4TFetZKC6XUvhUHvUB
	LvLe8B310ZhvPWfQrxW5ZxmnqVQphw3tnxScY6B09/THc3Lhw58j
X-Google-Smtp-Source: AGHT+IFL+RJSEuaSv3fi2mTBA6VAduVL4ZiKPcIMGjB3ZCfHVjqVdnjvQbaUO3yXuQaG3Q6iRWTnMQ==
X-Received: by 2002:a17:902:f551:b0:1db:e74b:5bbf with SMTP id h17-20020a170902f55100b001dbe74b5bbfmr6911085plf.0.1708420368259;
        Tue, 20 Feb 2024 01:12:48 -0800 (PST)
Received: from archie.me ([103.131.18.64])
        by smtp.gmail.com with ESMTPSA id t12-20020a1709028c8c00b001d949393c50sm5687300plo.187.2024.02.20.01.12.47

Return-Path: <linux-kernel+bounces-139862-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 4FDE38A0895
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 08:37:49 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 729281C21E2C
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 06:37:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8C2E713D617;
	Thu, 11 Apr 2024 06:37:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="giMzWZzS"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B9B7713CA86
	for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 06:37:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712817457; cv=none; b=ev5SOb+QC9njBPQZkWsqPNmJw91O5iNaXQsHZnC5FMT4tnGbYZmhU2pyTVjjDuPuDQd2+yXyj7DWW9yPBBjIrJMQ3LcmPlgz032WfRn1apnxpxAehfG2+qujXexA0Vv7iVOFmOm91PJdtqRsRSsx9yVxB2zP4Duy3Rckytlhkro=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712817457; c=relaxed/simple;
	bh=J4MtSGZ9A4PqQEESdLkR2qbhqClsDX2SFx9QZn6D+7I=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=KArRjnxlRQGT/fPzBYvUTD3BJsr/2pzlzzaUb+EZl3jsjFqAOcCSSX25GLwPhe/kK/fQLz/XEYaLlcOu68Q34slBEkC7fZ00YqUb211J9WHwqoc4mC0hr8Q9FXubL4epkheQMO8UtNDjZm0Ux1yLhMP4KVg2edlSErrNcF4BRsg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=giMzWZzS; arc=none smtp.client-ip=10.30.226.201

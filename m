Return-Path: <linux-kernel+bounces-47465-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D4391844E4E
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Feb 2024 02:07:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 0477E1C22A4E
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Feb 2024 01:07:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3AC9C125D2;
...
Received: from refb01.tmes.trendmicro.eu (refb01.tmes.trendmicro.eu [18.185.115.53])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C2DDA6121
	for <linux-kernel@vger.kernel.org>; Thu,  1 Feb 2024 01:06:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=18.185.115.53
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706749601; cv=fail; b=Hnh3dAqA+zdhTvboVOVxSvk7bbKZlBlBFHl+tZCVmH5S/Fmjp5nbjKzMlXFzHCfVr36p7Q4kR+A+sCgMPsW/HukUldHiNS3HO4ypa29iyqrga26pUpLQ+1O38x5I/TN7yxn3kPc40RJXV/pUwVb98YcmEMlo/Ab3Ou5EVxNYDIc=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706749601; c=relaxed/simple;
	bh=D57pOeABfamN98NGLpRroVr6iGToMt3H85oc0X/wUSE=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version:Content-Type; b=IBFCTnYzmP06ZJG121pz7A77vafQPvQ9pyhwkWi2p0UzHNCkd5wyWLxeTgk3ktkBPsw9xPHWw57UCMlXJad6LNK1nTnVwnaFyXq6ErsRHAgiby51NAAaYqM2PFECLpHsHyyhylcMcCrSrhvbjrYlViz777fMNzl+C2liyoFVhWs=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=opensynergy.com; spf=pass smtp.mailfrom=opensynergy.com; dkim=pass (2048-bit key) header.d=opensynergy.com header.i=@opensynergy.com header.b=AkFHexsJ; arc=fail smtp.client-ip=18.185.115.53

Return-Path: <linux-kernel+bounces-86014-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8252786BE8E
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 02:52:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 37F3C2820F7
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 01:52:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0D3183612A;
	Thu, 29 Feb 2024 01:52:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=riseup.net header.i=@riseup.net header.b="m8e3tNSz"
Received: from mx0.riseup.net (mx0.riseup.net [198.252.153.6])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6975C2E84B
	for <linux-kernel@vger.kernel.org>; Thu, 29 Feb 2024 01:52:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.252.153.6
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709171547; cv=none; b=bGsPmxVk83qt4PHvI4byZvA5TwLpQkmfQRfYtmhyIQCDCu73fsNTSRuTvcXoL8Rkn+CrHmhUYPpEdf+pnxgoA1g8+ejAfAxNjeZ3kO3RLQxFPX1vsEUWLKx7hIoidL61ikEo3j12ajBdd8F1337RLTWaV0RXrVmxKxTN/KBrsQ0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709171547; c=relaxed/simple;
	bh=8Z53E8KQGcsZNKGI8YNr/o9l8s32OQUI3YC17G3LwOg=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:References:
	 In-Reply-To:Content-Type; b=RT2kShZUe+D5HVS+p6RBfaERTdh3QAcyZrDf3MtjmyA+/fJftCR/cDmR7LAFjJs+G8AwN8lbM3YHhPcAeEmeYdc67WOXeuXLQmw0+pxYt0J6IV22it6jFR7gKcbUcANpKTgMAUdsIbtbcdiaNy9u8ZFjS3IM3VHosYJZC5vqMPI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=riseup.net; spf=pass smtp.mailfrom=riseup.net; dkim=pass (1024-bit key) header.d=riseup.net header.i=@riseup.net header.b=m8e3tNSz; arc=none smtp.client-ip=198.252.153.6

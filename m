Return-Path: <linux-kernel+bounces-89577-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 1514D86F23E
	for <lists+linux-kernel@lfdr.de>; Sat,  2 Mar 2024 21:16:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 7E47F1F21E79
	for <lists+linux-kernel@lfdr.de>; Sat,  2 Mar 2024 20:16:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 88D3F40859;
	Sat,  2 Mar 2024 20:16:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="Kj44wMGj"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 59E9C2BAEB
	for <linux-kernel@vger.kernel.org>; Sat,  2 Mar 2024 20:16:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709410577; cv=none; b=S/GxB2IREKgSpE2WXofakFQ4EHdIAlL6ENC6DMzKZ9CfEG/vo900WVRRhl4dvSTsUyVk7t2oiyCxcbLu1l6pqZbNomM71HGpPPWmpN7wK0gcar2tPlCx5nE3JzutD40W0V5mT+yLwhzw8m1GQ0o8QcZST0vhDPNrE29wX1+7e68=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709410577; c=relaxed/simple;
	bh=xDdrYpyVOwjGGlpNGRXysIve2+7n9nWp+p/YQeSXGoU=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:To:Cc; b=CzstmMiESx5CseuO3ZX5a8vfYP5KyocL7vrJ7w7WhddMibH0xyTb9AizD7Qss2TvNDkBabGo6uKN1M4iCmMnDlDbQbH4nLcJQTVyFSIseDEcHFCaHvnHFF9XpAvQ4YWgwduqZ1GLf5aIEMkFdIFUzRBDFa+ekUEEOYeQ5Q7S7N0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=Kj44wMGj; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 7E6D8C433C7;
	Sat,  2 Mar 2024 20:16:16 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1709410576;
	bh=xDdrYpyVOwjGGlpNGRXysIve2+7n9nWp+p/YQeSXGoU=;
	h=From:Date:Subject:To:Cc:From;
	b=
From: Chris Li <chrisl@kernel.org>
Date: Sat, 02 Mar 2024 12:16:04 -0800
Subject: [PATCH v3] zswap: replace RB tree with xarray
Precedence: bulk
...
Message-Id: <20240302-zswap-xarray-v3-1-5900252f2302@kernel.org>
X-B4-Tracking: v=1; b=H4sIAAOJ42UC/13MQQ6CMBCF4auYrh3TGaCgK+9hXFQ6QKMB0poKE
 u5uISYGl+8l/zcJz86yF6fdJBwH623XxpHsd6JsdFszWBO3IEmpRJnC2790D4N2To+QoyIlOUu
 RExGT3nFlh5W7XONurH92blz1gMv7hTDfQgFBgjJaF6qURaX5fGfX8uPQuVosUqBfTXT8qwkQO
 JNUpKYqzQ039TzPH6jN62XnAAAA

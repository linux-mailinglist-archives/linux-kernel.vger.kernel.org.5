...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 002D77CE5B2
	for <lists+linux-kernel@lfdr.de>; Wed, 18 Oct 2023 19:59:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344888AbjJRR72 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 18 Oct 2023 13:59:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57098 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345053AbjJRR7E (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 18 Oct 2023 13:59:04 -0400
Received: from mail-yb1-xb32.google.com (mail-yb1-xb32.google.com [IPv6:2607:f8b0:4864:20::b32])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3E82C1730
        for <linux-kernel@vger.kernel.org>; Wed, 18 Oct 2023 10:58:36 -0700 (PDT)
Received: by mail-yb1-xb32.google.com with SMTP id 3f1490d57ef6-d9c2420e417so3201342276.2
        for <linux-kernel@vger.kernel.org>; Wed, 18 Oct 2023 10:58:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1697651915; x=1698256715; darn=vger.kernel.org;
        h=mime-version:references:in-reply-to:message-id:date:subject:cc:to
         :from:from:to:cc:subject:date:message-id:reply-to;
        bh=2ITpFPLGy2vK70umJQhcS1sYA8/nO58CJBaBDN7GgJE=;
        b=Bo+SaTecNaeKqbuW8LFN9r30AXCFwO5fqv9waSvEAsqIS0q/hMMKVpTOtp/Snp0pN9
         NBHHLj/gNYjs7vlJ9WS2tl+Itp74QK1ZwpTvWOfi9A+ubJD2co1CE+kNqx8xsaEB44VE
         n3c+QhufrNe0D6z9f5ohqqZLpiELbzrwF00cI=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1697651915; x=1698256715;
        h=mime-version:references:in-reply-to:message-id:date:subject:cc:to
         :from:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=2ITpFPLGy2vK70umJQhcS1sYA8/nO58CJBaBDN7GgJE=;
        b=
X-Gm-Message-State: AOJu0YxlRZYUlo0prqvlDJdLGa7GOKzurBLfXWV4AExRX7xBzkXaVz9K
        Vo6dx5HVs/wUGkY9Ox7JoiRRiQ==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="00000000000065251a0608016395"
...

KrSw
--00000000000065251a0608016395--

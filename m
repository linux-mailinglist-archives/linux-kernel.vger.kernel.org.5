Return-Path: <linux-kernel+bounces-101647-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id BB4F987A9D4
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 15:57:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 339AFB220BE
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 14:57:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 670063FB8B;
	Wed, 13 Mar 2024 14:57:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="ZPSXTLiu"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.14])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 910975CB8
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 14:57:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.14
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710341852; cv=fail; b=HgnHe5oEjG2Au39NYRFpOfMoh6/4L/iKLirKPKqC8AUCRxM5m582GAtgBS9C6wkDYFbWxV0FuZ7g1WXQw4db27+FsaotNAM1DfXIgOoai7QWCNheeeuddnzEd51z/OrRTD1hKCqC60abN6NfO/FVKVApQyuzjew1hOIBSilmwt8=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710341852; c=relaxed/simple;
	bh=cvXITNzngUSPQIoAnMgD7QVEAN1H8hhv9LyTmR0ySlU=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=NaZ2ztdM8NZj1IIoRUJdawx+7HDhxPtRkrXy24YPX5XzarNDFKE2lnoGFbYkUgyw6YrbuRurI5deGK4OdjdVdpYkR5xI2fCpOkmgWZtEOYlrV6c0U6i6Le2cq6bJ6el8NWsQFKod0rrFgbfaUX035D9/AXACJWesTXnT2ZLXejo=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=ZPSXTLiu; arc=fail smtp.client-ip=192.198.163.14
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1710341851; x=1741877851;
  h=from:to:cc:subject:date:message-id:references:
   in-reply-to:content-id:content-transfer-encoding:
   mime-version;
  bh=cvXITNzngUSPQIoAnMgD7QVEAN1H8hhv9LyTmR0ySlU=;
  b=ZPSXTLiuZ/o/sS5/KMBSjXBtxjNTbaQSb3ibSYa7rrvU5bfb6fJu0wFQ
   4ZzskfwhVYFJF+Fk5+hPAhynZ1vL+aXISRJbQbUc5XTgH6Ol0TD3Ay71f
   rW36SX/nfV4nBEtNw0+mhvxlgCMmIVrEG1LmntTK6kwdHlEclMeiDZqrs
   w0CmC/oxsjucA0Xcoanj4dm6purw/zq/hNtfO+CYol0+2g/12Kurb570J
   aMwedoIfhFQzIAwUoQ4Gtjp+fFQpaj/1enJKMwke33VqvFdERg8S5wj7N
   8riaoMoWJtEmgEQRQZMtKvAbmExgZ2ghL54ZgZM6/UpwId8bqr3CGrdMX
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="5292141"
X-IronPort-AV: E=Sophos;i="6.07,122,1708416000"; 
   d="scan'208";a="5292141"

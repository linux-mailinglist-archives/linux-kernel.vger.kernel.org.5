Return-Path: <linux-kernel+bounces-146679-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C18B8A693A
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 12:58:47 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 8DA681F21EF9
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 10:58:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EC20D12837E;
	Tue, 16 Apr 2024 10:58:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b="EMRbsynZ"
Received: from MRZP264CU002.outbound.protection.outlook.com (mail-francesouthazon11020002.outbound.protection.outlook.com [52.101.165.2])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 56D7B127E28
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 10:58:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=52.101.165.2
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713265119; cv=fail; b=OZqH5rswlxrcX57fOrzVnUpyBBpsfp4axKmhBU188N47jgJxTyaOmPG4sNB07LEuueQb1wDZS3GU8NnP3IJJume8DKhdH5ma9IFa4yqj6qFqTMTBwx13FPwZD4EAQssnVkJeHdu6JnZ0ejegWbLhp+PB5fcnwyMiTuzyCKLMKqM=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713265119; c=relaxed/simple;
	bh=dIIK2hm6/at8UQTIqPt8dykHLwZVB4iYlfbJ3y7o+Vs=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=medngRtwUTEfxomRJhpBiOVDwib7KM7bWFR0QYUw7Ak54hvMWKne5+DfRg7Sc0wZE1k/A6UR0sYG390sdsOQhqm/84bhPzYTgyiuBT5PMbzVdBLji7HpseRe0Rbqt8DVvCC/dprslI5XQ9ac9PxgDhnAZ0jjKVeaTtne7whl1ik=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=csgroup.eu; spf=pass smtp.mailfrom=csgroup.eu; dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b=EMRbsynZ; arc=fail smtp.client-ip=52.101.165.2
...
Thread-Topic: [RFC PATCH 0/8] Reimplement huge pages without hugepd on powerpc
 8xx
Thread-Index:
 AQHafsSU45Ki1FdCPEivNpHUmuU++LFIqD8AgBqxMACAAW6xAIAABmgAgAUFpQCAAQhTgA==
...
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?SjdvU1dlL0lTbEsrbEFLVHpXSXA4VnNSSXk4NFhsWHgxTWRQT3VrL0tCaXFh?=

Return-Path: <linux-kernel+bounces-122353-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id DE15488F58E
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 03:52:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 44D21B243ED
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 02:52:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C81B02C84C;
...
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2F26E2C6A8
	for <linux-kernel@vger.kernel.org>; Thu, 28 Mar 2024 02:51:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711594298; cv=none; b=Q9AtJbMqrvciSNsZnBlQ7cfOjjiUsPbK1aRY1KANhUgTFGHivJfqJDNTHDdF36P40XFf5SQyO1KqLP/XY6hZzEH5p3RPAMMtPjnaPGOiplTxG29wtNCqU8QwpCJiMQMg+lEAtyj0S1emCjQxV1hm35ecxxSmZ7xQprx7BLj08f8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711594298; c=relaxed/simple;
	bh=eA5JpppvJ6kceU+mSDaXLnkO1NxsMOe5o4POmWSCqQw=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=g1UdeckX6E1yxKfrznHezLprkwhIdRtm1NNwdsKOFuBYQD5lRUgkmeJsqQWCQBb8gYBbf9OUKV/qvk58fJbXN3I1xKXKjTRYd/ladgNVLpPPSHZ0z/VZHBRoC1UjX1KNor7qYb85dNFn7EvOQVwYKS0GMPdpE+Frah2UHBkSoy0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--ackerleytng.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=ZNILcH7o; arc=none smtp.client-ip=209.85.219.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--ackerleytng.bounces.google.com
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-dcc0bcf9256so619087276.3
        for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 19:51:37 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=GPqMDjWy6wn0n2FZzL74JwLmXN+yXA5I0HEhcS2w7RY=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVkgSUxjlrMYJrmI+YcvIVNIreMahEs9baSxqRI+jpgQ61I0omW7AvVlNIWpJQ7oVLiGU/u0fe9NqKv5QTAK1st7PMVBBi1Hg+2IwQP
X-Gm-Message-State: AOJu0Yw3QnoFCd5J9HLA+54a9wCwsARjlSYySwpHDdnHROoMHqSZGsO+
	tbhU2mh58L2v19od9XtHDMRfkQnhdJeKSCDcVHXqsdGp2Vfoc9UOSTb1k5QQEB6gc138E3x4QRr
	DJkGuU+arxZVrAc/TrpLh6A==

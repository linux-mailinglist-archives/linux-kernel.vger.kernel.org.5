Return-Path: <linux-kernel+bounces-168176-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 8D2AB8BB4BB
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 22:22:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 41E1F2818EF
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 20:22:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 65683158D9B;
	Fri,  3 May 2024 20:22:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="IDzgmuKC"
Received: from mail-ot1-f54.google.com (mail-ot1-f54.google.com [209.85.210.54])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ED6DE158A25
	for <linux-kernel@vger.kernel.org>; Fri,  3 May 2024 20:22:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.54
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714767736; cv=none; b=Axu/E9HYcsEDlRQBxWndR3J4GWJCU/M8emLrJiMNeJMnorBR3mbM5EIRs7OPPH97vkbcwdwzLIwI2YrJmr7oMYq4A9TnzDid+AIdyqXvZnJPBbz4Z5UdS0WhstO/4pZV21zRdwqFliJliQi/llzAgX5+5F6NUiNtb0mm5ZOeSxU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714767736; c=relaxed/simple;
	bh=IM4s7t35cWWJ9dCCcyRBlI31sykmymLJEsKzS38qhPY=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Xs+kJ4B8qSVolxTrQ358pOJClkVtawQutod7X6cLqCdobtwYVasZssWEFNiD5cIZalv22xC/7QHFzqzSxPLHaWbTSzxxvFkJUZC5RIQ8wJVGH6LtoM2fYQRCD/klmToP61Oij0UpV9U/XRaiDNP/GFPw/SQdlsY3pGfOa6O52Jk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com; spf=fail smtp.mailfrom=broadcom.com; dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b=IDzgmuKC; arc=none smtp.client-ip=209.85.210.54
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-ot1-f54.google.com with SMTP id 46e09a7af769-6ee35146ac5so26923a34.0
        for <linux-kernel@vger.kernel.org>; Fri, 03 May 2024 13:22:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1714767734; x=1715372534; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=EidKx5x7Zd5NFlXUrkE+qML52zYcrMmAo5DxyefKDwU=;
        b=IDzgmuKC7PmrZX3BvCuOU2MdXIvhXCW/rqBGkru4vtHFQTsTBAuGqI0bBW10d8ZGI2
         d0vb7/PzBWB/2yhDM1TYEnh6aTfqdCtG9hIPKQkJJDpXNcAl5V9XsVkafEo1NrXKIS+t
         uT2P1N9OkNklPsB0HDt1pOcJfHepfiZUvKXcI=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=EidKx5x7Zd5NFlXUrkE+qML52zYcrMmAo5DxyefKDwU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXlqTTVY2JVDomwNNDB13T4aHMhLeE5MaUTz6Ixq2wMZNDGkHFKgVgfDpavcVegl9wssft+IRpMjpwHQodYFtYNebNA8wgRJGnm8ozs
X-Gm-Message-State: AOJu0Yxxb2oqvkGCzPB06aJ7y3HHoSF0U9io0T9D0qUws0HVzJBj/aCW
	EPs5V3qLpgexxjZOEcVji1qDu4DYnB+WP9mLkJXE9a41ne/aJ9DLFZ5XLVojXg==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000ae6eb60617927917"

--000000000000ae6eb60617927917

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C2D347910CB
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Sep 2023 07:14:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240240AbjIDFOf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 4 Sep 2023 01:14:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46552 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1352236AbjIDFOe (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 4 Sep 2023 01:14:34 -0400
Received: from mail-qt1-x82e.google.com (mail-qt1-x82e.google.com [IPv6:2607:f8b0:4864:20::82e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4E85A109
        for <linux-kernel@vger.kernel.org>; Sun,  3 Sep 2023 22:13:59 -0700 (PDT)
Received: by mail-qt1-x82e.google.com with SMTP id d75a77b69052e-40a47e8e38dso262931cf.1
        for <linux-kernel@vger.kernel.org>; Sun, 03 Sep 2023 22:13:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20221208; t=1693804438; x=1694409238; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=TkiaROEHx/Dg8ybcCsiHX7jBGveMC+YQvWhFsUF23Qk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1693804438; x=1694409238;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=TkiaROEHx/Dg8ybcCsiHX7jBGveMC+YQvWhFsUF23Qk=;
        b=
X-Gm-Message-State: AOJu0YxmMvwFHT/FTi+YuSINpWEe2qTUxX9LUKiXeMB9/L9X7Z+BvBBJ
        TnTIMaQ7qyfdq3l4W/uTjOpnhR0ShSn0+G0eBv3R2Be6fy+wgYP2RTDkf471
X-Google-Smtp-Source: AGHT+IGa6U7yxN9mslIUtnQ8FxO5PlDjLVuzal5K4GkU4Di84QM9+uwi68cmfJEIb8STNFvA2KkureWXEwRm8CenPhI=
X-Received: by 2002:a05:622a:1d0:b0:410:8ba3:21c7 with SMTP id
 t16-20020a05622a01d000b004108ba321c7mr286364qtw.18.1693804438232; Sun, 03 Sep
 2023 22:13:58 -0700 (PDT)
MIME-Version: 1.0
...
>
> In addition to parsing the perf.data file, the provides BPF-based CPU usa=
ge
...
>
>   # ./perf kwork -k sched,irq,softirq record -- ./perf bench sched messag=
ing -g 1 -l 10000

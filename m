Return-Path: <linux-kernel+bounces-94947-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id C9589874707
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 05:02:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4335F1F238CE
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 04:02:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 373C4134BD;
	Thu,  7 Mar 2024 04:02:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="ZikMWSJj"
Received: from NAM10-MW2-obe.outbound.protection.outlook.com (mail-mw2nam10on2080.outbound.protection.outlook.com [40.107.94.80])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C0EA717EF
	for <linux-kernel@vger.kernel.org>; Thu,  7 Mar 2024 04:02:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.94.80
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709784143; cv=fail; b=IvWXkddyvqKq+NFNR5P84wBDtx4nmoZQUzWcxhZIxA7Jt1mOsqM1QlkENB2h/bq4tpZZctK81G26OzFFPh3jOlX7mEffXgKbzQ5Jdg12loYSepFz4qBSjjLqUMwXVgRtVHZKT3/cE1vCQTA8n1R6rIReN2qbo5ZbJi9+R+gq/FI=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709784143; c=relaxed/simple;
	bh=umrbROqOO/cc2Oxe1aiH+w/4Y4rdlYDzhnlsbV/Uq8w=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=FXui4hkzxa2q2N9SBbpkYpz46Zk4WACVNJx/B7R53Y5hgYpTj4QaBZOohhOGnjRDXy9w4aunCvjd01v226O2GtipdZtKUtjji9nCXljfUSAwVOmTteN1TtbJB4vEuZZmjQ1McuRn1xlUuGA3n4n9I77PRBH0p6l7NOxkMhQSUIY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=ZikMWSJj; arc=fail smtp.client-ip=40.107.94.80
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?MWFmZER5Wldyblk5TlZLcERoaC9nU1RjemFNL3JMa0VQOFF3QStuVzZ1eW9y?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 07 Mar 2024 04:02:16.2987
 (UTC)

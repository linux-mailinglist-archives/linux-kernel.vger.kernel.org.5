Return-Path: <linux-kernel+bounces-96693-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id E48A487600F
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Mar 2024 09:48:10 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 5AC72B24B46
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Mar 2024 08:48:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3EDCE37171;
	Fri,  8 Mar 2024 08:47:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="VMTrgmgy"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0C2C34DA15
	for <linux-kernel@vger.kernel.org>; Fri,  8 Mar 2024 08:47:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709887671; cv=none; b=iWL5FT0zD9O1EjEkNp76XHYyvEfpRlaNIjVXpBCB4BtkPdjYkVvQa9eY01cNW1G8K4SCevccWC4P1eMxb119hODu+eeYk//NID+7vrnOfklOGirGuXehCxpR4k5KTt8rQBf/J9BhfcqlVoASdM90DaSxuY0cNJLERbSGwW/PwNA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709887671; c=relaxed/simple;
	bh=PTZNCNhRJDslkq3RnkGDtpjjrUDk9ero7gQgpBOYRwg=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=CR0G02B2NkohGwPiJx0VhpEV61IclVywdqMzyTE5wB40mWMT4GlxySnjbdGqVHzi6BukydynGHsRlmyTJw6XK+/rlUTDZhEBSsLF18mADCxkXZ89cytr/j82GIdJ0GckWRRwUlldhZLy/pZ6lgoYsCgfx3YvzB7avItmTjjNtCw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=VMTrgmgy; arc=none smtp.client-ip=198.175.65.11
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=VMTrgmgyVmDsK/FWZP/kzqqzf5MSWIVeJa3Nm5W+sjJ0U5fErzYUGAup
   ...
   P3TxZQK7WCStVG+pTRjYqbEnW8dch6+LGB242TEz/CTkuknamlOKwg5VB
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,11006"; a="15166257"
X-IronPort-AV: E=Sophos;i="6.07,109,1708416000"; 
   d="scan'208";a="15166257"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
  by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Mar 2024 00:47:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,109,1708416000"; 
   d="scan'208";a="14887475"

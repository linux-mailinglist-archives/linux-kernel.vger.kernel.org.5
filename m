Return-Path: <linux-kernel+bounces-90078-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id ACEF286F9F1
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 07:17:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 632CF281565
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 06:17:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 821CFD51D;
	Mon,  4 Mar 2024 06:17:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="S26BBUwG"
Received: from mail-pf1-f176.google.com (mail-pf1-f176.google.com [209.85.210.176])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E8BDCBA5E
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 06:17:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709533064; cv=none; b=p2Tcfa/ZTgyPhhCq0e4HhgTdIMjIfqfm05Bdwyn2RteKcGSrdnvI/eLH6pGk6ZqYbUXBoY6qpnIC1XL9sIlKHf8amO2hNz2DiPJ2/O/CZR64jKlZMigvDsLkB1uaZ+aSUXComnEO6/P0c2b4gDgeFN2sB5P2Qji/vIA3A/ZOfJo=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=S26BBUwG; arc=none smtp.client-ip=209.85.210.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pf1-f176.google.com with SMTP id d2e1a72fcca58-6e56da425b5so2865503b3a.0
        for <linux-kernel@vger.kernel.org>; Sun, 03 Mar 2024 22:17:41 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8zwoQ7Hu6cKX/3vgoNUWWeHdXC/JkbTAc8F7XvfFH9k=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVuxN8lxuY0MSToG2YFdp4pcE0qQWOUgcIy6mivDGY1ZitMDHrHfDDcBuswXp2D4mYX3gqnwURSQLpJUMI27FRrCqtsPRvzGU8+NbcQ
X-Gm-Message-State: AOJu0YwFig3VpZ5CE9VGCCCCQUZ0dF0UDQaJVP5jCfZHlMfFmkGbd7cq
	4OnXe91ZWTVkoxgMgAcFfqsoPkgIvfPkenQKoyP5jeLDzkYbSH2tmfotVg3uGg==

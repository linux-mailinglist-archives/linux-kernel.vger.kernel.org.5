...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B1DDE770A84
	for <lists+linux-kernel@lfdr.de>; Fri,  4 Aug 2023 23:08:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230497AbjHDVIn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 4 Aug 2023 17:08:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35388 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230349AbjHDVIP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 4 Aug 2023 17:08:15 -0400
Received: from mail-pf1-x432.google.com (mail-pf1-x432.google.com [IPv6:2607:f8b0:4864:20::432])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0DB4D4C3B
        for <linux-kernel@vger.kernel.org>; Fri,  4 Aug 2023 14:07:25 -0700 (PDT)
Received: by mail-pf1-x432.google.com with SMTP id d2e1a72fcca58-686ba97e4feso2333108b3a.0
        for <linux-kernel@vger.kernel.org>; Fri, 04 Aug 2023 14:07:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google; t=1691183243; x=1691788043;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=VNDAtrU25aj6ZP4bQWj0APLJi4B34GsziEpWhng/8JI=;
        b=OIeIwYaKjUbKT7o1VfqN2rM1ojzUgZhYMNyt9GXc4au4BxZNaKrvf44cxwhOEOJk99
         nUT67+6BP32EIAmgd7GMcbkz8LKuxhP0jJkTSsx+E1aBgQbHs1RHaAYkjX6bqWNTJe5O
         wxNBUpp4NIteLU6F6Iqk/orzGfTiIcdFm5DPo=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1691183243; x=1691788043;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=VNDAtrU25aj6ZP4bQWj0APLJi4B34GsziEpWhng/8JI=;
        b=
X-Gm-Message-State: AOJu0Yx7ngbXPbsoQc7CG/7Ac+9x17OlF8hYqA3rN4ysiJrNJ+ij9OLX
        Abj+pfSrA/FZBFHqHgAu8NqUPc8s8IdlfwcOuweWwTxf
X-Google-Smtp-Source: AGHT+IFkbNOFoh/VI4k1FOKVvL/4zX2h+f9c0koj1hj0xdsNC4QSnnSpGjC+Wrgn2SfibLOdC4Cvgw==
X-Received: by 2002:aa7:8884:0:b0:687:9909:3c75 with SMTP id z4-20020aa78884000000b0068799093c75mr3885000pfe.4.1691183243227;
        Fri, 04 Aug 2023 14:07:23 -0700 (PDT)
Received: from tictac2.mtv.corp.google.com ([2620:15c:9d:2:e186:e5d2:e60:bad3])
        by smtp.gmail.com with ESMTPSA id n22-20020aa78a56000000b0068664ace38asm2037584pfa.19.2023.08.04.14.07.21
...
Cc:     Linus Walleij <linus.walleij@linaro.org>,
        ...
        Ondrej Jirman <megi@xff.cz>, Sam Ravnborg <sam@ravnborg.org>,
        Stefan Mavrodiev <stefan@olimex.com>,
        Sumit Semwal <sumit.semwal@linaro.org>,
        linux-kernel@vger.kernel.org
Subject: [RFC PATCH 05/10] drm/panel: Don't store+check prepared/enabled for panels needing shutdown

Return-Path: <linux-kernel+bounces-33033-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 8620D8363BF
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 13:54:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 522E3B2BF9F
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 12:41:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5DB053D54A;
	Mon, 22 Jan 2024 12:39:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Ei/V1F65"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E399C3D567
	for <linux-kernel@vger.kernel.org>; Mon, 22 Jan 2024 12:39:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705927149; cv=none; b=TQYCUTQI4g4swsB8eU5SXg4NE8bTo5/gcFPTmN6g+ZeznIHSXUICjNDzegHEt1qciZXwudE0uFMKF9m2e8ehEZSuHnY3EMnR0qgnucLZN4OD7fP8krNLl0z/5Xf8BVtblrqcdXbilUEo/ZjS8ZjaxpNKwewArjgfe03YXqWbvM8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705927149; c=relaxed/simple;
	bh=+xGlq8qo/+56ZzcegYaekvbisegxnMruSd7lD52DUF4=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=c4jnN1+RW0m7AuMzZ4S74JsTzQWPUVdQRVWwWZhQpLzApyiQdnuAAxwFqx6cljf95kY6W6ckeL4ZgOaCFVOzD3BRh2+6QBvRBadl/7HPVIPJttT9JCxW/32Ef+6WDh8PBK0H3Cg4tbkmjEN7i+UDsFKwe/ml9C41bEGfvmSwO6s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Ei/V1F65; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=Ei/V1F65MSh95Lgvrt+lzMkBulUpkJ0qkUdlBfQQga3CZKmEW6yq5w7urRCWCL1CIBkHPS
	Ruc702nPvGy/sGzCKYhqLe84Rvv5TsSudc2I6bj7W1ODIH4mp79gWTqFw/yuKMjz0yEhQP
	UrCPhaENazOVH+i5iTmuznAwijAGbTc=

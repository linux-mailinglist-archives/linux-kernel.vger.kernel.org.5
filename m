...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2491D7DBC9F
	for <lists+linux-kernel@lfdr.de>; Mon, 30 Oct 2023 16:32:26 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233666AbjJ3PcZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 30 Oct 2023 11:32:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46408 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231395AbjJ3PcW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 30 Oct 2023 11:32:22 -0400
Received: from mail-wr1-x44a.google.com (mail-wr1-x44a.google.com [IPv6:2a00:1450:4864:20::44a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 932FDB3
        for <linux-kernel@vger.kernel.org>; Mon, 30 Oct 2023 08:32:19 -0700 (PDT)
Received: by mail-wr1-x44a.google.com with SMTP id ffacd0b85a97d-32f7cfab43eso908660f8f.1
        for <linux-kernel@vger.kernel.org>; Mon, 30 Oct 2023 08:32:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698679938; x=1699284738; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=00X+K7tQIGqj3wkduJfRhjiel20GeeDllIRy1nuGhjg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698679938; x=1699284738;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=00X+K7tQIGqj3wkduJfRhjiel20GeeDllIRy1nuGhjg=;
        b=
X-Gm-Message-State: AOJu0YwdtrsME+0RJmXVyu0fyIw+OIlRwm9ni9soSnfBoie1ruTsycX7
        ejcj+BWwLdy6Rr9mmqQyWZfWukEokjA=
X-Google-Smtp-Source: AGHT+IGjoe7dCjaDEHgKsr9JK0pXSaJI8CjwQUeQ/C0wV7m1w/4KFnJJ9AyUOo86EVEVB/0KyKLauZxi6XU=
X-Received: from glider.muc.corp.google.com ([2a00:79e0:9c:201:132e:31bc:8300:d4e1])
 (user=glider job=sendgmr) by 2002:adf:f94a:0:b0:32d:a117:fda6 with SMTP id
 q10-20020adff94a000000b0032da117fda6mr82163wrr.4.1698679937742; Mon, 30 Oct
 2023 08:32:17 -0700 (PDT)
Date:   Mon, 30 Oct 2023 16:32:10 +0100
In-Reply-To: <20231030153210.139512-1-glider@google.com>
Mime-Version: 1.0
References: <20231030153210.139512-1-glider@google.com>
X-Mailer: git-send-email 2.42.0.820.g83a721a137-goog
Message-ID: <20231030153210.139512-2-glider@google.com>
Subject: [PATCH v11 2/2] lib/test_bitmap: add tests for bitmap_{read,write}()

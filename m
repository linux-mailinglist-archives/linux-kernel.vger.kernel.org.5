...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D7971787F00
	for <lists+linux-kernel@lfdr.de>; Fri, 25 Aug 2023 06:27:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235789AbjHYEZz (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 25 Aug 2023 00:25:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44060 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236111AbjHYEZM (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 25 Aug 2023 00:25:12 -0400
Received: from mail-qt1-x82c.google.com (mail-qt1-x82c.google.com [IPv6:2607:f8b0:4864:20::82c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 87E911FE9
        for <linux-kernel@vger.kernel.org>; Thu, 24 Aug 2023 21:25:06 -0700 (PDT)
Received: by mail-qt1-x82c.google.com with SMTP id d75a77b69052e-407db3e9669so93471cf.1
        for <linux-kernel@vger.kernel.org>; Thu, 24 Aug 2023 21:25:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20221208; t=1692937505; x=1693542305; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=NgTfRvUpN/Pg+hfCrj1tva4fW4lISxqY8aAnAYusIt4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1692937505; x=1693542305;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=NgTfRvUpN/Pg+hfCrj1tva4fW4lISxqY8aAnAYusIt4=;
        b=
X-Gm-Message-State: AOJu0YyVt7PbaXhhYxSH80t4doudZn/5JpaLGbvYoW8/jOHJa6ewsUGj
        Jk5XZCnFvaXmz4X7KB88HVvj5EjBI9fo1b7q1pMb2A==
X-Google-Smtp-Source: AGHT+IELCPMPoDGQVRfJShO34W4Ch2c2poOdChr3Fta9nX81SXzm5mP3DZzyL423JPubHqY78/m+Yiqz524mhm89k1w=
X-Received: by 2002:a05:622a:1004:b0:403:aa88:cf7e with SMTP id
 d4-20020a05622a100400b00403aa88cf7emr86744qte.29.1692937503528; Thu, 24 Aug
 2023 21:25:03 -0700 (PDT)
MIME-Version: 1.0
References: <1692606977-92009-1-git-send-email-renyu.zj@linux.alibaba.com> <1692606977-92009-4-git-send-email-renyu.zj@linux.alibaba.com>
In-Reply-To: <1692606977-92009-4-git-send-email-renyu.zj@linux.alibaba.com>
From:   Ian Rogers <irogers@google.com>
Date:   Thu, 24 Aug 2023 21:24:50 -0700
Message-ID: <CAP-5=fWJ=-V5vrTVXKHw7nbM0vkpKXLjFurVa5GEL9shDCmCtg@mail.gmail.com>
Subject: Re: [PATCH v7 3/8] perf vendor events: Supplement the omitted EventCode
...
However, I don't think this change makes sense as the event=3D0 is
overwritten in the case of an arch_std event:
https://git.kernel.org/pub/scm/linux/kernel/git/perf/perf-tools-next.git/tr=
ee/tools/perf/pmu-events/jevents.py?h=3Dperf-tools-next#n369
So yes event=3D0 was filled in, but it was then overwritten.

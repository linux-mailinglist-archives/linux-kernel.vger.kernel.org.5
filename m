Return-Path: <linux-kernel+bounces-137559-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 92E7389E3E0
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 21:47:11 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id EE9B81F2201C
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 19:47:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D325D157A52;
	Tue,  9 Apr 2024 19:47:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b="BlXeYKYU"
Received: from fanzine2.igalia.com (fanzine2.igalia.com [213.97.179.56])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 474601E89E
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 19:46:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.97.179.56
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712692023; cv=none; b=mx/eRy4rps3BIyiady9gURrafpKdeH5sTLeAKvbqhmj/m+1yZHl0Z+kjdWAuBhETv8Bi1vAu9XVmOd4jeISDxAkRGNk9WwNPcyiDnFzv4ltG7PC1e/0869orYr2yaPrnv91NVkk5duAMKxOiCLMKzJar5R541Wf/qareG6UfdYo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712692023; c=relaxed/simple;
	bh=wNeLqxmjL3DHohKZVyrijwhQ38s6hgyE5xPE/V4ka6M=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=rh0GWp1Gj/6VXc6sn4nwk/d6CnZMYiV7WhhzEtID9fAaZw6kRoXpOf/QtFwe0vxHi0GqVlqRfjHaZZ1uwaUhjIlE0b2M8mj7bgtI0diQl/ibBV37PMwwJljXMdLbtK4LATCEnCy6MEc7+JrlP+KsZmhwF0fFjaAPTH76A/V0zuU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=igalia.com; spf=pass smtp.mailfrom=igalia.com; dkim=pass (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b=BlXeYKYU; arc=none smtp.client-ip=213.97.179.56

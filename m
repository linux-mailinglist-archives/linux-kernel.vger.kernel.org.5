...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E40007EB5C9
	for <lists+linux-kernel@lfdr.de>; Tue, 14 Nov 2023 18:47:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233877AbjKNRrJ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 14 Nov 2023 12:47:09 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47690 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233869AbjKNRrF (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 14 Nov 2023 12:47:05 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2CC09103
        for <linux-kernel@vger.kernel.org>; Tue, 14 Nov 2023 09:47:02 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1699984022; x=1731520022;
  h=date:from:to:cc:subject:message-id:references:
   content-transfer-encoding:in-reply-to:mime-version;
  bh=EZzcb9qBUHmq7zBLy9ldqVPJY0U1GOn+VQcM4B2o5as=;
  b=HBf7X2HccwpW64zq4GcWJNZvyD2iRjradg2c+D7zCh1haCS4iLnKI9nU
   z4B11MckArejI4RKSvOSbgtqR5SkDspKT9goTUFPlYDGfr/4YMT9yE8bo
   6VZRKdc5ylWN36YQGb9INXG3wP1jb6GEtcMQWqVFfG1g/ch6Q/4l/Ib6V
   H1WbjeAMT5fvmCkC5QGCHkrxkKCTw5+/dlVm9LPL8W1ObSQfapI+c6+WR
   jLdtUrBuBoxd8oHu/5OUUdxpbEYoOefAaq+wQdmoZl3EmiLYCHGqEs5lb
   8HJhitgOFWbVlBdtGA8DuAjpl/j7Z3imHCY80r/uN41/67kZJljm4deaY
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10894"; a="390506820"
X-IronPort-AV: E=Sophos;i="6.03,302,1694761200"; 
   d="scan'208";a="390506820"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Nov 2023 09:46:51 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10894"; a="758240189"
X-IronPort-AV: E=Sophos;i="6.03,302,1694761200"; 
   d="scan'208";a="758240189"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
  by orsmga007.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 14 Nov 2023 09:46:51 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 14 Nov 2023 17:46:48.7429
 (UTC)

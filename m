Return-Path: <linux-kernel+bounces-116610-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E0EDF88A10F
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 14:10:46 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 5A1871F399CC
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 13:10:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ECEC817109D;
	Mon, 25 Mar 2024 09:10:37 +0000 (UTC)
Received: from smtpbgau2.qq.com (smtpbgau2.qq.com [54.206.34.216])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DDF1B13C664
	for <linux-kernel@vger.kernel.org>; Mon, 25 Mar 2024 07:06:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=54.206.34.216
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711350370; cv=none; b=NA0FkDTUrmiy3YymB0WsMmkUoq87H0ltH/SZaTreJSXItlslBSrSJMrNnaZoAz3pJSbDIPmZSwiLNObEa/I8reKbDMXDnUu21NnwoOzPXdk8Yj61Rh6XS9cA+2IZdm6yu5jSXCMU7OnTbCWhXkJKbffvzZwZSHTKXEyXlmWNW9w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711350370; c=relaxed/simple;
	bh=gXVfbZtg7t4XflAWzOG/m5lQCPnC7rOMx/DxV/xkLHI=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=Ub6NKhBPmjju+ISLbOCnedui1Brqfk0ReMT3As51SndDyrVEx/yCs+wdsgGq40uQNHs8CWSW8mb2aR16X7RIl4BMXapCGz0OsUBzE1XtKaUBIfKzC/lv/kg7it50et+IWMJe0sD8WPzj22Uow+7cS7XQtuyO3pP3VDz9WtH02h4=
...
X-QQ-mid: bizesmtp80t1711350293t4a037zq
X-QQ-Originating-IP: 0YzAY+v6yvQAHAU0cUp6JYJg117sfGfo7S5fZSNQ4hw=
Received: from localhost ( [112.0.147.175])
	by bizesmtp.qq.com (ESMTP) with 
	id ; Mon, 25 Mar 2024 15:04:51 +0800 (CST)
X-QQ-SSF: 00400000000000704000000A0000000
X-QQ-FEAT: 
X-QQ-GoodBg: 2
X-BIZMAIL-ID: 16342201689199884755
Date: Mon, 25 Mar 2024 15:04:51 +0800
...
Message-ID: <75DB4873B9725539+ZgEiEw0WiqAxIAHk@centos8>
...
I didn't know that it has been landed in linux-next, really sorry about
this mess.

Andrew,

Can you please drop this patch from non-mm tree? Or the explicit revert
patch needs to be submitted?

Return-Path: <linux-kernel+bounces-111451-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 732CA886C8F
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 14:05:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2E9972859E2
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 13:05:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9E49646BA0;
	Fri, 22 Mar 2024 13:04:36 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 76F964502D;
	Fri, 22 Mar 2024 13:04:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.140.110.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711112676; cv=none; b=VVVgCdhDDbhEOXzUC3w7eb0oH/BgtJ6S6gwCFkDQSR/roJnMWtBj3XxbCuPncgG0vkGFPTU2PtuUoZGdxLoRplVMhOUEY+OqhLQ8VCRW5y+WwJ1OUDfmcgtG53AYumArDpp5hoGsEtnXpafLjT4A4i9iT/5foBtuz1nCMv21mpE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711112676; c=relaxed/simple;
	bh=XQSKmN1TVfytkq7r8tlE3KspdUqFU8nJv4BPKNrYrio=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=q3VHh6fCo0xe/XzwM8jVIJ49QnWcW2DQucMYJ4EToW5iDH/aqiBn5sO86rumQthdJ5rwxdBEY3l0uT3J47AdIYWOSX2Eq6t3QBma502QQZvwf55vJ4EeBb19dJlKGMzlTJMLTSS/DX3spoxGxp05bhzQ9awTelMphN4chQYi6GI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com; spf=pass smtp.mailfrom=arm.com; arc=none smtp.client-ip=217.140.110.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 0185E1063;
	Fri, 22 Mar 2024 06:05:08 -0700 (PDT)
Received: from e126817.cambridge.arm.com (e126817.cambridge.arm.com [10.2.3.5])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id 245263F762;
	Fri, 22 Mar 2024 06:04:32 -0700 (PDT)
...
Subject: [PATCH v3 2/4] tools/perf: Track where perf_sample_ids need per-thread periods
Date: Fri, 22 Mar 2024 13:04:12 +0000
Message-ID: <20240322130414.70186-3-ben.gainey@arm.com>

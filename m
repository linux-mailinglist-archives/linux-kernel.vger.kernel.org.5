...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 61F0C7DF975
	for <lists+linux-kernel@lfdr.de>; Thu,  2 Nov 2023 19:03:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376349AbjKBSDX (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 2 Nov 2023 14:03:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56112 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235337AbjKBSDN (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 2 Nov 2023 14:03:13 -0400
Received: from mail-yw1-x1149.google.com (mail-yw1-x1149.google.com [IPv6:2607:f8b0:4864:20::1149])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A958719B9
        for <linux-kernel@vger.kernel.org>; Thu,  2 Nov 2023 10:59:17 -0700 (PDT)
Received: by mail-yw1-x1149.google.com with SMTP id 00721157ae682-5b064442464so17738157b3.3
        for <linux-kernel@vger.kernel.org>; Thu, 02 Nov 2023 10:59:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698947957; x=1699552757; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=U9w4V/td7TVuGDaXfz2/TNcOZMETdM8ldpCuL8GOHhM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698947957; x=1699552757;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=U9w4V/td7TVuGDaXfz2/TNcOZMETdM8ldpCuL8GOHhM=;
        b=
X-Gm-Message-State: AOJu0Yw1TfItoVmGPTQBqx11xTC/1AnAkpy+ut8hYPr1xpdCben7oQLu
        GqqTl0WiivAv7HGgXSa3KrFIWlRGuIBK
X-Google-Smtp-Source: AGHT+IFHEwYanpvQOzxLDtm5IxZPyvGEQwkE6izZzDQNkeMR66jOK2nGvmZEt4mjFnMBfbdNtDpVVC6bjFVy
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:bb34:df9c:836c:afca])
 ...
 130-20020a250488000000b00da0545229f7mr377530ybe.4.1698947956772; Thu, 02 Nov
 2023 10:59:16 -0700 (PDT)
Date:   Thu,  2 Nov 2023 10:57:17 -0700
In-Reply-To: <20231102175735.2272696-1-irogers@google.com>
Message-Id: <20231102175735.2272696-36-irogers@google.com>
Mime-Version: 1.0
References: <20231102175735.2272696-1-irogers@google.com>
X-Mailer: git-send-email 2.42.0.869.gea05f2083d-goog
Subject: [PATCH v4 35/53] perf report: Sort child tasks by tid

Return-Path: <linux-kernel+bounces-68869-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D37A858123
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 16:34:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 564B1B23409
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 15:33:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5523C133420;
	Fri, 16 Feb 2024 15:25:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b="HxCqj7vS"
Received: from FRA01-PR2-obe.outbound.protection.outlook.com (mail-pr2fra01on2097.outbound.protection.outlook.com [40.107.12.97])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 40C7812FB3E
	for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 15:25:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.12.97
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708097128; cv=fail; b=BEoYU5i+uVxoZrQD6TeEdIqWfqLPszxYzg8cW9AukDaAM0UTXIq1QezX35YnO0s0P8ZPFY5FmWk07LPVWrfcfQJ0JKwr4R6KQ70R27fakMdLnn2l4GyU5Hr5uKW1jov7Ugj4yDbp24fD2NrYtW44R3kkaGotslcTJp+KFfVKkGA=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708097128; c=relaxed/simple;
	bh=Gux1Xu6tmzPAPNlr/UDLjOhuC4ag+3HGClxOmeDCfjM=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=HL3JyidM0aYsRgc37fx8ZagDILd/DvxRt6Ou9o23ZR7CnLZyLHxZ67wG0fx6qXhQdLRraz9xZbyPR4NM//Oyvxxb+tjBth/TDPhmG3gOkNULODYnxJtoUfRzzdRPoFEbUJ4NeqNc/VKFW+HGacZ6/g+yRj+me++QXheLbSt3W8w=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=csgroup.eu; spf=pass smtp.mailfrom=csgroup.eu; dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b=HxCqj7vS; arc=fail smtp.client-ip=40.107.12.97
...
References:
 <38a8d765ed9149bc6b5484a7142e3bc59ffa3b1a.1671475543.git.christophe.leroy@csgroup.eu>
...
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?STVrS01RUVVCQTR1a09UODhxcENMUUdGRmo5em9KZkhDdXdjSWpjL3U5NEt5?=

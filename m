Return-Path: <linux-kernel+bounces-90827-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 3938B870582
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 16:31:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5D8C21C20A8F
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 15:31:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BE36B5026E;
	Mon,  4 Mar 2024 15:29:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="SGnKRm17"
Received: from relay5-d.mail.gandi.net (relay5-d.mail.gandi.net [217.70.183.197])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C9054778C
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 15:29:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.197
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709566170; cv=none; b=ay2Bhu4kTix0xSTDFFjaYpWq/UvjMhKaD9MNTicclyChvDM728VgaorNmIhE69EN9L3hjAputVy2FVbT0z0b5zlVjS+djWjB4uTp7y1r9gaO5W3fTBOBJcrk53VQa38/bOXcf0kUTbvUl0AHmdz2yOQkXVskkA40mxqSaP9/zoY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709566170; c=relaxed/simple;
	bh=JIoXrYSBgeg0QLNIPh8bxgpI6Eagu1fkt6Zjo95AAXg=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=X+wJM7YFmKMDz8x3b92VMl6ZWWb7otE2jpnLtzst+7nqqC7n/YIH7ormu51d9fBqKXi4R3EjKQIycNvMYqG1BSY27wAYwXRrX0NIQZJxotpvYE2NzmdwzK5oDFnq1G6CjNegvo2LoNe95ufbQ+d85SKqtQBMjklh0sMqsPs0RI0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=SGnKRm17; arc=none smtp.client-ip=217.70.183.197

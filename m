Return-Path: <linux-kernel+bounces-102306-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 9473D87B04B
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 19:50:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 4B79728E170
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 18:50:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 11333135A6E;
	Wed, 13 Mar 2024 17:45:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="SeJaOX7n"
Received: from relay2-d.mail.gandi.net (relay2-d.mail.gandi.net [217.70.183.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E856D67752
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 17:45:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710351943; cv=none; b=oqfPoNZFgIOm7imiG1axqp28XWATNIebFbK/UdMO2Meyw0iFfLw0tA+usowom9GhoOPBdjr5wTV1E6ojabrVTifVf9PjaJmZFd9cRiCQ7dACCB4ifsiDVv0vw7yv3hEii/JG050Ozgcku9aNCkTGIUNFuRRwh8kwPi0ZLkHQcJo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710351943; c=relaxed/simple;
	bh=iD71b+k0OiTeuqKlKf0a+qVcOP9Pq/u1+8xaqCzxc8o=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=hRCVJmF8+u8IunauhvF/E7LIDUKCwhiJ2il9eyXS+CRfUK4GTfKVttWSdDjwBuRBtxxYheixIJ8nUgBOGNsBONUcQft8iuZI1B/9HUkwR/DkRHAfIBa3gbatDZkOdzpnzL1o7CkWHrEJYJUM8f6/EZD4JVrsySQdr5uA1sIp/dI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=SeJaOX7n; arc=none smtp.client-ip=217.70.183.194

Return-Path: <linux-kernel+bounces-49514-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D173D846B57
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 09:56:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 01FA21C28F69
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 08:56:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0B58B60881;
	Fri,  2 Feb 2024 08:55:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=haloniitty.fi header.i=@haloniitty.fi header.b="VdRNRtAH"
Received: from whm50.louhi.net (whm50.louhi.net [77.240.19.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EC5D360873
	for <linux-kernel@vger.kernel.org>; Fri,  2 Feb 2024 08:55:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=77.240.19.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706864147; cv=none; b=EB4i2tsO64BQryPYqur3vJUGDYxOVxqrfTwx5af68aSDOO2duwDaqF/bj92JLTzOGoU6xgx+1QfH6jXEvS6P9hW3s/7n3bYAFMQPN/drGRk2kSfROj597NJOH0Co6biV4NDRfhGHOd6gEgPSoYBUR59KSjqHd7QDmqJ0U0zXKbE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706864147; c=relaxed/simple;
	bh=dcPeDX1WQER7f8fxHPfHcut+KnWshEFq4N/7hgeVnBQ=;
	h=Date:From:To:Cc:Subject:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=G9qlSsiqct0pb8j2kmESL/GWVUrjvifE+LVACyHUeaMxWeGG4eDtGb0VXakh8fAIDnPskMeI6eLfBg0hav+GuTANxWx9CvxBnaAK5YlpyEcNo454+1uiBmPambJakDjZoTwIun95s2GNBBYt+xIpxyEi4qZ9AddcT/1zSFCoQWo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=haloniitty.fi; spf=pass smtp.mailfrom=haloniitty.fi; dkim=pass (2048-bit key) header.d=haloniitty.fi header.i=@haloniitty.fi header.b=VdRNRtAH; arc=none smtp.client-ip=77.240.19.51

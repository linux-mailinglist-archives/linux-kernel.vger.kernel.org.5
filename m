Return-Path: <linux-kernel+bounces-121303-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id C989A88E529
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 15:18:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7A7F7293B7E
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 14:18:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7D482149C47;
	Wed, 27 Mar 2024 12:43:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="N+l1onCR"
Received: from mail-ej1-f41.google.com (mail-ej1-f41.google.com [209.85.218.41])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3CF12136665
	for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 12:43:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711543436; cv=none; b=bGY9uUpUfvCl4wq1a1WcNjqrRllcTsIRGj0QsAHmlVWr/C4SU3Mr6D8Pj0TmVo0WegnJCN9tpiyY/C5+jyoUng1qgQBbAhyMPdlDvzcjI8GxDgqiopvv6MFTo0ln23vrWUqRI+vlH4Ke+rRevuKoxrYe5Tw5IBr1tGDT2UXmZLw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711543436; c=relaxed/simple;
	bh=CUCGqZGlbwrgPkwPeA7fzEXfYZ5lWG+kw/qtWPfvSV4=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=ldwkvkUgmVl1r2V3+OCODaPXwW9y7cVNDPYv+GVfab3mk/Jbo9nqHvjeXpxN9W6eVxxmgLwkeBxTgL1bs+/R+6LaIg8jQJB1uW06rjNbD7eRHr1Ry+urro8R6QJVXvcAMulSpku9cLrfgKj5zzYO+sN+7g+iLqhwuqeMAHGfnoI=
...
Received: by mail-ej1-f41.google.com with SMTP id a640c23a62f3a-a46cd9e7fcaso807152366b.1
        for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 05:43:52 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=EPamPBtPxW6+pkIV3m4EaBMhb46zDx5KgvXpbm+zagg=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVaT+ORWYjmkgwWOxlOWV6r6T5yAOgM68myVCWS3kttoW3dpsakk2XUEbMLnNtioqHq72UlQSNeGktoE8LVzhGEGSFjSdk5A5cDhDnO
X-Gm-Message-State: AOJu0YwljhaNdlLhyE6+ljdr0F7OqiiuvYsLKJmESRAknacTxOmFqrmY
	3MlYM8zhUHCBRJVK2btUv+nE8S1Hvo0HfTC63Ogf6j0DNaAed7WkVspcPzCP+Jk=

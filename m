Return-Path: <linux-kernel+bounces-135952-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id ECFA389CDC4
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 23:45:19 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A27022848AF
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 21:45:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 35D7114885F;
...
Received: from mail-io1-f53.google.com (mail-io1-f53.google.com [209.85.166.53])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A4AFD1442F3
	for <linux-kernel@vger.kernel.org>; Mon,  8 Apr 2024 21:45:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.53
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712612711; cv=none; b=GwjXkR3gjE0TDbyz7OgNAHjsAsU9Ze8HAiQvkrq0wE/X/VeNjTH/4rC8J8VDWObvQY3aX839mee0rOfl7yGRBxaMOYpMnqVx8ksx6o3KcsotbQuvY24lj4mmwmMGGPtNiexU7nwq/HsnwXBVNm4GQLywgvX4AQ26kK2F3dgTgoE=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=oCKAg4T5; arc=none smtp.client-ip=209.85.166.53
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-io1-f53.google.com with SMTP id ca18e2360f4ac-7c8d2e0e9cfso131890639f.1
        for <linux-kernel@vger.kernel.org>; Mon, 08 Apr 2024 14:45:09 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=fWZpTS9XdHFgXpHr6/MbkrB3un8w3RjB6kb0cWMEi/E=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWEkZEDDCGEO775dBmhoXRdRmTdGn33A1P4ry+/gyD+PL63KU70rNgvtCZHYbjCi1Me/REvYXNsd0D7/d3lnvc0bUqVXmpWbylxnfrM
X-Gm-Message-State: AOJu0YzXUmxULwMVd0MfjpYRrtAhVLjo+rrlrkbUCo0DbPhajWz72sRS
	gTqAa7+WTSDRd18rjSJZ7ekpxjnCkcPmiKpAzzBps9IJ4dijfbktCC0yx11Bjw==

Return-Path: <linux-kernel+bounces-43169-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id EE70C840CB1
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 18:01:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1EB811C23CF4
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 17:01:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 86BC2157049;
	Mon, 29 Jan 2024 17:00:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="ci5jDZGz"
Received: from mail-vk1-f182.google.com (mail-vk1-f182.google.com [209.85.221.182])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DD018157030
	for <linux-kernel@vger.kernel.org>; Mon, 29 Jan 2024 17:00:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706547653; cv=none; b=BAhEDub5h3q9id3vlHdwlfcCHI3Ql5r0adIdWw1fZWGu7M7C8ygetOEbEHoxuff/l9KFobxSCExzDqtJslKNo4EsrUajFcjGRiG7M0XIyb+U6g7bzJoD2+lFm0XvMnXrJEUvDjV0bdE5V5RFRHL5GoYl1eS3l7mi/5tIZIjyfg4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706547653; c=relaxed/simple;
	bh=pTnB/1GvzNNfUuwHkGTHJcWxynW1gxVzvW4NZpYGoZw=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=sQQr0N8OvhFh6HSo4b5JDjgtfWP7OkSBXfH7ilco/vIu/pOYiNzzG/6B4hOdJjVBiiV3QGGcHfjgR3PU+DVBH770/6ATzcN1qpZsxq0AxVnn0cM7vu2CsfZkkb0DMXtTfP/b7MHA5wLXpk6agnx6o940bI/03SEzDp0aG8lWgLo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=ci5jDZGz; arc=none smtp.client-ip=209.85.221.182
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-vk1-f182.google.com with SMTP id 71dfb90a1353d-4bda1df7e35so419966e0c.3
        for <linux-kernel@vger.kernel.org>; Mon, 29 Jan 2024 09:00:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1706547650; x=1707152450; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=AELipZXkMkCicP1r++WnBLgJJLRoR3BHJPq49bTuGqg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706547650; x=1707152450;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=AELipZXkMkCicP1r++WnBLgJJLRoR3BHJPq49bTuGqg=;
        b=
X-Gm-Message-State: AOJu0YzqROTcbwgIsSTWHE/s7KaCCGkWMYT4bSbptnMPjmbmdkDDJx8+
	dgL8JL3eZgljl067x4uzCKgjX8xSPIGs2CznrAozUI/MVAJeBBTRMMdRBVcLGUNSsufYR+/2Umi
	AYtkWTrrv1c7iaqcCReLdAHOX5nM=
X-Google-Smtp-Source: AGHT+IH+4U7YLmD1hsufp7QTz9GTQMfbNh+ZsAMbuXqUxXGgVEVTEkLcdItkSTzXTERKOCZ9xOxOhlKVtosVzJbH0D0=
X-Received: by 2002:a05:6122:2019:b0:4bd:6109:ab9a with SMTP id
 l25-20020a056122201900b004bd6109ab9amr2461352vkd.8.1706547649340; Mon, 29 Jan
 2024 09:00:49 -0800 (PST)
Precedence: bulk
...
Message-ID: <CAOMdWSK5CfVpvwmCxCtYLJ-Qt+ZwhETF3K+AhNcBGtEpkKvFqg@mail.gmail.com>

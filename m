Return-Path: <linux-kernel+bounces-36442-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id AA59683A0C5
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 05:54:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 728751F26D45
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 04:54:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 631EDC2C7;
	Wed, 24 Jan 2024 04:54:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="OeUj4/ce"
Received: from mail-il1-f175.google.com (mail-il1-f175.google.com [209.85.166.175])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 11B01E541
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 04:53:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.175
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706072052; cv=none; b=KIij8BAy47Cde5YmRmqyNyU9DslL9tzE/gMf8HZcTf6/en2Ppo9By6XPCq0g2v74Dc/BRNLEGaPxmw1bsmXDtiTi/he/Rrz8qACXUhvOdYM7zl17qtChkI3pty9dxvlvE64khl7fju6qrEI/JGrmQC0mHbzYE26fvCdwxnPWN74=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706072052; c=relaxed/simple;
	bh=rCrf1JEjHyu0OLGZaF7b1Oj+gly1W0GXFAiI4M65Zi8=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=tvXVqKIaHkWuxteSjeZ59zmusgm/eYBZbL8UunyYLvR8Bo0rgqGERB9dDjtr3glOm2M6CVTlBv2ElTKfkMeOGw506/svM442ttucK0zXNV1EazoNyg2GfBVGlv4IxMn1g1TuIFP0BvjIatDR7koir2Ubs/rp8vEQBKX5pFhr3Ps=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=OeUj4/ce; arc=none smtp.client-ip=209.85.166.175
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-il1-f175.google.com with SMTP id e9e14a558f8ab-361b24d1a9eso102655ab.0
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 20:53:52 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1706072032; x=1706676832; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=5LRO/7j+HoHTA3wOZqtto13/caOnsYQE8S2WCJ0aX48=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706072032; x=1706676832;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=5LRO/7j+HoHTA3wOZqtto13/caOnsYQE8S2WCJ0aX48=;
        b=
X-Gm-Message-State: AOJu0Yx+EZw0KFamap/xKARFWJbLuM68Zo1vz18HYjMU8UJ13f2zfC9u
	fN15bl/tKoNtTHu1h30LlMec6j9aj3Q92oRGPCqI/MK71+1ZlPqDaEHnQwQL+Z3j7GqyYL+YjmZ
	lBBThgA0451wwYixLTCJYu5c907abScCUnoeT
X-Google-Smtp-Source: AGHT+IHzrfezcbCpJZ13sF3xTDGuZ563vmomN807XkNnZpDx/D2cfl2pRpMTgApy54+91XoLNJlgJUBLlqSlfuQ4o2g=
X-Received: by 2002:a92:da49:0:b0:360:1777:dc19 with SMTP id
 p9-20020a92da49000000b003601777dc19mr61497ilq.14.1706072030325; Tue, 23 Jan
 2024 20:53:50 -0800 (PST)
Precedence: bulk
...
MIME-Version: 1.0
References: <20231212230224.1473300-1-weilin.wang@intel.com> <20231212230224.1473300-6-weilin.wang@intel.com>
In-Reply-To: <20231212230224.1473300-6-weilin.wang@intel.com>
From: Ian Rogers <irogers@google.com>
Date: Tue, 23 Jan 2024 20:53:36 -0800
Message-ID: <CAP-5=fVB+o_Wu5MPTBujbMvsttxbz10z6XzS1BFc8t5k6JirNQ@mail.gmail.com>
Subject: Re: [RFC PATCH v3 04/18] perf pmu-events: Add counter info into JSON
...
>  14 files changed, 2260 insertions(+)
>  create mode 100644 tools/perf/pmu-events/arch/x86/sapphirerapids/counter=
json
>
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/cache.json b/t=
ools/perf/pmu-events/arch/x86/sapphirerapids/cache.json
> index 9606e76b98d6..67d5150f5c0b 100644
...
Given the list of counters, "Counters" seems a more intuitive name
than "Counter".
...
>      },
>      {
>          "BriefDescription": "All accesses to L2 cache [This event is ali=
as to L2_RQSTS.REFERENCES]",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x24",
>          "EventName": "L2_REQUEST.ALL",
>          "PublicDescription": "Counts all requests that were hit or true =
misses in L2 cache. True-miss excludes misses that were merged with ongoing=
 L2 misses. [This event is alias to L2_RQSTS.REFERENCES]",
> @@ -106,6 +119,7 @@
>      },
>      {
>          "BriefDescription": "Read requests with true-miss in L2 cache. [=
This event is alias to L2_RQSTS.MISS]",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x24",
>          "EventName": "L2_REQUEST.MISS",
>          "PublicDescription": "Counts read requests of any type with true=
-miss in the L2 cache. True-miss excludes L2 misses that were merged with o=
ngoing L2 misses. [This event is alias to L2_RQSTS.MISS]",
> @@ -114,6 +128,7 @@
>      },
>      {
...
>          "PublicDescription": "Counts Demand Data Read requests accessing=
 the L2 cache. These requests may hit or miss L2 cache. True-miss exclude m=
isses that were merged with ongoing L2 misses. An access is counted once.",
> @@ -130,6 +146,7 @@
>      },
>      {
...
>          "PublicDescription": "Counts demand Data Read requests with true=
-miss in the L2 cache. True-miss excludes misses that were merged with ongo=
ing L2 misses. An access is counted once.",
> @@ -193,6 +217,7 @@
>      },
>      {
...
>      {
>          "BriefDescription": "Read requests with true-miss in L2 cache. [=
This event is alias to L2_REQUEST.MISS]",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x24",
>          "EventName": "L2_RQSTS.MISS",
>          "PublicDescription": "Counts read requests of any type with true=
-miss in the L2 cache. True-miss excludes L2 misses that were merged with o=
ngoing L2 misses. [This event is alias to L2_REQUEST.MISS]",
> @@ -208,6 +234,7 @@
>      },
>      {
>          "BriefDescription": "All accesses to L2 cache [This event is ali=
as to L2_REQUEST.ALL]",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x24",
>          "EventName": "L2_RQSTS.REFERENCES",
>          "PublicDescription": "Counts all requests that were hit or true =
misses in L2 cache. True-miss excludes misses that were merged with ongoing=
 L2 misses. [This event is alias to L2_REQUEST.ALL]",
> @@ -216,6 +243,7 @@
>      },
>      {
...
>          "PublicDescription": "Counts Software prefetch requests that hit=
 the L2 cache. Accounts for PREFETCHNTA and PREFETCHT0/1/2 instructions whe=
n FB is not full.",
> @@ -240,6 +270,7 @@
>      },
>      {
...
s the L2 cache. Accounts for PREFETCHNTA and PREFETCHT0/1/2 instructions wh=
en FB is not full.",
> @@ -248,6 +279,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of completed demand load requests t=
hat missed the L1 data cache including shadow misses (FB hits, merge to an =
ongoing L1D miss)",
> @@ -352,6 +394,7 @@
>      },
>      {
...
>      },
>      {
>          "BriefDescription": "Retired load instructions with remote Intel=
(R) Optane(TM) DC persistent memory as the data source where the data reque=
st missed all caches.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd3",
>          "EventName": "MEM_LOAD_L3_MISS_RETIRED.REMOTE_PMM",
>          "PublicDescription": "Counts retired load instructions with remo=
te Intel(R) Optane(TM) DC persistent memory as the data source and the data=
 request missed L3.",
> @@ -438,6 +489,7 @@
>      },
>      {
...
>      },
>      {
>          "BriefDescription": "Retired load instructions with local Intel(=
R) Optane(TM) DC persistent memory as the data source where the data reques=
t missed all caches.",
> +        "Counter": "0,1,2,3",
>          "Data_LA": "1",
>          "EventCode": "0xd1",
...
>          "PublicDescription": "Number of retired micro-operations (uops) =
for load or store memory accesses",
> @@ -543,6 +605,7 @@
>      },
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that hit in the L3 or were snooped from another =
core's caches on the same socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that resulted in a snoop hit a modified line in =
another core's caches which forwarded the data.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that hit a modified line in a distant L3 Cache o=
r were snooped from a distant core's L1/L2 caches on this socket when the s=
...
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that either hit a non-modified line in a distant=
...
>          "BriefDescription": "Counts demand data reads that hit in the L3=
 or were snooped from another core's caches on the same socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts demand data reads that resulted in a=
 snoop hit a modified line in another core's caches which forwarded the dat=
a.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand data reads that resulted in a=
 snoop that hit in another core, which did not forward the data.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand data reads that resulted in a=
 snoop hit in another core's caches which forwarded the unmodified data to =
the requesting core.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts demand data reads that were supplied=
 ...
 core's caches which forwarded the data.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand data reads that were supplied=
 by a cache on a remote socket where a snoop hit in another core's caches w=
hich forwarded the unmodified data to the requesting core.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts demand data reads that hit a modifie=
d line in a distant L3 Cache or were snooped from a distant core's L1/L2 ca=
ches on this socket when the system is in SNC (sub-NUMA cluster) mode.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts demand data reads that either hit a =
non-modified line in a distant L3 Cache or were snooped from a distant core=
...
>      {
>          "BriefDescription": "Counts demand reads for ownership (RFO) req=
uests and software prefetches for exclusive ownership (PREFETCHW) that resu=
lted in a snoop hit a modified line in another core's caches which forwarde=
d the data.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts demand reads for ownership (RFO) req=
uests and software prefetches for exclusive ownership (PREFETCHW) that hit =
a modified line in a distant L3 Cache or were snooped from a distant core's=
...
>      {
>          "BriefDescription": "Counts demand reads for ownership (RFO) req=
uests and software prefetches for exclusive ownership (PREFETCHW) that eith=
er hit a non-modified line in a distant L3 Cache or were snooped from a dis=
tant core's L1/L2 caches on this socket when the system is in SNC (sub-NUMA=
 cluster) mode.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
hat hit in the L3 or were snooped from another core's caches on the same so=
cket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that hit in the L3 or were snooped from another core's caches on the =
same socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that resulted in a snoop hit a modified line in another core's caches=
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that resulted in a snoop that hit in another core, which did not forw=
ard the data.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that resulted in a snoop hit in another core's caches which forwarded=
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by a cache on a remote socket where a snoop was se=
nt and data was returned (Modified or Not Modified).",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by a cache on a remote socket where a snoop hit a =
modified line in another core's caches which forwarded the data.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by a cache on a remote socket where a snoop hit in=
 another core's caches which forwarded the unmodified data to the requestin=
g core.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that hit a modified line in a distant L3 Cache or were snooped from a=
 distant core's L1/L2 caches on this socket when the system is in SNC (sub-=
NUMA cluster) mode.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that either hit a non-modified line in a distant L3 Cache or were sno=
oped from a distant core's L1/L2 caches on this socket when the system is i=
n SNC (sub-NUMA cluster) mode.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts demand reads for ownership (RFO), ha=
rdware prefetch RFOs (which bring data to L2), and software prefetches for =
exclusive ownership (PREFETCHW) that hit to a (M)odified cacheline in the L=
3 or snoop filter.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts streaming stores that hit in the L3 =
or were snooped from another core's caches on the same socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DA=
TA_RD",
> +        "Counter": "0,1,2,3",
>          "CounterMask": "1",
>          "EventCode": "0x20",
...
>      },
>      {
>          "BriefDescription": "Cycles where at least 1 outstanding demand =
data read request is pending.",
> +        "Counter": "0,1,2,3",
>          "CounterMask": "1",
>          "EventCode": "0x20",
>          "EventName": "OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DEMAND_DA=
TA_RD",
> @@ -842,6 +938,7 @@
>      },
>      {
>          "BriefDescription": "OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DE=
MAND_RFO",
> +        "Counter": "0,1,2,3",
>          "CounterMask": "1",
>          "EventCode": "0x20",
...
f outstanding demand data read requests pending.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x20",
>          "EventName": "OFFCORE_REQUESTS_OUTSTANDING.DEMAND_DATA_RD",
>          "PublicDescription": "For every cycle, increments by the number =
of outstanding demand data read requests pending.   Requests are considered=
 outstanding from the time they miss the core's L2 cache until the transact=
ion completion message is sent to the requestor.",
> @@ -865,6 +964,7 @@
>      },
>      {
>          "BriefDescription": "Counts bus locks, accounts for cache line s=
plit locks and UC locks.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2c",
>          "EventName": "SQ_MISC.BUS_LOCK",
>          "PublicDescription": "Counts the more expensive bus lock needed =
to enforce cache coherency for certain memory accesses that need to be done=
 atomically.  Can be created by issuing an atomic instruction (via the LOCK=
 prefix) which causes a cache line split or accesses uncacheable memory.",
> @@ -873,6 +973,7 @@
>      },
>      {
...
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/counter.json b=
/tools/perf/pmu-events/arch/x86/sapphirerapids/counter.json
> new file mode 100644
> index 000000000000..5f8c0b7c8d19
> --- /dev/null
...
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/floating-point=
json b/tools/perf/pmu-events/arch/x86/sapphirerapids/floating-point.json
> index 4a9d211e9d4f..5b144ac504ed 100644
...
>          "PublicDescription": "Number of SSE/AVX computational 128-bit pa=
cked double precision floating-point instructions retired; some instruction=
s will count twice as noted below.  Each count represents 2 computation ope=
rations, one for each element.  Applies to SSE* and AVX* packed double prec=
ision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DIV MIN MAX=
 SQRT DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count twice as t=
hey perform 2 calculations per element. The DAZ and FTZ flags in the MXCSR =
...
>          "PublicDescription": "Number of SSE/AVX computational 128-bit pa=
cked single precision floating-point instructions retired; some instruction=
s will count twice as noted below.  Each count represents 4 computation ope=
rations, one for each element.  Applies to SSE* and AVX* packed single prec=
ision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DIV MIN MAX=
 SQRT RSQRT RCP DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count =
twice as they perform 2 calculations per element. The DAZ and FTZ flags in =
...
>          "PublicDescription": "Number of SSE/AVX computational 256-bit pa=
cked double precision floating-point instructions retired; some instruction=
s will count twice as noted below.  Each count represents 4 computation ope=
rations, one for each element.  Applies to SSE* and AVX* packed double prec=
ision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DIV MIN MAX=
 SQRT FM(N)ADD/SUB.  FM(N)ADD/SUB instructions count twice as they perform =
2 calculations per element. The DAZ and FTZ flags in the MXCSR register nee=
d to be set when using these events.",
> @@ -69,6 +78,7 @@
>      },
>      {
>          "BriefDescription": "Counts number of SSE/AVX computational 256-=
...
>          "PublicDescription": "Number of SSE/AVX computational 256-bit pa=
cked single precision floating-point instructions retired; some instruction=
s will count twice as noted below.  Each count represents 8 computation ope=
rations, one for each element.  Applies to SSE* and AVX* packed single prec=
ision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DIV MIN MAX=
 SQRT RSQRT RCP DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count =
twice as they perform 2 calculations per element. The DAZ and FTZ flags in =
...
>      {
>          "BriefDescription": "Number of SSE/AVX computational 128-bit pac=
ked single and 256-bit packed double precision FP instructions retired; som=
e instructions will count twice as noted below.  Each count represents 2 or=
/and 4 computation operations, 1 for each element.  Applies to SSE* and AVX=
* packed single precision and packed double precision FP instructions: ADD =
SUB HADD HSUB SUBADD MUL DIV MIN MAX RCP14 RSQRT14 SQRT DPP FM(N)ADD/SUB.  =
DPP and FM(N)ADD/SUB count twice as they perform 2 calculations per element=
",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xc7",
>          "EventName": "FP_ARITH_INST_RETIRED.4_FLOPS",
>          "PublicDescription": "Number of SSE/AVX computational 128-bit pa=
cked single precision and 256-bit packed double precision  floating-point i=
nstructions retired; some instructions will count twice as noted below.  Ea=
ch count represents 2 or/and 4 computation operations, one for each element=
  Applies to SSE* and AVX* packed single precision floating-point and pack=
ed double precision floating-point instructions: ADD SUB HADD HSUB SUBADD M=
UL DIV MIN MAX RCP14 RSQRT14 SQRT DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB i=
nstructions count twice as they perform 2 calculations per element. The DAZ=
 and FTZ flags in the MXCSR register need to be set when using these events=
",
> @@ -85,6 +96,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of SSE/AVX computational 512-bit pa=
cked double precision floating-point instructions retired; some instruction=
s will count twice as noted below.  Each count represents 8 computation ope=
rations, one for each element.  Applies to SSE* and AVX* packed double prec=
ision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT14 RCP=
14 FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perform 2 ca=
lculations per element. The DAZ and FTZ flags in the MXCSR register need to=
...
>          "PublicDescription": "Number of SSE/AVX computational 512-bit pa=
cked single precision floating-point instructions retired; some instruction=
s will count twice as noted below.  Each count represents 16 computation op=
...
P14 FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perform 2 c=
alculations per element. The DAZ and FTZ flags in the MXCSR register need t=
o be set when using these events.",
> @@ -101,6 +114,7 @@
>      },
>      {
>          "BriefDescription": "Number of SSE/AVX computational 256-bit pac=
ked single precision and 512-bit packed double precision  FP instructions r=
etired; some instructions will count twice as noted below.  Each count repr=
esents 8 computation operations, 1 for each element.  Applies to SSE* and A=
VX* packed single precision and double precision FP instructions: ADD SUB H=
ADD HSUB SUBADD MUL DIV MIN MAX SQRT RSQRT RSQRT14 RCP RCP14 DPP FM(N)ADD/S=
UB.  DPP and FM(N)ADD/SUB count twice as they perform 2 calculations per el=
ement.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xc7",
>          "EventName": "FP_ARITH_INST_RETIRED.8_FLOPS",
>          "PublicDescription": "Number of SSE/AVX computational 256-bit pa=
cked single precision and 512-bit packed double precision  floating-point i=
nstructions retired; some instructions will count twice as noted below.  Ea=
ch count represents 8 computation operations, one for each element.  Applie=
s to SSE* and AVX* packed single precision and double precision floating-po=
int instructions: ADD SUB HADD HSUB SUBADD MUL DIV MIN MAX SQRT RSQRT RSQRT=
14 RCP RCP14 DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count twi=
ce as they perform 2 calculations per element. The DAZ and FTZ flags in the=
 MXCSR register need to be set when using these events.",
> @@ -109,6 +123,7 @@
>      },
>      {
>          "BriefDescription": "Number of SSE/AVX computational scalar floa=
ting-point instructions retired; some instructions will count twice as note=
d below.  Applies to SSE* and AVX* scalar, double and single precision floa=
ting-point: ADD SUB MUL DIV MIN MAX RCP14 RSQRT14 RANGE SQRT DPP FM(N)ADD/S=
UB.  DPP and FM(N)ADD/SUB instructions count twice as they perform multiple=
 calculations per element.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xc7",
>          "EventName": "FP_ARITH_INST_RETIRED.SCALAR",
>          "PublicDescription": "Number of SSE/AVX computational scalar sin=
gle precision and double precision floating-point instructions retired; som=
e instructions will count twice as noted below.  Each count represents 1 co=
mputational operation. Applies to SSE* and AVX* scalar single precision flo=
ating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT RCP FM(N)ADD/S=
UB.  FM(N)ADD/SUB instructions count twice as they perform 2 calculations p=
er element. The DAZ and FTZ flags in the MXCSR register need to be set when=
 using these events.",
> @@ -117,6 +132,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of SSE/AVX computational scalar dou=
ble precision floating-point instructions retired; some instructions will c=
ount twice as noted below.  Each count represents 1 computational operation=
 Applies to SSE* and AVX* scalar double precision floating-point instructi=
ons: ADD SUB MUL DIV MIN MAX SQRT FM(N)ADD/SUB.  FM(N)ADD/SUB instructions =
count twice as they perform 2 calculations per element. The DAZ and FTZ fla=
gs in the MXCSR register need to be set when using these events.",
> @@ -125,6 +141,7 @@
>      },
>      {
>          "BriefDescription": "Counts number of SSE/AVX computational scal=
...
>          "PublicDescription": "Number of SSE/AVX computational scalar sin=
gle precision floating-point instructions retired; some instructions will c=
ount twice as noted below.  Each count represents 1 computational operation=
 Applies to SSE* and AVX* scalar single precision floating-point instructi=
ons: ADD SUB MUL DIV MIN MAX SQRT RSQRT RCP FM(N)ADD/SUB.  FM(N)ADD/SUB ins=
...
>      },
>      {
>          "BriefDescription": "Number of any Vector retired FP arithmetic =
instructions",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xc7",
>          "EventName": "FP_ARITH_INST_RETIRED.VECTOR",
>          "PublicDescription": "Number of any Vector retired FP arithmetic=
 instructions.  The DAZ and FTZ flags in the MXCSR register need to be set =
...
>      },
>      {
>          "BriefDescription": "Number of all Scalar Half-Precision FP arit=
hmetic instructions(1) retired - regular and complex.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xcf",
...
>      },
>      {
>          "BriefDescription": "Number of all Vector (also called packed) H=
alf-Precision FP arithmetic instructions(1) retired.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xcf",
>          "EventName": "FP_ARITH_INST_RETIRED2.VECTOR",
>          "PublicDescription": "FP_ARITH_INST_RETIRED2.VECTOR",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/frontend.json =
b/tools/perf/pmu-events/arch/x86/sapphirerapids/frontend.json
> index 9e53da55d0c1..b89f07e7cb93 100644
...
>          "PublicDescription": "Number of times the front-end is resteered=
 when it finds a branch instruction in a fetch line. This is called Unknown=
 Branch which occurs for the first time a branch instruction is fetched or =
when the branch is not tracked by the BPU (Branch Prediction Unit) anymore.=
",
> @@ -9,6 +10,7 @@
>      },
>      {
...
> @@ -50,10 +57,12 @@
>          "PEBS": "1",
>          "PublicDescription": "Number of retired Instructions that experi=
enced a critical DSB (Decode stream buffer i.e. the decoded instruction-cac=
he) miss. Critical means stalls were exposed to the back-end as a result of=
 the DSB miss.",
>          "SampleAfterValue": "100007",
> +        "TakenAlone": "1",
>          "UMask": "0x1"
...
talled due to an L1 instruction cache miss. The decode pipeline works at a =
32 Byte granularity.",
> @@ -247,6 +290,7 @@
>      },
>      {
...
he machine is not stalled [This event is alias to IDQ_UOPS_NOT_DELIVERED.CO=
RE]",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0x9c",
...
ven cycle. [This event is alias to IDQ_UOPS_NOT_DELIVERED.CORE]",
> @@ -342,6 +396,7 @@
>      },
>      {
>          "BriefDescription": "Cycles when no uops are not delivered by th=
e IDQ when backend of the machine is not stalled [This event is alias to ID=
Q_UOPS_NOT_DELIVERED.CYCLES_0_UOPS_DELIV.CORE]",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "CounterMask": "6",
>          "EventCode": "0x9c",
...
vered to the back-end when the back-end is not stalled [This event is alias=
 to IDQ_UOPS_NOT_DELIVERED.CYCLES_FE_WAS_OK]",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "CounterMask": "1",
>          "EventCode": "0x9c",
...
>      {
>          "BriefDescription": "Uops not delivered by IDQ when backend of t=
he machine is not stalled [This event is alias to IDQ_BUBBLES.CORE]",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0x9c",
...
>          "PublicDescription": "Counts the number of uops not delivered to=
 by the Instruction Decode Queue (IDQ) to the back-end of the pipeline when=
 there was no back-end stalls. This event counts for one SMT thread in a gi=
ven cycle. [This event is alias to IDQ_BUBBLES.CORE]",
> @@ -369,6 +426,7 @@
>      },
>      {
>          "BriefDescription": "Cycles when no uops are not delivered by th=
e IDQ when backend of the machine is not stalled [This event is alias to ID=
Q_BUBBLES.CYCLES_0_UOPS_DELIV.CORE]",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "CounterMask": "6",
>          "EventCode": "0x9c",
...
>          "BriefDescription": "Cycles when optimal number of uops was deli=
vered to the back-end when the back-end is not stalled [This event is alias=
 to IDQ_BUBBLES.CYCLES_FE_WAS_OK]",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "CounterMask": "1",
>          "EventCode": "0x9c",
>          "EventName": "IDQ_UOPS_NOT_DELIVERED.CYCLES_FE_WAS_OK",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/memory.json b/=
tools/perf/pmu-events/arch/x86/sapphirerapids/memory.json
> index e8bf7c9c44e1..4c1f257bfd0e 100644
...
>          "BriefDescription": "Execution stalls while L2 cache miss demand=
 cacheable load request is outstanding.",
> +        "Counter": "0,1,2,3",
>          "CounterMask": "5",
>          "EventCode": "0x47",
...
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that were not supplied by the local socket's L1,=
 L2, or L3 caches.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
lied by the local socket's L1, L2, or L3 caches.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand reads for ownership (RFO) req=
uests and software prefetches for exclusive ownership (PREFETCHW) that were=
...
>      {
>          "BriefDescription": "Counts hardware prefetches to the L3 only t=
hat missed the local socket's L1, L2, and L3 caches.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts hardware prefetches to the L3 only t=
hat were not supplied by the local socket's L1, L2, or L3 caches and the ca=
cheline is homed locally.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were not supplied by the local socket's L1, L2, or L3 caches.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were not supplied by the local socket's L1, L2, or L3 caches and=
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that missed the L3 Cache and were supplied by the local socket (DRAM =
or PMM), whether or not in Sub NUMA Cluster(SNC) Mode.  In SNC Mode counts =
PMM or DRAM accesses that are controlled by the close or distant SNC Cluste=
r.  It does not count misses to the L3 which go to Local CXL Type 2 Memory =
or Local Non DRAM.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts streaming stores that missed the loc=
al socket's L1, L2, and L3 caches.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts streaming stores that were not suppl=
ied by the local socket's L1, L2, or L3 caches and the cacheline is homed l=
ocally.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts demand data read requests that miss =
the L3 cache.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x21",
...
>      {
>          "BriefDescription": "For every cycle, increments by the number o=
f demand data read requests pending that are known to have missed the L3 ca=
che.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x20",
>          "EventName": "OFFCORE_REQUESTS_OUTSTANDING.L3_MISS_DEMAND_DATA_R=
D",
>          "PublicDescription": "For every cycle, increments by the number =
of demand data read requests pending that are known to have missed the L3 c=
ache.  Note that this does not capture all elapsed cycles while requests ar=
e outstanding - only cycles from when the requests were known by the reques=
ting core to have missed the L3 cache.",
> @@ -262,6 +296,7 @@
>      },
>      {
...
a cache conflict.",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/other.json b/t=
ools/perf/pmu-events/arch/x86/sapphirerapids/other.json
> index 442ef3807a9d..5a5ead85b902 100644
...
>      },
>      {
>          "BriefDescription": "Counts the cycles where the AMX (Advance Ma=
trix Extension) unit is busy performing an operation.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xb7",
...
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that were supplied by DRAM.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that were supplied by DRAM attached to this sock=
et, unless in Sub NUMA Cluster(SNC) Mode.  In SNC Mode counts only those DR=
AM accesses that are controlled by the close SNC Cluster.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand instruction fetches and L1 in=
struction cache prefetches that were supplied by DRAM on a distant memory c=
ontroller of this socket when the system is in SNC (sub-NUMA cluster) mode.=
",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts demand data reads that were supplied=
 ...
 SNC Mode counts only those DRAM accesses that are controlled by the close =
SNC Cluster.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand data reads that were supplied=
 by PMM attached to this socket, whether or not in Sub NUMA Cluster(SNC) Mo=
de.  In SNC Mode counts PMM accesses that are controlled by the close or di=
stant SNC Cluster.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand data reads that were supplied=
 by DRAM attached to another socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand data reads that were supplied=
 by PMM attached to another socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      {
>          "BriefDescription": "Counts demand data reads that were supplied=
 by DRAM on a distant memory controller of this socket when the system is i=
n SNC (sub-NUMA cluster) mode.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts demand reads for ownership (RFO) req=
uests and software prefetches for exclusive ownership (PREFETCHW) that were=
 supplied by DRAM attached to this socket, unless in Sub NUMA Cluster(SNC) =
Mode.  In SNC Mode counts only those DRAM accesses that are controlled by t=
he close SNC Cluster.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts demand reads for ownership (RFO) req=
uests and software prefetches for exclusive ownership (PREFETCHW) that were=
 supplied by DRAM on a distant memory controller of this socket when the sy=
...
>      },
>      {
>          "BriefDescription": "Counts data load hardware prefetch requests=
 to the L1 data cache that have any type of response.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts hardware prefetches (which bring dat=
a to L2) that have any type of response.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts hardware prefetches to the L3 only t=
hat were not supplied by the local socket's L1, L2, or L3 caches and the ca=
cheline was homed in a remote socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts writebacks of modified cachelines an=
d streaming stores that have any type of response.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that have any type of response.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by DRAM.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by DRAM attached to this socket, unless in Sub NUM=
A Cluster(SNC) Mode.  In SNC Mode counts only those DRAM accesses that are =
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by DRAM attached to this socket, whether or not in=
 Sub NUMA Cluster(SNC) Mode.  In SNC Mode counts DRAM accesses that are con=
trolled by the close or distant SNC Cluster.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by PMM attached to this socket, whether or not in =
Sub NUMA Cluster(SNC) Mode.  In SNC Mode counts PMM accesses that are contr=
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were not supplied by the local socket's L1, L2, or L3 caches and=
 were supplied by a remote socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by DRAM attached to another socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by DRAM or PMM attached to another socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by PMM attached to another socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>          "BriefDescription": "Counts all (cacheable) data read, code read=
 and RFO requests including demands and prefetches to the core caches (L1 o=
r L2) that were supplied by DRAM on a distant memory controller of this soc=
ket when the system is in SNC (sub-NUMA cluster) mode.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
>      },
>      {
>          "BriefDescription": "Counts Demand RFOs, ItoM's, PREFECTHW's, Ha=
rdware RFO Prefetches to the L1/L2 and Streaming stores that likely resulte=
d in a store to Memory (DRAM or PMM)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2A,0x2B",
...
hen the front-end pipeline runs into starvation periods (e.g. branch mispre=
...
>      },
>      {
>          "BriefDescription": "Cycles the uncore cannot take further reque=
sts",
> +        "Counter": "0,1,2,3",
>          "CounterMask": "1",
>          "EventCode": "0x2d",
...
> index 6dcf3b763af4..d52c264fa50d 100644
...
>          "PublicDescription": "Number of AMX-based retired arithmetic bfl=
oat16 (BF16) floating-point operations. Counts TDPBF16PS FP instructions. S=
W to use operation multiplier of 4",
> @@ -9,6 +10,7 @@
>      },
>      {
>          "BriefDescription": "AMX retired arithmetic integer 8-bit operat=
ions.",
> +        "Counter": "0",
>          "EventCode": "0xce",
>          "EventName": "AMX_OPS_RETIRED.INT8",
>          "PublicDescription": "Number of AMX-based retired arithmetic int=
eger operations of 8-bit width source operands. Counts TDPB[SS,UU,US,SU]D i=
nstructions. SW should use operation multiplier of 8.",
> @@ -17,6 +19,7 @@
>      },
>      {
>          "BriefDescription": "This event is deprecated. Refer to new even=
...
>      },
>      {
>          "BriefDescription": "This event counts the cycles the integer di=
vider is busy.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "CounterMask": "1",
>          "EventCode": "0xb0",
...
icrocode assist is invoked by hardware. Examples include AD (page Access Di=
rty), FP and AVX related assists.",
> @@ -69,6 +77,7 @@
>      },
>      {
...
>      },
>      {
>          "BriefDescription": "Miss-predicted near indirect branch instruc=
tions retired (excluding returns)",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xc5",
...
>      },
>      {
>          "BriefDescription": "Core clocks when the thread is in the C0.1 =
light-weight slower wakeup time but more power saving optimized state.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xec",
>          "EventName": "CPU_CLK_UNHALTED.C01",
>          "PublicDescription": "Counts core clocks when the thread is in t=
he C0.1 light-weight slower wakeup time but more power saving optimized sta=
te.  This state can be entered via the TPAUSE or UMWAIT instructions.",
> @@ -228,6 +254,7 @@
>      },
>      {
>          "BriefDescription": "Core clocks when the thread is in the C0.2 =
light-weight faster wakeup time but less power saving optimized state.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xec",
>          "EventName": "CPU_CLK_UNHALTED.C02",
>          "PublicDescription": "Counts core clocks when the thread is in t=
he C0.2 light-weight faster wakeup time but less power saving optimized sta=
te.  This state can be entered via the TPAUSE or UMWAIT instructions.",
> @@ -236,6 +263,7 @@
>      },
>      {
>          "BriefDescription": "Core clocks when the thread is in the C0.1 =
or C0.2 or running a PAUSE in C0 ACPI state.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xec",
>          "EventName": "CPU_CLK_UNHALTED.C0_WAIT",
>          "PublicDescription": "Counts core clocks when the thread is in t=
he C0.1 or C0.2 power saving optimized states (TPAUSE or UMWAIT instruction=
s) or running the PAUSE instruction.",
> @@ -244,6 +272,7 @@
>      },
>      {
...
ut has the same incrementing frequency as the time stamp counter. This even=
t can approximate elapsed time while the core was not in a halt state. It i=
s counted on a dedicated fixed counter, leaving the four (eight when Hypert=
hreading is disabled) programmable counters available for other events. Not=
e: On all current platforms this event stops counting during 'throttling (T=
M)' states duty off periods the processor is 'halted'.  The counter update =
...
>      },
>      {
>          "BriefDescription": "Cycles no uop executed while RS was not emp=
ty, the SB was not full and there was no outstanding load.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xa6",
>          "EventName": "EXE_ACTIVITY.EXE_BOUND_0_PORTS",
>          "PublicDescription": "Number of cycles total of 0 uops executed =
on all ports, Reservation Station (RS) was not empty, the Store Buffer (SB)=
 was not full and there was no outstanding load.",
> @@ -418,6 +468,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of decoders utilized in a cycle whe=
n the MITE (legacy decode pipeline) fetches instructions.",
> @@ -426,6 +477,7 @@
>      },
>      {
...
>          "PublicDescription": "Counts all retired NOP or ENDBR32/64 instr=
uctions",
> @@ -457,6 +512,7 @@
>      },
>      {
...
>      },
>      {
>          "BriefDescription": "Iterations of Repeat string retired instruc=
tions.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xc0",
>          "EventName": "INST_RETIRED.REP_ITERATION",
>          "PublicDescription": "Number of iterations of Repeat (REP) strin=
g retired instructions such as MOVS, CMPS, and SCAS. Each has a byte, word,=
 and doubleword version and string instructions can be repeated using a rep=
etition prefix, REP, that allows their architectural execution to be repeat=
ed a number of times as specified by the RCX register. Note the number of i=
terations is implementation-dependent.",
> @@ -473,6 +530,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of retired integer ADD/SUB (regular=
 or horizontal), SAD 128-bit vector instructions.",
> @@ -545,6 +612,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of retired integer ADD/SUB (regular=
 or horizontal), SAD 256-bit vector instructions.",
> @@ -553,6 +621,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of slots in TMA method where no mic=
ro-operations were being issued from front-end to back-end of the machine d=
ue to lack of back-end resources.",
> @@ -712,6 +798,7 @@
>      },
>      {
...
>          "PublicDescription": "Number of uops dispatch to execution  port=
 0.",
> @@ -749,6 +840,7 @@
>      },
>      {
...
>      },
>      {
>          "BriefDescription": "Retired uops except the last uop of each in=
struction.",
> +        "Counter": "0,1,2,3,4,5,6,7",
>          "EventCode": "0xc2",
>          "EventName": "UOPS_RETIRED.HEAVY",
>          "PublicDescription": "Counts the number of retired micro-operati=
ons (uops) except the last uop of each instruction. An instruction that is =
decoded into less than two uops does not contribute to the count.",
> @@ -937,15 +1050,18 @@
>      },
>      {
...
>          "Deprecated": "1",
>          "EventCode": "0xc2",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-cache.j=
son b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-cache.json
> index cf6fa70f37c1..fc3ecfc0e5a7 100644
...
>  [
>      {
>          "BriefDescription": "CHA to iMC Bypass : Intermediate bypass Tak=
en",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x57",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Any Cycle with M=
ultiple Snoops",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Multiple Core Re=
quests",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Single Core Requ=
ests",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Multiple Evictio=
n",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Multiple Externa=
l Snoops",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Single External =
Snoops",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Multiple Snoop T=
argets from Remote",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Core Cross Snoops Issued : Single Snoop Tar=
get from Remote",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x33",
...
>      },
>      {
>          "BriefDescription": "Egress Blocking due to Ordering requirement=
s : Down",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xba",
...
>      },
>      {
>          "BriefDescription": "Counts Number of Hits in HitMe Cache : Shar=
ed hit and op is RdInvOwn, RdInv, Inv*",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x5f",
...
>      },
>      {
>          "BriefDescription": "Counts Number of Hits in HitMe Cache : op i=
s WbMtoE",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x5f",
...
>      {
>          "BriefDescription": "Counts Number of Hits in HitMe Cache : op i=
s WbMtoI, WbPushMtoI, WbFlush, or WbMtoS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x5f",
...
>      },
>      {
>          "BriefDescription": "Counts Number of times HitMe Cache is acces=
sed : op is RdCode, RdData, RdDataMigratory, RdCur, RdInvOwn, RdInv, Inv*",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x5e",
...
>      {
>          "BriefDescription": "Counts Number of times HitMe Cache is acces=
sed : op is WbMtoE, WbMtoI, WbPushMtoI, WbFlush, or WbMtoS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x5e",
...
>      },
>      {
>          "BriefDescription": "Counts Number of Misses in HitMe Cache : No=
 SF/LLC HitS/F and op is RdInvOwn",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x60",
...
>      },
>      {
>          "BriefDescription": "Counts Number of Misses in HitMe Cache : op=
 is RdCode, RdData, RdDataMigratory, RdCur, RdInv, Inv*",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x60",
...
>      },
>      {
>          "BriefDescription": "Counts Number of Misses in HitMe Cache : SF=
...
>      },
>      {
>          "BriefDescription": "Counts the number of Allocate/Update to Hit=
Me Cache : Deallocate HitME$ on Reads without RspFwdI*",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x61",
...
>      {
>          "BriefDescription": "Counts the number of Allocate/Update to Hit=
Me Cache : op is RspIFwd or RspIFwdWb for a local request",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x61",
...
>      {
>          "BriefDescription": "Counts the number of Allocate/Update to Hit=
Me Cache : Update HitMe Cache on RdInvOwn even if not RspFwdI*",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x61",
...
>      {
>          "BriefDescription": "Counts the number of Allocate/Update to Hit=
Me Cache : op is RspIFwd or RspIFwdWb for a remote request",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x61",
...
>      {
>          "BriefDescription": "Counts the number of Allocate/Update to Hit=
Me Cache : Update HitMe Cache to SHARed",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x61",
...
>      },
>      {
>          "BriefDescription": "CHA to iMC Full Line Writes Issued : ISOCH =
Full Line",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x5b",
...
>      },
>      {
>          "BriefDescription": "CHA to iMC Full Line Writes Issued : Partia=
l Non-ISOCH",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x5b",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : All transactions from Remot=
e Agents",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache and Snoop Filter Lookups; Data Read R=
equest",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : Demand Data Reads, Core and=
 LLC prefetches",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : Flush or Invalidate Request=
s",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : CRd Requests that come from=
...
>      {
>          "BriefDescription": "Cache and Snoop Filter Lookups; Data Read R=
equest that come from the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : Demand CRd Requests that co=
me from the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache and Snoop Filter Lookups; Demand Data=
 Reads that come from the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : Demand RFO Requests that co=
me from the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      {
>          "BriefDescription": "Cache Lookups : Flush or Invalidate Request=
s that come from the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache and Snoop Filter Lookups; Prefetch re=
quests to the LLC that come from the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache and Snoop Filter Lookups; Data Read P=
refetches that come from the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : CRd Prefetches that come fr=
om the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : RFO Prefetches that come fr=
om the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : RFO Requests that come from=
 the local socket (usually the core)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      {
>          "BriefDescription": "Cache and Snoop Filter Lookups; Data Read R=
equests that come from a Remote socket",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      {
>          "BriefDescription": "Cache Lookups : Flush or Invalidate request=
s that come from a Remote socket.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : Filters Requests for those =
that write info into the cache that come from a remote socket",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache and Snoop Filter Lookups; Snoop Reque=
sts from a Remote Socket",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "Cache Lookups : Locally HOMed RFOs - Demand=
 and Prefetches",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x34",
...
>      },
>      {
>          "BriefDescription": "All LLC lines in E state that are victimize=
...
>      },
>      {
>          "BriefDescription": "All LLC lines in F or S state that are vict=
imized on a fill from an IO device",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x37",
...
>      },
>      {
>          "BriefDescription": "All LLC lines in M state that are victimize=
d on a fill from an IO device",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x37",
...
>      },
>      {
>          "BriefDescription": "All LLC lines in any state that are victimi=
zed on a fill from an IO device",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x37",
...
>      },
>      {
>          "BriefDescription": "All LLC lines in S state that are victimize=
d on a fill",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x37",
...
>      },
>      {
>          "BriefDescription": "OSB Snoop Broadcast : RFO HitS Snoop Broadc=
ast",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x55",
...
>      },
>      {
>          "BriefDescription": "Memory Mode related events; Counts the numb=
er of times CHA saw a Near Memory set conflict in SF/LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x64",
...
>      {
>          "BriefDescription": "Memory Mode related events; Counts the numb=
er of times CHA saw a Near Memory set conflict in TOR",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x64",
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2.MEMWRN=
I",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x70",
...
>      },
>      {
>          "BriefDescription": "Number of SLOW TOR Request inserted to ha_p=
mm_tor_req_fifo",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x67",
...
>      },
>      {
>          "BriefDescription": "Requests for exclusive ownership of a cache=
...
>      },
>      {
>          "BriefDescription": "Remote requests for exclusive ownership of =
a cache line  without receiving data",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x50",
...
>      },
>      {
>          "BriefDescription": "Ingress (from CMS) Allocations : IRQ Reject=
ed",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x13",
...
>      },
>      {
>          "BriefDescription": "IPQ Requests (from CMS) Rejected - Set 0 : =
AD REQ on VN0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x22",
...
>      },
>      {
>          "BriefDescription": "IPQ Requests (from CMS) Rejected - Set 1 : =
Allow Snoop",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x23",
...
>      },
>      {
>          "BriefDescription": "IRQ Requests (from CMS) Rejected - Set 0 : =
AD REQ on VN0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x18",
...
>      },
>      {
>          "BriefDescription": "IRQ Requests (from CMS) Rejected - Set 1 : =
Allow Snoop",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x19",
...
>      },
>      {
>          "BriefDescription": "PRQ Requests (from CMS) Rejected - Set 0 : =
AD REQ on VN0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x20",
...
>      },
>      {
>          "BriefDescription": "PRQ Requests (from CMS) Rejected - Set 1 : =
Allow Snoop",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x21",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : AD REQ on V=
N0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : AD RSP on V=
N0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : Non UPI AK =
Request",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : BL NCB on V=
N0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : BL NCS on V=
N0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : BL RSP on V=
N0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : BL WB on VN=
0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 0 : Non UPI IV =
Request",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2a",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 1 : LLC OR SF W=
ay",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2b",
...
>      },
>      {
>          "BriefDescription": "Request Queue Retries - Set 1 : PhyAddr Mat=
ch",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x2b",
...
>      },
>      {
>          "BriefDescription": "Snoops Sent : Broadcast snoop for Local Req=
uests",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x51",
...
>      },
>      {
>          "BriefDescription": "Snoops Sent : Broadcast snoops for Remote R=
equests",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x51",
...
>      },
>      {
>          "BriefDescription": "Snoops Sent : Directed snoops for Local Req=
uests",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x51",
...
>      },
>      {
>          "BriefDescription": "Snoops Sent : Directed snoops for Remote Re=
quests",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x51",
...
>      },
>      {
>          "BriefDescription": "Snoops Sent : Broadcast or directed Snoops =
sent for Local Requests",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x51",
...
>      },
>      {
>          "BriefDescription": "Misc Snoop Responses Received : MtoI RspIDa=
taM",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x6b",
...
>      },
>      {
>          "BriefDescription": "Misc Snoop Responses Received : MtoI RspIFw=
dM",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x6b",
...
>      },
>      {
>          "BriefDescription": "Misc Snoop Responses Received : Pull Data P=
artial - Hit LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x6b",
...
>      },
>      {
>          "BriefDescription": "Misc Snoop Responses Received : RspIFwdPtl =
Hit LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x6b",
...
>      },
>      {
>          "BriefDescription": "All requests issued from IA cores to CXL ac=
celerator memory regions that hit the LLC.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : DRd PTEs issued by iA Cores t=
hat Hit the LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts; DRd Opt Pref hits from local I=
A",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : ItoMs issued by iA Cores that=
 Hit LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : ItoMCacheNears issued by iA C=
ores",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "CRds and equivalent opcodes issued from an =
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : CRd issued by iA Cores that M=
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : CRd_Prefs issued by iA Cores =
...
>      {
>          "BriefDescription": "All requests issued from IA cores to CXL ac=
celerator memory regions that miss the LLC.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "DRds and equivalent opcodes issued from an =
IA core which miss the L3 and target memory in a CXL type 2 accelerator.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "DRds issued from an IA core which miss the =
L3 and target memory in a CXL type 2 memory expander card.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_DRD_CXL_ACC_LOC=
AL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts for DRds issued by IA Cores tar=
...
>      },
>      {
>          "BriefDescription": "TOR Inserts for DRd misses from local IA ta=
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : DRds issued by iA Cores targe=
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_DRD_OPT_CXL_ACC=
_LOCAL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts; DRd Opt Pref misses from local=
 IA",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_DRD_OPT_PREF_CX=
L_ACC_LOCAL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
>          "EventName": "UNC_CHA_TOR_INSERTS.IA_MISS_DRD_OPT_PREF_CXL_ACC_L=
OCAL",
>          "PerPkg": "1",
> @@ -3522,6 +3919,7 @@
>      },
...
>      },
>      {
>          "BriefDescription": "TOR Inserts for DRd Pref misses from local =
IA",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "L2 data prefetches issued from an IA core w=
hich miss the L3 and target memory in a CXL type 2 accelerator.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_DRD_PREF_CXL_AC=
C_LOCAL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts; LLCPrefCode misses from local =
IA",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "LLC Prefetch Code transactions issued from =
an IA core which miss the L3 and target memory in a CXL type 2 accelerator.=
",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts; LLCPrefData misses from local =
IA",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "LLC data prefetches issued from an IA core =
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_LLCPREFDATA_CXL=
_ACC_LOCAL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
>          "EventName": "UNC_CHA_TOR_INSERTS.IA_MISS_LLCPREFDATA_CXL_ACC_LO=
CAL",
>          "PerPkg": "1",
> @@ -3708,6 +4126,7 @@
>      },
>      {
>          "BriefDescription": "TOR Inserts; LLCPrefRFO misses from local I=
A",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "L2 RFO prefetches issued from an IA core wh=
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_LLCPREFRFO_CXL_=
ACC_LOCAL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
>          "EventName": "UNC_CHA_TOR_INSERTS.IA_MISS_LLCPREFRFO_CXL_ACC_LOC=
AL",
>          "PerPkg": "1",
> @@ -3734,6 +4155,7 @@
>      },
>      {
>          "BriefDescription": "TOR Inserts : WCiLFs issued by iA Cores tar=
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : WCiLs issued by iA Cores targ=
...
>      },
>      {
>          "BriefDescription": "RFO and L2 RFO prefetches issued from an IA=
...
>      },
>      {
>          "BriefDescription": "RFOs issued from an IA core which miss the =
L3 and target memory in a CXL type 2 accelerator.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_RFO_CXL_ACC_LOC=
AL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "LLC RFO prefetches issued from an IA core w=
hich miss the L3 and target memory in a CXL type 2 accelerator.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "UNC_CHA_TOR_INSERTS.IA_MISS_RFO_PREF_CXL_AC=
C_LOCAL",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts; RFO prefetch misses from local=
 IA",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : UCRdFs issued by iA Cores tha=
t Missed LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : WCiLs issued by iA Cores that=
 Missed the LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : WCiLF issued by iA Cores that=
 Missed the LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : WiLs issued by iA Cores that =
Missed LLC",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : CLFlushes issued by IO Device=
s",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : ItoMCacheNears, indicating a =
...
>      },
>      {
>          "BriefDescription": "TOR Inserts; RdCur and FsRdCur hits from lo=
cal IO",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts for ItoMCacheNears from IO devi=
ces.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts; RdCur and FsRdCur misses from =
local IO",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x35",
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : Match the Opcode in b[29:19] =
...
>      },
>      {
>          "BriefDescription": "TOR Inserts : Match the PreMorphed Opcode i=
...
>      },
>      {
>          "BriefDescription": "XPT Prefetches : Dropped (on 0?) - No Credi=
ts",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x6f",
...
>      },
>      {
>          "BriefDescription": "XPT Prefetches : Dropped (on 1?) - No Credi=
ts",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x6f",
...
>          "PerPkg": "1",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-cxl.jso=
n b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-cxl.json
> index f3e84fd88de3..147903614004 100644
...
>      },
>      {
>          "BriefDescription": "Count the number of Headerless flits receiv=
ed",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x4b",
...
>      },
>      {
>          "BriefDescription": "Count the number of valid messages in the f=
lit",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x4b",
...
>      },
>      {
>          "BriefDescription": "Number of Allocation to Cache Data Packing =
buffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x41",
...
>      },
>      {
>          "BriefDescription": "Number of Allocation to Cache Req Packing b=
uffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x41",
...
>      },
>      {
>          "BriefDescription": "Number of Allocation to Cache Rsp Packing b=
uffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x41",
...
>      },
>      {
>          "BriefDescription": "Number of Allocation to Mem Data Packing bu=
ffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x41",
...
>      },
>      {
>          "BriefDescription": "Number of Allocation to Mem Rxx Packing buf=
fer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x41",
...
>      },
>      {
>          "BriefDescription": "Number of cycles of Not Empty for Cache Dat=
a Packing buffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Number of cycles of Not Empty for Cache Req=
 Packing buffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Number of cycles of Not Empty for Cache Rsp=
 Packing buffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Number of cycles of Not Empty for Mem Data =
Packing buffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Number of cycles of Not Empty for Mem Rxx P=
acking buffer",
> +        "Counter": "4,5,6,7",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Number of Allocation to Cache Rsp1 Packing =
buffer",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x02",
...
>      },
>      {
>          "BriefDescription": "Number of Allocation to Cache Rsp0 Packing =
buffer",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x02",
...
>          "PerPkg": "1",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-interco=
nnect.json b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-interconn=
ect.json
> index 09d840c7da4c..ee023a574bd2 100644
> --- a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-interconnect.j=
son
> +++ b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-interconnect.j=
son
> @@ -1,6 +1,7 @@
>  [
>      {
>          "BriefDescription": "Total IRP occupancy of inbound read and wri=
te requests to coherent memory.",
> +        "Counter": "0,1",
>          "EventCode": "0x0f",
...
>      },
>      {
>          "BriefDescription": "Counts Timeouts - Set 0 : Cache Inserts of =
Atomic Transactions as Secondary",
> +        "Counter": "0,1",
>          "EventCode": "0x1e",
...
>      {
>          "BriefDescription": "Counts Timeouts - Set 0 : Cache Inserts of =
Read Transactions as Secondary",
> +        "Counter": "0,1",
>          "EventCode": "0x1e",
...
>      {
>          "BriefDescription": "Counts Timeouts - Set 0 : Cache Inserts of =
Write Transactions as Secondary",
> +        "Counter": "0,1",
>          "EventCode": "0x1e",
...
>      },
>      {
>          "BriefDescription": "Counts Timeouts - Set 0 : Fastpath Transfer=
...
>      },
>      {
>          "BriefDescription": "Counts Timeouts - Set 0 : Prefetch Ack Hint=
s From Primary to Secondary",
> +        "Counter": "0,1",
>          "EventCode": "0x1e",
...
>      },
>      {
>          "BriefDescription": "Counts Timeouts - Set 0 : Slow path fwpf di=
dn't find prefetch",
> +        "Counter": "0,1",
>          "EventCode": "0x1e",
...
>      },
>      {
>          "BriefDescription": "Misc Events - Set 1 : Slow Transfer of E Li=
ne",
> +        "Counter": "0,1",
>          "EventCode": "0x1f",
...
>      },
>      {
>          "BriefDescription": "Misc Events - Set 1 : Slow Transfer of I Li=
ne",
> +        "Counter": "0,1",
>          "EventCode": "0x1f",
...
>      },
>      {
>          "BriefDescription": "Misc Events - Set 1 : Slow Transfer of M Li=
ne",
> +        "Counter": "0,1",
>          "EventCode": "0x1f",
...
>      },
>      {
>          "BriefDescription": "Misc Events - Set 1 : Slow Transfer of S Li=
ne",
> +        "Counter": "0,1",
>          "EventCode": "0x1f",
...
>      },
>      {
>          "BriefDescription": "Responses to snoops of any type that hit M,=
 E, S or I line in the IIO",
> +        "Counter": "0,1",
>          "EventCode": "0x12",
...
>      },
>      {
>          "BriefDescription": "Responses to snoops of any type that hit E =
or S line in the IIO cache",
> +        "Counter": "0,1",
>          "EventCode": "0x12",
...
>      },
>      {
>          "BriefDescription": "Responses to snoops of any type that hit I =
line in the IIO cache",
> +        "Counter": "0,1",
>          "EventCode": "0x12",
...
>      },
>      {
>          "BriefDescription": "Responses to snoops of any type that miss t=
he IIO cache",
> +        "Counter": "0,1",
>          "EventCode": "0x12",
...
>      },
>      {
>          "BriefDescription": "Inbound write (fast path) requests received=
 by the IRP.",
> +        "Counter": "0,1",
>          "EventCode": "0x11",
...
>      {
>          "BriefDescription": "Cycles when direct to core mode, which bypa=
sses the CHA, was disabled : Non Cisgress",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x17",
>          "EventName": "UNC_M2M_DIRECT2CORE_NOT_TAKEN_DIRSTATE.NON_CISGRES=
S",
>          "PerPkg": "1",
> @@ -465,6 +523,7 @@
>      },
>      {
>          "BriefDescription": "Counts the time when FM didn't do d2c for f=
ill reads (cross tile case)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4a",
...
>      {
>          "BriefDescription": "Number of reads in which direct to core tra=
nsaction was overridden : Cisgress",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x18",
...
>      {
>          "BriefDescription": "Number of reads in which direct to core tra=
nsaction was overridden : 2LM Hit?",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x18",
...
>      },
>      {
>          "BriefDescription": "Number of times a direct to UPI transaction=
 was overridden.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1C",
...
>      },
>      {
>          "BriefDescription": "Cycles when Direct2UPI was Disabled : Cisgr=
ess D2U Ignored",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1A",
...
>      },
>      {
>          "BriefDescription": "Cycles when Direct2UPI was Disabled : Egres=
s Ignored D2U",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1A",
...
>      },
>      {
>          "BriefDescription": "Cycles when Direct2UPI was Disabled : Non C=
isgress D2U Ignored",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1A",
...
>      },
>      {
>          "BriefDescription": "Directory Miss : On NonDirty Line in A Stat=
e",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1e",
...
>      },
>      {
>          "BriefDescription": "Directory Miss : On NonDirty Line in I Stat=
e",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1e",
...
>      },
>      {
>          "BriefDescription": "Directory Miss : On NonDirty Line in L Stat=
e",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1e",
...
>      },
>      {
>          "BriefDescription": "Directory Miss : On NonDirty Line in S Stat=
e",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1e",
...
>      },
>      {
>          "BriefDescription": "Data Prefetches Dropped : UPI - All Channel=
s",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x58",
...
>      },
>      {
>          "BriefDescription": "UNC_M2M_PREFCAM_RxC_DEALLOCS.PMM_MEMMODE_AC=
CEPT",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x62",
...
>      },
>      {
>          "BriefDescription": "AD Ingress (from CMS) Occupancy - Prefetche=
s",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x60",
...
>      },
>      {
>          "BriefDescription": "AD Ingress (from CMS) : AD Ingress (from CM=
S) Allocations",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x02",
...
>      },
>      {
>          "BriefDescription": "M2M->iMC WPQ Cycles w/Credits - Special : C=
hannel 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x38",
...
>      },
>      {
>          "BriefDescription": "Write Tracker Non-Posted Inserts : Channel =
0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4d",
...
>      },
>      {
>          "BriefDescription": "Write Tracker Non-Posted Occupancy : Channe=
l 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4c",
...
>      },
>      {
>          "BriefDescription": "M2 BL Credits Empty : IIO0 and IIO1 share t=
he same ring destination. (1 VN0 credit only)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x23",
...
>      },
>      {
>          "BriefDescription": "M2 BL Credits Empty : All IIO targets for N=
CS are in single mask. ORs them together",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x23",
...
>      },
>      {
>          "BriefDescription": "M2 BL Credits Empty : Selected M2p BL NCS c=
redits",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x23",
...
>      },
>      {
>          "BriefDescription": "Ingress Queue Bypasses : AD to Slot 0 on BL=
 Arb",
> +        "Counter": "0,1,2",
>          "EventCode": "0x40",
...
>      },
>      {
>          "BriefDescription": "Ingress Queue Bypasses : AD to Slot 0 on Id=
le",
> +        "Counter": "0,1,2",
>          "EventCode": "0x40",
...
>      },
>      {
>          "BriefDescription": "VN0 message can't slot into flit : REQ on A=
D",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4e",
...
>      },
>      {
>          "BriefDescription": "VN0 message can't slot into flit : RSP on A=
D",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4e",
...
>      },
>      {
>          "BriefDescription": "VN0 message can't slot into flit : SNP on A=
D",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4e",
...
>      },
>      {
>          "BriefDescription": "VN0 message can't slot into flit : NCB on B=
L",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4e",
...
>      },
>      {
>          "BriefDescription": "VN0 message can't slot into flit : NCS on B=
L",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4e",
...
>      },
>      {
>          "BriefDescription": "VN0 message can't slot into flit : RSP on B=
L",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4e",
...
>      },
>      {
>          "BriefDescription": "VN1 message can't slot into flit : REQ on A=
D",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4f",
...
>      },
>      {
>          "BriefDescription": "VN1 message can't slot into flit : RSP on A=
D",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4f",
...
>      },
>      {
>          "BriefDescription": "VN1 message can't slot into flit : SNP on A=
D",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4f",
...
>      },
>      {
>          "BriefDescription": "VN1 message can't slot into flit : NCB on B=
L",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4f",
...
>      },
>      {
>          "BriefDescription": "VN1 message can't slot into flit : NCS on B=
L",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4f",
...
>      },
>      {
>          "BriefDescription": "VN1 message can't slot into flit : RSP on B=
L",
> +        "Counter": "0,1,2",
>          "EventCode": "0x4f",
...
>      },
>      {
>          "BriefDescription": "Number of allocations into the CRS Egress  =
used to queue up requests destined to the mesh (AD Bouncable)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      {
>          "BriefDescription": "Number of allocations into the CRS Egress  =
used to queue up requests destined to the mesh (AD credited)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      {
>          "BriefDescription": "Number of allocations into the CRS Egress  =
used to queue up requests destined to the mesh (AK)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      {
>          "BriefDescription": "Number of allocations into the CRS Egress  =
used to queue up requests destined to the mesh (AKC)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      {
>          "BriefDescription": "Number of allocations into the CRS Egress  =
used to queue up requests destined to the mesh (BL Bouncable)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      {
>          "BriefDescription": "Number of allocations into the CRS Egress  =
used to queue up requests destined to the mesh (BL credited)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      {
>          "BriefDescription": "Number of allocations into the CRS Egress  =
used to queue up requests destined to the mesh (IV)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      },
>      {
>          "BriefDescription": "Number of cycles incoming messages from the=
 vertical ring that are bounced at the SBO\r\nIngress (V-EMIB) (AD)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4B",
...
>      },
>      {
>          "BriefDescription": "Counts the number of cycles when the distre=
ss signals are asserted based on SBO Ingress threshold",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x15",
...
>      },
>      {
>          "BriefDescription": "UNC_UPI_M3_RXQ_BLOCKED.FLOWQ_AD_VNA_BTW_2_T=
HRESH",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x15",
...
>      },
>      {
>          "BriefDescription": "UNC_UPI_M3_RXQ_BLOCKED.FLOWQ_BL_VNA_BTW_0_T=
HRESH",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x15",
...
>      },
>      {
>          "BriefDescription": "Matches on Receive path of a UPI Port : Non=
-Coherent Bypass",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x05",
...
>      },
>      {
>          "BriefDescription": "Valid Flits Received : Slot NULL or LLCRD E=
mpty",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x03",
...
>      },
>      {
>          "BriefDescription": "Matches on Transmit path of a UPI Port : No=
n-Coherent Bypass",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x04",
...
>      {
>          "BriefDescription": "Matches on Transmit path of a UPI Port : No=
n-Coherent Bypass, Match Opcode",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x04",
...
>      {
>          "BriefDescription": "Matches on Transmit path of a UPI Port : No=
n-Coherent Standard, Match Opcode",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x04",
...
>          "PerPkg": "1",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-io.json=
 b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-io.json
> index 8b5f54fed103..caf82e7ba92b 100644
> --- a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-io.json
> +++ b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-io.json
> @@ -1,6 +1,7 @@
>  [
>      {
>          "BriefDescription": "Free running counter that increments for ev=
ery 32 bytes of data sent from the IO agent to the SOC",
> +        "Counter": "1",
>          "EventCode": "0xff",
...
>      },
>      {
>          "BriefDescription": "PCIe Completion Buffer Inserts of completio=
...
>      },
>      {
>          "BriefDescription": "Data requested by the CPU : Core reading fr=
om Cards MMIO space",
> +        "Counter": "2,3",
>          "EventCode": "0xc0",
...
>      },
>      {
>          "BriefDescription": "Data requested by the CPU : Core writing to=
 Cards MMIO space",
> +        "Counter": "2,3",
>          "EventCode": "0xc0",
...
>      },
>      {
>          "BriefDescription": "Data requested by the CPU : Another card (d=
ifferent IIO stack) reading from this card.",
> +        "Counter": "2,3",
>          "EventCode": "0xc0",
...
>      {
>          "BriefDescription": "Data requested by the CPU : Another card (d=
ifferent IIO stack) writing to this card.",
> +        "Counter": "2,3",
>          "EventCode": "0xc0",
...
>      },
>      {
>          "BriefDescription": "Data requested of the CPU : CmpD - device s=
ending completion to CPU request",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Read request for 4 bytes made by IIO Part0-=
7 to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Read request for 4 bytes made by IIO Part1 =
to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Read request for 4 bytes made by IIO Part2 =
to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Read request for 4 bytes made by IIO Part3 =
to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Data requested of the CPU : Card reading fr=
om DRAM",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Write request of 4 bytes made by IIO Part0-=
7 to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Write request of 4 bytes made by IIO Part1 =
to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Write request of 4 bytes made by IIO Part2 =
to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Write request of 4 bytes made by IIO Part3 =
to Memory",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Data requested of the CPU : Card writing to=
 DRAM",
> +        "Counter": "0,1",
>          "EventCode": "0x83",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests : Passing dat=
a to be written",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x86",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests : Issuing fin=
al read or write of line",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x86",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests : Processing =
response from IOMMU",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x86",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests : Issuing to =
IOMMU",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x86",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests : Request Own=
ership",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x86",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests : Writing lin=
e",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x86",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests granted : Pas=
sing data to be written",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x87",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests granted : Iss=
uing final read or write of line",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x87",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests granted : Pro=
cessing response from IOMMU",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x87",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests granted : Req=
uest Ownership",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x87",
...
>      },
>      {
>          "BriefDescription": "Incoming arbitration requests granted : Wri=
ting line",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x87",
...
>      },
>      {
>          "BriefDescription": "AND Mask/match for debug bus : !(Non-PCIE b=
us) and PCIE bus",
> +        "Counter": "0,1",
>          "EventCode": "0x02",
...
>      },
>      {
>          "BriefDescription": "OR Mask/match for debug bus : !(Non-PCIE bu=
s) and PCIE bus",
> +        "Counter": "0,1",
>          "EventCode": "0x03",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Abo=
rt",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Con=
fined P2P",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Loc=
al P2P",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Mul=
ti-cast",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Mem=
ory",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Msg=
B",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Rem=
ote P2P",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Num requests sent by PCIe - by target : Ubo=
x",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x8e",
...
>      },
>      {
>          "BriefDescription": "Outbound cacheline requests issued : 64B re=
quests issued to device",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd0",
...
>      },
>      {
>          "BriefDescription": "Outbound TLP (transaction layer packet) req=
uests issued : To device",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd1",
...
>      },
>      {
>          "BriefDescription": "PWT occupancy.  Does not include 9th bit of=
 occupancy (will undercount if PWT is greater than 255 per cycle).",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Request Ownership : Issuing final read or w=
rite of line",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x91",
...
>      },
>      {
>          "BriefDescription": "Request Ownership : Passing data to be writ=
ten",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x91",
...
>      },
>      {
>          "BriefDescription": "Processing response from IOMMU : Passing da=
ta to be written",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x92",
...
>      },
>      {
>          "BriefDescription": "Processing response from IOMMU : Issuing fi=
nal read or write of line",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x92",
...
>      },
>      {
>          "BriefDescription": "Processing response from IOMMU : Request Ow=
nership",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x92",
...
>      },
>      {
>          "BriefDescription": "Processing response from IOMMU : Writing li=
ne",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x92",
...
>      },
>      {
>          "BriefDescription": "PCIe Request - pass complete : Passing data=
 to be written",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x90",
...
>      },
>      {
>          "BriefDescription": "PCIe Request - pass complete : Issuing fina=
...
>      },
>      {
>          "BriefDescription": "PCIe Request - pass complete : Request Owne=
rship",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x90",
...
>      },
>      {
>          "BriefDescription": "Number Transactions requested by the CPU : =
Core reading from Cards MMIO space",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xc1",
...
>      {
>          "BriefDescription": "Number Transactions requested by the CPU : =
Core writing to Cards MMIO space",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xc1",
...
>      {
>          "BriefDescription": "Number Transactions requested by the CPU : =
Another card (different IIO stack) writing to this card.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xc1",
...
>      },
>      {
>          "BriefDescription": "Number Transactions requested of the CPU : =
CmpD - device sending completion to CPU request",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x84",
...
>      {
>          "BriefDescription": "Number Transactions requested of the CPU : =
Card writing to another Card (same or different stack)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x84",
...
>      },
>      {
>          "BriefDescription": "M2PCIe IIO Credits in Use : DRS to CMS Port=
 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x32",
...
>      },
>      {
>          "BriefDescription": "M2PCIe IIO Credits in Use : NCB to CMS Port=
 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x32",
...
>      },
>      {
>          "BriefDescription": "M2PCIe IIO Credits in Use : NCS to CMS Port=
 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x32",
...
>      },
>      {
>          "BriefDescription": "Local Dedicated P2P Credit Taken - 0 : M2IO=
SF0 - NCB",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x46",
...
>      },
>      {
>          "BriefDescription": "Local Dedicated P2P Credit Taken - 1 : M2IO=
SF4 - NCB",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x47",
...
>      },
>      {
>          "BriefDescription": "Local P2P Dedicated Credits Returned - 0 : =
M2IOSF0 - NCB",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x19",
...
>      },
>      {
>          "BriefDescription": "Local P2P Dedicated Credits Returned - 1 : =
M2IOSF4 - NCB",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1a",
...
>      },
>      {
>          "BriefDescription": "Local Shared P2P Credit Returned to credit =
ring : Agent0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x44",
...
>      },
>      {
>          "BriefDescription": "Waiting on Local Shared P2P Credit - 0 : M2=
IOSF0 - NCB",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4a",
...
>      },
>      {
>          "BriefDescription": "Waiting on Local Shared P2P Credit - 1 : M2=
IOSF4 - NCB",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4b",
...
>      },
>      {
>          "BriefDescription": "Remote Dedicated P2P Credit Taken - 0 : UPI=
0 - DRS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x48",
...
>      },
>      {
>          "BriefDescription": "Remote Dedicated P2P Credit Taken - 1 : UPI=
2 - DRS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x49",
...
>      },
>      {
>          "BriefDescription": "Remote P2P Dedicated Credits Returned : UPI=
0 - NCB",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1b",
...
>      },
>      {
>          "BriefDescription": "Remote Shared P2P Credit Returned to credit=
 ring : Agent0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x45",
...
>      },
>      {
>          "BriefDescription": "Remote Shared P2P Credit Taken - 0 : UPI0 -=
 DRS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Remote Shared P2P Credit Taken - 0 : UPI1 -=
 DRS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x42",
...
>      },
>      {
>          "BriefDescription": "Remote Shared P2P Credit Taken - 1 : UPI2 -=
 DRS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x43",
...
>      },
>      {
>          "BriefDescription": "Waiting on Remote Shared P2P Credit - 0 : U=
PI0 - DRS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4c",
...
>      },
>      {
>          "BriefDescription": "Waiting on Remote Shared P2P Credit - 1 : U=
PI2 - DRS",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x4d",
...
>          "FCMask": "0x00000000",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-memory.=
json b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-memory.json
> index 3ff9e9b722c8..20c064e818a9 100644
...
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x17",
>          "EventName": "UNC_M2HBM_DIRECT2CORE_NOT_TAKEN_DIRSTATE.NON_CISGR=
ESS",
>          "PerPkg": "1",
> @@ -32,6 +36,7 @@
>      },
...
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1A",
>          "EventName": "UNC_M2HBM_DIRECT2UPI_NOT_TAKEN_DIRSTATE.NON_CISGRE=
SS",
>          "FCMask": "0x00000000",
> @@ -104,6 +116,7 @@
>      },
...
>      },
>      {
>          "BriefDescription": "Count distress signalled on AkAd cmp messag=
e",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x67",
...
>      },
>      {
>          "BriefDescription": "Count distress signalled on NM fill write m=
essage",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x67",
...
>      },
>      {
>          "BriefDescription": "BL Ingress (from CMS) : BL Ingress (from CM=
S) Allocations",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x04",
...
>      },
>      {
>          "BriefDescription": "AD Egress (to CMS) : AD Egress (to CMS) All=
ocations",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x06",
...
>      },
>      {
>          "BriefDescription": "BL Egress (to CMS) : Inserts - CMS0 - Near =
Side",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x0E",
...
>      },
>      {
>          "BriefDescription": "BL Egress (to CMS) : Inserts - CMS1 - Far S=
ide",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x0E",
...
>      },
>      {
>          "BriefDescription": "BL Egress (to CMS) Occupancy : Common Mesh =
Stop - Near Side",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x0f",
...
>      },
>      {
>          "BriefDescription": "Activate due to read, write, underfill, or =
bypass",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x02",
...
>      },
>      {
>          "BriefDescription": "HBM Activate Count : Activate due to Read i=
n PCH0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x02",
...
>      },
>      {
>          "BriefDescription": "HBM Activate Count : Underfill Read transac=
tion on Page Empty or Page Miss",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x02",
...
>      },
>      {
>          "BriefDescription": "HBM Activate Count : Activate due to Write =
in PCH0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x02",
...
>      },
>      {
>          "BriefDescription": "Read CAS commands issued (regular and under=
fill)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x05",
...
>      },
>      {
>          "BriefDescription": "Regular read CAS commands issued (does not =
include underfills)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x05",
...
>      },
>      {
>          "BriefDescription": "HBM RD_CAS and WR_CAS Commands. : HBM WR_CA=
...
>      },
>      {
>          "BriefDescription": "Read CAS Command in Regular Mode (64B) in P=
seudochannel 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x06",
...
>      },
>      {
>          "BriefDescription": "Underfill Read CAS Command in Interleaved M=
ode (32B)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x06",
...
>      },
>      {
>          "BriefDescription": "Underfill Read CAS Command in Regular Mode =
(64B) in Pseudochannel 1",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x06",
...
>      },
>      {
>          "BriefDescription": "Write CAS Command in Regular Mode (64B) in =
Pseudochannel 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x06",
...
>      },
>      {
>          "BriefDescription": "HBM Precharge commands. : Precharges from P=
age Table",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x03",
...
>      },
>      {
>          "BriefDescription": "HBM Precharge commands. : Precharge due to =
read",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x03",
...
>      },
>      {
>          "BriefDescription": "Counts the number of cycles where the read =
buffer has greater than UMASK elements.  NOTE: Umask must be set to the max=
imum number of elements in the queue (24 entries for SPR).",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x19",
...
>      },
>      {
>          "BriefDescription": "Counts the number of inserts into the read =
buffer.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x17",
...
>      },
>      {
>          "BriefDescription": "Counts the number of elements in the read b=
uffer per cycle.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1a",
...
>      },
>      {
>          "BriefDescription": "DRAM RD_CAS and WR_CAS Commands. : Pseudo C=
hannel 0",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x05",
...
>      },
>      {
>          "BriefDescription": "All DRAM read CAS commands issued (includin=
g underfills)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x05",
...
>      },
>      {
>          "BriefDescription": "DRAM RD_CAS and WR_CAS Commands. : DRAM WR_=
CAS commands w/o auto-pre",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x05",
...
>      },
>      {
>          "BriefDescription": "Precharge due to read, write, underfill, or=
 PGT.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x03",
...
>      },
>      {
>          "BriefDescription": "DRAM Precharge commands. : Precharges from =
Page Table",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x03",
...
>      {
>          "BriefDescription": "Counts the number of cycles where the read =
buffer has greater than UMASK elements.  This includes reads to both DDR an=
d PMEM.  NOTE: Umask must be set to the maximum number of elements in the q=
ueue (24 entries for SPR).",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x19",
...
>      {
>          "BriefDescription": "Counts the number of inserts into the read =
buffer destined for DDR.  Does not count reads destined for PMEM.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x17",
...
>      },
>      {
>          "BriefDescription": "Counts the number of cycles where there's a=
t least one element in the read buffer.  This includes reads to both DDR an=
d PMEM.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x18",
...
>      {
>          "BriefDescription": "Counts the number of elements in the read b=
uffer, including reads to both DDR and PMEM.",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0x1a",
...
>      },
>      {
>          "BriefDescription": "Scoreboard Occupancy : Persistent Mem write=
s",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd5",
...
>      },
>      {
>          "BriefDescription": "Scoreboard Prefetch Occupancy : Persistent =
Mem",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xDB",
...
>      },
>      {
>          "BriefDescription": "Number of Scoreboard Requests Rejected : FM=
 requests rejected due to full address conflict",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd4",
...
>      },
>      {
>          "BriefDescription": "Number of Scoreboard Requests Rejected : NM=
 requests rejected due to set conflict",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd4",
...
>      },
>      {
>          "BriefDescription": "Number of Scoreboard Requests Rejected : Pa=
trol requests rejected due to set conflict",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd4",
...
>      },
>      {
>          "BriefDescription": "2LM Tag check hit in near memory cache (DDR=
4)",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd3",
...
>      },
>      {
>          "BriefDescription": "2LM Tag check miss, existing data may be ev=
icted to PMM",
> +        "Counter": "0,1,2,3",
>          "EventCode": "0xd3",
...
>          "FCMask": "0x00000000",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-power.j=
son b/tools/perf/pmu-events/arch/x86/sapphirerapids/uncore-power.json
> index 8948e85074f0..4d669afb121a 100644
...
>          "PerPkg": "1",
> diff --git a/tools/perf/pmu-events/arch/x86/sapphirerapids/virtual-memory=
json b/tools/perf/pmu-events/arch/x86/sapphirerapids/virtual-memory.json
...
>          "PublicDescription": "Counts completed page walks  (1G sizes) ca=

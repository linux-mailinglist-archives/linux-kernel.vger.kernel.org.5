...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E0AC280FAEE
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Dec 2023 00:03:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377951AbjLLXDN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Dec 2023 18:03:13 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36828 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235306AbjLLXDE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Dec 2023 18:03:04 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 99EEF124;
        Tue, 12 Dec 2023 15:02:55 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702422176; x=1733958176;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=hnVwZ4L+0SodxUr0NAI3zWQkKTtpdaS3jG5mL2jJo5Q=;
  b=Y0HXWgvSPBuU74fgtK/t8OifmhfiT3lNahn4GERqKrM9mgZ11o+40hQX
   /3N7j2CETLgTjK0Gd32wDbmD61iPVJRfP7QJsMUUyI9Aus/OJryYKailv
   aEOah0JoPEZo1G1MR4wNZlC+VCK8OMSfMAcZ6q21GGv9yjhs8dB5cgfgJ
   Pd1lzCjzijbvlxMWXt7hVMHfq/jd07DQFbywaHtysIf7xhkYW3F28IMcV
   w1tOAMPp+GhOuW2TvtJwZGi6qeaF1HHNPcVkxPprXe8G+KBWxbpUmIv3z
   PNqqM3zT9g/EhvbhVuCGuBDBpqPeEatArbdl+XR9T0B7UkCVJpoFGS9y3
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10922"; a="392055918"
X-IronPort-AV: E=Sophos;i="6.04,271,1695711600"; 
   d="scan'208";a="392055918"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Dec 2023 15:02:46 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10922"; a="864391972"
X-IronPort-AV: E=Sophos;i="6.04,271,1695711600"; 
   d="scan'208";a="864391972"
Received: from node-10329.jf.intel.com ([10.54.34.22])
  by FMSMGA003.fm.intel.com with ESMTP; 12 Dec 2023 15:02:44 -0800
...
Subject: [RFC PATCH v3 04/18] perf pmu-events: Add counter info into JSON files for SapphireRapids
Date:   Tue, 12 Dec 2023 15:02:10 -0800
Message-Id: <20231212230224.1473300-6-weilin.wang@intel.com>

Return-Path: <linux-kernel+bounces-56631-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 275C484CCFE
	for <lists+linux-kernel@lfdr.de>; Wed,  7 Feb 2024 15:40:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 32B7C1C249BB
	for <lists+linux-kernel@lfdr.de>; Wed,  7 Feb 2024 14:40:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4C91A7E77E;
...
Received: from mail-pl1-f173.google.com (mail-pl1-f173.google.com [209.85.214.173])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1547E7CF07
	for <linux-kernel@vger.kernel.org>; Wed,  7 Feb 2024 14:40:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707316812; cv=none; b=p3Vu8vxsaK+7fR4w3A7x2gKzsFIZwVmg8KRTKTKWy7yR9ArMTfCyWzsXWxV7Fm3Mr7RTo3cq9jATOIBzdd2IEHpntsyYwn5HtVwghuMFgAYlbryRD8p5WcwzXCefUwURUx5B5+duEG23ha0WoLQ5qZFdwaYx7fQMmnrKqZz+ayo=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=fastly.com; spf=pass smtp.mailfrom=fastly.com; dkim=pass (1024-bit key) header.d=fastly.com header.i=@fastly.com header.b=gwquoAEy; arc=none smtp.client-ip=209.85.214.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=fastly.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=fastly.com
Received: by mail-pl1-f173.google.com with SMTP id d9443c01a7336-1d72f71f222so6152445ad.1
        for <linux-kernel@vger.kernel.org>; Wed, 07 Feb 2024 06:40:10 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=BTy0TD/WzR5RIh6lZhgnOebUhLZ8bbC+FvuZI+ulvFU=;
        b=
X-Gm-Message-State: AOJu0YwJVytieBUKp4aEdw3emeZYqpgrNscoe8bGtN/ZBZRg1CT78Q9/
	xbdX5NyQB8ohcYKSZaixIg3o3+PFfgstLev1XdIzoZLxZUGJQZI8k8Ehkn3zOKE=

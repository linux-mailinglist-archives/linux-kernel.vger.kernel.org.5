Return-Path: <linux-kernel+bounces-74099-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3761B85CFF0
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 06:44:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 68FF21C22EB6
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 05:44:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1187E3A8D8;
...
Received: from out-188.mta0.migadu.com (out-188.mta0.migadu.com [91.218.175.188])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6BFF839FC3
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 05:43:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.188
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708494204; cv=none; b=qs+Q49YEpFaAHHuUWVXJi12MrFxeSj+6xj9M5VMW5Ajw8Q0mjdCZBDB3upFpcB5t2HqALTRB9z3kbWDFJ0S4c5tvDwSchgu2GZY/4UZuDHRMq+Y1aGtZfaall0lfmjLgmd+KnAedkP3JlskUQU926mVU6fzqdI0VjuGjKisWGO4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708494204; c=relaxed/simple;
	bh=ZmOXn9U2kRyvale593aVJAMMtGmI9I8PRxYMMaYh3Hg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=ifMRX4ODAoZtxcUU2iWz7LRJrQVYPwtOaYWbTFizoU0/f//1SE0FYJRYwJWIrWe3LyX7hk6kTytRZxqDt1NJi9k49U6xCOZWYDxE698Nt+UE/C28rX1tkJVHXvSYm1+piM9/2Na+A2WvPp0kgsz4r2qahIGjIcvXrLGfKeJKDy8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=fYgh58Q8; arc=none smtp.client-ip=91.218.175.188

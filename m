Return-Path: <linux-kernel+bounces-95076-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E8EE8748F7
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 08:45:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A21881C213EE
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 07:45:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D3AB3633E0;
	Thu,  7 Mar 2024 07:45:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b="NtyTkus7"
Received: from EUR04-DB3-obe.outbound.protection.outlook.com (mail-db3eur04on2071.outbound.protection.outlook.com [40.107.6.71])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BF54663117;
	Thu,  7 Mar 2024 07:45:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.6.71
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709797516; cv=fail; b=lJNqkYMJMgua4qUo3rKh+mhpmaB5ZXHQSVvvN44mVkf8rFWJx/FavynCXE0qktxIvXYy5mrlv3m1c80QLhnvD5l2quKqPATkPpnruflRkcldWCmhqF6KBD4nLa9sHOE9JpJMBDtF9bgv/H8kfkZZYMGuR9mmjrDmfzUfs06Vd/s=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709797516; c=relaxed/simple;
	bh=UdzpLy7t/M4jL8zY0CvNf54Yx25bprqtjbhvuOVzB7A=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 Content-Type:MIME-Version; b=QHxRsZbANODOJEFJ6l4dKYepBwKoMdEDyzdpLfomsh6Ed7tCOBZ/vbYAmAAyGE3age2JvlYp6wO6S+vEwUzyOygNnlevn92K3DVfWKZk2ssUxs/0cYaFiw+yorPUKnDdkcADXkK2JItCNMgUHGXcuX+4JZ6IPBJXyprscUsiGuc=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b=NtyTkus7; arc=fail smtp.client-ip=40.107.6.71

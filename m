Return-Path: <linux-kernel+bounces-37345-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A54EA83AE8E
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 17:42:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id CA6A01C22A89
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 16:42:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AFCC37E570;
	Wed, 24 Jan 2024 16:41:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="jveuhRfD"
Received: from NAM11-CO1-obe.outbound.protection.outlook.com (mail-co1nam11on2050.outbound.protection.outlook.com [40.107.220.50])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3B41E7E566
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 16:41:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.220.50
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706114516; cv=fail; b=uZu4XWedx5nAgwfy82aqmmE6N7wi3AGflJBdWRfuolN/weygEuAKf6VyATf12kAkPoJNE4sMcE+w0kxGnMzvjIJIqoj7hEOJJZmAOCfYGHQr5nvE+Uw0pk0t6mikYawn8OwgmVymOQ3vb9Aop2kvmjFje0wCAcD08huFOsPUQ7M=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706114516; c=relaxed/simple;
	bh=STgxnsEg1XaCTCMflo2pEgtriW8KJM5aM/z3RreCF9w=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=lgiPB5fJ0XkSpmZGcyASjSn7KPaTmnrkpI3rO6fiDzvUN6cp1z3vxdFXvq9mvOsAM6a6YAibRpjNOhoJ0Py1aYGFr+fHV06gsODtI4E4iXFNfl9ee+HqsWTNKTPpymUkKVPMs5FNTQHhMAKmpVpjoHi6f7kRuvbPJi35nsyCCK4=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=jveuhRfD; arc=fail smtp.client-ip=40.107.220.50
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 Jan 2024 16:41:52.0929
 (UTC)

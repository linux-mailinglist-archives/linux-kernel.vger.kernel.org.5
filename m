...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7EF3976CAD6
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Aug 2023 12:25:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233589AbjHBKZu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Aug 2023 06:25:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43170 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229664AbjHBKY5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Aug 2023 06:24:57 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EBE9A3581
        for <linux-kernel@vger.kernel.org>; Wed,  2 Aug 2023 03:22:42 -0700 (PDT)
Message-ID: <20230802101934.529871761@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1690971708;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=PHVw76eHVn9i5zyTYY9cldIsdDgruBt9pP2vpfcIs8M=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1690971708;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=PHVw76eHVn9i5zyTYY9cldIsdDgruBt9pP2vpfcIs8M=;
        b=CnzPbGuZKBbAUkjmYrcE54MO8vYV1BQba5ERzS2ubaiwKbHI/WLujMV6f+PIhp/KV6OI6h
        A+0u6a2wfJmziTAA==
...
Subject: [patch V3 32/40] x86/cpu: Use common topology code for AMD
References: <20230802101635.459108805@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Wed,  2 Aug 2023 12:21:47 +0200 (CEST)

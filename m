Return-Path: <linux-kernel+bounces-145234-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 611CF8A5138
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 15:26:30 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 93E90B23C1B
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 13:26:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 25D5580BFA;
	Mon, 15 Apr 2024 13:15:20 +0000 (UTC)
...
Received: from mail-wm1-f41.google.com (mail-wm1-f41.google.com [209.85.128.41])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5BF8573514
	for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 13:15:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713186919; cv=none; b=KCZIGLG9GGiIPF6OKomfH4P5xk0jMWV6ZsZp9E1dgHLBhDE3BU89GKzmkd/+eItS8qe1K5wybt01YiLqKjYhGgKbInmwfCSGzxPu37Oxi/imb80SdHsczYIv2hUf4dxfDL4D2w33Zbq/cftXH+wRLnMGb3Eqy9dCYnpS9+HTP0w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713186919; c=relaxed/simple;
	bh=wQu4AB/hrYeKhHh8iDIAICEBW2rABai55pnKGz7N32g=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=gDSyLbZLFbTCmsfLq08OKE7JabkE2LQhiZ/Io7AaNoCXKBY10YyP8SN3udXbuo8P6ZXq7nNVTp/l2Ls+6ZEuzvBbzu8aQZHyHssXp7ZB0I5FCz9tFJOD729fntH6axTMwhRoBgUiEnNUcucgxFdOPr9unXup7shma5C1Nm8arCY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ventanamicro.com; spf=pass smtp.mailfrom=ventanamicro.com; dkim=pass (2048-bit key) header.d=ventanamicro.com header.i=@ventanamicro.com header.b=bugntPOs; arc=none smtp.client-ip=209.85.128.41
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ventanamicro.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ventanamicro.com
Received: by mail-wm1-f41.google.com with SMTP id 5b1f17b1804b1-418671bac0aso3703205e9.1
        for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 06:15:16 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=hkfoH6pgevkYBCq40yfYP4WU2j0tmJHdJg6k4nyDGog=;
        b=
X-Gm-Message-State: AOJu0Yzd6c44Op1X+AwflluxGup3bkxujeC9E1NbjaRMQX1P53P/WVQM
	3yAQVfBtUDe3Qswl/zS0EXul1bWpA1fWNWSlTXPEpORur/zXJT/fgntZSn4tdWM=

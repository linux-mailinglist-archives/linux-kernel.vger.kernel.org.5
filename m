...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0CF3580FAF5
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Dec 2023 00:04:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232365AbjLLXEJ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Dec 2023 18:04:09 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43374 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377996AbjLLXDh (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Dec 2023 18:03:37 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0AC2FCE;
        Tue, 12 Dec 2023 15:03:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702422204; x=1733958204;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=/mreCn63iLKWynb3qZDzR2PmBkSu28+YLN6NZmj2X4Y=;
  b=UMiZWiLUlCtoUjX3xiLrD26aMWwGfq6vSTLR22Hb1xYNIRAdOKB0azAF
   viFlbzFDaVm8M5cOs+Ps5a946z0GzTTIpZAwHhW4wp2w2kEi380VcBUdV
   IPgpYle1W6NQXHfebVlfIi608BxblMKWtnLmNm5pVDgknGi0zZ0bw8Ong
   /mUmKv2pUD7GMnKF61IZMHOO7K+HvQYHf8HDjYH8Zj9CGH9nS87L4bvAr
   xNcU8zaxCz4d5VsM1oW5r+lbzBa2ea/j1NR0uiNSxBkMYypn4+/8l3nlx
   F0Z+3NsRpLOm6GxesPioZiIbCnWy6F+7kFF1H18dwvn+LYKvJrcx6Wfk9
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10922"; a="392055984"
X-IronPort-AV: E=Sophos;i="6.04,271,1695711600"; 
   d="scan'208";a="392055984"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Dec 2023 15:02:55 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10922"; a="864392016"
X-IronPort-AV: E=Sophos;i="6.04,271,1695711600"; 
   d="scan'208";a="864392016"
Received: from node-10329.jf.intel.com ([10.54.34.22])
  by FMSMGA003.fm.intel.com with ESMTP; 12 Dec 2023 15:02:53 -0800
...
Subject: [RFC PATCH v3 10/18] perf stat: Add build string function and topdown events handling in hardware-grouping
Date:   Tue, 12 Dec 2023 15:02:16 -0800
Message-Id: <20231212230224.1473300-12-weilin.wang@intel.com>

Return-Path: <linux-kernel+bounces-76017-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 1D1E185F1FC
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 08:41:37 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 7A684B22A11
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 07:41:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DDD271799B;
	Thu, 22 Feb 2024 07:41:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b="Lo9d4p+U"
Received: from fllv0015.ext.ti.com (fllv0015.ext.ti.com [198.47.19.141])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 53AEE125D7
	for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 07:41:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.47.19.141
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708587688; cv=none; b=JCZe0LP9xhmOdJ7ng4RB5d01Gu42puYDO4P1SMmMnMpUlOV63YyWrsP/HvCfOyLbdPj2lkdAwh33D73Xu0cHEiGt+aZcMooWe9MZ3ldUXlsCYIM9T/uXWP7zwOSYxnnhRUjo1sJtO1xvMEim/+x2NP8TArMpByyLDAFI1BitoeY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708587688; c=relaxed/simple;
	bh=FxwV+qnYFqWQVGNyWJ57X7Sx9rhrLP6HlfGC/Cl0+/M=;
	h=From:To:CC:Subject:Date:Message-ID:MIME-Version:Content-Type; b=OrewI3VrfeUDJgYw2YrWndDXb6i8Y4wHEFgOTqrzOg5iVp7ZdenWOLVtpPrCNgf7HbFHXmL7AGM+mbYJgoMMdkche32HP0owN5OY9aGoDkKgVEuRyTBXwnyu7rvvfcS9yRwzW7OLMueXz1jpZ6P5d4/Qggiy9P7hPGgeFhUob3U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ti.com; spf=pass smtp.mailfrom=ti.com; dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b=Lo9d4p+U; arc=none smtp.client-ip=198.47.19.141

Return-Path: <linux-kernel+bounces-31893-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 25067833603
	for <lists+linux-kernel@lfdr.de>; Sat, 20 Jan 2024 20:54:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 64D7A1F21DC9
	for <lists+linux-kernel@lfdr.de>; Sat, 20 Jan 2024 19:54:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9BA2F12E5F;
	Sat, 20 Jan 2024 19:54:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b="HTxTMiNH";
	dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b="TXDKCwef"
Received: from domac.alu.hr (domac.alu.unizg.hr [161.53.235.3])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8F4F71173C
	for <linux-kernel@vger.kernel.org>; Sat, 20 Jan 2024 19:54:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=161.53.235.3
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705780473; cv=none; b=dkCw+WP4UY7Kspg9J3bFgv6i/lrHvkBZ5Xdp7H4HiICFzOjcfLTcsnp+j1Ky7XWzpqe8IZQZfkXIl/6AQHP2hvmO4cS6AQXSefPE29SwOUH6MUosLnwZDDm5prj64YxnqjMv+Q6XkU+bz+FBGbyI6vev0hVd55e+TOgIAte7e7A=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705780473; c=relaxed/simple;
	bh=gcWwWqE3eGKOdoAM0D6d/YcXBD4NmyZhMgjcz8GV+Bg=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:Cc:References:
	 In-Reply-To:Content-Type; b=tZq5zPxQ0uhYDiyRQhrSNzEwa16ERULjwRQidVNZ6anB7FR8j7ntdZUK4jqv5/+75fSmnPN0a85XVE/qd0KeVRGn9uXHyPLsasKsI7WEF3LmDXpOJWQY7IBoXkipn7KbffoNaD9RSlWIl6x8+TqLAJb6LgPMV+hXd9mej2AyeHw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=alu.unizg.hr; spf=pass smtp.mailfrom=alu.unizg.hr; dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b=HTxTMiNH; dkim=pass (2048-bit key) header.d=alu.unizg.hr header.i=@alu.unizg.hr header.b=TXDKCwef; arc=none smtp.client-ip=161.53.235.3

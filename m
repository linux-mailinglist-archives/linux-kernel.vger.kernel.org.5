...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D80427FC236
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Nov 2023 19:16:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345776AbjK1OmG (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 28 Nov 2023 09:42:06 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60336 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344945AbjK1OmE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 28 Nov 2023 09:42:04 -0500
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1BE161B5
        for <linux-kernel@vger.kernel.org>; Tue, 28 Nov 2023 06:42:11 -0800 (PST)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 673A6C433C9;
        Tue, 28 Nov 2023 14:42:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1701182530;
        bh=CnNUQFoLrsurpjxvjJR+p8aYW5sAtq+wOxkuzT065+0=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Tue, 28 Nov 2023 15:42:08 +0100
...
Message-ID: <oho6bypbvr7rhveiqmosp3wmb7ptygcuuuq6v2jrsqugfuyfas@5czwntre4pc5>
References: <e239b94b-462a-41e5-9a4c-cd1ffd530d75@opensource.cirrus.com>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha512;
        protocol="application/pgp-signature"; boundary="5suw35aauyo64sus"
Content-Disposition: inline
In-Reply-To: <e239b94b-462a-41e5-9a4c-cd1ffd530d75@opensource.cirrus.com>
...
> tpm_tis_core(E) tpm(E) intel_pmc_core(E) acpi_pad(E) rng_core(E) acpi_tad=
(E)
...
> mmc_block(E) i915(E) drm_buddy(E) ttm(E) intel_gtt(E) drm_display_helper(=
E)
...
> 5c c3 cc cc cc cc 48 8b 37 48 89 fa 48 c7 c7 80 a6 a1 92 e8 64 2a 68 ff <=
0f>
...
> [   82.596587]  ? platform_device_devm_init+0x74/0xd0 [platform_device_te=
st]
...
https://lore.kernel.org/linux-kselftest/20231128101627.65399-1-marpagan@red=
hat.com/
...
iHUEABYKAB0WIQRcEzekXsqa64kGDp7j7w1vZxhRxQUCZWX8PwAKCRDj7w1vZxhR
xWdwAP0VcSmVrvNy2ms8Pe1WCBqlNDKMYAeKDVRNpiTeHjqzFgD/RXKcYlYZk113
cMGSq3Swmia4tWsB2G5M3c036Emb9QI=
=gXa/
-----END PGP SIGNATURE-----

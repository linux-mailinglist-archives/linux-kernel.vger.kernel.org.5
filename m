...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F36317634D8
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Jul 2023 13:26:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233691AbjGZL0j (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Jul 2023 07:26:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55518 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233349AbjGZL0W (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Jul 2023 07:26:22 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C817B2D4F
        for <linux-kernel@vger.kernel.org>; Wed, 26 Jul 2023 04:26:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1690370775; x=1721906775;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=u6tOBKsm/uXU7BoUumR+I8oYqyALBD5ClqwKPq9brOY=;
  b=hgREaxbwXY4i4FkxnWYIkZjd5j/JFxfED9rVj7S7jYil7dw0kYws82xO
   MkYFgYgGt77PVvHwbhGDCSkc6j0YESoph6SUY7cComhfW8z37/ZE50AEp
   ngupVe3zf8pxpp4mAfApI1u02dk3ZOoLotgrdHRye9zX37+OvkQmvj3+j
   il2doiI3r94Y/x3C+7IMWgt3a9rteV/l81ggCX4PBWWLfmrgoHN2vp+Vs
   aq+LZ3/+PlCKMEN951OKdzHCjNFlzdwRW68i86CgRZ303gDBPuCCpWAYs
   lDPYCQ+JloptV+vcih2HopNCCGzE1s8mkwutTj9BNTUCfgbUpPwIL0us8
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10782"; a="370664063"
X-IronPort-AV: E=Sophos;i="6.01,231,1684825200"; 
   d="scan'208";a="370664063"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Jul 2023 04:26:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10782"; a="791811047"
X-IronPort-AV: E=Sophos;i="6.01,231,1684825200"; 
   d="scan'208";a="791811047"
Received: from bterry-mobl2.amr.corp.intel.com (HELO khuang2-desk.gar.corp.intel.com) ([10.209.177.246])
  by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Jul 2023 04:26:07 -0700
...
Subject: [PATCH v3 06/12] x86/tdx: Extend TDX_MODULE_CALL to support more TDCALL/SEAMCALL leafs
Date:   Wed, 26 Jul 2023 23:25:08 +1200
Message-ID: <3d91bb67e17270d6df6c09308861961e04c13921.1690369495.git.kai.huang@intel.com>

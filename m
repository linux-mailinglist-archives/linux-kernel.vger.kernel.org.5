Return-Path: <linux-kernel+bounces-29993-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A68C83165D
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 11:04:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2F3A51F234C0
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 10:04:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D056D2033B;
	Thu, 18 Jan 2024 10:04:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=imgtec.com header.i=@imgtec.com header.b="kI6N06tN";
	dkim=pass (1024-bit key) header.d=IMGTecCRM.onmicrosoft.com header.i=@IMGTecCRM.onmicrosoft.com header.b="VZLLKGKm"
Received: from mx08-00376f01.pphosted.com (mx08-00376f01.pphosted.com [91.207.212.86])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F0A2C20305
	for <linux-kernel@vger.kernel.org>; Thu, 18 Jan 2024 10:04:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=91.207.212.86
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705572250; cv=fail; b=gRVpDfOan7v6bKSlWF3A+pB+PtIxiDPutGrNjcsrh6eYZgXlHStiGWOuIGlE04wGey16Qz4nmEtyaROROWkwZeM9QIt/81t3+szKx4MjJC9PEb4S9uiC/S1x2ztADobs8stW7EL0rXvrTPfweSIBJqHF1LZ7xVaw7dXmPhVC6cw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705572250; c=relaxed/simple;
	...
	h=Received:DKIM-Signature:Received:Received:Received:
	 ...
	 X-EXCLAIMER-MD-CONFIG:X-Proofpoint-ORIG-GUID:X-Proofpoint-GUID; b=WKFL1aFBUKnvnOURb6C39s6/aeWjagXiHAjQfMBFQXuGSKjsyhMAXbP2pEHaQgy8pUwuWvYbtE2xFevQ+TPLwNktrB6z000gFhAOmNRzZ7poJK3pTyEsnVxO4uvxtN+mMLqxHOfS3bFYS5/9CQs6uOsXZ8DoVNzHpAj0PqBCYh4=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=imgtec.com; spf=pass smtp.mailfrom=imgtec.com; dkim=pass (2048-bit key) header.d=imgtec.com header.i=@imgtec.com header.b=kI6N06tN; dkim=pass (1024-bit key) header.d=IMGTecCRM.onmicrosoft.com header.i=@IMGTecCRM.onmicrosoft.com header.b=VZLLKGKm; arc=fail smtp.client-ip=91.207.212.86
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=imgtec.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=imgtec.com
Received: from pps.filterd (m0168888.ppops.net [127.0.0.1])
	by mx08-00376f01.pphosted.com (8.17.1.24/8.17.1.24) with ESMTP id 40I8Z2Xt016671;
	Thu, 18 Jan 2024 09:39:03 GMT
...
Received: from CWXP265MB3397.GBRP265.PROD.OUTLOOK.COM (2603:10a6:400:e7::8) by
 LO3P265MB2233.GBRP265.PROD.OUTLOOK.COM (2603:10a6:600:103::11) with Microsoft
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:CWXP265MB3397.GBRP265.PROD.OUTLOOK.COM;PTR:;CAT:NONE;SFS:(13230031)(346002)(136003)(396003)(376002)(366004)(39850400004)(230922051799003)(230173577357003)(230273577357003)(451199024)(186009)(64100799003)(1800799012)(26005)(83380400001)(122000001)(99936003)(38070700009)(31696002)(86362001)(36756003)(38100700002)(41300700001)(6916009)(66556008)(64756008)(76116006)(91956017)(66446008)(316002)(66946007)(54906003)(5660300002)(2906002)(8936002)(8676002)(4326008)(66476007)(31686004)(53546011)(2616005)(6512007)(478600001)(71200400001)(6506007)(6486002)(45980500001);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 18 Jan 2024 09:38:59.0405
 (UTC)

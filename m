Return-Path: <linux-kernel+bounces-98537-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A5361877BA6
	for <lists+linux-kernel@lfdr.de>; Mon, 11 Mar 2024 09:23:57 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 23D6EB20CF7
	for <lists+linux-kernel@lfdr.de>; Mon, 11 Mar 2024 08:23:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3034711720;
	Mon, 11 Mar 2024 08:23:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b="BYX4XobY"
Received: from EUR05-VI1-obe.outbound.protection.outlook.com (mail-vi1eur05on2052.outbound.protection.outlook.com [40.107.21.52])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2718A8830;
	Mon, 11 Mar 2024 08:23:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.21.52
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710145427; cv=fail; b=HGQLdRcVaQjQMLvnHHucvV6lSjWPioqAooKYR92n9sesBGwQW2btt27npoIDyJs85Fl6MPwyiTl7WaaHlANlFqvoHbicvI5tk0jvTTJnaqjzcxIcZszLF6HUVq/jH87+Sl7da1r19pCKRE64iDUJAgGnwd4ReDvpu5nbMGF0pwo=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710145427; c=relaxed/simple;
	bh=zIlDBxCVJ5lrNVPcrAs5DO1S5H3vHOXCmX0OHB2/BEM=;
	h=From:To:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=hGfOxqs55R4PEyimH1MqPrzmPK7bGxU1Y+iVaco3xoYa8QGq87WO9CCRV4Af71ZTZetkV5MAzgZSUQFebv2QHMdlfHGGavQfdELXKZWGYdOKmhM4FUi2nbaMXZ60+mw3tPIOaMduF0IjVpoff5yWzk1iQl6LmlYwyVN75fdi5+4=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b=BYX4XobY; arc=fail smtp.client-ip=40.107.21.52

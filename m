...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C1CE57888BD
	for <lists+linux-kernel@lfdr.de>; Fri, 25 Aug 2023 15:34:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245213AbjHYNde (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 25 Aug 2023 09:33:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58066 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S245112AbjHYNdW (ORCPT
...
Received: from icts-p-cavuit-4.kulnet.kuleuven.be (icts-p-cavuit-4.kulnet.kuleuven.be [IPv6:2a02:2c40:0:c0::25:134])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A88E02127;
        Fri, 25 Aug 2023 06:33:20 -0700 (PDT)
X-KULeuven-Envelope-From: jo.vanbulck@cs.kuleuven.be
X-Spam-Status: No, score=-2.0 required=5.0 tests=BAYES_00,DKIM_SIGNED,
        DKIM_VALID,DKIM_VALID_AU,RCVD_IN_DNSWL_BLOCKED,SPF_HELO_NONE,SPF_PASS
        autolearn=ham autolearn_force=no version=3.4.6
X-KULeuven-Scanned: Found to be clean
X-KULeuven-ID: 4FBAB113.AF756
...
Received: from icts-p-ceifnet-smtps-0.kuleuven.be (icts-p-ceifnet-smtps.service.icts.svcd [IPv6:2a02:2c40:0:51:144:242:ac11:2f])
        by icts-p-cavuit-4.kulnet.kuleuven.be (Postfix) with ESMTP id 4FBAB113;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=cs.kuleuven.be;
        s=cav; t=1692970398;
        bh=tuF76FSnilif4UtpsYL1IEdOWJgXPKQsBVW8XMWsRSE=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References;
        b=NxiQPhgqSnyWVsQRjp1bdin2Syo3VJOp39MiNb1N8JZHova5FgGbNjX81F2W52UcJ
         72RbBqDxcTh+ogHkUiZmP0Dzm3WqQ3GE1gui0GOsx0/8rowBcyRpar9FIzopswaaZ0
         TWwK0fE+BbXmrEVkZ0DNbmv3q9OFjiKUdlvbdCDo=
Received: from localhost.localdomain (ptr-82s0fs8e775rpuqrs36.18120a2.ip6.access.telenet.be [IPv6:2a02:1811:d31:8b00:b56b:371:2317:a8f2])
        ...
        by icts-p-ceifnet-smtps-0.kuleuven.be (Postfix) with ESMTPSA id 14931D4EBEF26;
        Fri, 25 Aug 2023 15:33:18 +0200 (CEST)
...
Subject: [PATCH v4 09/13] selftests/sgx: Specify freestanding environment for enclave compilation
Date:   Fri, 25 Aug 2023 15:32:48 +0200
Message-Id: <20230825133252.9056-10-jo.vanbulck@cs.kuleuven.be>

Return-Path: <linux-kernel+bounces-132128-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 86FCF898FFD
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 23:19:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id F4224B23FC1
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 21:19:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F3BFE13BADA;
	Thu,  4 Apr 2024 21:19:24 +0000 (UTC)
Received: from mail-il1-f197.google.com (mail-il1-f197.google.com [209.85.166.197])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 91C5413AA4D
	for <linux-kernel@vger.kernel.org>; Thu,  4 Apr 2024 21:19:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.197
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712265564; cv=none; b=oSOYswDKOn80vKWSOV8ARabAuHiznkBdaVLLFDoVDdp0bYxQzriLSo7a+Qd/scwCQXFJPR5ga2uyJK3k8d1Na4gzTp7LS9qty/Y5SRViZ6MWjD5NJQ1sN4J7WV1ba+YZnIJahDlHbR9IQEaXEvyExktm9eFhcqBglO9/9xz3P38=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712265564; c=relaxed/simple;
	bh=4gFKZJsZkOva5xsvIHI7fyp7h0DEuI0hQrqWNykS+24=;
	h=MIME-Version:Date:Message-ID:Subject:From:To:Content-Type; b=hNpH69O0Y8Int7+vP3svR3wS3S72oUe1UHOPN3P5BXkoRAl73MSNd7g8IxHgYna+BMiu5Wt9z2Dwr83G48YqYOjpWM6k7d9kp2oxqPXwkyzNJn4oraXAgmkCZjvqOmhTEu8B+LQAB+EX1zVk9Tz3KGhq7L1LFus18uYNhJjZ4KQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=fail (p=none dis=none) header.from=syzkaller.appspotmail.com; spf=pass smtp.mailfrom=M3KW2WVRGUFZ5GODRSRYTGD7.apphosting.bounces.google.com; arc=none smtp.client-ip=209.85.166.197
Authentication-Results: smtp.subspace.kernel.org; dmarc=fail (p=none dis=none) header.from=syzkaller.appspotmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=M3KW2WVRGUFZ5GODRSRYTGD7.apphosting.bounces.google.com
Received: by mail-il1-f197.google.com with SMTP id e9e14a558f8ab-369f9e8863dso12379275ab.3
        for <linux-kernel@vger.kernel.org>; Thu, 04 Apr 2024 14:19:22 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1712265562; x=1712870362;
        h=to:from:subject:message-id:date:mime-version:x-gm-message-state
         :from:to:cc:subject:date:message-id:reply-to;
        bh=lmuL5umgLBhd+rm0dXh3QIj4ggH/x0UfN42sBdpvmi8=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWASoUhwmbU6rsZGB7F33zZG6Oeo24ezcmyjx9S1qrENa8ecmAz2FSn51X9qPVKfzlSQodGgVbHE8es9Mcx7Uos1XbiCofCo8sfGlOW
X-Gm-Message-State: AOJu0YyseIuTVmfM7bJDNKRsgXj+LSMTws3wbaCQHfWOt4P3ssocGC3P
	soKTihuDMAFIamSPMMRaLpwPq5DoyYmP+0mEB4Kzuq6bmc5hd05R3RQAxBFxH3zWSMhsdnPSUpq
	k/52piDU/D6jbB3kWeHR6CCfYcrEjnhkgos9vLJiXVt/KOnZ7aVfszQw=
X-Google-Smtp-Source: AGHT+IFpWi12crOHRPanJuUOTFP7XpK1ck2Kei6mG934s1CzWQFVtEGzAkuCCdpWGi8AsF58g8s4w5KmXmAJ46DlEo3LlAXWndnF
Precedence: bulk
...
MIME-Version: 1.0
X-Received: by 2002:a05:6e02:368b:b0:369:f7ca:a358 with SMTP id
 cj11-20020a056e02368b00b00369f7caa358mr31937ilb.0.1712265561814; Thu, 04 Apr
 2024 14:19:21 -0700 (PDT)
Date: Thu, 04 Apr 2024 14:19:21 -0700
X-Google-Appengine-App-Id: s~syzkaller
X-Google-Appengine-App-Id-Alias: syzkaller
Message-ID: <00000000000092c8da06154be4f5@google.com>
Subject: [syzbot] [bpf?] KASAN: slab-use-after-free Read in bpf_link_free

Return-Path: <linux-kernel+bounces-49264-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id EB9358467ED
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 07:22:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id BC2D51C24729
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 06:22:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DAFC2495F0;
	Fri,  2 Feb 2024 06:16:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="EFhAhJvb"
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4D8A0482FB
	for <linux-kernel@vger.kernel.org>; Fri,  2 Feb 2024 06:16:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706854609; cv=none; b=nTdS38u5Me1WyysVVZ11t+TJOP/V7uZoI9bYzjLnJCYCTyimDJHz+oM0upgU6zVRoAtrxcZi9JDh3Cnp3ZiUBc7B7UihMDlGtFqc4PzhA5qgLTyvOZGP3NotEqnZAhqw5ICDnyU5gnDnUgn9knvn2qRGrIfUwZZONq/FGnjJ77Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706854609; c=relaxed/simple;
	bh=HOI+PCvurIoV95iofH/JcCQBNH1Kc01Nopt36MsxP50=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=pg7DOVOAh/w9WsmDG85xRaRHa8ArauNX1YRnSW9mgtuwZNXhhXQ0sEZl+OX1DqdDn4mZ1tBEYt/UJZhElM/G4t8QTF7gcYETSv109F/NkbtC+cRFkrfqq3qNWL2hNw0a0IfjrLQZx360S3/LHhFVk+wsppixjLHUkAwX2spnm7k=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=EFhAhJvb; arc=none smtp.client-ip=209.85.219.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-dc657e9bdc4so2429688276.0
        for <linux-kernel@vger.kernel.org>; Thu, 01 Feb 2024 22:16:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1706854600; x=1707459400; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=tIealv889NAxEr2xYCNET8sEiiz1VeDDnePfK9F0VE4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706854600; x=1707459400;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=tIealv889NAxEr2xYCNET8sEiiz1VeDDnePfK9F0VE4=;
        b=
X-Gm-Message-State: AOJu0YzEyRMaAIGCNiff0E7m7ZVOLWW1LDhVRR8ne5O6fXcpUGhoo0Et
	7dkAdzArCjOW7s0SL1cViXQXpOq6DabLijT/iPCp6I31VGYCFOCkRWhTcg9LgtHWvkwr9K6Lo1a
	aT8DbqA==
X-Google-Smtp-Source: AGHT+IFahvYBI9NuxgZudpe/2ABy9bzKe4HKGuWDu7gDRfTNEq9rg1tftbDpMMnxayVHX+jZYyPCXUStvgRd
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:a85f:db1d:a66b:7f53])
 (user=irogers job=sendgmr) by 2002:a05:6902:2187:b0:dc6:e20f:80cb with SMTP
 id dl7-20020a056902218700b00dc6e20f80cbmr68377ybb.3.1706854600245; Thu, 01
 Feb 2024 22:16:40 -0800 (PST)
Date: Thu,  1 Feb 2024 22:15:30 -0800
In-Reply-To: <20240202061532.1939474-1-irogers@google.com>
Message-Id: <20240202061532.1939474-24-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v8 23/25] perf dso: Add reference count checking and accessor functions
...
index 590dff09899c..dbe2d5a25eea 100644
...
index 03cf45088fd8..ba2fddc30c7c 100644
...
index d5db1f284dad..a00d41da572d 100644
...
+	if (dso && dso__kernel(dso)) {
 		...
 		if (kmap)
@@ -760,7 +760,7 @@ static int __maps__fixup_overlap_and_insert(struct maps *maps, struct map *new)
...
+				dso__name(map__dso(new)));
 			...
 			map__fprintf(new, fp);
@@ -981,7 +981,7 @@ static int map__strcmp_name(const void *name, const void *b)
 {
...
@@ -1000,7 +1000,7 @@ struct map *maps__find_by_name(struct maps *maps, const char *name)
...
@@ -1037,7 +1037,7 @@ struct map *maps__find_by_name(struct maps *maps, const char *name)

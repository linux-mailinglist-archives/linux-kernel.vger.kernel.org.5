...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4CAEC7E05A4
	for <lists+linux-kernel@lfdr.de>; Fri,  3 Nov 2023 16:35:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233653AbjKCPfu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 3 Nov 2023 11:35:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53868 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230110AbjKCPfs (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 3 Nov 2023 11:35:48 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D414D112
        for <linux-kernel@vger.kernel.org>; Fri,  3 Nov 2023 08:34:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1699025698;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=6I+svjCQClpGsA/iiv76PtiyM5cXX4stVU2i+dbhzLc=;
        b=Qe2S4w54iBeSL1IO1YE0opxpaYw+IekDen0HtFTCJqKvJbuNNQDcVvfw8FqnC0aKc7+EZN
        zt+vAvCF+aAPFetzqP+p1holaqckcLFkjTEXUGgPP7I5p+bQvVoES3sfA5tnSHVGq+L5CP
        nOXJhyxt5OVlrwTx4cqYek6eAvJM5sc=
Received: from mail-ej1-f70.google.com (mail-ej1-f70.google.com
 [209.85.218.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-73-0VydoCMTNK62x7U9OHxnZQ-1; Fri, 03 Nov 2023 11:34:57 -0400
X-MC-Unique: 0VydoCMTNK62x7U9OHxnZQ-1
Received: by mail-ej1-f70.google.com with SMTP id a640c23a62f3a-9dd58f58281so37661866b.0
        for <linux-kernel@vger.kernel.org>; Fri, 03 Nov 2023 08:34:57 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:from:references
         ...
         :reply-to;
        bh=6I+svjCQClpGsA/iiv76PtiyM5cXX4stVU2i+dbhzLc=;
        b=
X-Gm-Message-State: AOJu0Yz0IfmpXL5cUklygYaqaOA0SUCuQ3zN/UgF9WK2g2d9RK2QqGzf
        cS88eXypRhLydclcTO4jLxb2fay+WsuFrH1eEsS/cEYGvrDhg/IYyamgE+ShT6KJ2bI3IJoOGA9
        D/EX4wRBHtF3qpZQCzoxfXmlJ
X-Received: by 2002:a17:907:70b:b0:9d2:20ee:b18b with SMTP id xb11-20020a170907070b00b009d220eeb18bmr7011271ejb.42.1699025696194;
...
X-Received: by 2002:a17:907:70b:b0:9d2:20ee:b18b with SMTP id xb11-20020a170907070b00b009d220eeb18bmr7011213ejb.42.1699025695692;
        Fri, 03 Nov 2023 08:34:55 -0700 (PDT)
Received: from ?IPV6:2a02:810d:4b3f:de9c:abf:b8ff:feee:998b? ([2a02:810d:4b3f:de9c:abf:b8ff:feee:998b])
        by smtp.gmail.com with ESMTPSA id o11-20020a1709062e8b00b0099ce025f8ccsm1022109eji.186.2023.11.03.08.34.54

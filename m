...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1C1E97F9386
	for <lists+linux-kernel@lfdr.de>; Sun, 26 Nov 2023 16:47:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231955AbjKZPrb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 26 Nov 2023 10:47:31 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55036 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231899AbjKZPrR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 26 Nov 2023 10:47:17 -0500
Received: from mail-lf1-x12d.google.com (mail-lf1-x12d.google.com [IPv6:2a00:1450:4864:20::12d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D59AD1733
        for <linux-kernel@vger.kernel.org>; Sun, 26 Nov 2023 07:46:51 -0800 (PST)
Received: by mail-lf1-x12d.google.com with SMTP id 2adb3069b0e04-507a0907896so4476030e87.2
        for <linux-kernel@vger.kernel.org>; Sun, 26 Nov 2023 07:46:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=amarulasolutions.com; s=google; t=1701013610; x=1701618410; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=cIMMz8wLJivOaa5nAUHEwRejpQ5B3CKhmLwaInr1cws=;
        b=IkttUpP5VgzE4LFaiMXZZwYM0PS1wHGfZbMCnEzgSrn5N1YK/iyU/fWD+C/uST9a2F
         /E5n8eyxaH6j9cE5b7x7yNc8ODbDxUESEvR+n92oulRTMPPnFTzZq9MSgJfaIvTjtRw0
         OUGWhsEDfC+meESVfYDXrYgMCLbkh4DkdbXxU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=cIMMz8wLJivOaa5nAUHEwRejpQ5B3CKhmLwaInr1cws=;
        b=
X-Gm-Message-State: AOJu0Yy3AbCumcG2LhbbPkuuHQ9ZjwTVN5kOQwM3akbpzBrDNqPnx2ug
        j04cct29E4ebjqCrUXJsMQqXBiRg3xhp/v69vkg6+w==
X-Google-Smtp-Source: AGHT+IHxesyAIVg+EAF8XpEyn/RgLgoK8+w6eolRbUcPBOBOC/aBM0VcxGfVuYHr9oWC8ve7u5so+Q==
X-Received: by 2002:ac2:4424:0:b0:509:e5a3:ef49 with SMTP id w4-20020ac24424000000b00509e5a3ef49mr6156178lfl.18.1701013609648;
...
Received: from dario-ThinkPad-T14s-Gen-2i.homenet.telecomitalia.it (host-95-244-100-54.retail.telecomitalia.it. [95.244.100.54])
        by smtp.gmail.com with ESMTPSA id h24-20020a170906591800b009fdc684a79esm4656158ejq.124.2023.11.26.07.46.48

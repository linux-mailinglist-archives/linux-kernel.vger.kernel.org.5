Return-Path: <linux-kernel+bounces-76697-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 0212D85FB22
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 15:24:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 573DAB23BE0
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 14:24:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A49B21474C1;
...
Received: from mail-io1-f51.google.com (mail-io1-f51.google.com [209.85.166.51])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2BB3F4776E
	for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 14:23:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708611806; cv=none; b=Ac0brq61jxp6e/qSdisJ71jtFqNY9Fwd1Z1eUTqQICs8v542Exx9yLogxM6rgddxSAhPOd1uJCEM1GOsuCgYWmkNuSwd8TGcKn6qBato+hdnJAlX4qmMq61BBbAZv4eh4mRJComDw3tKq/8Y/MWUYLgYjRBbL/GwPm7moeT43+0=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org; spf=pass smtp.mailfrom=linuxfoundation.org; dkim=pass (1024-bit key) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.b=Tq6RPqfI; arc=none smtp.client-ip=209.85.166.51
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linuxfoundation.org
Received: by mail-io1-f51.google.com with SMTP id ca18e2360f4ac-7c00a2cbcf6so61710239f.1
        for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 06:23:24 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=VHaXxIxgBTJmgtue73WVl6b/Cy0dVFZjoWVjGUpCh3I=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX7yupGBZ56NtetFS9upZeSs/ob2psxYtSuPByI66ioJMeTzxiawmcvB5pjE5yh07YrRxLQ0n/sWeHIfT79wKRPIJDmbk9Q+Gg+RZrb
X-Gm-Message-State: AOJu0Yz/02qjuyVYKw7Y31RnqfpuQMYTskHhDpw4Y4V4NHg5H8ZgPwxC
	BAo3mP5KXiHCR1YbHa0BEplS0pe6usSoC66/u0K0PdIa7GuSneXrS7aiX7LzNK8=

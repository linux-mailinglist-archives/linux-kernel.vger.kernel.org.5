Return-Path: <linux-kernel+bounces-76397-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EC0B85F6A5
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 12:20:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id BA0612823E5
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 11:20:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 08CFA42078;
	Thu, 22 Feb 2024 11:20:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Rwzsn6Jb"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4A8C63E49E
	for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 11:20:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708600838; cv=none; b=mjTQLfada6kIqy3Lrs46R2ZaOkyjRQcuZGjW1+9jY/yRxtuZGmLvzudhJilSecyb0PNnOGtCBe9mpBbHgAunxBiRmVmShF2NwpXKzl0ev100lissukc/QKJYapTzw5gYXbpnh2L5Gn59F3krg0jrtZJNgCsmd+Jy9syyzAee3bo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708600838; c=relaxed/simple;
	bh=uOxzPBYt/P48bNbB+8JM7JJxg6nLL3TYmXadjeE9yqo=;
	h=From:To:cc:Subject:MIME-Version:Content-Type:Date:Message-ID; b=KqE2BTKcDH5vXaVyVto53BDGr1UmdpbM8+Qqh4pBsV0foC1hrGgzC/Q0xYyn0YLOvHboydwKY0vaRGFhmj4DSZn7QtVzKmN2JzEbdr1Gjl+uDfShQfKIngSNqZE93rriLNjR9Ft730WtfCW8ZC0PPuL+WuGkU24oZJGyef8khJE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Rwzsn6Jb; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1708600834;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding;
	bh=LPoBMnsb3gS4Rs9L9OAxvvlN8RkZUtTPsWd7Jd+IW8k=;
	b=Rwzsn6Jb2C5O/Cj0X6kvoZPDSW86VMKed4elz1yReEhKeBDjcUNdGNrJovdkRZZPefvzM5
	VgkNDSueiPfJzJSFud/btsY2b5CCIG+khS6oGLTufKGvR2iLWpS8Es9diJ8+ZNYcPJLBov
	EjvNPxUN81F7F/gnwevffNZI/nM+nCw=

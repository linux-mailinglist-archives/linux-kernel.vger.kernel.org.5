Return-Path: <linux-kernel+bounces-136765-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 8C96289D7EC
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 13:34:08 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 43D89288F6C
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 11:34:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F12CB130E52;
	Tue,  9 Apr 2024 11:30:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="nr9rFbGr"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C4EDF12FF69
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 11:30:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.9
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712662238; cv=none; b=l94pEzSVBOSruSQMbz8JqI0qgWvS3wt8n3I68pts/ZHcu43U/BGrA/asI9jlBG/Cek6k+2quK3XLyb7ycw28wJZ5vVP4Bfa0ioq0WqpoSAFSeZk+U3wET+3MwQKtv3PoSPLepFjvnOo5n8aV8ofnM2o7UMhNWl/hjn3rMdhpCAs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712662238; c=relaxed/simple;
	bh=lXGbLbEIageAkOMzvWvUo5IHEMvretwLD8L0BXZCbGQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=QJntXHdCaIM75rC3+l1K7GJ9AcnzyMB7zHKgOz+7YpoOobXpZ0JGPiUN/KRs1Tr7Aj8BE9F2xMNTyi/D8VaU2zLlQ1ETBwrz/Qou3uGONyATCH6724AsMtNCWUrSCGPyhTsBNLfw1gXItY8tk09rmVLs/ZXY98m15+Qhv/soceA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com; spf=none smtp.helo=mgamail.intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=nr9rFbGr; arc=none smtp.client-ip=198.175.65.9
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=lXGbLbEIageAkOMzvWvUo5IHEMvretwLD8L0BXZCbGQ=;
  b=nr9rFbGrdl4T5dCZRd4En1UyzC8Z7RGMO0mugbB2tUD6SNIDqPQbMwjH
   fMh1KsHHV62BhSXzAU/9LCGxduZ9O/3B10mfjRHiBXzUPqLpXRLwOlwrs
   cPfjgIgHxi+2kwLswLa6paQHFnjdmo2hZ1GLtORKtt2u+MARpOPH+vpO9
   3ZSuvxVXQHJ7Txw+3Zx7GlQsmqwEXCZy12qYpJz1cdReRD/zhVa8Owljv
   l7JN/sL4J/da37L6DFSA4twHZ8IkGXUlIdF+zUNcC3OYYaAxG7qJe5MgF
   Dzfb3zHIaX7osFabJeLcTieUlC9GF66HCeAbUSn04Br1UZRCN9rClZc6q
   A==;
X-CSE-ConnectionGUID: BTxS2vEFS2iTSLIxfc+Edw==
X-CSE-MsgGUID: oDXlH7JtSiaTB/uLBU3rSQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11038"; a="30460493"
X-IronPort-AV: E=Sophos;i="6.07,189,1708416000"; 
   d="scan'208";a="30460493"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Apr 2024 04:30:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,11038"; a="937093357"
X-IronPort-AV: E=Sophos;i="6.07,189,1708416000"; 
   d="scan'208";a="937093357"
Received: from black.fi.intel.com ([10.237.72.28])
  by fmsmga001.fm.intel.com with ESMTP; 09 Apr 2024 04:30:29 -0700
Received: by black.fi.intel.com (Postfix, from userid 1000)
	id 545DC160A; Tue,  9 Apr 2024 14:30:18 +0300 (EEST)
...
Date: Tue,  9 Apr 2024 14:30:09 +0300
Message-ID: <20240409113010.465412-18-kirill.shutemov@linux.intel.com>

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 67083774507
	for <lists+linux-kernel@lfdr.de>; Tue,  8 Aug 2023 20:35:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235287AbjHHSfj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 8 Aug 2023 14:35:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57716 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235483AbjHHSfW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 8 Aug 2023 14:35:22 -0400
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.220.29])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B883FD24C7
        for <linux-kernel@vger.kernel.org>; Tue,  8 Aug 2023 09:29:47 -0700 (PDT)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out2.suse.de (Postfix) with ESMTPS id EB1E620318;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.cz; s=susede2_rsa;
        ...
        bh=TBu9LYlHJ8OjXikD6cSMhoFhFKNv3djoLniF9L00kCU=;
        b=V2Kbm2lIqct91r38K4Ct7TQaHhljTuhoYVMpRcAt3cKRaekudh4nhIcpG85OITNPFcOyyB
        9ny32bzS3cJ9kFOEpuYoc/5Az+gqs0imKKtm2YkXP1T1/JudJTJ8/RU4aO2ZNKp10qyzdy
        0cT/eGNDsn8TY4oRAkOVz4/R6bWkim8=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.cz;
        ...
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=TBu9LYlHJ8OjXikD6cSMhoFhFKNv3djoLniF9L00kCU=;
        b=lLwi1ysLAUCxBlvGR5/1aEpWdfJUdaAtB0i8tJnQ/pz/b9FbcFpkHWfHfHfiX6579mtNR+
        sIcdcA5cPJNiLFAw==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id BC8AA13451;
        Tue,  8 Aug 2023 09:53:52 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id mIhcLbAQ0mSBJQAAMHmgww
...
Subject: [RFC v1 2/5] mm, slub: add opt-in slub_percpu_array
Date:   Tue,  8 Aug 2023 11:53:45 +0200
Message-ID: <20230808095342.12637-9-vbabka@suse.cz>

Return-Path: <linux-kernel+bounces-133515-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A72489A4BC
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 21:15:51 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2E33E1C2198D
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 19:15:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E67E6172BC2;
...
Received: from mail-pj1-f48.google.com (mail-pj1-f48.google.com [209.85.216.48])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4997C172BA4
	for <linux-kernel@vger.kernel.org>; Fri,  5 Apr 2024 19:15:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.216.48
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712344540; cv=none; b=FcCTlcjwNLhFpg4K19ZITK6BrFqhULExzEPMqlWUN+54uJpQkGXmjUwh7EnNv8jg+Dly3t2wbnheYdXNrv5a3229R0BwqHXonOZjFFiteVqhagH0zXbFTJ3sxo8o6EBuacPvHY95iTzFRk0GNuGpEMUKCOqizUwp4pgbcjDkGxU=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=dilger.ca; spf=pass smtp.mailfrom=dilger.ca; dkim=pass (2048-bit key) header.d=dilger-ca.20230601.gappssmtp.com header.i=@dilger-ca.20230601.gappssmtp.com header.b=dckJbH8t; arc=none smtp.client-ip=209.85.216.48
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=dilger.ca
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=dilger.ca
Received: by mail-pj1-f48.google.com with SMTP id 98e67ed59e1d1-2a2f007a33dso1478065a91.0
        for <linux-kernel@vger.kernel.org>; Fri, 05 Apr 2024 12:15:38 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=cWmfDDERJb42IjzSqTDZHJTCfY0P4Md9v2hGsxPXotE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCV5V5esQHe4tBxfYu1wPLd4r7yTEwCObIjT7lvA7R8Oljj/pPaZiGfW8Vtkfn6ZaEmC8FsT0Pk+z0qF4RrM5/l1thjzU75l8Qb2ACNb
X-Gm-Message-State: AOJu0Yy3JWvZrPADE+XaZ3AOzPeof7ULwePSpyYpWxOQp83PsKaZ+1hq
	OZvMBPCcIPgBrgSlg3U+PANgorQf75NcHgyYGABzxrHPXZulu3O1ktfJNeK/iJk=

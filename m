Return-Path: <linux-kernel+bounces-43418-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E81F841399
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 20:36:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 36E98284123
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 19:36:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5061212F584;
	Mon, 29 Jan 2024 19:35:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="DL1DtO5C"
Received: from mail-yb1-f202.google.com (mail-yb1-f202.google.com [209.85.219.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2A91C7604E
	for <linux-kernel@vger.kernel.org>; Mon, 29 Jan 2024 19:35:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706556928; cv=none; b=lE4U5TxafO7q3+GwYpz89dN/dOvbzvzCFoj7RFpOK0IMNkl1HTiYZWPEIu1p8tT2XFCRzMOhVq6qEq0xTu4+om9C95sbpUzxQC/xi8jn1kqAUbIHJxcPjgTH9k1LV7Kss4Q19Qol3LF4glQwpujvfF/LCcxuaToYPOTdYSPi0Sc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706556928; c=relaxed/simple;
	bh=OJgQ1qhLDabP6L30mWXu4b8oGn7mXavl1NGjOvY9bUw=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=f+5ls7WMbVXEnNi2tratTCQab++HsuTzDEjU8vFpqKbA2Jllt/LHyxt/lnc5kz0yqtKpFLZHmF+a1HgjNaVODl/IQrNf9I14WABgofW/xwkOYjj+N7vcR4/A41yHldcrQk36D0gIFTzvbeKMHa7q+61vsmLrxeuobcasNGU82Xs=
...
Received: by mail-yb1-f202.google.com with SMTP id 3f1490d57ef6-d9a541b720aso5607089276.0
        for <linux-kernel@vger.kernel.org>; Mon, 29 Jan 2024 11:35:26 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=RxV5wBXLAd7sIIElP90tsYG05NDDw/o/tErBcn9qBHI=;
        b=
X-Gm-Message-State: AOJu0YyuDeFAAELwhQXt4LFdlYQ/bxtHW3sWLgmODCzQyO1+KwBzUEYz
	Vs7oasFWqPtTamZ5TgRnw7WGXLvnmjrpd1BknVKziXkQynHFUaYNpdwYXA/deV+r7Y+kLjOVjqN
	YuwSOu/A+0T7DuDmTFqdCAw==

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 667168043F2
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Dec 2023 02:22:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1343860AbjLEBWl (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 4 Dec 2023 20:22:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46444 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1343967AbjLEBWj (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 4 Dec 2023 20:22:39 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DDC8AAF
        for <linux-kernel@vger.kernel.org>; Mon,  4 Dec 2023 17:22:45 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1701739365; x=1733275365;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:content-transfer-encoding:mime-version;
  bh=QycBI7Kt9PgTyJxaiH/+LWXtKXKuLCo9OVwQRLqdWtI=;
  b=Yf5zpCuuv+dyon/djCylw1zejvpqRtoS360l8fgM5FrPoLkzUN8Y5azC
   5xbuHHmzZQ86loL6ggt/z74OFeeeqTiKvmhMSatFcoHjstDjuzjKgjfQq
   hwIlYWCPYiGTigg1r58lRK7IoJPKUX2tt5ArdcchcPgLuFyJr9DNwqQSR
   sd1zpRPGR6Ua3M95m8OTx+m8cnN1EfdDkFU+G9GgMkWguhJWZYbG4/y19
   UCpiiRMWHGAlGDRBsu7LBLSRF5XLjQeHbUUCUjNNt7/PIK4ckBZxBP4pT
   UBkqO3+/u4BnJZvpRnmlg0BOuTPW5dh4MHFo4LU0THjYC9QINleXoWHyG
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10914"; a="393558947"
X-IronPort-AV: E=Sophos;i="6.04,251,1695711600"; 
   d="scan'208";a="393558947"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Dec 2023 17:22:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.04,251,1695711600"; 
   d="scan'208";a="12157625"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
  by orviesa002.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 04 Dec 2023 17:22:45 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 05 Dec 2023 01:22:41.9900
 (UTC)

Return-Path: <linux-kernel+bounces-42915-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id CC429840873
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 15:34:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 2C095B216E9
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 14:34:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1068C153BFE;
	Mon, 29 Jan 2024 14:33:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="POJj4/lN"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A8B3C153BF7
	for <linux-kernel@vger.kernel.org>; Mon, 29 Jan 2024 14:33:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706538782; cv=none; b=DUq/FWBQbM78PjZ+n5n8QXJowjkh7U8yXitD0ffNLkPLR3sx20KM/0ubvDachW2jjSAsRX+FCEvAYRQUxsu6ymquu49OdVqvipJdagU/lB4DCPGU4p0LndxKb6mL5M1cRGMrSSvQ3znT3v1CdfdhJKawqq7ZM7AJ9KhsRcAjf9U=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706538782; c=relaxed/simple;
	bh=v2LHXe4M1/jpGFAoHOpD/tUoB3keJAoacIpB/KTVpWc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=CCFEEPK3uwIKWxcyc00mOFDojveQWDBhLZg+zYbWbCBAv5Otx3FxBDHXAWkS3XS/Wtv0az6UwwpXlUzfUKgRTHASInhovYqjH/xET6nHaV/Uq9CyE7khsGRMywF6dUbFQ7Me2PU8rquCZfVtt1qVZHk4o/E3EFNRBY8WExFqNho=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=POJj4/lN; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1706538779;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=hRXeU82IBxy/RcnY5wfdvSjzmzqpCs6vJAdTnhTQH90=;
	b=POJj4/lNGKrPMzIG/2zii53FhYQWi8vNmGtPCJ/aJD3+d27Ag3c1UhRujedqdxTGdfVUE0
	m6MkFsFGP2ZDVfS3onBCiMQI91m7bdTnK/e4JPmmbSRQhZxww6/7Lf1zIuzUHF9HarUfUO
	isC4DgdJrKtyqJ4BHSUukJf+xtLJTVs=

Return-Path: <linux-kernel+bounces-64241-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7194A853C9B
	for <lists+linux-kernel@lfdr.de>; Tue, 13 Feb 2024 22:04:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 95D871C22EAF
	for <lists+linux-kernel@lfdr.de>; Tue, 13 Feb 2024 21:04:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7E6536214A;
	Tue, 13 Feb 2024 21:04:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="oThPAt7A";
	dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="Mo+4l+9C"
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E8A106166A
	for <linux-kernel@vger.kernel.org>; Tue, 13 Feb 2024 21:04:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=193.142.43.55
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707858246; cv=none; b=CndHz/uK7fW26ZJfjYTo6FTJsuPI2v640+uwZ4j3W60Yt8P8k7Y2TAo3reEOthOtQdTA6cv9jQk2KW9T9pQhHwxzN2Xont5C1l+9q6C64x7Q/Ov2bSRzWWexCa6xSYTp08M5fzW5nAbhmJ+71FemjP6jMf/Zb/JFWH3C8dwlAe4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707858246; c=relaxed/simple;
	bh=6T48eqhBmuVATTAjL7s2/3tyCanrQ1D9wxoD7N9DwbU=;
	h=Message-ID:From:To:Cc:Subject:References:MIME-Version:
	 Content-Type:Date; b=phvVbkNqZ/5hSPfX/4sioAfvfCQYruA1+0V4L5B80d+bNzxhWcGjrwxoW0bkLv3w3FZjv2QKzSpqYcnDEK14oyJ8awW5cAvqiZ9RL+bJu6YzlqYoTGGh8mtP65dorsr30VSBIf/AE83PVOD/CvqGQvoKWX2mfZLraBCVK3O1cxU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linutronix.de; spf=pass smtp.mailfrom=linutronix.de; dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=oThPAt7A; dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=Mo+4l+9C; arc=none smtp.client-ip=193.142.43.55
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linutronix.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linutronix.de
Message-ID: <20240212153624.581436579@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
	s=2020; t=1707858242;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 references:references; bh=TgjcMkEmh9QuLe+xtahkCxwOwC4VCKXyQhju+8JtJjg=;
	b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
	s=2020e; t=1707858242;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 references:references; bh=TgjcMkEmh9QuLe+xtahkCxwOwC4VCKXyQhju+8JtJjg=;
	b=Mo+4l+9CGc8vzn2UIK0WtUlYAqSSn+7vTJ45OQqkrRUU/RWF8ayVvDvQscP0zIamwV+Wyu
	p9ak+z65Tted2ZCQ==
...
Subject: [patch V6 02/19] x86/cpu: Provide cpu_init/parse_topology()
...
Date: Tue, 13 Feb 2024 22:04:01 +0100 (CET)
...
@@ -1591,6 +1591,8 @@ static void __init early_identify_cpu(st
...
@@ -1601,6 +1603,7 @@ static void __init early_identify_cpu(st
...
@@ -1748,18 +1751,6 @@ static void generic_identify(struct cpui
...
-
 	...
 	/*
@@ -1818,9 +1809,6 @@ static void identify_cpu(struct cpuinfo_
...
-	c->topo.l2c_id = BAD_APICID;
 	...
 	c->x86_phys_bits = 36;
@@ -1839,6 +1827,8 @@ static void identify_cpu(struct cpuinfo_
...
@@ -1846,10 +1836,10 @@ static void identify_cpu(struct cpuinfo_
 	apply_forced_caps(c);

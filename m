Return-Path: <linux-kernel+bounces-88260-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B8EB86DF54
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 11:39:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 4BFC8285B98
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 10:39:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1642F6A8CB;
	Fri,  1 Mar 2024 10:39:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ffwll.ch header.i=@ffwll.ch header.b="CgNYaF/Z"
Received: from mail-ej1-f52.google.com (mail-ej1-f52.google.com [209.85.218.52])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 81B6716FF46
	for <linux-kernel@vger.kernel.org>; Fri,  1 Mar 2024 10:39:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.52
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709289550; cv=none; b=mZ68cppoc2iCrtw8VXj3Ev4TEqgpeKxK/I8Teexcb4mspF908/jt+pJbFPIC7KVA7/chNz+51xfHvMJJrtsJIfEDebakoNEFwWYLV6NXeTeXqi5Tlrsb+/30UIhgMYhvVmL4oyOHs0qbpUd2syaODPUyPwQ7Cn/aAkpz0sbIKPM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709289550; c=relaxed/simple;
	bh=SmsNgOeXcYBeZVMj7SI3Q2vhFXai5DXhHbFFk4IH5JE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=CwyR1WCxjQ1IsK9+loEG2STYMnRRXaJEfxKoAiXJ2Tge61Zz8fFX4RYLn5fLpsfwGX8EHxtNs0BQ7XD4JsgXWcd3cHOv/3Jlyv+Uz9lOQFG/zIrle9y4AWPYCpj5k10o3vudeCJ5yCkk23rZPWqL9tSMOS282VmldVu6HGsXCKc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ffwll.ch; spf=none smtp.mailfrom=ffwll.ch; dkim=pass (1024-bit key) header.d=ffwll.ch header.i=@ffwll.ch header.b=CgNYaF/Z; arc=none smtp.client-ip=209.85.218.52
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ffwll.ch
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=ffwll.ch
Received: by mail-ej1-f52.google.com with SMTP id a640c23a62f3a-a4462fbf098so37257366b.1
        for <linux-kernel@vger.kernel.org>; Fri, 01 Mar 2024 02:39:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ffwll.ch; s=google; t=1709289546; x=1709894346; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=fePj1lO9tth4Z81r0wTp5zyq5wY/LQ0qjbQTJUa59fQ=;
        b=CgNYaF/ZHWu4AMDyHNfTEgO6K0UrYH+cJOlgxyNTndIn7ALLLylIR6FWSXCYlzqe0l
         q66SgSj0mVxxIUeFikUWSWD2qVf3ucFmpjaVt0EJH/3zTIOQUeMbZXPXuPohwM+xo5Ak
         X5W+dDMTJviPKJJSgxpYyTu4ZEiiMdm9kp42w=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=fePj1lO9tth4Z81r0wTp5zyq5wY/LQ0qjbQTJUa59fQ=;
        b=
X-Gm-Message-State: AOJu0YxqhxesplukLqi4PP2GYN1JwRTm8gtYm5Gb+8UDx5tP75exzZVz
	w0JwglHpXmpsLPbZ1aZtRlzyqhCbH7aUU7MfUr0kUvIktnzy0Vj0e9BNctNnZF0=
X-Google-Smtp-Source: AGHT+IGwo/IrEGk3BQ1+y4476Pf486gExEN2ZqeEOVPVGljIA+ceuDIOzIuaWtdhT8ScXIAo6UeUSw==
X-Received: by 2002:a17:907:1608:b0:a44:205d:bb84 with SMTP id cw8-20020a170907160800b00a44205dbb84mr853956ejd.2.1709289545617;
        Fri, 01 Mar 2024 02:39:05 -0800 (PST)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
        by smtp.gmail.com with ESMTPSA id j11-20020a5d604b000000b0033d9ee09b7asm4197063wrt.107.2024.03.01.02.39.04

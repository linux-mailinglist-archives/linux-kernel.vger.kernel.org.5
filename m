...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B154379C3C5
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Sep 2023 05:10:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241906AbjILDK7 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 11 Sep 2023 23:10:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54500 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241891AbjILDKr (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 11 Sep 2023 23:10:47 -0400
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nxp.com; s=selector2;
 ...
 bh=hujdsgHZZWzrBS99IN5Tzd9//Ucycp+FScAMAJQRRmo=;
 b=Qbl4fZLajZPIfR+7gWIAPnhXtCS3ORLrWZSOEm4dLbPcYonDl01gOi6K+seEL1cHSfsaJwbJkl96rbMd8wxa07RrfMzBPdasLs97SbBZOTvr4Mf3Wys8ONlFObvg1BPkxLpLrsoGYiRgQqkL2C1APa8D0i51IJvZsmegv6s55G8=
...
References: <20230905213842.3035779-1-Frank.Li@nxp.com>
 ...
 <2e42bee0-937e-1dcf-2d18-91b362d35be4@starfivetech.com>
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <2e42bee0-937e-1dcf-2d18-91b362d35be4@starfivetech.com>
X-ClientProxiedBy: BYAPR04CA0019.namprd04.prod.outlook.com
 (2603:10b6:a03:40::32) To AM6PR04MB4838.eurprd04.prod.outlook.com
 (2603:10a6:20b:4::16)
MIME-Version: 1.0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: AM6PR04MB4838:EE_|DB9PR04MB8092:EE_
X-MS-Office365-Filtering-Correlation-Id: 649afc99-e01e-4b15-b133-08dbb314e62f
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:AM6PR04MB4838.eurprd04.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(7916004)(39860400002)(136003)(366004)(376002)(396003)(346002)(1800799009)(186009)(451199024)(41300700001)(6666004)(6506007)(52116002)(6486002)(53546011)(6512007)(9686003)(83380400001)(30864003)(2906002)(33716001)(66476007)(6916009)(66556008)(66946007)(316002)(478600001)(5660300002)(8936002)(4326008)(8676002)(26005)(86362001)(38350700002)(38100700002)(67856001)(579004);DIR:OUT;SFP:1101;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?jjnAbGB576Lx3ABZT0uJwDfHlmFNEwbrj8WWHQ80ITcIQOMIWupedd0nTK?=
 =?iso-8859-1?Q?cVeZPg1N7JdkWnRvtuoRz2jrb9ZJmWcHeUJTtpBxjdLof+ZjsCEst1n+Q5?=
 =?iso-8859-1?Q?TNvs46fkbaDFRuCCqPswkJyeaqUzZwKSz2VrvcVMzENuLCI/f2SdlHndpU?=
 =?iso-8859-1?Q?TL6vHCa0rYniL2zSqwuVS30C9/FRXO9SuIx10tR6qMQArwTpTwqgxgAVIL?=
 =?iso-8859-1?Q?wdpLsya17CDC0f2fBDStXBeXegxXdRDBgSUv6EFnPeCu2lcwJPSlX0dKOv?=
 =?iso-8859-1?Q?BE+WER9WS0jjA8sLLapePX0MJZi+4g9pfstWZWGbGplVlMYfu/eiRuQYf0?=
 =?iso-8859-1?Q?9EaNLz73+mMyztLc7PC5Kht1PO6wVTSbD+RyAVoZqPIYIngo8TGApwEoXD?=
 =?iso-8859-1?Q?nOW8WbXmKUHGTijhM01D6UFI9ulnEkJ6WailMvRKJI7Fns6gSRgGOeXMAr?=
 =?iso-8859-1?Q?LtS865y3kgQPQqly4XCxl0MV1hpgSADmGt4vJbTfywUbXFouGAQnW+V2FE?=
 =?iso-8859-1?Q?p0wbP5xoW2h0ekSDUUoAm/A0zoauyBam1H4wPinImyhBn4CfeftkegwbSG?=
 =?iso-8859-1?Q?H3cTZVpEDtSOTkBboF5BtZWRXHuQkwLaB/TXXNWnsVGWhri7oDdYtR6/RV?=
 =?iso-8859-1?Q?DtZ44ZIXotP6hAqrBEckN+aVmdp90/M3bv/hcY3ublVDmxuLOJZfP9YAmo?=
 =?iso-8859-1?Q?SnmRmAlDTRY807Q+FVYStxKL+lzU/vjOx7TAbgSnXUJ5UolMAWtBBeIX3b?=
 =?iso-8859-1?Q?Wwlv4SXBFgT1aw8jFFahLvLfqwSd9B1wL7f52EiOK6vpf8wNroqmqujNkH?=
 =?iso-8859-1?Q?w6VN6t+smFQm9D1howGYIeVRfcMF0sUUnMPGm/A3o7zcUxSUpgsFM/J9l2?=
 =?iso-8859-1?Q?tlu9ip+vhcBWN57JUqA43swxlm1HhQ3eXYaXFIQd9SiA5ZsE+CsydpeD/m?=
 =?iso-8859-1?Q?FZylq9E13jbhzGeDt/xIHIGaRKyNOdtYh9qjBHJOaTOa7SGjjPwYhKa57B?=
 =?iso-8859-1?Q?+30CaC0Ve7F8Kr9YUmavGBXfCn+zx/xIkgXRik1yuzMWc1ZJrxAaMqeftx?=
 =?iso-8859-1?Q?scbrNFxIFvHa+Q/qdvDMr7Lx1aJNbB0+i8gqXGdSdS+hHL4AJ90ohTs5al?=
 =?iso-8859-1?Q?+XxUfPMdyBSXnb6huwwPSnsE4wDKmqJsOE0G4mkO0OvbZMIwYMtlmkeY0Z?=
 =?iso-8859-1?Q?crGYvF9kZxz56GHq7iPqYev/Yjqipf3hR1sJl8alnWGuzyGnbEms3wlgLi?=
 =?iso-8859-1?Q?I3ur9tzyFyzGDsiGruKgG/MTvEY4TtmaO3q4a7q1mY5gQ7AtSnxT1GAXwo?=
 =?iso-8859-1?Q?uf2o3fE7OCi3oj160RogT+vsudedEBtSv/6jGIkUyjtvvqniPG3tiUZIi9?=
 =?iso-8859-1?Q?LTJ4OAv7SOi1tXC5v4Ksy3GqsGihsH+FXCoOoYfUyS2t/SFUACuIdUzMEL?=
 =?iso-8859-1?Q?z3C5v6ybqKFOi9U7kqYPNfrvlnmVs4WIPjejzjoUA4W52OIuBpRuK1sEi4?=
 =?iso-8859-1?Q?G6zwRH0D8R0lybLVO1EQSar7z9vhRtP5zxv4azOi8HwyD+B3lgpv9YAyRh?=
 =?iso-8859-1?Q?KygiGRTyysLnPySdCYQT6cXOi3cVMTOn1vDNsk1T32zM/WLV5AEZdjIEV1?=
 =?iso-8859-1?Q?T3dRoBrhG6PCY=3D?=
X-OriginatorOrg: nxp.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 649afc99-e01e-4b15-b133-08dbb314e62f
X-MS-Exchange-CrossTenant-AuthSource: AM6PR04MB4838.eurprd04.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Sep 2023 22:17:34.9444
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 686ea1d3-bc2b-4c6f-a92c-d99c5c301635
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: gNiR2aJPiezxoLLJc8up/zl7R6vxMOVXFY9fTzrCaWdsFd8DLiUDpZfvUSVQkIrXgH5tlx1G8cqXFPaMFuZwaw==
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DB9PR04MB8092
X-Spam-Status: No, score=-0.7 required=5.0 tests=BAYES_00,DKIM_INVALID,
        DKIM_SIGNED,FORGED_SPF_HELO,RCVD_IN_DNSWL_BLOCKED,SPF_HELO_PASS,

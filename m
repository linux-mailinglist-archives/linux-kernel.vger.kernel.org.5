Return-Path: <linux-kernel+bounces-54772-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5801284B37E
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 12:32:06 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 177C6283674
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 11:32:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 25E2F130AFB;
	Tue,  6 Feb 2024 11:29:59 +0000 (UTC)
Received: from szxga06-in.huawei.com (szxga06-in.huawei.com [45.249.212.32])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 428BE12E1D8;
	Tue,  6 Feb 2024 11:29:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.32
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707218998; cv=none; b=Dx6smWsNN4SFTDnFiknnsCGHSamDzb8bdtXDy7Gjd9D1JGDQ6EeLno5UdSUX/a60wL0Bz7Sffay4QZiW1DHPy6TtRmkEhtUkfPnQPTef8D5yg6JDL1s5fBvmAlyXW5EZbBWWmWD4v1gsl+mKTWDHR918b0GCwQLrH7F/OsSZ++E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707218998; c=relaxed/simple;
	bh=xnUfh5tNvpXi9BR+N3yxZpocjCbyoo7Gh9VK7eqqUzI=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=jrPli8iWoVCH+KMOEd9T39m6mi1PMLUr81qNVXnoOSOUizTDD7TClaGkBUlIwKFPzBTweDj1jCwnBXPIia6fpbZ/IFnxI7Ik1W3UIUKDbBCrmAzOBWAFONMQFY+HWDywNTr5Jp0nTc2gQHARfebRtDOli5xUw23BB1BqCmzmkpY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.32
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.88.234])
	by szxga06-in.huawei.com (SkyGuard) with ESMTP id 4TTgxx6q7rz1vtGS;
	Tue,  6 Feb 2024 19:29:25 +0800 (CST)
Received: from kwepemd100002.china.huawei.com (unknown [7.221.188.184])
	by mail.maildlp.com (Postfix) with ESMTPS id A394B1402C7;
	Tue,  6 Feb 2024 19:29:53 +0800 (CST)
Received: from M910t.huawei.com (10.110.54.157) by
 kwepemd100002.china.huawei.com (7.221.188.184) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.2.1258.28; Tue, 6 Feb 2024 19:29:52 +0800
...
Subject: [PATCH v7 1/5] perf: build: introduce the libcapstone
Date: Tue, 6 Feb 2024 19:29:25 +0800
Message-ID: <20240206112929.1035548-2-changbin.du@huawei.com>

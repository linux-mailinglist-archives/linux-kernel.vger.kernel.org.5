Return-Path: <linux-kernel+bounces-152259-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1AE3A8ABB8B
	for <lists+linux-kernel@lfdr.de>; Sat, 20 Apr 2024 14:34:44 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3E3C11C20A63
	for <lists+linux-kernel@lfdr.de>; Sat, 20 Apr 2024 12:34:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2584B134DE;
	Sat, 20 Apr 2024 12:34:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=posteo.net header.i=@posteo.net header.b="ZUst7EC5"
Received: from mout01.posteo.de (mout01.posteo.de [185.67.36.65])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 96C6312E73
	for <linux-kernel@vger.kernel.org>; Sat, 20 Apr 2024 12:34:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.67.36.65
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713616475; cv=none; b=pygQlAlTOddB4PM5rYC082N0Ez8pOPcHaOxXLsR7tgOkbUFteQUuLq2Wxo92S4SWXHHwub/6PhGSkrV41I+QodKhHYvUTdPcL2h+y4WweztcHzsbFuDx5ky/rlkNDumOiwziaoMhx8xLs8GP4UfOxFxZcjlw6uKockkxW8gswrU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713616475; c=relaxed/simple;
	bh=KMr0K8DIDwe3NZEz5yRWgIu6Sv/Zygl5OdVwc8r2b40=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=Ah15uMEhu5yJk19ZkKZGPlpyeMY42aLHrlU224nyqxSHT7xFz+OmlP9ZflRb0R9zgzh0IlvebBCJtXqPf0hDkt1brhW5qCKhBPdbHSGnTxmMpIsM9SuRvmHZXELhSsQzNfmC0CS20+GMTkllZMC2wZj0EoS2UaWaEIAyifHeqY4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=posteo.net; spf=pass smtp.mailfrom=posteo.net; dkim=pass (2048-bit key) header.d=posteo.net header.i=@posteo.net header.b=ZUst7EC5; arc=none smtp.client-ip=185.67.36.65
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=posteo.net
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=posteo.net
Received: from submission (posteo.de [185.67.36.169]) 
	by mout01.posteo.de (Postfix) with ESMTPS id 7A2B4240029
	for <linux-kernel@vger.kernel.org>; Sat, 20 Apr 2024 14:34:25 +0200 (CEST)

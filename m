...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DF3807FF195
	for <lists+linux-kernel@lfdr.de>; Thu, 30 Nov 2023 15:18:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345975AbjK3ORp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 30 Nov 2023 09:17:45 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36272 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1346013AbjK3ORZ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 30 Nov 2023 09:17:25 -0500
Received: from mail-ej1-x636.google.com (mail-ej1-x636.google.com [IPv6:2a00:1450:4864:20::636])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4AB5910F1
        for <linux-kernel@vger.kernel.org>; Thu, 30 Nov 2023 06:17:26 -0800 (PST)
Received: by mail-ej1-x636.google.com with SMTP id a640c23a62f3a-a184d717de1so129852666b.1
        for <linux-kernel@vger.kernel.org>; Thu, 30 Nov 2023 06:17:26 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=amarulasolutions.com; s=google; t=1701353844; x=1701958644; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=iBSFE7wuI7cWsbY7avwQ/zjrbx0wxDJgM1FTWZ+ONNg=;
        b=Tj33q3QABZ2VzTJ3oWBHaK8gbim+vAhTADIPq2Y5tgrtEVtAE5GqS/MJButdjgq9+6
         N7nJd9fOpC6NIn1eu9yyspBoYNVkNrMhZiB2NXB+dHoTmpMOPZztrZgyeYmQ0tu2n8c1
         iTsfhR7CSxF/kgoPSuVLadEMy7yRH3MZvDMb4=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=iBSFE7wuI7cWsbY7avwQ/zjrbx0wxDJgM1FTWZ+ONNg=;
        b=
X-Gm-Message-State: AOJu0YxsIZkexv+Wq1zzvlLp9SFianYhG2H8lzzstH9m5Y9FOxQ52br9
        70qA6H0RlJWyY5laMYVEKpBv4HYXw2Wi9YC539nd2Q==
X-Google-Smtp-Source: AGHT+IHz7spudw42nkbxasdPGKducH2EaycjcPe0EiTwDsK/JvOdSLLoN3ppXS1JF2nFzgDFYv4MNg==
X-Received: by 2002:a17:906:194f:b0:a04:3f97:f3f1 with SMTP id b15-20020a170906194f00b00a043f97f3f1mr16763433eje.58.1701353844685;
        Thu, 30 Nov 2023 06:17:24 -0800 (PST)
Received: from localhost.localdomain ([2001:b07:6474:ebbf:d1eb:b106:516d:db0a])
        by smtp.gmail.com with ESMTPSA id my18-20020a1709065a5200b009f28db2b702sm716064ejc.209.2023.11.30.06.17.23
...
Subject: [PATCH v3 09/10] drm/panel: ilitek-ili9805: add support for Tianma TM041XDHG01 panel

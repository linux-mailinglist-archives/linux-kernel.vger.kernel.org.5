Return-Path: <linux-kernel+bounces-153337-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 9157D8ACCCC
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 14:36:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 633561F2202D
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 12:36:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 00B47146011;
	Mon, 22 Apr 2024 12:36:41 +0000 (UTC)
Received: from laurent.telenet-ops.be (laurent.telenet-ops.be [195.130.137.89])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6E5903D3B3
	for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 12:36:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.130.137.89
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713789393; cv=none; b=ulFa4n0MpETmZe0q5JUmuimOSJBNoMJWyf7OfvpfVIoBI6ERRFos5Zh3+qLLVrcd/Y2mOKn4tJPI0uzQhTjJUZoPMXN1YeKHMpaLaul3V8EsjcjnYaE+oKCOm9d7Xr0kgZq4MxaN+tEZrq6Cm+fqSMjjGXCJXlcdtlXg3tuPOa0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713789393; c=relaxed/simple;
	bh=fSPBEhH3Nt8nHPCGZEnZGAI/mdNrbSn5XPbGz3YrMpg=;
	h=From:To:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=NIZUaf7jh025i9tJm4eLSeo2HKzVasaK8PpQNRX/PFx5a/06VD8+zg/wl8ZYtosQDxXsh4ED8CfIA4dnD2zRXHkIJgU/0ZpQ8m6gRJ//zdUe6gnI7ILLkHEmquDkqdhBmLgLWGJy1SI/UrhI9QzothcquqFRxxtPbfuUldwAZIQ=
...
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed80:76d0:2bff:fec8:549])
	...
	id ECcH2C00F0SSLxL01CcHRk; Mon, 22 Apr 2024 14:36:17 +0200
Received: from rox.of.borg ([192.168.97.57])
	by ramsan.of.borg with esmtp (Exim 4.95)
	(envelope-from <geert@linux-m68k.org>)
	id 1rystX-001siV-3Z
	for linux-kernel@vger.kernel.org;
	Mon, 22 Apr 2024 14:36:17 +0200
...
Subject: Build regressions/improvements in v6.9-rc4
Date: Mon, 22 Apr 2024 14:36:17 +0200
Message-Id: <20240422123617.1363267-1-geert@linux-m68k.org>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <CAHk-=whdUP62_7N6s837tTFjvmcGxyRnMGwnVnZwn2fDVf5E8A@mail.gmail.com>
...
[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/0bbac3facb5d6cc0171c45c9873a2dc96bea9680/ (all 138 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/e8f897f4afef0031fe618a8e94127a0934896aba/ (all 138 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/fec50db7033ea478773b159e0e2efb135270e3b7/ (all 138 configs)
...
10 error regressions:
  ...
  + error: arch/sparc/kernel/signal_32.o: relocation truncated to fit: R_SPARC_WDISP22 against `.text':  => (.fixup+0x10), (.fixup+0x20), (.fixup+0x18), (.fixup+0x8), (.fixup+0x0)
  ...
  + {standard input}: Error: pcrel too far:  => 561, 543, 554, 545, 563, 552, 572, 570, 590, 579, 588, 581

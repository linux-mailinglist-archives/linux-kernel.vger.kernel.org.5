Return-Path: <linux-kernel+bounces-85967-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B8ED86BDD9
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 02:05:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 9FAE21C242C7
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 01:05:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 677B744365;
	Thu, 29 Feb 2024 01:01:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b="os+zqjld"
Received: from mail-pl1-f170.google.com (mail-pl1-f170.google.com [209.85.214.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7B4FF13D2FE
	for <linux-kernel@vger.kernel.org>; Thu, 29 Feb 2024 01:01:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709168505; cv=none; b=j0Kf3nOKJjFB67SPux5o1UkhtNFDHmgUqTcE+GCXHiVqawScmE9NYfK2yl+XDBnfjvVkcqL7JVqDLNn2k2aMUsorFP0lwlk7MSGdgwUSo4YC6WIkXAhOr6nQXJsKK/SdA7we2ZyW/AQ5vziebM1Jjpr/TGy8iTRSM8WO1zs3hmc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709168505; c=relaxed/simple;
	bh=QXNusurNjKAKL54cG15b5W5oqhi9D6TV7hcIlIsoqqc=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=YaNie9G27UoLsAxtaceHrIukggJEPoFeBzCKlmF57XikfIuU9xQdjJ7TgciuANilJxRiUaEm7ssJz7lIvVMsRsRmR3CJe5kCJiKvk3RDgO+DPWuakDXopCUKZ8yylnkASr4JRWFCTdU51FZoMgXtfyxH23/HNCBT45CpdH1pWIY=
...
Received: by mail-pl1-f170.google.com with SMTP id d9443c01a7336-1dcafff3c50so3579885ad.0
        for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 17:01:43 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=HblTcnp394YnoDG8K1yJz0F3T1kb+qA3LFW6mA061oQ=;
        b=
X-Gm-Message-State: AOJu0YyBCKLXDxnUrb4KtWcNWC2jQata3wuNvYxqOQCh95abii4ZSE5Z
	FVXkUvg/3uRU6Ah3Ie1bek5aEVLNNXdBwaFqoNFJOaGA2OWAZP/jK3u/4cw0+J4n2SiaImb+zl6
	I

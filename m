...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DCD417A13E0
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Sep 2023 04:35:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231685AbjIOCfS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 14 Sep 2023 22:35:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40354 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231220AbjIOCfR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 14 Sep 2023 22:35:17 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5A1B9268E
        for <linux-kernel@vger.kernel.org>; Thu, 14 Sep 2023 19:35:13 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1694745313; x=1726281313;
  h=date:from:to:cc:subject:message-id;
  bh=w3OSJutpdVR2zad/bBM9zRuvCbhqi8Aq4WR0jQqkBUM=;
  b=GZIHgPu7iHM9Oh3+Qh/HDVwq3gqvparY1aSrm6y0nI1qd9dtWULj3hyA
   Q7p33vsGLXxWY5pILLpMj6kzaGRvv06Iugr15vpnWxmXLexp5NkEO7OxT
   byW6L2DX2BCtegY/cs7qZzM+VT9eURCMoFeKVLnDoaTr43h/cG2lKIXgT
   iF8nmYoYb8awG5HT86Q/vT3Qu4B5ywo1QmPwQVZDKB0UyF2r4e2+cL+zI
   JA7BLSu0ercRHyBAdlwfoAlVYgxh4vZi8HzNDeUy9wmpt2PCup9xDBSlO
   vxEVabTolic3OzwMN7IEdIBlFTNsZbqBg9d+YWVIStKBIgH6kY447P3mM
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10833"; a="410079921"
X-IronPort-AV: E=Sophos;i="6.02,147,1688454000"; 
   d="scan'208";a="410079921"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Sep 2023 19:35:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10833"; a="1075625784"
X-IronPort-AV: E=Sophos;i="6.02,147,1688454000"; 
   d="scan'208";a="1075625784"
Received: from lkp-server02.sh.intel.com (HELO 9ef86b2655e5) ([10.239.97.151])
  by fmsmga005.fm.intel.com with ESMTP; 14 Sep 2023 19:35:11 -0700
Received: from kbuild by 9ef86b2655e5 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qgyfl-0002K5-0Q;
        Fri, 15 Sep 2023 02:35:09 +0000
Date:   Fri, 15 Sep 2023 10:34:16 +0800
From:   kernel test robot <lkp@intel.com>
To:     "x86-ml" <x86@kernel.org>
Cc:     linux-kernel@vger.kernel.org
Subject: [tip:x86/urgent] BUILD SUCCESS
 7362132a6408d23244b95025ea85dd3dc41e5332
Message-ID: <202309151014.w59bs0Q5-lkp@intel.com>
...
branch HEAD: 7362132a6408d23244b95025ea85dd3dc41e5332  x86/boot/compressed: Reserve more memory for page tables

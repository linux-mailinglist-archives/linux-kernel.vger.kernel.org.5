Return-Path: <linux-kernel+bounces-60989-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id D82D6850C2C
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 00:16:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 63D751F2149F
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 23:16:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 683D917C70;
	Sun, 11 Feb 2024 23:15:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="ZtkGBDXs"
Received: from mail-ed1-f41.google.com (mail-ed1-f41.google.com [209.85.208.41])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E6C3917548
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 23:15:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.41
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707693345; cv=none; b=eym+Fyhi16KIKdkd7LEUSQwN+9AUgjYHI7kxB3TrpX2EwezDrEmVElnYnhJQKK68aHLbf22VRjB8Blyn633+axjb++bbmna+Uwen1ULwDrHmpbyq/orjlyFyaHj49u/a/MSkp4uKmhgpYv7kBOBZVJCx1TBVfljzsqrgocj5n34=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707693345; c=relaxed/simple;
	bh=EINUZJwko3Gf0QbcPfi08L73aK5jL2hMEANq2ElpqNc=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=ZbOj3ISVZqRzjrDWBY/RkH9MeRdN+FmZpnXUrMMdF5kFlo4pb2iIkOnOQ64scPnEGblRSVQPorem6sPpu4IOpxge8VsWYQFPRLBeEtZVOju3dvwMQkva8v5gw7o4HtOmhxUTB2kj55hvjSRqS1k8xoOjUirqVttKyIgbDCTXPCA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=ZtkGBDXs; arc=none smtp.client-ip=209.85.208.41
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ed1-f41.google.com with SMTP id 4fb4d7f45d1cf-561587ce966so2995362a12.1
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 15:15:37 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707693335; x=1708298135; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ejWZEi7TYL5VXPc1nXDBB2l6mB09poQCjbbGA7dNR0M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707693335; x=1708298135;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=ejWZEi7TYL5VXPc1nXDBB2l6mB09poQCjbbGA7dNR0M=;
        b=
X-Gm-Message-State: AOJu0YyRwi+s0Za90Gt13xgFvEGEfuDcrOj1GkUWMercPlAvSsT+r7QM
	7GjfMiwzdhf1sE2W3KXYCJGqwW+U9SZVyJtcbupWt4Q7S5th3wohMw/shD19RUTHWXNTxVtTg7Q
	m
X-Google-Smtp-Source: AGHT+IFMor5pDDGWHeeCL7PBHkN0MWZ+WdFs5/8ckVO3vmP7u4NUE81vr5vdzeJwcXarUS45gAgKRg==
X-Received: by 2002:a05:6402:3218:b0:561:c656:fc35 with SMTP id g24-20020a056402321800b00561c656fc35mr30090eda.2.1707693334705;
        Sun, 11 Feb 2024 15:15:34 -0800 (PST)
Received: from raven.blarg.de (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id et13-20020a056402378d00b0055d19c9daf2sm2170180edb.15.2024.02.11.15.15.33
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 15:15:33 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v4 05/35] kref.h: move declarations to kref_types.h
Date: Mon, 12 Feb 2024 00:14:48 +0100
Message-Id: <20240211231518.349442-6-max.kellermann@ionos.com>

Return-Path: <linux-kernel+bounces-129798-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id B18B089700C
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 15:17:28 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D48771C26A23
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 13:17:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C4DA41487E1;
	Wed,  3 Apr 2024 13:17:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b="nFjG1XyQ"
Received: from PAUP264CU001.outbound.protection.outlook.com (mail-francecentralazon11021011.outbound.protection.outlook.com [52.101.167.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B6B2D1482EA
...
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712150231; cv=fail; b=p/07P3EX4fT3pUdBLhA9YpBKGBYZZ3hkfzTZmnamFWi1cw5WChNcESO00Cr/oSTlyEl1JFAtvYcPdJh2iMPf7LJxuXkpCnZVUL3rGFkESUk+N+uHSS9rv10dCc2RFWT+rm2NsvbeJwnndRmVCVmTLZG9p4Aqw7bmCFEYJp7iCWw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712150231; c=relaxed/simple;
	bh=aOc0vNEAf/2C7NNUN/aH5CJ/AHTqARD6uMPXLPQOJHE=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=WnQ6Gx5+iCsIOMn3AUXCTN3mkU5Gc5dmyfFGgKASh1w4Kb87vmC6pwxjGFlZj9ss62odOBCYNUSy7r9n3R7ttpCZYqnuSxyDeBVtcFOmk/EZhXvG6PjJc38SHtbr7WQgV0+l0BW25e80k9K8TMMdDoljcNpQM47DVevBHOZmWKQ=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=csgroup.eu; spf=pass smtp.mailfrom=csgroup.eu; dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b=nFjG1XyQ; arc=fail smtp.client-ip=52.101.167.11
...
Thread-Index:
 AQHagFrF+NhtRwW1WEuV4j/Hb81merFVYNaAgAA88QCAAAKgAIAAC9qAgADSXoCAAAUJAIAAC4AAgAAClIA=
...
x-microsoft-antispam-message-info:
 
x-forefront-antispam-report:
 CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MRZP264MB2988.FRAP264.PROD.OUTLOOK.COM;PTR:;CAT:NONE;SFS:(13230031)(366007)(376005)(1800799015)(7416005);DIR:OUT;SFP:1102;
x-ms-exchange-antispam-messagedata-chunkcount: 1
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?bURjMURESU85ZFJqVmJtMWFXRnhiTWpCbzhucldoNGExNUtkV0JXWjFjS1ZY?=

Return-Path: <linux-kernel+bounces-49023-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 84F078464E9
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 01:10:49 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id AA7DE1C23FD0
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 00:10:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6329F15A5;
	Fri,  2 Feb 2024 00:10:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=quicinc.com header.i=@quicinc.com header.b="mEuP9xES"
Received: from mx0a-0031df01.pphosted.com (mx0a-0031df01.pphosted.com [205.220.168.131])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A19D27E9
	for <linux-kernel@vger.kernel.org>; Fri,  2 Feb 2024 00:10:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=205.220.168.131
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706832642; cv=none; b=kf/txtyTaKhy4kPTCDFQ2MqHsgNt9aqAGxNxEmcenihQ006bMd8d7pCH5wuKjp2SUadf7iVA77y5L+m+wIZYL+8P5Dovb5zm/0wZbWN05Y/a22wIleORPMJFGtVYwVo+6B7AtvPSYCWGgKeTsgdKsZOy/hmDbCajyBq8uojxthQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706832642; c=relaxed/simple;
	bh=oSugeVUiRO1IiMt6Ita7KviMhoi4orEYII2dW/trClE=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-ID:To:CC; b=mJjZKijovyY+gBZiRlUdGXC+bOjEe91/42v6ly2xr6MUgPK0EXGBxRVlVcoWxsLcFBefIWefifcVBhy3u6bEPZTdygz1dlhNYvRj5DldfWFsOnwb+cAdqCQ96LtTtPz/6CVJFevf6nirNDiOdmGAn4SN/uWo9Sva3pZw5hQcSvY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=quicinc.com; spf=pass smtp.mailfrom=quicinc.com; dkim=pass (2048-bit key) header.d=quicinc.com header.i=@quicinc.com header.b=mEuP9xES; arc=none smtp.client-ip=205.220.168.131
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=quicinc.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=quicinc.com
Received: from pps.filterd (m0279866.ppops.net [127.0.0.1])
	by mx0a-0031df01.pphosted.com (8.17.1.24/8.17.1.24) with ESMTP id 411MYTkk027656;
	Fri, 2 Feb 2024 00:10:28 GMT
...
Subject: [PATCH v2] drm/panel: visionox-vtdr6130: Set prepare_prev_first
 flag
Precedence: bulk

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A815C75F86E
	for <lists+linux-kernel@lfdr.de>; Mon, 24 Jul 2023 15:36:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231448AbjGXNeR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 24 Jul 2023 09:34:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36776 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231422AbjGXNeG (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 24 Jul 2023 09:34:06 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 30A92E66
        for <linux-kernel@vger.kernel.org>; Mon, 24 Jul 2023 06:34:00 -0700 (PDT)
Message-ID: <20230724132045.059890995@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1690205638;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=42hY1z4hgQj4e7JMNLbJLEjJil1FgDJ29QawyO0o/c8=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1690205638;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=42hY1z4hgQj4e7JMNLbJLEjJil1FgDJ29QawyO0o/c8=;
        b=t2rzb0O4w38tNROYKOPJxGVzrz7G8UAvR/lCXxWVVry84W227VftvUMkR3PKNXKxBWN1ur
        0XixiVtnoZubdYBg==
...
Subject: [patch V2 08/58] x86/apic: Nuke unused apic::inquire_remote_apic()
References: <20230724131206.500814398@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Mon, 24 Jul 2023 15:33:58 +0200 (CEST)

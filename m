Return-Path: <linux-kernel+bounces-90236-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F64786FC49
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 09:50:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 5FCB8B21E3B
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 08:50:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 79D0D3D0CD;
	Mon,  4 Mar 2024 08:44:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="MRwA7ngq"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2A2B93CF4E
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 08:44:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709541856; cv=none; b=E3bXAd6nWlB/RVhK01r+1Xn2c+nDb5R+H0KN6satyVjXsfOqBS0AiLTPkca4El5PDLVp2xvFxfkYoHj48cDUGB892snaF1rYsWrUweZ6C4mrhNMHwo+GPZgVfJ8a7D5zUYdIArBHWIgqeEWfRyrL1+rj8BwimXmQ5K+UwbxQzAI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709541856; c=relaxed/simple;
	bh=oIqB3xc596pNpY+hyhYB0P322CF2/th4m8CJZWolOUc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=qJGBJwFirLBm0dvlmoXJOI9wI4YPaV4k0+ONCAYajzbZnHgO11mXyBj4m/GNR77P4Q5vqJJ3AZ/KDsfBTYM3qkqe2K+0yM7yg3Jaem8A5w4P6ck7yagO3Zzy3Dgwg39Z8h6vg62S3OViF05QSXyP3pCNb/NBEdy4V71OSPcYkH0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=MRwA7ngq; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709541852;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=O49RI6IXXsxc9exHEL8HK+AdkLbFGJgCrHpZAGl7/2I=;
	b=MRwA7ngqU4DKit3CBXRH4pxxcvlbHdabiOj+sza25geE9Q35yOJUDWV0lyv/wunO1EYbe7
	qJfg4aG6nbNxv0RKTtCgPiR3URA3oifBRPuZ6vKRXpOEikI6Jyqisu4RuVllCrhhSpinqD
	oPj9M3q7hXlHdOXZnTyvgnJuRgdPqag=

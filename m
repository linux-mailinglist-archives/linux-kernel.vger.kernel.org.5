Return-Path: <linux-kernel+bounces-136480-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E3F5689D488
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 10:36:19 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 90B982835D3
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 08:36:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C2ED98061D;
	Tue,  9 Apr 2024 08:29:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="pd5eB7Rn"
Received: from mail-wm1-f52.google.com (mail-wm1-f52.google.com [209.85.128.52])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7E5FD80617
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 08:29:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.52
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712651385; cv=none; b=hmPMRv9fNMhz3Rfl27Gg2vA6VgJ7hKa25GmM9iycCP46i+jxKTVaCetQLrRMYQ4GcV6lSqYiUnUwWVfK8uVagip1Z7CFoeiNE1tL8NpkKbyLaayuMVBrAdt54J2hEMfZ8VVZbI8m95E8mOkgptXOcJ8i6RTtvE5J83G73cU36rc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712651385; c=relaxed/simple;
	bh=w0s9TvriV5d6PVWa1UVWntDWt35dh/sJlLpqyIbjEYw=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=Wl89Ki9P7KBF7XVkarmaZALlqEL3h80Qu+dtyTAuPMJpehtXoI+HcQFPavMdhk4ZrayFemObqqyWwK8L9tikwOZI4YhPMoJD1SZ2MgpKjL3IIwL6jkhppCxwiAl0jhM3K/7pYgbCixSaGJx5gZbmn8s05ea2p2vU12p2PEXT698=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=pd5eB7Rn; arc=none smtp.client-ip=209.85.128.52
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-wm1-f52.google.com with SMTP id 5b1f17b1804b1-4154d38ce9dso60435e9.0
        for <linux-kernel@vger.kernel.org>; Tue, 09 Apr 2024 01:29:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1712651382; x=1713256182; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=0SJ6M60wcHbUjnkixQTWHKKHEfREfPttCQb1qhPa+lQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=0SJ6M60wcHbUjnkixQTWHKKHEfREfPttCQb1qhPa+lQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUqiGGyvbPMclei+FVOiwnXcBGhwdZD+Vq9Ow28WKtkVu7SQmG/roR+yAZiWLu7k1iey3UbShkX68PKme9yrg8s76OCh/uHgMZA4dqo
X-Gm-Message-State: AOJu0YxfFJcrycKJq5SXBxQjX3EkdowP6NdsTphvH4f+xWvHBM4DxZDM
	PYv/hP8lJZfQSjP6ckuaoKCVWeZfLTEWZW/kqYJJPXcyjAjP9RWaAiaM+CsaKkhKnhKNv85BiZk
	tIYVAbke0DDEYnxmBvZoUO3awqg3j6tyTIxKB
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="00000000000043635b0615a5b95d"

--00000000000043635b0615a5b95d

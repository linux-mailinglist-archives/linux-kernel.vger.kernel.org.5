Return-Path: <linux-kernel+bounces-78096-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id B8E7D860ED4
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 11:01:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2EBB31F25F12
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 10:01:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 038ED5CDEC;
	Fri, 23 Feb 2024 10:00:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="gKH8cROA"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AA8BD5CDCE
	for <linux-kernel@vger.kernel.org>; Fri, 23 Feb 2024 10:00:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708682446; cv=none; b=OybkZ24oc0HPZ+lzpg5nddm3f+HDa80rm6onfxn7H2ai125F8v8Zpl57SRh0Gfs1MbWZNpulyGtrMfGfN7rj4OWCxsIvmw7huwY+AqEawMzHgQUrFewFHWsmxq05bYMrZuJds7lwKFvZN7VgGEqNfXNrO4OCT8xF92P3EJ8k8GA=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=gKH8cROA; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1708682443;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=yMxU6mWYxU/uR8JFHXPXzXOoISCHQJaMCW+CTaHOAQg=;
	b=gKH8cROA6rciH5jEYdaVw1IF9LajRrtSyJKfLjVs60GaS1RCgmChU+/3KW2GvofEMbZKuY
	O3Kv7LYImnwXjCztrtITNvwWpvToKc10ZDaFzdg2ciugz98ltAC/q8qBJ78EFQgj6yu2eh
	E7Sd+NzWtZAw1kuPwt5PmYSBcirtfjs=
Received: from mail-ed1-f71.google.com (mail-ed1-f71.google.com
 [209.85.208.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-180-Pgwj58v5NHKZ-JJ8fCTmHw-1; Fri, 23 Feb 2024 05:00:42 -0500
X-MC-Unique: Pgwj58v5NHKZ-JJ8fCTmHw-1
Received: by mail-ed1-f71.google.com with SMTP id 4fb4d7f45d1cf-56544b5af9dso290487a12.2
        for <linux-kernel@vger.kernel.org>; Fri, 23 Feb 2024 02:00:41 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=yMxU6mWYxU/uR8JFHXPXzXOoISCHQJaMCW+CTaHOAQg=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU30zrovH2lBscY5i4kgteyvosYJoA0jx2H9VFtX7F9Cu3H4gxHAKJjNLmSHLpVC6fK0/ONE/YWPshBQ/LXj3XSHmcJ3/mozO5iASfz
X-Gm-Message-State: AOJu0YwrXKvB5N1ZO6Qb3xo53MuTBdxeUNGzS3DqvQMgSn0H+qh0d2Eq
	UFG1inWVwHm7gmnU+vMoibu+MWzR5ivQ1ytDmqXn7pCM/5oHCMH6FJ/HpMMZlFJdMJhXZUfBqUs
	ymiw5cV4h0KGN9C2F2AbfU8FXpuIF1mGRPqw/1Jsk1zQrwx/dIWHQFY7sbSWVUYAg1NPzVQ==
X-Received: by 2002:aa7:d44c:0:b0:564:ae07:e539 with SMTP id q12-20020aa7d44c000000b00564ae07e539mr835438edr.25.1708682440061;

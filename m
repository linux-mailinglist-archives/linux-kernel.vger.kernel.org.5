...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 199F6811C45
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Dec 2023 19:21:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235503AbjLMSVb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Dec 2023 13:21:31 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44894 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235534AbjLMSUh (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Dec 2023 13:20:37 -0500
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EF4E412B
        for <linux-kernel@vger.kernel.org>; Wed, 13 Dec 2023 10:20:38 -0800 (PST)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3F6A8C43395;
        Wed, 13 Dec 2023 18:20:38 +0000 (UTC)
Received: from rostedt by gandalf with local (Exim 4.97)
        (envelope-from <rostedt@goodmis.org>)
        id 1rDTrH-00000002a8G-2bjZ;
        Wed, 13 Dec 2023 13:21:23 -0500
Message-ID: <20231213182123.406384649@goodmis.org>
User-Agent: quilt/0.67
Date:   Wed, 13 Dec 2023 13:17:42 -0500
...
Subject: [PATCH v3 05/15] ring-buffer: Read and write to ring buffers with custom sub buffer
 size
...
index 4df4c74dabc4..2e201ef5b1ce 100644
--- a/kernel/trace/trace.c
+++ b/kernel/trace/trace.c
@@ -8280,6 +8280,8 @@ tracing_buffers_read(struct file *filp, char __user *ubuf,
 {
...
@@ -8291,6 +8293,8 @@ tracing_buffers_read(struct file *filp, char __user *ubuf,
 		return -EBUSY;
 #endif
...
+
 	if (!info->spare) {
 		info->spare = ring_buffer_alloc_read_page(iter->array_buffer->buffer,
 							  iter->cpu_file);
@@ -8305,13 +8309,13 @@ tracing_buffers_read(struct file *filp, char __user *ubuf,
 		return ret;
...
@@ -8332,11 +8336,11 @@ tracing_buffers_read(struct file *filp, char __user *ubuf,
...
@@ -8447,6 +8451,7 @@ tracing_buffers_splice_read(struct file *file, loff_t *ppos,
...
@@ -8455,13 +8460,14 @@ tracing_buffers_splice_read(struct file *file, loff_t *ppos,
 		return -EBUSY;
 #endif
...
@@ -8471,7 +8477,7 @@ tracing_buffers_splice_read(struct file *file, loff_t *ppos,
 	trace_access_lock(iter->cpu_file);
...
@@ -8492,7 +8498,7 @@ tracing_buffers_splice_read(struct file *file, loff_t *ppos,
 		}
...
@@ -8501,14 +8507,14 @@ tracing_buffers_splice_read(struct file *file, loff_t *ppos,
 			break;
 		}

Return-Path: <linux-kernel+bounces-153578-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id C1A888ACFDF
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 16:47:57 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4D52B1F214EA
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 14:47:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 13447152182;
	Mon, 22 Apr 2024 14:47:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="EmU2IE11"
Received: from NAM10-DM6-obe.outbound.protection.outlook.com (mail-dm6nam10on2055.outbound.protection.outlook.com [40.107.93.55])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2DD5F15217C
	for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 14:47:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.93.55
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713797271; cv=fail; b=VF2gMZrdxeQY7jBdp5A/9Q781HCsqAd26sdtJXJYqwm0s7uuByI3on8QdrN+/iaSJWJE0aMWzB0wJ4sf41Q1k+/GnQDsTRqU+oKqlPZ3OsabZQf1KmfkUJq/YF8RzvfBZBzcz6Vqhb4MW0ks1rIz3LtsAfm40s/DgvBjrUTLsUQ=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713797271; c=relaxed/simple;
	bh=PqWbK0yuBJgcrB78fyntY94VNx8G2MfBsTJgzdPbCH0=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=XgcaNmXIqiMrGkWUnQlaHhsyurcXcvaT6jhsHEAvUb2zVQ0MD/v6Cq6/V+3v//ZVkattSE2Nt0ubX/moOwdC/d0tzsBZIILltNM3Frq5rDjapXIT3+3klzsd868XFhMrCLWnIDPJdZtmSlgpO/67QNQHV1+hE0anC68irCLDazE=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=EmU2IE11; arc=fail smtp.client-ip=40.107.93.55
...
X-Microsoft-Antispam-Message-Info:
	=?utf-8?B?ZmJKNTl4T1o5YW5scUErOTlTczVnMmNOOGZ2K1k1ejJiem9pRmVTYVppR0hp?=
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?SkVyZE5iN2ZRTHFobnV1dmM4c3hEK1ZTNVkzUktBOEhwRFVGM3Jxc1ZPdTgr?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Apr 2024 14:47:46.1634
 (UTC)

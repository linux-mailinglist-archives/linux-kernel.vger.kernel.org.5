Return-Path: <linux-kernel+bounces-66608-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F360855EE9
	for <lists+linux-kernel@lfdr.de>; Thu, 15 Feb 2024 11:13:58 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 083661F24EEF
	for <lists+linux-kernel@lfdr.de>; Thu, 15 Feb 2024 10:13:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3B01C6A003;
	Thu, 15 Feb 2024 10:11:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b="cUr2IR/A"
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 470F36A011
	for <linux-kernel@vger.kernel.org>; Thu, 15 Feb 2024 10:11:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.61.82.184
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707991894; cv=none; b=Rg23b6vKcSsTO1vP5Ms7NxS8htCKRjFnvWM4dAN7Lb72b2HEayLce+530iz7WaH2arqqy+6DpE7P45iz9rMdZi7Bw/ka6dX4S2Owu+rvUuZZAt6gWc+AZCGxz5T1rk+6rbsvk17y39mlz/z8uCau1Rsy1CxT8+4JBGH9DE19ZPg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707991894; c=relaxed/simple;
	bh=w40LHJ1vzM8KYnewAkjCmXsAVaCNeNk9uspcrRmbsEA=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=G4i36zY+Y9uGiZA+820qAQeNs1Q+v9wJOAy2bN2/2ck9ThGe21PjneCwtGn9HdyHQKgbmUpCpbidUhR5A214p2SQsHGTC8/DG8u59zd3qhuZDJZBWa7cI+5c9ceGctwv8uQl2v+qFYRF01cqa0cB56x2tu0gPlYQ357ba4NyoiU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com; spf=pass smtp.mailfrom=mediatek.com; dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b=cUr2IR/A; arc=none smtp.client-ip=210.61.82.184
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mediatek.com
X-UUID: 9253d2facbea11eea2298b7352fd921d-20240215
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
	h=Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=k7GSG8F4GUsljl8fwatv0FWuLYxLL+lQMic2cNt5zmw=;
...
X-CID-O-INFO: VERSION:1.1.37,REQID:a7bae21b-80ef-471b-9948-573bba0c30bf,IP:0,U
	RL:0,TC:0,Content:0,EDM:-25,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTIO
	N:release,TS:-25
X-CID-META: VersionHash:6f543d0,CLOUDID:b74d528f-e2c0-40b0-a8fe-7c7e47299109,B
...
Subject: [PATCH v5 07/13] drm/mediatek: Support alpha blending in display driver
...
X-TM-SNTS-SMTP:
	0CDCBDF2AFBA346F7A109E9699FAC315776E24D3610380DA250F2C3C7367766B2000:8
X-MTK: N

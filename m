...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B6AB080E411
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Dec 2023 06:52:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229850AbjLLFwq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Dec 2023 00:52:46 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54092 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229449AbjLLFwp (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Dec 2023 00:52:45 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E6B0599
        for <linux-kernel@vger.kernel.org>; Mon, 11 Dec 2023 21:52:48 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702360368; x=1733896368;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=UrqOi+WLgkl5AimUz0t7EENUj6wDekZ/fRSR3d/KyFk=;
  b=WklWIuURmJ/2IwNEmAEXCewV0AoHOPULGytq/AOrg7pxr4rA+BrdVksX
   BkT8EcjEQC2qUQ5Px3wae7OSpt/PeT36OYUfr1yLv3SVCPchlr8e7kAXe
   aKnPVF4hGRez7t4PuxCydteUk1sryzzXFf+GG5Cld0hzxexw2jxTdxJW1
   iqw8F0empCuDxb0HGedsvtBVb1Ld8Wj7hlqapqOBK6LbCoC6KxrwVKVHW
   o1zIQYXhVclqiibqGXhrVLAs6oBgDK1Dk/3Ttpn2lyPNDwK8uMsXfFF8R
   5ADeyMu7RlbO79U1tN+Mc8wS0QTOe/Yy4wZ3J3ychIiJFYgHhwOGyGm+5
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10921"; a="394507732"
X-IronPort-AV: E=Sophos;i="6.04,269,1695711600"; 
   d="scan'208";a="394507732"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Dec 2023 21:52:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10921"; a="946635876"
X-IronPort-AV: E=Sophos;i="6.04,269,1695711600"; 
   d="scan'208";a="946635876"
Received: from lkp-server02.sh.intel.com (HELO b07ab15da5fe) ([10.239.97.151])
  by orsmga005.jf.intel.com with ESMTP; 11 Dec 2023 21:52:46 -0800
Received: from kbuild by b07ab15da5fe with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1rCvhE-000In5-0h;
        Tue, 12 Dec 2023 05:52:44 +0000
Date:   Tue, 12 Dec 2023 13:51:48 +0800
...
Message-ID: <202312121348.WP5jv2wa-lkp@intel.com>
MIME-Version: 1.0
...
date:   3 years ago
config: powerpc-randconfig-r121-20231107 (https://download.01.org/0day-ci/archive/20231212/202312121348.WP5jv2wa-lkp@intel.com/config)
compiler: powerpc-linux-gcc (GCC) 13.2.0
reproduce: (https://download.01.org/0day-ci/archive/20231212/202312121348.WP5jv2wa-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202312121348.WP5jv2wa-lkp@intel.com/

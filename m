Return-Path: <linux-kernel+bounces-122201-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 12C1E88F367
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 01:05:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 7C3701F29FAC
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 00:05:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 899B6A38;
	Thu, 28 Mar 2024 00:05:51 +0000 (UTC)
...
Received: from mail-il1-f176.google.com (mail-il1-f176.google.com [209.85.166.176])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 05AD517E
	for <linux-kernel@vger.kernel.org>; Thu, 28 Mar 2024 00:05:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711584350; cv=none; b=S103AygqIbbysuyHsXo8fcQ11af+EFnxnudBMeCtZllZsDjc6YnrA62BudS0bB4NO8CXCyncVvUEZSUWWhjTnWtXlQp28Pi71VkgzKcSDCnBXZAK3ZO5zfqNo0fhAyFsW34YKtx9mtc2Ci98Lvms1KDIsllLv0wdcoCDcw++XqY=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org; spf=pass smtp.mailfrom=linuxfoundation.org; dkim=pass (1024-bit key) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.b=GlYgy2ek; arc=none smtp.client-ip=209.85.166.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linuxfoundation.org
Received: by mail-il1-f176.google.com with SMTP id e9e14a558f8ab-3688f1b7848so612635ab.0
        for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 17:05:48 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=SCTMIq8WtfXbFIqQEZh1qfZYEzZdHCH9y3zHSAgcufU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWLDEFnMidzvmuGjNBVh4UoXFKixgNvkR/+DiSyEfgeJHn9zdXbuNnWQ585k03f/WJbf0JDTPIKiH0YNw6/Oz/06Wlz5bQz/ixYAhRl
X-Gm-Message-State: AOJu0Yy/VrOjRL9uVVg5A/AAX8y1CokyOtaSqe45FpvhA6c8zvplN3FG
	GeO5LBVQ92sOogKkFMTtnY1sdlvEY2p/kUMaJ5lT4psAmKwg4wDE5BKeSva30/E=

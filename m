...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4CC1B7973ED
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Sep 2023 17:33:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344010AbjIGPcN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 7 Sep 2023 11:32:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33360 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S245439AbjIGP3b (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 7 Sep 2023 11:29:31 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C8A9A19A8
        for <linux-kernel@vger.kernel.org>; Thu,  7 Sep 2023 08:29:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1694100542; x=1725636542;
  h=date:from:to:cc:subject:message-id;
  bh=OpCHk2nLzxlmFNvFpn0ibnqYjbsW219eeGnnFZvuwBs=;
  b=mx4bPNhq/qMZR36Jp6rIFG9xzIzkSWH/Q0UYh1Lnpcnn/nO7rHMSrDf9
   Ugwrh94w+1LGkPB+LwBgzfQI490eB5icaULVsEovgGqg2wM/215mejqdW
   9lsJE9tHccHKIOVsVh/wUOhMC1Di9VsTX47yvyFORqNdR1iOsWWbMCi/r
   k28HK18mc0og5QTlfCHiLVZfBIgakDDrQ7o7jXfEalKeo9fuQQOlJ43/k
   bDK8XMrRKqHWd9fj/rqxj00tXPcxt87YiJTMENt8TQxJElosaAAaIVnY7
   YmC5Zaa3j2iF+sGXkyztOguSLIENCadtKmKaAQbJxUbj7HBazBUCtmth/
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10825"; a="381113482"
X-IronPort-AV: E=Sophos;i="6.02,235,1688454000"; 
   d="scan'208";a="381113482"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Sep 2023 04:35:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10825"; a="741989020"
X-IronPort-AV: E=Sophos;i="6.02,235,1688454000"; 
   d="scan'208";a="741989020"
...
Date:   Thu, 07 Sep 2023 19:34:23 +0800
From:   kernel test robot <lkp@intel.com>
To:     "x86-ml" <x86@kernel.org>
Cc:     linux-kernel@vger.kernel.org
Subject: [tip:x86/asm] BUILD SUCCESS
 3dae5c43badf285e22f6d88388e8a232a83bdfec
Message-ID: <202309071921.PNhN0iyA-lkp@intel.com>
...
branch HEAD: 3dae5c43badf285e22f6d88388e8a232a83bdfec  x86/asm/bitops: Use __builtin_clz{l|ll} to evaluate constant expressions

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0FF14760CC3
	for <lists+linux-kernel@lfdr.de>; Tue, 25 Jul 2023 10:15:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232578AbjGYIPa (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 25 Jul 2023 04:15:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45302 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232118AbjGYIPV (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 25 Jul 2023 04:15:21 -0400
Received: from mail.loongson.cn (mail.loongson.cn [114.242.206.163])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 0DAFFE64
        for <linux-kernel@vger.kernel.org>; Tue, 25 Jul 2023 01:15:18 -0700 (PDT)
Received: from loongson.cn (unknown [113.200.148.30])
        by gateway (Coremail) with SMTP id _____8BxIvCShL9k+qMJAA--.23214S3;
        Tue, 25 Jul 2023 16:15:14 +0800 (CST)
Received: from linux.localdomain (unknown [113.200.148.30])
        by localhost.localdomain (Coremail) with SMTP id AQAAf8CxLCOOhL9kAFg6AA--.7611S4;
        Tue, 25 Jul 2023 16:15:13 +0800 (CST)
...
Subject: [PATCH v1 2/6] objtool/LoongArch: Implement instruction decoder
Date:   Tue, 25 Jul 2023 16:15:06 +0800
Message-Id: <1690272910-11869-3-git-send-email-yangtiezhu@loongson.cn>
...
X-CM-TRANSID: AQAAf8CxLCOOhL9kAFg6AA--.7611S4
X-CM-SenderInfo: p1dqw3xlh2x3gn0dqz5rrqw2lrqou0/
X-Coremail-Antispam: 1Uk129KBj9fXoWfJFykXw18AF1kGw4kGw47ZFc_yoW8JF18uo
        W8tFyDKw1rJr4Uua1UJrn7JF47Zr1I9rW5A34SvrsYyF45Zw15WrZrCw43W3Wa9w48JrZr
...
beq, bne, blt, bge, bltu, bgeu, beqz, bnez, b, bl and jirl
...
---
 ...
 tools/objtool/arch/loongarch/decode.c   | 245 +++++++++++++++++++++++++++++++-
...
+#include <asm/inst.h>
 ...
 {
@@ -39,21 +41,260 @@ int arch_decode_hint_reg(u8 sp_reg, int *base)
 	return 0;
 }

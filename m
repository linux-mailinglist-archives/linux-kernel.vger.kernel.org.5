Return-Path: <linux-kernel+bounces-57339-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id A219884D720
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 01:24:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id C72B2B23BB5
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 00:24:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DA69E364B8;
	Thu,  8 Feb 2024 00:23:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b="dipC5q6v"
Received: from mail-pf1-f175.google.com (mail-pf1-f175.google.com [209.85.210.175])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 108E7D502
	for <linux-kernel@vger.kernel.org>; Thu,  8 Feb 2024 00:22:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.175
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707351778; cv=none; b=ohwgCfdvL78B9myjJeS/mC+K6Zdu6twBvCG/3JsoLZ2tpohIsPN3MGAc7MOC2oVEBM6fmojb0aOkiACPZsVuYwYdDIpwtVkuAQfakUzUie7N9pzAMADfPwEYmXb9nnaNf/1mZDdQaESAvVDA4guNGP3KA/tNpYr1EP7DnacxVyk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707351778; c=relaxed/simple;
	bh=k9dX1AH+JrR9QJl7J/gQ/AQsn5nI9IWJTFu0J4+wouI=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=GoG8NRa5P51BjpgIoRj3+4DcYqRrez7VFpZ7MfAXSrGrhDzinu3Wb7lCBnr0HxIwbiK+RHy5VSGkqiwVy6AGAn9HjVpajqf1ouAC38LIg4wfDoi0t6/rtyijocD9t+rMUOLQIqXHfW8UvDrYK4xbYs9vhFjIsMGG7G79FaDD2bE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com; spf=pass smtp.mailfrom=rivosinc.com; dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b=dipC5q6v; arc=none smtp.client-ip=209.85.210.175
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=rivosinc.com
Received: by mail-pf1-f175.google.com with SMTP id d2e1a72fcca58-6e054f674b3so944382b3a.1
        for <linux-kernel@vger.kernel.org>; Wed, 07 Feb 2024 16:22:55 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1707351775; x=1707956575; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=y03eo8zm3NyHYWFHIU58L2H6GGWgJwuTHDHwHHQIis4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707351775; x=1707956575;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=y03eo8zm3NyHYWFHIU58L2H6GGWgJwuTHDHwHHQIis4=;
        b=
X-Gm-Message-State: AOJu0Yzfo5bN7EhSN3IhvVdcD27bxkd3la+H/xXYkcPHWJSMoOLCVd6e
	gl5fGQsOP1N4KUuYee7FnahZZqJ/vUTHTlanlLpRvZQbRC6/ttzM6y8hkOe4A5L+n812T3IxK+V
	L
X-Google-Smtp-Source: AGHT+IGvLknlsccQJE0+N36N+sjOvZwEahI9qMsPmMkO2pp8ZyrQDKQLIs/3m5Oce19FintDwSebBA==
X-Received: by 2002:a05:6a00:9399:b0:6e0:4059:f420 with SMTP id ka25-20020a056a00939900b006e04059f420mr4245916pfb.17.1707351774631;
        Wed, 07 Feb 2024 16:22:54 -0800 (PST)
X-Forwarded-Encrypted: i=1; AJvYcCXw70b2jPGgNnZTCQq9+acc8256lS/W6tb6LdKNeO9vVev7hSFAz9gz4jsJ1juak6AAHEAHnfIdVhUI1rllqe8+oKT4asXzEGahXpYGlWYriI0YQO6UV1CenZTiU8dpeRcU7fJpceh8ETxRKXeDqQb4Ap4lzFrpeAYKA/BPEs4jguxgL0quxLwdCeUygg==
Received: from charlie.ba.rivosinc.com ([64.71.180.162])
        by smtp.gmail.com with ESMTPSA id g13-20020aa79dcd000000b006e03a640007sm2272630pfq.71.2024.02.07.16.22.53
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 07 Feb 2024 16:22:53 -0800 (PST)
From: Charlie Jenkins <charlie@rivosinc.com>
Date: Wed, 07 Feb 2024 16:22:51 -0800
Subject: [PATCH v6 2/2] lib: checksum: Use aligned accesses for
...
Message-Id: <20240207-fix_sparse_errors_checksum_tests-v6-2-4caa9629705b@rivosinc.com>
...
X-Mailer: b4 0.12.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1707351771; l=29150;
 i=charlie@rivosinc.com; s=20231120; h=from:subject:message-id;
 bh=k9dX1AH+JrR9QJl7J/gQ/AQsn5nI9IWJTFu0J4+wouI=;
 b=CA0E1qtTVVuWpx+akhcLh5iXX32gn+JzGRAZE5qCtRUshq9pcmBQSdqqLpWuqsWgTukWo10PV
 gqIlvxQbpv0Dmifwhe6e6U0f/yizrS10C6sh0ieLT8URLtGDx8DYl1y

Return-Path: <linux-kernel+bounces-160766-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 92B8B8B4288
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 01:11:07 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 0926F1F22702
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 23:11:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 487C03BBDC;
	Fri, 26 Apr 2024 23:10:55 +0000 (UTC)
...
Received: from mail-pl1-f176.google.com (mail-pl1-f176.google.com [209.85.214.176])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BD6503A1CD
	for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 23:10:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714173054; cv=none; b=QkLCjqE6+O4wlJkEuEk6cDjjd4zLIFhNTjEfcVdwZYuT4Ew6l4yjbv015RsE3gjjlzQBzlsyjW9WcdXi8VRuVz2GXeHKI9VF4LoW4DCBTdlt9TgKM21y05j9R3+kWN2Rv1GbpfAnllD+BWgZQzAr0bKzuASUJ9RMKjcAQeR70Vs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714173054; c=relaxed/simple;
	bh=TCphrKjYXxlWEN2NCob2dqtLGwdv432OtjOv0XccxHE=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=dLihRm3AIVr9w+KM6/kZK4r69wLYX37bgFAoJwIyg+wo+RPDsFplbsSyK5Kvf0jG7VxaVcMPv4omz9oVyGP61zWQvDrlDxxqhUaxwa5lkmxPUunG+vpDhnRYFRt6nQtPtgHRV3pb7buZ5KgaWAULhHORVVVGROoYG6UY72dZ5g4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=kf2jLahA; arc=none smtp.client-ip=209.85.214.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-pl1-f176.google.com with SMTP id d9443c01a7336-1e4c4fb6af3so20269745ad.0
        for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 16:10:51 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=CuTV6L1jExGCcwF2zmpAZoA6sTDj9zYxjotoZnSctqo=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVwcjTyEFGGXTU3D38v2OmFqXDFsg2KpHDSMukS+4NecFAHJ9OnY02EVyDy8weJxOgF9rU409/J9Xm+KNq1ucQXNLwhNM+cdaV8xS9M
X-Gm-Message-State: AOJu0YyBgZcEkhwST2iBfi2l2AvaJ7ZyhiJaSW62xMuBp1M3zXiQSon5
	3B0IA2lkwKqb6HOO1aW3xhzdMIsYy/wvDREvjeoJ+AjcVC1dfm7qRFC+VRxbMw==

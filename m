Return-Path: <linux-kernel+bounces-118138-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B3EA88B654
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 01:49:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 784C3B2C70C
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 22:47:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E812880050;
...
Received: from mail-qt1-f179.google.com (mail-qt1-f179.google.com [209.85.160.179])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EF7257F7E8
	for <linux-kernel@vger.kernel.org>; Mon, 25 Mar 2024 22:47:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.179
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711406832; cv=none; b=ChKG2HYjDKUTs4rvYyZt3ufI7AwVPoGtzbLr5QbTl4DHp67IJsJRBWh8CXeMu+MiOcE0zlWsLbS8M/XUqNepKkzOFf79m3BL5idWdKQk2xfgJyCqcDSgPwVm3kAWD3osSiGUxblDlXs1ANcmQKv4aD5VrLBvggWRGpNTwHd+CQo=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca; spf=pass smtp.mailfrom=ziepe.ca; dkim=pass (2048-bit key) header.d=ziepe.ca header.i=@ziepe.ca header.b=TLMprQLF; arc=none smtp.client-ip=209.85.160.179
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ziepe.ca
Received: by mail-qt1-f179.google.com with SMTP id d75a77b69052e-42f4b66dc9eso27600021cf.2
        for <linux-kernel@vger.kernel.org>; Mon, 25 Mar 2024 15:47:08 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=MlPMTJaNGiZjUvi6saKf2R4Fpag5/u1oxV37EUoykZM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX9rywK/eCWlhXK85HOUta2byyPow6oqOIUmM78CJNJwUg3syNhYV1HzlMx0Jg5W3x3oqyaTa9YNVBGikV+gp1Qm4bSSiwoENpUZIs/
X-Gm-Message-State: AOJu0YzYUKd9edMSsIwBczz7C6HjKpiYt/rkK1TCOD62+FXjqcHjFnY2
	eFkCfaQ12rr0zibbkwduc84bEYYo8joTSLvK2QlqdS/QRFO1ekdxFC4oXq8Lb/o=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2521B7DC8B5
	for <lists+linux-kernel@lfdr.de>; Tue, 31 Oct 2023 09:54:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235483AbjJaIyI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 31 Oct 2023 04:54:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43968 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1343611AbjJaIyE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 31 Oct 2023 04:54:04 -0400
Received: from mail-vs1-xe34.google.com (mail-vs1-xe34.google.com [IPv6:2607:f8b0:4864:20::e34])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 25D9F91
        for <linux-kernel@vger.kernel.org>; Tue, 31 Oct 2023 01:53:57 -0700 (PDT)
Received: by mail-vs1-xe34.google.com with SMTP id ada2fe7eead31-457c2d81f7fso2248622137.3
        for <linux-kernel@vger.kernel.org>; Tue, 31 Oct 2023 01:53:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698742436; x=1699347236; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=fwLdK3eUs6wjC0h63dbLS0DbIDCS00KxivCrGSUTD7Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698742436; x=1699347236;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=fwLdK3eUs6wjC0h63dbLS0DbIDCS00KxivCrGSUTD7Q=;
        b=
X-Gm-Message-State: AOJu0Yy6/Nu2xKCU4U5SNeAS+PBZjlbYhub2fCD9kHzaNRVHvcXzXQ9H
        R+beyMspf4v1xQ9SIE+bqSrTsIxRfuyiBbO1jWw4vw==
X-Google-Smtp-Source: AGHT+IGX8nwWMBddXXTMkyZk/T8rmYFEcAIAsuI6rYZ+L73rb6hbKvpWsMO7ahaRpyCylHtXKpPOPqxzebue1GSbmZw=
X-Received: by 2002:a67:c392:0:b0:457:cd5d:6ab5 with SMTP id
 s18-20020a67c392000000b00457cd5d6ab5mr12010118vsj.23.1698742435123; Tue, 31
 Oct 2023 01:53:55 -0700 (PDT)
MIME-Version: 1.0
References: <80129780abd7432787d0136c2b0a5ada@qianxin.com>
In-Reply-To: <80129780abd7432787d0136c2b0a5ada@qianxin.com>
From:   Marco Elver <elver@google.com>
Date:   Tue, 31 Oct 2023 09:53:17 +0100
Message-ID: <CANpmjNOSBkTtKm_yjFx783RfCEHSPmjcUB7kmvRANFNeCzU5MA@mail.gmail.com>
...
On Tue, 31 Oct 2023 at 09:20, =E6=9F=B3=E8=8F=81=E5=B3=B0 <liujingfeng@qian=
xin.com> wrote:
>
> Hi,here is a null-ptr crash in linux-6.4(commit: 6995e2de6891c724bfeb2db3=
3d7b87775f913ad1) usb driver, the crash address __device_attach+0xa9 transf=
er to code line is linux/drivers/base/dd.c:1006.
>
> Here is the crash info:
> [  942.813508] usb usb1: device_add(1-0:1.0) --> -12
> [  942.814132] general protection fault, probably for non-canonical addre=
ss 0xdffffc0000000021: 0000 [#1] PREEMPT SMP KASAN NOPTI
> [  942.815060] KASAN: null-ptr-deref in range [0x0000000000000108-0x00000=
0000000010f]
> [  942.815665] CPU: 0 PID: 4280 Comm: syz-executor.3 Not tainted 6.4.0 #8
> [  942.816187] Hardware name: QEMU Standard PC (i440FX + PIIX, 1996), BIO=
S 1.13.0-1ubuntu1.1 04/01/2014
> [  942.816909] RIP: 0010:__device_attach+0xa9/0x450
> [  942.817305] Code: e8 03 42 80 3c 20 00 0f 85 3f 03 00 00 48 b8 00 00 0=
0 00 00 fc ff df 4c 8b 65 48 49 8d bc 24 08 01 00 00 48 89 fa 48 c1 ea 03 <=
0f> b6 04 02 84 c0 74 06 0f 8e f8 02 00 00 41 f6 84 24 08 01 00 00
> [  942.819425] RSP: 0018:ffff888116927b98 EFLAGS: 00010206
> [  942.819894] RAX: dffffc0000000000 RBX: 1ffff11022d24f73 RCX: 000000000=
0000000
> [  942.820894] RDX: 0000000000000021 RSI: ffffffff847c3300 RDI: 000000000=
0000108
> [  942.821467] RBP: ffff88811959b078 R08: 0000000000000000 R09: ffffffff8=
60a0097
> [  942.822055] R10: ffff888116927b98 R11: 0000000000000001 R12: 000000000=
0000000
> [  942.822626] R13: ffff88811959b0f8 R14: 00000000fffffff0 R15: 000000000=
0000000
> [  942.823212] FS:  00007f00232a3700(0000) GS:ffff88811ae00000(0000) knlG=
S:0000000000000000
> [  942.823860] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
> [  942.824340] CR2: 00007fff79859fb0 CR3: 000000010a18a005 CR4: 000000000=
0770ef0
> [  942.824907] DR0: 0000000000000000 DR1: 0000000000000000 DR2: 000000000=
0000000
> [  942.825474] DR3: 0000000000000000 DR6: 00000000fffe0ff0 DR7: 000000000=
0000400
> [  942.826056] PKRU: 55555554
> [  942.826294] Call Trace:
> [  942.826507]  <TASK>
> [  942.826691]  ? die_addr+0x38/0xa0
> [  942.826989]  ? exc_general_protection+0x144/0x220
> [  942.827426]  ? asm_exc_general_protection+0x22/0x30
> [  942.827846]  ? __device_attach+0xa9/0x450
> [  942.828202]  ? __device_attach+0x76/0x450
> [  942.828538]  ? __pfx___device_attach+0x10/0x10
> [  942.828907]  ? usb_ifnum_to_if+0x140/0x1d0
> [  942.829267]  proc_ioctl.part.0+0x3ff/0x4a0
> [  942.829614]  usbdev_ioctl+0x178a/0x3f70
> [  942.829961]  ? __pfx_usbdev_ioctl+0x10/0x10
> [  942.830322]  ? __pfx___lock_acquire+0x10/0x10
> [  942.830694]  ? do_vfs_ioctl+0x120/0x1480
> [  942.831035]  ? __pfx_do_vfs_ioctl+0x10/0x10
> [  942.831392]  ? find_held_lock+0x2c/0x110
> [  942.831745]  ? __fget_files+0x1f8/0x420
> [  942.832094]  ? lock_release+0x3c3/0x6a0
> [  942.832420]  ? __pfx_lock_release+0x10/0x10
> [  942.832770]  ? lock_release+0x3c3/0x6a0
> [  942.833118]  ? __fget_files+0x21a/0x420
> [  942.833476]  ? __pfx_usbdev_ioctl+0x10/0x10
> [  942.833846]  __x64_sys_ioctl+0x171/0x1e0
> [  942.834221]  do_syscall_64+0x38/0x90
> [  942.834554]  entry_SYSCALL_64_after_hwframe+0x72/0xdc
> [  942.834994] RIP: 0033:0x4699cd
> [  942.835283] Code: 02 b8 ff ff ff ff c3 66 0f 1f 44 00 00 f3 0f 1e fa 4=
...
> [  942.836760] RSP: 002b:00007f00232a2c58 EFLAGS: 00000246 ORIG_RAX: 0000=
000000000010
> [  942.837378] RAX: ffffffffffffffda RBX: 000000000057c008 RCX: 000000000=
04699cd
> [  942.837972] RDX: 0000000020000180 RSI: 00000000c0105512 RDI: 000000000=
0000003
> [  942.838563] RBP: 00000000004d4a17 R08: 0000000000000000 R09: 000000000=
0000000
> [  942.839155] R10: 0000000000000000 R11: 0000000000000246 R12: 000000000=
057c008
> [  942.839738] R13: 00007ffe93c75b1f R14: 00007ffe93c75cc0 R15: 00007f002=
32a2dc0
> [  942.840350]  </TASK>
>
>
> Here is calling sequence, it looks need to call fault-inject into the sec=
ond ioctl$USBDEVFS_SETCONFIGURATION:
>
> # {Threaded:false Collide:false Repeat:true RepeatTimes:0 Procs:1 Slowdow=
n:1 Sandbox:none Fault:true FaultCall:4 FaultNth:20 Leak:false NetInjection=
:true NetDevices:true NetReset:true Cgroups:true BinfmtMisc:true CloseFDs:t=
rue KCSAN:false DevlinkPCI:true USB:true VhciInjection:true Wifi:true IEEE8=
02154:true Sysctl:true UseTmpDir:true HandleSegv:true Repro:true Trace:fals=
e}
> r0 =3D syz_open_dev$usbfs(&(0x7f0000000600)=3D'/dev/bus/usb/00#/00#\x00',=
 0x8a3, 0x20081)
> ioctl$USBDEVFS_IOCTL(r0, 0xc0105512, &(0x7f0000000140))
> r2 =3D syz_open_dev$usbfs(&(0x7f0000000540)=3D'/dev/bus/usb/00#/00#\x00',=
 0x1ff, 0xb002)
> ioctl$USBDEVFS_SETCONFIGURATION(r2, 0x80045505, &(0x7f0000000040))
> ioctl$USBDEVFS_SETCONFIGURATION(r2, 0x80045505, &(0x7f0000000080)=3D0x1)
> r3 =3D syz_open_dev$usbfs(&(0x7f0000000540)=3D'/dev/bus/usb/00#/00#\x00',=
 0x1ff, 0x9002)
> ioctl$USBDEVFS_IOCTL(r3, 0xc0105512, &(0x7f0000000180)=3D@usbdevfs_connec=
t)
>
> Here is a C source reproducer by syzkaller:
>
...
> }
>
> #define NONFAILING(...) ({ int ok =3D 1; __atomic_fetch_add(&skip_segv, 1=
, __ATOMIC_SEQ_CST); if (_setjmp(segv_env) =3D=3D 0) { __VA_ARGS__; } else =
ok =3D 0; __atomic_fetch_sub(&skip_segv, 1, __ATOMIC_SEQ_CST); ok; })
>
...
>                                 intptr_t res =3D 0;
>         NONFAILING(memcpy((void*)0x20000600, "/dev/bus/usb/00#/00#\000", =
21));
>         res =3D -1;
>         NONFAILING(res =3D syz_open_dev(0x20000600, 0x8a3, 0x20081));
>         if (res !=3D -1)
>                 r[0] =3D res;
>         NONFAILING(*(uint32_t*)0x20000140 =3D 0);
>         NONFAILING(*(uint32_t*)0x20000144 =3D 0x5516);
>         NONFAILING(*(uint64_t*)0x20000148 =3D 0);
>         syscall(__NR_ioctl, r[0], 0xc0105512, 0x20000140ul);
>         NONFAILING(memcpy((void*)0x20000540, "/dev/bus/usb/00#/00#\000", =
21));
>         res =3D -1;
>         NONFAILING(res =3D syz_open_dev(0x20000540, 0x1ff, 0xb002));
>         if (res !=3D -1)
>                 r[1] =3D res;
>         NONFAILING(*(uint32_t*)0x20000040 =3D 0);
>         syscall(__NR_ioctl, r[1], 0x80045505, 0x20000040ul);
>         NONFAILING(*(uint32_t*)0x20000080 =3D 1);
>         inject_fault(20);
>         syscall(__NR_ioctl, r[1], 0x80045505, 0x20000080ul);
>         NONFAILING(memcpy((void*)0x20000540, "/dev/bus/usb/00#/00#\000", =
21));
>         res =3D -1;
>         NONFAILING(res =3D syz_open_dev(0x20000540, 0x1ff, 0x9002));
>         if (res !=3D -1)
>                 r[2] =3D res;
>         NONFAILING(*(uint32_t*)0x20000180 =3D 0);
>         NONFAILING(*(uint32_t*)0x20000184 =3D 0x5517);
>         NONFAILING(*(uint64_t*)0x20000188 =3D 0);
>         syscall(__NR_ioctl, r[2], 0xc0105512, 0x20000180ul);
>         return 0;
> }
>
> Here is my linux-6.4 kernel config:
>
> #
> # Automatically generated file; DO NOT EDIT.
> # Linux/x86 6.4.0 Kernel Configuration
> #
> CONFIG_CC_VERSION_TEXT=3D"gcc (Ubuntu 11.3.0-1ubuntu1~22.04.1) 11.3.0"
> CONFIG_CC_IS_GCC=3Dy
> CONFIG_GCC_VERSION=3D110300
...
d/syzkaller/80129780abd7432787d0136c2b0a5ada%40qianxin.com.

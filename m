Return-Path: <linux-kernel+bounces-164112-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 503FD8B7920
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 16:24:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id BC7DE1F22BDF
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 14:24:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4234A1A38E6;
	Tue, 30 Apr 2024 14:10:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Gs+ENXXK"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A27A61A38C1
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 14:10:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714486220; cv=none; b=cbPRYrQeg/IIRKfSCPkQfrFfxE6shyKdVZF/BCXnEy9ysnDYGugsFT+/Ne197CnlURYTTv30wQSseEqvTbQR1vaCXch088OKIlh1KuRGbXiPEi3PLfSA/vkkuGNgVkIybPEafGta/ko3Ql7yYgoF535xVQWaVinDeiAXNy/d/pg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714486220; c=relaxed/simple;
	bh=hu71cRLsrF73lS4CDqJ4Lb8BdQtcEr9H/WX+SrLm+dc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=sgt+CxLKqER21/5mPE4C9KX/FRikOp67Tp7+SnyMQXck5gxh1z/rnYwKnIOE1j/N3xV1Cyv1g3KAcStv57Cly64chRFDFe6ci7unX4B8Ts+zdTM76sakdS7SU9gd8KniiPMj2caLZma7rwbETAukU4z6MLxaZl1dxB0xjDsNcis=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Gs+ENXXK; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1714486217;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=se781sJDa12XJsILVmnkyuBearyo7jO3MQmJNKl7ch4=;
	b=Gs+ENXXK7NF6x/Mz75hQLxBsXXalI1c+ZD7FeusQAOZOFIYY6uZH8PsqK7GkdWor8bglK5
	AAK/WQ34cvbKVhA8/CRsBMN2Ci+l2Qw+atA1YzS9WSkpTslQ/dMiSeZLltBfoJ6mk5aKGC
	8bZvsO59DOGnLq+S+FmUS8KuUCYc7vU=

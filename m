Return-Path: <linux-kernel+bounces-127771-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 03A948950B2
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 12:49:06 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id AF114B23AB0
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 10:49:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1EC766217D;
	Tue,  2 Apr 2024 10:48:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b="O4RsN9Fl"
Received: from fanzine2.igalia.com (fanzine2.igalia.com [213.97.179.56])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5EDDC5FDA7
	for <linux-kernel@vger.kernel.org>; Tue,  2 Apr 2024 10:48:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.97.179.56
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712054909; cv=none; b=rmqkRtHqVByce6NnMWY0iXfwYSFvRGa3NSHQSNifHs4KWSoiqXz6u4PtIf0U+bnpK1wAAMOcAXP6azCMx9UJRWp+Els/WtjuYB3IbSEcPSy00dWbLv0NX/t8TtgZSLFMf99BsM57oDcBggp6LROpkFr+jjjoKuydczMXHrbKBJU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712054909; c=relaxed/simple;
	bh=1V28BlG8Xm86SQWtDmQBrKT5avqLoHCD+gmrkTUElqU=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=OiKpyjMQfaSGnCFzLXW0h521DJgonCmTUw9r0LOHWyzPPGM2R0pmPcuqLXCmAPGJJLZVWve7cwzZvLJUNmrNaTp9NqwTyiMtKz0dHntAhODcMzYvqxG/h3PgqieI7hD8cD7mgPwP2pfgEpb+RPr798G2/fkXu3a62nwpo0m0LB4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=igalia.com; spf=pass smtp.mailfrom=igalia.com; dkim=pass (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b=O4RsN9Fl; arc=none smtp.client-ip=213.97.179.56

Return-Path: <linux-kernel+bounces-88337-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E70386E02E
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 12:27:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 636E1B2201C
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 11:26:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E66E56CDC2;
	Fri,  1 Mar 2024 11:26:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="EY/8cuB2"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BC7696CDD0
	for <linux-kernel@vger.kernel.org>; Fri,  1 Mar 2024 11:26:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709292398; cv=none; b=JZEymUI5UJTXvYoj61csttv8MLQMjXxPW95tjQ2bub0mmi4tUBk0soR6QI9+/Ok1guuWsxVcUx8ZVVokz2qLGZnAnU+Hun88huSXxYzHaSbnXOryRkYpDSskWuoPfOnfFQKFJReFD21sbGgCW7t+4XQWjeWI3bdhHy6aeDn07M4=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=EY/8cuB2; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-lj1-f198.google.com (mail-lj1-f198.google.com
 ...
 us-mta-230-N9_Kd5MUNaCSRO2yBJgFVw-1; Fri, 01 Mar 2024 06:26:32 -0500
X-MC-Unique: N9_Kd5MUNaCSRO2yBJgFVw-1
Received: by mail-lj1-f198.google.com with SMTP id 38308e7fff4ca-2d298d601adso13557161fa.2
        for <linux-kernel@vger.kernel.org>; Fri, 01 Mar 2024 03:26:32 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=wjYgI2KsgeWuP3sAlk9TqZqYfNa6GCpmBp03vZLpou0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUnW2hyNJYHFXNg26eFLeJfUq++25DdUQJ+VQYsn6MekcwROgcPhuVfM75oblaq6b5bccfK/JGBIIl8mUo1K4gNc/JGGyZY3X7RXyTW
X-Gm-Message-State: AOJu0YxRbjTMFDe1RMWy9v2kYHhre+e75JuC5asqK1ynSnVJQQllMvNp
	wo/Mfhr5eNvtKZ6zxBLMQoykUETerXd7d3TcgceTn9c1CV1rlK6JA8lZ8ROQdL7hYvgZOswp38d
	M2dhGs2pRsePEGyBmi58/NEjHrKaROEC/jYxBmF1yC6KHx2sJbVCNGLo+DvX65Q==
X-Received: by 2002:a2e:95d5:0:b0:2d2:5668:3a40 with SMTP id y21-20020a2e95d5000000b002d256683a40mr942896ljh.4.1709292390401;

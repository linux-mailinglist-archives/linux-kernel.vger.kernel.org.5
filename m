...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 75B1275707C
	for <lists+linux-kernel@lfdr.de>; Tue, 18 Jul 2023 01:25:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230183AbjGQXZy (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 17 Jul 2023 19:25:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43724 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230062AbjGQXZw (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 17 Jul 2023 19:25:52 -0400
Received: from mail-lf1-x12e.google.com (mail-lf1-x12e.google.com [IPv6:2a00:1450:4864:20::12e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5BDE31AC
        for <linux-kernel@vger.kernel.org>; Mon, 17 Jul 2023 16:25:06 -0700 (PDT)
Received: by mail-lf1-x12e.google.com with SMTP id 2adb3069b0e04-4fd32e611e0so4158810e87.0
        for <linux-kernel@vger.kernel.org>; Mon, 17 Jul 2023 16:25:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=atishpatra.org; s=google; t=1689636186; x=1692228186;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=T0vSTddCvpCRB5+yiUAWYvUbtvxTOv2Q4zjZH3DHeeg=;
        b=I/mUjLqy4mLdHkR+BwTOC9b9TZ5wXxeSVspl1j2Zqu3jsQwKW3DoCSqiugdzgoEVWm
         oeY70oMe9WX7hoKzgQTt/msrf/dGJysdm0YUXnhlICEDQOgHG3ckzl1Lagm0FK6Wfqo7
         c1Ueu026ITVD+35nvX4n2T/sCzjiNLb1gxqHY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689636186; x=1692228186;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=T0vSTddCvpCRB5+yiUAWYvUbtvxTOv2Q4zjZH3DHeeg=;
        b=
X-Gm-Message-State: ABy/qLYSNMqta3WiVytL4QJuHorJHlxYQIj5NZ79j2aUF/Yxy/H3voXY
        umIZzmui1wKrxsOGDkImzF41xRdQknjWSyR1p80y
X-Google-Smtp-Source: APBJJlEnOlGbG17t3bsZWN7lS8b9NLFGSd6K+pYqObwoUMfSLiOXoJ40L/qgWyCLgjJKxgZhkFeJ9Be2g3Q/07jG5TY=
X-Received: by 2002:ac2:4c45:0:b0:4eb:46c2:e771 with SMTP id
 o5-20020ac24c45000000b004eb46c2e771mr4215007lfk.14.1689636186128; Mon, 17 Jul
 2023 16:23:06 -0700 (PDT)
MIME-Version: 1.0
References: <20230703124647.215952-1-alexghiti@rivosinc.com> <DDB4EEB8-12A0-4E66-8E96-808E84A82078@remlab.net>
In-Reply-To: <DDB4EEB8-12A0-4E66-8E96-808E84A82078@remlab.net>
From:   Atish Patra <atishp@atishpatra.org>
Date:   Mon, 17 Jul 2023 16:22:54 -0700
Message-ID: <CAOnJCU+ee=FXWp7mz_Tn07TbRBb3eXLFBqyRBAJbhQTO-Jxvrw@mail.gmail.com>
...
On Mon, Jul 17, 2023 at 6:38=E2=80=AFAM R=C3=A9mi Denis-Courmont <remi@reml=
ab.net> wrote:
>
> Hi,
>
> Le 3 juillet 2023 15:46:37 GMT+03:00, Alexandre Ghiti <alexghiti@rivosinc=
.com> a =C3=A9crit :
...
>
> AFAIK, if the default settings breaks user space, the patchset is conside=
red to break user space. That being the case, either this case is deemed sp=
ecial enough that breaking user space is OK, or it is not.
>
...
> If it is not OK, then the only way out that I can think of, consists of t=
rapping and emulating the counters, returning the same sanitised values tha=
t Linux perf would return. Then you can add a kernel config option to disab=
le that trap-and-emulation code in the future.
>
...
> Either way, I don't suppose that there should be an option to be insecure=
ly backward compatible.
>
> >
> >This version needs openSBI v1.3 *and* a kernel fix that went upstream la=
tely
...
> >
> >Changes in v3:
> >- patch 1 now contains the ref to the faulty commit (no Fixes tag as it =
is only a comment), as Andrew suggested
...
> >- Documentation now mentions that time CSR is *always* accessible, whate=
ver the mode, as suggested by Andrew
> >- Removed CYCLEH reference and add TODO for rv32 support, as suggested b=
y Atish
...
> >- Move arch_perf_update_userpage https://lore.kernel.org/lkml/2023061611=
4831.3186980-1-maz@kernel.org/T/

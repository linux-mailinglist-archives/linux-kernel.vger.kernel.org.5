...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D38EA7C6045
	for <lists+linux-kernel@lfdr.de>; Thu, 12 Oct 2023 00:20:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376496AbjJKWUo (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 11 Oct 2023 18:20:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57964 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235187AbjJKWUk (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 11 Oct 2023 18:20:40 -0400
Received: from mail-pg1-x52d.google.com (mail-pg1-x52d.google.com [IPv6:2607:f8b0:4864:20::52d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6DBC8A9
        for <linux-kernel@vger.kernel.org>; Wed, 11 Oct 2023 15:20:33 -0700 (PDT)
Received: by mail-pg1-x52d.google.com with SMTP id 41be03b00d2f7-564af0ac494so258215a12.0
        for <linux-kernel@vger.kernel.org>; Wed, 11 Oct 2023 15:20:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1697062833; x=1697667633; darn=vger.kernel.org;
        h=mime-version:references:in-reply-to:message-id:date:subject:cc:to
         :from:from:to:cc:subject:date:message-id:reply-to;
        bh=dJTGqDDz1pkTmieNfdhYKtzWGMZBdSfjsnGp5o/SJKU=;
        b=OMwJ+TcxF1rsvtps4a4cBTNcu4BwihbjNq0uLzA2c/A0vIzjv6WOAGBnp3v9Dyiil3
         a2yZFN+0l1rJDu6uquQITlvfixVAMyqLeE0g8iTpwdguAcPdSd/lMp+I4Yp8XH6UWy1R
         48HCVTnvyojEJAoeekqXOUBiSiRIr1QoTEd9k=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1697062833; x=1697667633;
        h=mime-version:references:in-reply-to:message-id:date:subject:cc:to
         :from:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=dJTGqDDz1pkTmieNfdhYKtzWGMZBdSfjsnGp5o/SJKU=;
        b=
X-Gm-Message-State: AOJu0YxqW5wyfMmNpEAtHWZekKoN2VC2WX4KL8dGmmDeCyQBFoVO6LHn
        spUh5hctOGOC9B+ZdQhKnMG4dA==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="0000000000005528e10607783b8d"
...

UUvb
--0000000000005528e10607783b8d--

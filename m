Return-Path: <linux-kernel+bounces-81173-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1C7408671A7
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 11:43:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id C67B929325C
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 10:43:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C3B7E1D699;
	Mon, 26 Feb 2024 10:35:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ibm.com header.i=@ibm.com header.b="IY1NUbki"
Received: from mx0b-001b2d01.pphosted.com (mx0b-001b2d01.pphosted.com [148.163.158.5])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DD4E41D553
	for <linux-kernel@vger.kernel.org>; Mon, 26 Feb 2024 10:35:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=148.163.158.5
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708943706; cv=none; b=oYPrE5sBizsic4i+IbElFrQwmsRdop1+OQ01RKhfX8m0N1UQ5yXzMjhjvYYe6B/kdYmQ9rbwj/O6HukscnTecZ7Ttl2Spziimr7Srtcr85mXQeiXlQPWE0O+rJoMb7EB46v4TAaCUN4aN+25Svzr9D2tmP49f3oC1D6yYdeLnuI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708943706; c=relaxed/simple;
	bh=HBmQNYAH2fq1mIoc8hR3t1/A1xJjlK+hGaaGeENmQyA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=dm37slU1oxF3WZ8btfcFEm13iLFu4E7kImadOFiOzoAQ2QATGCT9M3UFaKyp+MWL7s0hL9lt6O6v8N4r/ZXu+nu3oINTs6VdpSmRPRBUZFxOcajNsPq4hQ27Y05quBX1n+NnScqri+G5rnNZc+hd0HWsBUgzaC2SfED2ZgRPano=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.ibm.com; spf=pass smtp.mailfrom=linux.ibm.com; dkim=pass (2048-bit key) header.d=ibm.com header.i=@ibm.com header.b=IY1NUbki; arc=none smtp.client-ip=148.163.158.5

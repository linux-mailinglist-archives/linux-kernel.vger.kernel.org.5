...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 22BF97FBA32
	for <lists+linux-kernel@lfdr.de>; Tue, 28 Nov 2023 13:35:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344555AbjK1MfL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 28 Nov 2023 07:35:11 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54656 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234756AbjK1MfJ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 28 Nov 2023 07:35:09 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DCB05D4B
        for <linux-kernel@vger.kernel.org>; Tue, 28 Nov 2023 04:35:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1701174912; x=1732710912;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references;
  bh=N1m2FgfeJd7EYp9t50bsylaS/HSZzX+QgPDpfP3BPM4=;
  b=Y2F+V4cGHxI8NdikqtP1T448CnkW2C6K0zZjkd/A0ah1ZUR1Me4vexHi
   8R1rirpZVJvvwG+2dHLS2tdFvD7Sf1WapTm9uf45Gdynwk3mcm+3KgUNW
   N12/V3n5kGxwat4qq7cL81e092x/74ui2wJl4x4wJfUXgWFUFzW2Eal3W
   StyAeQa1Sx1B//2PKrFNjVVGBo86xAZ9bd3BG+r3i5s0UGSFY1vdUIVIv
   d2Yb6vQOr0f0LXMwuChxcWbp8MxKgW+iclSCfdCUq6AkQU403UD/h4MLx
   y+gd6i1SUvGai6mvNFrJK0KB9ykb8xK+chM1hdPJy+2S16sZcAfEBXofV
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10907"; a="373086859"
X-IronPort-AV: E=Sophos;i="6.04,233,1695711600"; 
   d="scan'208";a="373086859"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Nov 2023 04:35:12 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.04,233,1695711600"; 
   d="scan'208";a="9935673"
Received: from shsensorbuild2.sh.intel.com ([10.239.134.197])
  by orviesa002.jf.intel.com with ESMTP; 28 Nov 2023 04:35:09 -0800
...
Subject: [PATCH 1/2] mei: Add transport driver for IVSC device
Date:   Tue, 28 Nov 2023 20:34:05 +0800
Message-Id: <1701174846-16316-2-git-send-email-wentong.wu@intel.com>

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6155977B9AA
	for <lists+linux-kernel@lfdr.de>; Mon, 14 Aug 2023 15:21:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229861AbjHNNUk (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Aug 2023 09:20:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48024 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230389AbjHNNU1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Aug 2023 09:20:27 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B5F981715
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 06:19:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1692019168;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=2RDC+QyLnMMHKTWgScU/gURr1SwPSbxOBZTFmsq5BWk=;
        b=Kb77Ts6TTK8MDu2IPB2ROYWkFUC3YqPTJ/Oh7I6Lz6fMlsEHeVyXhHhwCBRkiRWUIhOqgX
        ZDFc4k6ukyODNdsFV36ttaDaKEg6oAApdnu3HYz/0DjMBQBh157y0TqWrJA6BJHYFCCeik
        p5zCVusNXK+mHym35xhS9zo/YIkafuQ=
Received: from mail-lj1-f198.google.com (mail-lj1-f198.google.com
 [209.85.208.198]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-312---sVHLCANquUK6DAkFVE3Q-1; Mon, 14 Aug 2023 09:19:25 -0400
X-MC-Unique: --sVHLCANquUK6DAkFVE3Q-1
Received: by mail-lj1-f198.google.com with SMTP id 38308e7fff4ca-2b6fdb8d0acso8621141fa.0
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 06:19:25 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=2RDC+QyLnMMHKTWgScU/gURr1SwPSbxOBZTFmsq5BWk=;
        b=
X-Gm-Message-State: AOJu0Yyz3hqU90RYvanb53iejSnLvHo70KSXtHWVoztd18NvftTJac2q
        pZD1pSUVIMiq9kBYLYIsQFJVH2Dt832DqyAJkKmnWcMnr03ycTLwKS80BBEr5fD6Yf0R7fud3qA
        GC5BcThttHhAVTY4fPxFAsjIuiLcHl+SXOQ4twWxf
X-Received: by 2002:a05:651c:1c6:b0:2bb:7710:1cea with SMTP id d6-20020a05651c01c600b002bb77101ceamr1994451ljn.0.1692019163126;
...
References: <20230806213107.GFZNARG6moWpFuSJ9W@fat_crate.local>
 ...
 <87r0occhtw.wl-tiwai@suse.de> <CACO55tvbLhn5vC=CpcZbuFEj2cja1=Nt=BKsZmU3+SKgbxoE7Q@mail.gmail.com>
 <87zg2t23js.wl-tiwai@suse.de> <CACO55tvPGx7npsXg+tpDoz=KXQBs4Pwz3h9Bie-vHithcHV5eA@mail.gmail.com>

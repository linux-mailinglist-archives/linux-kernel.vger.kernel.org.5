...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C94947BF2B7
	for <lists+linux-kernel@lfdr.de>; Tue, 10 Oct 2023 08:03:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1442179AbjJJGDC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 10 Oct 2023 02:03:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38638 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1376502AbjJJGDA (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 10 Oct 2023 02:03:00 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EBD729E
        for <linux-kernel@vger.kernel.org>; Mon,  9 Oct 2023 23:02:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1696917777; x=1728453777;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=0G6gt6lnFftW2DcF9mbGWPYV6OT7ANdfn60B606dT2E=;
  b=FWG4ZJA7223ODiinKWYDvVQ++NvTTdpmtrw2yDsotDPhuhcXT9X6sxd4
   SjeeO+J7GNl1QpTfmn1mghE/XtHYugBgMuVeevzMrtkLA0PCtiQapLi7N
   NMBTE/1jAR9OraDG5g5WZUylg5OYzw1bcKyAb3LxYgF7iK45xkgNo7DM7
   LForsjCTRQxMi4tFSXDSV6WxL3NmqnquTu3O3l+o/e/x+SrYgFDbfeYBX
   gExMF9xZCT4TfiWcmJqehWXsPpKNUgHgjJuHJRzCFwT6Ed4inY/ZcpNOH
   QQnMak49nAME/y8PVlza3Wrw5aCIN3J6fPq/Fksgk8WuL7bXo79XVT7uG
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="450810951"
X-IronPort-AV: E=Sophos;i="6.03,211,1694761200"; 
   d="scan'208";a="450810951"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Oct 2023 23:02:57 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="729957281"
X-IronPort-AV: E=Sophos;i="6.03,211,1694761200"; 
   d="scan'208";a="729957281"
Received: from lkp-server02.sh.intel.com (HELO f64821696465) ([10.239.97.151])
  by orsmga006.jf.intel.com with ESMTP; 09 Oct 2023 23:02:56 -0700
Received: from kbuild by f64821696465 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qq5pR-00003m-0p;
        Tue, 10 Oct 2023 06:02:51 +0000
Date:   Tue, 10 Oct 2023 14:01:39 +0800
From:   kernel test robot <lkp@intel.com>
To:     "Eric W. Biederman" <ebiederm@xmission.com>
Cc:     oe-kbuild-all@lists.linux.dev, linux-kernel@vger.kernel.org
Subject: kernel/exit.c:738:45: sparse: sparse: incorrect type in initializer
 (different address spaces)
Message-ID: <202310101346.M4iwTbnP-lkp@intel.com>
MIME-Version: 1.0
...
config: i386-randconfig-061-20230909 (https://download.01.org/0day-ci/archive/20231010/202310101346.M4iwTbnP-lkp@intel.com/config)
compiler: gcc-12 (Debian 12.2.0-14) 12.2.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231010/202310101346.M4iwTbnP-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202310101346.M4iwTbnP-lkp@intel.com/

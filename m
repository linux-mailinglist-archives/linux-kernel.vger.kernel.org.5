Return-Path: <linux-kernel+bounces-59570-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id BAE0384F923
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 17:04:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4B0461F22DFF
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 16:04:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 97C50762C9;
	Fri,  9 Feb 2024 16:03:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="gDfNbXU8"
Received: from out-186.mta0.migadu.com (out-186.mta0.migadu.com [91.218.175.186])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ED51F7AE78
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 16:03:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.186
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707494612; cv=none; b=tUlec56EaN26k8L7h8busRYMgSKXGWzpoLgFjX79c6hv6sgJtiOj8ZmaQh2SkVjq2e9pfaNQIdETdHfD1rAdn7dhiUdW1l+gbbRVjqk9OE9xo/nGDuteAIenl9DR0GyTisXJiRLYzBTJME3svqXe3pZQTUnSpfKZn4nGHw0PKL4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707494612; c=relaxed/simple;
	bh=93lkchCJyb1wt4DyKOA7dMyMB5U4Se+ySx37LwZdkvU=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=GWHi13fNYSKYd3Ag9Vyf5VK2iirL8vhdnlaD0bRY7U1xkNwLjjZ8kaRBGMJSbwTuw4H3Ixynkz8NjWcfUYvuqdKHVT2sj922p2b6Fl4c0/RKPQaWD7PgfT2LxRciq0DrdOM8g9j4LuquA5nfMu/vVavuxWUqbeGkFIXAIOtuFbA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=gDfNbXU8; arc=none smtp.client-ip=91.218.175.186

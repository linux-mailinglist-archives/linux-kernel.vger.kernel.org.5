Return-Path: <linux-kernel+bounces-142794-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 07ACC8A3029
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 16:08:15 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2A8D71C21A00
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 14:08:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1EAE885958;
	Fri, 12 Apr 2024 14:08:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b="e2b0Ys6t"
Received: from MRZP264CU002.outbound.protection.outlook.com (mail-francesouthazon11020003.outbound.protection.outlook.com [52.101.165.3])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BF18150241
	for <linux-kernel@vger.kernel.org>; Fri, 12 Apr 2024 14:08:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=52.101.165.3
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712930888; cv=fail; b=BbzJ7Me2i2nnVEZatQZmEMHfkt0A5sCx8aIYAccSm6ItZAAKwjmDcV5Wu9mWvxMRB12N6X9G4DY4zi0kEiP5uz6C2xkQt2R2PpaujweOSelZwMJ3E7awqugIk43Pri7Jcli2p9WVv0JTKNHzq39Q+FBt2o+/qj/wNDlLnVtIMzs=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712930888; c=relaxed/simple;
	bh=dQksJRu4pj5GWi2/lM/0D38MI0I3gZEb7B09aFO3Yq0=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=frKDkfAigfSq52kc9BryQ5YmdeZN/pmhjxUIX4SA+lqo2RkLoFh9evfj/sIv/17DqQMB7ioPIL0d0WUIdaiahTvCBUwH2zjoMaGMks997szAxyqcntyfpmp17gk4fza6153vHcxwl6/5IRD3v0hxLcMZ9BD6ZtPlOwdzo9uCyRg=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=csgroup.eu; spf=pass smtp.mailfrom=csgroup.eu; dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b=e2b0Ys6t; arc=fail smtp.client-ip=52.101.165.3
...
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?TWNOckRLd2UrZmpGR1V5cndCNXk1UG9zcitOelJ1WHhKUUJLU1Zjbndid01q?=

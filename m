Return-Path: <linux-kernel+bounces-132000-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 48B94898E72
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 20:58:27 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 7F8A7B297DA
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 18:58:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 127F0133286;
	Thu,  4 Apr 2024 18:58:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="VXgLPssg"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AF10B1B7F4
	for <linux-kernel@vger.kernel.org>; Thu,  4 Apr 2024 18:58:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712257098; cv=none; b=WhvpDiTkBacSio2/WhQOspljCGXw6mPAAV+4lDPQeTsqOP1XudPbQbBJQBEjRXn6sCkbPI8iYIRx+OpaP9YmbAUAe9fDQn0GPqLERhweVbhSBvSv6qoGEm1z0TZbPygwqnBalclauXPZfDawNLKmFNXiKBaLtPRMJs4CS6UkfM8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712257098; c=relaxed/simple;
	bh=bW+qYJIcgCeHhAAtpvbzFnMst/WuvYdclKU+v5/Rbv8=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=UjaYP1sJPfwTUlIMIX0ozBE4F6fxeDcQAoT3soBP8pjFMhfW4LqQ0uD8xRha/LHq8WZ4xDT70z1J+NM72c5iBm8Y5fPkYBIZQAwCwTdkoiObhFDvgWJUl141E7Komt91P+y4h8CoypLuCVUfQgHX3iTb06ReUIqRR3pE2km3t1k=
...
Received: from mail-wr1-f69.google.com (mail-wr1-f69.google.com
 ...
 us-mta-303-RPj-ludwM52sY8HaOzsnfw-1; Thu, 04 Apr 2024 14:58:13 -0400
X-MC-Unique: RPj-ludwM52sY8HaOzsnfw-1
Received: by mail-wr1-f69.google.com with SMTP id ffacd0b85a97d-343cd240b2dso292262f8f.2
        for <linux-kernel@vger.kernel.org>; Thu, 04 Apr 2024 11:58:12 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1712257091; x=1712861891;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt
         :content-language:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:x-gm-message-state:from:to:cc:subject
         :date:message-id:reply-to;
        bh=iUpAfMHg+laFfCU8zqN8B3PSMZVWl02POndufzeitW0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUAbOlwS/fjaiE5qG5wxvLozrW2ihSG5XLAL0XO4L/BmUDAmAtqngwiucRXlyMN1C69l0mXQQNFzYnkb1qSmhxjkRDilVgYsZmMnevB
X-Gm-Message-State: AOJu0YxZQHGVXWX0s/tyU0gxPvj7oWURUuYxBcGKmHzJawtSqmML0TlH
	kBTcNOtzKbGxSCyaDKG0Xz2w5cpdk7bpWUM+Uif6UQoeeLcYD6dxXP2ud0GEh6DrLSp93AbpA75
	EfnZKA3CAIPqAmKkPjKDMciffNtnrVjzMB0sPWDpcz7qAtUQKEau5MLsO/XIY8A==
X-Received: by 2002:adf:fa08:0:b0:343:3e49:d6d9 with SMTP id m8-20020adffa08000000b003433e49d6d9mr2425560wrr.47.1712257090522;

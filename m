Return-Path: <linux-kernel+bounces-90303-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 09EBB86FD31
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 10:23:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 285E71C225A7
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 09:23:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EEA46224C7;
...
Received: from mail-pl1-f177.google.com (mail-pl1-f177.google.com [209.85.214.177])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 717E1224D5
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 09:22:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.177
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709544178; cv=none; b=rpCplqe+9rrcmrUYwWRjGzRNdl0RSVqqlUdqzn0ZcZJ6O5r2u1hwOHec/5fhY6ruHXeykQ6iWBLS7/PSSYPirC6BIJZoZij7U5eeobcpgq76MlsMcNGqUQoK2cAqUp+dm/SNB+hQCgHlbl2IfklK5/GF7PRijV+TJHqlUDOcCvg=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=w/rzCx+Z; arc=none smtp.client-ip=209.85.214.177
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pl1-f177.google.com with SMTP id d9443c01a7336-1dccb2edc6dso34427325ad.3
        for <linux-kernel@vger.kernel.org>; Mon, 04 Mar 2024 01:22:56 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ek1Qy4Ek2Nyv1vPfoJh/C4U3d/HEVvBzxEIXrGxKmxc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXMhSyEf5fEMq8zWZlmL8ng30fx1SElJDnekk3MLDPNTM1WCsxfgFSfmwgb163g/S0aQ3VIIyxfkM8V8e4KyW9HQphgx/A3wPJaN1Do
X-Gm-Message-State: AOJu0Yz57eTB82JFFeezjkgLOfgSHiCSLPg7CRymB6rHxepVLw7ddL8a
	eup/+KxzCyy2PUte8uMRaxK+eCzix2glpqZGuooSjaQCHWSaELeY4giGHrUyaw==

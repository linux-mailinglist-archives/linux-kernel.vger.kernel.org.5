Return-Path: <linux-kernel+bounces-162847-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BA748B6153
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 20:46:53 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A0181B21D74
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 18:46:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5518D13AA2C;
	Mon, 29 Apr 2024 18:46:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="1EhD1x/v"
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D06DF13AA3A
	for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 18:46:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714416389; cv=none; b=KcwevMIfO3CeYLGpA6DZ1P0j+C2Gc5NBgBm8uVZh2UP+d6kKypC4i9wdvftPo7HROBUiAF7ra5kqPRDoRMP7tnWcqBUxcWjLQKpUVgD7CsCjPs1M67Mb4lYZUhgnGqRJQpQ5wDWmZr4IF+c2bWWDTb1nfkZGu4p+zpCp8HzJl/8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714416389; c=relaxed/simple;
	bh=C/lc+AGf/Tq5IYjiIijITz1XV9PrHM6TD0L9DK0tCu0=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=tpcmBgfnzsSHL6T0ZpqMY9ATD27NF+vjtTxWtDWggoSXeEUTGrhN35tEzyeJwvE9X9/Eu2FVzq/IwVTBn3fsWC7SVlZcNXmh+hcYeu+hAtrg5a+iU/sqreS0yBnerk9tjF8/UAMVolNUmz5wyUX0dVdBybzoyNaHU0H1RV6xI0c=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=1EhD1x/v; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-61b2ef746c9so88430257b3.1
        for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 11:46:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1714416387; x=1715021187; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=Xf9DU2dnw7wispX/TBVDNkoG04QwKWtFDLd1toiCdnE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1714416387; x=1715021187;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=Xf9DU2dnw7wispX/TBVDNkoG04QwKWtFDLd1toiCdnE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX3tJGBRd5AlwVbm3fwRUm46tvx/u1Mj7A5+SBX++27/B+PAraUsxyU/78gI+Rx6A0WrcXaORlxGt4eeQ6cWNUeqV5enTKQ9xh4pLas
X-Gm-Message-State: AOJu0Yx4tIELljXzksaDvXJqcsNLQ0iPlpwd1sZlF1yW4qsQf5wPWRDT
	CSx/seaCmq38tZWxnIfQ/tZqcSpqEC8bVN7FnHsFGXvwyHw5mO5pFmRFrcteEtqNebPUDIBzj6J
	ZA6TS9w==
X-Google-Smtp-Source: AGHT+IGPydZbUt+b3QmjwSP1/MHEdBLjXwTfCIOYQ6jzhIq0CY7QQKQWfamegHc+V4vpY44Ue8XrBltTY/FS
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:c137:aa10:25e1:8f1e])
 (user=irogers job=sendgmr) by 2002:a81:6cd2:0:b0:618:80c0:1a2e with SMTP id
 h201-20020a816cd2000000b0061880c01a2emr2918407ywc.6.1714416386799; Mon, 29
 Apr 2024 11:46:26 -0700 (PDT)
Date: Mon, 29 Apr 2024 11:46:08 -0700
In-Reply-To: <20240429184614.1224041-1-irogers@google.com>
Message-Id: <20240429184614.1224041-2-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v5 1/7] perf dsos: Switch backing storage to array from rbtree/list

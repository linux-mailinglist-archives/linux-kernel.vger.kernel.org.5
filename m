...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AF6E27FAD18
	for <lists+linux-kernel@lfdr.de>; Mon, 27 Nov 2023 23:12:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234290AbjK0WMS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 27 Nov 2023 17:12:18 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44120 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234095AbjK0WLc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 27 Nov 2023 17:11:32 -0500
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 339ED1BC7
        for <linux-kernel@vger.kernel.org>; Mon, 27 Nov 2023 14:10:22 -0800 (PST)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-5cd6a86a898so55452847b3.3
        for <linux-kernel@vger.kernel.org>; Mon, 27 Nov 2023 14:10:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1701123021; x=1701727821; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=JXR2oFhM/uHSxKU7ZYsum2CdxkOyK81QvnCN2L3U7+w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1701123021; x=1701727821;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=JXR2oFhM/uHSxKU7ZYsum2CdxkOyK81QvnCN2L3U7+w=;
        b=
X-Gm-Message-State: AOJu0Yx3qdO2QZvx22zMiwGBnrh0efYPBNJX7q333emAcBYLrQu51psZ
        APHZyz7WbkRQfSPDTQ6ewDE5bB8/fmsC
X-Google-Smtp-Source: AGHT+IFxzmPn8NJvekEoKBC+APSMWSWl97L6bnJ+KcwJund0U1Xa7U0PaJqhe0ZvxwlCA1U1H0vQAjSbxU6q
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:829:6e77:9093:f39b])
 (user=irogers job=sendgmr) by 2002:a05:690c:3183:b0:5ca:4a99:7008 with SMTP
 id fd3-20020a05690c318300b005ca4a997008mr466925ywb.10.1701123021409; Mon, 27
 Nov 2023 14:10:21 -0800 (PST)
Date:   Mon, 27 Nov 2023 14:08:37 -0800
In-Reply-To: <20231127220902.1315692-1-irogers@google.com>
Message-Id: <20231127220902.1315692-26-irogers@google.com>
Mime-Version: 1.0
References: <20231127220902.1315692-1-irogers@google.com>
X-Mailer: git-send-email 2.43.0.rc1.413.gea7ed67945-goog
Subject: [PATCH v5 25/50] perf maps: Switch from rbtree to lazily sorted array
 for addresses

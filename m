Return-Path: <linux-kernel+bounces-105397-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id D1E4C87DD5E
	for <lists+linux-kernel@lfdr.de>; Sun, 17 Mar 2024 15:14:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D69391C208F1
	for <lists+linux-kernel@lfdr.de>; Sun, 17 Mar 2024 14:14:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DF56E1BDE6;
	Sun, 17 Mar 2024 14:14:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="iTuslJKI"
Received: from mail-ej1-f47.google.com (mail-ej1-f47.google.com [209.85.218.47])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5E0F61BC31
	for <linux-kernel@vger.kernel.org>; Sun, 17 Mar 2024 14:14:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.47
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710684887; cv=none; b=S+PBFfAiogOLqBVwTyytEajXqPl4UcU+Kir4/dbJ3c0T8UjdUXcgKDZn3M2Ta7gf4J9dlDBEnq5omdjhaMA+bZx2N4n1afQ2HYRCOAO+ySMfs7cZMjdxfnOFPu2Qc1uVF5xXDoqbCYrOwRm5wIYW+n6rOexYfXnSEN5VgYmilgw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710684887; c=relaxed/simple;
	bh=/wORN9fk4NSpIrf//CV3kAzZwzRsJa3iVNNdFDZgcvw=;
	h=MIME-Version:From:Date:Message-ID:Subject:To:Cc:Content-Type; b=ABDkFfeJC1w71THpT0nMSsK9Ug8KczKgPQ/hDl2pHWQ4BiMXIR9YRPDCXW+SidYTn379DY5m04piL7QiG7bCTX4GV1O8gYoE8LoPQTXeOPWMfWSLt4CI5UpBC01y+f1bfsdXw/6ixO3v8Ipvy8Om1BdEHAcK9/JwOWfjnFZhifQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=iTuslJKI; arc=none smtp.client-ip=209.85.218.47
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-ej1-f47.google.com with SMTP id a640c23a62f3a-a468226e135so249762666b.0
        for <linux-kernel@vger.kernel.org>; Sun, 17 Mar 2024 07:14:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1710684884; x=1711289684; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:mime-version:from:to:cc:subject
         :date:message-id:reply-to;
        bh=1zF3nxi0Q3cRPTs8wp2JQcTRCUSdcBF94Gi4E5POtwo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1710684884; x=1711289684;
        h=cc:to:subject:message-id:date:from:mime-version:x-gm-message-state
         :from:to:cc:subject:date:message-id:reply-to;
        bh=1zF3nxi0Q3cRPTs8wp2JQcTRCUSdcBF94Gi4E5POtwo=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWbf6fbcluOcOnw0f5BAuUg/PC9RalUGp6QpmBCZCQ3rVcw0qQHpA08p28DJRaiZTKxxG+gWfOCRioamdkxkPrYOVDHaFkfiO0duMnf
X-Gm-Message-State: AOJu0YxushNGKysre11ZqXu+x7bwv6+4J68zuYYwT/+gvzUxO8sTq7fT
	wpqRHlVZncpZCAu9Zwk7pKHS66LzzmkmOoQwA2SmS8FxbOro195H4lH7ROezEDPXbZKfdfQuwPX
	F/E/TDV9OhV9A3b2L562DSfc3j6g=
X-Google-Smtp-Source: AGHT+IF2zrqbF2ciTvduSUrnr62EKOprsFPci0VakjHmjx7JXkrAwvx7hiu0NgGClzXF8d0cV8LvhlJ3MBF/rLpt36U=
X-Received: by 2002:a17:906:22cd:b0:a46:5a46:7512 with SMTP id
 q13-20020a17090622cd00b00a465a467512mr6157800eja.74.1710684883482; Sun, 17
 Mar 2024 07:14:43 -0700 (PDT)
Precedence: bulk
...
Date: Sun, 17 Mar 2024 22:14:31 +0800
Message-ID: <CAKHoSAt6Bma+KFMnitP6uQJJfrzBnyRGW_Py=ZP5FOxuDBQTOw@mail.gmail.com>
Subject: INFO: rcu detected stall in perf_event_open

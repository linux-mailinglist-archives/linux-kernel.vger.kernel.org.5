Return-Path: <linux-kernel+bounces-69223-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 322A68585F2
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 20:05:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 91A51B228EC
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 19:05:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3ACE2137C3B;
	Fri, 16 Feb 2024 19:04:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=xff.cz header.i=@xff.cz header.b="Xo8yth0b"
Received: from vps.xff.cz (vps.xff.cz [195.181.215.36])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BF8CF136658
	for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 19:04:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.181.215.36
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708110279; cv=none; b=TTVe8j91Lrl3Ai6UuBVax2Qt5rAxntPl5gU3x+lRxa79lL2pyXGr0zCYc8lWsEw8d08LPN+9gYuHQNaS3+cZAOqe1pmjk5l5iPKfeprlYj89R7A8bO0C7oz486DCoN8jrHXeMpzpzbjEWt/sIod7n1lh5jxm73T8B5PHFrvS3bA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708110279; c=relaxed/simple;
	bh=gzfy6/vvZoRzl37dLBsm+GqehoPej8h+i37amwWN5NI=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=FiKvwKERRkM76aly9Snrm6TKrXJKAsuIAyre5ksXtysJYFYbazzXQkd3niAO9aZAJVYzBn1U4hUkEAaL6JPBUjACiEuNIYlC6vEsozajW9z3fUkmgwCEAahfi1eE2QeyNhP7lTIHaniZRYdDBGMwSIPMF0cEYMoHrfoqZeOOk5k=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=xff.cz; spf=pass smtp.mailfrom=xff.cz; dkim=pass (1024-bit key) header.d=xff.cz header.i=@xff.cz header.b=Xo8yth0b; arc=none smtp.client-ip=195.181.215.36
...
Subject: [PATCH 2/3] drm/sun4i: Add more parameters to sunxi_engine commit callback

Return-Path: <linux-kernel+bounces-163526-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 349D08B6C90
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 10:15:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id EB3ECB217D1
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 08:14:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 35611524D9;
	Tue, 30 Apr 2024 08:14:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ffwll.ch header.i=@ffwll.ch header.b="gGPygzeD"
Received: from mail-lf1-f45.google.com (mail-lf1-f45.google.com [209.85.167.45])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 549B247F42
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 08:14:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.45
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714464891; cv=none; b=KhBKdPhP1+2rzq7GMoG0+lUxvrVZawLHShv5GoZn68PmrZgpxW9RItMkp6KGKSnh5qvGf4z1DH3syTn6xTZcIJ/gZFySnNXHx2Knx4Ekz/0h4JPK+lPOi4n56f+QlvMbJ1kyCeSCOFNIcnahMFA6TVOK/MSnsRuKgKMKdkpoPSU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714464891; c=relaxed/simple;
	bh=GHhr+Kg8QPwb2S+8i6A+Ryl3yEbiJCM+EvH+Jz55j1w=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=M1WyJrggFwbr8SnjRi/veN2fi1W/r18q4voXhg1kVZ0ku1BdoFhv1QmycmUPVKYrewMikSBpT9Y12ySO0vKn5o5+k+KOvTwoq8Vxs38XMe66ZYidm/cTbAdZ7U3trHRQmsH2sOkaqRF2WYqqf5PsP9PZjOQWcsF3wrHE3LerDRs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ffwll.ch; spf=none smtp.mailfrom=ffwll.ch; dkim=pass (1024-bit key) header.d=ffwll.ch header.i=@ffwll.ch header.b=gGPygzeD; arc=none smtp.client-ip=209.85.167.45
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ffwll.ch
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=ffwll.ch
Received: by mail-lf1-f45.google.com with SMTP id 2adb3069b0e04-51d9af6bf36so305758e87.3
        for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 01:14:48 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8kQTjfd0G9f9yj0lt8lg+AWljdbUaD8NKQmCiyCQ1as=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXvplnWEJznjElKBaQv7COwW+fa+XWIg3Q4QISLd+U+YKQNq0slxcPVNJZYmFO0HTGgJUjlw0HZ1J1yfO+AH04mVNjgFiAZvF3UUi3Y
X-Gm-Message-State: AOJu0Yx/alI+Jwg2dUIWuSfrPcYQjbIJUX7SbMrEKKx90orgaFMx5fZZ
	YRQ+eIHBNpdWo8XZJ6rU7P5OEf8XWVMFEVNtgHpObWObC8RPqU5fNT94ATlGvKo=

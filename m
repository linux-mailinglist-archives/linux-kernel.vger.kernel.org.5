...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 495B17AE4B8
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Sep 2023 06:50:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229679AbjIZEuq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 26 Sep 2023 00:50:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41222 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229461AbjIZEuo (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 26 Sep 2023 00:50:44 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DEA77D9
        for <linux-kernel@vger.kernel.org>; Mon, 25 Sep 2023 21:50:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1695703836; x=1727239836;
  h=date:from:to:cc:subject:message-id:in-reply-to:
   mime-version;
  bh=9IgugYqFNYngyEpAy+Rk3tQSaRpRCV2TJZjQW2LmOiA=;
  b=fopuAkAdLk6l1fHXxUWpk5n1wG1v1IriGdBTIq0Bt1+Kxw/mzrUmQcd4
   omDcbuD8HeQWtoluyJMZPLU1j1PI+tiMY9O676pjW3e2wDjez5GQM70Ec
   QC8owlRYCSpVhZD5cm7Qa78wMsi67V86TUV6FoI0IMWbBD7ljQgGrdQuU
   03FgzCVdxTaIq9mhDW7iMc3GvIkiNyX2t27jct16QxVCMGz3Qykx4KBEz
   vuWuB5H6c1CgxXcqcR+M2DWlynHD9IeinpSMHGR91rSgJQ0QcI11nV3kI
   iKsdFQS3fR9HWTP9OM+SJhinMYt+u1Tk/axmGHWsxhWrHwgaO5VJJSXgA
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="371816373"
X-IronPort-AV: E=Sophos;i="6.03,177,1694761200"; 
   d="scan'208";a="371816373"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Sep 2023 21:50:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="995676710"
X-IronPort-AV: E=Sophos;i="6.03,177,1694761200"; 
   d="scan'208";a="995676710"
Received: from orsmsx602.amr.corp.intel.com ([10.22.229.15])
  by fmsmga006.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 25 Sep 2023 21:50:34 -0700
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 26 Sep 2023 04:50:27.1920
 (UTC)

Return-Path: <linux-kernel+bounces-6865-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B9608819EA8
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 13:08:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7C08E286545
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 12:08:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8593A22303;
	Wed, 20 Dec 2023 12:08:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ImfNdaeS"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D133A21A19
	for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 12:08:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703074117;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=6lDADQU/QwMuzljE6DX09YoExSvuL9lKPAYvW84M09c=;
	b=ImfNdaeSQ7lIpAxNNsMgpcXVUpplBVtNU/0H6PuVSfCy2HqbDoZ2v9dbVrOs65GQvgrTay
	yr24iuGB3mXCrjFWLCHWUzaPu5xgh7/Ca5K2gU5E5qi1remocg5+VNkx8nL9PwnrFkev1q
	Q+K17UoNqW3QrGv2MQzUUAbf16GEaTw=
Received: from mail-wm1-f69.google.com (mail-wm1-f69.google.com
 [209.85.128.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-319-KUZy1NHTPDykZqT5hHtjPw-1; Wed, 20 Dec 2023 07:08:36 -0500
X-MC-Unique: KUZy1NHTPDykZqT5hHtjPw-1
Received: by mail-wm1-f69.google.com with SMTP id 5b1f17b1804b1-40c295f59ceso3376885e9.0
        for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 04:08:36 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703074115; x=1703678915;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=6lDADQU/QwMuzljE6DX09YoExSvuL9lKPAYvW84M09c=;
        b=
X-Gm-Message-State: AOJu0YxSsg5WmpzeUcPomAXt1yQjtmtKuOWdmBLe81qob11UGL4MkH/y
	Y3S2rnflN4gOUfaDknI/tj4ElPjwBkmskjGiFaN+Gftp/hJW/em4jooHz5sglFfJTiIfHu9dy8d
	cQ+P909a3Vdjolkn4eP9QqaWQ
X-Received: by 2002:a05:600c:3f90:b0:40c:5f0d:47bd with SMTP id fs16-20020a05600c3f9000b0040c5f0d47bdmr1548461wmb.156.1703074114933;
        Wed, 20 Dec 2023 04:08:34 -0800 (PST)
X-Google-Smtp-Source: AGHT+IGhD5y65uiRdBitJ5jn1P3rnFg0UKqLI3O5EOj+eZspn4WjjkE7U1CTuzKntl/sEh0Tf12Nyg==
X-Received: by 2002:a05:600c:3f90:b0:40c:5f0d:47bd with SMTP id fs16-20020a05600c3f9000b0040c5f0d47bdmr1548434wmb.156.1703074114392;
        Wed, 20 Dec 2023 04:08:34 -0800 (PST)
Received: from ?IPV6:2003:cb:c73b:eb00:8e25:6953:927:1802? (p200300cbc73beb008e25695309271802.dip0.t-ipconnect.de. [2003:cb:c73b:eb00:8e25:6953:927:1802])
        by smtp.gmail.com with ESMTPSA id az1-20020a05600c600100b0040b5517ae31sm7310959wmb.6.2023.12.20.04.08.30
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 20 Dec 2023 04:08:33 -0800 (PST)
Message-ID: <6f414c1d-41f2-41f9-b02f-68b9f4a8cbe2@redhat.com>
Date: Wed, 20 Dec 2023 13:08:29 +0100
Precedence: bulk

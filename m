...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7F23A78AE90
	for <lists+linux-kernel@lfdr.de>; Mon, 28 Aug 2023 13:16:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229931AbjH1LQM (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 28 Aug 2023 07:16:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36018 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229823AbjH1LP5 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 28 Aug 2023 07:15:57 -0400
Received: from xavier.telenet-ops.be (xavier.telenet-ops.be [IPv6:2a02:1800:120:4::f00:14])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D338EE1
...
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed40:b3d7:dcc4:78fd:953])
        ...
        id ezFn2A00D08ffG601zFnSk; Mon, 28 Aug 2023 13:15:47 +0200
...
Received: from geert by rox.of.borg with local (Exim 4.95)
        ...
        id 1qaWIR-002fhf-8a
        for linux-kernel@vger.kernel.org;
        Mon, 28 Aug 2023 09:04:23 +0200
From:   Geert Uytterhoeven <geert@linux-m68k.org>
To:     linux-kernel@vger.kernel.org
Subject: Build regressions/improvements in v6.5
Date:   Mon, 28 Aug 2023 09:04:23 +0200
Message-Id: <20230828070423.636947-1-geert@linux-m68k.org>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <CAHk-=wgmKhCrdrOCjp=5v9NO6C=PJ8ZTZcCXj09piHzsZ7qqmw@mail.gmail.com>
References: <CAHk-=wgmKhCrdrOCjp=5v9NO6C=PJ8ZTZcCXj09piHzsZ7qqmw@mail.gmail.com>
MIME-Version: 1.0
...
v6.5[1] compared to v6.4[2].

Summarized:
  - build errors: +5/-4
  - build warnings: +44/-19

JFYI, when comparing v6.5[1] to v6.5-rc7[3], the summaries are:
  - build errors: +0/-0
  - build warnings: +0/-0
...
[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/2dde18cd1d8fac735875f2e4987f11817cc0bc2c/ (234 out of 235 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/6995e2de6891c724bfeb2db33d7b87775f913ad1/ (160 out of 235 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/706a741595047797872e669b3101429ab8d378ef/ (all 235 configs)
...
44 warning regressions:
  + .config: warning: override: ARCH_RV32I changes choice state: 4833 => 4973, 4969
...
19 warning improvements:
  - .config: warning: override: reassigning to symbol MIPS_CPS_NS16550_SHIFT: 14424, 14423, 14416 => 14495, 14503

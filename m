Return-Path: <linux-kernel+bounces-70795-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 83E8D859C7C
	for <lists+linux-kernel@lfdr.de>; Mon, 19 Feb 2024 08:00:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id EEABCB2198A
	for <lists+linux-kernel@lfdr.de>; Mon, 19 Feb 2024 06:59:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 740C5208D1;
...
Received: from mail-wm1-f50.google.com (mail-wm1-f50.google.com [209.85.128.50])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6AA32208BE
	for <linux-kernel@vger.kernel.org>; Mon, 19 Feb 2024 06:59:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.50
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708325984; cv=none; b=mLP4rDOORUA7zCSKVJLwnEdgOxOPAFj9w85fC8BFsdm0flOgjBuGPuWszXAmroBucpR2WUiYB4Yj8+yyQqNxGCeBTGWSNi8wULrRnMkQD8pfBkllfr/fu5Gp6Hj0Cc/GMg2aTbsrvAgTNuyYyOaAosJG20B+DeJXzK5yvrUFQ4Q=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=epFrHBKa; arc=none smtp.client-ip=209.85.128.50
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-wm1-f50.google.com with SMTP id 5b1f17b1804b1-4125e435b38so13145795e9.0
        for <linux-kernel@vger.kernel.org>; Sun, 18 Feb 2024 22:59:42 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:from
         ...
         :reply-to;
        bh=AfAV24x7YrRfp7a1aPkTeFhdi55Bp5TvgPp9C25tWp0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX7hYh/+JE+FyJEvS45ipVYw4tmmBqSyZDuBIG9T9mIGdicsuQTz/Hw5/AkLgTuCgMWrn7MpCGoo81OWFSbdTOFKVUMEtne8PUGuKRm
X-Gm-Message-State: AOJu0YwT2NnWSINuHGARCIlx6xk8AhbRwEGIGediNSRHIKsxE2AWhX5h
	8DGqr7w3gq6TFzyvlifjzSeu1gTPvk4MDT3E7FkcdRojgSvMpGZQj4A3AKKjtkY=

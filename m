Return-Path: <linux-kernel+bounces-62340-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id D646C851EB5
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 21:34:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id EBA7FB26F65
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 20:34:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E0B244CDE0;
	Mon, 12 Feb 2024 20:33:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b="t6eV/XOT"
Received: from mail-pf1-f173.google.com (mail-pf1-f173.google.com [209.85.210.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6422E405FB
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 20:33:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707769997; cv=none; b=IMpt0xpkaOnTBZMWToJF57PTFyXro7K0Wa730ifNvjVhh0GTiIpXfgfvBuknfxKuKw4lQ99L1/ugqwqhRBDNHCukGVVd6cg1OzMN3XYUyGaYAUKO0t+dK6ApyulfCWYyksEoK0VKkyWfYYlvzizDSV/maguGQqRtv3DBbv0HzUg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707769997; c=relaxed/simple;
	bh=6zUw/PTFSycim0FvjRNx8t/mWkF3cfra/mUS/Vl5Dr4=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=pH2eT/omqJEoJCole3651YE6qQhn+yIWH5LGXpIwZR0l+fF0zOgJ1O7QUI8ctiiGsa3oRGZMQoPIJZdCCuajBLyAsm+BTIbE80igVxIv5zXmP1YfPxIclOTq2dErq2NdCXYhwaqk8+waEwN5X5rU7dgQJRy+Zfg2JrWhW8Onf+o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com; spf=pass smtp.mailfrom=rivosinc.com; dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b=t6eV/XOT; arc=none smtp.client-ip=209.85.210.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=rivosinc.com
Received: by mail-pf1-f173.google.com with SMTP id d2e1a72fcca58-6e09ea155c5so1779686b3a.2
        for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 12:33:14 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1707769993; x=1708374793; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=wOF350uoGMfAZ3PFgp/cuUWSH/KhMC6g3I8VG7NymAI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707769993; x=1708374793;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=wOF350uoGMfAZ3PFgp/cuUWSH/KhMC6g3I8VG7NymAI=;
        b=
X-Gm-Message-State: AOJu0YwJi1x7vqZblpaMwrdtlmNehnm7z6LLtgb+v2eJ1+EFycOxnFga
	vx/pK4nlHL1q2MxleDwE2CYdSNuj7EMRclRBlo2Z+rmlRfUG0dpUb643rIp2PfM=
X-Google-Smtp-Source: AGHT+IHV5uAXDlGEElvSMdeOICAdHF6AXj7pzpAvtqTptVj2RDEaRBs1K7z7omoO2oK7riGT4rWOzg==
X-Received: by 2002:a05:6a00:4588:b0:6e0:3b48:572d with SMTP id it8-20020a056a00458800b006e03b48572dmr7152402pfb.31.1707769993421;
        Mon, 12 Feb 2024 12:33:13 -0800 (PST)
X-Forwarded-Encrypted: i=1; AJvYcCW96YrnjPAeG5yhxwoSmQyw9CuBnWOMHvOkle/3c7wA3sv0DQ2qqRIRfGluRNJ1GjYVcf96XsUThlI7pfCpxBDyrYlgEXL9hfTCqmHbHrWSKOvgFCCDPUR21qqQAaLSyq5OdxzVBxI2JioPf9umTSysy3TazTPxwuIgcrRiSSlYK0lSDdPxAMJWPQG4r1BOhB0RtTQSKiXyIuTRS1Yo1MRIXmNZ0Ic=
Received: from charlie.ba.rivosinc.com ([64.71.180.162])
        by smtp.gmail.com with ESMTPSA id o15-20020a056a001b4f00b006e09e97b803sm5552506pfv.46.2024.02.12.12.33.12
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 12 Feb 2024 12:33:12 -0800 (PST)
From: Charlie Jenkins <charlie@rivosinc.com>
Date: Mon, 12 Feb 2024 12:33:05 -0800
Subject: [PATCH v7 2/2] lib: checksum: Use aligned accesses for
...
Message-Id: <20240212-fix_sparse_errors_checksum_tests-v7-2-bbd3b8f64746@rivosinc.com>
...
X-Mailer: b4 0.12.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1707769990; l=28504;
 i=charlie@rivosinc.com; s=20231120; h=from:subject:message-id;
 bh=6zUw/PTFSycim0FvjRNx8t/mWkF3cfra/mUS/Vl5Dr4=;
 b=9e76rVFoLqbJFeBB9gI/6pzYCD6RnPbfBAD6rBAl41SkK+5AcsmiJ/+divO8zWaNg5+jPd/Vs
 BdekMiiiGbMDBg1qeMKFQhA9dTpAPV6p/owHjBU/zQKzsx+w4/3FvxM

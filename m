...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BCE0C7A9CF9
	for <lists+linux-kernel@lfdr.de>; Thu, 21 Sep 2023 21:27:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230206AbjIUT1h (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 21 Sep 2023 15:27:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43508 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229914AbjIUT1Z (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 21 Sep 2023 15:27:25 -0400
Received: from mail-ed1-x52c.google.com (mail-ed1-x52c.google.com [IPv6:2a00:1450:4864:20::52c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0E57DA4A96
        for <linux-kernel@vger.kernel.org>; Thu, 21 Sep 2023 10:58:13 -0700 (PDT)
Received: by mail-ed1-x52c.google.com with SMTP id 4fb4d7f45d1cf-52f3ba561d9so2680300a12.1
        for <linux-kernel@vger.kernel.org>; Thu, 21 Sep 2023 10:58:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1695319091; x=1695923891; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=gjA+Mxd9CUA1gMUBtiDdZZJ99kNAYftACXbwoegb0fE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1695319091; x=1695923891;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=gjA+Mxd9CUA1gMUBtiDdZZJ99kNAYftACXbwoegb0fE=;
        b=
X-Gm-Message-State: AOJu0YyDR9f3YPT50dzmb7w6MO3iwPejszOf7Ic28HCigmjiSqZnNj08
        3r+Td72kxunCMxGVyl/pWpps0v7iiyZGw8YIIag2xLvKtCWWl4VAZySBtQ==

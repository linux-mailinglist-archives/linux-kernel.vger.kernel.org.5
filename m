Return-Path: <linux-kernel+bounces-132571-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 27B908996BE
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 09:41:12 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CB9A1284BF8
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 07:41:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B822413C834;
	Fri,  5 Apr 2024 07:40:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="SAErXAND"
Received: from mail-wr1-f42.google.com (mail-wr1-f42.google.com [209.85.221.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1F55912FF64
	for <linux-kernel@vger.kernel.org>; Fri,  5 Apr 2024 07:40:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712302816; cv=none; b=sg1r/4I/oH/cfepQOKP2hnhwRT347SmAX15pvb0JNwPE4Frx2cQ2FBz9edzs3dLc8wDNsxEib3XRgotpo8U111TRgHuXIC7ZkX2VUPd71B8Ulg1G24VZPgFy7eODTmovh1MK7dYSzUQixIrquuJ4zsk+0Zw0vpzWKMIU299JJLU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712302816; c=relaxed/simple;
	bh=WfR3fzgOc+lYO6U7TgwGQD81mZqIEEtqO9tFKn6iuM4=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=WT3aCB3118NzlC+CPiM5N0fUhmPEYnAKLFBmjjopUYqri5rvSTX7vF2x8eS3R2YrB/wmpw9wgxPoPTF23I5+XCYUHPw7N9p+0FwXE2q6opa2JXE12sNsSkuyKspeDs9OWWqeHOdqzjNU7t423l+ULiYmax8/9M1j9tE0wzmvfGY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=SAErXAND; arc=none smtp.client-ip=209.85.221.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-wr1-f42.google.com with SMTP id ffacd0b85a97d-34388753650so850779f8f.3
        for <linux-kernel@vger.kernel.org>; Fri, 05 Apr 2024 00:40:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1712302811; x=1712907611; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=9LP7LwhNxKs9alceF3MwlRSStgVkDK9Wscv2B2RIGfw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1712302811; x=1712907611;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=9LP7LwhNxKs9alceF3MwlRSStgVkDK9Wscv2B2RIGfw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWGeSwnPx1Y8Me10wGXWY9Qh31R9bJ8Q5FstHhykzl1E4yA1u/zhAG/YTnvqjYyadUA6fLy17hsbnUwc3O9oHf4EHnCl35P9SjH8kyO
X-Gm-Message-State: AOJu0YyxINeYW2d9t/uf3qpO6fZC1o+3mOCOjtTmWlpY5gw+4tKo05Yw
	+ZAxxoga+76eCv2XZLxMfNELBSN2KG68LFb0odFsDVIUJ7KnxUdO
X-Google-Smtp-Source: AGHT+IGCsPkWnNAIaosQtxn1qOWpENK8q1HyGVshaAtkMXtouAdNIqkgO9q0XAMS3tK4t7WSCof+KA==
X-Received: by 2002:a05:6000:1864:b0:343:5cac:8d9e with SMTP id d4-20020a056000186400b003435cac8d9emr579813wri.33.1712302811116;
        Fri, 05 Apr 2024 00:40:11 -0700 (PDT)
Received: from localhost.localdomain ([2a06:c701:737b:ef00:2bdf:f41a:ebd1:fb2c])
        by smtp.gmail.com with ESMTPSA id l10-20020adfe58a000000b003434f526cb5sm1311643wrm.95.2024.04.05.00.40.09
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 05 Apr 2024 00:40:10 -0700 (PDT)
...
Subject: [PATCH v3 2/7] staging: pi433: Rename struct pi433_device instances to pi433.
Date: Fri,  5 Apr 2024 10:39:55 +0300
Message-Id: <20240405074000.3481217-3-ikobh7@gmail.com>

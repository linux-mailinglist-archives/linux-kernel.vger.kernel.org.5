Return-Path: <linux-kernel+bounces-14182-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 853BE8218DC
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Jan 2024 10:25:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 29A1C282890
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Jan 2024 09:25:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 712C16AB9;
	Tue,  2 Jan 2024 09:25:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="Ttzh2bqT";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="N5682qh9";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="Ttzh2bqT";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="N5682qh9"
...
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4D10463D0;
	Tue,  2 Jan 2024 09:25:03 +0000 (UTC)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
	t=1704187501; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:

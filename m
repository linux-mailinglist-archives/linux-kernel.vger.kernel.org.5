Return-Path: <linux-kernel+bounces-160522-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D2478B3EA7
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 19:52:24 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9409EB24DC1
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 17:52:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C1EC016DEA6;
	Fri, 26 Apr 2024 17:50:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="fik83fAe"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6DF90171E71
	for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 17:50:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714153821; cv=none; b=fQn8Lpng9GyetUBhJS8R/rQyQwi9nAY2bWHgXVvdtyKjnf9X4XPdTvJBS4vhVD8HFAjXRQgHmW6jtbqeqqPGSz1GWamozXSM6uBXjdCRFOiVwjP+yC3quSAnw59lWd+nOGFkKqOKp1F4SFEs/QSTLz6CngPcvfampyu6uBfK7ww=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714153821; c=relaxed/simple;
	bh=IrOyuos8J+8LPmr7JCCUNriN5z7rzTrPhAAICgTnZ8Q=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=JZR4ztpmAOqmL3dzXp57uywR5iEeIl2+84JieZbFuYmJsP/E7JfsmOT5r/8uSaz1PrYiSVHf7c0w0dXqulERS6sbhSEAO31DBaMfN9BC9L9GQTOgqcLzyJkODLUTDLYSqogNouXL5AbJduJMC1guLkkIU4sGink8r9Iw4XSENHU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=fik83fAe; arc=none smtp.client-ip=170.10.133.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=fik83fAeVJ/yA/Kjj+9uilUVfL2qbx68FJfzGBNy/++GZMNvFVVLou/gjkRL4P2L6sXUde
	Hgb4K9v558WwO95JsAL9FkP84tBYu0K83eeoU9lRXxaC6fIKvWPswq7W9fzlxgmdsz7AeS
	fgeqLqJqm33vvDJD+laKcKUdOcP2OGw=

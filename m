...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 39E297800B7
	for <lists+linux-kernel@lfdr.de>; Fri, 18 Aug 2023 00:03:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1355632AbjHQWCj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 17 Aug 2023 18:02:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39640 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1355512AbjHQWCI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 17 Aug 2023 18:02:08 -0400
Received: from linux.microsoft.com (linux.microsoft.com [13.77.154.182])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 97A8D2698;
        Thu, 17 Aug 2023 15:02:02 -0700 (PDT)
Received: from linuxonhyperv3.guj3yctzbm1etfxqx2vob5hsef.xx.internal.cloudapp.net (linux.microsoft.com [13.77.154.182])
        by linux.microsoft.com (Postfix) with ESMTPSA id 5EAFF211F92C;
        Thu, 17 Aug 2023 15:02:00 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 linux.microsoft.com 5EAFF211F92C
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.microsoft.com;
        s=default; t=1692309720;
        bh=yXtYf8QVoKCx4AIxFz/hZ9AsLy/tZz6mme5mLBMe8sc=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=oJEUyWtvXisokky+XI1GphD6AAvSd+yToI1IinElhzXh0AHeUS1ZTV27GtSpLYOA4
         KgXLwtEuAbII8NDLKUEGgMrFJ4GCSuN0G0GONdUcz94Ek2/pWqNNhZFMjGJOGjFBM6
         lAbXXdRSMxYGhavYAfCcM17yu9Mrnkec7/qehWAA=
...
Subject: [PATCH v2 15/15] Drivers: hv: Add modules to expose /dev/mshv to VMMs running on Hyper-V
Date:   Thu, 17 Aug 2023 15:01:51 -0700
Message-Id: <1692309711-5573-16-git-send-email-nunodasneves@linux.microsoft.com>
...
Module mshv is the parent module to the other two. It provides /dev/mshv, plus
some common hypercall helper code. When one of the child modules is loaded, it
...
Module mshv_root provides APIs for creating and managing child partitions. It
...
new file mode 100644
index 000000000000..48bc215a914c
--- /dev/null

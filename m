...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 271B6784C39
	for <lists+linux-kernel@lfdr.de>; Tue, 22 Aug 2023 23:50:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231418AbjHVVuw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 22 Aug 2023 17:50:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56344 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230444AbjHVVuv (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 22 Aug 2023 17:50:51 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C70C9CD1
        for <linux-kernel@vger.kernel.org>; Tue, 22 Aug 2023 14:50:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1692741049; x=1724277049;
  h=from:to:cc:subject:date:message-id:references:
   in-reply-to:content-id:content-transfer-encoding:
   mime-version;
  bh=cVRP5Nk6awkgXabxnRuQxY8d2GYQ3gf9UzyXM4rl6Jc=;
  b=b8KNayzcDRVOLiv78DiO/UNtbahdCPsxNvCqZ5/Vz1i5U9OYN7NWFx12
   9eFTFmc/TFPekEZO5yhJbngdmFIHI0payNlhyNsOnIVFfOUAEi0bTzaiC
   vHugEjDLqBoeUJYCWXpjOeGtPG68ZnzTFR9h0V2ngpGHeeZ3MyWlU0tdZ
   wpzMmmqoDNXzxRRPO9bHNEVEzIVzF2A05eUX3dmMzzLPo5mWF4rdFUxfB
   zmBCeHlbUfTCgvf0uWz0lyYAfDm3VXtC7YB64RXN845YxTj9FdExpUfnx
   GQDz8MCPbpLYLIOXwHhYBsICAc3yWWcSYgLRVzeCYMdeoK4Q6+MDKqwCL
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10810"; a="354336327"
X-IronPort-AV: E=Sophos;i="6.01,194,1684825200"; 
   d="scan'208";a="354336327"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Aug 2023 14:50:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10810"; a="850781557"
X-IronPort-AV: E=Sophos;i="6.01,194,1684825200"; 
   d="scan'208";a="850781557"
...
To:     "harshit.m.mogalapalli@oracle.com" <harshit.m.mogalapalli@oracle.com>,
        "rbmarliere@gmail.com" <rbmarliere@gmail.com>,
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 22 Aug 2023 21:50:39.1893
 (UTC)

Return-Path: <linux-kernel+bounces-108109-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 46A2D880611
	for <lists+linux-kernel@lfdr.de>; Tue, 19 Mar 2024 21:32:46 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 5BEFBB21E5F
	for <lists+linux-kernel@lfdr.de>; Tue, 19 Mar 2024 20:32:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9A1B23BBC3;
	Tue, 19 Mar 2024 20:32:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="ZyrLRWdB"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B689338F99
	for <linux-kernel@vger.kernel.org>; Tue, 19 Mar 2024 20:32:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710880358; cv=none; b=NpjtRZsdxvlYZnJ4WcHnv8mEfVfCLJlxnZqkTBFRjDmncdh8u+NZhZ5P3jBFK3ZnoCiGswnzmrmSPr6w8II6YWNUyUGtfcVhw01eEQjwFuS9h7IfApRygEY1p0xzS9HvM9KqrpWvVlB5SPiKbbBr24i22nIABLh02R+R+Ti/Fjg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710880358; c=relaxed/simple;
	bh=jl51Jx65J5tyULR4PNJC7HoZKpTsX3eJNnK4CEMrUMI=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=KXjSuq8p6Ee4tdULkH3K0WF4pfVqLYN0V2QZteHx/jxTHFS7oiddJSx3BJjGJCH5RbE7GiNSjC/azbEwr66g0XNAZlxqvm7HHb0Bw4JBmIQsEjT5fVqIviHIlWuv+KQ7A41PMDDds/uL4yNx13jizOa/NdUnyfletBSe3Ra3Ab0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=ZyrLRWdB; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id A8516C433F1;
	Tue, 19 Mar 2024 20:32:37 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1710880358;
	bh=jl51Jx65J5tyULR4PNJC7HoZKpTsX3eJNnK4CEMrUMI=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=ZyrLRWdBq8KJKWKTy35Xo8DkD+AMjorIATrYB9Zojek/hkkWpcwcKVHfgqSmfH5zf
	 ynonC/k05wIqkB6jttH8GdRL/a6xsN5o8GZ+PlkfUQFy6lhbecECwAIsOTKa3mZ9Vt
	 e6zOlUzTnLow7WBzKXbGW2VmevC73AzGrhGiVfQv5xdzrR7PwGVhdqjuKBV8lCowA2
	 ...
	 uzFFdMYbD7HZQ==
Date: Tue, 19 Mar 2024 17:32:34 -0300
...
Message-ID: <Zfn2YmP_MEEbS4ro@x1>
References: <ZfnULIn3XKDq0bpc@x1>
 <CAP-5=fXtwu285_=dLVT5NDP5Ck=3OV0kTBn68p9=mFjjFniRkA@mail.gmail.com>
Precedence: bulk
...
In-Reply-To: <CAP-5=fXtwu285_=dLVT5NDP5Ck=3OV0kTBn68p9=mFjjFniRkA@mail.gmail.com>

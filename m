Return-Path: <linux-kernel+bounces-126887-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A5231894377
	for <lists+linux-kernel@lfdr.de>; Mon,  1 Apr 2024 19:03:58 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 3129A283760
	for <lists+linux-kernel@lfdr.de>; Mon,  1 Apr 2024 17:03:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B626C4AEDF;
	Mon,  1 Apr 2024 17:03:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b="kJ72qQo6"
Received: from fanzine2.igalia.com (fanzine2.igalia.com [213.97.179.56])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5E19F1DFF4
	for <linux-kernel@vger.kernel.org>; Mon,  1 Apr 2024 17:03:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.97.179.56
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711991032; cv=none; b=et6a+B2Bx+RRxnx1msg89d0r2X3E4+4PxwIIebfJcFzo5PA28tla6uCYNj1++rDerc7bGMk5dYE6eBvgWdrqmKUrS78g3GfCbkp4BaMZIyAZK9/e0QuNYoziiHANRFb7YVmvqGCotmt13WRnTqctclnSuKlw8Xtkes+yfLmNMTw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711991032; c=relaxed/simple;
	bh=sOpym9tRoW221gqorjbXoM5dQh8ifZ/a4an8ccQqP2Q=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=FdCWH4eNdj3h0Ea0N/VfTMRW5gfRHZB8qz9CzifgBmLJCMsykp6MAnU49GMZFdQUgLv1XMRh7VzI5RGiRtQXGtaobhyyOADEUBFJLvFNvQwkjJ4gDKp/AU8ZoVWrZ/HLUDyb2hVKoYfdWOBd3wEN2O4h7E1N/gozwMHjLfeCZ54=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=igalia.com; spf=pass smtp.mailfrom=igalia.com; dkim=pass (2048-bit key) header.d=igalia.com header.i=@igalia.com header.b=kJ72qQo6; arc=none smtp.client-ip=213.97.179.56

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DD1EB7803B7
	for <lists+linux-kernel@lfdr.de>; Fri, 18 Aug 2023 04:13:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1357204AbjHRCMd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 17 Aug 2023 22:12:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46696 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1357244AbjHRCMP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 17 Aug 2023 22:12:15 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 31AB33A96
        for <linux-kernel@vger.kernel.org>; Thu, 17 Aug 2023 19:12:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1692324728; x=1723860728;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=z8m9y/HRaK6bNW4o/i1Vr528QwaJeXoe4fcIIgGQ9tA=;
  b=msftZE2Mm3maiZLFOWL0H9m48OA8qKC6lXKmRfFbo0KSRMWxk7AsOZnt
   zgjhAF4HTeXiP8JILSzm+hu/LpUkRNoIFh3xbyanZh/ybeD9rTNyG7Ruz
   q3YS4TyPQkVUNAoat3Xu9fVUbN3eC2vnu9xf5Im6Vz3Aql+L1nosgmYvR
   dRc951PJPO3o3bfs6+fu1O57UIjqirdGD8c62YK2UE5iks8Gj5L/MEBV1
   TSannuWfP7bIC6EDYO25EuUnvSCUVGUqt7UvNtfIfVPaFxBiyMoUSvLwz
   1G8Rk3slxBXPsrhNzRuJdIj+HEa+/gfd9r3u6Pc+oa4/i6b5073kXiEPh
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10805"; a="459344568"
X-IronPort-AV: E=Sophos;i="6.01,181,1684825200"; 
   d="scan'208";a="459344568"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Aug 2023 19:12:07 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10805"; a="804950822"
X-IronPort-AV: E=Sophos;i="6.01,181,1684825200"; 
   d="scan'208";a="804950822"
Received: from lkp-server02.sh.intel.com (HELO a9caf1a0cf30) ([10.239.97.151])
  by fmsmga004.fm.intel.com with ESMTP; 17 Aug 2023 19:12:04 -0700
Received: from kbuild by a9caf1a0cf30 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qWoy4-0001cu-0E;
        Fri, 18 Aug 2023 02:12:04 +0000
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="vZcrQmaYN/ukFcKE"
...
reproduce (this is a W=1 build):
        # https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=66e3a13e7c2c44d0c9dd6bb244680ca7529a8845
        git remote add linus https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git
        git fetch --no-tags linus master
        git checkout 66e3a13e7c2c44d0c9dd6bb244680ca7529a8845
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        make W=1 O=build_dir ARCH=x86_64 olddefconfig
        make W=1 O=build_dir ARCH=x86_64 SHELL=/bin/bash arch/x86/kernel/ kernel/bpf/ net/bpf/

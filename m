Return-Path: <linux-kernel+bounces-53072-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 21FF784A058
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 18:12:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id ACAEE1F230DE
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 17:12:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F076E41748;
...
Received: from mail-ot1-f50.google.com (mail-ot1-f50.google.com [209.85.210.50])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3A2B04503C
	for <linux-kernel@vger.kernel.org>; Mon,  5 Feb 2024 17:12:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.50
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707153154; cv=none; b=gi2riL4iG3qLyxlp1GAIDUnssXr5RkRaiOtartBBb+xMLDEkaIrkWsb2n+MONuVMJHp/m4Nb/39scqYRrzpVKaUvuotaxbSXdVzGRKkIBn/5koXyDRGnQw+03GyGzPjVaKqHD/MEBTULx6/6N1oc6U4aZcKQ5N/47EHygFQjjpg=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca; spf=pass smtp.mailfrom=ziepe.ca; dkim=pass (2048-bit key) header.d=ziepe.ca header.i=@ziepe.ca header.b=POl5+JL/; arc=none smtp.client-ip=209.85.210.50
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ziepe.ca
Received: by mail-ot1-f50.google.com with SMTP id 46e09a7af769-6e1352dd653so3036943a34.2
        for <linux-kernel@vger.kernel.org>; Mon, 05 Feb 2024 09:12:31 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=5qDbIp2yNtXU1RzQ539qXvN5xu3jf0vrl0xdf7V68t0=;
        b=
X-Gm-Message-State: AOJu0YydKtDSHZqOxHy14ZHjjQ9qqHO6hB/trJJ5fHAVbLG/cVWYydxT
	FJz+NJFxKhJ6WuYzTkKekxlDvkhEDGc+cqHap4R1vDlliinIGb/7/yshBKgzpIo=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1C23A78409A
	for <lists+linux-kernel@lfdr.de>; Tue, 22 Aug 2023 14:20:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235680AbjHVMUV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 22 Aug 2023 08:20:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37010 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235671AbjHVMUT (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 22 Aug 2023 08:20:19 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 20212196
        for <linux-kernel@vger.kernel.org>; Tue, 22 Aug 2023 05:20:16 -0700 (PDT)
Message-ID: <20230822121953.976548391@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1692706808;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=cvgwhjBD+/R0SUsh9RaE6AXuLHEnejgVlzbn05G7mGI=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1692706808;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=cvgwhjBD+/R0SUsh9RaE6AXuLHEnejgVlzbn05G7mGI=;
        b=5Nfk3bB8IL1ZbmrXDdBzzXSoLHc07Eh4si2mp7RrXgSMIldEPnxRoab1FII11lpFPNtavw
        eiKjiPxNADUN4FCA==
...
Subject: [patch 1/2] x86/microcode/32: Move early loading after paging enable
References: <20230822121936.476984181@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Tue, 22 Aug 2023 14:20:08 +0200 (CEST)

Return-Path: <linux-kernel+bounces-147512-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E4B38A7570
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 22:22:06 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 973BF1F25274
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 20:22:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D1A7F13C80E;
	Tue, 16 Apr 2024 20:19:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="IMFwx/db"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 28F6413AD2F
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 20:19:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713298786; cv=none; b=IXs+m0n/VTQ1sca5jUwACNUspFUI/XMJb4eEXQyRYSyDVwpt+4hp0OC9Yl2t50pkDaNsWv9MkD9BVLk8hjfASNt4lfp5lhgsLadsqHOaTkLOP0mYA697wX8kaiJF8Oz9U280p5L5uteakR8+BU3BltlIX/McheIK78coDvglRe4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713298786; c=relaxed/simple;
	bh=kBa0ttNLzIYcw56Tj7ZRgDCKQbljsWpNgIINUFwTnJY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=Gnlx/gtfvpbUD7khKLXz550EKAW0CUvSLWYo/nBAH4lfAr1UYtVQdEjYefJYAZV6DHearKqxSK0N8K7Gju8U+uoosXy7U39LH1BHsjjHkUSC4xjKGORazJvXZZqiVug6vFnUsoTTbBFMOi5VkZsx47v+/KyBpDZqAuWUUe2HHa4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=IMFwx/db; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1713298783;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=YQLC+xwt/HGEzdmMe/E3njAwGkq+LzsNlxhiuERSL3g=;
	b=IMFwx/db9YMwAwQJoz0seSyQ5nuv5i9RbZAl+Bkx4UDv4xoB+hmQpWXdlDwBSuIqpIJkvN
	8fIbcOthKFq+/wT/rO8kYa4BMIsF8nTAqtpmByPq6LNWoY6WzkeT46sWCdCTftuz+99NR1
	1DxGW091XYqC/hlzTks2qjZJksQXRWI=

Return-Path: <linux-kernel+bounces-100936-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 9083C879FD1
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 00:51:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id BDBB31F228F5
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 23:51:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2A7BB482F6;
	Tue, 12 Mar 2024 23:49:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="HNvu0Taz"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.14])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 995C14E1DD;
	Tue, 12 Mar 2024 23:49:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.14
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710287384; cv=none; b=b+W+AO4xeYwl4OIV5Wlcs0UoNeqD5k5XRD3Vt6CASGBkKcmgGbwds4tp731jB0yn9AJT9OFhe303DLVCBH6H3Uad1v94MWo2vhLSTMLRu5eOFAOeZ+6xxK4iEquCOj1h4FDnu8SXLO01AlPkY6j3eo1RI4erQP9AV7yrfQopR8Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710287384; c=relaxed/simple;
	bh=HSr/Vtv4RFVUnokdm/6RY8MiOHot6rsc3mmUhwDDUpw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=BfACJt3yRH/DT37Jzn/XBQv1tOzq1TaGwp/BrF/jqY2k4FE6m5VRWVrEZzvqcANpiFfO7jr5f3MFJ1XSAthgXk8msGNGJgRtrU+JgiWHaQ1ZdB4U8ZhGog4qEAmSep1wiiwcpIM7GkIJPIx6VIqKDZuOuXURp4ba7ZTh2nezccQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=HNvu0Taz; arc=none smtp.client-ip=198.175.65.14
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=HSr/Vtv4RFVUnokdm/6RY8MiOHot6rsc3mmUhwDDUpw=;
  b=HNvu0Tazuido6JaofZYy9UEqEUk78gKY5wm58hLDaqyJl+rsVO8P8Dzi
   ODCmqsvNi3d71HBm3ceWaEo0xtC3VdVC84C6v4W2MC7pDGZMHvA06dFTv
   ww7aOiNl2i8CL4vtP/c//zqVN8Dt6oClLuOi/a4o86r+dYuUXEKWiykLA
   nRcmBZ+xG6Eqhdd6qveNK0sI/zA3iRjjZ7rPiOw7F3ZCjeiChSjfkCo1g
   Ycp+lyduXW///Tq8p7ou77r3yOlmEH3+s8dTTyyH3JXXve/irJbPR5utl
   2/jSi0h2+xwU/JfbYeJ9DpVxlCv57iT0RXBynveqwKss1wofKHcpu2Pjp
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="8847716"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="8847716"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
  by orvoesa106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Mar 2024 16:49:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="42715698"
...
Subject: [RFC PATCH v4 6/6] perf vendor events intel: Add MTL metric json files
Date: Tue, 12 Mar 2024 19:49:21 -0400
Message-ID: <20240312234921.812685-7-weilin.wang@intel.com>

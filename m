Return-Path: <linux-kernel+bounces-56831-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3AEAF84CFD8
	for <lists+linux-kernel@lfdr.de>; Wed,  7 Feb 2024 18:40:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3B6221C23136
	for <lists+linux-kernel@lfdr.de>; Wed,  7 Feb 2024 17:40:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1B62C82D6C;
	Wed,  7 Feb 2024 17:40:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=mit.edu header.i=@mit.edu header.b="ElgKNZ5o"
Received: from outgoing.mit.edu (outgoing-auth-1.mit.edu [18.9.28.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 59D4682883
	for <linux-kernel@vger.kernel.org>; Wed,  7 Feb 2024 17:40:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=18.9.28.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707327642; cv=none; b=eeZPyJ0WUbnbB3qnhMS07kcGTJLqjtZuVwWWlWgRzWB0Yq45/lNWzBbZpS8yHqVYqPNRWkqiUs7QsCwbzi3HadkyYwO2nYy8MQATZxzJHq271nsLRHUEe0D/SQHjZ8TaP9Lr3M9QRgD2wU4GV7METQoHJW+ciLiewEDQ0weuMzk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707327642; c=relaxed/simple;
	bh=rpxr7u3oQ1f9tEqbE9lXrYaJvrFwR/A74/ikjVgV3ZM=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=AeyCcatHoTsincDt3C/nQhsDsMl7INhvjwNu6FeOZo/5IPYmztmUqClPW+qar058FzGJ6CZmIWRnYhH9owN8ye5dza3HD6bBIQPZyo7pGEFlhUpEE6p5cHLQVOhPMTwTpuh4WnZEoReaMEPb6ir9rI4al8fxlq48169fmWOWOw4=

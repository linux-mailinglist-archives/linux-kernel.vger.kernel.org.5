Return-Path: <linux-kernel+bounces-165510-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 396E98B8D71
	for <lists+linux-kernel@lfdr.de>; Wed,  1 May 2024 17:46:00 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D8D84285660
	for <lists+linux-kernel@lfdr.de>; Wed,  1 May 2024 15:45:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 219D5131730;
	Wed,  1 May 2024 15:43:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b="QfftHLvu"
Received: from mail-pf1-f180.google.com (mail-pf1-f180.google.com [209.85.210.180])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2A20A130E27
	for <linux-kernel@vger.kernel.org>; Wed,  1 May 2024 15:43:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.180
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714578222; cv=none; b=FqwAVat253xDJPEweIB8UHQATEEeavI+tsHwzM//EB+7WVJEGF1l9AJnYcUEc4YK+QdSFpw4f023M6KuPa47NXRs3vNnTbP2ewpfoO0Jsv7XT+Eiy47jQzWHW3SoIippQkbSDoun5EbEde23eZvrtcC6AlVjcykEI569X37TtYE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714578222; c=relaxed/simple;
	bh=7Yd1PSAW7e+rUqZBTSR1vimgg2dBZCkyx4crswNxR8c=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=h7bv3pSixaoicc6bMc6OJl4Q/llv+tIrHAv/0hX8zHvkKry7cf3njI9QLRa7pxFgLJ+HoWRQqi1jqnA4c9TSRf7zKidiZpD9dIPaoJDMGWFmRTfsAbqtnikDulSV/FQR49ElDthax4U2IRYJxLUX6Hmj7b4Yjd1Q/engIc6RtvU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=QfftHLvu; arc=none smtp.client-ip=209.85.210.180
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-pf1-f180.google.com with SMTP id d2e1a72fcca58-6f3f6aa1437so3391400b3a.3
        for <linux-kernel@vger.kernel.org>; Wed, 01 May 2024 08:43:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google; t=1714578216; x=1715183016; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=pkwrBbfCjOsJ2BvUtkk0pGwMNhz7eA01MHph4bkgbvM=;
        b=QfftHLvuzbhip01YY/4mpgMhrtW3ACqv6pVOyNGV67DAylkXrDpHRAFc6B/NfvVDZc
         E/g+DCXBW0m6gqejREQ5o99e9OR0eAMiL2OA8wRJt0iXZHt05gxfMFPceAQD0ER5AI8t
         qt2W23wQstU/JAc/yRAebBblM3/NkiclxnxTk=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1714578216; x=1715183016;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=pkwrBbfCjOsJ2BvUtkk0pGwMNhz7eA01MHph4bkgbvM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX5HUK0r8g3Req4owKL1QswhWi+Hr2oI0oW1a802vqNL0ESduh/e47lomJO2JemBs2ePkbCHBzH70Dj+eZ9PK0zWn4bug//oqCOXayG
X-Gm-Message-State: AOJu0YzFXRLXk/m8QY/uuoS5FZIZeh12i2DeykxHbmnPXHHnd0ZNdtK6
	N075qFYPJL/yFk6Ci1AK3AvdjQRKClg8S8DaVIbzOCOnL7RsitMMO12cs3SuQg==
X-Google-Smtp-Source: AGHT+IE+cPAgO0n7Exj+VvhBDEtKKsPMuNMW75JMbnx9vpKOFii6L+/WmqUjuhC+NPnJKxrXWBYwCQ==
X-Received: by 2002:a05:6a21:6d94:b0:1a7:7b92:e0ed with SMTP id wl20-20020a056a216d9400b001a77b92e0edmr2967637pzb.51.1714578215641;
        Wed, 01 May 2024 08:43:35 -0700 (PDT)
Received: from dianders.sjc.corp.google.com ([2620:15c:9d:2:e886:8de:19a2:55b0])
        by smtp.gmail.com with ESMTPSA id fb12-20020a056a002d8c00b006f3ec69bc09sm7717924pfb.75.2024.05.01.08.43.33
...
Subject: [PATCH v3 7/9] drm/panel: boe-tv101wum-nl6: Don't use a table for initting panels

Return-Path: <linux-kernel+bounces-163961-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 90E738B769D
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 15:10:41 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A06041C22220
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 13:10:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4C982171652;
	Tue, 30 Apr 2024 13:10:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="QZSnTNuI";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="v7elbcIm";
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="QZSnTNuI";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="v7elbcIm"
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1CA5712C462
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 13:10:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.135.223.131
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714482631; cv=none; b=GfjCtdehgV3wR2/eAM+z2PupSg2wD2mDSrtIiqTgCZlHMagpH+96YeeAkz3mtNiVXD+9ypwgK38yFLEKX8d5JesCPIETk9cKAADwZHg4MHEfxnBcwGNC5sN+YHMTq9AS6PJ1tqIBauPNhyXJCQZaQll328FIVNkUeC2OH/A0BCU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714482631; c=relaxed/simple;
	bh=NGXOrw45kqwwmbv1YT2AxJuxcdwhddhozPvtmXESUzg=;
	h=Date:Message-ID:From:To:Cc:Subject:In-Reply-To:References:
	 MIME-Version:Content-Type; b=CklwNtmHGeNwMqpHRzP2GiqctG31oda798Gx0TdWO2TamL1LXZG5I9RtYwGB81twzwcZubyO3iLhvguH6a9I/l5HrzvnJ7fSNWExb9mG+fp9Fx3pybwNu63OXeEVhzCb031zXQYxJpKQdBA/dIugC1uCt5Yl7UdJVidaWTwTSc8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=suse.de; spf=pass smtp.mailfrom=suse.de; dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b=QZSnTNuI; dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b=v7elbcIm; dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b=QZSnTNuI; dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b=v7elbcIm; arc=none smtp.client-ip=195.135.223.131
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
	t=1714482625; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
...
Cc: <robh+dt@kernel.org>,
	...
	<broonie@kernel.org>,
	<soyer@irl.hu>
Subject: Re: [PATCH v4 3/3] ALSA: hda/tas2781: Firmware load for tas2781 hda driver based on SPI

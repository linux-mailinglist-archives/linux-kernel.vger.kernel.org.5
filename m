Return-Path: <linux-kernel+bounces-60075-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id D145184FF8E
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 23:16:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6D8491F216A8
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 22:16:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 90A61383AF;
	Fri,  9 Feb 2024 22:15:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="OqWnVdxW"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 548EF381CF
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 22:15:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707516939; cv=none; b=avXIo2tQoDZgaDrE8Coss+K+zxoCg+d9FONBId+YAHvTeysvEM/TA/iJLZ9uZBtVI8X3gFrR/W8bW6Y6GPz9BLL9BWSD8zcTPAukfN952ZQ4efx/qhHsswErRgoIhP4FiNzqw57kjlvQGTi3C4owAxbD4pug8PZxKVOU+dQzhxI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707516939; c=relaxed/simple;
	bh=gJjdcDN9SIZ57EMSsnxvz4s6wGh9ngGev4G0JhDn5Lw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=UiEODUYFR5E2Yh+27ZswlcVMZazAn97r6iWwB2nPhhGwxgHr1dN+jdk1yf0IzKZXexQ73TPSYkeleP7ATQzkpL9GDNEMLGhAb4xg9KRhdMDgVkBsSWJIfHF3Eje3firyUYVmww8rmNR7n2xxgH4C8b0V7uN0SXvC8QJv3BqKYm8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=OqWnVdxW; arc=none smtp.client-ip=170.10.129.124

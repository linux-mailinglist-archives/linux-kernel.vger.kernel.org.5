...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 86C4880514B
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Dec 2023 11:54:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376780AbjLEKyW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 5 Dec 2023 05:54:22 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33332 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1376795AbjLEKyP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 5 Dec 2023 05:54:15 -0500
Received: from mail-ej1-x630.google.com (mail-ej1-x630.google.com [IPv6:2a00:1450:4864:20::630])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 36DA418F
        for <linux-kernel@vger.kernel.org>; Tue,  5 Dec 2023 02:54:13 -0800 (PST)
Received: by mail-ej1-x630.google.com with SMTP id a640c23a62f3a-9fa2714e828so726819866b.1
        for <linux-kernel@vger.kernel.org>; Tue, 05 Dec 2023 02:54:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=amarulasolutions.com; s=google; t=1701773651; x=1702378451; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=wSNU+Jq9XEvjoSdX9cIvuPipP71yJs5/klp+ZtYxSM8=;
        b=JksvFYGs2BLB8S8nan/x2UbMkoFw0WFfaBMAHCZT6Eq4iVTwZ1280ERxfxcnQVa99B
         ImIUUYnCd9YYNvkHqKQSYOZ9AYyQ/l2c6BcfulWvJvU7StMsms1+BayZHZkihUTdh1DM
         e37hTiGTt6ovqkRzw8cG667JclcAelO2pQZ+s=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=wSNU+Jq9XEvjoSdX9cIvuPipP71yJs5/klp+ZtYxSM8=;
        b=
X-Gm-Message-State: AOJu0YycwX1v01Rp5hrvc96A5WHsmI0xpItydrZQdUaIU4K4e7/0oJ2k
        OC5zaYamIfqxnlVXAMhgLWlvUbWtY37Yvk5Jtpiu/A==
X-Google-Smtp-Source: AGHT+IE0Z7d4b5Y0OtD2OM3pSXxFX6UcG4c3MTsKSlTNPwh46JoujtK+Dl/sfvZyLmZaUBL3EMjIXw==
X-Received: by 2002:a17:906:4e5a:b0:a19:a19b:55cf with SMTP id g26-20020a1709064e5a00b00a19a19b55cfmr349594ejw.95.1701773651235;
...
Received: from dario-ThinkPad-T14s-Gen-2i.homenet.telecomitalia.it (host-82-54-95-129.retail.telecomitalia.it. [82.54.95.129])
        by smtp.gmail.com with ESMTPSA id n23-20020a170906089700b0099297782aa9sm6413491eje.49.2023.12.05.02.54.10

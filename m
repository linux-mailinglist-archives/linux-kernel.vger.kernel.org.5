Return-Path: <linux-kernel+bounces-36433-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id B048383A0A5
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 05:37:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A39541C26009
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 04:37:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 864C4C155;
	Wed, 24 Jan 2024 04:37:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="d+oau75T"
Received: from mail-pl1-f172.google.com (mail-pl1-f172.google.com [209.85.214.172])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3057FE549
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 04:37:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706071035; cv=none; b=UboegQzGNs4HG7pB0439qAxb5XIoGCA8n4HDfnDPhky5wWSFGIXVXjIu+YISGF+vLscca/AoNZw01wer+FdpjMRfUiJza7IkfBJJUMvd/2ghk3GPv0yZnOnLPh0tdF7ILnkvtCG6wI61hAjAJmW67Iwd7qMXXTH1OtJowI5spms=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706071035; c=relaxed/simple;
	bh=0+7QEnrtEA0ThnqoDJsGvCABoGBmYULuTyuQ7ehrnKI=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=BrdczoScBAulmEZLUmLiG/+0fWsqQyOox15jTH3ZEd92/dITjiCTkAI5Fbt31dpRroie1uwXqjS7VGpe995c2II79YZRyqWObqyxky+g3joyklZYFs/C7rSADGEby2//Z0ikrTFissTN3Z7j4/K2R4EOTrP7+n4EYuFTRN0c3wE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=d+oau75T; arc=none smtp.client-ip=209.85.214.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-pl1-f172.google.com with SMTP id d9443c01a7336-1d5ce88b51cso110575ad.0
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 20:37:13 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=JLmj7MysHRx2l1EP+DjhWCBE3phDUFYCOnPwerSOkKk=;
        b=
X-Gm-Message-State: AOJu0Yyr3qCp4PNBM0li0/+UqU05HSEg1OTXFbrjIRWjPsN01xv7Us/J
	wiOC8BwvT+nP/jGgu14ZhV/XXL52NGt1qyLS3LE8JFCY1wPItkb6TpqJXuFNyxvleTm1NUAasoI

Return-Path: <linux-kernel+bounces-80349-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 21F7486670F
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 00:57:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id C9DE02812F7
	for <lists+linux-kernel@lfdr.de>; Sun, 25 Feb 2024 23:57:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4BA471BC4E;
	Sun, 25 Feb 2024 23:57:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux-foundation.org header.i=@linux-foundation.org header.b="N7kJAuvk"
Received: from mail-ej1-f49.google.com (mail-ej1-f49.google.com [209.85.218.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A32551B94E
	for <linux-kernel@vger.kernel.org>; Sun, 25 Feb 2024 23:57:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708905464; cv=none; b=o5gXHT32UL/S0xHa6OD/69zo/jJgA831FiwCkpM3D3H3evpjkbtQLJjZqqeVx5bCYNphwhtTpxa2VtLkjXkjrITy8s36bpy+HHcuMPoV6yFoYjiL8I5wOCm96zbCfCJGwPqPxwDvGnxI7MxUDV6ExrZtTMLNh7AxNyMOFudKOF8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708905464; c=relaxed/simple;
	bh=o1Lt+BZm1x7SpJJ7YQ6wKMJVZHxLJkYeQpb3XvSX4rs=;
	h=MIME-Version:From:Date:Message-ID:Subject:To:Content-Type; b=Q47mHG5pd/+mpjzCpXz9MnXSax0+y7tZvUo86/6G3V5LmY9VnyJq1F7Gq8SEig1tnQOHgXlKfg+rPD9oGCpN3RNmFFUCRyHHo4oakeQsxpJ9GYK6MKJtlJzJva/iClSVu6XiIpxmd2AvBkPp2uGr1/m5faNktJgRp9k0jKmyzrI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=linux-foundation.org; spf=pass smtp.mailfrom=linuxfoundation.org; dkim=pass (1024-bit key) header.d=linux-foundation.org header.i=@linux-foundation.org header.b=N7kJAuvk; arc=none smtp.client-ip=209.85.218.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=linux-foundation.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linuxfoundation.org
Received: by mail-ej1-f49.google.com with SMTP id a640c23a62f3a-a3e85a76fa8so221931666b.1
        for <linux-kernel@vger.kernel.org>; Sun, 25 Feb 2024 15:57:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google; t=1708905460; x=1709510260; darn=vger.kernel.org;
        h=content-transfer-encoding:to:subject:message-id:date:from
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=Ounv/zZ9VHu8RhMGNnKftpXg5L78Y03jpOdBmbzHJ7s=;
        b=N7kJAuvk4LmM2IgE/BnyHCgS6gHbZcuTicL8xc0+aMJiVfuYkclrn/PpoLHIYrq+Mz
         FyqQ4PvBYytd9zx7LfWxXrSA8Cweo6Iax/gx/3FClLL03EVuhjnil2A75epbeslipzAG
         NEKmLe1f6tHU+6qzyLkwn4H7axb7m/skVj+vY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1708905460; x=1709510260;
        h=content-transfer-encoding:to:subject:message-id:date:from
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Ounv/zZ9VHu8RhMGNnKftpXg5L78Y03jpOdBmbzHJ7s=;
        b=
X-Gm-Message-State: AOJu0YxLqZt5KqF/sMuxjaavgoF3x8J5xO1eXAWVGkh+/7t6LxWLcgSV
	Z9AweE1KTGeYJ8j5d5pLS+xGTerMB17HCQZEcY7dqc3798GYlISWBQxah6xMmEtU64zdcxjbe1R
	6pt9vuA==
X-Google-Smtp-Source: AGHT+IE9xT8Ic9407xkeP4smHukuHgaVawhOdqzBEE2BWasjrBG4Nm1uf4MhPUBWYp0Lm/2cSmZodg==
X-Received: by 2002:a17:907:1704:b0:a3e:792f:3955 with SMTP id le4-20020a170907170400b00a3e792f3955mr3517617ejc.62.1708905459418;
        Sun, 25 Feb 2024 15:57:39 -0800 (PST)
Received: from mail-ed1-f51.google.com (mail-ed1-f51.google.com. [209.85.208.51])
        by smtp.gmail.com with ESMTPSA id vk4-20020a170907cbc400b00a42ed1b8b15sm1802338ejc.211.2024.02.25.15.57.38
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 25 Feb 2024 15:57:38 -0800 (PST)
Received: by mail-ed1-f51.google.com with SMTP id 4fb4d7f45d1cf-5656e5754ccso3011232a12.0
        for <linux-kernel@vger.kernel.org>; Sun, 25 Feb 2024 15:57:38 -0800 (PST)
X-Received: by 2002:a17:906:52cb:b0:a3f:b6f8:3969 with SMTP id
 w11-20020a17090652cb00b00a3fb6f83969mr3208257ejn.9.1708905458025; Sun, 25 Feb
 2024 15:57:38 -0800 (PST)
Precedence: bulk
...
Date: Sun, 25 Feb 2024 15:57:21 -0800
X-Gmail-Original-Message-ID: <CAHk-=whZ=iA6DhijePcW-pJjZ8YD4T5qLpLKVSUT+4gWNm_0sA@mail.gmail.com>
Message-ID: <CAHk-=whZ=iA6DhijePcW-pJjZ8YD4T5qLpLKVSUT+4gWNm_0sA@mail.gmail.com>
Subject: Linux 6.8-rc6
...
rcu-delayed helper
      hfsplus: switch to rcu-delayed unloading of nls and freeing ->s_fs_in=
fo
      afs: fix __afs_break_callback() / afs_drop_open_mmap() race
      nfs: make nfs_set_verifier() safe for use in RCU pathwalk
      nfs: fix UAF on pathwalk running into umount
      procfs: move dropping pde and pid from ->evict_inode() to ->free_inod=
e()
...
Fabio Estevam (2):
      ...
      Revert "arm64: dts: imx8mn-var-som-symphony: Describe the USB-C conne=
ctor"
...
Guenter Roeck (4):
      MAINTAINERS: Drop myself as maintainer of TYPEC port controller drive=
rs
...
Heiko Stuebner (2):
      arm64: dts: rockchip: drop unneeded status from rk3588-jaguar gpio-le=
ds
...
Mario Limonciello (5):
      ...
      platform/x86/amd/pmf: Fix a potential race with policy binary sideloa=
d
...
Nhat Pham (1):
      mm/swap_state: update zswap LRU's protection range with the folio loc=
ked
...
Sabrina Dubroca (5):
      ...
      selftests: tls: add test for peeking past a record of a different typ=
e

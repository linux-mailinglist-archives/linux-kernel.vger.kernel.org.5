Return-Path: <linux-kernel+bounces-83464-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id C1A0B8699CC
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 16:05:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 786E62849A2
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 15:05:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 52EA214CAC4;
	Tue, 27 Feb 2024 15:02:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="diNZSy5K"
Received: from relay5-d.mail.gandi.net (relay5-d.mail.gandi.net [217.70.183.197])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AA344145333
	for <linux-kernel@vger.kernel.org>; Tue, 27 Feb 2024 15:02:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.197
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709046139; cv=none; b=bx/j6Nfur+z/2v3y27ru4eJl4I5SI3zYdadW03IQ75tQX+NoR/vUoFft4KNp2NKIkhvGJZeqqIBBDurEvep9JM87KI9WJaIENAb20XabZQDnRhMhoyWEZZemvFIt9wgoiy19K0G+BSAhdQs2F53sAHp6ZEqtuzw8VNi09DyQL28=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709046139; c=relaxed/simple;
	bh=lSzItFRvCJCiO837Mfbarejos42+yIJANJ+ARNi/0pU=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=niK96EtFi54/QoPDnc+4+lC3NbFiuFRLcvxjO3sYLuF81awwNz6eplLe1ADnWJiao4qBx9VA6Y4uaQ270LFVCZ4MUF5g7EohtDIjlgISjBmWBx/XzEbF/Sj4CXVNcnaIBzt5KovoXaWIitNaN+vLLRKYxjCe2eApOKVcDga69Fo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=diNZSy5K; arc=none smtp.client-ip=217.70.183.197

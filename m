Return-Path: <linux-kernel+bounces-147263-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id C7CED8A71B2
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 18:52:08 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id DC0C6B21562
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 16:52:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7DED412BE9F;
	Tue, 16 Apr 2024 16:52:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="TCExYtqi"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F32CD1F956
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 16:51:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713286319; cv=none; b=j+tBPJDWnwVkSLu0XEDhrpQ/xaE9qkE2qa1LrLTwbf73kcT9Vml7Kgbdi+MkMkRFwfExxKCKhCEhOrMJoijGUsuw5OTl9xsOqsZcg1KZL8dvxpu/FQLxaCdLaCSgGTeF8PMyHtgT4IcWfUrJvHtnCjEhVuM6BrTBvZccfI+K0LI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713286319; c=relaxed/simple;
	bh=zsJUJUHsUii8pk3VPP4/T8lQBZVw2zTFN2rO4MceCCw=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=Denz/s3YVYCCiLZAV/cAI05ANxqPsEYQz4siKlUhPifrpxpRcrj1ZGTEsx8NpSPLGKQXKy3wIQiMTi2XVz4kq8Wsrj1dRnJGquHBT3uaEjQ6QAu7rVGWter8JcPmm0gQWjKPcoMhiDwwJF92Sq5eenunqHobWMmq4ztaFm4mGgI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=TCExYtqi; arc=none smtp.client-ip=10.30.226.201

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8FE9177B74D
	for <lists+linux-kernel@lfdr.de>; Mon, 14 Aug 2023 13:06:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233042AbjHNLF1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Aug 2023 07:05:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59810 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231387AbjHNLFB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Aug 2023 07:05:01 -0400
Received: from mail-pj1-f77.google.com (mail-pj1-f77.google.com [209.85.216.77])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4FB6818F
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 04:05:00 -0700 (PDT)
Received: by mail-pj1-f77.google.com with SMTP id 98e67ed59e1d1-2685bc4f867so4644379a91.0
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 04:05:00 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1692011100; x=1692615900;
        h=to:from:subject:message-id:date:mime-version:x-gm-message-state
         :from:to:cc:subject:date:message-id:reply-to;
        bh=YcKSRohjVIKuuvNZ4BYCYzg+dhK1WKBTv271/C07ueo=;
        b=
X-Gm-Message-State: AOJu0YyLbAh3sQ//bOJes3zdTaf2ZZMLd9SJGgDYKT2XdNHOjutB/Xkn
        IUoZrrjrTUjBLTJCtoQ1saF8qp/lhUnEWABrQw3Std/8gKVD
X-Google-Smtp-Source: AGHT+IFls9/Muz2LlL7JV1SdDr0dgmjubFiddpwsyFJFvHMExufpMlY3+hKJmbNVCQX5KUqv8fymPTNWYdoZcmx/g5V3ag+74fbd
MIME-Version: 1.0
X-Received: by 2002:a17:902:da8f:b0:1bb:b39d:8cb0 with SMTP id
 j15-20020a170902da8f00b001bbb39d8cb0mr3833616plx.1.1692011099839; Mon, 14 Aug
 2023 04:04:59 -0700 (PDT)
Date:   Mon, 14 Aug 2023 04:04:59 -0700
X-Google-Appengine-App-Id: s~syzkaller
X-Google-Appengine-App-Id-Alias: syzkaller
Message-ID: <0000000000008fe2100602e008a4@google.com>
Subject: [syzbot] [mm?] upstream boot error: KASAN: slab-out-of-bounds Read in bootstrap
From:   syzbot <syzbot+2f508e913916096bf53a@syzkaller.appspotmail.com>

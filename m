Return-Path: <linux-kernel+bounces-143301-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BE2498A36F5
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 22:21:10 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 16338B21BB3
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 20:21:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9E07A1514F4;
	Fri, 12 Apr 2024 20:20:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b="QFRcz+Ed"
Received: from mail-il1-f171.google.com (mail-il1-f171.google.com [209.85.166.171])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7A8EE1509B7
	for <linux-kernel@vger.kernel.org>; Fri, 12 Apr 2024 20:20:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712953251; cv=none; b=pfHsYzo4zNKzAes2a0dHlXY3/f/sVwQ95LpKO93FstSV5cqN4jnF14zSeirDpv2vgWW/xLqLrgay+tjHbTUnhlU/k7DpNDl9ZqFHaCvdiFPGm9eB1VuamBzFomTtD32Ki7/S3nw0fYadcg97pmRsvEdAGypHtnY5H0QhKdS7lHM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712953251; c=relaxed/simple;
	bh=rhC/i0iadwEL7dTRicBlO/h67qbFEWpJbLwK1NO3meo=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=J8yB3j3ZaOEFYQKCIcY0qs/jxjMKmY38ZXxJ5Nkvcim/kuN1boxp2vrLNno0pULYgU3g/28DXA84Chur9IUYrTtvZrppvfyhnms1PPP0jLdlX8gh6eY+ZBzsVk/50q6mYTjlgyy8pJf2x/0jxQ20he5dGz5LlVtTfzyrljRIGc4=
...
Received: by mail-il1-f171.google.com with SMTP id e9e14a558f8ab-36a138f237bso4943235ab.0
        for <linux-kernel@vger.kernel.org>; Fri, 12 Apr 2024 13:20:49 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=G4g0asrIwIh0jCELCnJaY/AHU8getaccX1K08gj5vk8=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVdaCUiSFbft/Y86cAL4FTTXo4LWZLZej2PI2sUxMbf7AwV/Xi4t1ey3JhLZknjonWvP4JkZ39ehG0DCR0ooHqnNLExOHB9Ya8nkJeQ
X-Gm-Message-State: AOJu0YyXb1x56dwJJb8Zx/04CMiyS5Soo508vxOQxf0CT1IUAOnxo93Q
	g1OS+H9jacfvhmQ8huDKPsuNt1j9VgSNz9Gaq/NvooNSevwJ7HXlCsQS5a2H1uY=

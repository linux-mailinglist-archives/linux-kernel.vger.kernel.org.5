Return-Path: <linux-kernel+bounces-77225-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 3822C860255
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 20:10:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 996A11F24612
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 19:10:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 728EE54903;
	Thu, 22 Feb 2024 19:09:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="aDikd+rq"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.10])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C9DFC2575B
	for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 19:09:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=198.175.65.10
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708628971; cv=fail; b=WwqK9lMwgR91/Uyd4KSEnnDzYQp6k9N2b/kA1+ApacL4x9uzQCJLhvFyTiU1QHngLDioRu9fWkN1jEZ/uS+mXUS7nlwrUjf3he00OVHMS81OasxJP+w5MDDsPKIuTYjjKr6o5zE/Xf6NkmTZ48X6Q34Bxzft9XIaA2aaPOAcOCE=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708628971; c=relaxed/simple;
	bh=/uQIqYFMFeMPyC7DwE8SzNHtllNO+OXhGmumgx39xDI=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=LE8cqIhLjFpXxSE0dau+dVh9IhY7ul8bit6R7AUnzRxXQop/yRjc7oZ2BPjlKsk8/+f7LWMKyqoQjlDuZRLeou+VWaij0tKuPp+wKKPgQcfHAgJlMSHEk9K3QLE83JHpoB+zwq0ZuorQH57TvFGqYGCs8COeJAQe1CaZMye81oQ=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=aDikd+rq; arc=fail smtp.client-ip=198.175.65.10
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=aDikd+rqiMLSToStdRamAV3/ncanflkPnF85rBgYmSTzeTg+biLB896m
   ...
   2oGq1HQqd/6b9/DeXo5Z5mndU27LV24AdilYWDgOoeIKyLY9IT9unugH8
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10992"; a="20320519"
X-IronPort-AV: E=Sophos;i="6.06,179,1705392000"; 
   d="scan'208";a="20320519"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by orvoesa102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Feb 2024 11:09:30 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10992"; a="913572585"
X-IronPort-AV: E=Sophos;i="6.06,179,1705392000"; 
   d="scan'208";a="913572585"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
  by fmsmga002.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 22 Feb 2024 11:09:29 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Feb 2024 19:09:22.2584
 (UTC)

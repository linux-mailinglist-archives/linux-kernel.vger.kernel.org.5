...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2D5F276B25C
	for <lists+linux-kernel@lfdr.de>; Tue,  1 Aug 2023 12:52:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234236AbjHAKwF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 1 Aug 2023 06:52:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57100 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233956AbjHAKv2 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 1 Aug 2023 06:51:28 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4A3384C12
        for <linux-kernel@vger.kernel.org>; Tue,  1 Aug 2023 03:48:59 -0700 (PDT)
Message-ID: <20230801103817.840601735@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1690886861;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=/3PRh4Uq/w0/mm1OO+9nNoy3VWXLU/1yiwtVumBjbdg=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1690886861;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=/3PRh4Uq/w0/mm1OO+9nNoy3VWXLU/1yiwtVumBjbdg=;
        b=XQ2Q/qov8pX8OaunySoBqXx3TIIR0BwiQKj1l2o/VfgJjoyv1lelZ/PkaMYOVT3iZu9ic5
        Ao3j7902sz5cDRDQ==
...
Subject: [patch V3 49/60] x86/apic: Nuke ack_APIC_irq()
References: <20230801103042.936020332@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Tue,  1 Aug 2023 12:47:41 +0200 (CEST)

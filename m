Return-Path: <linux-kernel+bounces-98060-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BAC3877498
	for <lists+linux-kernel@lfdr.de>; Sun, 10 Mar 2024 01:50:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 21790B20EA0
	for <lists+linux-kernel@lfdr.de>; Sun, 10 Mar 2024 00:50:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C062AA5F;
	Sun, 10 Mar 2024 00:50:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b="GQbP44zN"
Received: from fllv0016.ext.ti.com (fllv0016.ext.ti.com [198.47.19.142])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AC08B7FB
	for <linux-kernel@vger.kernel.org>; Sun, 10 Mar 2024 00:50:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.47.19.142
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710031849; cv=none; b=W0cGrkQVyw8Q2RB0gpr2PoJDhcz1PF+YVFSrbEK1c3zjJz734XaMG+pEr1N7cbz3JcIn/asqZOX/+d3IC3Xq1kcsVWMxUzycVPKZ9wfL1pakWS2AOWLAPZ+PO6cUchmki9dU7QGXWCAgYB4y92R5ZWyGhnn+qMfyVIokHonPZJI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710031849; c=relaxed/simple;
	bh=bbVchnAWOmDf0SY5tz51gU0zBbPFluXdodP+37nox/s=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=Jy7KZ75N1HHADiR4I8K5Ge1YttDHIQixe7RUCNXIy9UsgFNBYByvO9nmZAG0L/PCGswiVaqUL7VhzRy1AQZl61IYT9EO5/SOQzXtzUYXFYFloZfO5qmHCsuC0kFRx994Ycx+47KGt9S03QYDYQ7pYLu1rzmKnu1rTFoJIT0vdIs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ti.com; spf=pass smtp.mailfrom=ti.com; dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b=GQbP44zN; arc=none smtp.client-ip=198.47.19.142

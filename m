Return-Path: <linux-kernel+bounces-98119-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 3EFAE877556
	for <lists+linux-kernel@lfdr.de>; Sun, 10 Mar 2024 05:54:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2A1511C212A3
	for <lists+linux-kernel@lfdr.de>; Sun, 10 Mar 2024 04:54:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 21782DDBD;
	Sun, 10 Mar 2024 04:53:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="Y9elywXD"
Received: from out-183.mta1.migadu.com (out-183.mta1.migadu.com [95.215.58.183])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 90E229445
	for <linux-kernel@vger.kernel.org>; Sun, 10 Mar 2024 04:53:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.183
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710046415; cv=none; b=DGaDcb/XjMfBF+YCsmuOpidbalMIqltlvnJCv8g/ercYllBAISusF73ho7BDziozf7k9Uh9d0iSgOYUAmyq/AbOnJSy4HUAsP4eTngusUybdNWrGrcqSQnqdOLG7VEUZ3ODUNIEUI2bTyi2RQ4HmBJE0bwnNYj5hjR0nGZ20RyQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710046415; c=relaxed/simple;
	bh=+M5/D3rA/Qm/pKCZPYWYSQSBNzUmBrlAdlHD3eIkNA4=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=jfDZoaMdjgBCh8ODsFqtI+FaLJBVx2O+WCLD0oRai+qbIMGILUfV1BFyIxzUCknC6dUCaFBZm5b5JNKnTWbSv00epzQa+y89C48A64nAj7F5vhhK2V4Yx6o4NNcrC/WpIhXnxyHywXt/c5H5bf+2XOtPFOxTL/nBw1V3OGMK4/4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=Y9elywXD; arc=none smtp.client-ip=95.215.58.183

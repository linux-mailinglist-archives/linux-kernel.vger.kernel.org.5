...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8DA4C7ACE93
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Sep 2023 05:03:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229952AbjIYDDl (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 24 Sep 2023 23:03:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38860 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229634AbjIYDDj (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 24 Sep 2023 23:03:39 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AC4A8A3
        for <linux-kernel@vger.kernel.org>; Sun, 24 Sep 2023 20:03:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1695611012; x=1727147012;
  h=date:from:to:cc:subject:message-id;
  bh=ozhME9+B2+43gURxlJCoI798sD8CnYidGuaFd++zfsE=;
  b=OYENCFbx9uteC5TIBsVRedpXURmoSLuafHZvb1DaufTJpXXTHoxpglO1
   shBT48nK0dlwzmyxs8JyIOMXPDU4GzZC+KZTaoJeMtMLONE/KwZhVlIRP
   8ntV+/uOlG1rlHLGmE8ddn4RRS94jJpkpZg7p9gGLzGNDUwt/PRSeX8+A
   LGFjaTVB5BayqQtepRfN91CoPyHw47eYnPJ6h4f1/ImSIMK0cw5OyM/z6
   1GZJLI6nkkLwEOjA0oUD7ELTtwrwBNwsCH4h1hUN+LR9HqcuqKUvZAT7u
   gIco/u8JepA6PXu/KhwxCfLmuJf+dEU7UzdY8WfAQtpyIPWCj393/yGOq
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="445256872"
X-IronPort-AV: E=Sophos;i="6.03,174,1694761200"; 
   d="scan'208";a="445256872"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Sep 2023 20:03:27 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="995205176"
X-IronPort-AV: E=Sophos;i="6.03,174,1694761200"; 
   d="scan'208";a="995205176"
Received: from lkp-server02.sh.intel.com (HELO 32c80313467c) ([10.239.97.151])
  by fmsmga006.fm.intel.com with ESMTP; 24 Sep 2023 20:03:11 -0700
Received: from kbuild by 32c80313467c with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qkbsL-000139-04;
        Mon, 25 Sep 2023 03:03:09 +0000
Date:   Mon, 25 Sep 2023 11:02:39 +0800
From:   kernel test robot <lkp@intel.com>
To:     "x86-ml" <x86@kernel.org>
Cc:     linux-kernel@vger.kernel.org
Subject: [tip:x86/bugs] BUILD SUCCESS
 e2efc8e7d36a38e0a1f7724e74ff7c885963e7ca
Message-ID: <202309251136.cTd3N1fb-lkp@intel.com>
...
branch HEAD: e2efc8e7d36a38e0a1f7724e74ff7c885963e7ca  x86/pti: Fix kernel warnings for pti= and nopti cmdline options

Return-Path: <linux-kernel+bounces-38081-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1602083BAC7
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 08:38:37 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id BAF1F28263A
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 07:38:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9DF7C12B7D;
	Thu, 25 Jan 2024 07:38:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=amd.com header.i=@amd.com header.b="Noin44L0"
Received: from NAM02-BN1-obe.outbound.protection.outlook.com (mail-bn1nam02on2078.outbound.protection.outlook.com [40.107.212.78])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C5F6512B66
	for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 07:38:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.212.78
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706168308; cv=fail; b=YBwqvvgORUYNl3Y1UxD0jj255umrphFgoB0m7gSY1rirw1Cbbzn6aNRQMvD4opp0BJsD7zweUqKd70S+zemkApemspzj9btVPShB/a9WX+vxf6Uj7G+jEh8eyxoKtpdsbeQuK+pm95lnxsLryetw/Xsdsd1YaxTdMWwCF66jqPY=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706168308; c=relaxed/simple;
	bh=MkpDqKqIOi9IcJRrgehBNqok2uQ0FvGT5F3hOkUWkpQ=;
	h=Message-ID:Date:Cc:Subject:To:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=NgSZw0mzkKnQSCzVv78/Ebxc3pcXt3yZ6WSH/AfGOi9V2Ct3FzF0bioOUJHCyF3jCLLLXaC75Cym5hVno0MEkeUplrqwRXXjtAq1HoXCdAMZHeUfGa9s1LPBhtKoy06DYcnlTl8c4rO4movWziYqmCNWIoQdE1Y4/XDey1HWuvE=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=Noin44L0; arc=fail smtp.client-ip=40.107.212.78
...
Cc: majun@amd.com, Sathishkumar S <sathishkumar.sundararaju@amd.com>,
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?dU1nN0Ivc0JNNExra1Y4TW1QOUlQSTJla3JtcncxbjJOc3JkTC9pVzI5MHBI?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 25 Jan 2024 07:38:22.3231
 (UTC)

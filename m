Return-Path: <linux-kernel+bounces-165835-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A9B28B9232
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 01:20:37 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4DF361C21315
	for <lists+linux-kernel@lfdr.de>; Wed,  1 May 2024 23:20:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BCB89168AE6;
	Wed,  1 May 2024 23:20:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="k2nRTaKV"
Received: from mail-qt1-f174.google.com (mail-qt1-f174.google.com [209.85.160.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 454AE17C6B
	for <linux-kernel@vger.kernel.org>; Wed,  1 May 2024 23:20:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714605631; cv=none; b=i9gp9A5AUR2POpulDZ+Kg1J+Afn+lOUgA6YVXg/RDzqhYVzkgoqKn4EKgrGxv7oQoFfeCQzUlaPWjfiVi6H1zWL3aLzopYXGack72WkgSKSIefZWoTl72BIeSJEJNvN311EzE5FEzSYS+9HA5bBWqW71/Aawar06C1clDZYOh5Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714605631; c=relaxed/simple;
	bh=FfAcT60OTZxrBXU3XMCh/Q74J34rQBTTiJHoUDtHV8Y=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=rr2tiOBx3EssQs5cnJGCE9SzoCgK9xwee+Xg9e1DXZAzNjB9GX+OU49E++OlFLCnHChzVVfr/wJTDpNl3sEBgY2CJjRSF1TfUQIRLXTpG4IplCHjv8IKsCJ3JNi1OHhlGu3mpmBO1xhrZ7J/yiI8ipx2etYgIk065ufpevB1Osc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=k2nRTaKV; arc=none smtp.client-ip=209.85.160.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-qt1-f174.google.com with SMTP id d75a77b69052e-439b1c72676so101061cf.1
        for <linux-kernel@vger.kernel.org>; Wed, 01 May 2024 16:20:28 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=NEZkxkwhgtTx0NvMGLlLrfli5x/gWfMQKijcqUJLPFQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCX0KCX91xuavJ9Rrv+Zhov84htGxl/02Xfy+4pbgH9nLtlWUBW0ZSbwR1pc9rAPCvod1o2v5TI7FVCWTMCMBeLQtP9uj9VrD6u3ZA6P
X-Gm-Message-State: AOJu0YxCXxLigsu2rTAwFG8VisWjeDZUfXo3YZXe+8PEq5yiXMFXUwiL
	JlCYmvxPP/JyzNb9++vkfgzxxFhVonyhvLCgptGwNp++eSslsmhuAExkAxBXa+DEUo2EnO7D0v9
	ZPlzMtzoz16GRbIDM4304V7hENe3CRS/uBa7A

Return-Path: <linux-kernel+bounces-61496-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 2589C8512E4
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 13:03:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 7ACDE1F21DA1
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 12:03:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C55DA3BB37;
	Mon, 12 Feb 2024 11:55:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="hr3oBRpc"
Received: from mail-ej1-f45.google.com (mail-ej1-f45.google.com [209.85.218.45])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2A3543DB92
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 11:55:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.45
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707738956; cv=none; b=nUHSsq8N5EBDLL4fHaRj7kGOIgUIgBPHcglO+KZ0pfRVq7S5Aa0hQfaLazggjqkoKR7gNin/Nubik3ipr+EBxmqGXVvHUR8ObXVLp8YHGecD4OfG+eHoAguFj76w7Ns3cs2oTRj/7zvCn+YtHG6TuS5N/Wkp5P0q1U8o5VuoGdI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707738956; c=relaxed/simple;
	bh=id3i2WJVW4phBYmsgQbEq/shWl5HZVQBYyUEbvFhfTA=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=KT1duxqvamqLPCjPGo16h0iManXQlgMBT72LRTTvncusS9V7OurcTiSBeZmsV4kCoTUOVl106zltGe/rbSuusxNRoYogBJF5gP8xv3hpz0FpV1/UyCTBSZGm2wVST2pJCbhFXxG8DsKRLHRIfDwGDfy9/sj4xpj0+QSo9xCYB/A=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=hr3oBRpc; arc=none smtp.client-ip=209.85.218.45
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ej1-f45.google.com with SMTP id a640c23a62f3a-a3be744df3fso306238566b.0
        for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 03:55:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707738948; x=1708343748; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=dAUragZkRoCdpC25LrNJxmewnsmkUuYReVo96/LCc70=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707738948; x=1708343748;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=dAUragZkRoCdpC25LrNJxmewnsmkUuYReVo96/LCc70=;
        b=
X-Gm-Message-State: AOJu0YxcDhLvXj5cZVxMEfwDnNdLnLWvwNtS2jgpvQUbB9Z6Uv4ZA9N1
	F8my++Oaly2q0KaBiq7Fm5snsRY31i8ujH6YLbfyItZuBTacrlG7Y4dR2lawcTUTyBc7Cu+SrFc
	N
X-Google-Smtp-Source: AGHT+IFJIWG+y3Ab2Rimuf5I2X12xZaVro6/Z+Isyv1dfmGtMHkjSfGHsIUJJHg+SsZ6D9XqhhprOA==
X-Received: by 2002:a17:906:ad9:b0:a3c:a56a:faf3 with SMTP id z25-20020a1709060ad900b00a3ca56afaf3mr1351255ejf.67.1707738948127;
        Mon, 12 Feb 2024 03:55:48 -0800 (PST)
Received: from raven.blarg.de (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id m1-20020a17090607c100b00a36c3e2e52dsm139203ejc.61.2024.02.12.03.55.46
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 12 Feb 2024 03:55:47 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v5 35/35] include: remove lots of unnecessary <linux/kernel.h> includes
Date: Mon, 12 Feb 2024 12:55:00 +0100
Message-Id: <20240212115500.2078463-36-max.kellermann@ionos.com>
...
---
 ...
 80 files changed, 3 insertions(+), 82 deletions(-)

diff --git a/arch/arm64/include/asm/cpufeature.h b/arch/arm64/include/asm/cpufeature.h
index d7c6988188d9..79ad18a0efcb 100644

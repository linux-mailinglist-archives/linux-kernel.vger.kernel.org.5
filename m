Return-Path: <linux-kernel+bounces-86071-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A759C86BF36
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 04:00:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 0618CB24F4D
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 03:00:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5AC5D44C7A;
	Thu, 29 Feb 2024 02:58:44 +0000 (UTC)
...
Received: from mail-oa1-f47.google.com (mail-oa1-f47.google.com [209.85.160.47])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 25D59446AB
	for <linux-kernel@vger.kernel.org>; Thu, 29 Feb 2024 02:58:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.47
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709175523; cv=none; b=W/IwX3knFa3VSKDNVF6t4htABI+/+5bYfLYwmN8sgcc1mlzIW91fcXfTlZjIIzbpgE85keKSm4Z0sSFQzH6rGdCAzUQD6mIWwhWphdVlGf16m24BXBhfREu5bKgA/vUHfLXD/iU7XtqROmZaZIyk73DgyEG3OJBkKG9Z2J0ysBo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709175523; c=relaxed/simple;
	bh=mx4ftk9A2eIm9XAiiyU38OIODZ8JYeMn5dt8m6qb2xg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=QLy/Dv7YBxu3eLmpDiBV7iqHttkmbVE1cZ5KXr5+3MYxXUfWPOOnL10eXf9LKvn//aFTneMwosk76VCLk3pB4qy0ZqR38LRIRI8X41CmrUZUdUeibU8gIwIVpmwnJPJTYIISxbc8r31vxVflmZffhVAGHjOZDgts/Gm6PrGjenw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=OSJZ1f5M; arc=none smtp.client-ip=209.85.160.47
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-oa1-f47.google.com with SMTP id 586e51a60fabf-21e45ece781so265963fac.0
        for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 18:58:39 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mkoJpJo0GmazuamQk6RjcdpeI7xXFyOUp8sC9NxHbRI=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUHFSshDbWaxZq4vzGfHGwYtO+Vk+65vof73GIujICjmbjG4zcBvPQ+7k7m02KMa+ZuhwKU172Dpabr7/BwX/IMmQl/8aKCWKPRQwOk
X-Gm-Message-State: AOJu0YxIAuV1Zrcj8PQrBN+MEa6695Z/CzwNtD4jkW/bqFqFuTW8kVtX
	upUsmwkGvA3qbXRrsipbcjvwbVGn7Q/mGqYZT7mmWDvLvB4uTl/WhzYkAZzItg==

Return-Path: <linux-kernel+bounces-87219-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 526F186D140
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 18:57:37 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CFD4C283DDC
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 17:57:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 377CB78273;
	Thu, 29 Feb 2024 17:57:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=riseup.net header.i=@riseup.net header.b="gB0Eowvg"
Received: from mx1.riseup.net (mx1.riseup.net [198.252.153.129])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 93819757F0
	for <linux-kernel@vger.kernel.org>; Thu, 29 Feb 2024 17:57:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.252.153.129
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709229438; cv=none; b=UZKL0qIzMnLAY8PMXzx4Ybg97wAQoKEb+Rt+/tVPPgO/ewcpdb81I5nbSK1SL8Drbz5mpe0dzh54a/KxH8Xiq73639Yw04D3Febt/fKaxEVthC8OudAiLKlhNCSwJY1zZPMatUEwY8bokNrPN6N9qObIdZeFQNk17urFnoG5TS4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709229438; c=relaxed/simple;
	bh=YiOGMUCUhtSRu4azM34qURZEVoFwlRFSn2/RQtI5RFU=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=IODggQMASKsv+BhLynEoT8JDaMg1QbmcxNsYoQ8CVn2pW0BIzQFPxAjey5/2MFJc5LrbhN8gyEbLHYoV5HVi/gjTpRk8UgxvUV2Vdl0X/tW0DXWQmboynVrxSJUGPogZnxF2HMr3VrmOi7iu5ZcRsOSH6PZEU/TI4Wapm49TssM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=riseup.net; spf=pass smtp.mailfrom=riseup.net; dkim=pass (1024-bit key) header.d=riseup.net header.i=@riseup.net header.b=gB0Eowvg; arc=none smtp.client-ip=198.252.153.129

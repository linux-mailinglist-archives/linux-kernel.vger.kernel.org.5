Return-Path: <linux-kernel+bounces-137817-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id BFAA489E804
	for <lists+linux-kernel@lfdr.de>; Wed, 10 Apr 2024 04:10:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 38F2D1F22507
	for <lists+linux-kernel@lfdr.de>; Wed, 10 Apr 2024 02:10:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7CA9A944D;
	Wed, 10 Apr 2024 02:10:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="eMoSmsVZ"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.20])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3F48B53BE
	for <linux-kernel@vger.kernel.org>; Wed, 10 Apr 2024 02:10:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.20
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712715006; cv=none; b=hL0Q3I3D3CoWqGnl4+9a9YRv4ksqPK2cozwFQH/7fFsWIqfGjcx9Ul3uKFAd+d4m/rU8UkRzLA+vRXpMdtEpUynaK7hLRSFt+QfpIRoyJnZ/mvsYcMH4Rizd8bz+R+n80IYbPDDGNHkVclKaKFRCH/aXZxesEPHi8uWAnS3mg+Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712715006; c=relaxed/simple;
	bh=SwmxmPxDMRej1aYgKsDEycIVIcKzEXYyxRg87X2L/r8=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=SXofi6af/ftux8GqkQv3GegdkG4+5q8XmXry5rxb/IsS7o2CMokj0lWtJ9nxWR0BFdpQTOI1oLD4FL5xOr2QQifcInKGieBkLVk5+Eb2typ8Tj/mJO8NJCicOqwnnwArtvMQ7TCvPsPk/9TCfWXQE2iWnVOUaiAcBIsuFOr0LMU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com; spf=none smtp.mailfrom=linux.intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=eMoSmsVZ; arc=none smtp.client-ip=198.175.65.20
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1712715005; x=1744251005;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=SwmxmPxDMRej1aYgKsDEycIVIcKzEXYyxRg87X2L/r8=;
  b=eMoSmsVZXqro+/s7xCNbF4uu7coug3OJyqsARBWSXBMQQGwu/fv6oAeS
   Lli+IAfPPO8VxJwiA47DJ1pemlBKzSWcw+bMOz7cCGMIHn/lKslWuZnPq
   WCp14pJh7gegjHHfNxuv1jckrIoMxwQq0Sfj+R22HvQeOEZXcAXZfoO0+
   TiSpI8XpTet0PVHfYSOCgYf8qK1H3/V623wmPY5TiowgHvfNee5hfv4eE
   R9ML0Pw/oBHqxAFB4p6/yP17Wtri5TtgvGijMFbKRMtJalhzgh/909T1h
   cjQXDRQtNqReoZZOP5h3Jn7XXt4R68w37Z9rvaeDzB2AaqLyZkh2lAq67
   Q==;
X-CSE-ConnectionGUID: Og8eijmeRoma2IL3TdNEmQ==
X-CSE-MsgGUID: eXHVCsYhQ1qGOhjLeB4WAQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11039"; a="7918532"
X-IronPort-AV: E=Sophos;i="6.07,190,1708416000"; 
   d="scan'208";a="7918532"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
  by orvoesa112.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Apr 2024 19:10:04 -0700
X-CSE-ConnectionGUID: qNPDp6isRJ+zv2EnAYlzGw==
X-CSE-MsgGUID: tAoth4ETR8qPGy/4unfZzg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,190,1708416000"; 
   d="scan'208";a="20478882"
Received: from unknown (HELO allen-box.sh.intel.com) ([10.239.159.127])
  by fmviesa007.fm.intel.com with ESMTP; 09 Apr 2024 19:10:01 -0700
...
Subject: [PATCH v2 01/12] iommu/vt-d: Add cache tag assignment interface
Date: Wed, 10 Apr 2024 10:08:33 +0800
Message-Id: <20240410020844.253535-2-baolu.lu@linux.intel.com>
...
---
 ...
 drivers/iommu/intel/cache.c  | 196 +++++++++++++++++++++++++++++++++++
...
index 404d2476a877..6f6bffc60852 100644
...
+	CACHE_TAG_IOTLB,
+	CACHE_TAG_DEVTLB,
+	CACHE_TAG_PARENT_IOTLB,
+	CACHE_TAG_PARENT_DEVTLB,
+};
+
+struct cache_tag {
...
index 000000000000..debbdaeff1c4
--- /dev/null
...
+	int ret;
+
+	ret = cache_tag_assign(domain, did, dev, pasid, CACHE_TAG_PARENT_IOTLB);
+	if (ret || !info->ats_enabled)
+		return ret;
+
+	ret = cache_tag_assign(domain, did, dev, pasid, CACHE_TAG_PARENT_DEVTLB);
+	if (ret)
+		cache_tag_unassign(domain, did, dev, pasid, CACHE_TAG_PARENT_IOTLB);
+
+	return ret;
+}
+
...
index 681789b1258d..17b8ce4b9154 100644
...
+	spin_lock_init(&domain->cache_lock);
 	...
 	return domain;
@@ -2317,11 +2319,20 @@ static int dmar_domain_attach_device(struct dmar_domain *domain,
 	struct device_domain_info *info = dev_iommu_priv_get(dev);
 	struct intel_iommu *iommu = info->iommu;
 	unsigned long flags;
+	u16 did;
...
@@ -3793,6 +3804,7 @@ void device_block_translation(struct device *dev)
 	struct device_domain_info *info = dev_iommu_priv_get(dev);
 	struct intel_iommu *iommu = info->iommu;
 	unsigned long flags;
+	u16 did;
...
@@ -3810,6 +3822,8 @@ void device_block_translation(struct device *dev)
 	list_del(&info->link);
...
@@ -4590,10 +4604,12 @@ static void intel_iommu_remove_dev_pasid(struct device *dev, ioasid_t pasid)
...
@@ -4677,6 +4702,8 @@ static int intel_iommu_set_dev_pasid(struct iommu_domain *domain,

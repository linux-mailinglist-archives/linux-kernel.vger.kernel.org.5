Return-Path: <linux-kernel+bounces-61472-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id C97978512C1
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 12:57:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D15191C22187
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 11:57:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 01AF03B182;
	Mon, 12 Feb 2024 11:55:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="ibHl0AH7"
Received: from mail-ej1-f47.google.com (mail-ej1-f47.google.com [209.85.218.47])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2970D39AD0
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 11:55:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.47
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707738928; cv=none; b=EXJ8ctjbEL2y68/K1o4nrFztoqmcbxqKJiEZb6t34pSQTNknHlNpgfvjaioylBTWo/lXiKJoPbPmyNBAvISj2zKIkNJ+l5yOaGRODFpqwfzyGM4xdB9lgNBFZRrup1hvy5DrgKKQXMlF+GU3SaDxg/sHcTxECNItvycQI3evlxY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707738928; c=relaxed/simple;
	bh=DVq7bQDbETpEiRySBMSc10qOGNGvNfPm+yXZn+o5jEY=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=QHX0nA+9h7wrmpl5FyIeMwXcbXK/NPRmbgAgRwWWCZgcIAxMLJ7x7iVDP3NAwfpEkhvhHSYIRe1qmevdy8/+LnxGMk+e9y+3jT8DrfsDNnu8WB41kiHUEl1JcNLl5zSrWzc+SzO/9gTIAhwX/1vrYqzXviwZuzEFc7+TxA+iVjw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=ibHl0AH7; arc=none smtp.client-ip=209.85.218.47
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ej1-f47.google.com with SMTP id a640c23a62f3a-a3916c1f9b0so414160866b.1
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:references:in-reply-to
         ...
         :message-id:reply-to;
        bh=xDYt+j9wfFwmW0Cdpurqy9zwf3Rf77G1ZTdllkWD0HA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xDYt+j9wfFwmW0Cdpurqy9zwf3Rf77G1ZTdllkWD0HA=;
        b=
X-Gm-Message-State: AOJu0Yz53fTac2gs28ds2jYwHMAs9svrvh4xABxXzqyRNLMJDGRG6n+N
	JYQJ37FZEsSRCyVy52aE4tdizMI+JZEq1lbKZ6galllBoKZscu5maudAdC71oTVkBQIqv8nYhTm
	w
X-Google-Smtp-Source: AGHT+IFdek9YPut16EnT54l2eNa8QjfOYLPLZOH4327/imm3WZVG52C5xfRuLspedUTAwc4o8Ibujw==
X-Received: by 2002:a17:906:6bc8:b0:a38:51c2:68a5 with SMTP id t8-20020a1709066bc800b00a3851c268a5mr4586918ejs.7.1707738917269;
        Mon, 12 Feb 2024 03:55:17 -0800 (PST)
Received: from raven.blarg.de (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id m1-20020a17090607c100b00a36c3e2e52dsm139203ejc.61.2024.02.12.03.55.16
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 12 Feb 2024 03:55:16 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v5 05/35] kref.h: move declarations to kref_types.h
Date: Mon, 12 Feb 2024 12:54:30 +0100
Message-Id: <20240212115500.2078463-6-max.kellermann@ionos.com>
...
index 935ee79cb391..2e041aedc317 100644

Return-Path: <linux-kernel+bounces-161861-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3E6D68B525B
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 09:30:38 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E9F1A281ACD
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 07:30:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D8BA614A8D;
...
Received: from out-186.mta1.migadu.com (out-186.mta1.migadu.com [95.215.58.186])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5114913AC5
	for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 07:30:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.186
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714375828; cv=none; b=N8Z/Zw497LM3z7cIJBcNXSuuOjLYUpI0uE/1P7fMBLaI8yG4ghxAbU5nc2EBDvBJ4iOKQgoLmZ5DMqT7/G81YjJq6EYcpAOh/Y6Ft1rPkOErwkoh9uqeFkIWRSZGDS+RHhrZXC7SBRTgahUws5RZw78dwDx0lmzLEI3vhNT7gSY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714375828; c=relaxed/simple;
	bh=abiLjfbVYT1PCT8XRlCX9O4WSfYiaoIRAzu9ILdzJ2w=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=evra/386YleONdJJLaK/OF8ynyiQ7tmdhyVHnFA05Fdn3DtILIymV7q+9PL8I+9nwj3SAUBpGBcQOjhPnN10fZkWRaxVkYlNxoBfQ7vPx70cgYMxGL2OD0LhQA89gwspe1ZnUeVkCLw+5kWtT1UFM330fchMAsQNUjjQ1+zPIEU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=H8CSOms1; arc=none smtp.client-ip=95.215.58.186

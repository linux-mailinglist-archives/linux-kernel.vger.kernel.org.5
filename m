...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C49787D9860
	for <lists+linux-kernel@lfdr.de>; Fri, 27 Oct 2023 14:34:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345815AbjJ0Mel (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 27 Oct 2023 08:34:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43686 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230101AbjJ0Meh (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 27 Oct 2023 08:34:37 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 69539C0
        for <linux-kernel@vger.kernel.org>; Fri, 27 Oct 2023 05:34:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1698410075; x=1729946075;
  h=date:from:to:cc:subject:message-id;
  bh=IdwnQHzA0AQMIqqtuqkgWyV5ZQyeRP9HJMp1ib/6qQc=;
  b=UMY2LGQj55lYuBJXI/X2srLz6e3yaZuJStXs/Q17w3soju4H8o4DIEzQ
   3+YQCAzkV85RewcSXNRQGa/t+NL0aS6a0FMrwNpDyAvbjgwcYLg7/N3os
   at0eXSTlqF9+qTRVJk3m3ukI8CLOjY9obWRdxZA2aYAwBQrmmGs2cSPdh
   9UhnUHy45k4ALjJXilpBzgOOuTNXqf5+GEa8bM2JXhEpI9wo9CGoXJme+
   PYqPdLiQlv3z4k25jQW+15tvSYjScSFFN3GUEPwocU6oyiTJEFNL/hYCw
   DPf1kVjA2D79JpPjnp67/Xh1qh4sj6Zp/PdCBzMUYnNts/b26GeXi/wBS
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10875"; a="418877478"
X-IronPort-AV: E=Sophos;i="6.03,256,1694761200"; 
   d="scan'208";a="418877478"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 27 Oct 2023 05:34:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10875"; a="709398784"
X-IronPort-AV: E=Sophos;i="6.03,256,1694761200"; 
   d="scan'208";a="709398784"
Received: from lkp-server01.sh.intel.com (HELO 8917679a5d3e) ([10.239.97.150])
  by orsmga003.jf.intel.com with ESMTP; 27 Oct 2023 05:34:33 -0700
Received: from kbuild by 8917679a5d3e with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qwM2p-000ApF-09;
        Fri, 27 Oct 2023 12:34:31 +0000
Date:   Fri, 27 Oct 2023 20:34:19 +0800
From:   kernel test robot <lkp@intel.com>
To:     "x86-ml" <x86@kernel.org>
Cc:     linux-kernel@vger.kernel.org
Subject: [tip:x86/apic] BUILD SUCCESS
 b56ebe7c896dc78b5865ec2c4b1dae3c93537517
Message-ID: <202310272016.nLBNsuIT-lkp@intel.com>
...
branch HEAD: b56ebe7c896dc78b5865ec2c4b1dae3c93537517  x86/apic/msi: Fix misconfigured non-maskable MSI quirk

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7DB44778069
	for <lists+linux-kernel@lfdr.de>; Thu, 10 Aug 2023 20:38:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235874AbjHJSin (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 10 Aug 2023 14:38:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33164 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235858AbjHJSiO (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 10 Aug 2023 14:38:14 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0D59F35AE
        for <linux-kernel@vger.kernel.org>; Thu, 10 Aug 2023 11:37:59 -0700 (PDT)
Message-ID: <20230810160805.875358976@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1691692670;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=HpjZz3joiv1/p3KpDArr5GSQpKRsQ6zE6sK4hsYD7vw=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1691692670;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=HpjZz3joiv1/p3KpDArr5GSQpKRsQ6zE6sK4hsYD7vw=;
        b=iNvZVVc+/sVAXpRDUgv2DlEPQQIAyqQRMXlvvEmoGFuc4ua90FGQkHDe/JbjccjLqkdq/N
        cqlM21G5ZNLmDLDA==
...
Subject: [patch 16/30] x86/microcode/intel: Switch to kvmalloc()
References: <20230810153317.850017756@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Thu, 10 Aug 2023 20:37:49 +0200 (CEST)

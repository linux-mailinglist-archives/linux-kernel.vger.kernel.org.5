Return-Path: <linux-kernel+bounces-121338-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B07F88E639
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 15:34:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A2FCB1F30909
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 14:34:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E50D9154BEC;
	Wed, 27 Mar 2024 13:06:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="KFIL7RHK"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 279A0154437
	for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 13:06:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711544763; cv=none; b=V39Zdiq7v93vAAU5Hh24Kkog6LxN7dnClmWuNG0J2RRKpSnZxfLIizxb/VRW5m9UjTuRMO1BY37iqBjzdF4aIa+BUEFtSAcLMqLhsTbe/WXd1Y/EfAIxcaeY0qvVfjqYS1+ElLJxb6oA0kir8zZAvd8XBIP2Rx9YnyWV03VlZIE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711544763; c=relaxed/simple;
	bh=ePUSYE7mfOlZBH02CU4Nm7CatB3dEi+OCZQnWcbFQSg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=DQbHq12sgeqzARyOv75WEIvqMnDKBJxbfxAphuJhAbm4J+ZYo0qF3ZU/diNU2O4577Gi5fAT8bvo61YiToZ30wswMtEDKnhtT6USMN7+CBmStgrgFs/kMw7MH505tV8Piy6x75iY+MDeAkKK+UvVRDsPFLIfOzNpcQwHnoQrDl8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=KFIL7RHK; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1711544761;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=lrn9kFJbDhptD+S1tnth6zQ8+0LvX0E75pC+GEdWFic=;
	b=KFIL7RHKc2W1jyZ4YuXOJHgIvDUWIN9lPf2fSh8vbnLF7nCXqWxNqTjZByxKXpuxCwestN
	bNJnivp15g8v28hCA2LQsckCn504RRENN0uBxNgkNF3NCVNLnlj/78IWE9MylTIV0M+zZ3
	kSXcB72E8Cvii3N5EFpfrCcqBm+ujcc=

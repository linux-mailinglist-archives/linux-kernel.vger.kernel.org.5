...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 16B127D5E27
	for <lists+linux-kernel@lfdr.de>; Wed, 25 Oct 2023 00:27:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344628AbjJXW14 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 24 Oct 2023 18:27:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55046 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344641AbjJXW1d (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 24 Oct 2023 18:27:33 -0400
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C73E01995
        for <linux-kernel@vger.kernel.org>; Tue, 24 Oct 2023 15:26:01 -0700 (PDT)
Received: by mail-yb1-xb49.google.com with SMTP id 3f1490d57ef6-d9cafa90160so5746288276.2
        for <linux-kernel@vger.kernel.org>; Tue, 24 Oct 2023 15:26:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698186361; x=1698791161; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=aO4t0OrO5M9nzlFoW7WXAJBPeF1LGPznAtpuwiNn4pU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698186361; x=1698791161;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=aO4t0OrO5M9nzlFoW7WXAJBPeF1LGPznAtpuwiNn4pU=;
        b=
X-Gm-Message-State: AOJu0Yx2XuMSTGZ6HmHmEdIGqI3wfvDOXOZE56usNVBRaISIZ245pStd
        0eX17jUXfpaCmnudOV3Edkqlvdkk5tiU
X-Google-Smtp-Source: AGHT+IE96o9BbQmgdJHNvdqbKxIid7HcujAXWX22JFxv59t228rE+8+lmwqGL85+++V3A4/X/vqK6BiTa5N1
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:93d2:18cc:4d63:45ba])
 ...
 o5-20020a056902010500b00da03da9ce08mr62325ybh.10.1698186360967; Tue, 24 Oct
 2023 15:26:00 -0700 (PDT)
Date:   Tue, 24 Oct 2023 15:23:51 -0700
In-Reply-To: <20231024222353.3024098-1-irogers@google.com>
Message-Id: <20231024222353.3024098-49-irogers@google.com>
Mime-Version: 1.0

Return-Path: <linux-kernel+bounces-30829-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 71D9F8324BF
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 07:47:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id CC32FB222B8
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 06:47:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EEE45D520;
	Fri, 19 Jan 2024 06:47:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="IK3GzMZr"
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 53B4AD2E0
	for <linux-kernel@vger.kernel.org>; Fri, 19 Jan 2024 06:47:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.55.52.115
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705646842; cv=fail; b=ILT3ens83b6HyweVORfb7NYycSIrCVBcuvRnIDZPKmtJQT+rx2h41rGUMF68Hk3zB6ncSZ4wKujwkkcvmeM+GiIOFMLBbsqUJp5bPHlYK9jyIcMMBX5xzBoU4AOyGylxNWe2M8/pXDxla+eymeuVha54NzsZ0a4KxypBFpdC0nI=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705646842; c=relaxed/simple;
	bh=fS55hVjPIQyHFnVVe0vDJilIjPyW7NpRn7SB1BRJDe8=;
	h=Date:From:To:CC:Subject:Message-ID:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=Wf3ULErWXK8TlslS0SoC90SPcsYILpWdY2DjK1fQvNzUC0BvQVfbcOM88yzH1mx2HGTwyOVk/CxA0DaVNRjRVOxdHndkc7DIWLvT5lVSaRQUwo0K5DSI2qpNJoMCdt3sp3IeBTvQxZrRwJnGDMZPN4t7ea12w9KpMU9ifFTekqA=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=IK3GzMZr; arc=fail smtp.client-ip=192.55.52.115
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1705646840; x=1737182840;
  h=date:from:to:cc:subject:message-id:in-reply-to:
   mime-version;
  bh=fS55hVjPIQyHFnVVe0vDJilIjPyW7NpRn7SB1BRJDe8=;
  b=IK3GzMZrljIb3Jt0gDJIYVD95q3n4WYUxefZu6V1DUON6NwREYYRKuNZ
   qaNFkRX701Zs9CkB4Nn2JmUosO9GNP2PfFpIZ1DiXlJtDcTzJWhFFJXAc
   WeLm0R091uWNsRvob3jPOZKNGuWlkr2VKDB4Jdg+V3KSYVptf8MTwALdF
   dd5qTWpROD1HTK0aHL8PLJTmu0PcDr9gHCj8tktfvboEeyshM5kkuTLnd
   ZWSMcBsHpz2INA63fyZiEBKEy74VHWHbEHYDki9ovtxLSp7MFcq8FNuYS
   e6FcrffjY9hiJe3XkSClAMCJV5s5/K1Ah9ILVrZDLa3CtqDjn2uLb4lCL
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10956"; a="400333487"
X-IronPort-AV: E=Sophos;i="6.05,204,1701158400"; 
   d="scan'208";a="400333487"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Jan 2024 22:47:06 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,204,1701158400"; 
   d="scan'208";a="26691734"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
  by orviesa002.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 18 Jan 2024 22:47:06 -0800
...
CC: <oe-lkp@lists.linux.dev>, <lkp@intel.com>,
	<dri-devel@lists.freedesktop.org>, <linux-kernel@vger.kernel.org>, "Maarten
 Lankhorst" <maarten.lankhorst@linux.intel.com>, Maxime Ripard
	<mripard@kernel.org>, David Airlie <airlied@gmail.com>, Daniel Vetter
	<daniel@ffwll.ch>, Saurabh Singh Sengar <ssengar@linux.microsoft.com>,
	Shradha Gupta <shradhagupta@linux.microsoft.com>, Shradha Gupta
	<shradhagupta@microsoft.com>, <oliver.sang@intel.com>
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:SJ2PR11MB8587.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(346002)(136003)(39860400002)(366004)(396003)(376002)(230273577357003)(230173577357003)(230922051799003)(1800799012)(186009)(451199024)(64100799003)(45080400002)(1076003)(41300700001)(26005)(66476007)(6916009)(5660300002)(8676002)(7416002)(8936002)(2906002)(316002)(36756003)(66946007)(4326008)(66556008)(54906003)(6512007)(6506007)(86362001)(478600001)(2616005)(966005)(6486002)(6666004)(83380400001)(38100700002)(82960400001)(505234007);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 19 Jan 2024 06:46:56.2989
 (UTC)

Return-Path: <linux-kernel+bounces-69190-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id C191085858B
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 19:45:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 627691F23122
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 18:45:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8D81A1482FF;
	Fri, 16 Feb 2024 18:42:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="LlwyUY4z"
Received: from out-176.mta0.migadu.com (out-176.mta0.migadu.com [91.218.175.176])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5522E1474BC
	for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 18:42:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708108945; cv=none; b=hDX2qg7TPf0bPRiJ+CYokg0a/hE6fFqtEk9Hd+Gdjba5aUIpsdv+bhZDvXviHVFhT4SZ4JkRXIIZ+eM2KsN7KdqFkoZnAcf2oIjBa9G/DOB0A+40+YxlXPp6nW4iDVCOzfFBzTFYg6KIJMIdDj5R0DiPAJaKJNsWHcFVlD7O4EA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708108945; c=relaxed/simple;
	bh=0+9hvpIMVuumxZZRLzdSlgvQCBBmw4uMTPz59W0JCTQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Lln0B7zZhDCi9fYdPA0q+CAgTD/qmQZijvdy533INI2JWzohUye0xgutWhQWkmEi7PC7tCA3c3Zjlkj3Bq2VY9I45sEO10PBqhq4fA1Qy6vcEmDD/9E4j7oxHSnVe34IDi0BuvbHdyvRTLeC0qNjpwUrwNHj1D/6Hxwj+GJWNhs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=LlwyUY4z; arc=none smtp.client-ip=91.218.175.176

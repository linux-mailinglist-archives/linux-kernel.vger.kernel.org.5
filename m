Return-Path: <linux-kernel+bounces-93139-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id C2884872B81
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 01:08:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 5D11B1F27980
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 00:08:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8DCC91B5AD;
	Wed,  6 Mar 2024 00:07:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="harNdq3f"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D93E51A5AC
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 00:07:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709683638; cv=none; b=fW3D7/e1L6Nv7kxDGEw1WXLyrKiWN/L+fc+j+KurVwFHZM0Hk3cPndy46BQquR72Cp8gGg8v+bRqyAAO6omAUCUoQgrnxf2hwxDXoozcUZhmvqanx0sNUtVM66y6xDVMEIoxfs6aGGoDy/mhha2n5pS1UmDJmZ2MtqP09U4sGr0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709683638; c=relaxed/simple;
	bh=MQ2ZFjtue/mlbT3gPUeVjpfqMS/NxZ1JCX8pts1RXQw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Bl3RR05m3Cq1/+x4rjRnAu5nBVNfb5vWyIDOJ4vJHYTKTdfwiYbk3o2Cvqibvij0W6sI6fxyCDIwlUfbyKhqXZAYuR7jMgOYhZBvWy5hCglVNf76ycCv/mQMLiKbp0iPsi6to3GhbpO/JsWuqNjGYgL94QwO5lYZXcpWe/H8OXw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=harNdq3f; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709683635;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=Ccm9SVhd+bAluRvWjYsOnhrUMg2QaaHeYK4kvnT54uM=;
	b=harNdq3fTe8NXz1sIbaXW93o0ocw8kvzpJg/+0aOrJgAG6lcJcVLXtS2cfU70oBhLF4Vja
	LbRhwUdJ8VOPeM5CizMte+mD8aD7BEHeFKm0ZaUbQkrHacU/Q+aF/enMcbY9mJNh7l3f7k
	mbmnWr4Z5lDH8gUv3XhvhXMv0QL1B9g=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A1A3E76021F
	for <lists+linux-kernel@lfdr.de>; Tue, 25 Jul 2023 00:20:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231433AbjGXWUs (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 24 Jul 2023 18:20:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48926 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229746AbjGXWUm (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 24 Jul 2023 18:20:42 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9ADEF10D
        for <linux-kernel@vger.kernel.org>; Mon, 24 Jul 2023 15:20:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1690237240; x=1721773240;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=tEk7hMrX5KFjfZK0sZ4WIgm/aTOyKJlLYjDwSd7VdbA=;
  b=jk3+E857OFDzsJgPcHSX/4dGaYrCnPbX3KYi4q7tzn0C8kYs3whGjOdT
   1mI36XM9jhXYND+MR4nfoSB/AaXoSmtMwbrGL9xzIwcS/w1jBy7mKQybN
   NmhEMhffBoapfVRhBI0Z4Ucl3q/YupXdayvsMP8MX7LqG1Ewa7i3FAkJG
   0OBok0hfsftFvcDlYWp4j3ctst85/x1yu7HpxrMBzQwgCUD2SvTqDHfYE
   ynrKVvVGXioFL8DPLv5bRNTV4vl+X2thNkFp3yoqpkKl9JrQfArzkGv8b
   enp0MhzU0kDAgzFF0CX/zqt7f2U58v6o+vNX7hfmrr1cYfvX6/HB82xEu
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="398476690"
X-IronPort-AV: E=Sophos;i="6.01,229,1684825200"; 
   d="scan'208";a="398476690"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jul 2023 15:20:40 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10781"; a="899675495"
X-IronPort-AV: E=Sophos;i="6.01,229,1684825200"; 
   d="scan'208";a="899675495"
...
Subject: [PATCH v11 1/8] iommu: Generalize PASID 0 for normal DMA w/o PASID
Date:   Mon, 24 Jul 2023 15:25:31 -0700
Message-Id: <20230724222538.3902553-2-jacob.jun.pan@linux.intel.com>

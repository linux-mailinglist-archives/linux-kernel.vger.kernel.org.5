Return-Path: <linux-kernel+bounces-112544-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 34B13887B59
	for <lists+linux-kernel@lfdr.de>; Sun, 24 Mar 2024 03:05:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 1EC52B21A56
	for <lists+linux-kernel@lfdr.de>; Sun, 24 Mar 2024 02:05:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 41CB74C91;
	Sun, 24 Mar 2024 02:05:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=g.clemson.edu header.i=@g.clemson.edu header.b="zGkb3CBW"
Received: from mail-yw1-f182.google.com (mail-yw1-f182.google.com [209.85.128.182])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C33710F7
	for <linux-kernel@vger.kernel.org>; Sun, 24 Mar 2024 02:05:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711245932; cv=none; b=Jm1jhTid8J3GJkhKlKj3xb5mHlAXrRaxPNsGwi6f159v+7eA7veFduXwSs7ksRKvFTg0veyYrRzacWYTfrcD7P/fGvsetQmcsaTmUmdA0giYJHdcfE/zl5WBEIVbEKK8oZEAQu/IEim0j5pmBY3RjI8f/y2jCApWWsTOU9sYB5s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711245932; c=relaxed/simple;
	bh=sNVv0VgvLzkY+56j0eQtqJySpSAZx3fgJ1/BeslJ2kY=;
	h=From:To:Subject:Date:Message-ID:MIME-Version:Content-Type; b=QBdncNOv5A+MfxPViArWK0WRA333oMLAhCELSaxparZ46PafofhL1gVWp97z027Q9CK+bU9XmI+x+9hkvTlu1k8jNWn0hgpHIDZMOJLXuF2bZsX+3zE77MjaE8Yapl8uMAdSllq3Gd4iNuPUrB4Wq9eKUQj+8jTHRtM9wdIfl3U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=g.clemson.edu; spf=pass smtp.mailfrom=g.clemson.edu; dkim=pass (2048-bit key) header.d=g.clemson.edu header.i=@g.clemson.edu header.b=zGkb3CBW; arc=none smtp.client-ip=209.85.128.182
...
Received: by mail-yw1-f182.google.com with SMTP id 00721157ae682-60a0579a955so40601027b3.3
        for <linux-kernel@vger.kernel.org>; Sat, 23 Mar 2024 19:05:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=g.clemson.edu; s=google; t=1711245928; x=1711850728; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:message-id:date:subject:to
         :from:from:to:cc:subject:date:message-id:reply-to;
        bh=wPOgNnxhTH834VfbDnhoBX94/Uy935Qj2z4r4xRfUo4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=wPOgNnxhTH834VfbDnhoBX94/Uy935Qj2z4r4xRfUo4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVt7wg+GfHAlTcj55fsJ0/rAgfOWMzoTz+BpCzAEyAUSVVWP3MqjPr3rY64fvz/5/8LusFkZQY0+oezsia00PIKLlDAjaGz/W85yEnW
X-Gm-Message-State: AOJu0YyqDijFrLfnXTgsauoxcRnyLhD8TU8JMGEINV2z0EStXIiNUpRk
	+Tbw7YTi5umFsYoSN8/20PPK2JuZQTge6uj46QGAO0bYZ/pltTfIExq/pO62ng==
X-Google-Smtp-Source: AGHT+IH/bSFv71pzGUE+yHsfzNnaW97p76jqbAD3qiBKUlvqoRcbCN8kCAZazr99fn8RExHpgpj81w==
X-Received: by 2002:a81:7c8b:0:b0:610:ce53:e274 with SMTP id x133-20020a817c8b000000b00610ce53e274mr3083194ywc.14.1711245928285;
...
Received: from mephi-laptop.localnet (130-127-40-81.lever.resnet.clemson.edu. [130.127.40.81])
        by smtp.gmail.com with ESMTPSA id et2-20020a05690c2e0200b006088f2afc2dsm506827ywb.87.2024.03.23.19.05.27

Return-Path: <linux-kernel+bounces-160783-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 15BA88B42D8
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 01:51:26 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id C533A283E4F
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 23:51:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4A2C13D56D;
	Fri, 26 Apr 2024 23:51:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="CVb3ShiT"
Received: from out-178.mta1.migadu.com (out-178.mta1.migadu.com [95.215.58.178])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 859593BBCE
	for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 23:51:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.178
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714175473; cv=none; b=qreMHlmrfCEhGrqDZ/gucCl92oqrfTiw1+evPKN7w+Pjb8gtHRGfNFmN83VxGz1KSwmvS7qDkRWuaj5G+nhxKcjOLf1bTWP/iy0ha0EA5+bVpqq95199+aIskb0Ol+zY2nLitMidnSdwAwcnbe7KjesleOrBYgH+8UqTAPx8fJA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714175473; c=relaxed/simple;
	bh=UOv2aSPHtSJ211fWROncfK9M6zsTUFl405ydVst3K9M=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=a/Mep6YF7urGSud8TZrz7fTSILZc+zAc51oA1gdrKUmThyzat8p8WpUsdZ3oRXV3qkorY7ttKR6hXrlWGPswzA0K/v0G41rbP6yv69e7irxVjVOWIHGxwvGGUgpM0nIff+D77FFK62P3yt0n6hrLsutqI/zrTSMl7m9p62/zGJo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=CVb3ShiT; arc=none smtp.client-ip=95.215.58.178

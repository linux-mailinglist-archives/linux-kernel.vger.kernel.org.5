Return-Path: <linux-kernel+bounces-94211-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 344BC873B67
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 17:00:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 585BC1C227D0
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 16:00:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3BAD2135A7F;
	Wed,  6 Mar 2024 16:00:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="dh7+wM4Y"
Received: from NAM02-BN1-obe.outbound.protection.outlook.com (mail-bn1nam02on2052.outbound.protection.outlook.com [40.107.212.52])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4CBC91353F5
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 16:00:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.212.52
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709740812; cv=fail; b=DePXJE8EbwYGZhNMWoTTeYDGB0+zsPR99oJUDwLK6zGnW7DSD6Mmm2WRKPkezqz4H6Br0eBxahE2CEXN8RHaPKk4r9RbvCnf/50xmX+zgzm26oR+0KVSnjwy+KUY30rbWiNaAIs4L7mnIqNYO12P5RtcrJe3rMEN5wIU+kslPGo=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709740812; c=relaxed/simple;
	bh=3zgYwYxCRQNzm+njCCg9fAaYI/DGw3cScB2EvVc18LY=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=j97TbIoiRsJ5p4YM4p1HyLKv4I3jdCC2zu9th5h+4+ZDdUIqGzfG81Jn//QuiyP6b6InSGsfQUnicS2c+N0ar1r8UBikxFV02JOUGoMFvTjiHA/8MJAdOeeYozxCvSsZqvAtSijYs2dsdE/tIJp0cuXWmMGc5vqC/96bCQWIjqY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=dh7+wM4Y; arc=fail smtp.client-ip=40.107.212.52
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?aTIzZG4yUEFjZHJTUktoWmdPOEZkcExVWUZNS2FaVnRYcFlkc0JuZjM3NDhY?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Mar 2024 16:00:06.3083
 (UTC)

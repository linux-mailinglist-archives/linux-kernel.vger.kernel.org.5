Return-Path: <linux-kernel+bounces-34907-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C08BC83890F
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 09:35:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id E646E1C25084
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 08:35:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F33515C5F5;
	Tue, 23 Jan 2024 08:33:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="St0CcoBD"
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2053.outbound.protection.outlook.com [40.107.244.53])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 52BDA5C5EF
	for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 08:33:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.244.53
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705998786; cv=fail; b=LmKapHk3oZGVsNLfGObnN0R8B+IrMkFAXDaZkNvr/ArYXDTJ1ebLJi15HPC518HgKgpjgTnauZ+Z3U1sTj46tX6b8d7hVPVxyqQw1LpMEQwoSu0Us1nxuCqaiqOl3pyoIWoWyuotLVzziIXhT0+QL15kCY2uAnWnDNnWzRjwstg=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705998786; c=relaxed/simple;
	bh=GF5H5hF3Tto4h9b7Ah84quNSn5EzNCrHDOTIHVbERss=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=Fu4jpLOO85ADMKRhH6EGtZMURUVWuqckPcLmpTtnWqxCxVghT6Y3xVYKR2NcD7J2rEj3s26TZChY8xQ8mR7r2fLBOJhvCr5p5x56oUhBPKGcEqjob16XjhvCOCBIoeMtodCjG4Tu08fan2zazRiaIPPA6qop8/yvUnQzWFIdBvE=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=St0CcoBD; arc=fail smtp.client-ip=40.107.244.53
...
msip_labels:
 MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ActionId=dd4fabe3-1bcd-49b7-9496-55fba4aae368;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ContentBits=0;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Enabled=true;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Method=Standard;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Name=General;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SetDate=2024-01-23T08:01:05Z;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SiteId=3dd8961f-e488-4e60-8e11-a82d994e183d;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 23 Jan 2024 08:33:00.9725
 (UTC)

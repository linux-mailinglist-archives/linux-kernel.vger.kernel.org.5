Return-Path: <linux-kernel+bounces-12046-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id BCCE881EF5E
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Dec 2023 15:13:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4BBBD1F220DC
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Dec 2023 14:13:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A142F45C1B;
	Wed, 27 Dec 2023 14:12:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="wg7MwqG4"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 122144597B
	for <linux-kernel@vger.kernel.org>; Wed, 27 Dec 2023 14:12:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--kinseyho.bounces.google.com
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-db410931c23so6111061276.2
        for <linux-kernel@vger.kernel.org>; Wed, 27 Dec 2023 06:12:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1703686344; x=1704291144; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=H66WYYyor5VKn1nkrvH777s0EpSf6ZBvBeCx9Al6YIY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703686344; x=1704291144;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=H66WYYyor5VKn1nkrvH777s0EpSf6ZBvBeCx9Al6YIY=;
        b=
X-Gm-Message-State: AOJu0YzoSSRo1xUztL/X9G0vQ8bY3iH1XLDrNa9WmUORd33qJuMbadMD
	CCbtZ7O6el14ae5hu+S0JYZSi8I+JZTtOfbUHewj
X-Google-Smtp-Source: AGHT+IHn94EZaJHivTiXtctZ2+otSRKVfvWTg+T4LNeKuH8VVnaKwxdPeXy2eqSD3G9RTBPglZstSXMIUpwhIg==
X-Received: from kinseyct.c.googlers.com ([fda3:e722:ac3:cc00:7f:e700:c0a8:46b])
 (user=kinseyho job=sendgmr) by 2002:a05:6902:1b08:b0:dbd:e0b4:9647 with SMTP
 id eh8-20020a0569021b0800b00dbde0b49647mr3200223ybb.5.1703686344087; Wed, 27
 Dec 2023 06:12:24 -0800 (PST)
...
Message-ID: <20231227141205.2200125-3-kinseyho@google.com>
Subject: [PATCH mm-unstable v4 2/5] mm/mglru: add CONFIG_LRU_GEN_WALKS_MMU

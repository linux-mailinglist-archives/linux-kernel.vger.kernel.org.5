Return-Path: <linux-kernel+bounces-101096-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FD2787A23B
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 05:17:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 33ACD1C20F12
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 04:17:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 134C410965;
	Wed, 13 Mar 2024 04:17:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="EZtngzNg"
Received: from mail-lf1-f42.google.com (mail-lf1-f42.google.com [209.85.167.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AA21110A1A
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 04:16:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710303422; cv=none; b=JV2JAQjFyy6DHsRiuHqiqeq2Tet9ymEcOORrZCgovhPky6bEUMu1tNsLkrTs8BhGadO7TvwI7qYW8Ojj3rnI/TyzsSbT+TFv+Bd4Ygei3OvhLqGePNSvqW+82UZVw9fX/pJQOQH3ldvFNeisy4waOTVF7bVfiNz7exIskAt4zSo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710303422; c=relaxed/simple;
	bh=kY4oxYTIenZ3AhcTudaM79duGAJxCIDaki9A7BPzwKc=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=XwhPUgDrv4ep+yH7PdVDAgpd96g3WAHzqqe3cBpChBH/RcVLcDMJ9ejM+Up+MRexI7AtLGMK843cpZmNppYsJZXSBbeSGz9B+EbE7wzCMQoMjlL92DglJ0iQ4sr1l2J8cX2d2P/+upmz+4j/MoVnX3cfYfznKtc9xoAyGEGVsaQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=EZtngzNg; arc=none smtp.client-ip=209.85.167.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-lf1-f42.google.com with SMTP id 2adb3069b0e04-51381021af1so6188131e87.0
        for <linux-kernel@vger.kernel.org>; Tue, 12 Mar 2024 21:16:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1710303412; x=1710908212; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=fKudODp3bFUUOF1QUnwb2edLLjX+nV2trcG4eg1F5dA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=fKudODp3bFUUOF1QUnwb2edLLjX+nV2trcG4eg1F5dA=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCV1b2wqtIzdNQbD7c5gZaxIErzE0marlZ40hMWdfAVtrN094nfH5vc98qj4UOpO1gQuKD/AAoNNNCR2fa7+d6WVrzfVZrZrvLZczy1Y
X-Gm-Message-State: AOJu0Yzo+JQDuD0n9EVpIFfh7GLD48CLC+ofVcxFFRriB699ic7ZX7f6
	cPhKpB0WWtLzP8bRzM7LWyNtl6WYGHlapBjDyjuYFA0ywcbSoG3Ob0dicd0uyV90ujXALIgBE6T
	PHV9m43R467UzwOOtAYhi8ALD84Y=

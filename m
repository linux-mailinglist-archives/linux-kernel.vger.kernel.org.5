Return-Path: <linux-kernel+bounces-6631-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B7A1F819B37
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 10:18:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9C601B22021
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 09:18:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 520931F60A;
	Wed, 20 Dec 2023 09:17:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="JJpILC8S"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9AD391F5E4
	for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 09:17:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703063874;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=51YhYfURjkTSAZFjlaTjEgUsM8OmUxf+tU0jMDZLv1Q=;
	b=JJpILC8SuF0OGhEZfRWZqHiJJlrV641Ry8uAEQWgff2nWFzwYX3fFVlgKub4rs3BEDmvF+
	QvyNwDLJ9s6M7Maqcx+cz/Gj6tb2wN4jvzNKABgE1lTu7EP+Ealr8Ma4sylcK4WRx6ICXc
	QeGkvwCFY8LsVgTvJg6buIt5Mh+fiF8=
Received: from mail-qv1-f70.google.com (mail-qv1-f70.google.com
 [209.85.219.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-350-WYqkbE0mP0agf1PWfUr2qQ-1; Wed, 20 Dec 2023 04:17:52 -0500
X-MC-Unique: WYqkbE0mP0agf1PWfUr2qQ-1
Received: by mail-qv1-f70.google.com with SMTP id 6a1803df08f44-67ef53b1f17so92107546d6.3
        for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 01:17:52 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703063871; x=1703668671;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :content-language:references:cc:to:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=51YhYfURjkTSAZFjlaTjEgUsM8OmUxf+tU0jMDZLv1Q=;
        b=
X-Gm-Message-State: AOJu0YyUD1k+MjNMdfzdzKESfQrqh23u4+p7UA7kwysedgxXu9IsHfyr
	9kTZ3mTamDR1rC0KD8GS/jqNhLQFASOR3v35JiU9+OsKgAn7visRc8o0Y1tCbsycwfD0k8+igtu
	ymJKA13xYQspajqsDoURIj/Pf
X-Received: by 2002:ad4:5dca:0:b0:67f:143d:b8c8 with SMTP id m10-20020ad45dca000000b0067f143db8c8mr13208299qvh.110.1703063871636;
        Wed, 20 Dec 2023 01:17:51 -0800 (PST)
X-Google-Smtp-Source: AGHT+IFDDpA2OAiYFhHdNO5Cg2Nqb9eOpfrgP9GNexEJ4SZ/FJG+Foon+Sy2N+ZjzIFtioVXUHbBvg==
X-Received: by 2002:ad4:5dca:0:b0:67f:143d:b8c8 with SMTP id m10-20020ad45dca000000b0067f143db8c8mr13208278qvh.110.1703063871248;
        Wed, 20 Dec 2023 01:17:51 -0800 (PST)
Received: from ?IPV6:2003:cb:c73b:eb00:8e25:6953:927:1802? (p200300cbc73beb008e25695309271802.dip0.t-ipconnect.de. [2003:cb:c73b:eb00:8e25:6953:927:1802])
        by smtp.gmail.com with ESMTPSA id pp17-20020a056214139100b0067aa31371ddsm3451859qvb.80.2023.12.20.01.17.47
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 20 Dec 2023 01:17:50 -0800 (PST)
Message-ID: <7c0236ad-01f3-437f-8b04-125d69e90dc0@redhat.com>
Date: Wed, 20 Dec 2023 10:17:45 +0100
Precedence: bulk

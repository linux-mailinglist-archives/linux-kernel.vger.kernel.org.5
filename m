Return-Path: <linux-kernel+bounces-6662-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id A9819819BCD
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 10:55:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 603E12878B2
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 09:55:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BFFCE208C9;
	Wed, 20 Dec 2023 09:55:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="PbcG3T4y"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3FCEE208A9
	for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 09:55:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703066102;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=9As2S8Kzp1MuG6UxCCIg70Z966bnMvQcWNaINEWheFg=;
	b=PbcG3T4ypAQKbYhsfkY2o9+Oalbg8kAyHQtz4aDfc4Efpf37E9bljcjPkmdINLN5MmR0a8
	FMYoizdqc/vo4ILNcftTroCaryGiHtJslyp6NrFf9W2enU0RhS59lU5he/fAhIu0FDnfrA
	6m3OFi/lkGZAL7B9NQO+5IfA0/dU6Vk=
Received: from mail-wr1-f70.google.com (mail-wr1-f70.google.com
 [209.85.221.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-75-yQljdKxzOOefXLtB3iQAAw-1; Wed, 20 Dec 2023 04:55:00 -0500
X-MC-Unique: yQljdKxzOOefXLtB3iQAAw-1
Received: by mail-wr1-f70.google.com with SMTP id ffacd0b85a97d-336719795a7so871498f8f.0
        for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 01:55:00 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703066099; x=1703670899;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=9As2S8Kzp1MuG6UxCCIg70Z966bnMvQcWNaINEWheFg=;
        b=
X-Gm-Message-State: AOJu0YyUNEqLk3DYdprgSnnoV/RJZ6sqP+PhtqCSLL4gM2+xPxd9dC4G
	fIq7HnkeZLmKXH78FDoC7Da/zAv7wOsunIaC2MyGqHdZudNzpICK7IX20c2/aa8OeJJ6t3P+KLh
	cQ4BwJHWKeR8ROYUY+cjRRp7atWls9Qyw
X-Received: by 2002:adf:e947:0:b0:336:7641:f3de with SMTP id m7-20020adfe947000000b003367641f3demr986427wrn.91.1703066099289;
        Wed, 20 Dec 2023 01:54:59 -0800 (PST)
X-Google-Smtp-Source: AGHT+IHO+czHZFXA2zu/5/u7cTZLvbyreKBGeezPnZcws+2v39LtqwfGMEl+y9AzNLz7snW3kR3QyA==
X-Received: by 2002:adf:e947:0:b0:336:7641:f3de with SMTP id m7-20020adfe947000000b003367641f3demr986393wrn.91.1703066098779;
        Wed, 20 Dec 2023 01:54:58 -0800 (PST)
Received: from ?IPV6:2003:cb:c73b:eb00:8e25:6953:927:1802? (p200300cbc73beb008e25695309271802.dip0.t-ipconnect.de. [2003:cb:c73b:eb00:8e25:6953:927:1802])
        by smtp.gmail.com with ESMTPSA id a15-20020a5d508f000000b0033330846e76sm13054134wrt.86.2023.12.20.01.54.57
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 20 Dec 2023 01:54:58 -0800 (PST)
Message-ID: <28968568-f920-47ac-b6fd-87528ffd8f77@redhat.com>
Date: Wed, 20 Dec 2023 10:54:56 +0100
Precedence: bulk

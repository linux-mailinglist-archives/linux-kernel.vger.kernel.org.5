Return-Path: <linux-kernel+bounces-136658-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 94CE889D6C4
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 12:21:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id ABFA91F22399
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 10:21:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2BB42823A2;
	Tue,  9 Apr 2024 10:14:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=baylibre-com.20230601.gappssmtp.com header.i=@baylibre-com.20230601.gappssmtp.com header.b="hfCOIAlq"
Received: from mail-lf1-f46.google.com (mail-lf1-f46.google.com [209.85.167.46])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0281612FF87
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 10:14:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712657653; cv=none; b=gfurjREcWfMpHVyNL7R1vxn+N5DgiDL1aXcNcnT1fUkSg9N2c31VckOU8FsJvh9WmNP5O0cm9b2de5xkvksGgpQggkK3ndYwtdrLd41ht2rvv74fOBb2gPR57WSPFH31fo+Z5LEcxtd8LAwj9o27dTZOj5kEEn+THPgT2sXfJJw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712657653; c=relaxed/simple;
	bh=fS5gepwaOFtT0i3f0VRU0HUd1nso3GE9DnlSY4LLZy8=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=OMYGXJe7vAEPyY/Uzeqif4UT8OlYYx37PGE5vklhbDygYbI/48nzcrF5ZAUZUQZnjtt+Q6EsEthZKIMDN0hPAEhFQYTy0STdkKpUBsPCdNqe/3IUAyVSMzx2wskQenIAqFLtNcRzBHb3IE0pVMKr/uEsVObJJmCGPqA+1QiemxE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=baylibre.com; spf=pass smtp.mailfrom=baylibre.com; dkim=pass (2048-bit key) header.d=baylibre-com.20230601.gappssmtp.com header.i=@baylibre-com.20230601.gappssmtp.com header.b=hfCOIAlq; arc=none smtp.client-ip=209.85.167.46
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=baylibre.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=baylibre.com
Received: by mail-lf1-f46.google.com with SMTP id 2adb3069b0e04-516d0162fa1so6437763e87.3
        for <linux-kernel@vger.kernel.org>; Tue, 09 Apr 2024 03:14:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=84v62SXBYKKjz3cEOfxndVMabk9/ZyJrti/cV05xnCE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXx/JKpMP8QwfhHKpI4RIfMggVxJ8aBzR4dy8n6PFuoFbQ5lZCNJwpfCh8+G/V/nSMfhu5vvDi/66y3/TBh1Gtilk/cQyna0RFojSFC
X-Gm-Message-State: AOJu0Yz9EW+8LX1VtL+5e1LKXFCpXfHRpHB07wqLNN/Oeaadoi7PfGD1
	8MflOfHffouuzYeEjHIm7q7W5bMPESzfhrIqdrU9SwfSQow8SULU3I2MzMQ0CPTmo/poD8R2PR9
	rCgM=

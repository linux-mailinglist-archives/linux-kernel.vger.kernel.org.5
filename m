Return-Path: <linux-kernel+bounces-149490-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 351808A91BD
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Apr 2024 06:05:07 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A6C8F2828C5
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Apr 2024 04:05:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1D12E54BED;
	Thu, 18 Apr 2024 04:04:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b="DUM7aL+v"
Received: from lelv0143.ext.ti.com (lelv0143.ext.ti.com [198.47.23.248])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1BBF72570
	for <linux-kernel@vger.kernel.org>; Thu, 18 Apr 2024 04:04:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.47.23.248
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713413072; cv=none; b=RgoeCjOFroXHiKzhAJ35iC2F8sKegnTdV3DXs8e0FtgojwpnSC1bys+N4tNM2Wb11ztu8OdWjuDqadVGACnQI6rOzOs2ajR2KRFVnq5T1gVS4WlvtIpNNZ6vkS5KESB5CgPT8V+L9RwQmaF28HTsPbz4+ffTXgfvHKIktStitM0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713413072; c=relaxed/simple;
	bh=JFGM6C4Eytt2MX9XDuY6MRHPnAVaXFAkPCU8eQk2e3U=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=jqqmPZBp7UyxrZ5NP6hdc6/RWm6nxkUvDFeUda6UV0N9iAimoszXNN1drl3tKMsX1/u4LDuU3dgpuVDt4aYnkpwbWUMxYDbZ8+bBupm2ID5NaiCifrxs4ClSJ4UxMbAhhHI1uaOEiSJ5xbQvlGLJCzFz4LuQMfFoSGVOkw+quHA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ti.com; spf=pass smtp.mailfrom=ti.com; dkim=pass (1024-bit key) header.d=ti.com header.i=@ti.com header.b=DUM7aL+v; arc=none smtp.client-ip=198.47.23.248

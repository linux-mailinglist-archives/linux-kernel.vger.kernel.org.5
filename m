Return-Path: <linux-kernel+bounces-137138-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5BACD89DD6A
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 16:58:47 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id D5CE1B249E1
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 14:58:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C138312FF65;
	Tue,  9 Apr 2024 14:58:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=szeredi.hu header.i=@szeredi.hu header.b="W6HWQ7ZN"
Received: from mail-ed1-f49.google.com (mail-ed1-f49.google.com [209.85.208.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 855E712D210
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 14:58:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712674688; cv=none; b=JsRqhDgwxQQxku+d9Nm/PHFXd5CsTsrGK2S561VuCf0GqmwX8ifPLDcCCPxcHiQMiCqZrdYCMGBLbX1cUQ+HzrwjOveskIBTqGZfyr/FjlWkvekx7WIWN1i/mtF297+N9MR1PL8Mt+DLVsQ96EvLJW2Q2izC3PprSQSd0y00ff0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712674688; c=relaxed/simple;
	bh=dl0LmiRM57HxUberHzme3n8QEAA+YThYtslFTlwTygQ=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=bWnigsZ3I4f44b93akNsOZ2bloeBBqmpnvJFy7ZhVHFJd5yEvtaWS1qkWl8EUb+OAOGbXxdMCnCXaeB/BLKB7rV8qvlAaxGA9eV3FVMxNTg6QoZebYM2JPSysafcSmLG1id8DC7+ARKpJVUO8thHpEa1R15ZmM2JeCTzZBN7CVw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=szeredi.hu; spf=pass smtp.mailfrom=szeredi.hu; dkim=pass (1024-bit key) header.d=szeredi.hu header.i=@szeredi.hu header.b=W6HWQ7ZN; arc=none smtp.client-ip=209.85.208.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=szeredi.hu
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=szeredi.hu
Received: by mail-ed1-f49.google.com with SMTP id 4fb4d7f45d1cf-56e69a51a33so1706651a12.1
        for <linux-kernel@vger.kernel.org>; Tue, 09 Apr 2024 07:58:05 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=YW0DLDmEm9uNtI52bYp3RB2ImO6QOJ3pl+va1BwBzrQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUFHUx2K3k8gYi7pNuP2+45N4amyaiZjkqj7YQXNdliUTrsOqkuovG0EEZzzCJf2ubBFFRVV5iH4mZmf1MWxqVhG9FbquEaSHcUaUHB
X-Gm-Message-State: AOJu0Yw2DOjtwwErCAbFDrz+RU0syTbbvakxVEe+l/OzMr+NUjB8pa++
	/oyabWLMWgV+7gPe63tffLr3/k3MduYVtrp39WpAH3mCHV2V9rkZ31u1NOWmPKKBQg0LLlK/Jpl
	OF0ZTFPBIzLltH26tqXV5QIwYVP5Gj+uud+1KNQ==

Return-Path: <linux-kernel+bounces-100692-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 729E2879BF3
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 19:53:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2E0132893C8
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 18:53:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A88C9142621;
...
Received: from out-181.mta0.migadu.com (out-181.mta0.migadu.com [91.218.175.181])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BEA4D433A3
	for <linux-kernel@vger.kernel.org>; Tue, 12 Mar 2024 18:52:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710269578; cv=none; b=YARapa9ENjCgOBeUNgNYEzf2cPe4nc2Fd8smY1C2FdnycrpjLX3PIUgkZLuEF5S0RSa53/iycnaIhPviUcJ4TD0gCima/fRg8GB0Pyqkkg2B6Og/KrCXUUyM+sNRFD+ePxAH9urHXB+f2j4Y6PphchgMySkvj7GT8bUuRuZcS8o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710269578; c=relaxed/simple;
	bh=NKg4Q71TmG2wl3jNVwI2w6kog2D0YPNFn53K+82hu64=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=eMeY/v/hvBJ8agMIelduTywirBcsuLQVyF5s9b6hyjNZSdJ02VlUDMSxqjMg/atk7UHm2p51aT5jntErcVIkroDW7lvrAWWnXW8bJw4gWoh0/FBAmrdC5EIXddpP2rya+KIQ8855mWYwDZMlRwkGvVZmXkrMbUF0emYF+sf8aLs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=aMHEXlN8; arc=none smtp.client-ip=91.218.175.181

Return-Path: <linux-kernel+bounces-118878-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B70D788C08F
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 12:24:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id E7542B226B0
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 11:24:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EBAA153E2E;
	Tue, 26 Mar 2024 11:24:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b="E8QwcjPI"
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [213.167.242.64])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 77397DDBC
	for <linux-kernel@vger.kernel.org>; Tue, 26 Mar 2024 11:23:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.167.242.64
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711452240; cv=none; b=Zt3RRpMxgrZGMyXJksUH0bKfbcz3V14DfDyAjyCdwUJb3HqlX/BbXQHsTXfqG4AzyBAP1TPblYg1AI1DwrLlu9GSV+Zp4oJwLQhrPukFyr9b0d43VbM7FSEe8RAos4SqXz144ds5Cn8w2w4vqO5hjylRrlK+ImTqi5iP2WzxFF4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711452240; c=relaxed/simple;
	bh=cDHFY94VCs+4au5i+my9hvMk95Ehb70zLOWNxEgqEb4=;
	h=Content-Type:MIME-Version:In-Reply-To:References:Subject:From:Cc:
	 To:Date:Message-ID; b=LPeV8Wax5wscS2RRAFMPvjoeMWrXtxO2PkLCn2ATSAVs6lh1B1NEe8PTI+C3YHJ4ZG9GCFEa4EySYIpnXgNYHvO7yOwVljO4+e7CJuCJTcgVIs0H/RwsZpumIKuzOGRIkc1SVQvrwjp551hRa2p42iqHzWbvCLdsEqbMiWXN8NM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ideasonboard.com; spf=pass smtp.mailfrom=ideasonboard.com; dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b=E8QwcjPI; arc=none smtp.client-ip=213.167.242.64
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ideasonboard.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ideasonboard.com
Received: from pendragon.ideasonboard.com (aztw-30-b2-v4wan-166917-cust845.vm26.cable.virginm.net [82.37.23.78])
	by perceval.ideasonboard.com (Postfix) with ESMTPSA id 12B09497;
	Tue, 26 Mar 2024 12:23:24 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ideasonboard.com;
	s=mail; t=1711452204;
	bh=cDHFY94VCs+4au5i+my9hvMk95Ehb70zLOWNxEgqEb4=;
	h=In-Reply-To:References:Subject:From:Cc:To:Date:From;
	b=E8QwcjPIA139Am/hxHco3lDq5QmNC7IqKzV4l7zO160PHvqEIWDZGAzXYpiGk8Wka
	 W6uQIHp0H4+KiJuVJ84cbzEq2ZmgST5Ueou5e6duVz7vJarlHtSt5l7ycNiyAxKOFY
	 LF6SJfflX8DThSHxBfU9gHRbyrlN1xH7/IVsLqbg=
...
In-Reply-To: <20240319072712.133449-4-umang.jain@ideasonboard.com>
References: <20240319072712.133449-1-umang.jain@ideasonboard.com> <20240319072712.133449-4-umang.jain@ideasonboard.com>
Subject: Re: [PATCH v3 3/6] media: imx335: Use V4L2 CCI for accessing sensor registers
...
Date: Tue, 26 Mar 2024 11:23:52 +0000
Message-ID: <171145223294.1011926.9024981689511107447@ping.linuxembedded.co.uk>
User-Agent: alot/0.10

Quoting Umang Jain (2024-03-19 07:27:09)
...
It also helps improve readability of the driver.
...
Some of the register values written could be broken out into enum
defniitions or BIT() fields I think - but that can just as well be on
top. I think this already helps, and perhaps later we can look at
breaking out the register tables to functions for more flexible
configurations which would be a better time to add the register value
definitions.

As this patch preserves the way the driver writes to the device, and
keeps the values I think that actually helps clearly track the change in
the patch.

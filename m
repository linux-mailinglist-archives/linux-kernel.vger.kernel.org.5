Return-Path: <linux-kernel+bounces-17322-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F2E7824BC6
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Jan 2024 00:19:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id AA9C71F2328D
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Jan 2024 23:19:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2A60F2D054;
	Thu,  4 Jan 2024 23:19:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="lX3dLoaT"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-yb1-f202.google.com (mail-yb1-f202.google.com [209.85.219.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 84FD92D02A
	for <linux-kernel@vger.kernel.org>; Thu,  4 Jan 2024 23:19:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f202.google.com with SMTP id 3f1490d57ef6-dbe9eeb4a60so1202526276.3
        for <linux-kernel@vger.kernel.org>; Thu, 04 Jan 2024 15:19:09 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1704410348; x=1705015148; darn=vger.kernel.org;
        h=content-transfer-encoding:to:from:subject:mime-version:message-id
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=TPzuEKzRrL81jyZLVHH/kadM86g22bb5qzwLRzcADww=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704410348; x=1705015148;
        h=content-transfer-encoding:to:from:subject:mime-version:message-id
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=TPzuEKzRrL81jyZLVHH/kadM86g22bb5qzwLRzcADww=;
        b=
X-Gm-Message-State: AOJu0YzcKATUMVVOGFLHfc4JHOMyY6TTzyK+nUFlYwWKp2ft8OBpVPDP
	bDsTENd1l7Ab2cOP0CwiIYO4fn4nYSeW7UnJKCc=
X-Google-Smtp-Source: AGHT+IEXZzt69hSSjJG846GhPE1tjpnhudfHoZA4qgFiL1IClk9Rc1sBiWrHIfrct/M12mLKVolM+Re6LSub
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:6a70:551e:bdf8:84f3])
 (user=irogers job=sendgmr) by 2002:a25:6b01:0:b0:dbe:aab3:4371 with SMTP id
 g1-20020a256b01000000b00dbeaab34371mr40444ybc.8.1704410348569; Thu, 04 Jan
 2024 15:19:08 -0800 (PST)
Date: Thu,  4 Jan 2024 15:19:03 -0800
Message-Id: <20240104231903.775717-1-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v1] perf vendor events intel: Alderlake/sapphirerapids metric fixes

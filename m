Return-Path: <linux-kernel+bounces-79459-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id DE4A9862287
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 04:41:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 3DD0228475F
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 03:41:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1457313FEE;
	Sat, 24 Feb 2024 03:41:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="KZziM5lc"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 82670AD54
	for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 03:41:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708746068; cv=none; b=ppb3TF+pe/A7jUKEbMNnel/EhRf+roRdtSOXumltTrL8gG4aiajcl2IaO7JLHgVEcVL9Jd3CbKnIbepYQtRjueWCRPpRFQBaDQAsyBLBZsliG7vEswhM0LV//ZKOp6Qlcdxf5gc/l1I/3NxdRyOm5mBZlAtRXgDSl7XEdBLAdWg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708746068; c=relaxed/simple;
	bh=c/zHpktxnGFIiWqGp9NN1CDkYCuZli7EcAVubgMtnNg=;
	h=Date:From:To:Cc:Subject:Message-ID; b=XVN6wxdb4KGwK2LfPYK4PW6Er/9G+/BtySgIef/CnkTZn40BZ84E3d7/vWAJQ3cXKxXJ/HyNLKyl5CNBJ/Uv2Ja+/P9wgWC1p0lG/q620Ykyg0tuaYIHv/Wd59urSNJd4l4YcCn/RwstXlloWgLCbwcDzWV6SaI22XJkb/E3tUQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=KZziM5lc; arc=none smtp.client-ip=198.175.65.11
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1708746063; x=1740282063;
  h=date:from:to:cc:subject:message-id;
  bh=c/zHpktxnGFIiWqGp9NN1CDkYCuZli7EcAVubgMtnNg=;
  b=KZziM5lcolUVH9sSdIP070Gn8dTKZPuh1wQJ+YY+hhdasZxaAHMemHat
   /dq7a/Sg7NPU/K+9t8ckAtos2tGx+bSSe9V5leVCN9ImQgpQ9aG8D44tg
   7oKXl3hLFGEai+HQTy2ktRAslg9/J753ib+mrvnfJvgwQ9QKJYa4Is83m
   /HAHr3juchZtczg2A83BTXdPTjU8Vx9jz9rYPcJsSlompCAyYn82Iw/ig
   uKqPz30NPOVCBfAczbbpa9mfZ1YCsKxX42p/FUqtczyIS/TEaD+/ieCgt
   fVxT91qUkITj/zyUUrluzaQHIbFrePA8UbjQDsavypEkbMXqxIRHSPJrQ
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10993"; a="13647681"
X-IronPort-AV: E=Sophos;i="6.06,181,1705392000"; 
   d="scan'208";a="13647681"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
  by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Feb 2024 19:41:03 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,181,1705392000"; 
   d="scan'208";a="5995146"
Received: from lkp-server02.sh.intel.com (HELO 3c78fa4d504c) ([10.239.97.151])
  by fmviesa007.fm.intel.com with ESMTP; 23 Feb 2024 19:41:02 -0800
Received: from kbuild by 3c78fa4d504c with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1rdiuJ-0008BI-0b;
	Sat, 24 Feb 2024 03:40:59 +0000
Date: Sat, 24 Feb 2024 11:40:09 +0800
From: kernel test robot <lkp@intel.com>
To: "x86-ml" <x86@kernel.org>
Cc: linux-kernel@vger.kernel.org
Subject: [tip:irq/msi] BUILD SUCCESS
 ae4debc7fd82e4612a7f4460394b4fb8e95f6ed2
Message-ID: <202402241106.StauMs1c-lkp@intel.com>
...
branch HEAD: ae4debc7fd82e4612a7f4460394b4fb8e95f6ed2  genirq/msi: Export MSI allocation/free functions and provide a conveniance wrapper

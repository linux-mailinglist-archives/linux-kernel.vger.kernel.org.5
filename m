Return-Path: <linux-kernel+bounces-55118-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 871E084B7F7
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 15:33:06 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 3C46F1F26072
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 14:33:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D89EB132C3A;
...
Received: from mail-qk1-f181.google.com (mail-qk1-f181.google.com [209.85.222.181])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C73612F39C
	for <linux-kernel@vger.kernel.org>; Tue,  6 Feb 2024 14:32:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.222.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707229945; cv=none; b=RNOzXcqIhTKB8NUm9I38z4F8nr3fIdzXbh6ADB8XmGP9AvnVwAiyu4qGqx70ljuVBLyCgS0NsP6FpocihnwlDiLZbrB60UdZVTgozk2hC8rdjShtGlepJFPssx1IGIGiNm0ugCHeF9fer6mRbcg2P0XoMNccnvxLVYN/8ZcFAGs=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca; spf=pass smtp.mailfrom=ziepe.ca; dkim=pass (2048-bit key) header.d=ziepe.ca header.i=@ziepe.ca header.b=Yqr92IQH; arc=none smtp.client-ip=209.85.222.181
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ziepe.ca
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ziepe.ca
Received: by mail-qk1-f181.google.com with SMTP id af79cd13be357-7838af983c1so424142185a.3
        for <linux-kernel@vger.kernel.org>; Tue, 06 Feb 2024 06:32:23 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=Q/zHFU5Yqwp5a/UOgLX2f7LwI3WOYEuRTvyafnU2czI=;
        b=
X-Gm-Message-State: AOJu0YydUtZAUnE0dbNj302blQxdcsriRfELYK+BNeaV5hIerheUBfK5
	fzNlxgq12Jrgg81PdvOywGu1ie5ceSA9Cxtup2MexTIz+GaQ9unTtxCkDsKY3lc=

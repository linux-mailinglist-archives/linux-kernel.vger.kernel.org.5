Return-Path: <linux-kernel+bounces-137029-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id B877689DB53
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 15:56:13 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id CC97A1C2141B
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 13:56:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B4B5A12F397;
	Tue,  9 Apr 2024 13:52:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b="AzoxHpCk"
Received: from madrid.collaboradmins.com (madrid.collaboradmins.com [46.235.227.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CD323134CD3
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 13:52:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=46.235.227.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712670775; cv=none; b=Tj5PHeggpOj4LKPsUVW1AZT90/pZcAyhLMFPeUmSQJvAT2iM+zsZBO1QyxSQEyDHM2hhpIh02wxTlkuqDG+gKOyzPOCylDn0I1CF7BDSc2fp284ZAgPcWHgvN7RG53WC67W9oKhGBIcKYmy/sLv7RzEbLM0LWQJAltA49RZJVG4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712670775; c=relaxed/simple;
	bh=pjSASprXlZ+84+poL6wQsKBXTq1FeRPg2tyI7AUvAPU=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=T2sjya3lgRtevY+C1Y2fnSlKPTM2dxMNZBPfGzptDROOIMDCOk2/oB1fiW0fvGeaEJElQ9cr6Rvsu1gDyElM4SbSMFeon0lUstrNoPNL7s65ZToigivyUCCXch+NgcoVt9ySBShaq9KQv0HSPKa9pYzZXd3KqSAlOwfY+Z3tsKU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=collabora.com; spf=pass smtp.mailfrom=collabora.com; dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b=AzoxHpCk; arc=none smtp.client-ip=46.235.227.194

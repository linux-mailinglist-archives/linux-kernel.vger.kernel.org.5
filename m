...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9C6D47D42BC
	for <lists+linux-kernel@lfdr.de>; Tue, 24 Oct 2023 00:37:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229879AbjJWWge (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 23 Oct 2023 18:36:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53234 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229562AbjJWWgc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 23 Oct 2023 18:36:32 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DE8D2A3
        for <linux-kernel@vger.kernel.org>; Mon, 23 Oct 2023 15:35:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1698100541;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=XnUI6MXPyllgFcPvtyQzH/jOG9RtQses98Of+ki/vRo=;
        b=Wy7fdWF06F/60b3GbEKt+kb1zipku6ysdirQLcUBQQMMk5aHVedlsnSZquafnrgiPlyl4K
        3VPC0uaRAGipSD0jlY08hdekbYSwXDQz0+E4ZiiAT4n3qCtUC6l/PLw11E7um6q6Ilu4xi
        Hysjll2BYBQqINAKg3+KC5Ui8c3GVwg=
Received: from mail-ed1-f69.google.com (mail-ed1-f69.google.com
 [209.85.208.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-595-xhjaTqkiNPam0RTlDLATxw-1; Mon, 23 Oct 2023 18:35:30 -0400
X-MC-Unique: xhjaTqkiNPam0RTlDLATxw-1
Received: by mail-ed1-f69.google.com with SMTP id 4fb4d7f45d1cf-54029fbd343so1329877a12.2
        for <linux-kernel@vger.kernel.org>; Mon, 23 Oct 2023 15:35:30 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=XnUI6MXPyllgFcPvtyQzH/jOG9RtQses98Of+ki/vRo=;
        b=
X-Gm-Message-State: AOJu0YzKv1q+QFiaTC58e3RbP8sHwd/aozKWyFeGXMQ+aPdgfsLT1Jxs
        3M+LQq4TOi4P2PytaslkehM19ki0GrzIvrJUqkP1jDg8rjmpFFEHmcO8fz1S/mTjFSCWS9JR9rq
        a1xQ8ZjZYSobsLAUBBuALwyIF
X-Received: by 2002:a50:9fe3:0:b0:53e:158b:586d with SMTP id c90-20020a509fe3000000b0053e158b586dmr6243311edf.21.1698100529008;
...
X-Received: by 2002:a50:9fe3:0:b0:53e:158b:586d with SMTP id c90-20020a509fe3000000b0053e158b586dmr6243300edf.21.1698100528583;
        Mon, 23 Oct 2023 15:35:28 -0700 (PDT)
Received: from pollux ([2a02:810d:4b3f:de9c:642:1aff:fe31:a15c])
        by smtp.gmail.com with ESMTPSA id m20-20020a509994000000b0053635409213sm7117258edb.34.2023.10.23.15.35.27

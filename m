Return-Path: <linux-kernel+bounces-123035-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6BE8A890151
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 15:10:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 8EAD61C2B7DF
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Mar 2024 14:10:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3E9AB129E93;
	Thu, 28 Mar 2024 14:09:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="ulhoxQpS"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0C29E81737
	for <linux-kernel@vger.kernel.org>; Thu, 28 Mar 2024 14:09:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711634971; cv=none; b=quWmCCODEYlQJgKaCPjJTqHHrhWPxckS/U7OMt9IzyhpXzNFVL8qRegPw3VVuVcJh6GMzuZH99aMuD7Vgf/4AGbmmFZ1OXpumY+EuvPuFNelkT1JB2ENLlWtrvY2Hm6ay3Vd4i5x6ctEqktnJS30s+jJno1xxCr+gxf+IS21k2w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711634971; c=relaxed/simple;
	bh=ZR+FDy105meI+WZXdZ6rgTBpMmaMXCpT9ksqy5R2t4Q=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=LSh9KhgGMB4eQQkHo9acnBhFq7vLJxkB6cFmyjXuwgLZYAfzcK8viByAa34JMKEY0Y83lsk5pw0ahtJ+dMUWNonIC1nsO3HLz4jVO4wN8TNa8bwcvzmS91rx/CDFTsA++7SJy5DH4eiy7qi8k8myIrQI3DXoHJ5f+6rcOQGN1vo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=ulhoxQpS; arc=none smtp.client-ip=10.30.226.201
...
Subject: [PATCH] f2fs: zone: don't block IO if there is remained open zone

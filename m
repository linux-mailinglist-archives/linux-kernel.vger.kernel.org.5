...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=5N8itChEk8GU//5mEJKtr3mUGKsCDKlVDDcch4PolT8=;
 b=JrgULRa3yOzUoQsD/P8G67exDA4KnQYbUcf7WhOJmwAuSXwnFtOflpTheMESzJjLs6wlJCz7YWpYyhe2tLCQDnPwxklaCkTiB6yki+gHMiJ9QZJntYuRy82I10g0+pbeN7bjZChEqtjuYDKH1NmYmtNVi2tfxW+EklxyxP042e0=
Received: from MW4PR03CA0186.namprd03.prod.outlook.com (2603:10b6:303:b8::11)
 ...
 15.20.6678.24; Mon, 14 Aug 2023 05:53:56 +0000
Received: from CO1NAM11FT079.eop-nam11.prod.protection.outlook.com
 (2603:10b6:303:b8:cafe::73) by MW4PR03CA0186.outlook.office365.com
 (2603:10b6:303:b8::11) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.6652.33 via Frontend
 Transport; Mon, 14 Aug 2023 05:53:56 +0000
...
Received: from SATLEXMB04.amd.com (165.204.84.17) by
 ...
 15.20.6699.13 via Frontend Transport; Mon, 14 Aug 2023 05:53:55 +0000
...
Subject: [PATCH v4 07/14] x86/sev: Move and reorganize sev guest request api
Date:   Mon, 14 Aug 2023 11:22:15 +0530
Message-ID: <20230814055222.1056404-8-nikunj@amd.com>
...
X-MS-TrafficTypeDiagnostic: CO1NAM11FT079:EE_|DS7PR12MB6262:EE_
X-MS-Office365-Filtering-Correlation-Id: d3e0eae0-2826-4d23-6c1d-08db9c8ad8dc
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 14 Aug 2023 05:53:55.9082
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: d3e0eae0-2826-4d23-6c1d-08db9c8ad8dc
...
index 0f519b855169..e84f7c532f4e 100644
...
@@ -66,95 +40,6 @@ static inline unsigned int get_ctx_authsize(struct snp_guest_dev *snp_dev)
 	return 0;
 }
...
@@ -162,255 +47,6 @@ static inline struct snp_guest_dev *to_snp_dev(struct file *file)
...
@@ -610,7 +246,7 @@ static long snp_guest_ioctl(struct file *file, unsigned int ioctl, unsigned long
...
+	if (snp_is_vmpck_empty(snp_dev->vmpck_id)) {
 		...
 		return -ENOTTY;
@@ -638,147 +274,63 @@ static long snp_guest_ioctl(struct file *file, unsigned int ioctl, unsigned long
 	return ret;
 }
...
@@ -786,11 +338,9 @@ static int __exit sev_guest_remove(struct platform_device *pdev)
 {

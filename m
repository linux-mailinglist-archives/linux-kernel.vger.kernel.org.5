Return-Path: <linux-kernel+bounces-127688-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D17A894F7E
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 12:04:33 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 8A2EDB21F02
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 10:04:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5191C5A11A;
...
Received: from mail-ed1-f45.google.com (mail-ed1-f45.google.com [209.85.208.45])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 63D765914E
	for <linux-kernel@vger.kernel.org>; Tue,  2 Apr 2024 10:04:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.45
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712052254; cv=none; b=QskotNtloAtmQe91nbxIGp7IIyF2uxEuWGwVmQj/g5SWPZdBTL8GErVQY4PE/RjFLnCX48OwRJtWoWOejPv5Grm5EWcFTn+shCgLtbNNTTr7ca+OhZKyZnR1aZ2KEkO7HVnSIesLAnkaR0zFtXJSFpB0Apy7WyEvEU9+KVoXbAE=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=ER90SeNm; arc=none smtp.client-ip=209.85.208.45
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-ed1-f45.google.com with SMTP id 4fb4d7f45d1cf-56df87057bbso34965a12.3
        for <linux-kernel@vger.kernel.org>; Tue, 02 Apr 2024 03:04:12 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:from
         ...
         :message-id:reply-to;
        bh=lXlejm1gxhMkyf9SE5eKOVkRtnhxyT9RO6nl18SlSZM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUBYtlKynP9883g0BfeJ4upD9FF0xGwDTJ679WmyVVeE3T/tf7GRiRspZ2H94TU/CQNsJkr9n2c10xq3/8uUkMhR7anZ6ZZNDynY3zG
X-Gm-Message-State: AOJu0YwwdagCW80jVmHbrxT/uqelXyTJ+rBlRVC9jKLFSpTWurvH1O8v
	+yRvZNjK2nSsxhZjfdxYDWjFfW69/Ys91GZFNhafrW7Jvtuo8jBhSW/smZ3rlSY=

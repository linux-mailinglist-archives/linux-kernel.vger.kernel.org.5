Return-Path: <linux-kernel+bounces-37954-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A178683B8BA
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 05:39:10 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C62311C22FED
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 04:39:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5779A13AE8;
	Thu, 25 Jan 2024 04:37:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b="vvc5h+go"
Received: from mail-pf1-f171.google.com (mail-pf1-f171.google.com [209.85.210.171])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D94A412E40
	for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 04:37:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706157473; cv=none; b=Y3pgYePMeEUb+AVg5qN1m7q5YwS7lLwJ0kZqMcMf+H3VEDmtRvesXz1wxJbnlMFPdUEwtCzzCdCzxir56aDz4HQshwJFH9/0WMBHuWyjPEQnxJWixh7rzyTAzYjlMIxm/KrNtFMAMMbttAyqOvZxEQr1SqrkpWM1u0Lvg1oo0I8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706157473; c=relaxed/simple;
	bh=jmU5v1saYkXXq9EBev9Ue0PIDQh3p4wU0QdJKY7LopM=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=qPPA7hfEnFbxt6mfWP4BWBLXqvZFtxm0LNIPDjKCZbcI2dELJju5TjCnnPVHvXKDMzRMFFvgN+VCcydcIXuCoSq7EeCQdUZa234BiXMMkDov9pqrZsEp/IRXbhLyPzLeyZ4KR2iNlEHq4ceZFsmjGgtLxkCnlgj7h7WZ4Lqn9xM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com; spf=pass smtp.mailfrom=rivosinc.com; dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b=vvc5h+go; arc=none smtp.client-ip=209.85.210.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=rivosinc.com
Received: by mail-pf1-f171.google.com with SMTP id d2e1a72fcca58-6ddb1115e82so853622b3a.0
        for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 20:37:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1706157470; x=1706762270; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=QCA1ehFkp96pmOTkjvQQHxnaVfcybTJeIzIBQuqFuYo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706157470; x=1706762270;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=QCA1ehFkp96pmOTkjvQQHxnaVfcybTJeIzIBQuqFuYo=;
        b=
X-Gm-Message-State: AOJu0YwQpU668HNR+6zRU1lDu0Xo13j4E4+ojfJtb9UbFk1/zRrlM4tD
	16poLnIuHwR4GRywO+EJR2LIXsKR42+aaMCvig91AiIxuHXlX6RJI/R3MKMQPaU=
X-Google-Smtp-Source: AGHT+IHI/be75u766JgYeP8evVin90tZWQd25fqjSclMlvFgREp7sxKlz8cOIxCBK+62BI47BO6l2w==
X-Received: by 2002:a05:6a20:728e:b0:19c:6a60:b42b with SMTP id o14-20020a056a20728e00b0019c6a60b42bmr620095pzk.14.1706157469966;
        Wed, 24 Jan 2024 20:37:49 -0800 (PST)
Received: from charlie.ba.rivosinc.com ([64.71.180.162])
        by smtp.gmail.com with ESMTPSA id n2-20020a056a000d4200b006ddce8e110bsm355185pfv.128.2024.01.24.20.37.49
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 24 Jan 2024 20:37:49 -0800 (PST)
From: Charlie Jenkins <charlie@rivosinc.com>
Date: Wed, 24 Jan 2024 20:37:25 -0800
Subject: [PATCH v4 2/2] lib: checksum: Use aligned accesses for
...
Message-Id: <20240124-fix_sparse_errors_checksum_tests-v4-2-bc2b8d23a35c@rivosinc.com>
...
X-Mailer: b4 0.12.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1706157467; l=27961;
 i=charlie@rivosinc.com; s=20231120; h=from:subject:message-id;
 bh=jmU5v1saYkXXq9EBev9Ue0PIDQh3p4wU0QdJKY7LopM=;
 b=W2gw+iqkC6DnUh3S/b7+dBqe0H6aN+Ig4c5eG1B+MyfSW6xx/PLSms9fxpPieTTm2PP8cby7n
 uXDb1ou7qLhBSYUldsuYDC4WKmsSMt1UE6hYV+1I+RscRafkiSjdYdt
...
index 776ad3d6d5a1..4f16c354c706 100644

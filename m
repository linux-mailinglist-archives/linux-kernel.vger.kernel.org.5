Return-Path: <linux-kernel+bounces-17685-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 62311825125
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Jan 2024 10:48:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id CEC601F2205F
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Jan 2024 09:48:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2EF7024B47;
	Fri,  5 Jan 2024 09:48:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="WE2+zfu/"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-yw1-f201.google.com (mail-yw1-f201.google.com [209.85.128.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A388C249E9
	for <linux-kernel@vger.kernel.org>; Fri,  5 Jan 2024 09:47:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--vdonnefort.bounces.google.com
Received: by mail-yw1-f201.google.com with SMTP id 00721157ae682-5e9a02c6d49so25424317b3.2
        for <linux-kernel@vger.kernel.org>; Fri, 05 Jan 2024 01:47:58 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1704448077; x=1705052877; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=CmqFU5yf5cXpLanSSFZvIQvUYJLTz71QbTeswXv68B8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704448077; x=1705052877;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=CmqFU5yf5cXpLanSSFZvIQvUYJLTz71QbTeswXv68B8=;
        b=
X-Gm-Message-State: AOJu0YzoVMIeSt5TdBSp/taJ40QfSQ72IR/BSJYv/OlDNoXfLKFVHZOG
	outxexSRBgShMODyiubz4iqd0/4eNSWR5mYC3H9pZgU=
X-Google-Smtp-Source: AGHT+IFEi7XI1DOQtUKB2Q21+iuttWj8jjNX2Vfy4WATwdes0p8ZTmU32r57d1119zHR5UU5ldQ1RVoFP15RDCQ/
X-Received: from vdonnefort.c.googlers.com ([fda3:e722:ac3:cc00:28:9cb1:c0a8:2eea])
 (user=vdonnefort job=sendgmr) by 2002:a05:690c:2e8d:b0:5e8:90de:db6c with
 SMTP id eu13-20020a05690c2e8d00b005e890dedb6cmr945583ywb.1.1704448077725;
 Fri, 05 Jan 2024 01:47:57 -0800 (PST)
Date: Fri,  5 Jan 2024 09:47:28 +0000
...
Message-ID: <20240105094729.2363579-2-vdonnefort@google.com>

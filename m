Return-Path: <linux-kernel+bounces-137196-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 98B6A89DEA3
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 17:18:37 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id EDA931F2C6CE
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 15:18:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2ABEE13A86D;
	Tue,  9 Apr 2024 15:15:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="guZPahyG"
Received: from mail-lf1-f54.google.com (mail-lf1-f54.google.com [209.85.167.54])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D7B2113CAAA
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 15:15:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.54
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712675726; cv=none; b=ADVQKg0LcKPQRmvWnBAYRx8R1feB+601wcrDTt0bXowC8d2I6D8nhHZg2vKghxoL0XEk5z8vb3/NokEzn3TIdxXUQpK2GMz7vtMHYYLPzlYwW1snBtdgslWXRrNZYutEDIadQrZrcID85gRvZetHYjxFsHY1kz4SDPXylMAv5ao=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712675726; c=relaxed/simple;
	bh=qm9OEVMzX6tE9LDY9ir11jgqLKz3niWPp+bo/lgxXCY=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=tRd2XdGH8fI4b+aoOTdS/BdRG8CF50wLMHAbrmAaoyegQkJIp3wZG3ykqLUywsTehGf837ZI7njE2bU6S5kyVT/I+pSelW+MQc2zSMCvAn0o2KStFETUkbLO/02cMwaowLwdl1gjJZ0G+XEd/UzBbbMWD75T1zhlBXj1p0seLx0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=guZPahyG; arc=none smtp.client-ip=209.85.167.54
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-lf1-f54.google.com with SMTP id 2adb3069b0e04-516d0c004b1so6663440e87.2
        for <linux-kernel@vger.kernel.org>; Tue, 09 Apr 2024 08:15:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1712675721; x=1713280521; darn=vger.kernel.org;
        h=in-reply-to:content-transfer-encoding:content-disposition
         :mime-version:references:message-id:subject:cc:to:from:date:from:to
         :cc:subject:date:message-id:reply-to;
        bh=EMWS4mPrrF8Ct6YFyO/ObmKaP4rMRLJkaeYl8zMi+3U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=EMWS4mPrrF8Ct6YFyO/ObmKaP4rMRLJkaeYl8zMi+3U=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWGeL34Sh/9boMNf8imXCTxyV4y13qTFBzBC8YcqxnVUST5mYGbwHOUesSOTRTubmxCA7N1De0yr0lh2xSx8VeZ7OWWt9t5gbVCS/ql
X-Gm-Message-State: AOJu0YzVYtqk9cac9bZlPh6JS+3yXaGo4X5ail59MSwEPiMgJow1Nzs2
	xV5Eyzw/yD1a1LHLUB8bEvvC9tz277MB2MTj/ipJKhEkKfg2YU9rTtqZf1aSbek=
X-Google-Smtp-Source: AGHT+IEwLwk3ll8TD8uazg/KAa0xMwZFzr3n1kQvoteQbJ/0zZ06aOho8bjjvftdOkyC/tbJQJqGBw==
X-Received: by 2002:a05:6512:4859:b0:516:d14b:435f with SMTP id ep25-20020a056512485900b00516d14b435fmr8222378lfb.14.1712675720659;
        Tue, 09 Apr 2024 08:15:20 -0700 (PDT)
Received: from eriador.lumag.spb.ru (dzyjmhyyyyyyyyyyyykxt-3.rev.dnainternet.fi. [2001:14ba:a00e:a300::227])
        by smtp.gmail.com with ESMTPSA id w24-20020a05651234d800b00513cb309c8asm1572222lfr.52.2024.04.09.08.15.20
...
Cc: =?utf-8?B?TWHDrXJh?= Canal <mcanal@igalia.com>, 
	dri-devel@lists.freedesktop.org, daniels@collabora.com, helen.koike@collabora.com, 
	...
	linux-amlogic@lists.infradead.org, linux-rockchip@lists.infradead.org, linux-kernel@vger.kernel.org

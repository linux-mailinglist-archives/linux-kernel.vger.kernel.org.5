Return-Path: <linux-kernel+bounces-54774-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id EF37084B381
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 12:33:10 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A6E2D282E13
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 11:33:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1A5A6131722;
	Tue,  6 Feb 2024 11:30:01 +0000 (UTC)
Received: from szxga05-in.huawei.com (szxga05-in.huawei.com [45.249.212.191])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6DE44130AD4;
	Tue,  6 Feb 2024 11:29:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.191
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707219000; cv=none; b=YQgvrhfBtP5LFv0S30f/KlSwN5/Zr1qRGPtjvkAxCc2jr2ndql+uwZmKNhoBWnepduahJ44KzPOS+y25hWpJ1FqXv0woQUSOm5GQhX2APixMBcW6DmM4mrdoqp+zj6fNctm2WLteFA0ZgwtzitwHi20uqkx85DKn8Heh+0w2+aI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707219000; c=relaxed/simple;
	bh=Erd0plscaM1fNIfpMjva0QETCJ1XaeURSSfLXhFXv04=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=PvH6hANOxeI+T+lg9qY1Nf0dLda/SHfLknblV1/fUSbESOTtSp8O28oYrV4TbDrqaI7VQCVRfgWwLgTf/EILvac56fiX97SRLdgTlao4hBlwBSjb4rWHiKHKMW0nw63jrWqOpIq8hF5UHtQbtuNru1McsTFX4B5vs12RiOxkU6U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.191
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.163.44])
	by szxga05-in.huawei.com (SkyGuard) with ESMTP id 4TTgwJ4PB8z1gyfQ;
	Tue,  6 Feb 2024 19:28:00 +0800 (CST)
Received: from kwepemd100002.china.huawei.com (unknown [7.221.188.184])
	by mail.maildlp.com (Postfix) with ESMTPS id 2A7B2140499;
	Tue,  6 Feb 2024 19:29:56 +0800 (CST)
Received: from M910t.huawei.com (10.110.54.157) by
 kwepemd100002.china.huawei.com (7.221.188.184) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.2.1258.28; Tue, 6 Feb 2024 19:29:54 +0800
...
Subject: [PATCH v7 3/5] perf: script: add field 'disasm' to display mnemonic instructions
Date: Tue, 6 Feb 2024 19:29:27 +0800
Message-ID: <20240206112929.1035548-4-changbin.du@huawei.com>

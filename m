Return-Path: <linux-kernel+bounces-49172-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B0A88466C6
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 05:06:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id F1F2728E9A2
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 04:06:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EB9F912E70;
	Fri,  2 Feb 2024 04:05:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="EQ9ODBkn"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 83DCE14F8C
	for <linux-kernel@vger.kernel.org>; Fri,  2 Feb 2024 04:05:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706846724; cv=none; b=ZR5JkgnooNuY9d27W7+MWk7TZzXM/q9jC3mR+OV4sBephYWh9P9aElk0xNO4fjHRsW2tRuvB8wQGcyWUQ316zY1gfyqIVMYybY80zbiCbJRU/pwnrBWY7Fnotyi/S00inuiMDgWwtiZlYq/Q/OqEDNyEeaSEgATMLry3V6rhgEA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706846724; c=relaxed/simple;
	bh=dWXvi333COFPwchlTW8ExA3ESq60zjHHpDLkxnG1M4c=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=UuDtptuQsdo2YxX9RrznVxvNLRnrz6txF99v5yCPMHc1tbnKxYilMh/0ZuC12APBeUFkV0Pl9FI2+12WZl99UpFZ4yITSAlPp1orm8pOMLUQYM4N+jcGZNGHbNshF0jlyIXtinZLoLlzFv3HShoAiRaxF16oqJ/eJEGg2MgwrMw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=EQ9ODBkn; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1706846721;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=j1Iy4SrxzFk/JaS8F9chL+yj9ZQHoLBQ78gaOojkWw0=;
	b=EQ9ODBknjWuePY5afII2s4S8aXOf63X9iswL6T6HYlEQugu39GDSIoxMdgChz1XdzBW56a
	cNpsn+c3oUcs6Lp+AwS4OFEuQ8oaST7RfbLtf0ZxKsAfEeZYYEFp3dYL6+/eVfAygaZmri
	IHcsE0fgZ1mkqb1Y/6PhiAryv9t9cyA=
Received: from mail-pf1-f197.google.com (mail-pf1-f197.google.com
 [209.85.210.197]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-483-P6tKgh5iMOq8FkzbJyFucA-1; Thu, 01 Feb 2024 23:05:17 -0500
X-MC-Unique: P6tKgh5iMOq8FkzbJyFucA-1
Received: by mail-pf1-f197.google.com with SMTP id d2e1a72fcca58-6ddddbf239aso1405805b3a.3
        for <linux-kernel@vger.kernel.org>; Thu, 01 Feb 2024 20:05:17 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706846717; x=1707451517;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=j1Iy4SrxzFk/JaS8F9chL+yj9ZQHoLBQ78gaOojkWw0=;
        b=
X-Gm-Message-State: AOJu0YxcXsdAeszBYpx0cjcIet7TMAh3Ro2d8Rl6U9gKx+bi/7Nh+jqZ
	fvHJMldlNTuDqnGuSJk2/ci+Wrrc/ZkNSIvRFShK6W6Xlw0vyB6P2Gm4z0MVUmncBdRNZ+EwGum
	aW27C+qYfmEDFkkM+iMVhgs+PjPirbHCbXp75TWcfp0p+x8swtVGBLlqa+saTbYP/GX6/ca5Wvo
	3kBCAMMDzGfP6mOswlB/wmS2/c3bnnV26dn4dj
X-Received: by 2002:aa7:85cd:0:b0:6dd:9e89:8dd1 with SMTP id z13-20020aa785cd000000b006dd9e898dd1mr6449096pfn.13.1706846716580;

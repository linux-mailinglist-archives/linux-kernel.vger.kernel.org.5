Return-Path: <linux-kernel+bounces-136084-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 25C9189CFD8
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 03:31:33 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 62AF7B22C40
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 01:31:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 999C035894;
	Tue,  9 Apr 2024 01:30:10 +0000 (UTC)
Received: from szxga07-in.huawei.com (szxga07-in.huawei.com [45.249.212.35])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1578E4F5FE
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 01:30:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.35
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712626209; cv=none; b=GPlzBmPKdHv3/4fEPiPyJErvwuQc8wJD5zyK6O81rpUwDY7ZkIX/9BOkUqNvXPjdwuXOU2rsCw/WyL1EKiK5YcdehIVIcRC6CAdHgtybU7RZ5irCdgkdBU4zzy4EQYk27ylUYflSbRftKK7gaxgM1cdaKd0x8wDNrdlyxpPGhvg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712626209; c=relaxed/simple;
	bh=H8o+nuZI1hJCjMGEu6ctt5ZHYfqv2zuVjhZWas5mvKY=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=M+f01oE1Gy14g9xdf+aukSdczSXj9pIhoPlDaiSrYK4mk209tz29xobXVzODy4R7+n2vPuBdYwBgV1ZG22GYNVfyO3P3AJZJqaxuTVqZvmVOrvDUOXTZSUxbtMRIW8ZElv25sngH3nMUWIZg6txUZj8R7QTW8ZhXzjCIYdJInSY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.35
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.88.163])
	by szxga07-in.huawei.com (SkyGuard) with ESMTP id 4VD7c17510z1RBjs;
	Tue,  9 Apr 2024 09:27:13 +0800 (CST)
Received: from kwepemd200013.china.huawei.com (unknown [7.221.188.133])
	by mail.maildlp.com (Postfix) with ESMTPS id F0E91180063;
	Tue,  9 Apr 2024 09:30:04 +0800 (CST)
...
Subject: [PATCH 8/9] arm64: Deprecate old local_daif_{mask,save,restore}
Date: Tue, 9 Apr 2024 01:23:43 +0000
Message-ID: <20240409012344.3194724-9-liaochang1@huawei.com>

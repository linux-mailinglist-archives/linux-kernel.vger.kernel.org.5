Return-Path: <linux-kernel+bounces-94854-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 605B58745F4
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 03:12:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id CA1361F26480
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 02:12:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E3B557484;
	Thu,  7 Mar 2024 02:11:49 +0000 (UTC)
...
Received: from mail-il1-f172.google.com (mail-il1-f172.google.com [209.85.166.172])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9AA1553A9
	for <linux-kernel@vger.kernel.org>; Thu,  7 Mar 2024 02:11:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709777508; cv=none; b=brGj4xHhoGQLc7Gr8RlIb1+dnQPtEpoaK3lgLnmmuADRpD/2RSXUrGsmON2nlmZzwxGzG8cY3TP5a0ki0Z2yONbCvA0a53hUZgQLnx+dVgj6vPzz21ygSR/qr2Im3SPBcALUYCclcCFPpjZOl5TYg1u5lJGqSq/Pj8nejiKyvI8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709777508; c=relaxed/simple;
	bh=0xzXFjWZ1m80S8gluLF6raYLj/LTINPRUXBQ9my8S2I=;
	h=Content-Type:Message-ID:Date:MIME-Version:From:Subject:To:Cc; b=tsBrMgkwPoTTJG5S2gKfI+4VeFhk1wEvEGJYI0AxLI3VwufN9Y7PiLYmNW8L2NyhKKW0ce53koEGCANF5zQnvPFbojI7GeFk5Ti2q1o7kAU0PXelnOJWN3kxEqjWKdfdxahfLndX+LUSkld1BaTjV07MRpR+c3QwIPXIGQvUIbA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org; spf=pass smtp.mailfrom=linuxfoundation.org; dkim=pass (1024-bit key) header.d=linuxfoundation.org header.i=@linuxfoundation.org header.b=TwerY18e; arc=none smtp.client-ip=209.85.166.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linuxfoundation.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linuxfoundation.org
Received: by mail-il1-f172.google.com with SMTP id e9e14a558f8ab-35d374bebe3so582185ab.1
        for <linux-kernel@vger.kernel.org>; Wed, 06 Mar 2024 18:11:45 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:from:content-language:user-agent:mime-version:date
         ...
         :reply-to;
        bh=bU6ex/faxbEcoxve2/Lztk/HkuxBTPG2WMTvXEAw/AQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU+b66WF98BUVNQm7Tz8n/aGu/Pk6KRZcoooN9KOL/H4/EtQm8mF+SOprR69UMxyWZ1IuVN475EoHv8TcYg1e3tsIzUIgz6VfQ4yzGb
X-Gm-Message-State: AOJu0Yy2U87Q6gWQdzVK9VYdaa2uFGaoR0Cg5Sh8zlZYVXvKe/BmulMx
	Q+KRLaDYS92i7eAjIzm5ZgKdArg56/FqcCN64L9owmOM3NTlwDVwH74Q+Ls8oaE=

Return-Path: <linux-kernel+bounces-116680-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A52C88A287
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 14:39:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id BB4991C38D2C
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 13:39:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B747E1428EA;
...
Received: from out-183.mta1.migadu.com (out-183.mta1.migadu.com [95.215.58.183])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 668701703A6
	for <linux-kernel@vger.kernel.org>; Mon, 25 Mar 2024 08:06:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.183
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711354003; cv=none; b=AqDzKPhQ7r0gWEXlm6lo8kt7LsODCtt/5PemynswNmjQIRrHnZgMmqpN3sALYNBTz3/jJtgQJ3CvC0TybA+rsCWk154IqhhEE7CTSWC9CqIBdgPii6TeCIwwZEvZgliBBWasmcOL5qkDubbVkzss5dFTX7RTGdD1RaN9Lz0YBFQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711354003; c=relaxed/simple;
	bh=pZuKPKaS/70/EEjHqPwvnuI3Nv7pHPqM7eodBdRE2D8=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=WWcQJJyYiNA8m5oX7xAEYyald2BnS/eWqLV1XMScD1voXf0Waugt/D5+aX1vQebCC4cfyMhQjAcascDFERjHgqMZVL3/gYMMhFexigPsvbk5EbtEPqH7ry/wUdcGGz36/kjELTfzBOKqd55neHuoX9A9Pa02qDmWXIpYjOJ3ljE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=PgJSqEQn; arc=none smtp.client-ip=95.215.58.183

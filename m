Return-Path: <linux-kernel+bounces-107696-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A7AAB880058
	for <lists+linux-kernel@lfdr.de>; Tue, 19 Mar 2024 16:14:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 0594CB227DF
	for <lists+linux-kernel@lfdr.de>; Tue, 19 Mar 2024 15:14:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 87BB8651B1;
	Tue, 19 Mar 2024 15:14:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="1ZUUa7nX"
Received: from NAM11-DM6-obe.outbound.protection.outlook.com (mail-dm6nam11on2043.outbound.protection.outlook.com [40.107.223.43])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4E5E462818
	for <linux-kernel@vger.kernel.org>; Tue, 19 Mar 2024 15:14:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.223.43
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710861258; cv=fail; b=bcPhQOtFdxF3iPiIMxAP+bH+sudGr9rjWBCNbibx7nrWBK0kp1No690ZGN9VlCPheVrVzVAGusa3zPxcXtR8jYwSNAtYwpI3O5vOe69o5CTaXRci8CfT/KaaLrdCuBmLL+AENu0oOom1/KCZDNBJBqW/bCimDUVi5bQdqnxQGwg=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710861258; c=relaxed/simple;
	bh=4eExE6RFXlQfV4mZ70Vw9wW/6mM5NM65XIe0kYRf0gw=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=QPV/ZdoAMh0YhQrWRmtKqpSKy5EhI8hCBwfuU7sJKDWz+VXL+hmfuIL02ygoS4k7QHiP+WJrL4zgnSL6NS38xYuoszpAHP4CAZL+ry0rHn4NVaymk8Qd8sPiD1arQ5Ez78m65BWNJGkMl+k0zHuJp/AAOCXDMn/ho+uOz8aEoek=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=1ZUUa7nX; arc=fail smtp.client-ip=40.107.223.43
...
Message-ID:
 <PH7PR12MB559640BEA69816791A519630932C2@PH7PR12MB5596.namprd12.prod.outlook.com>
...
msip_labels:
 MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ActionId=e5f8319a-e6b5-4399-8967-191ca50cdbe4;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ContentBits=0;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Enabled=true;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Method=Standard;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Name=General;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SetDate=2024-03-19T15:13:57Z;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SiteId=3dd8961f-e488-4e60-8e11-a82d994e183d;
...
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?aVp4aEhnYmMrSHhndGRibXdPNDRjT1dLa2Q2YlRBSFVSQ1U1cUQzck03WnFW?=
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 19 Mar 2024 15:14:12.8814
 (UTC)

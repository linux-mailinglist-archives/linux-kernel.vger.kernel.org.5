Return-Path: <linux-kernel+bounces-72293-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id D523585B1B1
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 04:52:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 5540BB2237A
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 03:52:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8059E5813A;
...
Received: from mail-pl1-f195.google.com (mail-pl1-f195.google.com [209.85.214.195])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5423C58135
	for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 03:51:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.195
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708401091; cv=none; b=Eg10Oz2HZPZqBLST5EShvgjcNd4z6eQTobPxT4aFaK+fHOT3S6vzLnqOG3fs8GZcZcrzv4xWuFK4v+GGVtYI+E/hBGdKvYgy9iGr2Kxd/8Ou63cJXJc31i9ImaLHiMurDQGS/SJm4TRVhyQhMIBKG342Kj6fXGeZbi8ihOx9fzY=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=bytedance.com; spf=pass smtp.mailfrom=bytedance.com; dkim=pass (2048-bit key) header.d=bytedance.com header.i=@bytedance.com header.b=a8MUyTXR; arc=none smtp.client-ip=209.85.214.195
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=bytedance.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bytedance.com
Received: by mail-pl1-f195.google.com with SMTP id d9443c01a7336-1d746ce7d13so32803235ad.0
        for <linux-kernel@vger.kernel.org>; Mon, 19 Feb 2024 19:51:30 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Snh1k6Nld5+bv3WZ3l7dPau1Zu+9Ra2XDZxa5NzBZqk=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXPw3eTGCzbLciQGwyo0quao7OeQ03u0STjXqiBX5XCCYULd3JrC0t1DvzFX0az9hzyw4ZSY8bIXxUuvgnOH1V1i+P4qnizb1VxAJIs
X-Gm-Message-State: AOJu0YxjxaJRzqYx45b16inVmPvNH3DI2hAi4sL5fsC8vIwKk+KV+8wM
	WERKUT+E1EK9TNj8jcv6Caqxe//B6p+ZfZsqWRcw65OD4fwtgnh+10al3LxMs6Y=

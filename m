Return-Path: <linux-kernel+bounces-146803-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 1E60D8A6B35
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 14:37:43 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 416821C20FC1
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 12:37:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E3FED12B154;
	Tue, 16 Apr 2024 12:37:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Wpg0x6pF"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4CEEE1292D7
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 12:37:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713271050; cv=none; b=Cy3YtahjxgmAzlBT/YFzHnuln7gLp56pKyMmO8rlvf+Y5IsJxdAtNndMgm7puyQnMEW78s9wLGR/DMSIC89ysuU446m9/jGJnXA15P2YgYNQrbzPi54tztJIjiUkC/uTYLmCreAbJBOJHVnURKIiKyS2QRqCtXalN4KAZWoowxI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713271050; c=relaxed/simple;
	bh=ekVxjPvBZVT4t7cOXasmQhQ9V9xKqVBbv4JjdxDpiuM=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=lr0RsBfh8CB5do2FYRfDD3p/8JhjsrLJlEtKuhegRwbn4TtB+qQNeZ8QlnRPxi6gfLRjYiZ0g1sIAQTzaW3eiaCvZa1N2jOnZtZgh7mEHexEsTlGnvF3Gd3SVdcXEjAnT/ZbMv6kqz2v0Vkw1svAM6+RBK3A0oDDeCONqZIgmJM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Wpg0x6pF; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1713271047;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=YEPZpegKIfFunNWQiBPq4cn9O4X8BwktfnZ/+S4ey9o=;
	b=Wpg0x6pFsoxv4tnyhs3v+9pzgnSC0VJnArGXzVn//3i4WiYwESSh+iUyXDEoEm8pVsxX7X
	Dg5hOYAvFE+KHO+FOGviRYwuiT9oGl3wyRGlp78RknAOPHF9XHfRTUoBcMVC9cuHoCrtvL
	1zvlCGOQ+1HNdgzP8kNmjycDoJn9WPs=

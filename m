Return-Path: <linux-kernel+bounces-92481-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id EBE7A872108
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Mar 2024 15:00:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1B8B61C22B63
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Mar 2024 14:00:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 876BA8613A;
	Tue,  5 Mar 2024 14:00:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="jyQKXNrr"
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2064.outbound.protection.outlook.com [40.107.244.64])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D2B3C86151
	for <linux-kernel@vger.kernel.org>; Tue,  5 Mar 2024 14:00:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.244.64
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709647207; cv=fail; b=KdbYXRTvlaxUFis6KY3fgHa+iEkmklmztdMBO7FpMS/ZXNsMNglOdMnBESFZRB/+H2ph9AHG2Kv/XBdLc3jvooo7U3Ms18VTbNPAEX9SQ31mXpQqNx4QMtgH+aKuynTfWRzcOsc23fW8aigSd/ZP9tKxd8BS5IzINgBqDJ0QpVU=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709647207; c=relaxed/simple;
	bh=XGIUlwqnGCrppQPayA6w87kHTCj/iTJexQF9jGOoq2Q=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=u4+mviKQKutkJHELLmCUQJl53wi4fqfFUA7aQ0Rw6JVMZCNiPt7Bjy/x7I42DOV9uuGLy3YObtLWr6XZLdBGTtrrsPg2Du1sptI9LxC5n37gntbFUPtS5sjo26t0CnYpR36vnS/p1kGTfIyj5SeHYslxQ8eNtxMBlQfc4C2JbAY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=jyQKXNrr; arc=fail smtp.client-ip=40.107.244.64
...
Subject: Re: [PATCH v3] drm/amdgpu: add ring timeout information in
 devcoredump
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?UTVPOTJKb096VDNUN1UrZzNMdWxad1lTOGh3UzFoV0VYMUVNK2xqcEQ2Wjl5?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 05 Mar 2024 14:00:00.4716
 (UTC)

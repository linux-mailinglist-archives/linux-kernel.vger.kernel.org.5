Return-Path: <linux-kernel+bounces-136079-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id AE12E89CFD3
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 03:30:40 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 63A702817BD
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 01:30:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A97E64AEFE;
	Tue,  9 Apr 2024 01:30:04 +0000 (UTC)
Received: from szxga07-in.huawei.com (szxga07-in.huawei.com [45.249.212.35])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B59748BF9
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 01:30:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.35
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712626204; cv=none; b=WckVnUSn7jEtdsEFTMyoEHwdnAZpTBviLGD2kqnAKNrLzre8Fd2QqyyZQWWR+kAcHxUcWrNTDGCFnxsFDIwu33Cj5BVHLwX1N5ZHBhoBHxKnvnQykdInz28uLLwuxpkxl0xUGxK5uP4HFJ2nnwJ0sevNgRBuNRydaVyuAsssw4E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712626204; c=relaxed/simple;
	bh=nTnMqrGPAws22NuM6UdpUAlCpX/4nF6Z/m2kHbs1QrQ=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=BY8tmv3PoR8BdtP0SFFgpZaGRZzV+23ehgkxYuUjSCRrpSDvj3wV1Ud1Nru5OEQcbTNNKfYUiW76qVvp31hH8Ae0qwfuQHvAMJA4qLWTfHNPz1cqaOC67INnggxQH2J7ZLJWUYDlyjwaAHJxIt9p64owz52gMdWYKNUXxVaDcVg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.35
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.88.214])
	by szxga07-in.huawei.com (SkyGuard) with ESMTP id 4VD7bv2W6Nz1RBg4;
	Tue,  9 Apr 2024 09:27:07 +0800 (CST)
Received: from kwepemd200013.china.huawei.com (unknown [7.221.188.133])
	by mail.maildlp.com (Postfix) with ESMTPS id 55E301A016C;
	Tue,  9 Apr 2024 09:29:58 +0800 (CST)
...
Subject: [PATCH 2/9] arm64/cpufeature: Detect PE support for FEAT_NMI
Date: Tue, 9 Apr 2024 01:23:37 +0000
Message-ID: <20240409012344.3194724-3-liaochang1@huawei.com>

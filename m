Return-Path: <linux-kernel+bounces-54051-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 39D9684A9BF
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 23:59:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5F1A31C27D22
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 22:59:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CDE8A4F606;
	Mon,  5 Feb 2024 22:57:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="GGqPbEIA"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AFDBA41218
	for <linux-kernel@vger.kernel.org>; Mon,  5 Feb 2024 22:57:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707173875; cv=none; b=FU3W1v0lnAe7CqafBDuoi3kJksbMcmHaXj/D9BrXS1ZFLXibUTIPMDWGnD63s4UP54Z+tU5H/z8vgaPjf4v8Vx5BfgiLXtgUFz2bvDtlIvdOtewMpcm06tCYZz20odZCzDKk1qjLZXaivVIRSXfdoQ7A0ZJsUVvj07SEZaJdVt0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707173875; c=relaxed/simple;
	bh=nbCva3Pi+RfwE482peq2H/s2WoE0tO6Xpi+JhvsOI38=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=Yym1gx8dTrsQJc5A0jQiCCXlCKJyzlgCvoxN2Ed6xKYPMnbj7LPsBxVi3aHXmoDiVu7TudiWJOm7pwfOBnlQI/dpnCP0OBZcbouPWCdI02dI+sbZEXv/Df93TSP6REF7Pv1odXHtFASwiXXWfdQWA5TDCavWVtTdw12Y2ozmbxk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=GGqPbEIA; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1707173872;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=rsfhF+v4jP24sud3ne/FJVWtqEteLzbJn5JlLIWDz9E=;
	b=GGqPbEIACIIecPKbDt4Rjb9AP0cjkoUlpzZBFMRhr3IcQZyMu4frmONQ9uQ7R9emj6+K2P
	rZd7tKRAmIsEJT7ShcK/yamoZ521DyGti5CfLlXXIK6TrmuPFZEe2NDV+j2aSbNCnh0Lh+
	aMEY8Gg0w34UIS+svJXZwTXl0ov6L/0=

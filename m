Return-Path: <linux-kernel+bounces-59621-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 43A8684F9C7
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 17:41:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E4B59287EBF
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 16:41:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 96B877BB0E;
	Fri,  9 Feb 2024 16:40:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="Oc8CKXt8"
Received: from mail-ed1-f44.google.com (mail-ed1-f44.google.com [209.85.208.44])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 547EF7691B
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 16:40:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.44
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707496852; cv=none; b=C1fyOpQ+xE1F2hxLyDxSAQTwfGyWNg6p8CyOzsjKsA3UahZfEhwEigs/x4dHWqLBMDUzYABP7fEHsSgn0/LciKzT7hkMpEPoKtrEJJck0xxkaL1WYLSjx73PKZ9Oc7UBpWNCLNbr1v/2hkJHqDa6+1gCbdzHqfZPxMYtLvPyif4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707496852; c=relaxed/simple;
	bh=Oj/Sc799EYOeafhpR1FrkrBtmCYkPlAz/EoBkpGYuZs=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=UOeD4SdwBPO6peSrxq2Q1amgCGy1MZPcjiFlQS1F/P9EZAGtIcFJ7sdT1l7T/OH7xUMcsX/AmLfDgaAQSyb2lXrXJLia8rBuKKg5PyiPlULejc2mY09aU1fJ4jlSNxaIFbrqYI3fRkAY9w9wKNcEHHHBt0a0zE3NaP1/RpK7oj4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=Oc8CKXt8; arc=none smtp.client-ip=209.85.208.44
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ed1-f44.google.com with SMTP id 4fb4d7f45d1cf-560c696ccffso3884087a12.1
        for <linux-kernel@vger.kernel.org>; Fri, 09 Feb 2024 08:40:45 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707496844; x=1708101644; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Chmz2d81B5ktJTwSj+Bw5JcMJXbPq5H0gPIAaWeBEOQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707496844; x=1708101644;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Chmz2d81B5ktJTwSj+Bw5JcMJXbPq5H0gPIAaWeBEOQ=;
        b=
X-Gm-Message-State: AOJu0YyGNCknpvdLHYfsEKp8YujTagsrGlsjWuz8SG3adVUPE3jbcH4I
	GpUYHA6AhRlhH2BVNyud5FWF0FG9qBwZb1ni+MVio5Crb64SA7vwftehk/wdKHC2vMjdlI3m64D
	w
X-Google-Smtp-Source: AGHT+IHcKx5AkljIsHc6TZ7XDNXm70ncenvk70jvLI8A6SdKIwOI2eYTiZtyNdPcv8y/9bZnvutymQ==
X-Received: by 2002:a17:906:470e:b0:a38:5943:9593 with SMTP id y14-20020a170906470e00b00a3859439593mr1542467ejq.32.1707496843045;
        Fri, 09 Feb 2024 08:40:43 -0800 (PST)
Received: from raven.intern.cm-ag (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id tl27-20020a170907c31b00b00a3bfe97fe27sm477724ejc.218.2024.02.09.08.40.42
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 09 Feb 2024 08:40:42 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v2 02/35] include: remove unnecessary #include directives
Date: Fri,  9 Feb 2024 17:39:54 +0100
Message-Id: <20240209164027.2582906-3-max.kellermann@ionos.com>

Return-Path: <linux-kernel+bounces-61749-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 18CE685160F
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 14:56:51 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 7968D1F250E0
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 13:56:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D9A134177B;
	Mon, 12 Feb 2024 13:46:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Vtjq4HhY"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2CB2041760
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 13:46:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707745598; cv=none; b=dxTJLEeMbKU0Mi5RQAoclXSGL3Pdr2d4KlYSW8Q1TVQ8uaYXHdUDNxlrCpcmRELsY/f3wXQ9nwttxBQ3Bql2Z1GpTSo95xhF1u/nNT+6T/Zc7Q/z01hZsvrjARVr0hHdYe3lRWuWI75tYiwTKBxXS5PXksh0odg7d5vcLmcqc6U=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707745598; c=relaxed/simple;
	bh=xikkpXmyFAcuUoOrG6d/5jzB1Pf8+Rswqj6mZIPkvUM=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Ct4T++GKzXzCWEwuS7E0iSuctLt87dNx3yMVFhapL/2hVA7fVPznzsjuRjijvrAdtkNWBkQRrj9+3cl923rEaCodQJVIz/7lCh/yJJWXB3hNBNI3uR2hnLlwkd3z39/N8y4vS3k2oGCYfkH5Ne3sVkzIZ5+W130l8wBL4CGEWo8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Vtjq4HhY; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 ...
 us-mta-44-8YY19zYLOLOQ1aXs_209vg-1; Mon, 12 Feb 2024 08:46:33 -0500
X-MC-Unique: 8YY19zYLOLOQ1aXs_209vg-1
Received: by mail-wm1-f70.google.com with SMTP id 5b1f17b1804b1-411a8c8d9b2so259495e9.0
        for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 05:46:33 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=zKmWeo9+M/EVmSRX3wQ2UDRqy7D6ms4Kk2jOrOYSGJE=;
        b=
X-Gm-Message-State: AOJu0YygV5FRGZ6TsIUciwzS0/bRPT9ioRDV/i21oLXSsCAdAWIKcpsi
	KK+MX8iM+xCQHq5AK9nNBUnTeRq2Vct9ZXYHP+60iomV5WShEB729ATCM3hHAh6Ss+pet6Q2kaT
	81795qHhpgFAWpdb6v8UDnTt31gQoQoSD5qod8AHjc26sjV7hCCrhdA4Pdxhucg==
X-Received: by 2002:a05:600c:600c:b0:40f:dd3f:ba10 with SMTP id az12-20020a05600c600c00b0040fdd3fba10mr5191822wmb.33.1707745592208;

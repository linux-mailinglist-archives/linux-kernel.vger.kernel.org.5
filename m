...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9ED4F790C99
	for <lists+linux-kernel@lfdr.de>; Sun,  3 Sep 2023 17:05:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242461AbjICPFx (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 3 Sep 2023 11:05:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48348 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242046AbjICPFu (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 3 Sep 2023 11:05:50 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 39736118
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=M8yP0GnNxuK1VxQmj7ga1k1tsGsYlTWGtNZCowR300g=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=M8yP0GnNxuK1VxQmj7ga1k1tsGsYlTWGtNZCowR300g=;
        b=tnTrmqv/FwgLavLX3BtQGKkMjmENII3IpbLMqe62mgzlkbz4KzywuAfiU0FkaBIBvL9h/V
        7bZuUvSrpY7c2pAA==
...
Subject: [PATCH printk v3 1/7] printk: Add non-BKL (nbcon) console basic infrastructure
Date:   Sun,  3 Sep 2023 17:11:33 +0206
Message-Id: <20230903150539.245076-2-john.ogness@linutronix.de>

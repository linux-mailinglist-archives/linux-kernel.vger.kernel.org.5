Return-Path: <linux-kernel+bounces-142074-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id A954A8A271D
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 08:51:56 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6010D1F23D5E
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 06:51:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 452215103C;
	Fri, 12 Apr 2024 06:49:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=sifive.com header.i=@sifive.com header.b="lXqK8B1b"
Received: from mail-pl1-f179.google.com (mail-pl1-f179.google.com [209.85.214.179])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 420DF51036
	for <linux-kernel@vger.kernel.org>; Fri, 12 Apr 2024 06:49:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.179
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712904577; cv=none; b=QXvn7DSqVe9LcEhg87xWpwE1elaFSRnI8ZTMPnuZi1SkQ/+ftAsUMFIteZMSUB65X/VDk5Mf8q6Dernz/B/QP+5P15r2Pr5YU0h8uA0HwEv78CdPUTv16MB6yaXKIbQKznbCi1sf8XPPTsh6c8OA2Azw5nQ3UlYyMUzJiaPzWNU=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=sifive.com; spf=pass smtp.mailfrom=sifive.com; dkim=pass (2048-bit key) header.d=sifive.com header.i=@sifive.com header.b=lXqK8B1b; arc=none smtp.client-ip=209.85.214.179
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=sifive.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=sifive.com
Received: by mail-pl1-f179.google.com with SMTP id d9443c01a7336-1e2b1cd446fso5009935ad.3
        for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 23:49:36 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=v6E6ZusRhlxuRh8LTz85NPr0A8l1rMIJWkDOWsfceGk=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWTSvH/zr2Kf2cIRe93JDF3tTfLad6FVEwrMg03NiLWT1BGFdF/9Pl36XO/PO4GISehHPPmR0+e7LSXB5oBI+UpH4K9H1imTczXr2so
X-Gm-Message-State: AOJu0YxJTVW5rw97RVOTBrYRzJmte7dZPmvAJtG1m8wdux2+pSvJQANb
	denVVvFoqx2EPWevJNbq4GHkg7lRdjYER5RC1JWNjqC11520aDPA768fOLBdLuo=

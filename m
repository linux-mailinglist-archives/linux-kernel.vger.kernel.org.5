Return-Path: <linux-kernel+bounces-71493-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 0EFE485A62C
	for <lists+linux-kernel@lfdr.de>; Mon, 19 Feb 2024 15:39:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 69470B22A6E
	for <lists+linux-kernel@lfdr.de>; Mon, 19 Feb 2024 14:39:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 79CCD381AB;
	Mon, 19 Feb 2024 14:39:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Q1MHCbff"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 06E2B2EB10
	for <linux-kernel@vger.kernel.org>; Mon, 19 Feb 2024 14:39:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708353559; cv=none; b=VX0DhGetCECdfcqfzoNzCbQdjfv7KsnIsa7zCjySMJphqDLgDjSF7zmM1Jkcb6/ydduTA2YdhgHZ85qHxBvscG7deQ/xtypNUkxs+cszfNk2eM1psGvxKB6yZ2FkHFHG8S0WrC/ZGKR0AkmdqLYDLl6OYPj/WzDhj8Ccq4dSm0E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708353559; c=relaxed/simple;
	bh=FQW538CkhbCyOjNCq4Mt7YkUrwTilVq9pXAfhbPQhsU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=KoJaT/R5Wx57P4LuVeGVx72sJifttFQmbGkiqF0IyUnmHNXQHlHwJEOSvfot7JuJCGN95AepmTLvT3Fv4poSNJ7N1wrGz0FKY1hWRm9BQPBLGs3lebs0WHWDLBnZ2lMIGOUkOFGByM4cSDjyRHSZhgAOZaDnDCnGzgbVPQmTiCk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Q1MHCbff; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1708353556;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=61Y1ryM8fe/JjxMt1H4crmRFgXy4y3uGTZZvyqUo4+c=;
	b=Q1MHCbffLzlGFRnbuFillkeu/3UTiwhU0Be8ffLcRFizn0vyAXGp0VeyhubsbVyzkWBMB4
	zUP+ZNVKt1uMkPu2d12dIJDGYzC04VLJYAS0Z+Aad3Nx03BCv14NUYSuB9m4Wk89sCiMvg
	0EBs65fv106TTBEoE7ZCeD6VR5lU0/A=

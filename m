Return-Path: <linux-kernel+bounces-23208-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 046DB82A8FA
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Jan 2024 09:22:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8BD9A288953
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Jan 2024 08:22:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7C9E311CB8;
	Thu, 11 Jan 2024 08:20:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="na0E2emq"
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0A77AEAF0;
	Thu, 11 Jan 2024 08:20:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1704961217; x=1736497217;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=h0MCC5MvkTzOn27yapAD+KjXn1XVUh94zR0aFAaZM9I=;
  b=na0E2emqqztdpuJsWRdQUMx6FwLF1Q/+rpxDV63REd/iuIh5MRyq2IqZ
   IIs1BcWPaLVam3RZydl4yJe9ornexuCl5+ZQPBTIxdNUijRZZu1fgBFoy
   sJmYc203f1WPxV7aa+0g3owlpozSzKYyKQBvjB1F82nWiCvx9d3y1KSWg
   2mocJSOhv3IVrd7FkWmCcfNx7QfbMVHz5TtEQtBVV0h6NxGvyK/+xYhol
   TcFF02W0x0Xp3qcan2pFhxbEQp+DLdBl9jNUjlVPkb8AHNYlS7PElwYgO
   YPoBpsgt5SELhYYQBrtkc7U6aaxGRS9XXDoTG6L8U3tpxCeprXKrezanA
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10949"; a="465166568"
X-IronPort-AV: E=Sophos;i="6.04,185,1695711600"; 
   d="scan'208";a="465166568"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Jan 2024 00:20:15 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10949"; a="925923173"
X-IronPort-AV: E=Sophos;i="6.04,185,1695711600"; 
   d="scan'208";a="925923173"
Received: from ahunter6-mobl1.ger.corp.intel.com (HELO ahunter-VirtualBox.home\044ger.corp.intel.com) ([10.252.52.224])
  by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Jan 2024 00:20:11 -0800
...
Date: Thu, 11 Jan 2024 10:19:12 +0200
Message-Id: <20240111081914.3123-10-adrian.hunter@intel.com>

Return-Path: <linux-kernel+bounces-88717-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E2E4B86E5CA
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 17:39:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 25118B25272
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 16:39:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C4B8EF9D1;
	Fri,  1 Mar 2024 16:38:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="UTVIRQNP"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B19718C01
	for <linux-kernel@vger.kernel.org>; Fri,  1 Mar 2024 16:38:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709311102; cv=none; b=bm+mkECLv5RfsHmOYRpNZqseCuC6WIEGYIByLvFZNJxJRXfkgGn6+vW+SkV15x/gpzVpYWeyjgW8YMqEkMLXetjul79FR69EV0jz7lKG+c50POwSoxVfJxI5EFqypB47A0GngJLjSiAXFyChrqethJUtMVI4Dr2NRH4UxqlUFe0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709311102; c=relaxed/simple;
	bh=buGQQIqwfDOjT2V25LdvmamRLILtg2fDY6qrTYz9e6I=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=fNxxMdKEI3ft6YV1d27p8c9Oka7esnfYqTMLDskDKjNE8r+GJBFcQB4fUhvPkEtO97CJkBeoBFy5Uj2Jq8Pppr4Uy5VIKdUMTwf/20Yl+Aw8K6prk6/lKTaQ5WCe2tMWsJA9QFjKBWCWnkbHaM4Vjn8WcYzSWQ0Io/6vmgDaazU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=UTVIRQNP; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709311098;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=SInqaLs7+HuZGhZ5JkGiSMY+PTSraJJ+xEdb815D0Ac=;
	b=UTVIRQNPuEG9M2rau0CB8E34hJ9zqCLUl8Jkm00JEv93bl0ZLMOshF5ccUi38TzzDvVdIy
	LJK4poE4iagksDuYXDkxBqAE8U/T1nLuu8aw4lupNKgVfRVAQMmtEWdrK/9Fnu3KnLU1va

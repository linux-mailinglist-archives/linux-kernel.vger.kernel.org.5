Return-Path: <linux-kernel+bounces-67092-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 13BBA856628
	for <lists+linux-kernel@lfdr.de>; Thu, 15 Feb 2024 15:42:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B7A3C2821B1
	for <lists+linux-kernel@lfdr.de>; Thu, 15 Feb 2024 14:42:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2AB40132C1A;
	Thu, 15 Feb 2024 14:42:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ZjHd0ltX"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A552B132494
	for <linux-kernel@vger.kernel.org>; Thu, 15 Feb 2024 14:42:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708008137; cv=none; b=LNe6rZunMNBaR3rQ0aOKtfaYWa4QJBcD3abTYCAMp/Sp0xumkiMJKPOdy+wrmQV8CJRxXAy97NTbKLeSeIuBCb/SAU6EMDGZSmb0pUvjzFb4/m8ziJd103bk28vi5UYzAQgR9lhsD9A3O81+EjPuBqeH9KfZBVTZf6EUI/5fGTI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708008137; c=relaxed/simple;
	bh=KVQXyddDCqFOkaQkPG/3aBE9fjuhRZsKr40SbrA8X64=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Wy1BPeeOIOLGGQfCv/pjBy4i269sEPe3EhKV+G5mTN6l/oPJJ3aQ3xKCPf2EsXrG/KGhFYwUKnzJKLO7fwKU/1AvXXsLOt93jPu8QE67paeyJnC6k5lwahv3aBwzu1VVJYQOvaI7paWgV0+FPIiF54FJttLWiP88nW/S2/K3rWk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ZjHd0ltX; arc=none smtp.client-ip=170.10.129.124
...
Received: from mail-qk1-f199.google.com (mail-qk1-f199.google.com
 ...
 us-mta-643-h-R2R_ftMFC2WWaPlyPJaw-1; Thu, 15 Feb 2024 09:42:10 -0500
X-MC-Unique: h-R2R_ftMFC2WWaPlyPJaw-1
Received: by mail-qk1-f199.google.com with SMTP id af79cd13be357-7817253831cso118536285a.0
        for <linux-kernel@vger.kernel.org>; Thu, 15 Feb 2024 06:42:10 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DU/I58QZ3iymbaVm/jdmROBBRbIzgpeEc0Gm3Gdul0M=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWC7MnFhxtRLq7EOswwDEyv/0FlZXk+hMjShd0qPazVxD85d0VUt/v8l0rDX4DMy/HT3nZP8u3mDE8+bpy6XGKtaCuoyvDvC+ttSjde
X-Gm-Message-State: AOJu0Yy3KV7QkCXUU9ZpONOlxyPBYKa5ySw2PqfHiLELphz1nLRb3PDK
	RyX8u2hysx7MdnxXqDVjbuUcXdO0mOmBCBN31WXL1rYy+CFOmlVJzx3EEPlWj8KFBWDz58QyUfI
	SrgNPC8mBdqxVUaceMpqbq139rGpIkivCO3KeZRY/B8xJzV3I75f1dUQIIUbEiA==
X-Received: by 2002:a05:620a:13e4:b0:785:c28b:d86c with SMTP id h4-20020a05620a13e400b00785c28bd86cmr2100294qkl.66.1708008129716;

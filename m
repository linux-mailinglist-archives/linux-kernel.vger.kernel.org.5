...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D949A77C4B6
	for <lists+linux-kernel@lfdr.de>; Tue, 15 Aug 2023 02:49:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233791AbjHOAtO (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Aug 2023 20:49:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58222 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233470AbjHOAsZ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Aug 2023 20:48:25 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6C633133
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 17:48:22 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 3F6E36307C
        for <linux-kernel@vger.kernel.org>; Tue, 15 Aug 2023 00:48:22 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 6A2A7C433C9;
        Tue, 15 Aug 2023 00:48:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1692060501;
        bh=Jo2S/GSy0n9P6B+6mtn0Rjm7jip3VoyzvKoQ5atT/BM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH 08/20] ARC: boot log: eliminate struct cpuinfo_arc #4: boot log per ISA
Date:   Mon, 14 Aug 2023 17:48:01 -0700
Message-Id: <20230815004813.555115-9-vgupta@kernel.org>
...
index 17e32c707367..19deb8ca9c28 100644
--- a/arch/arc/mm/tlb.c
+++ b/arch/arc/mm/tlb.c
...
@@ -606,7 +606,7 @@ char *arc_mmu_mumbojumbo(int c, char *buf, int len)
 		       u_dtlb, u_itlb,

Return-Path: <linux-kernel+bounces-106745-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F7CF87F302
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Mar 2024 23:12:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id CC3EFB2209D
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Mar 2024 22:12:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1953C5C8EA;
	Mon, 18 Mar 2024 22:10:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="W7TZgBg9"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D241E5A7A7
	for <linux-kernel@vger.kernel.org>; Mon, 18 Mar 2024 22:10:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710799812; cv=none; b=M6YL5ClHoiJ4lANAQyHq3OFx/Sj9XhY8P5RR937r37M0Rt3F/EKIg4CVZJbPJO5w4IQkmgVrBSYK9TbpUQg3bSn91Aqs3QUHsP4i8wD2axqJ8CHcdpFOnpG2gOVPqdAB/OC0doogXomiSEjtxnvusb5eHndyo/5BtMdbfEZcEbk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710799812; c=relaxed/simple;
	bh=WDJgBGpsjfapdQHO9gSdZJmkJ2P8LFMBkWTD21ibKpc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=g8GPfle2DiBVvXSQi8oXXkRP/EkMsPqYFghpjZzvF/tWjaIVw5/wGZIs8I1OYRqRl4y+INbOdZF9ggTx+JKqJexEMhAXdWbOmWY4Aup7Hw7rEHMmS6mVsRYbXT6ebUP/bGabOx/1MgRo2D//L3kYdalOdD9vsbGxmThmv1Sgc2Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=W7TZgBg9; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=W7TZgBg9VfEPBrELDCNUn6w12yFF8DfVK97AtDvZVxkQEb/Rz6qPPdP3YuAVbC7gzSRVrT
	e/HVTdRFKqOulcpHwo4ijjttOjCxHi5EqBKSJuqsgeyLFW3kIIMPvajIPvf1YCsM2VV4cG
	oc6P1EL57gOusRucJyQoSHV4j/x3Y8Q=

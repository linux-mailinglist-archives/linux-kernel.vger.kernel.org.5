Return-Path: <linux-kernel+bounces-18825-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8A19B8263A1
	for <lists+linux-kernel@lfdr.de>; Sun,  7 Jan 2024 10:51:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 3D644282810
	for <lists+linux-kernel@lfdr.de>; Sun,  7 Jan 2024 09:51:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C518012B8C;
	Sun,  7 Jan 2024 09:51:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="fcE5q9jB"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-ed1-f47.google.com (mail-ed1-f47.google.com [209.85.208.47])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9F7C912B78
	for <linux-kernel@vger.kernel.org>; Sun,  7 Jan 2024 09:51:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-ed1-f47.google.com with SMTP id 4fb4d7f45d1cf-557a3ce9942so112795a12.1
        for <linux-kernel@vger.kernel.org>; Sun, 07 Jan 2024 01:51:33 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1704621092; x=1705225892; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=c2YW+dweAMaUJTQeM2y6Xf6kbCinTei9xtj0XMKNgAA=;
        b=fcE5q9jBSk+RyDAboGPwtte7aFryV/SamfUCu7AiEa/AwimVTGteXUP5/pqGK22Qnt
         otXMuIy77ClpEFUHf/xBi1Hu45JNSO5atlrlgyateNUIxlq0CDpQmsTxxXELtEmHuML3
         jPtynMh1NMwv4KXfsu2UUE3xy/Ub8A9RYZA1M=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=c2YW+dweAMaUJTQeM2y6Xf6kbCinTei9xtj0XMKNgAA=;
        b=
X-Gm-Message-State: AOJu0YzwZyphmp0BFmKcc8a+Z+4cIozFTETS8JqnzTUK2fiodPovgWYN
	h1Bo7apKnwpMFoyknEMmC1fTODaqjpZ+
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="000000000000adc494060e58064b"

--000000000000adc494060e58064b

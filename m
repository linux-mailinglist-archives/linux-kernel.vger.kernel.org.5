Return-Path: <linux-kernel+bounces-143133-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EF9B8A34D8
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 19:36:17 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 422AE1C225A4
	for <lists+linux-kernel@lfdr.de>; Fri, 12 Apr 2024 17:36:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E806614F12B;
	Fri, 12 Apr 2024 17:35:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="bZq97OOR"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4C1F814B08C
	for <linux-kernel@vger.kernel.org>; Fri, 12 Apr 2024 17:35:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712943339; cv=none; b=d5jXQNEyeH+xdfAW5NexxCWvb1ICmAGVvShHa26IjOZj6KPYWAKXeHyUgnZINJP11YBWodRGKGHeR0bxdvOh73wVGVEudGr4vkvY96YYjwE16FJxSIpx0Gk4YThaqxoDPsR6GhsJk24KM+y706xrdovUPeMHxYJ2zoa2jc+8UBQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712943339; c=relaxed/simple;
	bh=63JyyLKYruvxBcAv+i8jyMQWbjsNvFqo/lkAD2GJcEk=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=GOW5b+E+VnpJMdv1zYIxpey+tVNpszHCrWP0ph5whgSyEJn95h7KAZF/y7hrAltV83miDNZXB9YbmthQO+AZRGddas7i5WmYoj//bcaKlgjrTA+bWR6oDBLslq8+/jDXrRux7HUCS/HdJ93hSVPonJf+ZEeGYC+WfNG9ZsDRpAw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=bZq97OOR; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=bZq97OORfng4zeLASogwCOq/FEdlYqaigbk2dAcGQqEZMp8Cm4ClE9rWf9N8oAEowdXopo
	vP8ZPY2J/GOsuoi5UAccWsxBj9MZRG32nkhM8ZiDylfdBHnT/oOMB+SKX0u11ybd1cyJo7
	ETXioo9CcHzJiSvCXb18xzWy1NV7IQQ=

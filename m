Return-Path: <linux-kernel+bounces-132500-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id E44BF8995EB
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 08:54:05 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 13B0F1C22216
	for <lists+linux-kernel@lfdr.de>; Fri,  5 Apr 2024 06:54:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DEC942577D;
	Fri,  5 Apr 2024 06:53:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="NjFqhPXC"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 475EF224CE
	for <linux-kernel@vger.kernel.org>; Fri,  5 Apr 2024 06:53:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712300037; cv=none; b=QLHxZsCxFm+FsiOwhFw5nuo9wH+554pJS+r2chFH3lMwr3WJD04DdfPxxfnJn1kp/ldNLtwkNmAwwNqBNMY9Tc1yu4+3SYFkaKuVPRfot+ugVOCFQB9JgSgDnRCeKTvP1oJD1+0bo3TfgqmOylD8R45fJ71lbDRkll2v85OvJI0=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=NjFqhPXC; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-wr1-f69.google.com (mail-wr1-f69.google.com
 ...
 us-mta-590-rSQJX11-NvmZnowWEx-cfA-1; Fri, 05 Apr 2024 02:53:52 -0400
X-MC-Unique: rSQJX11-NvmZnowWEx-cfA-1
Received: by mail-wr1-f69.google.com with SMTP id ffacd0b85a97d-343bb240f70so698815f8f.1
        for <linux-kernel@vger.kernel.org>; Thu, 04 Apr 2024 23:53:52 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=NFXw0uXPa1e5iAn6t3w1lZoilH1G/Z4MsITH9Yy0Mbs=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUCqMEUMwS3+FUxqMtfFXWWsZx6S0SgceAvPZVPcAABxFCbVDDG6DXJM2XKaxSNZoLpxV5PY8O2Wp54HIHdmpjDBx31dJCKVsIT9CrW
X-Gm-Message-State: AOJu0YzrjTsH71b3ETYE566REd59D8R7Q1d1i2RqmkPxYTU10WTymqwo
	63qvNjdgex8YpxYhDQhL5KT5Y8dSC9UDx3l+nh3tFw0e/D5BrhkHGUib6j5qopvFb4yyr6ediUz
	WHt5ftyY+PAXdkfyxT7r7lUASYhbblNSsBOruEPcFwOJwQSzozVmaz/S5IqSOlw==
X-Received: by 2002:a5d:4705:0:b0:343:7f4b:6da5 with SMTP id y5-20020a5d4705000000b003437f4b6da5mr1302724wrq.17.1712300031645;

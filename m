Return-Path: <linux-kernel+bounces-49519-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id A519A846B61
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 09:57:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 479F1B2AC20
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 08:57:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 06BA7612F9;
	Fri,  2 Feb 2024 08:56:39 +0000 (UTC)
Received: from mailgw.kylinos.cn (mailgw.kylinos.cn [124.126.103.232])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 718F45FEFA
	for <linux-kernel@vger.kernel.org>; Fri,  2 Feb 2024 08:56:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=124.126.103.232
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706864198; cv=none; b=OZpqhwwAxo6hxk9gCJogkbPEA1BBnnP+25EsWdMPq6l9E9BiSaXHZpXiFpcbfgAbbMkq0yGudaRwHwq8hcvqLideIAXMdM33Yk9nJExX/MjpVfrgv2HkX1HPoiPI0qek2eQhyUC7Idv9pTYdhupzYwKh7luDqhS1RDDN3xkTC78=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706864198; c=relaxed/simple;
	bh=xe+JE2pdIoDLOLwdHNVYHPenxo3SxPEsnW0bL9LPUys=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=tZXJ1hQiTY+KAPaBZuQl18Gd3DnolK2cJiHE2ZTXNPPkt4m5wA4YNHFu8xi7RE7v9ICkoQaq1bIXwIHvH89ZQvUd15s6hvxCkwV6i3xtXeAzozeF251Q5Es0OJJNQbq10yDkpZChWi4RgZwtK2CWo4cPJDeuQxmVtD35TEOjpHY=
...
X-CID-O-INFO: VERSION:1.1.35,REQID:af666be1-41cc-499d-a5fe-c88955d0c6b4,IP:15,
	...
	ON:release,TS:1
X-CID-INFO: VERSION:1.1.35,REQID:af666be1-41cc-499d-a5fe-c88955d0c6b4,IP:15,UR
	L:0,TC:0,Content:-5,EDM:0,RT:0,SF:-9,FILE:0,BULK:0,RULE:Release_Ham,ACTION
	:release,TS:1
X-CID-META: VersionHash:5d391d7,CLOUDID:9a210c80-4f93-4875-95e7-8c66ea833d57,B

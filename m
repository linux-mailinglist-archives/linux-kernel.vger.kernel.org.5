Return-Path: <linux-kernel+bounces-156154-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 1527A8AFE9A
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Apr 2024 04:44:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 1C708B238E3
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Apr 2024 02:43:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7ECBD83CCA;
	Wed, 24 Apr 2024 02:43:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="Bvzmc2N1"
Received: from mail-pg1-f174.google.com (mail-pg1-f174.google.com [209.85.215.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CE25680BF5
	for <linux-kernel@vger.kernel.org>; Wed, 24 Apr 2024 02:43:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.215.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713926627; cv=none; b=gzjHDgd26ghGSSY53mn0mP59PIKf+meiAy7owbPTPvrFmzzdgzZauqas1wwewzvFHBcl00w89KGtt0U8y4zF+6+VSR54W9dsl8vW2FKzVK8IchAZJYSacOvzT966+uAUDpkKpuHrBSU42lDw91EatYiEspALaPdfAY90E8S6DbA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713926627; c=relaxed/simple;
	bh=YBH+ybySjpxZoSXfJc6QAoUaOMcM5HQ0FOTUR3WkT28=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=Fjfqxt4AMlRnXjYtbrPK8gT+n2n5iNxRTg2Mvc0F3f32HSNj7HowE6VSgtf0nOSYlfopHHOYNSBQ/8l03apSzoLHeds21WCaOaxQ1MHK3oXH91ZCXwpEy0pEE6riGfXledH+Us4O6/+ryTCO7h/P961Z5J+Dp53K7VFNwmbvs1Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=Bvzmc2N1; arc=none smtp.client-ip=209.85.215.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pg1-f174.google.com with SMTP id 41be03b00d2f7-5dcc4076c13so343933a12.0
        for <linux-kernel@vger.kernel.org>; Tue, 23 Apr 2024 19:43:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1713926625; x=1714531425; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=gZh6ePaIOuCwDbpk3olt/lwItI0lVW6WJuNX6TqYyCY=;
        b=
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=gZh6ePaIOuCwDbpk3olt/lwItI0lVW6WJuNX6TqYyCY=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVVWkEBcWlEXOWUgVYfS352CMTWAQTDFIC78AcqnLZFqwL+YcNbktX5R84/niZkpGNnOPnhTWA7MgN0NQBD/F/SzyWI3IrrmAdtSQ6p
X-Gm-Message-State: AOJu0YzDumskF6sNb8qXs2/KPwwwxJ8TlhkWDMU3947CdmdRFuIqBjSa
	2wXGYpEVTFhx/xm8KitBqWFZO516M3FNuYTNXYBSMT4BZtm+STx/XEJH1BqA82iIy0uRvwRJnnC
	uQSyqmrmBmOpB5eyhH655xxHy0mk=
...
References: <20240422052608.5297-1-maqianga@uniontech.com> <68f02c5c-5591-4d6f-9926-b0fc6f9f6287@amd.com>
 ...
 <f2e1b969-ce9c-450c-9882-99813b7334a0@amd.com> <94BEDC76B25ADCE8+20240424103025.74a98199@john-PC>

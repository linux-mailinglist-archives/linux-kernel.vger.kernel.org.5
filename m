Return-Path: <linux-kernel+bounces-57686-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F90484DC46
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 10:02:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B2A301F26823
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 09:02:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2B2A26BB51;
	Thu,  8 Feb 2024 09:01:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="Xc5IAV5L"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5CF3769E1E
	for <linux-kernel@vger.kernel.org>; Thu,  8 Feb 2024 09:01:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707382902; cv=none; b=BPiLD9/cOCbRxbyv9fPj0V7sr87qexl8Dw3DGa/QStdhWXuisX+fx+unRR/MPe8Euo54GRKojlU0nteSC2GsKGiHuNhgK/rKtEAXEJpJkvvyNaiO105J14n8SujuD5loRE7CYJ3C3CG5JiDoY+slbS0e7s48aHwKO+jTlnh3K2g=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707382902; c=relaxed/simple;
	bh=OBUoxt4MkeYkh52pUcownvPeB3VR21ftdX0z7jc5R6g=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=kbkxfeZv1aNxWsCSUMb81Rot1nOMTMm044N+lQDfn3tDcEjXt5dvo8qzsBXhhb/PbOvoXmF8h8Ir8beUrCfy0MnbHQRJ3hpoA1Vt3+13nlce70dYVw+G0LHCB3ZXXpfipYo2bDf7l/+SG0TddV2EJp6QyAcaF6DX+1t+ry/zWCM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=Xc5IAV5L; arc=none smtp.client-ip=10.30.226.201

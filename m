Return-Path: <linux-kernel+bounces-100572-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CCA4879A33
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 18:08:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A86D31F22975
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 17:08:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 527A3139573;
	Tue, 12 Mar 2024 17:05:30 +0000 (UTC)
...
Received: from mail-yb1-f181.google.com (mail-yb1-f181.google.com [209.85.219.181])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 18DCC137C28
	for <linux-kernel@vger.kernel.org>; Tue, 12 Mar 2024 17:05:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710263128; cv=none; b=jrmTceUZ5rJiFEQQbkgRwCzkRqDodhXWMdR/ogY7wJSbbW6Up/kNQD4bIiJ6mRjIr4Y5u4+upPpUJgrTPVQ7jpkgGg/6aha8d6UdCKnz1WobGIacBQJqOJ/9dVQv5ngrqg5F6aB/53SzUX+tgdVRBtXcawGfCOuK53He+kSfXOU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710263128; c=relaxed/simple;
	bh=nETdnNiXbfJYVcvR+8BdhDfh+cHHu3duiWQBr9gQ/cM=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=Raz2m8SooBfoOEJj0ata8j87a16+685JxeI/N70w1IwEOuzV0uJUYZCJL9z/VZGSC7x6RYW5AvkWao9cRyx7AF+Uxvwr96WNoJKjpf4iSLuvmVT3fW5PvzIUM6kTOa6xvCeO2jcS73aShfLig8kVwdnRFdCz4vE45KFlZ9pgyjk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=raspberrypi.com; spf=pass smtp.mailfrom=raspberrypi.com; dkim=pass (2048-bit key) header.d=raspberrypi.com header.i=@raspberrypi.com header.b=UFJllf71; arc=none smtp.client-ip=209.85.219.181
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=raspberrypi.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=raspberrypi.com
Received: by mail-yb1-f181.google.com with SMTP id 3f1490d57ef6-dc74435c428so5602200276.2
        for <linux-kernel@vger.kernel.org>; Tue, 12 Mar 2024 10:05:24 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=PImBKvEkplXQtr3VSaidgr6kxa6jFNk7CGiKtDSsyy8=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXf1yeqjAmI0ADgteDLlMiMrijoUhpZGF6BlsX5WDgoG2bwwIKe8pn88MgZgLez6i9Dbd1LO13dAH/tvaK1iQRJCmWtBqAA2yOyzwkM
X-Gm-Message-State: AOJu0YyN5jQ36rIjfj0LEOfSExuLQlDHWvPDPjyYVGDFWDqThINv2MwQ
	ijeCEfEFEf4TRcyZHHz+u2RiLRx5ONuVVfdPjCezpdcRa/uPjf5w0qti2Ecm2VfUwgG06F2e3zd
	LwXLCPVXe+NQLaq/usQpSWKRWtu3plVyexXybfA==

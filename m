Return-Path: <linux-kernel+bounces-6933-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id EA41A819F79
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 14:06:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 17BDF1C22C37
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 13:06:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8586825560;
	Wed, 20 Dec 2023 13:06:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="EuiYoCe0"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D6C942555F
	for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 13:06:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703077567;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=1ey4boAoTxw+9TbPJh317FGAnwOPCMWe0KJbetrmsDE=;
	b=EuiYoCe0DMqiTQU4c9GOCcTaSdl+P/FgwFaEpFJghownGSLBE+QHd7L7m7ccmgNg9VWqIe
	M8xP+j8YoI4FPUouLY1ehw+zfrgFzLMoUv9apH2PjgEGk+p/Y6qccNtcVO8P2mufWsA0OX
	8gQwkyrxpv2TfXYUXq0ZTpyL8RdqAes=
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 [209.85.128.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-561-Yp-9S0vFNCm0x5g6MP6HkA-1; Wed, 20 Dec 2023 08:06:06 -0500
X-MC-Unique: Yp-9S0vFNCm0x5g6MP6HkA-1
Received: by mail-wm1-f72.google.com with SMTP id 5b1f17b1804b1-40c4297e070so46241835e9.3
        for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 05:06:05 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703077565; x=1703682365;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=1ey4boAoTxw+9TbPJh317FGAnwOPCMWe0KJbetrmsDE=;
        b=
X-Gm-Message-State: AOJu0YwYA4N/Y0FfBu7A4mEEH7nSDEK37Switew+vEQk/yrI1zczVeQ2
	QWBGNZ4dngpnZBLWoKfYhrKssaG1N5IpRu3UGhmjlhhX+myDLdG2khf8cF5cuePU1jRaNQU7KfT
	cOq29G1fjZ3Vi8AlbJjYWGIFI
X-Received: by 2002:a05:600c:1393:b0:40c:4d80:f51a with SMTP id u19-20020a05600c139300b0040c4d80f51amr8169822wmf.96.1703077564829;
        Wed, 20 Dec 2023 05:06:04 -0800 (PST)
X-Google-Smtp-Source: AGHT+IG+Xq01MgUArnElue02MLxo2zo2GMFSQBaIoefAKTjYa6PvfzLhpynxRlQFyerzQm0X28AymQ==
X-Received: by 2002:a05:600c:1393:b0:40c:4d80:f51a with SMTP id u19-20020a05600c139300b0040c4d80f51amr8169809wmf.96.1703077564217;
        Wed, 20 Dec 2023 05:06:04 -0800 (PST)
Received: from ?IPV6:2003:cb:c73b:eb00:8e25:6953:927:1802? (p200300cbc73beb008e25695309271802.dip0.t-ipconnect.de. [2003:cb:c73b:eb00:8e25:6953:927:1802])
        by smtp.gmail.com with ESMTPSA id i7-20020a05600c354700b0040d2805d158sm6836523wmq.48.2023.12.20.05.06.02
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 20 Dec 2023 05:06:03 -0800 (PST)
Message-ID: <9f99a3ca-051e-4b1b-81e9-8456d8e422ad@redhat.com>
Date: Wed, 20 Dec 2023 14:06:02 +0100
Precedence: bulk

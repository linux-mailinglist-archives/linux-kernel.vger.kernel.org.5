Return-Path: <linux-kernel+bounces-77776-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8781E860A1A
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 06:00:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 22507287C49
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 05:00:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B35C711709;
	Fri, 23 Feb 2024 05:00:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="LsYLGvsm"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 303FBBA30;
	Fri, 23 Feb 2024 05:00:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=198.175.65.12
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708664413; cv=fail; b=N+ssoJhNbbvz+FXhs5Bnfstj8Za+5r4P52oKEsPB7DO8nJnAp4RQlWDGgAUAhc+cWDJ35GIod4JoHsbg5WRdRS55tj2bGRsAGljFVJ9XWileJ1Ef2rPM4GrJ0O7l1UYOkKjnRjC0JUkJZd49hO2l2FvSdYhDT1pG89/i21X7zFY=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708664413; c=relaxed/simple;
	bh=Gh8fMymxW8zAqfjnXoXhzOr2reTUfUHKzgPAUg8RKQg=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=dFF3SBhQVUDVOHiAAEufpSSOTcnWNzGiLvH5qZWVT9Fo1Ooxgb1fNk4xnVyvIQD22vNL3h0aiGRgwsyeBjo3OjFLGCmETw4emjLCMLNLwVyJVAf16YsoOz9js0j9MQnu+G4vtzJ0ilP29dkYSeAIOsVk7BhR4f2iDCjJPU9Vc7Y=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=LsYLGvsm; arc=fail smtp.client-ip=198.175.65.12
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=LsYLGvsm639k4XAlXpK3MOa8xpbhxspke2Euz6ZqQReRnHx6BvK1/sHH
   ...
   dFqpjUu870sLDCUEIbrIG9oV2vGJvIl2L475xeBbcSQi5Wx/vZC8+3eEE
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10992"; a="14389841"
X-IronPort-AV: E=Sophos;i="6.06,179,1705392000"; 
   d="scan'208";a="14389841"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
  by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Feb 2024 21:00:11 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,179,1705392000"; 
   d="scan'208";a="36808374"
Received: from orsmsx601.amr.corp.intel.com ([10.22.229.14])
  by fmviesa001.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 22 Feb 2024 21:00:09 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 23 Feb 2024 05:00:06.2739
 (UTC)

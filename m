Return-Path: <linux-kernel+bounces-46934-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A7253844682
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 18:51:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id BE7051C22EA5
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 17:51:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D60AF12F585;
	Wed, 31 Jan 2024 17:50:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b="mU7/4qao"
Received: from mail-pf1-f169.google.com (mail-pf1-f169.google.com [209.85.210.169])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6B8C612FF6A
	for <linux-kernel@vger.kernel.org>; Wed, 31 Jan 2024 17:50:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.169
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706723444; cv=none; b=t+jatlA2BGgFg2viueFmVyjF8o6o30BZJcCsRwFVuTRr7ezbd3VKPUi+wIgGZ7KXZKcDZRlfPdgcKHMbKQX2FP6eXaNtf38cln58AWZVUlcrNNmQJJFz25RxpMsgkOyEwsnUcGmzEf1xAoGLnBr03dNRpawC3pgAmLMVhfVbrio=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706723444; c=relaxed/simple;
	bh=sbT9HaInfiDd6hl9oyHFbQ9CuayDtfxDnZq4hIKCoAQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=qUC63hcxVw9EWJE3uVoPRxmZgwFnPwKcmr53cig9H0DM8h71IfJecuzt8xbQyBZuKr+x8vXkAZyv1X7SXQ3gpaDWsn9xiEm6woVUSD+4iZgECdNHVrkom+Wlva8viVdMMIZ2bPsEih2+wTJQjI+a2jeIFH+xX9ajLDHX/QAi4Cc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=mU7/4qao; arc=none smtp.client-ip=209.85.210.169
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-pf1-f169.google.com with SMTP id d2e1a72fcca58-6ddcfbc5a5fso4274113b3a.2
        for <linux-kernel@vger.kernel.org>; Wed, 31 Jan 2024 09:50:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google; t=1706723440; x=1707328240; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=tJyJ4y5jn9bwnp/ON3hOahDEtGOn1C8XFdVbt95j5Y0=;
        b=mU7/4qaodOd237r6QxY3O/o47DV34P+85OUxpRDaqQdGLkuEE591DNmIo5p/XQjYkM
         eUoWK8eriadF4xT2+5pTYpLgwcbKi10xHKeny62zR1vvj5Unn5nchGVVPKYCKnyqylW2
         ZDjk1HelNGL3jkzh6QPFIGgM0BtcRs3eqDxDQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706723440; x=1707328240;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=tJyJ4y5jn9bwnp/ON3hOahDEtGOn1C8XFdVbt95j5Y0=;
        b=
X-Gm-Message-State: AOJu0YyaSfxtx12uHfZgM85pEXpWtFGzmuyABXN6gJ8TdvcnpntURdrW
	j+m1rB0K70mcPd1qiGSz2FzrC7qrVq5BREF97smPg49E7PJyGNjB4JYitfgJig==

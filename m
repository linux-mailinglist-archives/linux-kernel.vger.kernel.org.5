Return-Path: <linux-kernel+bounces-139894-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 150778A08EA
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 08:56:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 482D6B258A0
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 06:56:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3340013E8A7;
	Thu, 11 Apr 2024 06:55:26 +0000 (UTC)
Received: from szxga02-in.huawei.com (szxga02-in.huawei.com [45.249.212.188])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8224D13E3F4
	for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 06:55:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.188
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712818525; cv=none; b=g/zNAemtlzC/0rbY9EnXHvRoQB6WkY2ZM6+EJDmFlcU0uglwbCq+Q+rsH/k5zgzuvptwcqKKMET0y10JHcBzeomRg0s6v4LD3EaAZeLHigHS+ecOR9bEmG2eRW376WL/GN1i+Ek74NzYdS+izyIoU42v8C9a0xnfUq+fqwvxFT0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712818525; c=relaxed/simple;
	bh=DUknK6OMkLGCAt736I9+KxRyeX2BT6UFivLu3n5tfos=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=sWtg3jo2KgNRn9LWmFB3L8DDuQlm0vxLb9znQwIr6bVyEhyDdJ4XnfC+gQtU8J3hhmQiJ572IKQvnPak7asphQ5ICCoGxoJMUyP9s42KqMKVQFjze5XnkramJpD9chvA5l/tdqn4NZTwBc97SNo2KveglfvLxa4yRU9c7kNnxgY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.188
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.163.48])
	by szxga02-in.huawei.com (SkyGuard) with ESMTP id 4VFVmb0XzlzYcmX;
	Thu, 11 Apr 2024 14:54:23 +0800 (CST)
Received: from kwepemd200013.china.huawei.com (unknown [7.221.188.133])
	by mail.maildlp.com (Postfix) with ESMTPS id 9274118007C;
	Thu, 11 Apr 2024 14:55:21 +0800 (CST)
...
Subject: [PATCH v2 6/9] arm64: daifflags: Add logical exception masks covering DAIF + PMR + ALLINT
Date: Thu, 11 Apr 2024 06:48:55 +0000
Message-ID: <20240411064858.3232574-7-liaochang1@huawei.com>

Return-Path: <linux-kernel+bounces-38599-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5443683C2E7
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 13:56:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id DCB0629067C
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 12:56:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3455B4F618;
	Thu, 25 Jan 2024 12:56:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=mit.edu header.i=@mit.edu header.b="AXNMOdEC"
Received: from outgoing.mit.edu (outgoing-auth-1.mit.edu [18.9.28.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D0FD54F5EF
	for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 12:56:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=18.9.28.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706187382; cv=none; b=CBPatUoif3/d1GYPqn0HWyvnRdCznHrWJeMo77fLwmQGmb4M7iIo7nHAKe6Fp7kpom1jmZZGpJWRBYgCPlWt+OshTEUJJF/F1xndwk0CX6ZdF/svy+MoJdVOAXLKJ9w7Cea0PrkpyEZ9exUOJwvfOVOWasl168ZP02sqNqZnUpw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706187382; c=relaxed/simple;
	bh=Hz949nb4lJNuFe+Z12rgcbk9PTaVMBCB/44QDUQ+PUE=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=bd7x7lJzomOR2B9aQzR/foUqSVgm19CacFzX7xaLWobej3BdmLjBidD0JN04x3m3aZX31tJO0VHKL5eQTchVUjacUxeUG5byapTJ2mQr93eaLOTv7uuqhxb6JhVD432hp9ctaPoDB+duzS05XCCSTWf1FfBc8HnjIcRVM/830O8=

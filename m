...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 36B5E7F2290
	for <lists+linux-kernel@lfdr.de>; Tue, 21 Nov 2023 01:52:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233028AbjKUAwX (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 20 Nov 2023 19:52:23 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60960 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232776AbjKUAwP (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 20 Nov 2023 19:52:15 -0500
Received: from mail-pl1-x62c.google.com (mail-pl1-x62c.google.com [IPv6:2607:f8b0:4864:20::62c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 08B42ED
        for <linux-kernel@vger.kernel.org>; Mon, 20 Nov 2023 16:52:01 -0800 (PST)
Received: by mail-pl1-x62c.google.com with SMTP id d9443c01a7336-1cf59c07faeso11189115ad.2
        for <linux-kernel@vger.kernel.org>; Mon, 20 Nov 2023 16:52:01 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1700527920; x=1701132720; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=6powpkwCQsdvB4FYXfhi2wCixH38Jc2Z07ow3ygi0Xo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1700527920; x=1701132720;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=6powpkwCQsdvB4FYXfhi2wCixH38Jc2Z07ow3ygi0Xo=;
        b=
X-Gm-Message-State: AOJu0YzvRrTKgC+3Fi3mu6IECXL8uyL4s+bN1O3GNkDquGG4xDw6ngTj
        HTTF+OTlZqu9p/9/uYHtg3ST78+b0hY=
X-Google-Smtp-Source: AGHT+IExZgJzmSNxqW5E3N51gSPyoKEQBDpCnNt8bRPg8tZZ3Tx/9RUyJp6AIpJdK/ITOn7J0Sgc2w==
X-Received: by 2002:a17:902:e5cd:b0:1cf:51c5:d427 with SMTP id u13-20020a170902e5cd00b001cf51c5d427mr7694576plf.65.1700527917265;
        Mon, 20 Nov 2023 16:51:57 -0800 (PST)
Received: from nickserv.taila7d40.ts.net (c-24-5-149-91.hsd1.ca.comcast.net. [24.5.149.91])
        by smtp.gmail.com with ESMTPSA id a12-20020a170902ee8c00b001c74876f018sm6705936pld.18.2023.11.20.16.51.54
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 20 Nov 2023 16:51:55 -0800 (PST)
...
Subject: [PATCH 1/2] zstd: import upstream v1.5.5
Date:   Mon, 20 Nov 2023 17:03:17 -0800
Message-ID: <20231121010318.524570-2-nickrterrell@gmail.com>

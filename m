...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 760E87E0626
	for <lists+linux-kernel@lfdr.de>; Fri,  3 Nov 2023 17:04:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345471AbjKCQEF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 3 Nov 2023 12:04:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46106 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345190AbjKCQDt (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 3 Nov 2023 12:03:49 -0400
Received: from mail-yb1-xb49.google.com (mail-yb1-xb49.google.com [IPv6:2607:f8b0:4864:20::b49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3461E1BC
        for <linux-kernel@vger.kernel.org>; Fri,  3 Nov 2023 09:03:43 -0700 (PDT)
Received: by mail-yb1-xb49.google.com with SMTP id 3f1490d57ef6-da03c5ae220so2807809276.1
        for <linux-kernel@vger.kernel.org>; Fri, 03 Nov 2023 09:03:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1699027422; x=1699632222; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=vmgYzX9Gh/HqVCtLQcjUqo5x4uBX58pquJxOOKimeCw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1699027422; x=1699632222;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=vmgYzX9Gh/HqVCtLQcjUqo5x4uBX58pquJxOOKimeCw=;
        b=
X-Gm-Message-State: AOJu0YwshHTTamqI7tiA75k5kviaZCCH2FzA94fcq3jzklMx7E7f/k7z
        5Gem3+h4t+7PDg+IAOHNbOHY/wDRYbg=
X-Google-Smtp-Source: AGHT+IHQr3yh2+t6gXQK4AqcRS89IjU+RXh0OF8PbPakJVl3VTJxekhpffcWfIXR+6x1OA74gUKqe8Z0Jeg=
X-Received: from glider.muc.corp.google.com ([2a00:79e0:9c:201:74c:1f8e:4661:7aaa])
 (user=glider job=sendgmr) by 2002:a05:6902:45:b0:d9b:59c3:6eef with SMTP id
 m5-20020a056902004500b00d9b59c36eefmr73214ybh.0.1699027422346; Fri, 03 Nov
 2023 09:03:42 -0700 (PDT)
Date:   Fri,  3 Nov 2023 17:03:33 +0100
In-Reply-To: <20231103160335.2464561-1-glider@google.com>
Mime-Version: 1.0
References: <20231103160335.2464561-1-glider@google.com>
X-Mailer: git-send-email 2.42.0.869.gea05f2083d-goog
Message-ID: <20231103160335.2464561-2-glider@google.com>

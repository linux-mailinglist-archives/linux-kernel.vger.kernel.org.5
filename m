Return-Path: <linux-kernel+bounces-127452-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E90E5894B94
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 08:40:11 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1800C1C225B4
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 06:40:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E22A029437;
	Tue,  2 Apr 2024 06:40:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b="l35aouJ4"
Received: from madrid.collaboradmins.com (madrid.collaboradmins.com [46.235.227.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 815DF21A0A
	for <linux-kernel@vger.kernel.org>; Tue,  2 Apr 2024 06:40:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=46.235.227.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712040005; cv=none; b=HiYTGTbsW6WItDYqrLS18zIs2jKrNdOO0XoDxEZa6016ErPl3+D/P6Xt7aC/FL4Xw0aMEVNpwNkXndHIaAlLwww6UxradRDODgXnNOMoAnwUaEF98L0ppF7ORv6GT+0ygLUQXzEjSQYbVMW0Dv6+XmnOJ/yBtX/Nfmn6zGvInso=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712040005; c=relaxed/simple;
	bh=qd9JukLxvek8X9skcUIB5L7Pz9p8/VW8vo2S6j46R74=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Ixn8m5gFUv2JSEFn9gZy3BQz6OYohiAILXS2plqSCg5m5pnprWS8/s6dljg7n4gkll58KXfkH9Di+LqpoZX8yDNXbdlVRf+WZzkjdwr6eXcAFRUmVmktjrk/xcb/H+99YlPTOsJ/nVgD6cQ2+jrb69KRfREaCM1kbPm5ENdt0Bc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=collabora.com; spf=pass smtp.mailfrom=collabora.com; dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b=l35aouJ4; arc=none smtp.client-ip=46.235.227.194
...
Subject: Re: [PATCH v5 08/10] drm/ci: rockchip: Refactor existing rockchip
 jobs

Return-Path: <linux-kernel+bounces-23254-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 58C1182A9CE
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Jan 2024 09:56:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id C318CB24623
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Jan 2024 08:56:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9EA011094E;
	Thu, 11 Jan 2024 08:56:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="YR3kmH3c"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4C74BFC0B
	for <linux-kernel@vger.kernel.org>; Thu, 11 Jan 2024 08:56:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1704963365;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding;
	bh=uRUU62WWJzjJ7HLfvfm0qPbImNGXrVHE/GZX0ITXdyI=;
	b=YR3kmH3cvHrvayQ2kwx3xwx4YhMA8OQb2K4jUcnAR+bCFsQG+YfYZGavv7D71A0F3a00cL
	XkAuJARRodIqOL4osruYQ/6NmJGlHED0Sqrf9LBa/MrTuVxlBy8CTBc+zYKG+SGTHTNJ9a
	daxj/pzsfyW36ajfzX3qLO4TAqL8Ghk=
Received: from mail-qv1-f72.google.com (mail-qv1-f72.google.com
 [209.85.219.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-301-orkyf079PeqDqo81t0vEWA-1; Thu, 11 Jan 2024 03:56:03 -0500
X-MC-Unique: orkyf079PeqDqo81t0vEWA-1
Received: by mail-qv1-f72.google.com with SMTP id 6a1803df08f44-680fce72f68so12524256d6.0
        for <linux-kernel@vger.kernel.org>; Thu, 11 Jan 2024 00:56:03 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=uRUU62WWJzjJ7HLfvfm0qPbImNGXrVHE/GZX0ITXdyI=;
        b=
X-Gm-Message-State: AOJu0YxcpB13I8NlGgOvTO4NIeeq4UW1dN9ZwkaDf0F5i20h0wDBrAdo
	xESWZEm5iWhYhSWn5oU1LE4IQFOddjV0axt5Of7NloLnYVvruGlY1fL4/GzHr+4lBD7JwoHQ57j
	I+oVIa/7tdmenoX6a4LkFveQhtpN10rGp
X-Received: by 2002:ad4:4ee5:0:b0:67f:4c05:4d34 with SMTP id dv5-20020ad44ee5000000b0067f4c054d34mr1504500qvb.5.1704963362524;

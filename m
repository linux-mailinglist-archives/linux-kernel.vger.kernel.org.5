...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1FF757BEFD7
	for <lists+linux-kernel@lfdr.de>; Tue, 10 Oct 2023 02:42:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1379230AbjJJAmL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 Oct 2023 20:42:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59632 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1379141AbjJJAmK (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Oct 2023 20:42:10 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9AB4B9F
        for <linux-kernel@vger.kernel.org>; Mon,  9 Oct 2023 17:42:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1696898528; x=1728434528;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=vkIlSDcv+vu8wyC4lDxfaAK5p98gLr8Ffb9RsAFaN30=;
  b=kg5tSxdHX55lHFKLY//bmTgtymjSBsJ3esoeM5G6NRC8rE16oyh764GG
   kuoHb1Wpglra2mQv2OvVGxu9Ekq+gQ54QUu7K8deLen6QIy/R0HJY18UI
   PKvA47JB60DGo81ahQp+P2zFCw+uj/KDqT3QJF+dBXBLBk5gKjlBeVWGZ
   saHueCZklS9o+fCGLx4ZrVpcOYscDTUB3z0rYoSgbATUEH9j47Jrdb2X2
   1jYO/50OLERxqpmf7xhhRKp2BdW77h+4bGkNNV5qQ75+A4U5TQtyBUPRn
   8OQjVrEiH3A4754H8ShzPg8gyPELjEk/OFS004dD3GKuxaD0EPQf4yYiG
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="384139904"
X-IronPort-AV: E=Sophos;i="6.03,211,1694761200"; 
   d="scan'208";a="384139904"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 Oct 2023 17:42:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10858"; a="1000446376"
X-IronPort-AV: E=Sophos;i="6.03,211,1694761200"; 
   d="scan'208";a="1000446376"
...
Date:   Tue, 10 Oct 2023 08:41:42 +0800
...
Subject: drivers/gpu/drm/vkms/vkms_formats.c:91:35: sparse: sparse: cast to
 restricted __le16
Message-ID: <202310100831.HIM8PruW-lkp@intel.com>
MIME-Version: 1.0
...
config: i386-randconfig-061-20230909 (https://download.01.org/0day-ci/archive/20231010/202310100831.HIM8PruW-lkp@intel.com/config)
compiler: gcc-12 (Debian 12.2.0-14) 12.2.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231010/202310100831.HIM8PruW-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202310100831.HIM8PruW-lkp@intel.com/

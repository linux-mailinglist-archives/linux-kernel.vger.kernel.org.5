Return-Path: <linux-kernel+bounces-73439-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id BB38885C297
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 18:26:02 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 365011C244A9
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 17:26:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AC17176C99;
	Tue, 20 Feb 2024 17:25:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="MY29Rcng"
Received: from out-175.mta0.migadu.com (out-175.mta0.migadu.com [91.218.175.175])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 728B276C8E
	for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 17:25:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.175
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708449932; cv=none; b=MJv86JMxFQc8sbpsS2gigePUqD0l9N0uBooHd5IDUgWvW26ZLRagB9bbyw+u+x16/TDreghSihryv09Lim+Ufn9Gp46mAK4p0I9x4GZHWfm3QTvQZZJoLiQTDIapaz0TNMfNPDZq8bH1go6Pk+NiAlhEWuuy8kuXexIJ3/CgN4k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708449932; c=relaxed/simple;
	bh=7DoFv3ud+YVzfH5w//bbhkrPFbfyVKzScJzS7+qnQ7U=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=TbaypSWvhdefxGazmetGnizcEx6iXH8ZAhX7CcIRVxXqAoElFc7VcV+503IJc472AA2Ryis4bhdt5ZRzvpiYZ4GFSchj4HMW3weyEwad3d+NDVbdrxbvGpSdppqJ0WICVRRSWyXo17CcMkzER+OieBQM3poGAkmnsmv0oF0B9zY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=MY29Rcng; arc=none smtp.client-ip=91.218.175.175

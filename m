Return-Path: <linux-kernel+bounces-167116-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 9DEC98BA4B1
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 02:49:55 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C15411C227B0
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 00:49:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D94A4DDB8;
...
Received: from mail-pl1-f181.google.com (mail-pl1-f181.google.com [209.85.214.181])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E7BBF29CA
	for <linux-kernel@vger.kernel.org>; Fri,  3 May 2024 00:49:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714697387; cv=none; b=TgWodH5WgIKD+fT/mkHWzkKVVaVALnGHx7m8QyeuC9p5J5/tYwlRxzfLZqKRAFkHLp/EVwqn9mWUab0EUoFI068NZxekOFYOGGVSGbO90f0Wfxm98wDQ/UxqGeAS1IdXj4VQ685yvw/tMPl32/W1C+5tJXOF2BNufeLWonHMdGI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714697387; c=relaxed/simple;
	bh=lvGVASQUWqVxHMy/YIsZTMOSOIcClC1mDAbxw4IZZa4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=lDEkAs08cePBPMt7SEMqTNn3Y7whf7srZXUEpVcoQvdYkVPMxjUdFFA8C5g+rdLuu5PIa00cjYF8+zdfKeuxtRq7cZSV4rRHRzsiOdCfN3zYQGp7y7NWV49JLkgekFEUQ5XF0KzqcGT8MBF7oLSWabuAjRA7y0uFcBI7TC5NgxM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=VzUEZfcz; arc=none smtp.client-ip=209.85.214.181
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-pl1-f181.google.com with SMTP id d9443c01a7336-1eab16c8d83so71193885ad.3
        for <linux-kernel@vger.kernel.org>; Thu, 02 May 2024 17:49:44 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=Wa5+5n4xYY4Yi8nY/7xTIbS3mmK4Gb+jmAeiTpe6kJE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVmZg7UYtJklz+B2+0fIP1Rd/5xWgkbi2H+G2VYB7HuLGqdDQcFUY4598BITsRqDIF7SoE+CQ32ExKcNph11ABC0lTb0rqkRBI58DBQ
X-Gm-Message-State: AOJu0Yw/IAuRxhUkuPQ2zTQJ5qLNZg/PTpkdyp7XMZcyO7xCziDXMSQ/
	v+HGYv+WSWRHTPJXTl5quD1ZOphiUs++JHNpCdX61zCSONuHR+c+FUGn+gfezw==

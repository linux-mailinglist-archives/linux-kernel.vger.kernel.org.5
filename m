...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CFF2D7C78BD
	for <lists+linux-kernel@lfdr.de>; Thu, 12 Oct 2023 23:40:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1442974AbjJLVkL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 12 Oct 2023 17:40:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51728 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347413AbjJLVkD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 12 Oct 2023 17:40:03 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 915EAC9
        for <linux-kernel@vger.kernel.org>; Thu, 12 Oct 2023 14:39:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1697146754;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=rkC6CGVt6B2EFDFnQqGwpmVy6jkyZf+xEe/YzfT0L3A=;
        b=ayfXp/DtNmwuM2ZCIAi2O8UmZRX0BmGDFgMSYM1tlQZ93Rx9Es9mnxMyCr3eUivWV79nGq
        lVFmZ2t6bK47UEPHN8wBJT5J1LnLJmqpdhQ9CjPCVzGTDAyVdBq78TA88XT4Dz1as6THod
        KLyBOEszcuURq+wjVVu1OZTT3jx2XtI=
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 [209.85.128.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-160-lodq7d2DN2mllGHeuOnQcg-1; Thu, 12 Oct 2023 17:39:13 -0400
X-MC-Unique: lodq7d2DN2mllGHeuOnQcg-1
Received: by mail-wm1-f71.google.com with SMTP id 5b1f17b1804b1-3f42bcef2acso9902135e9.2
        for <linux-kernel@vger.kernel.org>; Thu, 12 Oct 2023 14:39:13 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=rkC6CGVt6B2EFDFnQqGwpmVy6jkyZf+xEe/YzfT0L3A=;
        b=
X-Gm-Message-State: AOJu0YxxJ6yIbtIZtn+e5+PL6ngBejGgY9W8ktyT/7Et5YvaDA7WQFCd
        j6TSpMUyxLbfHKGG2ykNik5EaUnwDxCoZLAekDwyiYzzCYI1VYTgyYYTHaOUJnd/dhKxrSP32z+
        rVD17x1pqCqrVw8O01w+X5JM7nBXqacsulbii/HYJAZZw1+fkkUrS1bQ/1NadJDsym/sDC1AOlD
        duWercaFA=
X-Received: by 2002:a1c:6a16:0:b0:406:44fe:7621 with SMTP id f22-20020a1c6a16000000b0040644fe7621mr22351286wmc.25.1697146751836;
...
X-Received: by 2002:a1c:6a16:0:b0:406:44fe:7621 with SMTP id f22-20020a1c6a16000000b0040644fe7621mr22351257wmc.25.1697146751372;
        Thu, 12 Oct 2023 14:39:11 -0700 (PDT)
Received: from localhost (205.pool92-176-231.dynamic.orange.es. [92.176.231.205])
        by smtp.gmail.com with ESMTPSA id w2-20020a05600c014200b003fc16ee2864sm795942wmm.48.2023.10.12.14.39.10
...
Subject: [PATCH v3 4/6] drm/ssd130x: Add support for the SSD132x OLED controller family

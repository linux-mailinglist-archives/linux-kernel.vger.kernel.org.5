Return-Path: <linux-kernel+bounces-135323-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 6A80B89BF02
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 14:33:14 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 21563282737
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 12:33:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9229A2AF13;
...
Received: from mail-lj1-f174.google.com (mail-lj1-f174.google.com [209.85.208.174])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 04828347C2
	for <linux-kernel@vger.kernel.org>; Mon,  8 Apr 2024 12:33:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712579584; cv=none; b=D/7khDiXACfwzXtaMs7rep6+7Rtb5hEZNHLc0/0kQy1O0TXIQWdGaR6VR1nUqWx7thzFRlAXawcosXisgipPnjpZ/7VpElPf1FYqaUhCBFdd+q/2Nm3xK5N4NU9iOHL3jAuxYnSZk1C7AUu486cuJcJKXawEL3WvZv0DH0hiw3c=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=sLod5hoz; arc=none smtp.client-ip=209.85.208.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-lj1-f174.google.com with SMTP id 38308e7fff4ca-2d718ee7344so51227931fa.2
        for <linux-kernel@vger.kernel.org>; Mon, 08 Apr 2024 05:33:02 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:autocrypt:from
         ...
         :message-id:reply-to;
        bh=QhfREMjmRFKYklTUK7Py4/3OuLvxrGVK/uQ9yZ61kx0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWzRaSz804Um3kXnCUXJ8oal95ojtkr6QEquNVYbGXKavBbYIIQxIicQtgOLAlckIHodnIMCOATiUSO+8GoYWfP46BQZ+6zPUkIl5Py
X-Gm-Message-State: AOJu0YyGTSRPlqQW8W1A+DyD7GL6a4WVY3ayRPl/OGID1XLsxauP01WZ
	o9NUicZQkQXE6d1zKsN0tyKNMzG3fU70T67Q04GKmGjO4Z+7U3Mz3ciNN+ZFxHI=

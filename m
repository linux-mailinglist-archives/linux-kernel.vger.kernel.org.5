Return-Path: <linux-kernel+bounces-82643-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id E61BC868790
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 04:11:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 0D7931C24784
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 03:11:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 547C51CD01;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DF8E81B94E
	for <linux-kernel@vger.kernel.org>; Tue, 27 Feb 2024 03:10:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709003447; cv=none; b=BI7V1v93L6eIoJ09cyk3DOTxJq+V9AOvJ9Qac20qg/kwOO0VRuYQeVYF351BmkOZU6ya8EjBDlUSSysGzy7xv1+BXlfIW35Wt0Q3HMYA+6FJOlejsJVibE9Gmp/x4H2S37ShcQU6s7eW6wffPEuSZGOh2qdk5axV78N4wcBmaL8=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=RrRtBhYF; arc=none smtp.client-ip=170.10.129.124
...
Received: from mail-pg1-f198.google.com (mail-pg1-f198.google.com
 ...
 us-mta-85-SyRQj4PzNu2N1smh2ZZezQ-1; Mon, 26 Feb 2024 22:10:43 -0500
X-MC-Unique: SyRQj4PzNu2N1smh2ZZezQ-1
Received: by mail-pg1-f198.google.com with SMTP id 41be03b00d2f7-5dc97ac2facso1656793a12.0
        for <linux-kernel@vger.kernel.org>; Mon, 26 Feb 2024 19:10:43 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=yW5t2Z6Gbwkk+Nxw6G8FRSH8GBkS6FO1ImQ0kDaAxuA=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUG+cW+FYV12L6TJv49ejAFE4xwirbF+woQBbRaQRB136Nbz3VFXyE2OyD6iWRjSZqHfAbNeJTROcAYFL3Q5SnYjpt/xYDvBqpJ7/Es
X-Gm-Message-State: AOJu0Yx4nRx8lLqHp910UvIgTSwntpSthH1bhR6lPZFzJlD9iQTDNtQr
	aUIGm6+zv9ZnMxOvTqUEszeliCbmbhRfAR/Qg68QZypREYl3QXPo4WVp21+jYwGpTMbX239Wk9d
	Q332WEX0ZInXg/zwDdwkhObb9YYjbwRN5mPAHnHdwd8HQXJYSz8HfipHSlj4S8Q==
X-Received: by 2002:a17:902:b20c:b0:1dc:abeb:288 with SMTP id t12-20020a170902b20c00b001dcabeb0288mr3031031plr.1.1709003442389;

Return-Path: <linux-kernel+bounces-145599-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7FE3F8A5858
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 19:01:35 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A22811C20EB8
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 17:01:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8D9668289C;
...
Received: from mail-pf1-f171.google.com (mail-pf1-f171.google.com [209.85.210.171])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4CB0B8286A
	for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 17:01:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713200485; cv=none; b=tzf4W7KSOibQHpWmRb3h0JnoeipEySSOP1xjl4rAP7v+IjaCAPFs7O+qRQqJiTlYPxrdwY690D7eqd4Q0AP8+iCJeTNEM6AnAgxI2/21Byq+75a/g2V+2R3L/2N4MkYvPNwSr40QzUuQkVBBqVtK72zDR9bw+fyUNzV47mfsntI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713200485; c=relaxed/simple;
	bh=7lHC5xJ2vTJLbnQv7GLzUK6SG2A6vOhK+oNuADq/XBE=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=t/SztOZOipKIs/9S9DGdc7FT3lbcEAFkc+LF2W166VNriJ/eS886dISdaatOvYKbDlVUW5qfY4Ed4EVz81Uj4IH2Hcblzw0xt50ZmTP/TcIFecimVCJdhgGGGhxU+6faxh8Hiy12Pk+DlwR+WgAsphqEizX2M9tou/aePkdIPWo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ventanamicro.com; spf=pass smtp.mailfrom=ventanamicro.com; dkim=pass (2048-bit key) header.d=ventanamicro.com header.i=@ventanamicro.com header.b=b22mihX2; arc=none smtp.client-ip=209.85.210.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ventanamicro.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ventanamicro.com
Received: by mail-pf1-f171.google.com with SMTP id d2e1a72fcca58-6ed691fb83eso2822448b3a.1
        for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 10:01:24 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=afQUKb3+bReZJJVzkqw/D/pAyQK9zbCbxN1Z3zQxUCM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWv7/jeibSkGwghdlMT4d2/kV+mJvE3Fpllcc81KlA78nXlZ1jsV534BNn7VNLZTN8RqERYo6uyBWJqewo10l/rI3cNS5ELvGS6Xd8H
X-Gm-Message-State: AOJu0YwPXqQQ8zLJrg87VtTegGONjT4dIhqGFHxopkQaiXDYGl/j+wwT
	ckjr3uj/jGbB/2+GxsktWDM/g4k9toxaDaapF6SlJYy+rkYf/dNjy+HJacUgwKA=

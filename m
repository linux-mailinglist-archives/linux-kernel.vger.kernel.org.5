Return-Path: <linux-kernel+bounces-102939-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D90CC87B8B2
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Mar 2024 08:48:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8ECEA287BE1
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Mar 2024 07:48:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4C2375D46C;
	Thu, 14 Mar 2024 07:48:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="aZNrEm+n"
Received: from mail-pl1-f181.google.com (mail-pl1-f181.google.com [209.85.214.181])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 68BF05CDD0
	for <linux-kernel@vger.kernel.org>; Thu, 14 Mar 2024 07:48:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710402513; cv=none; b=fkXb/NLyxn7F4xokKuQP1bGWE7tOuh1GUUkugLfxxygU3PyFz+kzwkDswZoD4V5BliPJFpEmaroLwhh7pe+ydqktmigYCHa1m7O0pB3dFhN+yVH3E+8phtMdPkLBVHZJ3sAf/aEJBl2X/pujbeE6bQJisQ+ckcgoV9k5e8IoUkk=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=aZNrEm+n; arc=none smtp.client-ip=209.85.214.181
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pl1-f181.google.com with SMTP id d9443c01a7336-1dd81aee2b4so6564665ad.0
        for <linux-kernel@vger.kernel.org>; Thu, 14 Mar 2024 00:48:30 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:content-transfer-encoding:mime-version:message-id:date
         ...
         :reply-to;
        bh=oyf14pBAhDhhFGrYWiT4/jCBlK7mnjlUhjZRxVjfPSE=;
        b=BQaWaJh3dWTJaIHfnastnDtOIDzwxEqMkPlk/koWVZouQ5ok5l/DCjwVPyzVqfZOwx
         NylpcjeK8eQjhkWz+mi3b2FQ6mGXJ1fDQ58sRM33WmE4cxVtoYCpLKMnCnvefL5j5qGY
         ...
         7KaKyLWa7bXRcm3vyoGjXPFg3F23iZ/ZZFZ7diD1/acGg+ArPTZQcw9LLY3Z7+i5r3Sq
         rhmA==
X-Forwarded-Encrypted: i=1; AJvYcCXP86UkRrsLrR2Z/FJCXpfE2AFDOMmcrboc0Bu2IjQgrVntsGZ0T8TCZfTK0hYkVR5HNK/e8/jfW6oCcw4uH2z85L8F98GhYhmxOFMe
X-Gm-Message-State: AOJu0YxAFoGcjbluAQ/b99Y+V7VbY6akOeZNZBkDAHjJ5FQZfXTkGo89
	1CvfN301sQS2Kh6p3v9RxLhCxYXm3DNfmZLICDdk41F/uo/bxdugq8zau66/QQ==

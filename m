Return-Path: <linux-kernel+bounces-83114-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C2FCC868E97
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 12:18:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 00E301C218E1
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 11:18:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BE81D13A251;
	Tue, 27 Feb 2024 11:17:43 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C614C13A248
	for <linux-kernel@vger.kernel.org>; Tue, 27 Feb 2024 11:17:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.140.110.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709032663; cv=none; b=SMIdi1Zy2fHRu94nuOUkNgOZbjSKHJoAXeKsvm5hk/PcKw2+vkzXtl06sLophjgpY1g8W11+azSTZK5Ge1bwlcaq3zJrFHGyyIpKOvIb8a/PohPxqaCGMPDnP4Bj6HG27uh88xJrQi/P3GeiGLhToipfDxeYj0H9z52tFWkVwSM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709032663; c=relaxed/simple;
	bh=zMx9VNg0jW7yErLfdX4OtpOb+mzigK+UY/JrcAVpYN0=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=d0ZfgfQv3WEm+wlv54nfJnMJdp8LKK5QxIBzIv5buQM4Nc5AoGIywo9I3HIj6+u6s6oX28hlIM8ekJDandTkNmSoYzF0VVSqc0bgFq+sLOGTLwHydZ14WDl433f2Vmzt+oVYNnujPTDCm05jYuSELLfNqRgs/8lWvxgFgLhyEjo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com; spf=pass smtp.mailfrom=arm.com; arc=none smtp.client-ip=217.140.110.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 888D2DA7;
	Tue, 27 Feb 2024 03:18:19 -0800 (PST)
Received: from [10.1.197.1] (ewhatever.cambridge.arm.com [10.1.197.1])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 744AB3F6C4;
	Tue, 27 Feb 2024 03:17:40 -0800 (PST)
...
Cc: mike.leach@linaro.org, james.clark@arm.com, linux-kernel@vger.kernel.org,
 linux-arm-kernel@lists.infradead.org
References: <20240220214212.10231-1-pvkumar5749404@gmail.com>
 <02138784-d9fd-4331-bb34-fe1bd2fd043f@arm.com>
 <CAH8oh8W5=sAw8Lf6n_LRtxqdLde-+F2NeMTTc1SJSSpQNasFnA@mail.gmail.com>
From: Suzuki K Poulose <suzuki.poulose@arm.com>
In-Reply-To: <CAH8oh8W5=sAw8Lf6n_LRtxqdLde-+F2NeMTTc1SJSSpQNasFnA@mail.gmail.com>
...
> Prabhav
> 
> On Mon, Feb 26, 2024 at 9:25 PM Suzuki K Poulose <suzuki.poulose@arm.com 

Return-Path: <linux-kernel+bounces-162825-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 28D038B610E
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 20:24:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 81209281F63
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 18:23:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 46F921292DC;
	Mon, 29 Apr 2024 18:23:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="FTtUGZT+"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 95DE28614C
	for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 18:23:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714415026; cv=none; b=lMWBw1OctQ5R/3fYOybLlzbglZaLHC3rH0dlAMoDRNYp+lhKKvw5+RA2jjDMu6bzsfvBG/70BSD1U2fRxXE4VBCetGTdOBSTe7hV2mQDdDUGxOrw43dcl336pPwTP190NIo/zgwAUPjQp0PEwXoOnciY0tYrT4oEpDVLNwbmXmE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714415026; c=relaxed/simple;
	bh=2N8oyanNrkyKqFDzJd7H/3d3P1eVswNz12mYCtWrSuA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=f/SeL+1S7ldNCCaCG8DGzVM3UCZC/91r/JXw3p6sEiFWT5yqZzJ+C+IXlfFg6dofK4TBeTMSVE1UYzqQeE3ChM7Oh8d0ApJL75tMXeyGPyaa8mp0n1axcqfMLgfKfIa8zewX/hs1rtkTmqCT+aO+oDXZ32Eml9lkUVPKIo5jeMY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=FTtUGZT+; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1714415023;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=/xJ39egjPXPVzQcGg1vJ7sp0qcrk9q2He5yMjws7WO0=;
	b=FTtUGZT+5KNaLikfGVX0exTL+ZlDR8O/NwDx5H7PRp+Gjw6a0ThtBO9Gz2sPVXM4GVXYaL
	dM8R8ufankPFHsdHv4fAIc6eokhHOWgLHwNy+H5gxi3nUBzyTNYA/54cpHMm9ot2lUM2LC
	LISPmv9HTxYIB+TRcOdy1uxd05lJjwA=

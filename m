Return-Path: <linux-kernel+bounces-80475-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C88248668CF
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 04:42:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 5C0AF2820E7
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 03:42:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BCEA718EAF;
	Mon, 26 Feb 2024 03:42:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="XXtUmoP5"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C5E2FDF44
	for <linux-kernel@vger.kernel.org>; Mon, 26 Feb 2024 03:42:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=198.175.65.13
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708918934; cv=fail; b=T7P4XWKHr51iSmYZOx/fiC+Pfbm3ECp6DamMFHK8LhIu2DjtOEaIqh4gK4+T2rma6PhwXkXcAL/P8w0qb7HbLTyDdAtsWg8bOU5LT+d+dK+IekyiFcP1wqerFPjvBh/9o91IGhnMWJGAZrbtmLxyO4GFO45k3MP2EKtfMHJa878=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708918934; c=relaxed/simple;
	bh=qF7mDhw/DsOA4d+jt2lM0DBFJEPmnDCvtjE2Qg/Bgus=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=Aw+QEk7pFdIo/c3j/1APQCxmrLMyBvLgRiw8JBsW9xlVBG8q8wajWcEYoXbDggX1PP6KQPXPAkFboc2cyhi9rWUBQoH47M3MtcJXHZgZHv9qVyCUwbanim3RjSezjgb8Udwsw7k4bdSWUaM9kYbsX3Q+J/c62jjQ97LxjIoAwbk=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=XXtUmoP5; arc=fail smtp.client-ip=198.175.65.13
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1708918932; x=1740454932;
  h=date:from:to:cc:subject:message-id:references:
   in-reply-to:mime-version;
  bh=qF7mDhw/DsOA4d+jt2lM0DBFJEPmnDCvtjE2Qg/Bgus=;
  b=XXtUmoP53MWTb27AHoD/X54G+uJ7kjSNPVp6Q6eNa47TyMXF3feST1Ik
   dGXSoiLV9MmJTcXuLIfW1ckPCZiOll0ldrZ4rz/P6z49osQUf08d9TP9w
   jUjJmKnXLEt2fTCIk6KllkwCESQC3DgYjiYVgnXSlZvCpLNWxl+XNd/Mj
   bPFrj5lEmTNTZwHyDo73peTg7i+742W13X3LctiFNFkeIfZY6uKavczWn
   i6MAeBakJ8hz2/kSvCbQ+yviUKHYch0Zt1l2qJB7egxLu/MzTGL46jp67
   Eeoy4CW5vH+jeJiUySVd48QKvdzw5l2rzZOZh7p4/jc7QVd/MoiJKL8S7
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10995"; a="14316911"
X-IronPort-AV: E=Sophos;i="6.06,185,1705392000"; 
   d="scan'208";a="14316911"
Received: from orviesa008.jf.intel.com ([10.64.159.148])
  by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Feb 2024 19:42:12 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,185,1705392000"; 
   d="scan'208";a="7029748"
Received: from orsmsx601.amr.corp.intel.com ([10.22.229.14])
  by orviesa008.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 25 Feb 2024 19:42:12 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 26 Feb 2024 03:42:09.8803
 (UTC)

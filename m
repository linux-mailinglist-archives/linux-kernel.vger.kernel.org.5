Return-Path: <linux-kernel+bounces-42120-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id D16A883FCA9
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 04:20:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 46DBD1F227C9
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Jan 2024 03:20:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8D56D10788;
	Mon, 29 Jan 2024 03:20:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="OXpgMQQJ"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 46249FC1F
	for <linux-kernel@vger.kernel.org>; Mon, 29 Jan 2024 03:20:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706498442; cv=none; b=IFiTDI1hMYwfwVs6JYxIz5tgwcftDl0I9I6pKu8CWmcjZkiu+w6umGwY1cBOSWo9nnCGRCq29qKi4Pg2gOUJkZbobe26f5zRdhK/IMfJi3MXXKBaaZ8V57TWU0oNMEtBkRNR7eyy/YACbdyHgBr0fysBL6+6lsJjyjXsP7q1Fz0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706498442; c=relaxed/simple;
	bh=r/4Yclr74ahtXpXV+m5YFeBz0Y8jrHDZvJEmycRcYo8=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=mt1PLPqTUHQfVl+ZOWL2Q4BcDqHv3R1nQHyuHbK7xiWfMYrCZPtu89fNoHPsAUml63pJWKEaoUpbYoBhv8bjVb9lVQa/uMEAP7I7vcCfHbuZvRVqHnau5QVs+p0UQ5fIzlaKU1OOQHooeAYhnrC7tYAdA+tpB+m46mv161wKqc0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=OXpgMQQJ; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1706498440;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=7G+EdxBrZWtWfEsSXmLsfmBlcaKy+iy1nng6IU24Ic8=;
	b=OXpgMQQJc9R1Cf13tqNL4R6YcKf+UQXdy+8sd01CsqfFQgW2KxfitWjmO/ol1k7PFFhKVe
	hwtksK154gPXEe45inn2Ex88XE/KnET2mISwOEbWB/PJyGab0kYn6GIiiLb0xGD5NBkpaS
	/ksc4OGI5cQhrrG1L87yCNn19N1ZhCE=

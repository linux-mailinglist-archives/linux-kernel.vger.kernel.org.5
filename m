Return-Path: <linux-kernel+bounces-146911-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 122A68A6CD1
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 15:51:50 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id F35151C20BED
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 13:51:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F3BB912CDA8;
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C475A12C559
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 13:51:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713275498; cv=none; b=Q/101gCtyO19R7z3Gnjeuo0D7IslIUFFF8e2Xlijz7ECuk+Wic7q9HYeop9lKAGYvR91FOtU2D3aFNGjuFv/8JFd3Xj2sk+hRNebUhWOHCjBc+9KsaWCCqJvvXYRGP6J74HvKrQyu9U+jAL6lDSM9xhta4z+3OiTI1xitdVld8Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713275498; c=relaxed/simple;
	bh=QTAfbFgev3L2ptUAejaAhMPjhDL+4HSJM2/BMHHV6F8=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Fej+x1CfxDLkDS4oN0kjwxQJk8yCI2a0rIgB6rhu1FkFYK1VlsWM3LF9uHW7QS2C17Er7tdEzvbHNeT9HY0IVCaeo2k5beKU0q6UB8z27E75EtnOMzgf3iKXcDYrkf6QMWps+vy2Xm9RHkaIs1+32GkOWXS99n/VkoCCv3aGGAU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=CKVfmw6P; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-wr1-f72.google.com (mail-wr1-f72.google.com
 ...
 us-mta-154-U7GwqTBpOKumK0SbCZKwOg-1; Tue, 16 Apr 2024 09:51:33 -0400
X-MC-Unique: U7GwqTBpOKumK0SbCZKwOg-1
Received: by mail-wr1-f72.google.com with SMTP id ffacd0b85a97d-343d02b62ddso2756562f8f.1
        for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 06:51:33 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=KzEshGm05jYMH47Ft2QC8UnffG1g9JyMRcoOm48fEmc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVtjO8wRvQ/84VPM/iXeYV2HchwnNYAfU6/bgmMTMPTDyvpDjD2/aZms1XLFUiSIJ0fYhNBDJPd+FVRzizZ3oWlA5J0b8vVXR8BWsBu
X-Gm-Message-State: AOJu0YwN3yDDAk0BvSGPdtCa+LzPZAxMZwBoXWjk+ydR3M0KHHvDGyyE
	ft4rBbt9AlqwNFoa541kIMAlP9S1F7fVOtGpJ+xWZULTSjIMz0piKFKDVR5p+uh84XigpeYjgpc
	GKbD5uK2MMxw1marCPghnl0wnzQMepOnxrrsFxKki8tDWMAdOG0kcS13YAzWHAA==
X-Received: by 2002:a5d:4589:0:b0:33e:c316:2a51 with SMTP id p9-20020a5d4589000000b0033ec3162a51mr7672084wrq.27.1713275492286;

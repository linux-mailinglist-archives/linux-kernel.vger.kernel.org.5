Return-Path: <linux-kernel+bounces-74019-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0AF9C85CEEF
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 04:45:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 3AB4D280355
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 03:45:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 119AA3C481;
	Wed, 21 Feb 2024 03:42:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="bDP546u8"
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B2E5C39859
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 03:42:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708486945; cv=none; b=faVCkXOz2e5ybYdYiNlzb3d/ewS4rm/YWFXUSLsLVYul4djj2HSQR2m1U6FYiK178NqpfoRa01AcVCp8OJp6P5V0P9K6San634R+YEQBk/oRsSe/1eSyEH4w3fh23hvV3VhJ/oAlz3AcSb1/sl1XLsUGkzEPMDCXmiAcB3BUfdI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708486945; c=relaxed/simple;
	bh=SV8Q2XP3AEzUCdEScST86iV7qnjMAWaIiYJHWAwVraA=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=Vim6kKAzyGOIm4AKTBWfMcScvqneen3rqSgCZBkReOIzKclloYEYy/b/G1xxJB6RSoeUrZZJHDuQp9gu1UZVKzZJFbULNKBzXh6JQVM2k6KUWb61llAzbUmySmgoLxaz40AJSObypyHA3/Tgpdq2KyfIcjzeS5vlzHaYG60t4J0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=bDP546u8; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-60810219282so42976777b3.0
        for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 19:42:23 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1708486943; x=1709091743; darn=vger.kernel.org;
        ...
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1708486943; x=1709091743;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=46NbERsw+rX6VfHxglAqwzl8LfYw4J5J2BPeonbB4cQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXPFpT4HncJFA/Vk6fsI187f0Alz8XzxbRJKlApAA9XNVMUu9Hcq0fIfuoW9xMJE0L9rMJcA6XOAfDAA8McrKrwhSenW66QpzX+wcbO
X-Gm-Message-State: AOJu0Yw+yLZpINbvYxcoS//tY7o7DpwxrYWw3RSKq2u/FWpyp7o349eS
	QsssYgxSiigtb3fcnCoWk8bfd0KLYv6hDxVtUkE6GFzRSeDuzy93AaEVUNVUplf0mHTqkvUNP7B
	LP11fhw==
X-Google-Smtp-Source: AGHT+IET82N9VxF3P0mhswunlFqpZ962xGtp3e+douDh41h855ffc3i/FuxyiiNEpPVBfAizCbtju+rDiPsA
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:3c02:f882:5876:b7ab])
 ...
 d72-20020a0ddb4b000000b0060781e18b83mr3197747ywe.8.1708486942813; Tue, 20 Feb
 2024 19:42:22 -0800 (PST)
Date: Tue, 20 Feb 2024 19:41:55 -0800
In-Reply-To: <20240221034155.1500118-1-irogers@google.com>
Message-Id: <20240221034155.1500118-9-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v6 8/8] perf tests: Add option to run tests in parallel

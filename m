...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E48A17A185C
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Sep 2023 10:14:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233044AbjIOIOI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 15 Sep 2023 04:14:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55608 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233197AbjIOIN0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 15 Sep 2023 04:13:26 -0400
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DD48B2D42
        for <linux-kernel@vger.kernel.org>; Fri, 15 Sep 2023 01:12:15 -0700 (PDT)
Received: by smtp.kernel.org (Postfix) with ESMTPS id 76A56C2BCFE;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        ...
        b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
        by smtp.lore.kernel.org (Postfix) with ESMTP id 64EF3EE6441;
        Fri, 15 Sep 2023 08:12:10 +0000 (UTC)
From:   Nikita Shubin via B4 Relay 
        <devnull+nikita.shubin.maquefel.me@kernel.org>
Date:   Fri, 15 Sep 2023 11:11:21 +0300
Subject: [PATCH v4 39/42] ARM: ep93xx: delete all boardfiles
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230915-ep93xx-v4-39-a1d779dcec10@maquefel.me>
...
X-Developer-Signature: v=1; a=ed25519-sha256; t=1694765525; l=117548;
 i=nikita.shubin@maquefel.me; s=20230718; h=from:subject:message-id;
 bh=p4MK1l9pUpO4G1Qaw/E+iF0ZPow5TqIMBB9xnC/ZbXI=; =?utf-8?q?b=3DwmbnEzSNaW0m?=
 =?utf-8?q?jYhxMGg9yvNdWmMM/2TjM0rEE3viEsVU0nImiJoF6CucxIcjamZ2dNSinVZmjVqv?=
 CKkBCxlOB7d2YwwO4NP/GGRtozeJpMZ+j6BbmTF+lF9V0H9xuXYG

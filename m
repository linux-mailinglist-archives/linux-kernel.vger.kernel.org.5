Return-Path: <linux-kernel+bounces-166626-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B6A248B9D3B
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 17:19:56 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6CCB5287103
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 15:19:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1E59B15B96D;
...
Received: from mail-oi1-f180.google.com (mail-oi1-f180.google.com [209.85.167.180])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E77E015B13D
	for <linux-kernel@vger.kernel.org>; Thu,  2 May 2024 15:19:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.180
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714663152; cv=none; b=o6z57xPcxBTUvwWKCFTHeuq+ZMaaAmnz5CKdb2LjdEnINNfblUWJyEHM7/F9wF4TWm0H/tbdZqacvWY1WHCu3lIS+HKdAOVkvxdV978fQkdczTm7eMC5JRjcQmLUDShfYbYr6W2/3Qri0Jt4Lan/Z1B2awCqOGVHkLOoyeFDF5w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714663152; c=relaxed/simple;
	bh=i3wb7WRtSrVSSajbX7oqK5l2d30q5KzxqpxvbKAkRVk=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=BUIIO6NNKUm1K/vRntVephv4lTD1Yzz0YnBBhzu6RK/SzXIaH+mWr06eRKQqzmSAhqqStsOz/hhCNVLA+l51wQd1TELBSiKgLxA0nNotdx92O1tOwMa0dWstzwH50xPzF666BVAUNCkJxfMBops7oeVNKqIixLdq7S+s5bFkV9o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=ahWBPPlL; arc=none smtp.client-ip=209.85.167.180
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-oi1-f180.google.com with SMTP id 5614622812f47-3c6f785208dso1571469b6e.1
        for <linux-kernel@vger.kernel.org>; Thu, 02 May 2024 08:19:08 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=o45R2QGeOEyfQ95xK5XQm00x5VHsPQPc/6bWyA4205U=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUrK63bVxSILMk7/2ueJb57XsNVT9metePeSunwoxGsooCDpEN49BY3Ndxnmj/evPew/5gKfvwHcOlNNaG+qyNrEubx1/py13djvR4S
X-Gm-Message-State: AOJu0Yzb0GkeN0maI3WbJT88njV6A1XK1sR21363mxSNWSHd4shacAdZ
	gpRCm+6SRJyv1H2YrnL6ecj9FuhS5V4VRU6ez2nJuu8mHSfTawExnt0/5kDpoNqzU4acwn3pxzJ
	figFDDu1/fjOvABXVhfcsm9SQf6c8vbiNgeFO/xTA1nbfYoR5Dg==

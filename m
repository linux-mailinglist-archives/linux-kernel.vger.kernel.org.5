Return-Path: <linux-kernel+bounces-94562-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 76278874175
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 21:38:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D1DCD2864B2
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 20:38:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C4D351429B;
	Wed,  6 Mar 2024 20:38:11 +0000 (UTC)
Received: from relay5-d.mail.gandi.net (relay5-d.mail.gandi.net [217.70.183.197])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 18695D531;
	Wed,  6 Mar 2024 20:38:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.197
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709757490; cv=none; b=HrUCPuL9S+B3fcuxDpE81uU551QFa+ijshtIQDWf9ScBvUYUaeUhuo6XBsvsO4bIBaylsXsPx8IeJVuSd+/nZdK9lIXQA4G0giM8o7c0ASolkzZGrCeREK2/G7X6IStosm2NDaoWSVshC7eIGXSbFaYJyQE+X9Q1OIfGB2/j1X8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709757490; c=relaxed/simple;
	bh=nCr9yN0DKHVMyRm+ySvDPc9U+ggnPJT9UTR6/iKlEzM=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:References:Cc:
	 In-Reply-To:Content-Type; b=Abyj38W5JGJoYHUFWIHBmO+1yJ+s62AAyXSGCYLXBnpvqRwdLaWqzFF7mE7/d6NODMhMaR9hz6+F04NWOzf3yDQRv1IWCPclfT1Ihuwyu6csPFExz7PJoZLEZ+PdkOqZ18vZhFfnBfSqwv15tmkyJ6j/u2uMw5aEQy5/zFPjG7E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ghiti.fr; spf=pass smtp.mailfrom=ghiti.fr; arc=none smtp.client-ip=217.70.183.197
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ghiti.fr
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ghiti.fr
Received: by mail.gandi.net (Postfix) with ESMTPSA id 06D2B1C0004;
	Wed,  6 Mar 2024 20:38:01 +0000 (UTC)
Message-ID: <60a1ad85-7bca-45ef-91be-8f1b3cfc9011@ghiti.fr>
Date: Wed, 6 Mar 2024 21:38:01 +0100
Precedence: bulk

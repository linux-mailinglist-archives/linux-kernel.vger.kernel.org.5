Return-Path: <linux-kernel+bounces-31733-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 90E41833317
	for <lists+linux-kernel@lfdr.de>; Sat, 20 Jan 2024 08:24:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 050CC1F23D74
	for <lists+linux-kernel@lfdr.de>; Sat, 20 Jan 2024 07:24:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 055DD2105;
	Sat, 20 Jan 2024 07:23:58 +0000 (UTC)
Received: from szxga07-in.huawei.com (szxga07-in.huawei.com [45.249.212.35])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C5BD21FBC;
	Sat, 20 Jan 2024 07:23:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=45.249.212.35
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705735437; cv=none; b=TG5iJpn7Z9LKhz/gJzxsWSQ8qXkhkwC+PBoroIAfa/hJjxYvKFCA2/2vKtMNDLrGgcTe/NfA7rmSb3b7s88EqS+ZplFn/M7TTJNpshopJhSyX4zZOgWPGnjVz6RnuAkhHk4AXkpgyYvMN98TEdOK5XJl4AORIN4ys+MPKKmMYCo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705735437; c=relaxed/simple;
	bh=0cA6kcmKj4bnCD4NrZh+oeXoFuB+1qfeGQiotxB2uiU=;
	h=Date:From:To:CC:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=rv7GQ1A+h8jTdJDDH8EUAAZ7inCwtJL7eSFXf5dI5s3QwV9o7jM4DPf56G5AiSCjwkKekIAiZ1Sy3aog5FW5m4RNbrk19yu0LDtSC1ks4qEZryBfbnfUGsbEsE2FJY1NKMLebnk0XNDyvjpwo4IONB/U4+quzxHk0QGOHS5xQ7M=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com; spf=pass smtp.mailfrom=huawei.com; arc=none smtp.client-ip=45.249.212.35
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=huawei.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=huawei.com
Received: from mail.maildlp.com (unknown [172.19.163.44])
	by szxga07-in.huawei.com (SkyGuard) with ESMTP id 4TH7GV6Rz2z1S5FW;
	Sat, 20 Jan 2024 15:22:10 +0800 (CST)
Received: from kwepemd100002.china.huawei.com (unknown [7.221.188.184])
	by mail.maildlp.com (Postfix) with ESMTPS id D87AE1400D3;
	Sat, 20 Jan 2024 15:23:51 +0800 (CST)
Received: from M910t (10.110.54.157) by kwepemd100002.china.huawei.com
 ...
 2024 15:23:50 +0800
Date: Sat, 20 Jan 2024 15:23:40 +0800
...
In-Reply-To: <029cd7e3-51f5-4d04-8f54-c6e478e052a3@intel.com>

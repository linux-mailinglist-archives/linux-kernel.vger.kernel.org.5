...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 059E7753B64
	for <lists+linux-kernel@lfdr.de>; Fri, 14 Jul 2023 15:00:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235809AbjGNNAk (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 14 Jul 2023 09:00:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56644 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235530AbjGNNAi (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 14 Jul 2023 09:00:38 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B6FDD2D41;
        Fri, 14 Jul 2023 06:00:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1689339629; x=1720875629;
  h=date:from:to:cc:subject:message-id:
   content-transfer-encoding:mime-version;
  bh=vtt3mRCIGtB5EmykNYLnYbX1qaRIk19OIifYE9IEldo=;
  b=b5FipdImngkToll4SS22nAYbMVnltsr4UMW2sXpVfKfpP+vd7/zzPiN8
   VtPklKYbKzhVP++DjAoRL1rOkqOhyRGs0juzhfl8w7IFIKWBWzk4rF37b
   dWWt2yrnfSEb18kQZYWciOaHoW8lg/8xbwy0f59ilgGwoYM0NJL72/2Di
   PpiIv35/7yBZjD8CNomJh21FG5YUyOJDdFP3IlTwtuksMfELeSr3fr583
   mYwKd1BDWLICXppKc+Y5reJQcMD/St341RlxNgH9vZ86+Etq4q+c3w1vC
   EONdd2zXErGmIC8tN4GY89b660ocMex1eQWkrf51Ksv+1vMUTp4infF9u
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10770"; a="345063840"
X-IronPort-AV: E=Sophos;i="6.01,205,1684825200"; 
   d="yaml'?scan'208";a="345063840"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Jul 2023 06:00:23 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10770"; a="722386791"
X-IronPort-AV: E=Sophos;i="6.01,205,1684825200"; 
   d="yaml'?scan'208";a="722386791"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
  by orsmga002.jf.intel.com with ESMTP; 14 Jul 2023 06:00:20 -0700
Received: from fmsmsx612.amr.corp.intel.com (10.18.126.92) by
 fmsmsx601.amr.corp.intel.com (10.18.126.81) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27; Fri, 14 Jul 2023 06:00:18 -0700
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 fmsmsx612.amr.corp.intel.com (10.18.126.92) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27; Fri, 14 Jul 2023 06:00:17 -0700
Received: from fmsedg602.ED.cps.intel.com (10.1.192.136) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27 via Frontend Transport; Fri, 14 Jul 2023 06:00:17 -0700
Received: from NAM11-BN8-obe.outbound.protection.outlook.com (104.47.58.169)
 by edgegateway.intel.com (192.55.55.71) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.27; Fri, 14 Jul 2023 06:00:16 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=x9rvRxRc87Y6EX6H03EzosbQrQ7bIngz9MHkPONOS0g=;
 b=
...
CC:     <oe-lkp@lists.linux.dev>, <lkp@intel.com>,
        ...
        Zack Rusin <zackr@vmware.com>, <linux-doc@vger.kernel.org>,
...
Content-Type: multipart/mixed; boundary="wfwN/DM2XWF3TD/U"
...
X-MS-TrafficTypeDiagnostic: PH8PR11MB6779:EE_|CY5PR11MB6415:EE_
X-MS-Office365-Filtering-Correlation-Id: b53b72b0-4508-49e6-7eff-08db846a40ea
X-LD-Processed: 46c98d88-e344-4ed4-8496-4ed7712e255d,ExtAddr
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH8PR11MB6779.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230028)(396003)(39860400002)(346002)(366004)(136003)(376002)(451199021)(8676002)(8936002)(83380400001)(2906002)(2616005)(36756003)(30864003)(38100700002)(82960400001)(86362001)(7406005)(7416002)(1076003)(235185007)(5660300002)(26005)(6506007)(21490400003)(186003)(54906003)(66476007)(66556008)(66946007)(6916009)(6486002)(44144004)(4326008)(6666004)(6512007)(966005)(478600001)(41300700001)(316002)(2700100001)(579004)(559001);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?4NouExx+E/KH7tKvjBqTJNPFfeF2G1ovcHxUz4ho017mM4BGSP2kyfy1JZ?=
 =?iso-8859-1?Q?jwjbp4plMdVzRpmV6OfTiTQs5F2ipGsAPHHDVOsHVLoW7zLc6oqOIY2nju?=
 =?iso-8859-1?Q?692SzkSTlzSeevPMcGWRck9IWUbCuvzFFK5Z6ZmKznydwWxtBcf2WD4V8u?=
 =?iso-8859-1?Q?3Pa0H65jQY6VFPed6cqKaCyn3PPzKadgepW7TDydNtIgFvBllfjqsLo90K?=
 =?iso-8859-1?Q?1+uTXoz/sRDQATL3rd/0dH9HtWiso1N5lHCZs6DOE0bSnIgp7XpcGCdSCY?=
 =?iso-8859-1?Q?pPrU640yXtI95DuRvaZoJIUEcUHxCtto6m1si/LXyGgsrS4fXtb9pQKKLE?=
 =?iso-8859-1?Q?+3v4P+Xh/FFIel7KFYWoU2UNhfw7onT1vH592Oj+QA6vamZfjzQJ1Wxq+i?=
 =?iso-8859-1?Q?C6qPs3PvxltIBYeJeUJpgrh0+SfaRInW6Y9ZIp55kUcj5sV6sCfWpVWSXq?=
 =?iso-8859-1?Q?3UXmAEagK/UfWKqLyDaD+GtvIGKAYyTb7kMxYrWr3QSN8/Tu71sKSf9Uhi?=
 =?iso-8859-1?Q?9oOmHAlV557OK5E9nXp3VO2tT/AIsApaAoJE99Q/hZQwM8iuJTqZXopaoC?=
 =?iso-8859-1?Q?PJG1MRms6OnvaLSg89HkhJDXNx8thJTid+JVGZ5EoMmADAsoQlDyQYiuw5?=
 =?iso-8859-1?Q?uqglp9uk6dCgCk40+5S//FglV9ruZQ0AjEzyJQkSCERgTvFNqyH9Q8B+Oq?=
 =?iso-8859-1?Q?ml/Sns7KzB8Oxa3Kb2dS5QxMmYEODossizlxDhJLjlyeP+i2WycB6fEYya?=
 =?iso-8859-1?Q?zfQBnZQRDukWPwxIYwBfPNrd1U8uVkzhtqiJ24OTHgjKyCF0AxNEr20gGc?=
 =?iso-8859-1?Q?ZX2uGZi6KOX2hNK8xomp8HdVzZf7ZIrn9QHYJbJNpOlcYniOmLm5eZwfGI?=
 =?iso-8859-1?Q?DiuYU9BB5PeXuwQ5krhY4vXP26/t0o1AP5aeiscfC/ZN0zWuBtcu73NDEZ?=
 =?iso-8859-1?Q?3HWzePF2t1UE0wPCqtVzb6vv1s7kcOso13cemqHePaxMEa5cOhXk04fbPC?=
 =?iso-8859-1?Q?14IyeeUCxhFBUySw76H2l4Suympp7RXHG157gqXYXS54ix5gxZ4TBvjmha?=
 =?iso-8859-1?Q?QP5v3xjYi1qMc6AdW/q+edQPQL+Pa1QgPE9Hw4b6z0DHxX28W1ZW+PKW4L?=
 =?iso-8859-1?Q?oSLEDjnTqNLFFJqG/akuknNdHAWBCi7WnkTB6WT8D83CtCFBj1HZOtPo3X?=
 =?iso-8859-1?Q?PzMmcObRPFRsHT+ZRyav0zyFP3zaCgsfjBklyknEYKWtAFvftEOWtm1ceB?=
 =?iso-8859-1?Q?wCeasn89T2Wcac/ciiDjrU/tklgVCP7rKnoJ7gmjWPuwSE6TEdPqjUhrxj?=
 =?iso-8859-1?Q?CNgamHU9vLVGChJt1Aiek43LLkI1UY5VX4oUELMlGGDdfzBRSK+uw2FOqp?=
 =?iso-8859-1?Q?bAKSnT0iw4oD7tUubX9utOtMjD1W23tCDjrbLm/m9nGw8xPlI9gDHak+Th?=
 =?iso-8859-1?Q?xsI6HH1qFq8C0/Ba5aVHefhf5SrRNNMqzE8kIALrxd9Kdm1qYchK9prhaW?=
 =?iso-8859-1?Q?nVgT3gBmOFHln+gyRfp5sTW15i+wWSaNnTHvNjhCpA8UlA1rmWBfzz3Y5I?=
 =?iso-8859-1?Q?z4UxCJ0/jmO3K5Jd20ahJ63dMzG8MPfs84hdpdTTLrm5iokBpjKhGmYe2w?=
 =?iso-8859-1?Q?xnNCj7ajKcn4kxMTqh3Hqkx/i3xmzVLps2UI54++PXDSpABV4Myh3M4Q?=
 =?iso-8859-1?Q?=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: b53b72b0-4508-49e6-7eff-08db846a40ea
X-MS-Exchange-CrossTenant-AuthSource: PH8PR11MB6779.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 14 Jul 2023 13:00:10.1230
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: JPAfs2+sTGWrjCTE4zeqK8gIa6VKNu8YTYlULnatjxDTAYSaOy3JKy/DsIBPiTdzOupFkP4xIzlfG39bz5Li4A==
...
Content-Disposition: attachment;
	filename="config-6.4.0-rc4-00241-g0d940a9b270b"
...
compiler'
	export queue='vip'
	export testbox='lkp-icl-2sp9'
	export tbox_group='lkp-icl-2sp9'
	export branch='linus/master'
	export commit='0d940a9b270b9220dcff74d8e9123c9788365751'
	export repeat_to=3
	export submit_id='64ae30c00b9a93124ef59a12'
	export job_file='/lkp/jobs/queued/vip/lkp-icl-2sp9/will-it-scale-performance-process-16-page_fault3-debian-11.1-x86_64-20220510.cgz-0d940a9b270b-20230712-4686-1qcd455-2.yaml'
	export id='9defd7afcdbab157295bfbcfde8a069eade8170a'
	export queuer_version='/lkp/xsang/.src-20230712-104526'
	...
	export hdd_partitions='/dev/disk/by-id/wwn-0x50014ee2be2f4b3a-part*'
	export ssd_partitions='/dev/disk/by-id/wwn-0x500a0751e5ff0a85-part1
/dev/disk/by-id/wwn-0x500a0751e5ff0a85-part2
/dev/disk/by-id/wwn-0x500a0751e5ff0a85-part3'
	export rootfs_partition='/dev/disk/by-id/wwn-0x500a0751e5ff0a85-part4'
	export kernel_cmdline_hw='acpi_rsdp=0x698f6014'
...
'\{\"PREEMPT_RT\"\=\>\"n\"\}
	...
	export need_kconfig_hw='{"MEGARAID_NEWGEN"=>"y"}
MEGARAID_MM
MEGARAID_MAILBOX
MEGARAID_LEGACY
MEGARAID_SAS'
	...
	export enqueue_time='2023-07-12 12:49:07 +0800'
	export _id='64ae30c50b9a93124ef59a17'
	export _rt='/result/will-it-scale/performance-process-16-page_fault3/lkp-icl-2sp9/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751'
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/vmlinuz-6.4.0-rc4-00241-g0d940a9b270b'
	export result_root='/result/will-it-scale/performance-process-16-page_fault3/lkp-icl-2sp9/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/2'
	export user='lkp'
...
RESULT_ROOT=/result/will-it-scale/performance-process-16-page_fault3/lkp-icl-2sp9/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/2
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/vmlinuz-6.4.0-rc4-00241-g0d940a9b270b
branch=linus/master
job=/lkp/jobs/scheduled/lkp-icl-2sp9/will-it-scale-performance-process-16-page_fault3-debian-11.1-x86_64-20220510.cgz-0d940a9b270b-20230712-4686-1qcd455-2.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=0d940a9b270b9220dcff74d8e9123c9788365751
nmi_watchdog=0
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/modules.cgz'
	...
	export job_initrd='/lkp/jobs/scheduled/lkp-icl-2sp9/will-it-scale-performance-process-16-page_fault3-debian-11.1-x86_64-20220510.cgz-0d940a9b270b-20230712-4686-1qcd455-2.cgz'
...
extract_stats()
{
	...
	env mode='process' test='page_fault3' $LKP_SRC/stats/wrapper will-it-scale
...
#! /cephfs/db/releases/20230711135438/lkp-src/jobs/will-it-scale-part3.yaml
suite: will-it-scale
testcase: will-it-scale
category: benchmark
nr_task: 16
...
commit: 0d940a9b270b9220dcff74d8e9123c9788365751
repeat_to: 3
submit_id: 64ae30c00b9a93124ef59a12
job_file: "/lkp/jobs/scheduled/lkp-icl-2sp9/will-it-scale-performance-process-16-page_fault3-debian-11.1-x86_64-20220510.cgz-0d940a9b270b-20230712-4686-1qcd455-0.yaml"
id: 483b22551bb9fbb0dbd6689ca8133bfeefc16bb7
queuer_version: "/lkp/xsang/.src-20230712-104526"
...
kernel_cmdline_hw: acpi_rsdp=0x698f6014
...
compiler: gcc-12
kconfig: x86_64-rhel-8.3
enqueue_time: 2023-07-12 12:49:07.624701453 +08:00
_id: 64ae30c40b9a93124ef59a15
_rt: "/result/will-it-scale/performance-process-16-page_fault3/lkp-icl-2sp9/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751"
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/vmlinuz-6.4.0-rc4-00241-g0d940a9b270b"
result_root: "/result/will-it-scale/performance-process-16-page_fault3/lkp-icl-2sp9/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/vmlinuz-6.4.0-rc4-00241-g0d940a9b270b
- branch=linus/master
- job=/lkp/jobs/scheduled/lkp-icl-2sp9/will-it-scale-performance-process-16-page_fault3-debian-11.1-x86_64-20220510.cgz-0d940a9b270b-20230712-4686-1qcd455-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=0d940a9b270b9220dcff74d8e9123c9788365751
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-12/0d940a9b270b9220dcff74d8e9123c9788365751/modules.cgz"
...
#! /db/releases/20230711135438/lkp-src/include/site/lkp-wsx01
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:
watchdog:
job_initrd: "/lkp/jobs/scheduled/lkp-icl-2sp9/will-it-scale-performance-process-16-page_fault3-debian-11.1-x86_64-20220510.cgz-0d940a9b270b-20230712-4686-1qcd455-0.cgz"
dequeue_time: 2023-07-12 12:52:57.549124533 +08:00
job_state: finished
last_kernel: 6.4.0-rc7-00197-g9b199369231c
acpi_rsdp: '0x698f6014'
loadavg: 12.60 9.80 4.44 1/684 11123
start_time: '1689137836'
end_time: '1689138137'
version: "/lkp/lkp/.src-20230711-195224:74f359eb2b1b:3da06bd771bc"
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "page_fault3" "295" "process" "0" "0" "16"

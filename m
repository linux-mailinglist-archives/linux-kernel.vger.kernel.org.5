...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 78CEA79895E
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Sep 2023 16:57:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242302AbjIHO5e (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Sep 2023 10:57:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51654 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238446AbjIHO5d (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Sep 2023 10:57:33 -0400
Received: from mail-pf1-x42f.google.com (mail-pf1-x42f.google.com [IPv6:2607:f8b0:4864:20::42f])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 100D71FDB
        for <linux-kernel@vger.kernel.org>; Fri,  8 Sep 2023 07:57:20 -0700 (PDT)
Received: by mail-pf1-x42f.google.com with SMTP id d2e1a72fcca58-68c0d262933so1856279b3a.0
        for <linux-kernel@vger.kernel.org>; Fri, 08 Sep 2023 07:57:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1694185039; x=1694789839; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:message-id:to:from:cc
         :in-reply-to:subject:date:from:to:cc:subject:date:message-id
         :reply-to;
        bh=FGGiRdYfkUZyzOlEPSHbghN9AhTyjxVY0GEPEQoBbCo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1694185039; x=1694789839;
        h=content-transfer-encoding:mime-version:message-id:to:from:cc
         :in-reply-to:subject:date:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=FGGiRdYfkUZyzOlEPSHbghN9AhTyjxVY0GEPEQoBbCo=;
        b=
X-Gm-Message-State: AOJu0Yy7v0AIY49jYHjAdCuRod6hO6zw9nRGuWv/z4HIvbGQbuf0dyKf
        7krWXHMFQ1q//DJ2Zxjed+Altg==
X-Google-Smtp-Source: AGHT+IF8XjoSbdVATlIkY6oZVodGdB1hBYt3QKNDYqFJ5jLx2gWKi5m2s7SrCLsslOZHTSK3gHOeKA==
X-Received: by 2002:a05:6a00:14c6:b0:68b:e29c:b6a with SMTP id w6-20020a056a0014c600b0068be29c0b6amr2847517pfu.34.1694185039070;
        Fri, 08 Sep 2023 07:57:19 -0700 (PDT)
Received: from localhost ([135.180.227.0])
        by smtp.gmail.com with ESMTPSA id e5-20020a63aa05000000b00553d42a7cb5sm1266613pgf.68.2023.09.08.07.57.18
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 08 Sep 2023 07:57:18 -0700 (PDT)
Date:   Fri, 08 Sep 2023 07:57:18 -0700 (PDT)
X-Google-Original-Date: Fri, 08 Sep 2023 07:57:16 PDT (-0700)
Subject:     Re: [GIT PULL] perf tools changes for v6.6
In-Reply-To: <20230906005330.373916-1-acme@kernel.org>
CC:     Linus Torvalds <torvalds@linux-foundation.org>, mingo@kernel.org,
        tglx@linutronix.de, jolsa@kernel.org, namhyung@kernel.org,
        irogers@google.com, adrian.hunter@intel.com, williams@redhat.com,
        kcarcia@redhat.com, linux-kernel@vger.kernel.org,
        linux-perf-users@vger.kernel.org, acme@kernel.org,
        adityag@linux.ibm.com, akanksha@linux.ibm.com,
        anupnewsmail@gmail.com, atrajeev@linux.vnet.ibm.com,
        james.clark@arm.com, renyu.zj@linux.alibaba.com,
        john.g.garry@oracle.com, kjain@linux.ibm.com, luhongfei@vivo.com,
        mhiramat@kernel.org, tmricht@linux.ibm.com, xiujianfeng@huawei.com,
        alexghiti@rivosinc.com, acme@redhat.com
From:   Palmer Dabbelt <palmer@rivosinc.com>
To:     acme@kernel.org
Message-ID: <mhng-021d3023-ba14-4d68-a89c-a9358b7c6a86@palmer-ri-x1c9>
...
On Tue, 05 Sep 2023 17:53:30 PDT (-0700), acme@kernel.org wrote:
> Hi Linus,
>
...
Sorry again about that, I'd had some email brekages and missed a few 
things.  LMK if there's anything I can do to help sort it out.

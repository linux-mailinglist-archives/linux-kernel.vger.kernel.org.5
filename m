...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1858976E567
	for <lists+linux-kernel@lfdr.de>; Thu,  3 Aug 2023 12:17:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235385AbjHCKRj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 3 Aug 2023 06:17:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52250 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235346AbjHCKQ4 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 3 Aug 2023 06:16:56 -0400
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.154.123])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A25AC3ABE
        for <linux-kernel@vger.kernel.org>; Thu,  3 Aug 2023 03:16:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1691057790; x=1722593790;
  h=from:to:cc:subject:date:message-id:references:
   in-reply-to:content-id:content-transfer-encoding:
   mime-version;
  bh=DpPoYECzCm0Ws3856Av+fd1BjyFMBt3SCgYdU+VVSEw=;
  b=MJd7Mxgre5I1BgUnZTy2DxJNbA/ktmy5p2LrCavBSdA4GcU5e4R9HA1Q
   4/b4S6FxP73gvlmSJY9jsAPae8BMmpmX2zKFuaZwSyVZgaLSrXg291m5h
   /G3Md4cPPaHJe6NfMx68Qq+p6BvGCPrVuDYKgCh2u6LQBUblG4PsbXhnP
   3nzKEmPjQOHYcpMxeL4cWlQqlOvgU4G0UJnsQQ536j7+xUiFWlvI7kN1U
   zNW+IBrmUH+saiMz3QBGrNzMnNRBvVbQ+/k8fTa2y3VMIROmYizIcPQ3P
   BLkOEBXLCoCriTdFekYIcqrWcsjhcJkq3O2K84EKBS8oIo6PRfv77G1BZ
   A==;
X-IronPort-AV: E=Sophos;i="6.01,252,1684825200"; 
   d="scan'208";a="164651612"
X-Amp-Result: SKIPPED(no attachment in message)
Received: from unknown (HELO email.microchip.com) ([170.129.1.10])
  by esa6.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 03 Aug 2023 03:16:29 -0700
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MN2PR11MB4191.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230028)(39860400002)(136003)(346002)(396003)(366004)(376002)(451199021)(2616005)(53546011)(83380400001)(6506007)(26005)(186003)(41300700001)(2906002)(91956017)(66946007)(76116006)(4326008)(64756008)(66446008)(66476007)(66556008)(5660300002)(316002)(7416002)(8676002)(8936002)(6486002)(71200400001)(966005)(6512007)(478600001)(54906003)(110136005)(38100700002)(122000001)(31696002)(86362001)(36756003)(38070700005)(31686004)(45980500001);DIR:OUT;SFP:1101;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 03 Aug 2023 10:15:54.8627
 (UTC)

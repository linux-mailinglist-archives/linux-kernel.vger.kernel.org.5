...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 99F2480A466
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Dec 2023 14:24:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1573821AbjLHNY2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Dec 2023 08:24:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33842 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1573772AbjLHNYZ (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Dec 2023 08:24:25 -0500
Received: from smtp-relay-internal-0.canonical.com (smtp-relay-internal-0.canonical.com [185.125.188.122])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 920FD1997
        for <linux-kernel@vger.kernel.org>; Fri,  8 Dec 2023 05:24:28 -0800 (PST)
Received: from mail-lf1-f71.google.com (mail-lf1-f71.google.com [209.85.167.71])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
        (No client certificate requested)
        by smtp-relay-internal-0.canonical.com (Postfix) with ESMTPS id C931D40A75
        for <linux-kernel@vger.kernel.org>; Fri,  8 Dec 2023 13:24:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canonical.com;
        s=20210705; t=1702041866;
        bh=Mz4Ng/8ff6gsMSmQ6FluBHZZQT3Ql5HF7aZIOQuNwkA=;
        h=From:In-Reply-To:References:Mime-Version:Date:Message-ID:Subject:
         To:Cc:Content-Type;
        b=
Received: by mail-lf1-f71.google.com with SMTP id 2adb3069b0e04-50bf7c5c732so1541939e87.2
        for <linux-kernel@vger.kernel.org>; Fri, 08 Dec 2023 05:24:26 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1702041866; x=1702646666;
        h=cc:to:subject:message-id:date:mime-version:references:in-reply-to
         :from:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=Mz4Ng/8ff6gsMSmQ6FluBHZZQT3Ql5HF7aZIOQuNwkA=;
        b=
X-Gm-Message-State: AOJu0Yz4T8VxrwQnLgllz3nll5d5VPnd31Gg93k1PCZqTA3tCCQqcJ5F
        F7c97m1KQuxmgveMZDnxPuN+756rPzmp0mh/q58vC4sbvJV1DsFbtaHZRBMur03GxyrJ3HnREEw
        tkb7cBVU67Ey6Up8un5c3kVwa5X+/OST0dfX07m9k/By3e1KFR7h0WTCYww==
X-Received: by 2002:a05:6512:3f23:b0:50d:1522:fe93 with SMTP id y35-20020a0565123f2300b0050d1522fe93mr322784lfa.4.1702041865540;

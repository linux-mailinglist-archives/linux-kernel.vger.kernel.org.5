Return-Path: <linux-kernel+bounces-146334-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F7468A639B
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 08:19:34 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 773841C20FD0
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 06:19:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E445F158D98;
	Tue, 16 Apr 2024 06:16:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="Do7awE1o"
Received: from mail-yb1-f201.google.com (mail-yb1-f201.google.com [209.85.219.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A5D9113AA3E
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 06:16:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713248177; cv=none; b=a9mNeGUPCYjgv8/CXAx/ZlhzlJOA64rYXf9Xp6fTo9kg0E5GW9GFCUOa6c6AtigrRhTuGs+zgGDtuikKobIYxh9lqfdrcn66fymGQBNZ8UkVp5X3iF2zKW98jQp0mfI2BEXktrzvB27waUU/J1dC31dsoo7ZWBEMpzkVgglir/I=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713248177; c=relaxed/simple;
	bh=2JLJEqgocioKqNHfii+5wBTOxGZ8Be6F/7ih4JdBn7g=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=q5ttpjQ///RAwlnK+XjjVP7Ez+PbY0CGcnNGuW0qItvNzMls2V5/GGCAoGtgd+OjSmYAUA4r6STX8NOdA5igt1E98AGEVJYAxYjXDh5spxfD5lsLJPsaGRnLH5uqUmEIhksRoQow5Zym9A+3F1gBF4VhDesZtIFghe/Up7kwu80=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=Do7awE1o; arc=none smtp.client-ip=209.85.219.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f201.google.com with SMTP id 3f1490d57ef6-dc746178515so6408036276.2
        for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 23:16:15 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=gmdXM5hWuk31JKHSQhfePomAmthpx27vl44PJ3DD+Zg=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU0C3VWU1uCWgyZeC67T7VGaZ6/EmTSAM+/JuyD5ST2XXEUeEKLKMdSTtfqldW6Y5jNN4SfNfk9KAKNEMLmf1kGsLf/H5UBKjKZlvK3
X-Gm-Message-State: AOJu0Yx3uM4LnYz+HSYbibwUocQ4qpUm6mNZW0RbTHEWoyEP6j+mZKuo
	+20cSihIlOTbC2ey2S7vc4yc0mUbK73cu8HtG/cTRtwtkgC1bM8B/uwa9K4OVThgNS0sVtMH5Tm
	JBvCysw==

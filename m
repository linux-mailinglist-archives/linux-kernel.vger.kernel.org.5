Return-Path: <linux-kernel+bounces-59655-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id CE6BC84F9EE
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 17:47:44 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id F25DC1C2777C
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 16:47:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8AA3412CDAA;
	Fri,  9 Feb 2024 16:41:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="Mxj5VPwJ"
Received: from mail-ej1-f53.google.com (mail-ej1-f53.google.com [209.85.218.53])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4638D12A178
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 16:41:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.53
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707496888; cv=none; b=RhxgbhorCV0aodAy31DM+VZ9ufGKBfb+3ize2jzHPgpY4iM93SVDtiyBsju1G9GeSRNFMOtKvmAl87G/G2bdZq1YDbtsnwNRiem9M5PHsSD9dIeK5mHPBzPmprhs2ZsWe2FeSDYYBmpBQQqxexu7H5YNwhMcdrl0k4vUK2Q+dIE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707496888; c=relaxed/simple;
	bh=DOs/1CT7Q9lpsib1nJw3jvympuQfSrmsd//C5vY6qKY=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=W940SVhg4Xo3yR3mAvL/fsaUwJXYBqcjC50IrzE0+GEjnP0qX1rVKcUWCCzwwbWNpVv9TKefVAp6ChWkygpIAdrm9ST3lBHmpeZjKV4SH2PNlOo92SRA68CH0cFD6X8PJRwkBDT1sL6cDMj6yVICsSaiBV4VSfaKo9/bVcF/iGM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=Mxj5VPwJ; arc=none smtp.client-ip=209.85.218.53
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ej1-f53.google.com with SMTP id a640c23a62f3a-a3c0d92ca8aso38840866b.3
        for <linux-kernel@vger.kernel.org>; Fri, 09 Feb 2024 08:41:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707496880; x=1708101680; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ny55Id8/NqdjgmE7ajAns4TZAdiMo58DOz6DyfWMXq0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ny55Id8/NqdjgmE7ajAns4TZAdiMo58DOz6DyfWMXq0=;
        b=
X-Gm-Message-State: AOJu0YwZAS1C35F51RQi6SA73QtYjM/gbr+nijRvoefWxGrRZ9bqfofj
	P3dfWpmM4dz+qLczEUdllHSiiUdfuLbu9Mw4BhFlIy15+B2SKE2aWFGMah523Um1D9Tth94KiWI
	y
X-Google-Smtp-Source: AGHT+IHhOF0cjve4cSnfXyzbfWQygPkMzTTpXToOMxzisrSf4WkTLPHtFKxHkwzSD3POlhS6P9YbAA==
X-Received: by 2002:a17:906:f348:b0:a38:50f0:bffc with SMTP id hg8-20020a170906f34800b00a3850f0bffcmr1555197ejb.66.1707496879650;
        Fri, 09 Feb 2024 08:41:19 -0800 (PST)
Received: from raven.intern.cm-ag (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id tl27-20020a170907c31b00b00a3bfe97fe27sm477724ejc.218.2024.02.09.08.41.18
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 09 Feb 2024 08:41:18 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v2 35/35] include: remove lots of unnecessary <linux/kernel.h> includes
Date: Fri,  9 Feb 2024 17:40:27 +0100
Message-Id: <20240209164027.2582906-36-max.kellermann@ionos.com>

Return-Path: <linux-kernel+bounces-66599-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id CB074855EDF
	for <lists+linux-kernel@lfdr.de>; Thu, 15 Feb 2024 11:12:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 818D82814BF
	for <lists+linux-kernel@lfdr.de>; Thu, 15 Feb 2024 10:12:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ADF476A339;
	Thu, 15 Feb 2024 10:11:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b="cca/FaGd"
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 58B1369D1B
	for <linux-kernel@vger.kernel.org>; Thu, 15 Feb 2024 10:11:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=60.244.123.138
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707991891; cv=none; b=bBJStd9n1Gt3oRoB2zRXAiJy/3Z20PzPcFpHEuGbEg1R0ixXEB2lLJvQKoekWGyuuL/VBN1cnEZrQ6uANaG3uBlAOx1H+J3yAuvYax2HZ0j+/AVtvHje8C8gVlsuhUcCOisaoCvbNZhlYJUTdxmGP8hcFLTfcvQwbL9oscj6Sx4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707991891; c=relaxed/simple;
	bh=WOIXbX+wuJ6ogAcwT0mrg9zYXOIw3AFkDASGsuN42gc=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=Lm96Q6d31cDYcIRbiG0SHVsUnZbKKeblypDDNQT2GQn9XwDdb7mmlfeWwud4RPRHPqprvwiMbAH05UKfTJMQi5TdUdARbQW26YV+z9Huu2LhzmjISS+8/9hf6hyf1i4haurMNR3Xu3ejCkWG+8g1zkoEpC+Iax91qUee9HGRs04=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com; spf=pass smtp.mailfrom=mediatek.com; dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b=cca/FaGd; arc=none smtp.client-ip=60.244.123.138
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mediatek.com
X-UUID: 937b9668cbea11ee9e680517dc993faa-20240215
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
	h=Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=xmUFyIMD/TgqRbJ7GQkbUHjiBaVTDM/R7c369Zef1g4=;
...
X-CID-O-INFO: VERSION:1.1.37,REQID:eb22be69-f81a-4cb0-b26a-20227e25cbbf,IP:0,U
	RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTIO
	N:release,TS:-25
X-CID-META: VersionHash:6f543d0,CLOUDID:67636b80-4f93-4875-95e7-8c66ea833d57,B
...
X-TM-SNTS-SMTP:
	590B25C83335607A233B4FE573EE9F7EC9BDA74535F899966DD674CB5D6EFD4B2000:8
X-MTK: N

Return-Path: <linux-kernel+bounces-35211-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6F068838DBD
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 12:45:06 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 29A3B28A923
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 11:45:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3665C5D91E;
	Tue, 23 Jan 2024 11:44:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="w+0nof/4"
Received: from NAM04-MW2-obe.outbound.protection.outlook.com (mail-mw2nam04on2059.outbound.protection.outlook.com [40.107.101.59])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 96FF14BAA8
	for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 11:44:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.101.59
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706010289; cv=fail; b=Syw7emwReKAXYHGEnQAYyO/bK9rggDaVxwf0B72z5VN6HvROBcqH5h5/zu8F28JFIGMGBheWR2I7vgv0+zv3RYomH1ghbpMqGjjlV4h4qJHFdN3FCziEL8CoFTCTuuB7fQoSP1mXX7xGiA1FkcsY54AjL0YwYre/18gG9Ifli+o=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706010289; c=relaxed/simple;
	bh=pSjlBX957RaT/o8pOpblKZNc88jjtWxbeU9J6LKIfDM=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=eTAeaYY8ZqGUDw+MTFkit9MWIM+E4ojAEs5wdcCoZjTBKRhUZ+6gYysaPlz+iP8R621BJFPuwSuerQRpdw4P9DszOJPiEbJTIYZ1DQiow+cgyZ6NcarRHdgqDh6YoeuUYCNHUZ708FqxXRH4JHWsDgnf9h+XeRF10K8/BbjeCSU=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=w+0nof/4; arc=fail smtp.client-ip=40.107.101.59
...
Cc: "luto@kernel.org" <luto@kernel.org>,
 ...
 "surenb@google.com" <surenb@google.com>, "Zhu, James" <James.Zhu@amd.com>,
 ...
 "Li, Huazeng" <Huazeng.Li@amd.com>, "Xu, Colin" <Colin.Xu@amd.com>,
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 23 Jan 2024 11:44:45.0473
 (UTC)

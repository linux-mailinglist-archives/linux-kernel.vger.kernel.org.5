Return-Path: <linux-kernel+bounces-78238-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6DF5B861098
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 12:39:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 920341C218F0
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Feb 2024 11:39:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 004A37EEEB;
	Fri, 23 Feb 2024 11:37:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="C52IGamG"
Received: from relay2-d.mail.gandi.net (relay2-d.mail.gandi.net [217.70.183.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A1DDD7C0B7
	for <linux-kernel@vger.kernel.org>; Fri, 23 Feb 2024 11:37:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708688273; cv=none; b=or+HXHEsVw+xIQqqsi+n7Gw4i597K+6X1AzhLwaPd0KUo8Qsm6VNOTZpD3tc6RZ2ypU6tXziwugfwBxhGs3Xu/klQwJxycP++XcqHV5sZpp3eqHeaG/CFrimhNRg+5wJkQTU3asVO1ifxDNbSj1hClGL0xUvk/wh84evuUBMhV8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708688273; c=relaxed/simple;
	bh=CbZDxR4nwp2oYSERstirgHDd1YuaLkkFc3u/TORbVu0=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=nFclv8NXmVHR9wuoTtAvoMddP3wLB6AX2CH93YDigvkuX1uCCXQVJoG1zQzdsM8JjwB2KOWsCeWp9+K8ZAv361ZQS7lKQKyVApczJgdcFFZSqUVE0T6RgbaUJvuYiUHv8g4m6tgA+vJ/ImPJLTOgm6p73hAV/ltNwZ1z9cWQNmw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=C52IGamG; arc=none smtp.client-ip=217.70.183.194

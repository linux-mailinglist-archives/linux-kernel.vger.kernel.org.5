Return-Path: <linux-kernel+bounces-102326-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id B1EC287B0BE
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 20:00:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 207AE1F2406E
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 19:00:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 634415D909;
	Wed, 13 Mar 2024 18:02:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ItqaNtW8"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EFAF65D8FE
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 18:02:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710352925; cv=none; b=gEg7l4cujtM3pqJJN3CZW6xQCIWv8jt31jFlz6kd2NJXQFdb0kMVrDGD5jQcRBsfeuZEtJFOinmq/C/ZyRLS6YdJq7qJrIWZ8Xw/xHlwbQUo6IJHDZ8MBerbmKV6eZpKYHrzdYskXWEf0xwdVv3bT2sBp/7W9e20pizQFFNUd+A=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710352925; c=relaxed/simple;
	bh=YS/A//x6PCebh/TWonZTX7b84I7rd//vuuT12T+EEYU=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=jV4YaKqCpxfZzw+1l/4ABMIqYIBQ08/SRsjbADIoUpi9IYFb8h98ToNE/k5DSYnyY4vT7dokqgHG7Ww8TroUv3C0l0qOiLiyegnsGT3IOWGomwGwJiE6yZFawtb+ePykz3BnWkSenaVE7Hu7XWYu9gFI0UBdZSosKAa5U/gzCrA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ItqaNtW8; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1710352921;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding;
	bh=5UEYdMiZ1vcEMNvAnOtdk4ekyPB3q5c4UPNOfGmqfBI=;
	b=ItqaNtW8AxS3LyJC6GUTlDiQNf18YY1NZk+HGP5B76/68AoTxeFioX3fMlqr46CGNv65RF
	JfksBkAcv70p0KRwGjBk4p9u/ehREIZerbXEgJxdW/RWpbl6RCHCq1CDkZ/Fkq9KRc/6Kk
	rfp6d713wVS8SA+HCzMMQTCrO2URcr0=

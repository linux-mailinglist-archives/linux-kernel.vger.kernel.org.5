Return-Path: <linux-kernel+bounces-160255-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 133748B3AE4
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 17:17:59 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 0BDFA1C2434B
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 15:17:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 240BF149C5E;
	Fri, 26 Apr 2024 15:11:32 +0000 (UTC)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0C475154C02
	for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 15:11:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.140.110.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714144275; cv=none; b=HyowhNRK4v6Ncz7+xbQf1ciIJjmHCg4rl5gDmThNMupjkWWFMpGOaDEFLsKJ5GWNLvdNJNYHwEdkGErP/sIVXMCd5LDmzaldH7dYFr97mLkq9v3w7EpgV92xEAhcCWYjoEBDmxuTPKrYLiWXX1uxbwIhxLgELHfsagkqOa9CVYI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714144275; c=relaxed/simple;
	bh=XA18sHNIjGIeo7LoRO9HU6X9UvBm2oygBjjC0suozCk=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=gv0GabsAXKchIfWzciH67NTW5+xCYMP9hNhgy9Cqqs3LAgjvySACT/z4CRC4RNnFs49xVGnGcRSPq+Kbjc02lAcDg0kFRMdfGHZlRhQEzj7Bf1nK45avyjrjytOO1nA3ohvO9KyOq2iSWooyLkiH+X2+njcYtpGiBrqsdyTjjnc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com; spf=pass smtp.mailfrom=arm.com; arc=none smtp.client-ip=217.140.110.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 6CC891596;
	Fri, 26 Apr 2024 08:11:29 -0700 (PDT)
Received: from e133380.cambridge.arm.com (e133380.arm.com [10.1.197.52])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 1513A3F73F;
...
Subject: [PATCH v2 34/35] x86/resctrl: Move the resctrl filesystem code to /fs/resctrl
Date: Fri, 26 Apr 2024 16:09:03 +0100
Message-Id: <20240426150904.8854-34-Dave.Martin@arm.com>
...
move it to live in /fs/resctrl instead of /arch/x86.
 ...
 * This patch has been manually rebased on top of other changes to the
   series and needs to be rebuilt.

 * Break this patch up into smaller patches, if this can be done
   without adding excessive temporary glue to the constituent patches.

Changes in v2:

 * [Commit message only]: Typo fix:
   s/more it live/move it to live/
---
 ...
 arch/x86/kernel/cpu/resctrl/rdtgroup.c    | 4288 +--------------------
 ...
 11 files changed, 6992 insertions(+), 6885 deletions(-)
...
index e4244e771ef6..8c20bd04b840 100644
...
-
  ...
  *			   return value.
@@ -326,11 +105,7 @@ static inline struct rdt_hw_resource *resctrl_to_arch_res(struct rdt_resource *r
...
-extern struct dentry *debugfs_resctrl;
 ...
 {
@@ -394,95 +169,10 @@ union cpuid_0x10_x_edx {
 	unsigned int full;
 };
...
index 88634a5bef75..02fb9d87479a 100644
...
index 41eea46e62aa..1488d1728f1f 100644
...
index 6de33de5fa9b..061501e9fc98 100644
...
@@ -36,4219 +22,239 @@ DEFINE_STATIC_KEY_FALSE(rdt_enable_key);
...
index e69de29bb2d1..14a9f18efe45 100644
...
index e69de29bb2d1..8b18224eda35 100644

Return-Path: <linux-kernel+bounces-52058-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 63CFB84938D
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 06:52:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B45D7B22363
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 05:52:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3296BDF4A;
	Mon,  5 Feb 2024 05:51:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b="DGnX9ZhC"
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F3851BA34
	for <linux-kernel@vger.kernel.org>; Mon,  5 Feb 2024 05:51:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.61.82.184
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707112297; cv=none; b=TFz3zDfKiFvDPL9c9FWYXp7P/o+mYHx+6bKC9dvi9vmuSni99BdQnihgLnhRx2W2IcmaCEez/JR7/63af9hu13iVVz08oxhRGOIwWgDSfsNL8U4mpvzpPFEudK/dPkR1cwecPEtKlsDLovx+z+HMoakAaSx7DlrNKf1I6xJwVsY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707112297; c=relaxed/simple;
	bh=JU/IvQjOnFY8vCvJTRUhg2kTRWlRNXvfjDxvbgGxSSc=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=RHi4ZTpWrflKo5M0Ace5tJ0DtwB7YWxPGNaWhinuZUjQD/UetFfwd6F4kPpTZv87A0IfGTcVSF3Rlf/+pPzktwdmJSU8jO2PaRSvj8LKsfiuSSg/YogFgq2e5M47wE3+njH7cpxDfcyzpAKjZ1HaDpgXYzbNHUzOUDELBAeXQY0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com; spf=pass smtp.mailfrom=mediatek.com; dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b=DGnX9ZhC; arc=none smtp.client-ip=210.61.82.184
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mediatek.com
X-UUID: 9a7e3ce8c3ea11eea2298b7352fd921d-20240205
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
	h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=rlQwU9Zg/tBUOcU+SUkcgI9wbHYvFigC6czbzDnquWg=;
...
X-CID-O-INFO: VERSION:1.1.37,REQID:b7ee355e-7fcb-4be4-b50d-52dce14efeef,IP:0,U
	RL:0,TC:0,Content:0,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTION:
	release,TS:0
X-CID-META: VersionHash:6f543d0,CLOUDID:03af84fe-c16b-4159-a099-3b9d0558e447,B
...
Subject: [PATCH v2 1/3] Subject: [PATCH] drm/mediatek/dp: Add tee client application for HDCP feature

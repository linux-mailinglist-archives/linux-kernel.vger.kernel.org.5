Return-Path: <linux-kernel+bounces-45172-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id DD0CF842C70
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 20:11:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 0DCF81C2472E
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 19:11:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 39ED24E1B7;
	Tue, 30 Jan 2024 19:10:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b="WvGvl1WY"
Received: from mail-pl1-f172.google.com (mail-pl1-f172.google.com [209.85.214.172])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C9CA67AE45
	for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 19:10:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706641848; cv=none; b=f+TXc/T77nisNsLBtT+cPRsORiFlBQCJwgjKNjNMw1M2gBZ9qjH8KOmu5Mh9iJmvCNSKAoc1Fb1bodgAYOKxQUrI31DIP44gncLIw6DyXGm5vjNpQW7wqgw4Ay6qhGgn/SeecTyGK6jyyXY6mOL7UtkJz01DSGgU1KI/Z4qPncw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706641848; c=relaxed/simple;
	bh=OXkEPeXIkht+YoQng/MxWn1wO8C5MNZ3Ps16D9SQXn0=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=fUnDApkTjIneXPFOerhhRcjqUjkzkK9TRJ7EzOrqpKDl+1Rfzh4OEySpkEuB033ult65e4FTASYYEeZSj4nSrXG1hdG9Ndz9V3jQK614Az5eYiRXivbTmTHDCtfF2O0Xg//Ca434mV7piubapaCmvyYtd/b55sp7a4nGqxKebEc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com; spf=pass smtp.mailfrom=rivosinc.com; dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b=WvGvl1WY; arc=none smtp.client-ip=209.85.214.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=rivosinc.com
Received: by mail-pl1-f172.google.com with SMTP id d9443c01a7336-1d8d747a3bcso1127755ad.0
        for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 11:10:45 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1706641845; x=1707246645; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=pEQy42LHOq7YbLrbYk2Qv5HKcL2FwKHsO0im9ctcd94=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706641845; x=1707246645;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=pEQy42LHOq7YbLrbYk2Qv5HKcL2FwKHsO0im9ctcd94=;
        b=
X-Gm-Message-State: AOJu0YzLVNr2+KXh7vGyKY5L9gTh3y/XyPe4PxFeL2kiI5B70vcAaD9w
	bFC2Qs/M43F4Uh8OkvVyFi0WvozbR7nz+jEAUjU4q4AxOjw6qtqW2/DCkBeMTSA=
X-Google-Smtp-Source: AGHT+IGnt77+CcH63JYSjMsFqEZ7bvYMarKS3Vb+I3NccQhHXy/HcG+l/yIS2sSCl21g3gKh9mN0aA==
X-Received: by 2002:a17:902:bd8b:b0:1d8:d3bf:b367 with SMTP id q11-20020a170902bd8b00b001d8d3bfb367mr1821326pls.29.1706641844891;
        Tue, 30 Jan 2024 11:10:44 -0800 (PST)
Received: from charlie.ba.rivosinc.com ([64.71.180.162])
        by smtp.gmail.com with ESMTPSA id p16-20020a170902ebd000b001d91d515dffsm605340plg.156.2024.01.30.11.10.44
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 30 Jan 2024 11:10:44 -0800 (PST)
From: Charlie Jenkins <charlie@rivosinc.com>
Date: Tue, 30 Jan 2024 11:10:04 -0800
Subject: [PATCH v5 2/2] lib: checksum: Use aligned accesses for
...
Message-Id: <20240130-fix_sparse_errors_checksum_tests-v5-2-4d8a0a337e5e@rivosinc.com>
...
X-Mailer: b4 0.12.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1706641842; l=28008;
 i=charlie@rivosinc.com; s=20231120; h=from:subject:message-id;
 bh=OXkEPeXIkht+YoQng/MxWn1wO8C5MNZ3Ps16D9SQXn0=;
 b=ceme5UTvNJej+Uv2+YRdNBN45gF/sPdU25YYKLipowcMaoZf5bBJNY2tlkWmxtiJimQjfBp9Y
 kBAMZdE6zS+BA7wLSE5PgwgBUiOn8YK1FrOzfyW4xITHK0OcwNCoDrW

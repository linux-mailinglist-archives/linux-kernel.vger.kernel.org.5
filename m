...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 51C9E7634DD
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Jul 2023 13:27:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233699AbjGZL0z (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Jul 2023 07:26:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55876 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233559AbjGZL0i (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Jul 2023 07:26:38 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1803111F
        for <linux-kernel@vger.kernel.org>; Wed, 26 Jul 2023 04:26:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1690370783; x=1721906783;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=fwE+BdRmYqzKBGFKu9HiWcjvyH9bU+8qCE5K/Lp3npA=;
  b=mduPXLJFzjs9l84NP+1ZpWEUHtohdY88sIDyAl/2FVIhJ/ETkoDfaGR0
   eG+5hUXNL4/6bN23SFL0jsliXDkYHZes2BHjL3AjqfqFilgdzAYKpZUFq
   ucwkZU7/FDplkIzr1vxNDlBcePzHQLDHYCy+367ynapJvBArkmsm36wz8
   bpkCXZstZ4uuS6Pl054r7+A/xJ5k5QpNeondsspHcQLFn4pvDKWQJSgkM
   +2TVslNfiy9HXSF6QLlCRbUwyEl+kmc2rhCHjTfqq1hM4/1EXKfxxvO3Y
   6UgIy7mDw+KsIGpkQJdAuHlc9qIe/PpZ56LM2kHdLdICblCJTxRi5tML6
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10782"; a="370664115"
X-IronPort-AV: E=Sophos;i="6.01,231,1684825200"; 
   d="scan'208";a="370664115"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Jul 2023 04:26:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10782"; a="791811084"
X-IronPort-AV: E=Sophos;i="6.01,231,1684825200"; 
   d="scan'208";a="791811084"
Received: from bterry-mobl2.amr.corp.intel.com (HELO khuang2-desk.gar.corp.intel.com) ([10.209.177.246])
  by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Jul 2023 04:26:10 -0700
...
Subject: [PATCH v3 07/12] x86/tdx: Make TDX_HYPERCALL asm similar to TDX_MODULE_CALL
Date:   Wed, 26 Jul 2023 23:25:09 +1200
Message-ID: <6f92d08855491b3e9ff1221d2bb7af873d546afd.1690369495.git.kai.huang@intel.com>

Return-Path: <linux-kernel+bounces-121337-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 89CB788E632
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 15:34:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 40FDA2C1885
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 14:34:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1B9FC154427;
	Wed, 27 Mar 2024 13:05:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="MzXnqu6X"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C35F153BDB
	for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 13:05:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711544756; cv=none; b=NJcgp7q1QRMzO99P2Ub4RyQi694SNQum9hl+zLYoGjMfRdnHLabrL/4XMsLy3aFAoURI+DZVEzkzgwnOpmLMyLzPMvsnTqT/TVIL1l4I21l8OPgvt98BlVECxXIhMZ8W5FUuglWQaF8NEvbiE2qv+djJPaqZnHiR+sFGcEvdpv0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711544756; c=relaxed/simple;
	bh=evlZdisq7TKOJmTFWXSmuadHJ8cfGsrgUzSq3GdMWhs=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=DJXVet2cxLbBZ5BUIjy9PbBe7muBdn5ha0rvUGWJxSNleyHWQ7yn+wfF5b+H2HC/aY2E1wu6pgXOfKXNgvZKep8tQjbj73TJV6qhhEYdLyQKamcj8Dao4++xOkTMrhN0AAMJTer+x16dqq7cgJpvSl/jCZGhEzclP8D/BXN9IhY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=MzXnqu6X; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1711544753;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=Wr/7P5MDZH94eJfpoOo+cCo9qaR41n51SmrVumS+No0=;
	b=MzXnqu6X303CczXiW5jTyAVe1DrtRoXxz8trXN9jahoKlfGB4tNZh5C0o4NIJF/RLbx2ao
	jt5qV4c8pm3SqKnkqAn2O4nw5LIsNibRc/QhBelLozhrRqgXT4bvlBAS2/h0Af2pkG1n/q
	4QbsYEHl7/hXASjFU+BUWA17NaNFM8g=

Return-Path: <linux-kernel+bounces-135996-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 4897989CEB4
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 01:06:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id F37512840AC
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 23:06:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4FD0B143C65;
	Mon,  8 Apr 2024 23:06:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="uXu/kHVb"
Received: from mail-pl1-f201.google.com (mail-pl1-f201.google.com [209.85.214.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1FF5F127B5A
	for <linux-kernel@vger.kernel.org>; Mon,  8 Apr 2024 23:06:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712617585; cv=none; b=fgBLrMnP8Z4kwovlaH/INvcfFHC2HdUpFRp5jSB1WoIQAt0kJS6LczgpTi5EDHxDjsLcowFRVzxLHgwu9O377DagKUtyU03x9w764BkSFkOkn1/5NgG8+bJeSYcrXi/HxH+Pu8vdLB1wUsj9iILCoofF8wSRQF3frg0LeSzDo7A=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--seanjc.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=uXu/kHVb; arc=none smtp.client-ip=209.85.214.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--seanjc.bounces.google.com
Received: by mail-pl1-f201.google.com with SMTP id d9443c01a7336-1e2a1619cfcso38652865ad.0
        for <linux-kernel@vger.kernel.org>; Mon, 08 Apr 2024 16:06:23 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=AzGg/0EymHzkfd/vQ5f3X3kSeFagpEymNquXWZZ9WTc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVcigci+LPzl6frTCdJgTna4iPVZUVssct/K1bdS49Xt8nyzDhnssNI6aJdb53704za8+z8oqKBj2V//taxECDnFjUVKo5rvpefvJ5l
X-Gm-Message-State: AOJu0YzWUCMvMdc3ah155DtszIqs+OYuDdmBS4fEMeBylDvrREPtdO0l
	BoFgc5N6scMm47eHm5hMgjVgTqDfP+DQCkraDbOjR7hDmuS2ftMOMjSMF9LVk+7qWgVTjKJv0yM
	TUA==

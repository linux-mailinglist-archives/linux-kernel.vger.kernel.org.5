...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BC7077E641A
	for <lists+linux-kernel@lfdr.de>; Thu,  9 Nov 2023 08:01:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232598AbjKIHBA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 9 Nov 2023 02:01:00 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50576 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230300AbjKIHAz (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 9 Nov 2023 02:00:55 -0500
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2072.outbound.protection.outlook.com [40.107.244.72])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 366F92D4F
        for <linux-kernel@vger.kernel.org>; Wed,  8 Nov 2023 23:00:53 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=F+YNQZu7nMRY046L//iSEe9Rv3xg5jrNTdXQTOKvDqQ=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=F+YNQZu7nMRY046L//iSEe9Rv3xg5jrNTdXQTOKvDqQ=;
 b=rTlD9gMO69JMtWcx2mjXBkuZhbP2lArkHJOiVKVJs0/TeRLZki9dImbwWR/YHYx/NNH7XSwmtzhCKO89HMj+5NbWeXjg69Y25qMGYfEIneOGt9eLM3qzImnElBG6iE/l0q+j0LIEjE0InLlCS7vz3jnGNUslPaF5iT/CAoITC0s=
...
Received: from CO1PEPF000044FB.namprd21.prod.outlook.com
 (2603:10b6:907:1:cafe::6b) by MW2PR16CA0066.outlook.office365.com
...
Received: from SATLEXMB03.amd.com (165.204.84.17) by
 ...
 15.20.7002.1 via Frontend Transport; Thu, 9 Nov 2023 07:00:48 +0000
...
Received: from xsjarunbala50.xilinx.com (10.180.168.240) by SATLEXMB03.amd.com
 ...
 Transport; Thu, 9 Nov 2023 01:00:44 -0600
...
Subject: [PATCH v4 1/5] firmware: xilinx: Update firmware call interface to support additional args
Date:   Wed, 8 Nov 2023 23:00:17 -0800
Message-ID: <20231109070021.16291-2-jay.buddhabhatti@amd.com>
...
X-MS-TrafficTypeDiagnostic: CO1PEPF000044FB:EE_|LV2PR12MB5824:EE_
X-MS-Office365-Filtering-Correlation-Id: 785e8c08-e007-439d-c0a5-08dbe0f19aa2
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:165.204.84.17;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:SATLEXMB03.amd.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230031)(4636009)(376002)(136003)(396003)(39860400002)(346002)(230922051799003)(82310400011)(64100799003)(451199024)(1800799009)(186009)(46966006)(36840700001)(40470700004)(40480700001)(40460700003)(47076005)(36860700001)(83380400001)(86362001)(36756003)(8936002)(44832011)(41300700001)(4326008)(2906002)(15650500001)(8676002)(30864003)(921008)(336012)(426003)(6666004)(110136005)(478600001)(356005)(316002)(6636002)(81166007)(82740400003)(5660300002)(70586007)(26005)(54906003)(70206006)(2616005)(1076003)(36900700001)(83996005)(2101003);DIR:OUT;SFP:1101;
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Nov 2023 07:00:48.7748
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 785e8c08-e007-439d-c0a5-08dbe0f19aa2
...
index b0d22d4455d9..7cf056451a26 100644
...
index d1ea3898564c..9e923e55f5d1 100644

Return-Path: <linux-kernel+bounces-96287-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 111B08759C1
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 22:47:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B92C6287D30
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 21:47:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2CEE1140E34;
	Thu,  7 Mar 2024 21:46:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="dt8PbyM+"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.16])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 817B014039D
	for <linux-kernel@vger.kernel.org>; Thu,  7 Mar 2024 21:46:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.16
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709847969; cv=fail; b=fo4GbNNR7q44L4w/4yu1X/MD2PzqCHpGrXcxbXDT0Z+HXPSCiPI6haWR927kTvIF3u1bR9BWK+UgRp4MMj0nQtOu1qHeEL/zhIEIdie1Yy3iiYYv8t7mmPFwrURMJnOx5K7gkcnZhXYQm1elwJ7hvAJ4yERtwaQo9i+ZobUdZrc=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709847969; c=relaxed/simple;
	bh=mpYNyOhcfQ3l/JjKxTixECoVGkpEQfohqxtOszOcCPI=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=BMSyCcW2o3rikJ2+Gmw47Gkc+gTLkVmvHFa3oUO2Ym/+ZizObSSeSI4hWET4eX1TlwVkglqqvJ71rEcm3Z6MtLL7IypHA9TBwuPO6pk3XF9pR9rJKZtNgN6aV19HxGs2aMhtG0acytzvPYa11+S2w+FFsawPQpoLkEWbjt/dtko=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=dt8PbyM+; arc=fail smtp.client-ip=192.198.163.16
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=dt8PbyM+VOhML/OOiT2+4schCkCjMBaP28jVALABg438bdqIT8pzwQy4
   ...
   pQXSPpnBaopGR/cIcEOSWXx3ub2T6YazCjGEDPlaF7kaJZsqAiiklTyfE
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,11006"; a="5141812"
X-IronPort-AV: E=Sophos;i="6.07,107,1708416000"; 
   d="scan'208";a="5141812"
Received: from orviesa006.jf.intel.com ([10.64.159.146])
  by fmvoesa110.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Mar 2024 13:46:02 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,107,1708416000"; 
   d="scan'208";a="10661367"
Received: from orsmsx601.amr.corp.intel.com ([10.22.229.14])
  by orviesa006.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 07 Mar 2024 13:46:02 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 07 Mar 2024 21:45:58.6978
 (UTC)

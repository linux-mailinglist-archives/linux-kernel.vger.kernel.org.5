...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 63BE37C782B
	for <lists+linux-kernel@lfdr.de>; Thu, 12 Oct 2023 22:54:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1442748AbjJLUxv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 12 Oct 2023 16:53:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51212 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347397AbjJLUxu (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 12 Oct 2023 16:53:50 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1DA7BD8
        for <linux-kernel@vger.kernel.org>; Thu, 12 Oct 2023 13:53:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1697144029; x=1728680029;
  h=message-id:date:mime-version:subject:to:cc:references:
   from:in-reply-to:content-transfer-encoding;
  bh=tlHU+qyH4HPMXXzF01oswP1uhj0qbzGbfJXKzg0lJyg=;
  b=aUoPDAsHfvZc1b7GVXUez4bWKP9JjU+KrUFT3ocGOVIXEH8crwjuzsJX
   jCd7UuJeHc+NwukpN3d2s2P0UWybI75OHD5mIUK0iVLLg+VbtRAfi1WPS
   TcyDlWmmsS/pnv4kH2POKwIEshI3C2gYUuWmcdAaUh/P4IemGlpzI8G5n
   1fikNnOx+O8raTW0DFXsPKYyqmx+ShOaDh/nDOhSjo0Eb/nRNHdfL+10u
   HEhu2H5/FfOwIjZALiA4xRTjzrr0bYD+VHfykueKRLDsj0eKNy5/sybzX
   WRGT3Xd4+sOAxg6yMdk8l4XM+nN3qN2UDMKm1yeRCsjd00g+6WCzrEunq
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10861"; a="364402840"
X-IronPort-AV: E=Sophos;i="6.03,219,1694761200"; 
   d="scan'208";a="364402840"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Oct 2023 13:53:48 -0700
X-ExtLoop1: 1
...
Received: from aarka-mobl.amr.corp.intel.com (HELO [10.209.59.94]) ([10.209.59.94])
  by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Oct 2023 13:53:48 -0700

Return-Path: <linux-kernel+bounces-34960-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A0AF18389DD
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 09:59:58 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C50E11C2341C
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 08:59:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1737C58102;
	Tue, 23 Jan 2024 08:59:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="KfB2TZ96"
Received: from mail-wm1-f49.google.com (mail-wm1-f49.google.com [209.85.128.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B89CC57300
	for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 08:59:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706000386; cv=none; b=cwJ+rfFRUkdtxw5NGL3uPHeYSyRgEYcfHL6yZsPP7S/n6x+wkgzwULKWlFVtc7j7aJp+isIgqVL/ldcBIYEJY19pcKGokQM7PNIOMtOi7gNhQMGNy6z5mVihacOfcWU3/Rk1Sb0An09AJmX5I+peqS+KKuTSQ4LtZjfzEzGW8BI=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=KfB2TZ96; arc=none smtp.client-ip=209.85.128.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-wm1-f49.google.com with SMTP id 5b1f17b1804b1-40e913e3f03so51523925e9.3
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 00:59:44 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=9U30og0hu8i4oPLnJ1qghUjw2wEDIj1e74P1+b3Sa/k=;
        b=
X-Gm-Message-State: AOJu0Yy8J6j6Rg3XPfP3bjHoPD12hHNLIcg/p7NB5scywra/VQ9ZY31w
	6HsWZWWn6GYKdHz+HcS2nDZa57+xec8C7rGQ1FOEmVhW09340K5fiu37LO3DV/g=

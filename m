Return-Path: <linux-kernel+bounces-134977-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 7F52289B986
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 09:59:13 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9CAB21F2133A
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 07:59:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 705E5482E5;
	Mon,  8 Apr 2024 07:57:23 +0000 (UTC)
Received: from laurent.telenet-ops.be (laurent.telenet-ops.be [195.130.137.89])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C21EA47F4A
	for <linux-kernel@vger.kernel.org>; Mon,  8 Apr 2024 07:57:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.130.137.89
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712563036; cv=none; b=MXJ4PRdUKeGUAg1BNZn4lsePdp0E4684TlK8ezDXjiH8Yo6Ze6N/xShN0Lejb59M6pM6nrE6x3Gd1AtDQT7EvL9ESWL11ulfE5L7K/mUgufnT53OefgVtNkZ3Q1k/Eoudagl0xuu8ICtJz3msl59HKIlh/YcM39IvkVxtpRRp4Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712563036; c=relaxed/simple;
	bh=V+I2UgEjLGp+EhkRWgSslAx7mrP5O+/1cCqsL8Q3ZAQ=;
	h=From:To:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=ed1PvBPlpyFljkZ2cjewLDo9Q4zyhkrfVI3aPDGSc/4KRZRxj9IF9i9IBTI83i5y4sY1/udiFjVKOYL/n2PzInejW+g2/CQ44FSavtUARZ6bVC7SLKPYBRukr2rIMuSc/qdySfFVQ4xk0FdTnUu5ih2a7Z6mwLmqgyizN506Jaw=
...
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed80:76d0:2bff:fec8:549])
	...
	id 8Xwz2C00q0SSLxL01XwzLj; Mon, 08 Apr 2024 09:57:00 +0200
Received: from rox.of.borg ([192.168.97.57])
	by ramsan.of.borg with esmtp (Exim 4.95)
	(envelope-from <geert@linux-m68k.org>)
	id 1rtjrg-00ADRi-Of
	for linux-kernel@vger.kernel.org;
	Mon, 08 Apr 2024 09:56:59 +0200
Received: from geert by rox.of.borg with local (Exim 4.95)
	(envelope-from <geert@linux-m68k.org>)
	id 1rtjp0-00ATIv-Oa
	for linux-kernel@vger.kernel.org;
	Mon, 08 Apr 2024 09:53:42 +0200
From: Geert Uytterhoeven <geert@linux-m68k.org>
To: linux-kernel@vger.kernel.org
Subject: Build regressions/improvements in v6.9-rc3
Date: Mon,  8 Apr 2024 09:53:42 +0200
Message-Id: <20240408075342.2495918-1-geert@linux-m68k.org>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <CAHk-=whDuqyVC6xMkOnNt2EeTd-s4uqa3sYghj5UzkELFW2bpw@mail.gmail.com>
References: <CAHk-=whDuqyVC6xMkOnNt2EeTd-s4uqa3sYghj5UzkELFW2bpw@mail.gmail.com>
Precedence: bulk
...
9 error regressions:
  ...
  + error: arch/sparc/kernel/signal_32.o: relocation truncated to fit: R_SPARC_WDISP22 against `.text':  => (.fixup+0x20), (.fixup+0x18), (.fixup+0x8), (.fixup+0x10), (.fixup+0x0)
  ...
  + {standard input}: Error: invalid operands for opcode: 606 => 610, 1099
  + {standard input}: Error: pcrel too far:  => 572, 579, 570, 563, 552, 561, 545, 590, 588, 554, 581, 543

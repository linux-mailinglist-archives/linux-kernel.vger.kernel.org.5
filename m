Return-Path: <linux-kernel+bounces-160802-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F4E18B4309
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 02:10:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id D92221F23966
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 00:10:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0FEA4817;
	Sat, 27 Apr 2024 00:10:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="TNq03HK6"
Received: from mail-pl1-f202.google.com (mail-pl1-f202.google.com [209.85.214.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 189341C3D
	for <linux-kernel@vger.kernel.org>; Sat, 27 Apr 2024 00:10:12 +0000 (UTC)
...
Received: by mail-pl1-f202.google.com with SMTP id d9443c01a7336-1e2a1619cfcso23722815ad.0
        for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 17:10:12 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=pX3e6V8dfSE3Gfut3DvSdpkoJdELEXC0BtcZAcuIozM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXUpGplmVTr8CrBpC+QRKRHORZnD0nBSzeny0FoebU4RH3Ni8dX6ce1pEhp1IoVUi5kdkGxkQKvApe3C30rcuqlbdwDai08mjK0fG0o
X-Gm-Message-State: AOJu0YxQpYIbSLnqTxGKY1BKd9aPcghUWijudyYflo1p3z7lc+TJtogq
	+0AVFPG4ziKbY9kyanKe6vvt1rypjGIWGJ2MZ2msf2GnlvTi8fa86HbkjCiaxOvVHKJ9VC1WWdI
	InQ==

Return-Path: <linux-kernel+bounces-73106-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6218D85BDA6
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 14:52:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 86F0F1C217E4
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 13:52:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7D3246BB27;
	Tue, 20 Feb 2024 13:50:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="Jtc3W6Lw"
Received: from NAM10-DM6-obe.outbound.protection.outlook.com (mail-dm6nam10on2073.outbound.protection.outlook.com [40.107.93.73])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9C6F4612C0
	for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 13:50:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.93.73
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708437017; cv=fail; b=eUrX0erl92Tf4imVF5i46lWGz3baOMhuy5qWKjkD/dGyiQuHGUlSPcykmS3GYjIdnpSfJoZ+hSDnqJtniLuvylYjiU63FlO8WJB4MwoxjbIHXoAcTKuc/kexmPF3tT4p5hXZCGnDHbLT02N8kfmBN9mfi0edGsUVbsIdqHBIE20=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708437017; c=relaxed/simple;
	bh=Q7XGi2gYIUbxHCKNUokd48MoXkJ+llzoiAI1c1OuxBI=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=sHmYxQfjUXB/mwKaDuE84cTPAiHlak6X0uKUEt7i+6Sw3Bq904fv9knmyey7L14LSFcpgBgVfKg7y+Zpa4m+IDj08aip9/WtSZeqPjM365kzzKrotEXFDrZaQhrgG5C+e1WEWeTWkYdQ/CnA58gHTO2tRV3zRlNgbS9xAnSNeCY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=Jtc3W6Lw; arc=fail smtp.client-ip=40.107.93.73
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 20 Feb 2024 13:50:11.6028
 (UTC)

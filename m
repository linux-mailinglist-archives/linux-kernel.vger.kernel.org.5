Return-Path: <linux-kernel+bounces-58710-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 88DD184EA5C
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 22:23:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A5970B2BD8F
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 21:23:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9593C5025F;
	Thu,  8 Feb 2024 21:22:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="VaERUpEW"
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.20])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DCEA24F8BF
	for <linux-kernel@vger.kernel.org>; Thu,  8 Feb 2024 21:21:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=134.134.136.20
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707427320; cv=fail; b=j2yXlMzqNtzSRvmUlIiZY+of05DjzHbyIbdoC/hnhi1tEiIyBls/ARUJZHDZ0RL7x8aCwr+myTxhlpT+vm3ZkoyTuKAaJyZisrHusZ2QHUsFh373gUmROU9emqeYsVPFlf2zuJ7I+rogSYoJld8rCMyDNlkc5b1uYoMYNI7pyFA=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707427320; c=relaxed/simple;
	bh=ecp30BrwqlFlYVqY1hrY7I4AlQAD72cNGQD3FsGiMIk=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=XW8nDtvCuRQLKYSAIic4IRLu5e5SXP7pRV6xbc6vkuG6h1rjXVQXs7AJHE3Xspk6obC8lWpgz0mNrTAAJsrkSA7GkJ6IUDMrbtQgGzikggIN7b0hlBA3cZkcLPamfYi/Iypl5I0utcN9HhPfqAXdjcqtyy4K3+6pJbvi3XUiCQ4=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=VaERUpEW; arc=fail smtp.client-ip=134.134.136.20
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=VaERUpEWOWV29z7GSpF4Uzz4Z1r023mml1S0wRpTSlpFIVJU4yNV51Dm
   ...
   fpaW6MhdZUNhho5DV14ykgzFloabrJxLLE8skL8vvvxif8UMemuO5qse4
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10978"; a="395738738"
X-IronPort-AV: E=Sophos;i="6.05,254,1701158400"; 
   d="scan'208";a="395738738"
Received: from orviesa003.jf.intel.com ([10.64.159.143])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Feb 2024 13:21:58 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,254,1701158400"; 
   d="scan'208";a="6429389"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
  by orviesa003.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 08 Feb 2024 13:21:58 -0800
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:CY5PR11MB6139.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(7916004)(366004)(346002)(396003)(376002)(39860400002)(136003)(230922051799003)(1800799012)(451199024)(186009)(64100799003)(82960400001)(86362001)(316002)(66556008)(54906003)(66476007)(66946007)(6916009)(478600001)(4326008)(6486002)(8936002)(5660300002)(8676002)(2906002)(4744005)(38100700002)(9686003)(6512007)(6666004)(6506007)(26005)(33716001)(41300700001);DIR:OUT;SFP:1101;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Feb 2024 21:21:41.4365
 (UTC)

Return-Path: <linux-kernel+bounces-90817-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 67DF1870568
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 16:29:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B5C9FB23F96
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 15:29:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 51CB9482D4;
	Mon,  4 Mar 2024 15:28:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="JlGGxYRv"
Received: from relay1-d.mail.gandi.net (relay1-d.mail.gandi.net [217.70.183.193])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 46DC646B9A
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 15:28:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.193
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709566120; cv=none; b=kUjj7OA1HpuXTDeNpnpmE2UHb8JEhc8gFd/XcJiDOaPWv8d7kTCHJdx27xT8bb5CbRxtwCsExKKO431mWyFYVrpDoGHiiM1+h+xLXvwaLE1KVk807QDFlbDB3lsB4bheg92AaYwt+F4Tb+ncCy96wU1M3CdU44zJIiB4tVvKzsM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709566120; c=relaxed/simple;
	bh=Qs67fB4YiMfE6d4Nb8131YIF1tQRmf7K7VivhFj3p0c=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=fm48tmQ3ZYgLpRy4WxvfkOUM7Ke0fSuac1PhluZjdrSez05toiFK+eSCk/zn59uZcYsKNKziUL1gIKmIAR1ici6Vb5mZrRXk0ogE3GAfR5iUyfBMbIzrdRb0bO+on65U+EYex80QCjQRGUeiGqCekcn+uokt771Z+LInEUWCgRM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=JlGGxYRv; arc=none smtp.client-ip=217.70.183.193

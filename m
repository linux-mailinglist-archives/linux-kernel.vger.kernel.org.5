Return-Path: <linux-kernel+bounces-51824-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id E815A848FB8
	for <lists+linux-kernel@lfdr.de>; Sun,  4 Feb 2024 18:29:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 525BAB211E5
	for <lists+linux-kernel@lfdr.de>; Sun,  4 Feb 2024 17:29:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E54982C692;
	Sun,  4 Feb 2024 17:27:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="RI7wviJL"
Received: from mail-pj1-f51.google.com (mail-pj1-f51.google.com [209.85.216.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 80511249ED
	for <linux-kernel@vger.kernel.org>; Sun,  4 Feb 2024 17:27:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.216.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707067644; cv=none; b=kBWIFF7wpoCP2o/h36F9KL3ilhTBF9T/oS4niqpqoBGdFutQalGctZMvjoOc2Js1oQWSqe6m9MZpbrtt5kEJsU/dbBDoT9m/LpAmzwkSZQTfR2Z5Z+8HTLwng56nj8X4esWMGUGB22Bhd9fVe6wDOIEKjxM5M3eZANNtmso4xmQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707067644; c=relaxed/simple;
	bh=g+N4/pMex2OTpuBt4zmnLUgV3OED5BC0EvFdxFGHW1w=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=mniwAevedqgPSWm/JpfBsB8KOdPEaQvicwTeFr39vOz+AKKFdn5/EBAM4MkeOaQgfU84bjR9YAoRRdAIxuqam8wRB4S3tDqrCbpvn5C+3fb8AGNA1Yupl8sLjWxdNMfS/Fmhf/NoSZkKPkLaPvWs2N9Wq6/KFsiMDXVgzFQgKkY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=RI7wviJL; arc=none smtp.client-ip=209.85.216.51
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pj1-f51.google.com with SMTP id 98e67ed59e1d1-29631796acdso1545062a91.3
        for <linux-kernel@vger.kernel.org>; Sun, 04 Feb 2024 09:27:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1707067641; x=1707672441; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=n2HlygMGJvu57dPMbRKdjN2IB+zaU4AibnyroDvDzrY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707067641; x=1707672441;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=n2HlygMGJvu57dPMbRKdjN2IB+zaU4AibnyroDvDzrY=;
        b=
X-Gm-Message-State: AOJu0Yx6bPA7XBOT7MSWEUEKWtE+lzdtJl6hdrr1u6syIEZ5rbS+M7Ym
	FxuEwdGdDLzYgBCmg8S7dZM8HwNjl2HV95pGTAS/ByPAHYkcODuzInMLE+qpLBRzmJl4W9B8vC0
	6ZnKVj5OQ+Hz+lUZugWBgoyAPb40=
X-Google-Smtp-Source: AGHT+IEzabM8Y+02GEZA7S76FsHOqIIfSkRJLmyWZZAXnLoH16P3cxcbFZTHvZnnBNcyjaX8bJobq17h18SNoFYbCvI=
X-Received: by 2002:a17:90a:17a6:b0:296:14e5:1423 with SMTP id
 q35-20020a17090a17a600b0029614e51423mr9487157pja.13.1707067640232; Sun, 04
 Feb 2024 09:27:20 -0800 (PST)
Precedence: bulk
...
Date: Sun, 4 Feb 2024 18:27:07 +0100
Message-ID: <CADo9pHgL0MSRexxT18_f52V-L85eiOa+LwFABCT8c6C86a1HCQ@mail.gmail.com>
...
Compiled it on a Dell Latitude 7390 with a Intel(R) Core(TM) i5-8350U
CPU @ 1.70GHz using Arch Linux Following these instructions:
https://wiki.archlinux.org/title/Kernel/Traditional_compilation
and it works :)

Tested by: Luna Jernberg <droidbittin@gmail.com>

Den s=C3=B6n 4 feb. 2024 kl 13:39 skrev Linus Torvalds
...
>
> Andrew Halaney (1):
>       MAINTAINERS: Drop unreachable reviewer for Qualcomm ETHQOS ethernet=
 driver
>
> Andrew Lunn (1):
...
>
> Audra Mitchell (1):
>       selftests/mm: Update va_high_addr_switch.sh to check CPU for la57 f=
lag
>
> Badal Nilawar (1):
...
>       ext4: regenerate buddy after block freeing failed if under fc repla=
y
>       ext4: avoid bb_free and bb_fragments inconsistency in mb_free_block=
s()
...
>       selftests: forwarding: List helper scripts in TEST_FILES Makefile v=
ariable
>
> Benjamin Tissoires (4):
>       selftests/hid: wacom: fix confidence tests
>       HID: bpf: remove double fdget()
>       HID: bpf: actually free hdev memory after attaching a HID-BPF progr=
am
...
>       dmaengine: fsl-qdma: Fix a memory leak related to the status queue =
DMA
...
>
> Damian Muszynski (1):
>       crypto: qat - fix arbiter mapping generation algorithm for QAT 402x=
x
>
> Dan Carpenter (5):
...
>
> Daniel Golle (3):
>       net: ethernet: mtk_eth_soc: set DMA coherent mask to get PPE workin=
g
...
>       mm/memory: fix folio_set_dirty() vs. folio_mark_dirty() in zap_pte_=
range()
>
> David McFarland (1):
...
>
> Frank Li (1):
>       dmaengine: fix is_slave_direction() return false when DMA_DEV_TO_DE=
V
>
> Friedrich Vock (1):
...
>       hwmon: gigabyte_waterforce: Fix locking bug in waterforce_get_statu=
s()
>
> Heikki Krogerus (1):
...
>       parisc: Prevent hung tasks when printing inventory on serial consol=
e
>       parisc: Drop unneeded semicolon in parse_tree_node()
>       ipv6: Ensure natural alignment of const ipv6 loopback and router ad=
dresses
...
>
> Ian Rogers (6):
>       perf list: Switch error message to pr_err() to respect debug settin=
gs (-v)
...
>
> Israel Rukshin (1):
>       nvme-rdma: Fix transfer length when write_generate/read_verify are =
0
>
> Ivan Orlov (1):
...
>       io_uring/net: fix sr->len for IORING_OP_RECV with MSG_WAITALL and b=
uffers
>
> Jingbo Xu (1):
...
>
> Jos=C3=A9 Relvas (1):
>       ALSA: hda/realtek: Apply headset jack quirk for non-bass alc287 thi=
nkpads
>
...
>
> Kai-Heng Feng (1):
>       HID: i2c-hid: Skip SET_POWER SLEEP for Cirque touchpad on system su=
spend
>
> Kailang Yang (1):
...
>       ext4: remove unnecessary parameter "needed" in ext4_discard_preallo=
cations
...
>
> Krishna Kurapati (1):
>       usb: gadget: ncm: Fix endianness of wMaxSegmentSize variable in ecm=
_desc
>
...
>       HID: nvidia-shield: Add missing null pointer checks to LED initiali=
zation
>
> Lang Yu (1):
...
>
> Lennert Buytenhek (1):
>       ahci: Extend ASM1061 43-bit DMA address quirk to other ASM106x part=
s
>
> Leonard Dallmayr (1):
...
>       batman-adv: mcast: fix memory leak on deleting a batman-adv interfa=
ce
...
>       regulator: pwm-regulator: Add validity checks in continuous .get_vo=
ltage
...
>       kconfig: initialize sym->curr.tri to 'no' for all symbol types agai=
n
>
...
>       xhci: process isoc TD properly when there was a transaction error m=
id TD.
>
> Mathieu Desnoyers (1):
...
>
> Oliver Neukum (1):
>       USB: hub: check for alternate port before enabling A_ALT_HNP_SUPPOR=
T
>
> Ondrej Mosnacek (2):
...
>       netfilter: nf_log: replace BUG_ON by WARN_ON_ONCE when putting logg=
er
...
sion
>       ASoC: cs35l56: Firmware file must match the version of preloaded fi=
rmware
...
>       NFSv4.1: Assign the right value for initval and retries for rpc tim=
eout
>
> Samuel Holland (1):
...
>
> Sidhartha Kumar (1):
>       fs/hugetlbfs/inode.c: mm/memory-failure.c: fix hugetlbfs hwpoison h=
andling
>
> Simon Horman (1):
...
>       hv_netvsc: Fix race condition between netvsc_probe and netvsc_remov=
e
>
...
>       eventfs: Warn if an eventfs_inode is freed without is_freed being s=
et
...
>       perf tools: Fix calloc() arguments to address error introduced in g=
cc-14
>
> Szilard Fabian (1):
...
>       usb: core: Prevent null pointer dereference in update_port_device_s=
tate
>
> Uttkarsh Aggarwal (1):
>       usb: dwc3: gadget: Fix NULL pointer dereference in dwc3_gadget_susp=
end
>
...
>
> Zach O'Keefe (1):
>       mm/writeback: fix possible divide-by-zero in wb_dirty_limits(), aga=
in
>
> Zhang Bingwu (1):

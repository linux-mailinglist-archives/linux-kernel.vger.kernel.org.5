Return-Path: <linux-kernel+bounces-41365-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id AF0A383EFB3
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Jan 2024 20:22:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 286BE1F239B3
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Jan 2024 19:22:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0B0242E41C;
	Sat, 27 Jan 2024 19:22:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="XGq+pZJW"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D288CB665;
	Sat, 27 Jan 2024 19:22:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706383327; cv=none; b=o+xuA7z7F+okMbDel5WuwoLDND4PviHJ7H5rv/mw2VrGP7lHjpr7OuUtPLszMipnhAImc2Daz0tIcYZcLhr5W4YedLB3t2ioLQ743tJCNyDbmE54U/fruxOar4LYkKMSW9c/aqTIS0W/YbJ2dK8L2a60XyAfYNtKzAG6VcudPII=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706383327; c=relaxed/simple;
	bh=xmm7ifeGqDmVqZyF8BGNifLeNxrIoJFPqcRMveTbKL4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=AKiKAyGV7nXdpBP4DOqVVBpwfaGi1bQ3O99P3pvKj9Hb+3U8xewL1D4lIhEag5guAIc9X88kzWrSV33B8m//UsafnV/XCtpay9TRGx5R8X7y3EgTgpmQokbzf/Cx18au5idkqHG16/0FxOefvJhjcFnns1rXPVJk8vz+1GpR5ko=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=XGq+pZJW; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 33237C433F1;
	Sat, 27 Jan 2024 19:22:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1706383327;
	bh=xmm7ifeGqDmVqZyF8BGNifLeNxrIoJFPqcRMveTbKL4=;
	h=Date:From:To:Cc:Subject:Reply-To:References:In-Reply-To:From;
	b=
Received: by paulmck-ThinkPad-P17-Gen-1.home (Postfix, from userid 1000)
	id BE3E9CE0898; Sat, 27 Jan 2024 11:22:06 -0800 (PST)
Date: Sat, 27 Jan 2024 11:22:06 -0800
...
Subject: Re: [RFC PATCH] kprobes: Use synchronize_rcu_tasks_rude in
 kprobe_optimizer
Message-ID: <d7cb96d8-86e1-423d-a135-46b4e472fe9e@paulmck-laptop>
...
In-Reply-To: <29eaed4d-c4e5-cf9b-113b-da146b719820@huawei.com>

Return-Path: <linux-kernel+bounces-67895-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 840CC85728B
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 01:27:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 33C26B249E9
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 00:27:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 108AD441F;
	Fri, 16 Feb 2024 00:27:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=Nvidia.com header.i=@Nvidia.com header.b="Y78xpohz"
Received: from NAM04-BN8-obe.outbound.protection.outlook.com (mail-bn8nam04on2058.outbound.protection.outlook.com [40.107.100.58])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2C0FE8F70
	for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 00:26:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.100.58
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708043216; cv=fail; b=laMm13Xb2Odc61NCMLW1YVSnjMjZkFj5AKSZH/y6IrxfFRSvEanaWwoXtN/AYrToybb2P6tJRULoTpPwyNyf1kwj+/PjtprM2WzpFW8YL6BOIa+llHY6ikkeqOSAy4r6thZAGb/3SKfv204Ii0MDU0kaLBvAhSp6QN6XrobeNJY=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708043216; c=relaxed/simple;
	bh=sSFs4LanwVlrf8xMCV1BCSf6I+BMbzxVy2/9FiGBttM=;
	h=Date:From:To:CC:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=JRyL1Un4vfQJ9KJXGKFrbE7KZSOSAwUG/nQGY4FlBvcfGmTwEBy0kN2jg19vwfE51f7eD06Z26Hgn6MkLNxuyNPdkk/pfyTyHwk6RfN9wSIL0ALVRBzVQz+SytuVFSH8q1xfmN6052T2llUAh5s10BYs5Fggy0IVlZ8RQbVhN2o=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=nvidia.com; spf=fail smtp.mailfrom=nvidia.com; dkim=pass (2048-bit key) header.d=Nvidia.com header.i=@Nvidia.com header.b=Y78xpohz; arc=fail smtp.client-ip=40.107.100.58
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=nvidia.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=nvidia.com
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=MGp8N9MwcM7C+/Mi+7Hhp2dzNUEVBt2oWR9j1RPRv7M=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=MGp8N9MwcM7C+/Mi+7Hhp2dzNUEVBt2oWR9j1RPRv7M=;
 b=
...
Received: from SJ1PEPF00001CDE.namprd05.prod.outlook.com
 (2603:10b6:a03:d4:cafe::4d) by BYAPR06CA0023.outlook.office365.com
 (2603:10b6:a03:d4::36) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7292.26 via Frontend
 Transport; Fri, 16 Feb 2024 00:26:39 +0000
...
Received: from mail.nvidia.com (216.228.117.160) by
 ...
 15.20.7292.25 via Frontend Transport; Fri, 16 Feb 2024 00:26:39 +0000
...
Received: from Asurada-Nvidia (10.127.8.9) by mail.nvidia.com (10.129.68.8)
 ...
 Transport; Thu, 15 Feb 2024 16:26:25 -0800
...
Subject: Re: [PATCH v1 0/2] nvme-pci: Fix dma-iommu mapping failures when
 PAGE_SIZE=64KB
Message-ID: <Zc6rr/LleQ2krkyg@Asurada-Nvidia>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="sNbP+HBRwD4JlATc"
Content-Disposition: inline
In-Reply-To: <20240215163544.GA821@willie-the-truck>
X-NV-OnPremToCloud: ExternallySecured
X-EOPAttributedMessage: 0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: SJ1PEPF00001CDE:EE_|IA1PR12MB8286:EE_
X-MS-Office365-Filtering-Correlation-Id: 5f5990df-095b-4a1e-718e-08dc2e85f17a
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:216.228.117.160;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:mail.nvidia.com;PTR:dc6edge1.nvidia.com;CAT:NONE;SFS:(13230031)(4636009)(376002)(136003)(346002)(39860400002)(396003)(230922051799003)(186009)(36860700004)(82310400011)(451199024)(1800799012)(64100799003)(46966006)(40470700004)(235185007)(2906002)(55016003)(7416002)(33716001)(5660300002)(316002)(6916009)(41300700001)(7636003)(86362001)(356005)(4326008)(478600001)(8676002)(70586007)(70206006)(54906003)(9686003)(8936002)(44144004)(83380400001)(82740400003)(336012)(26005)(426003);DIR:OUT;SFP:1101;
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 16 Feb 2024 00:26:39.5223
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 5f5990df-095b-4a1e-718e-08dc2e85f17a
...
--sNbP+HBRwD4JlATc
Content-Type: text/plain; charset="us-ascii"; name="nvme_test_config"
Content-Disposition: attachment; filename="nvme_test_config"
Content-Description: nvme_test_config
...
CONFIG_ACPI_IRQCHIP_FWSPEC_ARG0=y

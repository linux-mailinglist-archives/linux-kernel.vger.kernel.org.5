Return-Path: <linux-kernel+bounces-29885-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 9CABF8314BC
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 09:34:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 131E21F2260B
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 08:34:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8EB6E11CB3;
	Thu, 18 Jan 2024 08:23:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="nmiW9E9C"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 99F5520B2D
	for <linux-kernel@vger.kernel.org>; Thu, 18 Jan 2024 08:23:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705566180; cv=none; b=blvITHgRRLStjvgBdFeFSBclsn7KAFgkQsyw754yA4+nFQ39ckoc6TO7nfmd5h+zdf0FyDV8k3BWiN7bpFFQHl3EtEOyCLICn+xNvRMNUZlq/DCk4WKnxjW3NXGgpan6zYk+dzwSI9KNn/9W+rTCeMHI5A3P7XYHIRXNBryZt54=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705566180; c=relaxed/simple;
	bh=8mb83CW2lbuHwSVT/r4dUWiQFfxT8qKnT5AWwVA0sLw=;
	h=Received:DKIM-Signature:Received:From:Date:Subject:MIME-Version:
	 Content-Type:Content-Transfer-Encoding:Message-Id:References:
	 In-Reply-To:To:Cc:X-Mailer:X-Developer-Signature:X-Developer-Key:
	 X-Endpoint-Received:X-Original-From:Reply-To; b=dIS5Cdw3JdAEYqYhQ+MYWrkB8cq87rSggqxmRWdYnjAYn/bwR7ZJNy9dcQCkTpelbKM8AgIqc//LN3Sq9K40Ev+qLqw0XxzBa8Dkt6rK3XVO7mD1Jf6Bh/du/3SmGc++GfXAfCxq6vkXEUzhBXZXAYD7sbDJ6J7u2DE/h8B7cTQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=nmiW9E9C; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id 71102C4E756;
	Thu, 18 Jan 2024 08:23:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1705566180;
	bh=8mb83CW2lbuHwSVT/r4dUWiQFfxT8qKnT5AWwVA0sLw=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 5EB01C47DD6;
	Thu, 18 Jan 2024 08:23:00 +0000 (UTC)
From:
 Nikita Shubin via B4 Relay <devnull+nikita.shubin.maquefel.me@kernel.org>
Date: Thu, 18 Jan 2024 11:21:19 +0300
Subject: [PATCH v7 36/39] ARM: ep93xx: delete all boardfiles
Precedence: bulk
...
Message-Id: <20240118-ep93xx-v7-36-d953846ae771@maquefel.me>
...
X-Developer-Signature: v=1; a=ed25519-sha256; t=1705566176; l=119092;
 i=nikita.shubin@maquefel.me; s=20230718; h=from:subject:message-id;
 bh=uhR66EhODWXKQFvJ7MBRo1kFgxp24yqu7CHAcAnWRvE=; =?utf-8?q?b=3Ds28WbdOilJMT?=
 =?utf-8?q?UbsrUNMTyQSDPjLr8zk/TkIJJpvVLRGbfZ6vVpfkLbFZZQNBQtLU5Iv3EvZlea13?=
 Nz29WI3MAEgMvpiESEYTaKCg10PLMP5UO1BCciJTAvQ2wadDHV3U

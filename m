Return-Path: <linux-kernel+bounces-112064-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C7BE8874CA
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 23:15:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 8F2811C22829
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 22:15:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 39A4681AD8;
	Fri, 22 Mar 2024 22:15:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Wd0GLu/A"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 219DD81753
	for <linux-kernel@vger.kernel.org>; Fri, 22 Mar 2024 22:15:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711145737; cv=none; b=P7UBgDYwVVINr95siY5qmQDuwdDyfp9fg1iurmjV501k644wXbrpMlIhExL4IThX/YVkrjIgNUQfxBBo5C+e+wkmnxy+vsZc7Lq93IDHN45LFVHwdUJOKXU1gLOueSBDoxpi3Xr6O7qRNZps7/h/7fPae+sU5YzmAa9ASsxZeVU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711145737; c=relaxed/simple;
	bh=c2AVaRtzw9AmK9VQiEAlKmtPt8C+9TBdsnJ0BLPlDts=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=G+Ho5QuZljho/IkfNQmegavo47fXNhf2hxn4qDviGOF6ZKm6jIomQcaKR2LwhGUHhbFwEwl4NQ9Qm1f21jU//ti9rRi5q932alBIzWLBuuh/JGrX/ZylmOooBXi21RbJZ1VWOvQqZjIHr4BXVhoVvhDaM3rQ7TacCdvUvFE/2EU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Wd0GLu/A; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1711145734;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=g7GQ3fPHiJFc4OvZ+/3sVtCU8QWBFnwHWiIOmeagJEg=;
	b=Wd0GLu/ApdrF2sXYC1nYkEWH+32onPFYL1XXoQh4QAHQOll0r5WpQ9Glrf+5XyJp56DHT5
	7VsAloUSwe6O0j0lgg11PE0+vgPgwYYgG/emPJSjvAon9siugqTW3dNVnil0yMGuxy+Om6
	20H8jeC/I5GnEKTWBD2y6xXw/3nsCjY=

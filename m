Return-Path: <linux-kernel+bounces-46251-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id F2ABC843D0D
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 11:43:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id DCE63B2D556
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 10:43:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7C85869DE3;
	Wed, 31 Jan 2024 10:43:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="LdqKxetn"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 09B8769D07
	for <linux-kernel@vger.kernel.org>; Wed, 31 Jan 2024 10:43:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706697795; cv=none; b=cnmHp2xOLKc8VqSqVABH9+dI5IHFyREUmxmM/2ZxkAv0mN4fBSDcksb4sowlxT3180qOf9yaSZVcyJqbj75R8OgJA+eyG7c2UgiM/WBzenfEsKmnXtCj7bXQYEH/klA3zFbEyaukLDY+AssldcYHGlWW7BLg9LmC2BcCYLKDTV8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706697795; c=relaxed/simple;
	bh=VKdh5ojB9n4H1igdsHNgzeWTEn+XBSJ7faZ2IWNWiks=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=e4t9b2K9UunYLJ1EtpQVtY36FsOBnDmA6xkZNOFHwxsFrLGRsxBrEhjdu14Z0dc365AAS/88TOy66z1IMY+EZJpqPejg8Mck5U7KBEslQVje9I/k87ANepDBmccvscUES2Lu0e6rn6sENC6tuO6DO8gdo2V7nJKxlhV1pe74gRY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=LdqKxetn; arc=none smtp.client-ip=170.10.133.124
...
Received: from mail-wm1-f71.google.com (mail-wm1-f71.google.com
 ...
 us-mta-308-YCS-MM4hM3SzydLVpS_gMg-1; Wed, 31 Jan 2024 05:43:10 -0500
X-MC-Unique: YCS-MM4hM3SzydLVpS_gMg-1
Received: by mail-wm1-f71.google.com with SMTP id 5b1f17b1804b1-40fb64f802dso670325e9.1
        for <linux-kernel@vger.kernel.org>; Wed, 31 Jan 2024 02:43:10 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=SHlw8k+TqYX0IO/Wrb506XALAVZ388XuzsT+3MrGA+U=;
        b=
X-Gm-Message-State: AOJu0YxY8MC/uxK2BQYTFUbNeS0ySgME2iHRfz5eg/HEq7My1pXwtgF4
	sKJYZ980foIdVOEPKi89VF99MLydy2eYyfOr4TXJ0bIy9SHU9PhfpU6XOPHQbDVNuuY7IpiGQCK
	lMa8mcXvEw633cLMi4jcSOcJosf44pCIYE2WqlyughzGCUVbPoEvNGEAVJtP11Q==
X-Received: by 2002:a05:600c:3b09:b0:40e:f693:94dc with SMTP id m9-20020a05600c3b0900b0040ef69394dcmr952902wms.11.1706697789721;

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 586E57DB56F
	for <lists+linux-kernel@lfdr.de>; Mon, 30 Oct 2023 09:48:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232324AbjJ3Isq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 30 Oct 2023 04:48:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51840 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232279AbjJ3Isc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 30 Oct 2023 04:48:32 -0400
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com [91.207.212.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CF58194
        for <linux-kernel@vger.kernel.org>; Mon, 30 Oct 2023 01:48:28 -0700 (PDT)
Received: from pps.filterd (m0046660.ppops.net [127.0.0.1])
        by mx07-00178001.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 39U8Amg1005259;
        Mon, 30 Oct 2023 09:48:17 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=foss.st.com; h=
        from:to:cc:subject:date:message-id:in-reply-to:references
        :mime-version:content-transfer-encoding:content-type; s=
        selector1; bh=hpY18ZGJQjmGpNL2tfzTTW/JJIrkHppm316Ry+FWFRs=; b=my
        
Received: from beta.dmz-eu.st.com (beta.dmz-eu.st.com [164.129.1.35])
        by mx07-00178001.pphosted.com (PPS) with ESMTPS id 3u0u0gxrwx-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 30 Oct 2023 09:48:17 +0100 (CET)
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
        by beta.dmz-eu.st.com (STMicroelectronics) with ESMTP id E3D16100067;
        Mon, 30 Oct 2023 09:48:16 +0100 (CET)
Received: from Webmail-eu.st.com (shfdag1node1.st.com [10.75.129.69])
        by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id D7B8A218613;
        Mon, 30 Oct 2023 09:48:16 +0100 (CET)
...
Subject: [PATCH v12 3/4] tee: optee: support tracking system threads
Date:   Mon, 30 Oct 2023 09:48:11 +0100
Message-ID: <20231030084812.905549-4-etienne.carriere@foss.st.com>
...
---
Changes since v11:
- Fixed inline description comment for struct optee_call_waiter added
  field that is named sys_thread, not sys_thread_req.
...
index 721fd4d24f47..d73396ed5b93 100644
...
index b659a6f521df..7832ccefe6d0 100644
...
index 8ae5e1047650..3b60acc15cf0 100644

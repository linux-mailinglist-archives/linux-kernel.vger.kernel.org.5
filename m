Return-Path: <linux-kernel+bounces-87272-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id F0AE686D1FB
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 19:22:10 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 800FB1F26723
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 18:22:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2D9C7160653;
	Thu, 29 Feb 2024 18:21:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="X1h7YtHa"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 85B5E7829E
	for <linux-kernel@vger.kernel.org>; Thu, 29 Feb 2024 18:21:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.198.163.7
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709230904; cv=fail; b=BpvF43yBU21TNoeNDbumWU1n+42ELPIyXAewbpW2xu4eQBaIIpYpj6t/WX+mhzVxSHOaSFJ8DPe4vbUIJ7YD5RWx8dutJ6JfQIiFGULuxEQzW9EBiDG66pzd+z+b9WfnXMWW5yUNQQe3H2zBoS4OPDgivq5vR1ZUVG9tBfqyrgA=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709230904; c=relaxed/simple;
	bh=WMmYmUQEzg0IF20lL2Gpc75dX+zjQMkh9mM5vqY5yFk=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=LH/ipAVHtVxr52EZsasIgqfnWw3aGrWBc6jjl8ynPx2Rnp30KbTzCEP3HuFKUjlsbafR8foEMiwUEDmKW3JOanFer5pmnfJhnU36rHZ2cT/CLypJ8QlTP9KjHT589/7mx1T0w2GjlnlWYU1cP/ms7cG4pT4FDkttxCRIn3aowUg=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=X1h7YtHa; arc=fail smtp.client-ip=192.198.163.7
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1709230902; x=1740766902;
  h=date:from:to:cc:subject:message-id:references:
   in-reply-to:mime-version;
  bh=WMmYmUQEzg0IF20lL2Gpc75dX+zjQMkh9mM5vqY5yFk=;
  b=X1h7YtHa5J5M9YZDIgEI995HWuTwDSAxN5WGb3LrCmDh3ieBC6F96orE
   ZwOjIk0pA32pgBVNeGlF/+Ps+DgcRem7c3ohzb9EawgY6DdkZpNKX+YNc
   YK2ry9IW9PBlIUdfBqnNxNi5NHkjdt4Dd7p8SLEcye+lCfMxmxLH7By+7
   Q7ApPVYQqBTfS7jR3tc1boKzENp5JLfBNgKYI2qEH0hXfnJnFBDT4fZDJ
   qNVQIlar4aYIaNICC8Iefa3/UXrVEqJ/VgqohUp7bKoaeq/p+/rADwQgK
   rT2EQJjC5ac1EXuE5lN5B6zalqKbqNTuz53BEqteqHkvFvuAyGKW1NgFD
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10999"; a="29155495"
X-IronPort-AV: E=Sophos;i="6.06,194,1705392000"; 
   d="scan'208";a="29155495"
Received: from fmviesa005.fm.intel.com ([10.60.135.145])
  by fmvoesa101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Feb 2024 10:21:41 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,194,1705392000"; 
   d="scan'208";a="12467040"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
  by fmviesa005.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 29 Feb 2024 10:21:41 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 29 Feb 2024 18:21:37.2827
 (UTC)

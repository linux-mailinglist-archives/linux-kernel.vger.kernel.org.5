Return-Path: <linux-kernel+bounces-82544-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C20386861E
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 02:40:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 6D8C01C256C3
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 01:40:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 87CFA5C8B;
	Tue, 27 Feb 2024 01:40:35 +0000 (UTC)
Received: from 14.mo581.mail-out.ovh.net (14.mo581.mail-out.ovh.net [178.33.251.19])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D46FD4A33
	for <linux-kernel@vger.kernel.org>; Tue, 27 Feb 2024 01:40:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=178.33.251.19
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708998035; cv=none; b=FK+m90WeFeUD5a9ag8i52+QH+k7hnnMQYE409fqbVzoG+Eeq5lYnZMKW09tudt7dZr+THOmxDDLyAyNlYQkQgEl6PTPURAeyRFzJ6kcxVrrKOH6IVJt+Y7u4Z4BUejckDLqCwV/S05ZWznNB1nAuLxeAQQWmH2jeq0NgO4ZPq74=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708998035; c=relaxed/simple;
	bh=oP+NUZOFqM2E6ptm+fLs9NHiWljY1OQX7Li7+FuOHyQ=;
	h=From:To:In-Reply-To:References:Subject:Message-Id:Date:
	 MIME-Version:Content-Type; b=Q6gT6q93YBmtDFOnnt1W+FV24EpvwoLKOMw2NGAihrdz86GuvG54UdmBh8yl1WyKy/M+mDEI1J7Ci3IurZxbvIVqRqBuGs0lDxYw77rUOVCk36RrefcDHA0ZlSfZ0kdVn1JBp6cNlnpXFJbpUJj90EcVdAVdv2R3rEscoLPtMHg=
...
Received: from director2.ghost.mail-out.ovh.net (unknown [10.109.140.5])
	by mo581.mail-out.ovh.net (Postfix) with ESMTP id 4TkKTD32Zqz19CJ
	for <linux-kernel@vger.kernel.org>; Tue, 27 Feb 2024 01:21:52 +0000 (UTC)
...
X-VR-SPAMSTATE: OK
X-VR-SPAMSCORE: -100
X-VR-SPAMCAUSE: 

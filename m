Return-Path: <linux-kernel+bounces-1445-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 297D9814F1A
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Dec 2023 18:45:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 94B361F2592A
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Dec 2023 17:45:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B29334654B;
	Fri, 15 Dec 2023 17:44:24 +0000 (UTC)
X-Original-To: linux-kernel@vger.kernel.org
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8E5BE45BFE
	for <linux-kernel@vger.kernel.org>; Fri, 15 Dec 2023 17:44:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 2DC6515DB;
	Fri, 15 Dec 2023 09:45:06 -0800 (PST)
Received: from merodach.members.linode.com (unknown [172.31.20.19])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 3C9AB3F5A1;
	Fri, 15 Dec 2023 09:44:18 -0800 (PST)
...
Cc: Fenghua Yu <fenghua.yu@intel.com>,
	...
	Babu Moger <babu.moger@amd.com>
Subject: [PATCH v8 06/24] x86/resctrl: Access per-rmid structures by index
Date: Fri, 15 Dec 2023 17:43:25 +0000
Message-Id: <20231215174343.13872-7-james.morse@arm.com>
...
index b5d4b76f97c5..ba6daef6bd26 100644
...
index f5d5570a5b5a..d623031def4c 100644
...
+	pmbm_data = &dom_mbm->mbm_local[idx];
 	...
 	if (!dom_mba) {
@@ -660,17 +693,15 @@ void cqm_handle_limbo(struct work_struct *work)
 {
...
@@ -735,19 +766,20 @@ void mbm_setup_overflow_handler(struct rdt_domain *dom, unsigned long delay_ms)
...
@@ -756,7 +788,9 @@ static int dom_data_init(struct rdt_resource *r)
...
index f64c13fe22d7..351b74670673 100644
--- a/arch/x86/kernel/cpu/resctrl/rdtgroup.c
+++ b/arch/x86/kernel/cpu/resctrl/rdtgroup.c
@@ -3858,8 +3858,8 @@ static void __init rdtgroup_setup_default(void)
 {
 	mutex_lock(&rdtgroup_mutex);

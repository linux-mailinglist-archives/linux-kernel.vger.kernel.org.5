...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A9D2879D9B6
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Sep 2023 21:43:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237644AbjILTnZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Sep 2023 15:43:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45024 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232259AbjILTnX (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Sep 2023 15:43:23 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C2009115
        for <linux-kernel@vger.kernel.org>; Tue, 12 Sep 2023 12:43:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1694547799; x=1726083799;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=ejdl+0vVIjvgJIHJy9K1YQcaPTrOwsh5PJXEkm+HTaQ=;
  b=VmuvoissC4ffkD6oVKmhlmSqi3YN2pIyVa20raXCesx33TFRVzbKR1XF
   iT7UpANwHaDuJyhDjcHi5jn6rUd8PvTG9e7/Fev23/IECrOdXkDyZgkLC
   NMzjwhU3E5Wm9Ud7yOyc3lLGP9fc6FFbe7WmfrNk2WTx/4KFAmV8ZklpC
   TeUgwKuX0TocIOEOx8xkmXoq4QlJo+5Cil5o0bI7qJPZyVG31LRFpqFzb
   lPXuYF6Kvb8mDsYWIlVI7xnBgplKmba2FILjoNXJYqduoZrjNw1Awdy3M
   BjKt8bXtd9uQF/clvQB4jtER9X0O7Euwf+QJ/70zr01XVDQ1Po/CMr8Zq
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10831"; a="409424926"
X-IronPort-AV: E=Sophos;i="6.02,141,1688454000"; 
   d="scan'208";a="409424926"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Sep 2023 12:43:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10831"; a="809395933"
X-IronPort-AV: E=Sophos;i="6.02,141,1688454000"; 
   d="scan'208";a="809395933"
Received: from lkp-server02.sh.intel.com (HELO 47e905db7d2b) ([10.239.97.151])
  by fmsmga008.fm.intel.com with ESMTP; 12 Sep 2023 12:43:16 -0700
Received: from kbuild by 47e905db7d2b with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qg9I2-0000CI-2f;
        Tue, 12 Sep 2023 19:43:14 +0000
Date:   Wed, 13 Sep 2023 03:43:06 +0800
...
Subject: Re: [PATCH] dma-mapping: fix dma_addressing_limited if dma_range_map
 is scanned
Message-ID: <202309130345.xV6bouV1-lkp@intel.com>
...
config: um-randconfig-r012-20230912 (https://download.01.org/0day-ci/archive/20230913/202309130345.xV6bouV1-lkp@intel.com/config)
compiler: clang version 17.0.0 (https://github.com/llvm/llvm-project.git 4a5ac14ee968ff0ad5d2cc1ffa0299048db4c88a)
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20230913/202309130345.xV6bouV1-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202309130345.xV6bouV1-lkp@intel.com/

Return-Path: <linux-kernel+bounces-103414-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 9689287BF18
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Mar 2024 15:39:03 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1079B1F24137
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Mar 2024 14:39:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 270501A38EB;
	Thu, 14 Mar 2024 14:38:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="tvnB58Fv"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0301B548F2
	for <linux-kernel@vger.kernel.org>; Thu, 14 Mar 2024 14:38:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710427132; cv=none; b=RH2ccpa/pZMXDIKgIhPPH9cfnvZrCYM4dXJlbCoxW1BaF0fuRwhy2GK/ZzvDmb5+vC/LZQ3xG6hu1PFycjSohefzA7DZFK2GPOJUrvmt/NpjZ5lPSQoW3qRDVDhdhWbgyeG4YFg8+GEsSVhearK7QYuc6gXugFIZi3NWV+xs5mg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710427132; c=relaxed/simple;
	bh=fs/E7Keij10ThCy09P18Rbmr7EypbyJsMX/yaWGDPIs=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type:
	 Content-Disposition; b=gDOP+fVLlA7yTQEzsPQBVBUkQsnNozREJkZN17vRrrvWIqSSmKB88ol1zm4XG+g9cod8+nmbdPo/sozNXauxgibVbBIDuVAxnGSFtpVaZNr8zC1fJHXFD44WZx/cohxzbazGxudpOhtj/Bq8QZ/zgn0MW0zDtc9lg7ub0VwdwiI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=tvnB58Fv; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 74A62C433F1;
	Thu, 14 Mar 2024 14:38:50 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1710427131;
	bh=fs/E7Keij10ThCy09P18Rbmr7EypbyJsMX/yaWGDPIs=;
	h=Date:From:To:Cc:Subject:From;
	b=

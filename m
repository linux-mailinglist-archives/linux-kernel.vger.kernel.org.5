Return-Path: <linux-kernel+bounces-52059-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 2764284938E
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 06:52:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 0D55C1F215F1
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 05:52:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4620710A01;
	Mon,  5 Feb 2024 05:51:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b="F0hjBsHo"
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 47FE8BA38
	for <linux-kernel@vger.kernel.org>; Mon,  5 Feb 2024 05:51:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.61.82.184
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707112299; cv=none; b=ozVBUynNJbz+3amHEpCjEJI+OmoDDtrM8HATbI7DO5wwHdPFiNwuHFCxxu80LSn4LMFnD7QU0qPhkSIvc5jpWMPuc5NdHDi0TNTL0k9fpxhPJu7mtyMC+oB0IcxE8RXJLvxXAtzT1pfatBX/KniKevptkNq3tnGng78IRGWAIF4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707112299; c=relaxed/simple;
	bh=LLGW4b/FjrKTRsBfHpncB63lndsuLXDmYjaseu/Ll+E=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=Q1BVzW7cqnLnOzsxQboef3RyOx0TIc5nANi+MM/oFMEs9JgQ8REMo3U4GJNTXe2JVw8ZFhWfg1qqBjNAYoRrpM20htAmMZRZl4eWOro80NFvPdkMyirzgCtrBlAOpdTohb2JuTHfAVtsRXqhgeTIukwI+zU0bLv80itjtiezfDE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com; spf=pass smtp.mailfrom=mediatek.com; dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b=F0hjBsHo; arc=none smtp.client-ip=210.61.82.184
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mediatek.com
X-UUID: 9a7c235ec3ea11eea2298b7352fd921d-20240205
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
	h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=cjwr8OfJxt9ACbx2ozd/vhd/QTWHF6m3uMddm4JGxwA=;
...
X-CID-O-INFO: VERSION:1.1.37,REQID:16af0c50-c95a-4e74-9336-99f2de17cbb4,IP:0,U
	RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTIO
	N:release,TS:-25
X-CID-META: VersionHash:6f543d0,CLOUDID:04af84fe-c16b-4159-a099-3b9d0558e447,B
...
Subject: [PATCH v2 2/3] Subject: [PATCH] drm/mediatek/dp: Add HDCP2.x feature for DisplayPort
...
X-TM-SNTS-SMTP:
	356CDC7B5E6F71D0DBF110D907440BB9C662829359FA9C0A0110922FBF210CEE2000:8
X-MTK: N

Return-Path: <linux-kernel+bounces-54056-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B1F084AA1E
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Feb 2024 00:01:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 5BA28B2688E
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 23:01:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B27635579B;
	Mon,  5 Feb 2024 22:58:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ehtDcmNT"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D93D1524D3
	for <linux-kernel@vger.kernel.org>; Mon,  5 Feb 2024 22:58:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707173888; cv=none; b=Kw8vrKkWa4g+JTMDmQuEaLLAGr0vLvU1Wlo1Pkv6x7dK0vZu8OLC0MAARfDPMNOwVU+yUxrsfnAK5SxuvrQqNlkn5tOUrsFmHP8u/S3QMl7Hi1swmvCdd/UlUg3Ie4CPHiL5YrCg8LhDewsGGFurrvpmMoRTyWu6DfdtOYR8n+s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707173888; c=relaxed/simple;
	bh=aFcgEdqM3jB4MxkKG8QYFByp2mlVnQrASaEMkbzpn5s=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=YN0qwO7Rl8za61ktWtHa5NhJVhSyPenNNdxqkpNN10VVxQT1pdl1fyq4mRy1+0dgV9Hh/jl/dGNypge/VLd2OKsPhaS0+OxXAPq0hsJPtIHDTUAAPLSab2qhIuOHgaOQFK2PIHyYDycwWPRzZfSqrdFDBTLBTaXHD4UQarGB3Cc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ehtDcmNT; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1707173883;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=evq7I8yHT5lFqzTbu9gfMKyqUUTsNpYO73yZf6A4u3M=;
	b=ehtDcmNTOwf8G2XxsGq+NEEqOiGvMf47cSH+qH7NYhlWyz0PVFTk9jIJcjMR3WEPpbkobX
	BlKWs5pwm5dZHCDOkMnQQOlZekgIa/YnFtdER7nViXn2b/jDpJYK7tRzp0cK2blKHi9aG1
	c6NZLUmL1WmPnLjg6r54z6lD+qut0ag=

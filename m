Return-Path: <linux-kernel+bounces-160616-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C94B8B4022
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 21:28:17 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4DE041C2207F
	for <lists+linux-kernel@lfdr.de>; Fri, 26 Apr 2024 19:28:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E772E18C19;
	Fri, 26 Apr 2024 19:28:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="GrtT88xe"
Received: from NAM11-DM6-obe.outbound.protection.outlook.com (mail-dm6nam11on2085.outbound.protection.outlook.com [40.107.223.85])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8F489BA45
	for <linux-kernel@vger.kernel.org>; Fri, 26 Apr 2024 19:28:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.223.85
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714159688; cv=fail; b=dbU7xhAGOeo35SgNiqlvGP0UKXS72nLcq+KKewb3DGSTV24NeSAcuperkd6tdlggt735POzMa2aYCLipwC2Z7HOmqC7F/eHx1C5pap1SG/po/cpod4Qo5SpkQJpHToYFaV83XdYW5wLEeNGL7npD3j3bGXAwtuwDmlWKVBUbXqE=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714159688; c=relaxed/simple;
	bh=hwwT9H/oGn76bzA6oJXfl6Mnh9FriKvJKYJtwcWGjlU=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-ID:References:
	 In-Reply-To:To:CC; b=Mu1bG1SZ430EFDOLpHk7pzmgfn4up+Ew1jdiQTB32zluvtANm/L1kcRFpdsQRWMh5hbbyN90JPqWX8n9s0XggMNU7j/dtc8pvElUgU6HDfZDmSjHtpZnWw08YR9L5mYC/s/60JymwazCm7dnVxjBvn33ddzvrHJBK2ONNJUMEIY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=GrtT88xe; arc=fail smtp.client-ip=40.107.223.85
...
Received: from xsjanatoliy50.xilinx.com (10.180.168.240) by SATLEXMB04.amd.com
 ...
 Transport; Fri, 26 Apr 2024 14:28:01 -0500
...
X-Microsoft-Antispam-Message-Info:
	=?utf-8?B?bG1oQ2ExM0tPMlhwa2l4QXRGbDdrbldEVC9TZm9nbXFMcjhPVVJoU0gzTmdP?=
...
X-Forefront-Antispam-Report:
	CIP:165.204.84.17;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:SATLEXMB03.amd.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230031)(1800799015)(82310400014)(7416005)(36860700004)(376005);DIR:OUT;SFP:1101;
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 26 Apr 2024 19:28:03.2707
 (UTC)

Return-Path: <linux-kernel+bounces-153870-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 895DD8AD451
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 20:50:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 09645B260A1
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 18:50:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2488C157498;
	Mon, 22 Apr 2024 18:46:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="r3UtJi6g"
Received: from out-173.mta0.migadu.com (out-173.mta0.migadu.com [91.218.175.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BC977156F3C
	for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 18:46:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713811590; cv=none; b=fR77kAyxX+/iT+RPyMfLthYLenjObMKufqa3TNC6wsPvCHi62ucXxEYDstfPF52BogFowyy/83mDTvgeuyj503ug1dYapDZfQUR9PKq83T4Cjw72EZ/LC7kkJ+zFB8a5LyOE0HSJasAy4u7OrX2IksLeQPJPoCDCkXcHMJIjF8w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713811590; c=relaxed/simple;
	bh=7GZBEbcRdbieHmRQkvkRKSwv1IA2XlvuZ7BF9XTlFNE=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=GpQgf43bEbyooCHsnkud4Z+oDjIfCgU7Gk/J0wVZnAxaZeHeZQ/pgPmrMVlX0F9o3mQyrpDJtks2y0Y8qmJ3caPaoxe5LyLfYRqRzSOP29hPuqe4FBz+OsSKtF7xBGw7sRm8N/DQVLTIQoUmnEboCglVnvry7YDbbwlHVfWQM8Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=r3UtJi6g; arc=none smtp.client-ip=91.218.175.173

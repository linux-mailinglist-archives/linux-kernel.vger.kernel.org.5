Return-Path: <linux-kernel+bounces-164076-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id C40F08B789D
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 16:12:49 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id AFE10B221F4
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 14:12:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6115D1C68AF;
	Tue, 30 Apr 2024 14:03:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ZOte8kMe"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EEB8A1C0DE5
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 14:03:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714485788; cv=none; b=P3cjpB76gIhut8unTujPmvQ9pEk1jWPwi6VxsMqmAtVIUEodfe7hGiy5ad5xJponW6EDLCkCp7M5kA8ysxqThVCTfYLs6gwTiEoNXgYsS2UR8EDnk8Nc5UCN99ifNWczOAsNs4/LHrVYUzqejBO8LqOjJCv2G/D8fm6IEXhUtQE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714485788; c=relaxed/simple;
	bh=wk+uIq/Whs3KGMA/PDY6hckSxP5pAH9XCOYxv3JWN4U=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=V8eggMNPzM7OHTe721wrBf6wXMBPezXBBNGax8h/NuV6IuDvVQCIPb7kPK0DBieaorclEOmbswQYTvg63MeqBVs9MgpQFaXWVmuUcs93j7+YCM27fz6KyHpq4QwrNDktZpRZDg22QLAg7Za/A7W5AzrzXuww6xAbGqsdnqrnirA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ZOte8kMe; arc=none smtp.client-ip=170.10.133.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=ZOte8kMeWM++DxrFjIgzjMrlF7KQtyUr/ymllg65eF45/5uw/qxIvzRnX80grpyLN1foAY
	M+41Ffr/RLo2CWPh1rICpXDfDDeq+jvRYC4XtB0pvP9cMiisHg+ntFHtsTq62p+bwKEBUe
	IR7v/ufSVwBavLuR5XnqDz6UK6TLy88=

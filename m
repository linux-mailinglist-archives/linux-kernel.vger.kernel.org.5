Return-Path: <linux-kernel+bounces-101479-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 008E687A7A8
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 13:37:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 241F51C21D21
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 12:37:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 53D5B3E487;
	Wed, 13 Mar 2024 12:36:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="dcRixcuV"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.13])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3902B27702;
	Wed, 13 Mar 2024 12:36:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.13
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710333410; cv=none; b=Ojcofy/jP43psaRar9FckiNW9nnWOZsUZX9XhP6S0jtY8QPIULrdPXAT/1mvrDUJ2exuqIz8TZo2o5zP+drJ8FmdHNIGY859p0eMA4GOB0COjM78TDaiIBl5xxA6VAaHuSLFpXHjCXsV/icqftPyCRYQM6YISH+Mb8uiBW+w9hg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710333410; c=relaxed/simple;
	bh=noMMvuMQdPVJG4GE9S+hmxtgQoz8Osswby0Uzf0THF4=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version:Content-Type; b=VSPa0D1HOzefhSRLn3aKFMcOSrEtkD8+VWixbI7Mw72toxuxrddbaewtnE1hHFUj/tmWOlGSo1gJmifnWyp91urO6XAzJ7BwAgZ/88QFT15jHPsrtbO1XhrNVW/rQhxP2rz4B+pCENh5Ys742Gr5xbr15FTDUHewC4Oi2appSw4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=dcRixcuV; arc=none smtp.client-ip=198.175.65.13
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1710333407; x=1741869407;
  h=from:to:cc:subject:date:message-id:mime-version:
   content-transfer-encoding;
  bh=noMMvuMQdPVJG4GE9S+hmxtgQoz8Osswby0Uzf0THF4=;
  b=dcRixcuVqRnJOyuG3ekUjDhy/kplmZ4IZhIaHROawxLp9W8mONyJxLE4
   i0vHmYDh0bq03u4A0dDpbjUJOkEiCC4kYvjlk9GDD+TIp4jGGLc//srZa
   FG8wVSEErYZ4bsF57Am2M/PFV/094ZpAg229MwjFWrcRCA0sWJIF/X/Bn
   vK5tZGbNV4sOmvKsowkWGOlEqijfdQzacN8qTf9eLjCvhTYgH3ekMlsq+
   q8WimNt5SqII/Utrf9vXcKJzdQYej4513HL2NFu6iEpPTCk4KVp+23hTR
   c27nwiN66sCMhRDlUa2GmP59/96geW/CjzF+7KyO0o0Qd8sV3pkB9SwzO
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="16240476"
X-IronPort-AV: E=Sophos;i="6.07,122,1708416000"; 
   d="scan'208";a="16240476"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
  by orvoesa105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Mar 2024 05:36:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,122,1708416000"; 
   d="scan'208";a="16510568"
Received: from ahunter6-mobl1.ger.corp.intel.com (HELO ahunter-VirtualBox.home\044ger.corp.intel.com) ([10.251.209.20])
  by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Mar 2024 05:36:44 -0700
...
Date: Wed, 13 Mar 2024 14:36:34 +0200
Message-Id: <20240313123634.4353-1-adrian.hunter@intel.com>

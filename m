Return-Path: <linux-kernel+bounces-152673-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id AC2ED8AC2A5
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 03:54:53 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 379381F211E3
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Apr 2024 01:54:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8235F4C80;
	Mon, 22 Apr 2024 01:54:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="UY1ZGvm3"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EBC1C4C97
	for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 01:54:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713750873; cv=none; b=J3MyGGuJ2hSS7mRNgQBIDsN3DsvjOUx2iozjkP8rxrLS6WeKUCsGr2jGJOir5famhQIXxvy+qpUTstHWpuQA0kMvEjTNccNQLnDiVZTbULIvEm48d64UKHTzj3DFVBVTY7SbcEdgTY9CrseCLtNhZEyvbW7wuqFFdhL9wmYP5mU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713750873; c=relaxed/simple;
	bh=SfhdMqqsGb/GVXHl6IHUVQQdHafTxfe3mLLG/FzGS/w=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=s2xnNkAWPD+4kONQHm4hSWbUyM1iJmlETt3T0Hh8T//0uDJpZznymxJa/eutjvXzvJPXy2LMzJqiRLJnBGcPxW+2hI00FPMyb0clG30WdkGqgJBT2JZVk6BeB/QykxjIx3qMrCtwm7KU4r4UgAEvTCunEgSRpKeGp3VsCZoN390=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=UY1ZGvm3; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1713750870;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=SfhdMqqsGb/GVXHl6IHUVQQdHafTxfe3mLLG/FzGS/w=;
	b=UY1ZGvm3fRvOE6rkcgNMtDN4rlKKY8tXbtsLvnYkjVo1Caeyepovd1AzBT7q/DtvOXRFLq
	Fw6apCbHhHL99c5UgPMqIdoBT/l1LKWmvn9cX3+zLxXx9zC3CfQcubAo61sOx/48WHMJ2S
	AWqCUK70Nn9X0QSQ+LBuGVWiUJiB57g=
Received: from mail-qv1-f71.google.com (mail-qv1-f71.google.com
 [209.85.219.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-33-sWl7ph7kNnO1gbMKG_igWg-1; Sun, 21 Apr 2024 21:54:28 -0400
X-MC-Unique: sWl7ph7kNnO1gbMKG_igWg-1
Received: by mail-qv1-f71.google.com with SMTP id 6a1803df08f44-6a08137ce61so5065286d6.3
        for <linux-kernel@vger.kernel.org>; Sun, 21 Apr 2024 18:54:28 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=SfhdMqqsGb/GVXHl6IHUVQQdHafTxfe3mLLG/FzGS/w=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVs7mhLnV39cucn5/LhTzzRijZsi75ZZ1sBYebsd8ShAfje8fpI1XXiJNmybI+fi50SujwR3Hxqa9iYFBwAiJIL2XktS58rHza8EZp0
X-Gm-Message-State: AOJu0YxUmi+XQqaMQfSRAFr6Rf//O8CGPUKTcKwWaWcO/Z8uTFVNLrtJ
	KfbqCBa0knAu5YREiMr2Ldwq/2jjA8G4iSobBvJCTZyc1D2ynyFbLzYrjsFvDNw2dF9ZSdkQHxb
	ZChkFWG5JfORDbaVM4yQIjdysj2PRgmMdmPju1IZ/yK+VeZFXzeXAdWGTVl1JKg==
X-Received: by 2002:a05:6214:812:b0:69c:9d5c:4181 with SMTP id df18-20020a056214081200b0069c9d5c4181mr8634540qvb.32.1713750868088;
...
X-Received: by 2002:a05:6214:812:b0:69c:9d5c:4181 with SMTP id df18-20020a056214081200b0069c9d5c4181mr8634527qvb.32.1713750867810;
        Sun, 21 Apr 2024 18:54:27 -0700 (PDT)
Received: from ?IPv6:2600:4040:5c6c:a300::789? ([2600:4040:5c6c:a300::789])
        by smtp.gmail.com with ESMTPSA id x18-20020a0ca892000000b0069b16a0f26esm397246qva.58.2024.04.21.18.54.26

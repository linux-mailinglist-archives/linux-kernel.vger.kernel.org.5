Return-Path: <linux-kernel+bounces-110976-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D5B1088668B
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 07:02:03 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 861512827C0
	for <lists+linux-kernel@lfdr.de>; Fri, 22 Mar 2024 06:02:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DCA4AC147;
	Fri, 22 Mar 2024 06:01:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b="j9h44js3"
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [213.167.242.64])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7CC03C121
	for <linux-kernel@vger.kernel.org>; Fri, 22 Mar 2024 06:01:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.167.242.64
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711087317; cv=none; b=SgICmx6bpwgv7LWeYiFveLpX+6P5XwWaLzNHyIb1HmZ3nr0mzbsR6N9nwdX9vmeDd4+1Zf3jN2DzZ/8msjzJjzSdZHBAG3jwA3sR1DSyyVaFeK7TvEuLNX2CobYDwRo2psTf0KUwi9LBYfTUjR4hgpTDMFUS4SgYKTxvl3HSAiw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711087317; c=relaxed/simple;
	bh=oiexX4l+9bPLzhTtjB1M8IXJxZY34RYqmLKUedmwsok=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=aAyykptv8S0J7D8699dpyPo4kvrItMehfdK/Yv0c/jmCEaxMvm4X4vJ0FtgmhEHH/LX9YDkJOGy05njAm+zbdyYHI8293K1FS9zYn/Vw0SeM7U4jeO30nsTev+vfy2ORbhHo2vcOesS9wJUemUgIG0M9JIrTM4SMp/0C1EpNnlY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ideasonboard.com; spf=pass smtp.mailfrom=ideasonboard.com; dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b=j9h44js3; arc=none smtp.client-ip=213.167.242.64

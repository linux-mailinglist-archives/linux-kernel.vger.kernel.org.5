...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 92D9279E6D6
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Sep 2023 13:33:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240376AbjIMLdT (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Sep 2023 07:33:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36130 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240342AbjIMLdR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Sep 2023 07:33:17 -0400
Received: from smtp78.iad3a.emailsrvr.com (smtp78.iad3a.emailsrvr.com [173.203.187.78])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 89B5D19B6
        for <linux-kernel@vger.kernel.org>; Wed, 13 Sep 2023 04:33:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mev.co.uk;
        s=20221208-6x11dpa4; t=1694604790;
        bh=+Sh3mtwEAE3bSbUpGi5QeUjtBxvEQfhfCzuMlBoZ5r8=;
        h=From:To:Subject:Date:From;
        b=IjKZNLf/vX5Tm9AASFkdZpIfY1wLbKVu+NBqC+KTOan/PqN9YU74P0/ybkTe95rHW
         AnbFOlUbYQOgPmPmmYlqrkgZDxrEqPGsLdoakoQkoh0cK7qk0nsHyag8SRrELYOKG/
         OHeblJkGB591DZjFryBoPi4Vzxsye9kbAyyXJZfk=
X-Auth-ID: abbotti@mev.co.uk
Received: by smtp26.relay.iad3a.emailsrvr.com (Authenticated sender: abbotti-AT-mev.co.uk) with ESMTPSA id A197140EF;
        Wed, 13 Sep 2023 07:33:09 -0400 (EDT)
...
Date:   Wed, 13 Sep 2023 12:32:37 +0100
Message-Id: <20230913113247.91749-4-abbotti@mev.co.uk>
X-Mailer: git-send-email 2.40.1
In-Reply-To: <20230913113247.91749-1-abbotti@mev.co.uk>
References: <20230913113247.91749-1-abbotti@mev.co.uk>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Classification-ID: 007ec4bd-2574-475a-9bbd-5a4f93b29aec-4-1
Precedence: bulk

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8DBD27B7F4C
	for <lists+linux-kernel@lfdr.de>; Wed,  4 Oct 2023 14:36:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242420AbjJDMgm (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 4 Oct 2023 08:36:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39502 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242439AbjJDMft (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 4 Oct 2023 08:35:49 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 92F1C136
        for <linux-kernel@vger.kernel.org>; Wed,  4 Oct 2023 05:35:40 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=uD4GtjbozKXmXyIEErTZhqTB6alursQL+ikTUHHcdZg=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1696422939;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=uD4GtjbozKXmXyIEErTZhqTB6alursQL+ikTUHHcdZg=;
        b=Dtp/ryapi2aGB2/A3lYCskKZYMshaco6bfIZZoRN3QnazC/WlChRYuCyHYgyeDi9wxBuCX
        ztGdvFLk3TldsZAw==
...
Subject: [PATCH v8 23/25] timer: Implement the hierarchical pull model
Date:   Wed,  4 Oct 2023 14:34:52 +0200
Message-Id: <20231004123454.15691-24-anna-maria@linutronix.de>

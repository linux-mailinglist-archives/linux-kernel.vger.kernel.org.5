Return-Path: <linux-kernel+bounces-93148-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 288D5872B92
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 01:11:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 8EA39B29288
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 00:11:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 18DCC1E868;
	Wed,  6 Mar 2024 00:07:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="d9F5TKVa"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 56B711CFB2
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 00:07:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709683655; cv=none; b=m8w4biwCjECLEzITbOuXu1CkfnN/3zU3QFiEJWedetZ7AQtzckCRdHtliYDpymu7ZXVgQ148v3zCRUf5JKbPGwmXiWMiD+5zdHIRJREGDK0cAkuVWq1HHB/PePvwaXpMteuZeSTJVrUnRVHjRwsB57o5pSwC0+ikX0/RE/iUqBc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709683655; c=relaxed/simple;
	bh=FTQQFqJR1cCZRwn2/b8zyJLb6/DG0ecGJ1QSlUG5a6o=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=XqDOKL1dFzwJeorQaF8+g99ZF9cReG66hG4KWNpAIolOJy8EdAva89Zns2Nn/yBXXWmgeWtY98J5itCFL4PErUqxbol3m5uUmAYDYOJOSmw0KXnzWVcscx9F70x5ygURbWUluR26i5/oisCAW07S0umCs5cnoM0DOtomN1oAQ9s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=d9F5TKVa; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709683651;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=RPjFZeqS43tDYZtcB7eX9f3xGU7eAWXrq4/BYD+n3hM=;
	b=d9F5TKVa5sgTEqu1Oi+b8T4SVjF6/fc4ST3wosfuUVckQAyXTmXtY+SwKClP8tR0OlcAlK
	6qqqvpCmvs3Qy1USwojuFTljAqXOKtCniZM9it5TzW7nLz0VrkW6cCJgwSW7Qgl4VVAkJG
	FlOU16Xirp3fS6L0D5OgoE+5aU2OjNg=

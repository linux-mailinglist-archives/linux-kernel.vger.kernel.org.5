Return-Path: <linux-kernel+bounces-136811-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6699489D887
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 13:51:53 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id BE87528391E
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 11:51:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F0111129A9A;
	Tue,  9 Apr 2024 11:51:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="dZo8aTjl"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DF3111EB46
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 11:51:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712663506; cv=none; b=DMRwepQq0xdZ4yk8JrVnxexLLPFpvJPe6fMoEndS3bevpHh4H2XaNF1vTQb+otFZ3skWXXtbZLQbVRHbBWJrsG+mPMoTQDWqDoBKoRFrn0eK9ZPk5E/Xaj6MX9kDyJYlD26Ekf0+IViZaOoObwOCpzpL7w7rkTCR4nBCCn0QAEU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712663506; c=relaxed/simple;
	bh=IzzZL6bnEiczxvB63ldbyzTFH0H1zPjxpP/c3wQnHSA=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:Cc:References:
	 In-Reply-To:Content-Type; b=JFq+OtmFBWbQFnTsJIY6ZmdJH7HX+dwWHGfMcKOfSQolG7eXd1jHjk51kiF1tmzxuU/UrmZQwOl7MVvtmeBOo9QLjVbwijCBz1C0U6iHFYepUcSKMGh1EMSVeoG2ZcuU9A4BAYnJlbAjUj+R9gj2syvr/BpsA47eMqidB4zb4Sc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=dZo8aTjl; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1712663503;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=yHluCbH+Y4mvtj/fpytANH7A8mHkCJCLpNilx8K/sOI=;
	b=dZo8aTjlJRb9OhGnJuZ9zu3LDHf+vbP/tKVyK1jpldy7eMuta4zyY1V/tIPW6a/JEjiYev
	eOMNcr7xhwF3nCsMiwXPSJbne2A7z2axwzZtS0bXxXV1VHHv/cq6yHqjeg58XUf7mNoYLs
	Mx+/MuyD8gcbSQVY0dDV20E+7x3uzMA=
Received: from mail-wm1-f72.google.com (mail-wm1-f72.google.com
 [209.85.128.72]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-480-Wv6iifWmN0GBhpHT2MT96g-1; Tue, 09 Apr 2024 07:51:42 -0400
X-MC-Unique: Wv6iifWmN0GBhpHT2MT96g-1
Received: by mail-wm1-f72.google.com with SMTP id 5b1f17b1804b1-4154f2b314cso24824465e9.3
        for <linux-kernel@vger.kernel.org>; Tue, 09 Apr 2024 04:51:42 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1712663501; x=1713268301;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt
         :content-language:references:cc:to:from:subject:user-agent
         :mime-version:date:message-id:x-gm-message-state:from:to:cc:subject
         :date:message-id:reply-to;
        bh=yHluCbH+Y4mvtj/fpytANH7A8mHkCJCLpNilx8K/sOI=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXKyQ0frMknKF/fLJXI5LPKJ1r/RjjrAtVlvF4o6Za1/s79YS6jwb1vFdyotcknhAiumy2RLGE04CrOO8mTmWJSuHdOg0kqxyG9ml90
X-Gm-Message-State: AOJu0YyN3ElyVuSyoOPBqLWHDSMB/78IwawmItihcApKDI1JeqF1NvGV
	NK63XQF+XszvX4jLRIS+e3NZQvWSUVxbmr5REHtQoqvP3zE06BfOaV1y0tKQdquEfoUDkbgVNNk
	GeO3GCbTc6SgXi64E/1JhUk6d5mKonSDiyrdf8IQTbO5cCDbjoszN6y3pBVku4A==
X-Received: by 2002:a05:600c:46c7:b0:416:8d61:7c91 with SMTP id q7-20020a05600c46c700b004168d617c91mr2639775wmo.10.1712663501026;
        Tue, 09 Apr 2024 04:51:41 -0700 (PDT)
X-Google-Smtp-Source: AGHT+IHVbTWTzCNi91QmQkIQQO2XSJFyOTMurYu/SOT0UCQwKMIMmwJv9Wiv5ua3/RQfzgX5OxnGjA==
X-Received: by 2002:a05:600c:46c7:b0:416:8d61:7c91 with SMTP id q7-20020a05600c46c700b004168d617c91mr2639750wmo.10.1712663500517;
        Tue, 09 Apr 2024 04:51:40 -0700 (PDT)
Received: from ?IPV6:2003:cb:c70a:be00:a285:bc76:307d:4eaa? (p200300cbc70abe00a285bc76307d4eaa.dip0.t-ipconnect.de. [2003:cb:c70a:be00:a285:bc76:307d:4eaa])
        by smtp.gmail.com with ESMTPSA id w15-20020a05600c474f00b0041668770f37sm8066896wmo.17.2024.04.09.04.51.39
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Tue, 09 Apr 2024 04:51:39 -0700 (PDT)
Message-ID: <c0d66e0d-f492-49ba-b79a-9215317bd65f@redhat.com>
Date: Tue, 9 Apr 2024 13:51:38 +0200
Precedence: bulk
...
In-Reply-To: <d02959bc-84d8-4c74-a0da-9ad1159502e1@redhat.com>

Return-Path: <linux-kernel+bounces-110308-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 91B22885CFA
	for <lists+linux-kernel@lfdr.de>; Thu, 21 Mar 2024 17:06:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 12B14285C8D
	for <lists+linux-kernel@lfdr.de>; Thu, 21 Mar 2024 16:06:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EC6AD12C53E;
	Thu, 21 Mar 2024 16:03:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="OJtyg/0k"
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3439312DD84
	for <linux-kernel@vger.kernel.org>; Thu, 21 Mar 2024 16:03:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711037024; cv=none; b=hGxm/a7PSnT3H/CzgpiuCHwrCYAxj0nYTDyx/leTyBeIwRGQDEyVtwrqnqu7uwQUST9biY/bcNQ6Ib1cVBXCod+OqzL7aXMvioZQmLR1LLdIhV5YmKpO2/A01Z5vrffTQPWRD6K42GwUsrLE/2ionX26azlg69Qc1ho+LPViiLo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711037024; c=relaxed/simple;
	bh=V5OekrwV/HGB+yzq0ntCLGCuYe+yTGZcQhxCahuMbWU=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=jHhta9tCGfBMdNoIWXtTj3yoiNJtTiLPoRr9XkGIqAfkqkam5oLDIIG/Sw+xnYlu/iF2OV2A3oUDMXLlajSMLdO8p5EF9gnXX8gwX9zdKNfiXUoc8QH8oloLgIttqBqGApU/RVqaYRVLpeCyzD9keJQhubBvHDJdw1TqBGeyy9k=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=OJtyg/0k; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-609f2920b53so17683847b3.0
        for <linux-kernel@vger.kernel.org>; Thu, 21 Mar 2024 09:03:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1711037015; x=1711641815; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=fXANvNORShfrlDLwBjLCo0v80u1xy+lyJmjV1yEVQO4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1711037015; x=1711641815;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=fXANvNORShfrlDLwBjLCo0v80u1xy+lyJmjV1yEVQO4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW4XMbfOFMwM6/UQpzLh9ElFZXnazEulUCD9M4H3m0cAfQ1whNKndw+uq4Enw1e0kySA3cU1DmxIn7dGVjU4Nfp58Qc10UyWgNlGtB0
X-Gm-Message-State: AOJu0YwKLSPbjBNR7SWqQBRBXmJQkRRje1pFRBAKIlUorOGVSoRmknHI
	zYgNA1BqAdXbI2iWzK9oVvQNBlQEICDzeuKzck+Ty6EqpqMW9BuVht0+azwGwisIOYhPxwkfno9
	rrpJQ/g==
X-Google-Smtp-Source: AGHT+IFIR2HLaYw9/9Q5jGkTvs7qA1/tkvNJRMqcuZXUoO0N2RpMaVdds0fPVXqF1M1HaH+51QNTPtGWZ7qA
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:7f3:cf74:42c4:c0a])
 (user=irogers job=sendgmr) by 2002:a0d:d9d7:0:b0:60c:9475:f4c6 with SMTP id
 b206-20020a0dd9d7000000b0060c9475f4c6mr3998309ywe.10.1711037015238; Thu, 21
 Mar 2024 09:03:35 -0700 (PDT)
Date: Thu, 21 Mar 2024 09:02:58 -0700
In-Reply-To: <20240321160300.1635121-1-irogers@google.com>
Message-Id: <20240321160300.1635121-12-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v2 11/13] perf dso: Add reference count checking and accessor functions
...
---
 ...
 55 files changed, 1162 insertions(+), 732 deletions(-)

diff --git a/tools/perf/builtin-annotate.c b/tools/perf/builtin-annotate.c
index f677671409b1..889d8172e29f 100644
...
+		he->mem_type->self.type_name, dso__name(dso), nr_samples);
 	...
 	if (evsel__is_group_event(evsel)) {
 		struct evsel *pos;
@@ -488,7 +488,7 @@ static void hists__find_annotations(struct hists *hists,
...
index 2e7148d667bd..f60a7567da1e 100644
...
index d3ec244e692a..70cbe153b9dc 100644
...
index 043d80791bd0..bb21947f38c7 100644
...
@@ -1585,7 +1585,7 @@ struct annotated_data_type *find_data_type(struct data_loc_info *dloc)
 	struct dso *dso = map__dso(dloc->ms->map);
 	Dwarf_Die type_die;
...
index 64e54ff1aa1d..dff346f95a40 100644
--- a/tools/perf/util/annotate.c
+++ b/tools/perf/util/annotate.c
@@ -1815,8 +1815,8 @@ int symbol__strerror_disassemble(struct map_symbol *ms, int errnum, char *buf, s
...
@@ -1838,11 +1838,11 @@ int symbol__strerror_disassemble(struct map_symbol *ms, int errnum, char *buf, s
...
@@ -1860,7 +1860,7 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
 	char *pos;
 	int len;
...
@@ -1869,7 +1869,7 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
...
@@ -1903,20 +1903,20 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
...
+		mutex_unlock(dso__lock(dso));
 	...
 	free(build_id_path);
@@ -2202,11 +2202,11 @@ static int symbol__disassemble(struct symbol *sym, struct annotate_args *args)
...
@@ -2657,7 +2657,7 @@ int symbol__annotate_printf(struct map_symbol *ms, struct evsel *evsel)
...
@@ -2822,7 +2822,7 @@ int map_symbol__annotation_dump(struct map_symbol *ms, struct evsel *evsel)
 	}
...
+		ms->sym->name, dso__long_name(map__dso(ms->map)), ev_name);
 	...
 	fclose(fp);
@@ -3082,7 +3082,7 @@ int symbol__tty_annotate2(struct map_symbol *ms, struct evsel *evsel)
 	if (err) {
 		char msg[BUFSIZ];
...
+		dso__set_annotate_warned(dso);
 		...
 		ui__error("Couldn't annotate %s:\n%s", sym->name, msg);
 		return -1;
@@ -3091,13 +3091,12 @@ int symbol__tty_annotate2(struct map_symbol *ms, struct evsel *evsel)
...
@@ -3116,7 +3115,7 @@ int symbol__tty_annotate(struct map_symbol *ms, struct evsel *evsel)
 	if (err) {
 		char msg[BUFSIZ];
...
+		dso__set_annotate_warned(dso);
 		...
 		ui__error("Couldn't annotate %s:\n%s", sym->name, msg);
 		return -1;
@@ -3127,7 +3126,7 @@ int symbol__tty_annotate(struct map_symbol *ms, struct evsel *evsel)
 	if (annotate_opts.print_lines) {
 		srcline_full_filename = annotate_opts.full_path;
 		symbol__calc_lines(ms, &source_line);
-		print_summary(&source_line, dso->long_name);
...
@@ -3941,7 +3940,7 @@ struct annotated_data_type *hist_entry__get_data_type(struct hist_entry *he)
 		}

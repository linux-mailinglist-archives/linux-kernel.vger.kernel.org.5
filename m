...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BE55776B266
	for <lists+linux-kernel@lfdr.de>; Tue,  1 Aug 2023 12:53:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231454AbjHAKxp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 1 Aug 2023 06:53:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34778 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234105AbjHAKwW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 1 Aug 2023 06:52:22 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D426F359F
        for <linux-kernel@vger.kernel.org>; Tue,  1 Aug 2023 03:49:27 -0700 (PDT)
Message-ID: <20230801103817.786370765@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1690886860;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=dj21GG+2OIX1Rs+wEX+47dOzfVF0PHc+KOqDglhdL7U=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1690886860;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=dj21GG+2OIX1Rs+wEX+47dOzfVF0PHc+KOqDglhdL7U=;
        b=/rYxxnBn9Q0xun5mvTlWH6zYxWTMXmE09Qb5x2NDclL4BrfwuvWjr19JivxING7XKediIv
        6ZE68Jqx5aqZKUDQ==
...
Subject: [patch V3 48/60] x86/apic: Remove pointless arguments from
 [native_]eoi_write()
References: <20230801103042.936020332@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Tue,  1 Aug 2023 12:47:40 +0200 (CEST)

Return-Path: <linux-kernel+bounces-94172-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 33A36873AE2
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 16:38:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D0B052826E1
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 15:38:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B4F371353FF;
	Wed,  6 Mar 2024 15:38:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="3z22kt0M"
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (mail-bn8nam12on2080.outbound.protection.outlook.com [40.107.237.80])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D4D6C1353FE
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 15:37:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.237.80
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709739480; cv=fail; b=OgfbOvUMAlWO2shtK/FO5Mmo+PNRMqQ8Zx4hkbxRpzjtoQdvdplW0WlYJcVg6sm+tr2dB8O5wtUDUc8TuX2vO42VHSIokN8GjnyTGMRKxzL1pKBGQYBJxb+OUgxEdVEnEZhSAhQnu6B69BjHGO+HEvGiCSDmglnWdK2FN4O5ku0=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709739480; c=relaxed/simple;
	bh=i7Fp3pcI7+nn0ctEHMOvKszoJWBWLrRGxTA90AV2gDw=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=u1c2FLVUF+fHgSiWwGHbMQVddZ+HYw5V53jA0bBgwgYh5HAhx56dmw7s6c6q2nBENv/paj8ut8ak2ju3xMvV2hQ+mhG5zrR8lk0XbqJBYLu2FLOGjHBnMTLm//6lmbusncTXV/EAn2/RSlvD4lsAIu3NMrbSyTteq7sqlo2FdPY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=3z22kt0M; arc=fail smtp.client-ip=40.107.237.80
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?MEEwZi8xeEROZkRNSkEyemU1em1tNXBpdXc2VjNZYUFSei92SXdHbHY5alo0?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 Mar 2024 15:37:54.6606
 (UTC)

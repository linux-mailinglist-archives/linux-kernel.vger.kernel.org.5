Return-Path: <linux-kernel+bounces-131006-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id AE4358981DB
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 09:06:14 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 35B221F23125
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 07:06:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9ABD357899;
	Thu,  4 Apr 2024 07:05:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=suse.de header.i=@suse.de header.b="BHMMgYkU";
	dkim=permerror (0-bit key) header.d=suse.de header.i=@suse.de header.b="DMflKcu2"
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BFAC555C35
	for <linux-kernel@vger.kernel.org>; Thu,  4 Apr 2024 07:05:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.135.223.131
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712214353; cv=none; b=lKTZfwN+xEZ0jcOOx7A4TcVe6EvadcrI5PcyKvMAek6di60vPFRgqELzAjsSvXbkpo6PsXynCgW0eL2DHnXGrSDh+I8tTBQYTMGxBHWkrDNBcpbaJWSA7JEuFbOUZA3sPI1eL9Jo+u1ztLIuaqU9iwCB8vHnmXUS0fALB40OclI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712214353; c=relaxed/simple;
	bh=+Yw303P06vUpHeiNshxkqg3FhelxXe2YPfl+wBWNLgM=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=ebncDS2zI8TOpcv+uREPmYrDTUzQiAmDJXsvkQGeVNJd1ZKjWv8OCqGX/Ei/VtwgpvgR8XJvY0rvV20liWhhTu3z5FoB3FFw8kS5P7CI97K0cVxwv4PhJ9CS79NIGwGUe0oNzGvV1m8MFyahpcxBcVU0NjrzEkx7yZptxL44qH4=
...
Received: from imap2.dmz-prg2.suse.org (imap2.dmz-prg2.suse.org [10.150.64.98])
	...
	(No client certificate requested)
	by smtp-out2.suse.de (Postfix) with ESMTPS id CF8805D673;
	Thu,  4 Apr 2024 07:05:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
	t=1712214349; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=ghkXx40nWEPSM9bclOWwsS092PohOPXWVqRF6XEBYQE=;
	b=BHMMgYkUiju095r33Rm4aFYQVJAwhFlIDN4uo666GZf1EZGTkXYRxMz5A3BQTzfRhJ8oNb
	CtTBgFODKCu7/cFXbTZUQheOsQIhLtf4bHs5qlDS6ulVH5UdWyu5SiRrmOxqe0qk6e8ihl
	+wYgMi7rurqELUnAhNYcjr67THsJgts=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
	s=susede2_ed25519; t=1712214349;
	h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=ghkXx40nWEPSM9bclOWwsS092PohOPXWVqRF6XEBYQE=;
	b=DMflKcu20nVPELyns9/pBRYiLwB8A3fIMLkoYrZfn85iYZ6nYiNRUcVI529KzKH7zGBig0
	jJO3FfEYbmXXKABg==
...
Received: from imap2.dmz-prg2.suse.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by imap2.dmz-prg2.suse.org (Postfix) with ESMTPS id 370B413A91;
	Thu,  4 Apr 2024 07:05:49 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
	by imap2.dmz-prg2.suse.org with ESMTPSA
	id wAuiCk1RDmY6cgAAn2gu4w
	(envelope-from <osalvador@suse.de>); Thu, 04 Apr 2024 07:05:49 +0000
...
Message-ID: <20240404070702.2744-3-osalvador@suse.de>
...
X-Spamd-Result: default: False [-1.77 / 50.00];
	 ...
	 MIME_TRACE(0.00)[0:+];
	 FREEMAIL_CC(0.00)[vger.kernel.org,kvack.org,suse.com,suse.cz,google.com,gmail.com,rivosinc.com,suse.de,syzkaller.appspotmail.com];
	 RCVD_TLS_ALL(0.00)[];

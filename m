Return-Path: <linux-kernel+bounces-64533-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 0566A853FFF
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Feb 2024 00:22:37 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 844B61F225F7
	for <lists+linux-kernel@lfdr.de>; Tue, 13 Feb 2024 23:22:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7D35D63100;
	Tue, 13 Feb 2024 23:22:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="WIMjLrik"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7A05463101
	for <linux-kernel@vger.kernel.org>; Tue, 13 Feb 2024 23:22:16 +0000 (UTC)
...
Received: from mail-wm1-f69.google.com (mail-wm1-f69.google.com
 ...
 us-mta-147-6TKqYwBXNNemVmsk75VpwQ-1; Tue, 13 Feb 2024 18:22:14 -0500
X-MC-Unique: 6TKqYwBXNNemVmsk75VpwQ-1
Received: by mail-wm1-f69.google.com with SMTP id 5b1f17b1804b1-40f01cf71ceso30194815e9.1
        for <linux-kernel@vger.kernel.org>; Tue, 13 Feb 2024 15:22:14 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=cZAfitLnBMjrYyoOukrJIwYyfYo9MO8Q5HzfCPeVj3g=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVxexU2BIbPQTfY2PZNGtD3Nt5c5eSlMcpilmy4ozhcyJycKs9YHbtEBZi6gQqyGjL9INoe+vHJE1/sKz2t26dz8pW8xAFbX/rnYvMd
X-Gm-Message-State: AOJu0YzwgvJsNX0iei3plrgvsW0DjAlJklq+BpaGNpL1U8zEgyCcVWjG
	SdYJVC1YgFav+lYolONY+IHzevKqTh5vAY2zC1gKWP7vIj3lQXXGWVnZb+hcTssuh5BV77snIgp
	qaOaD1jy6pBobdynkhqEh9LHWjyKneZ9lCHcYLxBkXsS8tdX0nNIvqN90JBUsIQ==
X-Received: by 2002:a05:600c:4f0e:b0:410:df8f:9ffa with SMTP id l14-20020a05600c4f0e00b00410df8f9ffamr700140wmq.25.1707866533008;

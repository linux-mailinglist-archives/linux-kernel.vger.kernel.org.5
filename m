Return-Path: <linux-kernel+bounces-154500-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C08F8ADCD3
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Apr 2024 06:27:55 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 8FF16B22B44
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Apr 2024 04:27:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DBACA200C7;
	Tue, 23 Apr 2024 04:26:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="PjG3hdkc"
Received: from mail-yb1-f202.google.com (mail-yb1-f202.google.com [209.85.219.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9B5282E633
	for <linux-kernel@vger.kernel.org>; Tue, 23 Apr 2024 04:26:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713846397; cv=none; b=e+4uSAI+gWVeyq8Gn3mQdirwtviGoIrUAcfLR306tTqXLfLMDn2TNu/VdWaFyZGqv3etF8q2nEWiiaJMr2vGtZWe8l8Vq+TbV5aZZKVwNoudELdgCbpb8eBTcQ6wZPyCvQHtcSfES6i5P4SxPtWj55mWegw6JbZIwHeYJL9EHLw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713846397; c=relaxed/simple;
	bh=UTxelfgn/NP6KqTtuDstAHWAUd3MVs0zQWTjQf9/5To=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=sQjtK+1tkjrQp21oT1b78JJK3T8DTENmpDCkQxsa5nIVMxAAvK7rPhSb+nJCjvK5VASTgYVjq8ysir1fcLGs2c+ybl8NaQxq/MjRPp8XtheY+iVFUnaB9WxjTjcpZEzMmeNec92eFaW3vqCns/UsyA0BnFGFfgnqsZXO5WZrnpI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=PjG3hdkc; arc=none smtp.client-ip=209.85.219.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f202.google.com with SMTP id 3f1490d57ef6-de465062289so11721099276.2
        for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 21:26:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1713846394; x=1714451194; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=0GpE3k2HUqwCUngw35FiLfWVB3EVA72rLEwbUIc8rrM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1713846394; x=1714451194;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=0GpE3k2HUqwCUngw35FiLfWVB3EVA72rLEwbUIc8rrM=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU9QdPTPFhv67pCMQepLOGhBW06CRnt6xmggGcPMLlGLqWnpDw8QI2vrURo6W1Y+cK8DAGvpTYfXBsWqJoS5u7MIHUKOU1AgFEnNUAh
X-Gm-Message-State: AOJu0YwtdYXaYOHInWiBHOozhC2hRLWjOG5YX0Epzo9sZPUyVHjvQwvI
	OV3UPD9Dv/iXIxUlqmMD8LBa6Wu3a/9JakUDSUGBk+EBgenejA+5koO7FnABAANw3rt88MZ1+7z
	FA8cnHg==
X-Google-Smtp-Source: AGHT+IFVPWmxRGL04x/P0fS2IA+wUTq9bJheRqDDlgRKnYkyhhNF0VQNhn17LFKJ37nkHsBQVoNUkgrjYvP4
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:4ca4:4d48:a7fe:d70c])
 (user=irogers job=sendgmr) by 2002:a25:bc2:0:b0:de5:17cb:8334 with SMTP id
 185-20020a250bc2000000b00de517cb8334mr1716652ybl.13.1713846393722; Mon, 22
 Apr 2024 21:26:33 -0700 (PDT)
Date: Mon, 22 Apr 2024 21:26:00 -0700
In-Reply-To: <20240423042601.2009469-1-irogers@google.com>
Message-Id: <20240423042601.2009469-7-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v4 6/7] perf dso: Reference counting related fixes

Return-Path: <linux-kernel+bounces-61481-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A95D8512D9
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 13:01:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id B13141C212C5
	for <lists+linux-kernel@lfdr.de>; Mon, 12 Feb 2024 12:01:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 295273EA68;
	Mon, 12 Feb 2024 11:55:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="dA8wr7+C"
Received: from mail-ej1-f49.google.com (mail-ej1-f49.google.com [209.85.218.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0DA793A8C7
	for <linux-kernel@vger.kernel.org>; Mon, 12 Feb 2024 11:55:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707738939; cv=none; b=i6mgeARdy0rDMd86ucr1chVvheHQ4NjNCIvZwEkrAH3hCJVrp4BXHsr6okkNmSIuDpj2XC1fpl5oNMqTlwlvSkUKivLCRo8rUm/lkUEQNnf1kaBAKhfymcuScNUxzqONLVs9BtUsnmWcBB3XNi665qoAInbzDNbnT/ILiXYijIw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707738939; c=relaxed/simple;
	bh=9ERRHChLNEstkc4Om7BDPnXD+bWQHDOsgoH571T3fJs=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=DQWOvEQzV4A4C0uTE1u8vzr9gWjx+Woka0TRxzlvrjgHy3pAv6zjb4ibdoXkIl4o0Y4Hhbsa+O5PZE94QCTrijSHp4L8TxR63GoErnO9JsLU0h6mTcAK+rb71Ph1KqAV5VAxhjvEep45F7I4RlpBe5t3hH3PMNaO3bGlDfJYoXc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=dA8wr7+C; arc=none smtp.client-ip=209.85.218.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ej1-f49.google.com with SMTP id a640c23a62f3a-a3ca07df603so95043566b.1
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:references:in-reply-to
         ...
         :message-id:reply-to;
        bh=dQAFJJWcWHNSxMp1F54bn1gLDUGPoV5basmkleb86GI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=dQAFJJWcWHNSxMp1F54bn1gLDUGPoV5basmkleb86GI=;
        b=
X-Gm-Message-State: AOJu0YxCXWye1PUcxKVXXWqkBa1R3AdMVrQ9/uROdcSC25vrIaA6uWN8
	wOKQPOGWroMhg3uk2TiiuETyVjCPXi0G7+y7G8G7oGtmMr2dvqQhlj9WVTczBS8QEy54c4hWGvi
	U
X-Google-Smtp-Source: AGHT+IGLvLZEAAx+UUY7MkIB+8AD73P90A8/Bz1InOu2sSs4Cj/7wgq+y9XE7AOlrE8xrpvFVk092Q==
X-Received: by 2002:a17:906:c5b:b0:a3c:19a3:310d with SMTP id t27-20020a1709060c5b00b00a3c19a3310dmr4735188ejf.30.1707738929727;
...
Subject: [PATCH v5 16/35] device.h: move declarations to device_types.h
Date: Mon, 12 Feb 2024 12:54:41 +0100
Message-Id: <20240212115500.2078463-17-max.kellermann@ionos.com>
...
index 0f4a9fe037b4..6595107bdf3c 100644
--- a/drivers/cxl/cxl.h
+++ b/drivers/cxl/cxl.h
@@ -7,6 +7,7 @@

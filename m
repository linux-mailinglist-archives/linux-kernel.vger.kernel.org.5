Return-Path: <linux-kernel+bounces-128359-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8423B8959D7
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 18:39:45 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 39C8D287676
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 16:39:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C6C0E1598FE;
	Tue,  2 Apr 2024 16:39:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="O5PJw0jF"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8F4B52AD1E
	for <linux-kernel@vger.kernel.org>; Tue,  2 Apr 2024 16:39:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712075979; cv=none; b=tTljaQAh7Gf6jhOzOyED3pa9gRkt1ZzrRCwb8xAABV4Jys0u/BQLaORGRB6SOseX3l/YzjlIlksDvTZk23YgQ0JpPTg3FAYNQVtT2hSY7TMvBWRok2cgqfZo9i0AI5KWYgpBYGE2RKMEn6TxOcbzk7KGQLPfHWS2VcNA6JwoQH4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712075979; c=relaxed/simple;
	bh=x2oTfh4Fh3MSJwHlP9ieTU3EtSKtRlBmZRnTn9ocxPg=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Qcsr1yOoUP4kwayhqiXnGbRez31Dxb0hqq7CtzgKgav73QxB5EPOcaaE7+7ub5mY2AOPsgoe3kZXRaJWom0FlXVpCAmH72GhJ+5RLZ6cvzsrHd4Vavrddt+lBy+QqHk/g8voYrAf8CE5asKW2LTZpOGpKEIBnX2YE4Wsv2J3+Mk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=O5PJw0jF; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1712075976;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=1iho2fHVZbhIBfU3vzg6gBJfNoVNEa84mgMip0YsLq0=;
	b=O5PJw0jF/FNPmewgYV0f9daZyg5wLXMbSY7r/WUG3H+U77G5qaJOHs52NkfPShKzeYlrBH
	Yl6fv8WquY02Xhv4Zw/rAVLMhQsFUNWtrierF+RX0lzby3EX109ndmHoNIpu6kzEM7fCkT
	jciq/clVhT9bI2wAgOyg9Fnvre/XUzg=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-198-egSKkERIPqCV8NrBnrVfBQ-1; Tue, 02 Apr 2024 12:39:35 -0400
X-MC-Unique: egSKkERIPqCV8NrBnrVfBQ-1
Received: by mail-wr1-f71.google.com with SMTP id ffacd0b85a97d-33ed44cb765so3047960f8f.2
        for <linux-kernel@vger.kernel.org>; Tue, 02 Apr 2024 09:39:34 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1iho2fHVZbhIBfU3vzg6gBJfNoVNEa84mgMip0YsLq0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUVq8vrCwxzmmgQ//tN2+mdaRLD27pY6wqCkSV+78OyDqrpCkDo6vgTKK01486H5Qxi3ca5MtNOQNacErL+9KqNWwk3VmvRT06kWLrV
X-Gm-Message-State: AOJu0YzpBRftNAdZfm8++jXDkxXR/OBcqFk9n9yO2jGUAqYzs6LUkbU6
	sxUsP6Vwc5lpCaHqx7Bn7QrxWIkgF82IACO/BcJY2KVi759x9sp7MlM/Ps+mz+3g92mDBXeHwUJ
	D1Tyb3T9RGjsV48aFJsFWoZvOrTUXy9pPBoG9X2QMDtN+7700yUH7PgtTW/SAow==
X-Received: by 2002:a5d:4145:0:b0:33e:19ae:3716 with SMTP id c5-20020a5d4145000000b0033e19ae3716mr7756499wrq.11.1712075974029;

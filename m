Return-Path: <linux-kernel+bounces-129664-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F261896E3D
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 13:33:32 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 89F241F2723D
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 11:33:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 86CAE14386C;
	Wed,  3 Apr 2024 11:33:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=google.com header.i=@google.com header.b="izNe8/tk"
Received: from mail-vs1-f54.google.com (mail-vs1-f54.google.com [209.85.217.54])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A05131420BC
	for <linux-kernel@vger.kernel.org>; Wed,  3 Apr 2024 11:33:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.217.54
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712143999; cv=none; b=KEcsg5D1zhN0gtjMp0f/dkWtBuiUc86a+ph5OCOtyMgkmjHE0ZQJ6vudEYUShY4PgR/J9vDBWsyDkYjKWOsgLrjXOGDfeE6uHAjE/1vjmtSgd9L5OyXftuvFbSZF4Wqn5MBu55x4Ht0J8DM3T9dkjHAgf9aP97s7vBz0mycqrSI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712143999; c=relaxed/simple;
	bh=tsEJprSITMHrDUel9OreTSksKpgQfpmMDQeIlZCSXP0=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=WIEv3o68r8KMamS/D2nGn2k/iVLFCWbW/iLVpOW21MrNsMLelImuLAE4J1vGnAknF5idTVibykv28WD/x+PZKUw/R8byQgZdm8U6895jE4weePxuG6CMAKDJnyjpif38EMg7tcoxhKNuvyB5D6hpiM46j7o/Vq+QoOv2/oP0Pa4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=izNe8/tk; arc=none smtp.client-ip=209.85.217.54
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-vs1-f54.google.com with SMTP id ada2fe7eead31-478913f1e48so544979137.2
        for <linux-kernel@vger.kernel.org>; Wed, 03 Apr 2024 04:33:16 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=/tl8APPri0E/l7pJOTr4H966sbHOCV8rek6AbY70NUQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCW+RN4vBoDebi0sY58sYoiy1JkXBkrD2hCx9YJSidz/QMyQgv6uKc3DthvxshN4feK0KN23Z9dte4l2R4wIcSPVZSS8tW0HDBYXWVL0
X-Gm-Message-State: AOJu0YzrOcJ67yJ8XIYRKIYODbJQswJ8R3Ha/zfYdOQim+dvY3aZkdM/
	M/PFNyVViZfc8Uvhd9X3FVIDZTJTg2RO6P1WOLps+R1hkWnbvIDiaFbGC2maivTukJegT2xtlrF
	MDhLOJXatbisyBNko1fWjD4YzbGhuADROuQwT

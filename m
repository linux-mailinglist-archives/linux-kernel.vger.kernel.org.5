Return-Path: <linux-kernel+bounces-68961-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 48B6F858289
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 17:32:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id F315D282392
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 16:32:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8615B130AD2;
	Fri, 16 Feb 2024 16:32:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="RCY6fnZL"
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2064.outbound.protection.outlook.com [40.107.244.64])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7C65412FF97
	for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 16:32:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.244.64
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708101138; cv=fail; b=VyBEawrk+Ig1CvtftUgCsFR5boqBkFEzOrEUicHRSkytn7bkz0P7u0c+2wxGLUzoceb/QGPTNe2CJKBdgfqOU7SMPgJcdc8oBQSqrlojwQlrTsu2beQjipma8w2Q8sjAgpnOYVsVg01OVCwWVgamb4iFcB3Ubh6Tjf4yzrJpih8=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708101138; c=relaxed/simple;
	bh=TRtoki5d/ZwzZEC8oQVRMq+kG+eiOxecMVtUIX8SH38=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=pD8Q+BkFV5+sA1rhHJ3HtgoHePAyOWDuA7AuexbnGIO35Z4u+bbACUe+0BAk8vsiSFJNw2UGlHfQACVJziATHzTwU0CvGcvFim/91h3YpnOM+s0QGeW5pqf97ouz1zf7hruub44yMWGXX2MiOKSkQPLvCuSnoO3/PfshqY6S3lE=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=RCY6fnZL; arc=fail smtp.client-ip=40.107.244.64
...
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MN0PR12MB6101.namprd12.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(39860400002)(396003)(366004)(136003)(346002)(376002)(230922051799003)(451199024)(1800799012)(64100799003)(186009)(6506007)(478600001)(6486002)(66946007)(6512007)(66476007)(966005)(54906003)(8936002)(53546011)(8676002)(41300700001)(6666004)(316002)(4326008)(38100700002)(110136005)(86362001)(31696002)(66556008)(83380400001)(2616005)(26005)(36756003)(5660300002)(31686004)(2906002)(44832011);DIR:OUT;SFP:1101;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?dWxpR1U0QjNiN3U2Y1h3dEdFVGM2YVR1NU1OYmRGMGpTcEk4cG9haVhBcTU5?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 16 Feb 2024 16:32:13.9428
 (UTC)

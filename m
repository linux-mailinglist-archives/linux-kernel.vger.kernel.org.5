Return-Path: <linux-kernel+bounces-101206-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C33387A3FB
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 09:16:02 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 8FA481C21942
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 08:16:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EAD1221A0C;
	Wed, 13 Mar 2024 08:15:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="CtjPHJex"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B7CDF1CA80
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 08:15:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710317718; cv=none; b=OYvsvUaqiiDEpfW1/A0/tOoUfgQM1HyWRGFZ0EdR5zKzwJ0nIbsXcF1h92xN/ZYCthS+efyZ8Aol1xc05X/oRrCf+Q7CfpAXq0jRGGfHX3gOcDsBVWtGRhoAjmMyn0tuAiPnPzL83qBvOp8a4ehvfOFkpVVDXqXsqBPSi2flXQg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710317718; c=relaxed/simple;
	bh=nEffeaEkUXeL9ZZoT5q8k9bvL4SIKdrRskLsclcByxU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=G4qA08MhD3R0tIdWuzr3GyHGeFMSoPhpXlPoTyFXpKv9qwkUD8iEfU4g/RgVM0u5BOxWuPf5zYtWTQTydzY/t48So0BBBJEhbJJiefpJ+edohQWKirlEgbB+HlSP29zXqTDUUbPO9o2XSEzBlrbdNDLkjnRFY2qt+V4Ohaw4Yo8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=CtjPHJex; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=CtjPHJexmYAGl4DLY6uhsXmWYBcT8sqS3SUAP7/F1RYeY6+2C4eRjcn+Ld6Pq2638jS6Sr
	zB2rEcYCeVJITRDlzYMLOldYE1ncKA7nLwLR580e60yUP+0ep2S+VYUWmpUjoFHvMrZRy3
	07+c57KGyh4WwiOinUKIRVsKgMVEIb0=

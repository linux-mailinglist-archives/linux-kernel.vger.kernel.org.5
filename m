Return-Path: <linux-kernel+bounces-44263-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id A17D6841F96
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 10:33:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2F41C1F2331C
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 09:33:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 31447605B7;
	Tue, 30 Jan 2024 09:33:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Q2hjl6pI"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 20A2159B7C
	for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 09:33:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706607224; cv=none; b=JypLnU9HGygX2jwytBPSZPdL2EgLitVJ9FyPV9LjOWDHxhVX78nUvfPasavd6YYCMyBjsFRzhbliOc4or5ubxZFULLZiRMX0/nLhalHMOBiBF+yOCUUySGk0vw3YEvAO2O0iOxm93C+shzj3SLQzvK3Rtw8TGBhV7g9U50Q0/y8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706607224; c=relaxed/simple;
	bh=wtG2w+BVmY9I4qEQwqYrx4XrB35b0l1YgsEy73E31FY=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Bn0b7yIx1s44d4rxqQxKWeb/xBfbHbPM/QT9wOj2x6QBezkNTIUqVRUMJdLvg8uAnnz1qZy3neWkXKp0inYXazYTfJ6S+gzK0BYX88CXhCykp3vsEDRRr1XScZhl69dEKDC+eHJQsvfqmAPjX/qiNKZyaXfiNH6PowKXj+QMW2A=
...
Received: from mail-wr1-f69.google.com (mail-wr1-f69.google.com
 ...
 us-mta-510-8W6r6GzGOfyziw6ftFPqOQ-1; Tue, 30 Jan 2024 04:33:38 -0500
X-MC-Unique: 8W6r6GzGOfyziw6ftFPqOQ-1
Received: by mail-wr1-f69.google.com with SMTP id ffacd0b85a97d-33aec659d0aso888047f8f.0
        for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 01:33:38 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=r8m7uPOH6IrpXxOx1GhKy9Dm1H+TruM8yPB84uxSQyo=;
        b=
X-Gm-Message-State: AOJu0YxKu5QaY6w9dU9FBo4WT141twg9y5vS+BYbk8UZ3wGpyIt8Y4a1
	6GzG4tgSxHM5thyPlFt5efHbPrzFi0HDJ7Onp1igqwajbW3WqZxT7UZPvlyZ6x32MDWHzPNRYoB
	LFHvGTZ5kVufUcMR3oAK2KV6sEWPdRxCfFipgH8olzyLxjaRQf+UGu34dQdHVfQ==
X-Received: by 2002:a05:600c:3b29:b0:40f:a661:d2b with SMTP id m41-20020a05600c3b2900b0040fa6610d2bmr357997wms.13.1706607217275;

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A599F7EE26B
	for <lists+linux-kernel@lfdr.de>; Thu, 16 Nov 2023 15:13:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1343566AbjKPON1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 16 Nov 2023 09:13:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60934 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230307AbjKPON0 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 16 Nov 2023 09:13:26 -0500
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AE734B7
        for <linux-kernel@vger.kernel.org>; Thu, 16 Nov 2023 06:13:20 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1700143999;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
        bh=G9x4uAI8y2q2wz2ZsP3GSuMiBRjZvjNFQepXOLiWalk=;
        b=TcBK7hbR3KRZS2zy9KsIJ4M257btGHklm1C1kh3RmLzDP9bV+cDxG+S1maP+4FuxKW3i2a
        vk28qXke1dbBPnedbmE4qBixLIP63royZUD59rVtQ4d+y8IiTZzpEIZiFmZNHupHVZc8x5
        2MkEeyt9WRSvRocCE2DG5k4UQJhrx4k=
Received: from mail-lj1-f198.google.com (mail-lj1-f198.google.com
 [209.85.208.198]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-176-5ImDPdg-PRqrEr-MAY5Ndw-1; Thu, 16 Nov 2023 09:13:18 -0500
X-MC-Unique: 5ImDPdg-PRqrEr-MAY5Ndw-1
Received: by mail-lj1-f198.google.com with SMTP id 38308e7fff4ca-2c51a7df557so7863561fa.0
        for <linux-kernel@vger.kernel.org>; Thu, 16 Nov 2023 06:13:18 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1700143997; x=1700748797;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=G9x4uAI8y2q2wz2ZsP3GSuMiBRjZvjNFQepXOLiWalk=;
        b=
X-Gm-Message-State: AOJu0Yy1iubyUJE9IvwGx80Bi4Gak6HmkCELNlJHPlFlIkq5bFA8b7fU
        EZR8jaidiXLHl8BGNrV/65R4b2Qb+I4rj85jnMMg7MraND1kgNtlQPb84+T5sGs81TIueTlzngM
        o5tmry6tDwFj5Pu1W4Edhyric6SEY4y/a
X-Received: by 2002:a2e:88cc:0:b0:2c5:2184:c53d with SMTP id a12-20020a2e88cc000000b002c52184c53dmr6683802ljk.25.1700143996674;
        Thu, 16 Nov 2023 06:13:16 -0800 (PST)
X-Google-Smtp-Source: AGHT+IHNWVjYo7MQfonLUS8AYQhuyTmpwOzAHSzNEdoBthTnlNCbco9ZSbwSKxCDALppUVHRPicIFw==
X-Received: by 2002:a2e:88cc:0:b0:2c5:2184:c53d with SMTP id a12-20020a2e88cc000000b002c52184c53dmr6683784ljk.25.1700143996163;
        Thu, 16 Nov 2023 06:13:16 -0800 (PST)
Received: from ?IPV6:2a09:80c0:192:0:5dac:bf3d:c41:c3e7? ([2a09:80c0:192:0:5dac:bf3d:c41:c3e7])
        by smtp.gmail.com with ESMTPSA id s16-20020adfea90000000b003313439c675sm13765369wrm.66.2023.11.16.06.13.14
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 16 Nov 2023 06:13:15 -0800 (PST)
Message-ID: <2618b024-6a95-4bfc-a08d-59d86e9931e5@redhat.com>
Date:   Thu, 16 Nov 2023 15:13:14 +0100
MIME-Version: 1.0

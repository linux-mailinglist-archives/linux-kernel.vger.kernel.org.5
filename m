Return-Path: <linux-kernel+bounces-87887-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id DC04F86DA84
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 05:06:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 90700282C20
	for <lists+linux-kernel@lfdr.de>; Fri,  1 Mar 2024 04:06:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D1A4847F6A;
	Fri,  1 Mar 2024 04:06:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="nNA8vEQP"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 651113FE54
	for <linux-kernel@vger.kernel.org>; Fri,  1 Mar 2024 04:06:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=198.175.65.18
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709265971; cv=fail; b=YR16GkeEwmK+IQV7gql1h4ZKAGD/WxnEytUNZ7Wm1KiCmKGIL8i2Lv9GgSeHFaM+gOuppvIt8apFB7lJo9nWD2Xv56o4sWkfOeQTJuvWXEZo5K06bO+m09Pw2cGErQI+XP7EYyLnvVBW9KTGOnI/lG6uCgn8m2ecZAsRKeJRdVk=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709265971; c=relaxed/simple;
	bh=RARxjMjorndujOXt7tW8m6LxDP++yid21v5Hk1Y3XOw=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=MAVtLLnEpZO6vFN8srKdsHJ8VKY2nmY9Mm3yxJRzQBRVbPZtRLhQnNpmQOpFfGwxh8ih0E+ek8+SnjD+qjiOTWEbk3qE7/Y2ww0NYnalvDmGegzDmZQQX3cWENfHDDVMqfxjq0j9I8hUS/3uu+37VrmNdkoA2SAPEI4J7bPYaWw=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=nNA8vEQP; arc=fail smtp.client-ip=198.175.65.18
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=nNA8vEQP3DEyzS55x2hbQZRZjMzLixakO3XEgoleaaYztfttNSO6HQsk
   ...
   YZujI0IJMkDwfyu5ZkzJPju40B0iEZETGLbYUlOiVfYM3xqR0nJJ1RNwP
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10999"; a="3903137"
X-IronPort-AV: E=Sophos;i="6.06,195,1705392000"; 
   d="scan'208";a="3903137"
Received: from orviesa002.jf.intel.com ([10.64.159.142])
  by orvoesa110.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Feb 2024 20:06:09 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,195,1705392000"; 
   d="scan'208";a="38904572"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
  by orviesa002.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 29 Feb 2024 20:06:08 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 01 Mar 2024 04:06:05.2653
 (UTC)

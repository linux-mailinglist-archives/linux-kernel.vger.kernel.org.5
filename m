Return-Path: <linux-kernel+bounces-41010-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A050883E99A
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Jan 2024 03:15:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 91A231C2359C
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Jan 2024 02:15:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7DC121D55B;
...
Received: from out-183.mta1.migadu.com (out-183.mta1.migadu.com [95.215.58.183])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 45ACE125B1
	for <linux-kernel@vger.kernel.org>; Sat, 27 Jan 2024 02:08:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.183
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706321326; cv=none; b=IG5iWLfUS/RygSZGdk3Y3p4NDefZ/aDCGjaSstrk7EIAX5sT35JcHKRFpAUgWiXv9NG/G6dgzZdedvX960c2LdIEWEH7ZPfHvuLlTiFXIq1CaFt2G5+G3xXb1ekSgzGDGsLt1DLdapkKARn7aJdXRF1TEc1PR+z9mckR9++K7KQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706321326; c=relaxed/simple;
	bh=NB0BzrAcaq2ykZlOjZmEopevoBwZpfcanoIfs3aB2/c=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=elcJBoaDqX0Rvo/jmfcIpv1AQQ/V8I44EVGs9xDSnaEthzD6VaBtExNYiOSnQSRO+cIqfwOqinbh8uTyhpRu+PUlZr5+eqhPxxs7+/23LZkXxnKjSafmFG7XQZ1h+DDx8mn2uOFTJ+K0RgbiT4plOxpvvUFxy54HJ83ikWeCd2Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=aJfiHuzw; arc=none smtp.client-ip=95.215.58.183

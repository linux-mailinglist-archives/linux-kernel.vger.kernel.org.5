...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4747577B30D
	for <lists+linux-kernel@lfdr.de>; Mon, 14 Aug 2023 09:54:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234338AbjHNHyC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Aug 2023 03:54:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43424 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234217AbjHNHxp (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Aug 2023 03:53:45 -0400
Received: from albert.telenet-ops.be (albert.telenet-ops.be [IPv6:2a02:1800:110:4::f00:1a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D42299F
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 00:53:42 -0700 (PDT)
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed40:b7e3:9ae:a42e:8138])
        by albert.telenet-ops.be with bizsmtp
        id ZKtf2A0091ziGSW06KtfbK; Mon, 14 Aug 2023 09:53:39 +0200
Received: from rox.of.borg ([192.168.97.57])
        by ramsan.of.borg with esmtp (Exim 4.95)
        (envelope-from <geert@linux-m68k.org>)
        id 1qVSOL-000Y0Q-O2
        for linux-kernel@vger.kernel.org;
        Mon, 14 Aug 2023 09:53:39 +0200
...
Subject: Build regressions/improvements in v6.5-rc6
Date:   Mon, 14 Aug 2023 09:53:39 +0200
Message-Id: <20230814075339.3360163-1-geert@linux-m68k.org>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <CAHk-=wg4pV_H8bWsfWPQGkcPUyHdVApc6pf6eETkZAF_zxgNNw@mail.gmail.com>
References: <CAHk-=wg4pV_H8bWsfWPQGkcPUyHdVApc6pf6eETkZAF_zxgNNw@mail.gmail.com>
MIME-Version: 1.0
...
v6.5-rc6[1] compared to v6.4[2].

Summarized:
  - build errors: +5/-4
  - build warnings: +44/-19

JFYI, when comparing v6.5-rc6[1] to v6.5-rc5[3], the summaries are:
  - build errors: +0/-0
  - build warnings: +0/-0
...
[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/2ccdd1b13c591d306f0401d98dedc4bdcd02b421/ (234 out of 235 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/6995e2de6891c724bfeb2db33d7b87775f913ad1/ (160 out of 235 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/52a93d39b17dc7eb98b6aa3edb93943248e03b2f/ (all 235 configs)
...
19 warning improvements:
  - .config: warning: override: reassigning to symbol MIPS_CPS_NS16550_SHIFT: 14416, 14423, 14424 => 14495, 14503

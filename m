Return-Path: <linux-kernel+bounces-162854-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 3BB6E8B615B
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 20:48:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 551FD1F22B2E
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 18:48:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BCBCD13AD32;
	Mon, 29 Apr 2024 18:46:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="fvndUQap"
Received: from mail-yw1-f202.google.com (mail-yw1-f202.google.com [209.85.128.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D5FCC13AA3A
	for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 18:46:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714416404; cv=none; b=E7nz6u9iEa1BZ/c9gFCk5N7VfGUVwQCcy+kYGM4iMQe17+DuqX4McYvj/rXF5Freat5ABHJjdvWpVQgrXyAe+DpmGpsa6HUKBV7/MH7ORkezjqPi3jzPdbxEIAQWh2YKlkJXBDyb6inLr7Nx5HZSMBn8ewvXy/HARW4IVbA9p0w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714416404; c=relaxed/simple;
	bh=RT5splsNNQv9/nmaxrSpXyvkn9qZM1R4EEpeVu02lvY=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=k7Stui9MwUTU0p3lwMbIosm/V8LmgavvP2O0Gt3Di3GdVqhLu9irAd0O/ixdaEqzPfwRiksyEj1JAPlfuzrcePQQK9ARoovzCovzJrtXP2wy+9BG3eUqSGThbzZLq9XjnOyjYbTJypT1UEICcCDIhe3IiXk+SDaR04abpQEmUS4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=fvndUQap; arc=none smtp.client-ip=209.85.128.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f202.google.com with SMTP id 00721157ae682-61be325413eso6907057b3.1
        for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 11:46:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1714416397; x=1715021197; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=TgAtM0VzuvAjERAUFjH02n3mIaJZ4Crda2gBLcNgsBY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1714416397; x=1715021197;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=TgAtM0VzuvAjERAUFjH02n3mIaJZ4Crda2gBLcNgsBY=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXj/r20hJRXGjcslwSRTew80mDE9IvaxSHeOAfrREm4QY8+QGXzmCN9avnnbc/95fisVvmUYBdehhCyJ7feCzm9m9TyaajvB9kPCQoa
X-Gm-Message-State: AOJu0YxdzjfvLwJoKTdddWLepNxp7DsT2ZhIvOEnQX/RVkiMOthk56Lv
	fh8d3d/wwQxGu+pT3KIyB7RW5BuOKcTCz6ybdt0SIJsWdk/C9z5fzca1HNYBRM0dfl3sEcLN1Lz
	4l6bhDA==
X-Google-Smtp-Source: AGHT+IEr1yAJlaNYoSffsqVT4lhkFDZc/CCQi8a6O21QBzmKz5RE9PXYk2UUNMQhfsh9FW0K0jgWEc3aeIbD
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:c137:aa10:25e1:8f1e])
 (user=irogers job=sendgmr) by 2002:a0d:d9cf:0:b0:611:5a9d:bb0e with SMTP id
 b198-20020a0dd9cf000000b006115a9dbb0emr101810ywe.4.1714416396730; Mon, 29 Apr
 2024 11:46:36 -0700 (PDT)
Date: Mon, 29 Apr 2024 11:46:12 -0700
In-Reply-To: <20240429184614.1224041-1-irogers@google.com>
Message-Id: <20240429184614.1224041-6-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v5 5/7] perf dso: Add reference count checking and accessor functions
...
---
 ...
 57 files changed, 1168 insertions(+), 738 deletions(-)

Return-Path: <linux-kernel+bounces-127646-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 19041894EE5
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 11:41:33 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9B7E81F21701
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 09:41:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0C4F558AA7;
	Tue,  2 Apr 2024 09:41:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="qu/5o+S6"
Received: from mail-lj1-f173.google.com (mail-lj1-f173.google.com [209.85.208.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D11529454
	for <linux-kernel@vger.kernel.org>; Tue,  2 Apr 2024 09:41:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712050881; cv=none; b=dRGwpW8MysOAHtWL4bYu+GhkhnIDe5Y1QvbeoPs5UaJjAe79SkqNn2q3ZqeYqaWyTW1d2LzWZrZukAJQcfp7bVRiQxfTaE0njTuQtb5vTzhUXIe3gsuZHtdCQBGUBnScJvEZzY9ZyTRt4ZwW8nODSwrGeAQf/1NA8i0Bph/jUzU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712050881; c=relaxed/simple;
	bh=4sjYkQRF91Mn0okjBiAFnKM2JI6HwgqBjrjEZhzRWFU=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=pbeDmojvsoD05ld5A3Ylm/nOkzQx4Q9/vYuLrQB/a/qxNVPFIy2yTj/2MRJliYIXZOCtnwpKqwJAfJe0fIp193HoD182eogV3KVmpvNEq3PBiOEHsuBFtZQkRJ2ARm2q+yKCoH3hXJPbcZ27AjK1U1ayRhTSw5yL7unxDvxwrWc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=qu/5o+S6; arc=none smtp.client-ip=209.85.208.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-lj1-f173.google.com with SMTP id 38308e7fff4ca-2d718ee7344so48271991fa.2
        for <linux-kernel@vger.kernel.org>; Tue, 02 Apr 2024 02:41:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1712050876; x=1712655676; darn=vger.kernel.org;
        h=in-reply-to:content-transfer-encoding:content-disposition
         :mime-version:references:message-id:subject:cc:to:from:date:from:to
         :cc:subject:date:message-id:reply-to;
        bh=x/Ekl9eS3ioYjyfIsk0dOB2O00Jo8kXjlA73VFXiwqw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=x/Ekl9eS3ioYjyfIsk0dOB2O00Jo8kXjlA73VFXiwqw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUAGFPrtAfQcqyx6Dhe8HfoTx1oHcxHCNy8dqz3PQuDLvyIb/7R/AG9FrjLo+E4yoRfBZ7GbTRybq34a0TCFHJgHLhG/9Qhfk4GJisV
X-Gm-Message-State: AOJu0YyCoybl2CKzZ5eh9OKE6rlGVv7Ir69RpB9Qd/1kelhKThZubS5D
	kuVDpTCooeVZ5uHE+6dxXONiyjb7Puv794W02QP8gdgs7DF/rhHFFy+BkAY1guU=
X-Google-Smtp-Source: AGHT+IH3V1HYvzf69M3tW/NTXAzFVWrs5m1HUQ1y0p+FUdUo+/ZZmGedQYWGbvBe6xjDm2UwZb+OnA==
X-Received: by 2002:a2e:9306:0:b0:2d8:2f68:d41c with SMTP id e6-20020a2e9306000000b002d82f68d41cmr557848ljh.3.1712050875627;
        Tue, 02 Apr 2024 02:41:15 -0700 (PDT)
Received: from eriador.lumag.spb.ru (dzyjmhyyyyyyyyyyyykxt-3.rev.dnainternet.fi. [2001:14ba:a00e:a300::227])
        by smtp.gmail.com with ESMTPSA id k5-20020a2ea285000000b002d6f7f2261bsm1620246lja.82.2024.04.02.02.41.14

Return-Path: <linux-kernel+bounces-117882-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id CEABF88B0C3
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 21:03:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 5226D300A9A
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Mar 2024 20:03:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 81D1845037;
	Mon, 25 Mar 2024 20:03:39 +0000 (UTC)
Received: from albert.telenet-ops.be (albert.telenet-ops.be [195.130.137.90])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0C34A1CD10
	for <linux-kernel@vger.kernel.org>; Mon, 25 Mar 2024 20:03:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.130.137.90
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711397012; cv=none; b=lgWdbBUHRYfc9dK7AcBUxRnfNm2gMJNDTl4C4iU3ujOHu437MsQMpJKGt6BC9BVm9vCDnLV02JrYNP/1K31diGULHRyHyh1wOF55ftzAtOFknyThnRX4zlizHE5j6VV+Er8UsQTMLRqR0OhFLxgsBMKZyxeJUkvPQELa7E/e14w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711397012; c=relaxed/simple;
	bh=6C1EzOAj8h1pK2dgqMke/dtz+eo8luAZKV5nbNDTglM=;
	h=From:To:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=IsUAM/RMwBDqwnaZxjPuYPuKE4l0ISnh7ej9cPjwEGLlaVzHiu+ocBtU5/dUUeYp3ejK735M9EzwninLaEqhOW30KeQw/3onpeRbeVBNkEUjG9KafgkSK/5v+TZ0bhwIf2AFR/wuGlqUpqIpCzdvbrvkShgc7X5Pp0v9/EAiEgQ=
...
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed80:76d0:2bff:fec8:549])
	...
	id 383F2C0050SSLxL0683FDG; Mon, 25 Mar 2024 21:03:15 +0100
Received: from rox.of.borg ([192.168.97.57])
	by ramsan.of.borg with esmtp (Exim 4.95)
	(envelope-from <geert@linux-m68k.org>)
	id 1roqWz-004vlC-81
	for linux-kernel@vger.kernel.org;
	Mon, 25 Mar 2024 21:03:15 +0100
...
Subject: Build regressions/improvements in v6.9-rc1
Date: Mon, 25 Mar 2024 21:03:15 +0100
Message-Id: <20240325200315.3896021-1-geert@linux-m68k.org>
...
1476 warning regressions:
  + /kisskb/src/drivers/uio/uio.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]:  => 795:16, 795:9

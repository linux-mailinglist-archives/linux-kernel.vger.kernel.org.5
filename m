...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ECEE7807DCF
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Dec 2023 02:21:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1443106AbjLGBV1 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Dec 2023 20:21:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56870 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1443036AbjLGBUf (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Dec 2023 20:20:35 -0500
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D10AB170E
        for <linux-kernel@vger.kernel.org>; Wed,  6 Dec 2023 17:19:12 -0800 (PST)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-5ca2a6f07b6so1759167b3.2
        for <linux-kernel@vger.kernel.org>; Wed, 06 Dec 2023 17:19:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1701911952; x=1702516752; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=xaz1ZTDIVQF16/Rwwnu4rRI5nlNIXFSG0sve+jb2C5w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1701911952; x=1702516752;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=xaz1ZTDIVQF16/Rwwnu4rRI5nlNIXFSG0sve+jb2C5w=;
        b=
X-Gm-Message-State: AOJu0Yyjd6atgSLc2x2BW7AbEO7AETdE4rtWSaDsIiYyv3bjxsaZGKET
        efuXnuLz78RgN9wU8y85XJDfUPFQiR/i
X-Google-Smtp-Source: AGHT+IF7s3xCtkkJTEBVKo9/LVSYLEJG/kvfAZRUpkgGwESQceaWdmDe3B4uTLk5U/3jEnvuSeGh5SFvk5M5
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:35bf:293e:7696:34e9])
 (user=irogers job=sendgmr) by 2002:a81:ad07:0:b0:5d3:8857:b78e with SMTP id
 l7-20020a81ad07000000b005d38857b78emr32793ywh.10.1701911951779; Wed, 06 Dec
 2023 17:19:11 -0800 (PST)
Date:   Wed,  6 Dec 2023 17:17:19 -0800
In-Reply-To: <20231207011722.1220634-1-irogers@google.com>
Message-Id: <20231207011722.1220634-46-irogers@google.com>
Mime-Version: 1.0
References: <20231207011722.1220634-1-irogers@google.com>
X-Mailer: git-send-email 2.43.0.rc2.451.g8631bc7472-goog
Subject: [PATCH v6 45/47] perf dso: Add reference count checking and accessor functions
...
index a9129b51d511..10ab9dbf8840 100644
--- a/tools/perf/builtin-annotate.c
+++ b/tools/perf/builtin-annotate.c
@@ -213,7 +213,7 @@ static int process_branch_callback(struct evsel *evsel,
 	}
...
@@ -248,7 +248,7 @@ static int evsel__add_sample(struct evsel *evsel, struct perf_sample *sample,
 		if (al->sym != NULL) {
...
index 1e42bd1c7d5a..adaa71b9db7a 100644
...
index 8620146d0378..39e7b1289c8b 100644
...
index 163f916fff68..ad4693b87941 100644
...
index 9a828dc601c7..54be2fc948c4 100644
--- a/tools/perf/util/annotate.c
+++ b/tools/perf/util/annotate.c
@@ -1771,8 +1771,8 @@ int symbol__strerror_disassemble(struct map_symbol *ms, int errnum, char *buf, s
...
@@ -1794,11 +1794,11 @@ int symbol__strerror_disassemble(struct map_symbol *ms, int errnum, char *buf, s
...
@@ -1816,7 +1816,7 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
 	char *pos;
 	int len;
...
@@ -1825,7 +1825,7 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
...
@@ -1859,20 +1859,20 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
...
+		mutex_unlock(dso__lock(dso));
 	...
 	free(build_id_path);
@@ -2159,11 +2159,11 @@ static int symbol__disassemble(struct symbol *sym, struct annotate_args *args)
...
@@ -2591,7 +2591,7 @@ int symbol__annotate_printf(struct map_symbol *ms, struct evsel *evsel,
...
@@ -2758,7 +2758,7 @@ int map_symbol__annotation_dump(struct map_symbol *ms, struct evsel *evsel,
 	}
...
+		ms->sym->name, dso__long_name(map__dso(ms->map)), ev_name);
 	...
 	fclose(fp);
@@ -3015,7 +3015,7 @@ int symbol__tty_annotate2(struct map_symbol *ms, struct evsel *evsel,
 	if (err) {
 		char msg[BUFSIZ];
...
+		dso__set_annotate_warned(dso);
 		...
 		ui__error("Couldn't annotate %s:\n%s", sym->name, msg);
 		return -1;
@@ -3024,12 +3024,12 @@ int symbol__tty_annotate2(struct map_symbol *ms, struct evsel *evsel,
 	if (opts->print_lines) {
...
@@ -3049,7 +3049,7 @@ int symbol__tty_annotate(struct map_symbol *ms, struct evsel *evsel,
 	if (err) {
 		char msg[BUFSIZ];
...
+		dso__set_annotate_warned(dso);
 		...
 		ui__error("Couldn't annotate %s:\n%s", sym->name, msg);
 		return -1;
@@ -3060,7 +3060,7 @@ int symbol__tty_annotate(struct map_symbol *ms, struct evsel *evsel,
 	if (opts->print_lines) {
 		srcline_full_filename = opts->full_path;
 		symbol__calc_lines(ms, &source_line, opts);
-		print_summary(&source_line, dso->long_name);
...
index f528c4364d23..fe1250629d74 100644
...
index 08f82c1f166c..4cb5bdc53ac6 100644
...
index 08cc2febabde..7fee7732f8ac 100644
...
index 27b123ccd2d1..34aac91b08ea 100644

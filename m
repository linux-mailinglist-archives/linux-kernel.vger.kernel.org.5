Return-Path: <linux-kernel+bounces-100887-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F70C879EA9
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 23:29:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 32D4E1C220C8
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Mar 2024 22:29:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2E7601448C0;
	Tue, 12 Mar 2024 22:29:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="YXEnqaow"
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.15])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DC3ED142636
	for <linux-kernel@vger.kernel.org>; Tue, 12 Mar 2024 22:29:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.15
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710282546; cv=none; b=Q7gnumukG02mVY/rQbKRAejCAHHzf5OzhcZNb+3v3720j0mboQSv6p0dFutTs0Ju/X1R4MQ8WjPXJqXheLft0CTeehe93DSiDMz2QkBKfiznnALqJVlxs6JbYoFDADTY/YVMscqhd/pPLV1oG7U1CmcqAkGe7TJvLdzqHCZzT8M=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710282546; c=relaxed/simple;
	bh=zVX1vaEkDKmChEJ4w568WWgPFcE9+A3WKwowQ5YMPd8=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=E+RXCwdGTcyoyhuzOpz3rirK4rSQY/JlLVXAsK0btMQLs1MD5Apxf1h3I9ZesJv//YogCZxdRfvorPUO326Jfb2LBIRPcdSkK6RggjsVm+4sh8KOtgZXfacdSz5RcyG8bX8+dfJ/BO/ri8FW6u5s/pxGgI+ks6TpXxbCpQnJc2s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=YXEnqaow; arc=none smtp.client-ip=192.198.163.15
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1710282544; x=1741818544;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=zVX1vaEkDKmChEJ4w568WWgPFcE9+A3WKwowQ5YMPd8=;
  b=YXEnqaowRjXpiScu3NxzDtJNRs7GiuUEh3WVvRLzRLLEg/MO9H9eWDny
   WOqLBT2sLPoYASVLjICFQlmGuRW5qYV4SWDKWeiJuXdSW4p8KsqmXYxkQ
   TDWVwLoyN8tMdnd/qTATJvG4k3dzysGLF7f/2AdHUqYBwuIJGiph4tLmp
   0Xe0EhGdXNUm+GZxuwO27OvJNjtxuS7utamxFbhEpC7Yfzbz8L0Nh2QzZ
   njITS1GXVIi2bzy/v3kT5fSOfcemsMA0KgJT5Vopn920V+tAyb9UbAg2E
   aSDp3nUGsjnrCMXYEHHh8P2ECf1LwAWShZqRFvJ33Fh3ryJ+gcx5smFyo
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,11011"; a="5191918"
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="5191918"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
  by fmvoesa109.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Mar 2024 15:29:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,119,1708416000"; 
   d="scan'208";a="16356826"
...
Subject: [PATCH v3 01/12] mm: Switch mm->get_unmapped_area() to a flag
Date: Tue, 12 Mar 2024 15:28:32 -0700
Message-Id: <20240312222843.2505560-2-rick.p.edgecombe@intel.com>

Return-Path: <linux-kernel+bounces-163491-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D79988B6C12
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 09:47:17 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id BB830B21B60
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 07:47:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3ABA23F8DE;
	Tue, 30 Apr 2024 07:47:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ffwll.ch header.i=@ffwll.ch header.b="RzHd60eq"
Received: from mail-wm1-f46.google.com (mail-wm1-f46.google.com [209.85.128.46])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 25AFB4085A
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 07:47:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714463228; cv=none; b=Y8I9BI9uGydCaQ05k1k/M/EsV/F9fPl+/qBhqpUp8crAo2ZzO+RRStFLORmjheQLBRXMsDUaC3YhIqLX6qcynRE1vV3f6MzNBU/vCOfqUYSGU+cgjMiRkJ6UJUjMOakOH9wQ2htRvCcGVxi5HzmVrxPHGiZgt3MdFGvyMZWvqdM=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ffwll.ch; spf=none smtp.mailfrom=ffwll.ch; dkim=pass (1024-bit key) header.d=ffwll.ch header.i=@ffwll.ch header.b=RzHd60eq; arc=none smtp.client-ip=209.85.128.46
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ffwll.ch
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=ffwll.ch
Received: by mail-wm1-f46.google.com with SMTP id 5b1f17b1804b1-41c017ee96aso1768665e9.3
        for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 00:47:05 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-transfer-encoding:content-disposition
         ...
         :reply-to;
        bh=Dl1GVdvN0rueQglXaHxovHAsGiDm4e1yNLBN8HxvIs4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUlUDTK24Lm/uGEcaLRiJUneQVBsZz3g33l+KWXnguOmWh5l04wJhoxXRV1C+K/H6wX6taHLEOSyC7rV0MuzUu4GdCcH/fzs0SCB+Ro
X-Gm-Message-State: AOJu0YzMHkGuvLUDAAqljZQeIDRt0OqHJ+HQuruKFWlcjsBJA9PTaWuH
	1tUIfh+iSVpSjqqyFJoZX3pR5/XSYHun+IVQO2kK/n6UmUkuVmNOttkEwnW74Do=

Return-Path: <linux-kernel+bounces-161756-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C63EE8B50CE
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 07:50:47 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id EA8931C20C34
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 05:50:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DC3DDDF59;
	Mon, 29 Apr 2024 05:50:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b="hsMAw2mB"
Received: from mx0b-0016f401.pphosted.com (mx0a-0016f401.pphosted.com [67.231.148.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C77A78BE2
	for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 05:50:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=67.231.148.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714369841; cv=none; b=BgfZdTCqI+bwVM03DwO9JrCJvY/g1svbIRazjfFfjhaF0QhW60pKzuIu5K3eIlInCtj25Xr10O48j6ecBdp8IiukQxGQFQUJPVVYhaJ3srcfhIVBg8xpAREkmmYNfR7JBVzq/2zDDT1sXl9L+ysKEnF7MD9ZNIhrDUQT02Lc5VQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714369841; c=relaxed/simple;
	bh=yX5o4KId6MaRfLVkd5rewgU350exSm/OIQeolNJ5ebA=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=PTxfHMVZTwvxmUk8tjdvnFrbPBXcPOtd78uTcGd2RLlXAjuJw7tT0A2Ljn2Qok06vZN+Am/dwcjDvxckJNHYL00LbsIIMdZJRnG4tzOj7nF2Me4lP/GfYd2zyjcjAqdX7Rayljy78Y6CYrX5eZKiZLfe4hZHXAQRKIdcuNVbYcU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=marvell.com; spf=pass smtp.mailfrom=marvell.com; dkim=pass (2048-bit key) header.d=marvell.com header.i=@marvell.com header.b=hsMAw2mB; arc=none smtp.client-ip=67.231.148.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=marvell.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=marvell.com
Received: from pps.filterd (m0045849.ppops.net [127.0.0.1])
	by mx0a-0016f401.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 43T00OST032161;
	Sun, 28 Apr 2024 22:50:34 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=marvell.com; h=
	from:to:cc:subject:date:message-id:in-reply-to:references
	:mime-version:content-transfer-encoding:content-type; s=
	pfpt0220; bh=aVHxbtd5ldkgREm7E/x4HQUfCJwDashVdQlH/mGQC30=; b=hsM
	
Received: from dc6wp-exch02.marvell.com ([4.21.29.225])
	by mx0a-0016f401.pphosted.com (PPS) with ESMTPS id 3xt0md8n7e-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Sun, 28 Apr 2024 22:50:34 -0700 (PDT)
Received: from DC6WP-EXCH02.marvell.com (10.76.176.209) by
 DC6WP-EXCH02.marvell.com (10.76.176.209) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1544.4; Sun, 28 Apr 2024 22:50:33 -0700
Received: from maili.marvell.com (10.69.176.80) by DC6WP-EXCH02.marvell.com
 (10.76.176.209) with Microsoft SMTP Server id 15.2.1544.4 via Frontend
 Transport; Sun, 28 Apr 2024 22:50:32 -0700
Received: from localhost.localdomain (unknown [10.28.36.156])
	by maili.marvell.com (Postfix) with ESMTP id A86993F7041;
	Sun, 28 Apr 2024 22:50:30 -0700 (PDT)
...
Date: Sun, 28 Apr 2024 22:50:27 -0700
Message-ID: <20240429055027.2162310-1-vattunuru@marvell.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <MW4PR18MB5244E39EEBC3689CBF086050A6152@MW4PR18MB5244.namprd18.prod.outlook.com>
...
X-Proofpoint-GUID: dSiFkvWuhOn0Xprz-WlsW9zW4-v38AvP
X-Proofpoint-ORIG-GUID: dSiFkvWuhOn0Xprz-WlsW9zW4-v38AvP

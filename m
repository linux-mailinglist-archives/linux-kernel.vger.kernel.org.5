Return-Path: <linux-kernel+bounces-36226-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 9497E839DAF
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 01:39:35 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 10C281F26E7F
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 00:39:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 98D663C23;
	Wed, 24 Jan 2024 00:38:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b="ggIB8zfE"
Received: from mail-pl1-f174.google.com (mail-pl1-f174.google.com [209.85.214.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0403C1842
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 00:38:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706056731; cv=none; b=Nv4e9ummvNTWjuEcmwAxggw008DqRXS7PKxejwPudQ6SjNzXcfgkS6VAvq8ALrI1l3tnXPBL8qla+3qvM0G/mWKYPVvNc6BnZaRqhl+cZvwq8XszQFroXW3lPtB38xCGeUFt+8tX0/pytRE3YZTR/DJXYtVt26ZqINmrpmP+ViY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706056731; c=relaxed/simple;
	bh=y0xerMze5uvG4Tp/ArebrejIG/fz3kGzBVuNfP8KQ3I=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=s5404hOwqoHjHWo/5rQAYuxSCk91OXCG6sdO4r692laSLHWmww7gWLQG47XL1oYqc7XB2N5z4MAFjDpMhfofPBbOSJ5IBWU1n2gIIACZCQkKbVUCbrLIsrft9sLV7F+ifGDqLnWgVH9e6PVWFdQ8kmOwHKcsZ2ZDoRF2SNZBW9Q=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com; spf=pass smtp.mailfrom=rivosinc.com; dkim=pass (2048-bit key) header.d=rivosinc-com.20230601.gappssmtp.com header.i=@rivosinc-com.20230601.gappssmtp.com header.b=ggIB8zfE; arc=none smtp.client-ip=209.85.214.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=rivosinc.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=rivosinc.com
Received: by mail-pl1-f174.google.com with SMTP id d9443c01a7336-1d730b6943bso14576695ad.2
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 16:38:48 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1706056728; x=1706661528; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=UDe0+RZbDlHhfO/SVhjXAKjiKVmMqyOiOjDVFTVZ+8Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706056728; x=1706661528;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=UDe0+RZbDlHhfO/SVhjXAKjiKVmMqyOiOjDVFTVZ+8Q=;
        b=
X-Gm-Message-State: AOJu0YyNt92VfGMb2ut9fB+O3tD9u7Zoj3MOV419zLZl6jueB3DDVSJ4
	jqBIgrRzWadQTI3exubOUHDuJatbBqkQjnwK8Wxhi/w0AYe/gaStItJT38t9YNQ=
X-Google-Smtp-Source: AGHT+IHFOx39UjEZ5WWjgLk/xf5fnmbHhmOgBzLuEaGkIfTuuiImSRzvkC0k6Gobb9Nu7EjreKxPyA==
X-Received: by 2002:a17:903:41cc:b0:1d7:7790:1ed1 with SMTP id u12-20020a17090341cc00b001d777901ed1mr35807ple.113.1706056728077;
        Tue, 23 Jan 2024 16:38:48 -0800 (PST)
Received: from charlie.ba.rivosinc.com ([64.71.180.162])
        by smtp.gmail.com with ESMTPSA id bi3-20020a170902bf0300b001d6fe15b563sm9384275plb.157.2024.01.23.16.38.47
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 23 Jan 2024 16:38:47 -0800 (PST)
From: Charlie Jenkins <charlie@rivosinc.com>
Date: Tue, 23 Jan 2024 16:38:43 -0800
Subject: [PATCH v3 2/2] lib: checksum: Use aligned accesses for
...
Message-Id: <20240123-fix_sparse_errors_checksum_tests-v3-2-efecc7f94297@rivosinc.com>
...
X-Mailer: b4 0.12.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1706056725; l=27913;
 i=charlie@rivosinc.com; s=20231120; h=from:subject:message-id;
 bh=y0xerMze5uvG4Tp/ArebrejIG/fz3kGzBVuNfP8KQ3I=;
 b=GuKkRjRyoilhxVY7V6XTI8H4xmLKiMx3G6S00AFYs0oVKQOVwDlrFUnMKrJIrL/P99mp3LR2+
 K/cR2VkvgQwAL1MyZ2S8wwFeWKRoIewyJNQNEFwgEG0IwxLJXvG8oZd
...
---
 lib/checksum_kunit.c | 386 +++++++++++++++++----------------------------------
 1 file changed, 127 insertions(+), 259 deletions(-)

diff --git a/lib/checksum_kunit.c b/lib/checksum_kunit.c
index 776ad3d6d5a1..91536f3b563a 100644
...
+	0xdc4a, 0x4ce2, 0x8b5,	0xdc26, 0x217e, 0x74b2, 0x85e2, 0xb8bc, 0x290,
+	0x88d7, 0xc552, 0x52df, 0x6145, 0x2d3e, 0xb96f, 0x48d7, 0xff3b, 0xa30a,
+	0xb8d7, 0x2030, 0xf091,
 };
...
+			expected = (__force __sum16)expected_fast_csum[index];
+			CHECK_EQ(csum_result, expected);
 		}
 	}
 }
@@ -594,29 +468,23 @@ static void test_ip_fast_csum(struct kunit *test)

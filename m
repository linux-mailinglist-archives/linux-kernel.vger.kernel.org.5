Return-Path: <linux-kernel+bounces-147411-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DBE08A7398
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 20:49:15 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A731FB242A1
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 18:49:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 52A6C13C834;
...
Received: from mail-pg1-f182.google.com (mail-pg1-f182.google.com [209.85.215.182])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1241A13C3F0
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 18:44:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.215.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713293101; cv=none; b=H1Cxa4p3KuExqh8Whc31IMj9sdOxrutbbPNd2rooNnaOLPfuthcuJZYAAILYVJ55b/PGwm7jsMRgei4GRNNxWEjvZal4IyjHHWLr0Dn6ozatyVqjGD1KbBut8LDnNA7hdCV2NiDfAf2Ft4rVrwX0iZpoRCyQTSzd9IO7qlBGTfw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713293101; c=relaxed/simple;
	bh=HvWaHaPle0cX5HGWWdRxWlP3z/kNux1E5mFj4+zTNsM=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=C/xkbaZIGpc/t3yDVn744zArnyWdujzaCAtdFTGQDbotis0OU9097FPq7JIqVXIAXQqI012AoBSExsxDGoiQ/gnDbqR5otm44wNWdBUCnrZ5C/KW97zZYkdGLviIN1P5D8eUDlSxqglYbaEVGnRBoI6rLxRzHpzmnuoAKMM/H2o=
...
Received: by mail-pg1-f182.google.com with SMTP id 41be03b00d2f7-5dcc4076c13so42418a12.0
        for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 11:44:59 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=QIyaUvQe1Xat3Gv2wtXts1DoFv5C5UbopqhCGzslRuw=;
        b=
X-Gm-Message-State: AOJu0YwujHrFQVcop0bZ3dBoTS64bOEACCPeol3M0mjtw5o590lVIVS9
	iAtaSiViGqdOOapHF9e7WqmoMJE3bp54wr2B2VQoW+C3ioY8eLtfFGFr8UeMknaP4NRQvGkxWsI
	i

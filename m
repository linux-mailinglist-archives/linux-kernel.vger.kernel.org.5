Return-Path: <linux-kernel+bounces-63579-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 272EB8531B4
	for <lists+linux-kernel@lfdr.de>; Tue, 13 Feb 2024 14:23:06 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4C8BD1C212E4
	for <lists+linux-kernel@lfdr.de>; Tue, 13 Feb 2024 13:23:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 941AE55C0F;
	Tue, 13 Feb 2024 13:23:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ImUvANDQ"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EB1E455794
	for <linux-kernel@vger.kernel.org>; Tue, 13 Feb 2024 13:22:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707830579; cv=none; b=SUttrX1cUJIyoj1Gia43bp9RNmlR8C3Ic1cNYOu7vlJCXdNxWxIIVZsCcDx8ptPrXa4XLWr34iwhrFNuxjCqQFrzyAKSsVO0q2OUujE8HoNwprBAkQuX0oXmKQh3suht521fNrr8uCDYT6preVr1vbx8xJpg/UkRUZAFYPAN648=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707830579; c=relaxed/simple;
	bh=kRLH5G0F3/jT4uka0TBF4hnhs0DpoayDJXkkRIuh8LM=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=lWSs2T5V07hoem5wbcfhDeYRvGxmzzpveXVVoPqaOiJ9NbRgAKVVerQcH9aBFjc5TqmRzOkAauUKVyZVM47HFE/w3VZNdhionfMKrILnjDLTIUYrw+AXvMmnCzfSjQhcWf6WORnYSKh235ZGZAhISgpwDUj2lJFYkMYnAUH6Wss=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ImUvANDQ; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1707830576;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=VEC2sf7LFQqJw89DqYMmjZDJRFTDZsCnAL9w8HwRw84=;
	b=ImUvANDQp4AHALZ7CmTD6Znwr9/Vrx1uwtvgX8AOZS+9mfKcgbgdiOKKVggICzMlMtBmKn
	iXZllHTj8Om9szfir05bwHNNWt7tCwcpqT7diStz/JFB91S3VEmeVP2Pl9DW7VuUVsL170
	Reizz0YymDKXZiIz58l9scxAMDBxeFE=
Received: from mail-wm1-f70.google.com (mail-wm1-f70.google.com
 [209.85.128.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-232-AGVDy9C-MGuHYN0VGTXtWA-1; Tue, 13 Feb 2024 08:22:50 -0500
X-MC-Unique: AGVDy9C-MGuHYN0VGTXtWA-1
Received: by mail-wm1-f70.google.com with SMTP id 5b1f17b1804b1-410e6b59df4so9123295e9.3
        for <linux-kernel@vger.kernel.org>; Tue, 13 Feb 2024 05:22:50 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         ...
         :message-id:reply-to;
        bh=VEC2sf7LFQqJw89DqYMmjZDJRFTDZsCnAL9w8HwRw84=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUynx8aX2YZCg2cYHtj4DBwAdmfn8zqaFIKlWGc3yjkhU+QfZprSXkEPy67I4GNeNHGevSURLtLAP8YCNxYUalpkE5Om7XOKguvl/Fd
X-Gm-Message-State: AOJu0YyWQEAXLNgvh50faxxFfRpShzmEmyaInE+1O1anNY31ONkQlM7f
	033Ox5WRWUCRqSXkz5YMbsKyxpPo/MdbA+9qvJyforu3+RIG6I10FMZxhgoVngscEPOvEdQptSX
	X/KkgvJrpWi/Xwj3A3vAjh31iMNaWQ6IxF+Vc+UMp+ZXKB+vOB9DsR1+aeNYqYg==
X-Received: by 2002:a05:6000:10c6:b0:33b:66c2:9735 with SMTP id b6-20020a05600010c600b0033b66c29735mr8069212wrx.18.1707830569486;

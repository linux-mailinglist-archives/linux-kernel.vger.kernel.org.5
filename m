Return-Path: <linux-kernel+bounces-91117-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B74C38709C5
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 19:41:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B88E1B2D040
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 18:39:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E00447869A;
	Mon,  4 Mar 2024 18:36:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="uM0L46Km"
Received: from mail-yb1-f202.google.com (mail-yb1-f202.google.com [209.85.219.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CBADA7C0B0
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 18:36:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709577374; cv=none; b=ZPo20whZMFe0O7E7gSBY9Jj7+T1uxscy0RCubsVCr9hi3hytEMKzmt/EO8IBz0CZ2JyN6+HqPjrZMsmBeCsHLnsOTgAbG7BzHLxMk+GMkSMkO3vgOfy2izUlJIfIDkpLEmCsGkxInyHMB0gPM7SWQmqzEzWPKI401/BFyMU9iL0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709577374; c=relaxed/simple;
	bh=JbYy+wG5THqcVvCNRoQ6kGW4Ji8JoAdyoF+FNC0YAKM=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=H8snuHKfNtKW1KCQJH0O7gT1B6MPylIRRoY5tfMC3hFtq6IDib/wxSCiRhq+M3u9fJJYFRRj9K1ciM3XbqEtWsujDpOx8X09snDnAY5aR2Oi/KmJD7obz3VvZTa2YHoZi6edb+toxgshsK/AsnX/Mm6flugMbYGZgJIzsJ6KxDU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=uM0L46Km; arc=none smtp.client-ip=209.85.219.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f202.google.com with SMTP id 3f1490d57ef6-dcc05887ee9so6494694276.1
        for <linux-kernel@vger.kernel.org>; Mon, 04 Mar 2024 10:36:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1709577367; x=1710182167; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=YK8PAY4Uad3Vzsf7UOx9weT+QmqU/vJED3UuWW2SVlQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1709577367; x=1710182167;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=YK8PAY4Uad3Vzsf7UOx9weT+QmqU/vJED3UuWW2SVlQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVWbNlcoWMZvFMuR/h9k45lFdUourtBicQtbxW8gw9v84Rt9y4uXE3ZZPUhHczUag5zjDz0wllhZ/xC/3dEsFekAh/TQ2S6QIPBu9+T
X-Gm-Message-State: AOJu0YxEQa74t7zm231H1veJQHObbITXHFul6yh0IXVEEXKbDTlmNE3m
	5RM3j0RK5mZC2ITzakY5zmR+W1/D1NtqKI0N/tlxn5coHo3Ny3uSUN0dTQ5fFaeMM6ccfMvsNTa
	F7aQisg==
X-Google-Smtp-Source: AGHT+IHiIDgjuDxwNRfJTgm+il53mcT9LSxnh7sWpBIuXIZTfJJ3wrLASbsLAmawFJ16Y180cowWzzQEP8sB
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:38b7:9cbf:f246:dafb])
 (user=irogers job=sendgmr) by 2002:a05:6902:1009:b0:dbe:387d:a8ef with SMTP
 id w9-20020a056902100900b00dbe387da8efmr338372ybt.1.1709577366767; Mon, 04
 Mar 2024 10:36:06 -0800 (PST)
Date: Mon,  4 Mar 2024 10:35:22 -0800
In-Reply-To: <20240304183525.3222581-1-irogers@google.com>
Message-Id: <20240304183525.3222581-12-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v1 11/13] perf dso: Add reference count checking and accessor functions
...
---
 ...
 54 files changed, 1144 insertions(+), 720 deletions(-)
...
index 37088cc0ff1b..b629ddf1219a 100644
--- a/tools/perf/builtin-script.c
+++ b/tools/perf/builtin-script.c
@@ -1014,11 +1014,11 @@ static int perf_sample__fprintf_brstackoff(struct perf_sample *sample,
 		to   = entries[i].to;
...
@@ -1079,7 +1079,7 @@ static int grab_bb(u8 *buffer, u64 start, u64 end,
...
@@ -1091,7 +1091,7 @@ static int grab_bb(u8 *buffer, u64 start, u64 end,
...
index ec5e21932876..c0fb4888f092 100644
...
index 30c4d19fcf11..371c99849f4b 100644
--- a/tools/perf/util/annotate-data.c
+++ b/tools/perf/util/annotate-data.c
@@ -143,7 +143,7 @@ static struct annotated_data_type *dso__findnew_data_type(struct dso *dso,
...
+	node = rb_find(&key, dso__data_types(dso), data_type_cmp);
 	if (node) {
 		...
 		free(type_name);
@@ -164,7 +164,7 @@ static struct annotated_data_type *dso__findnew_data_type(struct dso *dso,
...
@@ -369,7 +369,7 @@ struct annotated_data_type *find_data_type(struct map_symbol *ms, u64 ip,
 	Dwarf_Die type_die;
 	u64 pc;
...
index 107b264fa41e..aa8d12195d3a 100644
--- a/tools/perf/util/annotate.c
+++ b/tools/perf/util/annotate.c
@@ -1794,8 +1794,8 @@ int symbol__strerror_disassemble(struct map_symbol *ms, int errnum, char *buf, s
...
@@ -1817,11 +1817,11 @@ int symbol__strerror_disassemble(struct map_symbol *ms, int errnum, char *buf, s
...
@@ -1848,7 +1848,7 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
...
@@ -1882,20 +1882,20 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
...
+		mutex_unlock(dso__lock(dso));
 	...
 	free(build_id_path);
@@ -2181,11 +2181,11 @@ static int symbol__disassemble(struct symbol *sym, struct annotate_args *args)
...
@@ -2626,7 +2626,7 @@ int symbol__annotate_printf(struct map_symbol *ms, struct evsel *evsel)
...
@@ -2791,7 +2791,7 @@ int map_symbol__annotation_dump(struct map_symbol *ms, struct evsel *evsel)
 	}
...
+		ms->sym->name, dso__long_name(map__dso(ms->map)), ev_name);
 	...
 	fclose(fp);
@@ -3045,7 +3045,7 @@ int symbol__tty_annotate2(struct map_symbol *ms, struct evsel *evsel)
 	if (err) {
 		char msg[BUFSIZ];
...
+		dso__set_annotate_warned(dso);
 		...
 		ui__error("Couldn't annotate %s:\n%s", sym->name, msg);
 		return -1;
@@ -3054,13 +3054,12 @@ int symbol__tty_annotate2(struct map_symbol *ms, struct evsel *evsel)
...
@@ -3079,7 +3078,7 @@ int symbol__tty_annotate(struct map_symbol *ms, struct evsel *evsel)
 	if (err) {
 		char msg[BUFSIZ];
...
+		dso__set_annotate_warned(dso);
 		...
 		ui__error("Couldn't annotate %s:\n%s", sym->name, msg);
 		return -1;
@@ -3090,7 +3089,7 @@ int symbol__tty_annotate(struct map_symbol *ms, struct evsel *evsel)
 	if (annotate_opts.print_lines) {
 		srcline_full_filename = annotate_opts.full_path;
 		symbol__calc_lines(ms, &source_line);
-		print_summary(&source_line, dso->long_name);
...
index 97a0c21ba2a5..4153dc92154d 100644
...
index 67db017f7e7d..48404ddbee50 100644
...
@@ -596,7 +595,7 @@ struct kmap *__map__kmap(struct map *map)
 {
 	const struct dso *dso = map__dso(map);
...
index 2a0ad9ecf0a2..adf58a655f9b 100644
...
@@ -3794,8 +3793,8 @@ int show_available_funcs(const char *target, struct nsinfo *nsi,
...
index b4f0f60e60a6..7323e74959f3 100644

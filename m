...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 800277DF97C
	for <lists+linux-kernel@lfdr.de>; Thu,  2 Nov 2023 19:05:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1347017AbjKBSEv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 2 Nov 2023 14:04:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56520 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235684AbjKBSEc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 2 Nov 2023 14:04:32 -0400
Received: from mail-yb1-xb4a.google.com (mail-yb1-xb4a.google.com [IPv6:2607:f8b0:4864:20::b4a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ECD9E1FE5
        for <linux-kernel@vger.kernel.org>; Thu,  2 Nov 2023 10:59:30 -0700 (PDT)
Received: by mail-yb1-xb4a.google.com with SMTP id 3f1490d57ef6-d99ec34829aso1447979276.1
        for <linux-kernel@vger.kernel.org>; Thu, 02 Nov 2023 10:59:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698947970; x=1699552770; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=EqM227kTd1FSi4l4WjvOwCiaefHyEDc7Co5Q8C2p94M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698947970; x=1699552770;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=EqM227kTd1FSi4l4WjvOwCiaefHyEDc7Co5Q8C2p94M=;
        b=
X-Gm-Message-State: AOJu0YxzfIp32gkOUBsXKqxylkBSFTRAGhmV247AZQfVLt4sWLwuBHOU
        fDe5VzZUYFCvMObv/QHMdjR+0OP2XXJ/
X-Google-Smtp-Source: AGHT+IE74cnmVLT50i2Ws8ByKqeijeGiXzLZOEvySZorBv1+dsDelpB0P9unEPD1y4PGtCKVIJYKWbd1Ncv9
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:bb34:df9c:836c:afca])
 (user=irogers job=sendgmr) by 2002:a05:6902:1746:b0:d9a:59cb:8bed with SMTP
 id bz6-20020a056902174600b00d9a59cb8bedmr334956ybb.5.1698947970081; Thu, 02
 Nov 2023 10:59:30 -0700 (PDT)
Date:   Thu,  2 Nov 2023 10:57:23 -0700
In-Reply-To: <20231102175735.2272696-1-irogers@google.com>
Message-Id: <20231102175735.2272696-42-irogers@google.com>
Mime-Version: 1.0
References: <20231102175735.2272696-1-irogers@google.com>
X-Mailer: git-send-email 2.42.0.869.gea05f2083d-goog
Subject: [PATCH v4 41/53] perf dsos: Attempt to better abstract dsos internals

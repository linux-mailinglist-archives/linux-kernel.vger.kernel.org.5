...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D96A77D3EEA
	for <lists+linux-kernel@lfdr.de>; Mon, 23 Oct 2023 20:17:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232718AbjJWSRw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 23 Oct 2023 14:17:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40832 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231210AbjJWSRs (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 23 Oct 2023 14:17:48 -0400
Received: from mail-oi1-x233.google.com (mail-oi1-x233.google.com [IPv6:2607:f8b0:4864:20::233])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4B3538E
        for <linux-kernel@vger.kernel.org>; Mon, 23 Oct 2023 11:17:40 -0700 (PDT)
Received: by mail-oi1-x233.google.com with SMTP id 5614622812f47-3b2e22a4004so2623492b6e.3
        for <linux-kernel@vger.kernel.org>; Mon, 23 Oct 2023 11:17:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1698085059; x=1698689859; darn=vger.kernel.org;
        h=mime-version:references:in-reply-to:message-id:date:subject:cc:to
         :from:from:to:cc:subject:date:message-id:reply-to;
        bh=D1wDijW8I44LQnxSNkpq+MkPUC6CsBqHTn/Fa7YOg5U=;
        b=HmfkGob6mclJlexf5PVdP/9/GqvcUs9l/w7+ISYGIUhuIlRIT3LRg2i+Np3Fbb/3zy
         Co/Mlk31g036qXLNp8t+2OZyJeeBxxhwxFkwHclOODsvtjf1dkVQAKDbTI1JL7LO1wcP
         OkfhW825IpXFNHMYS85HYIXMmafZJkw8RWBy8=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698085059; x=1698689859;
        h=mime-version:references:in-reply-to:message-id:date:subject:cc:to
         :from:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=D1wDijW8I44LQnxSNkpq+MkPUC6CsBqHTn/Fa7YOg5U=;
        b=
X-Gm-Message-State: AOJu0Yxxyue9iWulicYwZhm9IJAsZkIj39YGnLTN9umhBf2Z0pvijEnC
        aomtcbepNaZXC9BuutdESoxc0w==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="000000000000ca0bea0608663cf9"
...

zL3v
--000000000000ca0bea0608663cf9--

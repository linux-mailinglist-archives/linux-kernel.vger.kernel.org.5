...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E2BE7752A20
	for <lists+linux-kernel@lfdr.de>; Thu, 13 Jul 2023 20:05:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230468AbjGMSFg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 13 Jul 2023 14:05:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36196 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229593AbjGMSFe (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 13 Jul 2023 14:05:34 -0400
Received: from NAM11-DM6-obe.outbound.protection.outlook.com (mail-dm6nam11on2083.outbound.protection.outlook.com [40.107.223.83])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F00F42722
        for <linux-kernel@vger.kernel.org>; Thu, 13 Jul 2023 11:05:29 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=AN9EzWn+OGZby1/mczJPNAgALvirXLbr3pBHDuQmKWA=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=AN9EzWn+OGZby1/mczJPNAgALvirXLbr3pBHDuQmKWA=;
 b=L8t4ztzyOPiAi1S0GP+pHB1cHACtEfsDNUFM2SHG6M+ldLfLfitOewAL2EsqrLl0eG68glX1litBXCb/0SGcnMwXbsHseFYg6drgDD5x9d5A8EDvsfTt+idA/prdx4ioKtUMSMLqdcnRbEw3dGwVptmBbAPk7ZwS2tDCNIWocOo=
...
Received: from DM6NAM11FT047.eop-nam11.prod.protection.outlook.com
 (2603:10b6:5:333:cafe::7f) by DM6PR03CA0078.outlook.office365.com
 (2603:10b6:5:333::11) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.6588.20 via Frontend
 Transport; Thu, 13 Jul 2023 18:05:26 +0000
...
Received: from SATLEXMB04.amd.com (165.204.84.17) by
 ...
 15.20.6588.25 via Frontend Transport; Thu, 13 Jul 2023 18:05:25 +0000
...
Date:   Thu, 13 Jul 2023 18:05:11 +0000
Message-ID: <20230713180511.2872093-1-john.allen@amd.com>
...
X-MS-TrafficTypeDiagnostic: DM6NAM11FT047:EE_|IA0PR12MB8839:EE_
X-MS-Office365-Filtering-Correlation-Id: dd346100-f68d-47bc-1f3e-08db83cbbc1e
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:165.204.84.17;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:SATLEXMB04.amd.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230028)(4636009)(136003)(396003)(346002)(39860400002)(376002)(451199021)(40470700004)(36840700001)(46966006)(15650500001)(82310400005)(86362001)(40460700003)(316002)(40480700001)(36756003)(110136005)(70206006)(70586007)(6666004)(81166007)(7696005)(356005)(82740400003)(478600001)(54906003)(19627235002)(26005)(2616005)(36860700001)(1076003)(336012)(16526019)(44832011)(47076005)(186003)(8676002)(2906002)(4326008)(83380400001)(5660300002)(30864003)(8936002)(426003)(41300700001)(36900700001);DIR:OUT;SFP:1101;
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 13 Jul 2023 18:05:25.9966
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: dd346100-f68d-47bc-1f3e-08db83cbbc1e

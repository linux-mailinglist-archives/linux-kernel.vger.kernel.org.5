Return-Path: <linux-kernel+bounces-83462-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 9E6678699C9
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 16:04:58 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 5364B293D4A
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 15:04:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 42C94149DE5;
	Tue, 27 Feb 2024 15:02:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="TIuivmmc"
Received: from relay8-d.mail.gandi.net (relay8-d.mail.gandi.net [217.70.183.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 28A121487E0
	for <linux-kernel@vger.kernel.org>; Tue, 27 Feb 2024 15:02:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709046138; cv=none; b=rUKH0p1ZYFAe0QAHLRJlwjVc6YHXPyXlO39Uf1JYx5AJHtVay5Iy46XvS/vheT1DELo0rulVbByFV6mp7CgbaNax+67qvxhXwbGGXewo6IlacY6V1IE6YbXCZnx/8doMjexPTdgKkYj1wWkn5amcxxAuzZDq39gC259JnQ6bZPg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709046138; c=relaxed/simple;
	bh=rrS4u1gjuzdpkqLLt9IvErorcz/ICZapoDZPP8nPxpQ=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=aOmpKWGV7OFGwsh04Nz5OCYThDVWeEqgN38G5/Ytrv4IX/SqNxI0pViD7uHUT5v018PWQZscmJnjlMRF9gMISpV7yl3Jcu/gxFFxLJmDjmf+vY1LZkjvKQtFym1d6+gFM2MKx68RW/1Bwkskr2aKbSpeMEYPWly3c2OTfckS8jw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=TIuivmmc; arc=none smtp.client-ip=217.70.183.201

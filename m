...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 666D779C928
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Sep 2023 10:01:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232059AbjILIBj (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Sep 2023 04:01:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49950 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231876AbjILIAG (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Sep 2023 04:00:06 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 20EC52D58
        for <linux-kernel@vger.kernel.org>; Tue, 12 Sep 2023 00:58:32 -0700 (PDT)
Message-ID: <20230912065502.568284573@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1694505510;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=VdESLJN1UDe6KHq+3VNdkhAeyWMXP2vTFS4VMSOD8jo=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1694505510;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=VdESLJN1UDe6KHq+3VNdkhAeyWMXP2vTFS4VMSOD8jo=;
        b=Cosagv9a1arZfw8X5ur0v7Q3gMaEvrlXcCDIrn4psoiXiQrJ+Z9CGOOJ+CZhZnEB4WKfzv
        0SW5s+hrTDgba4Bw==
...
Subject: [patch V3 29/30] x86/microcode: Prepare for minimal revision check
References: <20230912065249.695681286@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Tue, 12 Sep 2023 09:58:30 +0200 (CEST)
Precedence: bulk

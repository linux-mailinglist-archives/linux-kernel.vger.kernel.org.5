Return-Path: <linux-kernel+bounces-106494-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 0320D87EF6E
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Mar 2024 19:02:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6F3D11F231ED
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Mar 2024 18:02:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0C2A65675D;
	Mon, 18 Mar 2024 18:02:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="iMrEI2uO"
Received: from out-189.mta0.migadu.com (out-189.mta0.migadu.com [91.218.175.189])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1BD4455E71
	for <linux-kernel@vger.kernel.org>; Mon, 18 Mar 2024 18:02:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.189
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710784924; cv=none; b=YnDB6irzcS8vqZlQ+9a7wTBHj2b5NURH47UJzd3LfGubZwS478xemC8R2tXwbhTrLyU0mB9b9SRUNswZIYXeVFXpJxC0F42o5eQ1w2HRJCLQWdVmAxVnLhosjiw5HZkbELClfkdblyklz7ixJ2BX+ZaL+5H2EBiTsoc/42Cty/k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710784924; c=relaxed/simple;
	bh=rD35FqWC/tw47uINeGa4HyGcO2hVyyU0qQVbJEtwIgE=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=tPPXtaCymJs4z0D0rI3x+40zSgSGxEl18hgQDr58XQK7C9Tj93xBMxfkePxTj8FJjlJyw/7HtTXq10fMvi7XkDmovnYX4UrRfm9QiQG0BUda/ijRi92bH29TtoVWDGqfmWk0NqLUcqArsOOlxieMHh2vOTtA+no/NcPwqhgfiz4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=iMrEI2uO; arc=none smtp.client-ip=91.218.175.189

Return-Path: <linux-kernel+bounces-38518-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6390E83C0F6
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 12:36:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 180BF2820E2
	for <lists+linux-kernel@lfdr.de>; Thu, 25 Jan 2024 11:36:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C862357332;
...
Received: from mail-yb1-f202.google.com (mail-yb1-f202.google.com [209.85.219.202])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8AC8D55C3E
	for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 11:33:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706182392; cv=none; b=J6TS4Kd1IylkbwlGpDM3U2T3r1TgAZImo5D1DJb16IDd3BmJAObBsOpEyliaZggzUYrW/nuWiVJ9CojHe9YBeWcrBFZlMcxey9guWANdX1kA2fHvLOMetKme/YFfc3Cy3ZgxOSw7aw6P7cXLTXEOkEeyyeXlRXph+LQmuzwAJF8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706182392; c=relaxed/simple;
	bh=0byiLPnDWEQfwFYPOageH65AoBGROCIbfIjdgEIOffg=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=qYKfoj+o2vS4KjcNAUuqZA+/qn1CvE3hcEPVMK+B/Vt5HWNIzR7pb66yaHplextg65YCpvycSpTG088PdG9mdA/4jM84NpCvBFiMJqoSPpEL6OUYXasPahCm1PD/ls++jGl1mftf4QxMnuYocCoj450bhxTOBdsXwSnrfRNko/k=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--ardb.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=av+QYO+S; arc=none smtp.client-ip=209.85.219.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--ardb.bounces.google.com
Received: by mail-yb1-f202.google.com with SMTP id 3f1490d57ef6-dc37b0ac33cso4472739276.2
        for <linux-kernel@vger.kernel.org>; Thu, 25 Jan 2024 03:33:10 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Vu5UpmPKB2YLCZqvfGM/x/cMDohVrJdP/wVfbDfAQyQ=;
        b=
X-Gm-Message-State: AOJu0YxMPwTKZTz68lHJeAvPoHm1vQLJKobRAEc0jxnALmPAVi8zTKbf
	Kw3rKWyuTu9IXpyQ3/3pD0OjBqJQNzuqIln8BS3Bt+xRrXpQSOTFKoqsa8Jrl6+B3kPY1Mk+fH3
	Dz/SXQ6zPCx5xECBm8YyDbzrhLlURhm42kdl94xgqL64yNFB5dRScr0fyFra995QOYzthao765S
	u0p+72saz4Gu+wMGFUnBvpmrjdGENZsg==

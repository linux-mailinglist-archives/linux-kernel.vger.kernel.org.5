Return-Path: <linux-kernel+bounces-93448-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id B5259873002
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 08:55:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D7A331C219EE
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 07:55:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D52775CDF1;
	Wed,  6 Mar 2024 07:55:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="jlvhm6Ap"
Received: from mail-ua1-f44.google.com (mail-ua1-f44.google.com [209.85.222.44])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E35FC5C60F
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 07:54:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.222.44
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709711699; cv=none; b=P5tVdueZvmIxUmn2Z2UV9DAPxJYmMSJaNNqBEsoozLzFmeOpdAAw1+Z4XhPs0B4Wh1oCQ0kQ3x2SwUPN485e+E5Bie3E2RCyle1fA/y3lRNPWbCt2JLFLvmYB1lH3KePmgPEIZjRCc689kccnHCN3TLMjIBjRdfyveu7pLyKqUQ=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=jlvhm6Ap; arc=none smtp.client-ip=209.85.222.44
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-ua1-f44.google.com with SMTP id a1e0cc1a2514c-7da728b0597so2715277241.1
        for <linux-kernel@vger.kernel.org>; Tue, 05 Mar 2024 23:54:56 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=8TjHzenET0BsmhctyS5MBM+hfGxMEJbaLgMm6NPqdR0=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUUWTykpjQEhyZBSzcfLYJSl8oGk2qFdVHD5ISYLFgqSPaBgIysDtuSf2/EIADoLy0ZGPtwFPgZZJjFnBT1zmWq8oaiHYnNeFG8mLz9
X-Gm-Message-State: AOJu0YxOYhjQihss2yYHZWkCSP8H0cUnz7UhOsHHEJQQTN/kpxPb33V7
	Iu7i3niA/u3IcCu33sIB29FGTADe2oTUiBvbNk/O9bRaUoZiwmr6e17ISXula2pVq1HvlWFrwl6
	2G5PthFZJeh2hStp+eyA1MjjY5TAqS05VcHOnPg==

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 77F947F3EC8
	for <lists+linux-kernel@lfdr.de>; Wed, 22 Nov 2023 08:19:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234925AbjKVHTx (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 22 Nov 2023 02:19:53 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45346 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234905AbjKVHTw (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 22 Nov 2023 02:19:52 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1AD3590
        for <linux-kernel@vger.kernel.org>; Tue, 21 Nov 2023 23:19:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1700637589; x=1732173589;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=jR4qGpqNGr5N3SxGbPQmVUCK1n3af/eMYXsQ6k2UzVc=;
  b=VdWcYm/TZQcb9tn6LeslSmJoh+1xPiWY5GHQu3X1WKA93XcSvcCP+sB2
   F8X86Rb+6Y1aNuLApOFmZ1NfYBYKAkX4GWKHxiL5z/0W9jZgKHOpgoFrN
   Kab/Dgz0rJ75OpH+ta87a7Caae32GlqpjktkbmMC6R+S9nh8/ojYc32Df
   UzTjFMxJPLp4DN8vLKtTptjHHBZVjoyAqEMAeXD7+KHedP6TMo5KFLaBo
   Ph/hc/TjilGfJTDLnHSFStyBrsbPCu+z52ySrOcyyoSFcix6oeFWpeIXf
   GTp6bQIfEdxKXfaXlE6cIBn19xrbDRouEVM5y5mmartHPatKBTYKxG6/J
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10901"; a="371350478"
X-IronPort-AV: E=Sophos;i="6.04,218,1695711600"; 
   d="scan'208";a="371350478"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Nov 2023 23:19:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10901"; a="795997229"
X-IronPort-AV: E=Sophos;i="6.04,218,1695711600"; 
   d="scan'208";a="795997229"
Received: from lkp-server01.sh.intel.com (HELO d584ee6ebdcc) ([10.239.97.150])
  by orsmga008.jf.intel.com with ESMTP; 21 Nov 2023 23:19:46 -0800
Received: from kbuild by d584ee6ebdcc with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1r5hWS-0000Bh-04;
        Wed, 22 Nov 2023 07:19:44 +0000
Date:   Wed, 22 Nov 2023 15:19:26 +0800
...
Subject: Re: [PATCH] extcon: usbc-tusb320: Set interrupt polarity based on
 device-tree
Message-ID: <202311221355.yxYpTIw3-lkp@intel.com>
...
config: x86_64-randconfig-121-20231122 (https://download.01.org/0day-ci/archive/20231122/202311221355.yxYpTIw3-lkp@intel.com/config)
compiler: gcc-7 (Ubuntu 7.5.0-6ubuntu2) 7.5.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231122/202311221355.yxYpTIw3-lkp@intel.com/reproduce)

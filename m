Return-Path: <linux-kernel+bounces-2356-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E8BC815B90
	for <lists+linux-kernel@lfdr.de>; Sat, 16 Dec 2023 21:11:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A2FF41C21AAE
	for <lists+linux-kernel@lfdr.de>; Sat, 16 Dec 2023 20:10:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ED320328D1;
	Sat, 16 Dec 2023 20:10:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="Y2ehUGAk"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.9])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4807A31A8A
	for <linux-kernel@vger.kernel.org>; Sat, 16 Dec 2023 20:10:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702757451; x=1734293451;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=jRY0aBrZCb5XBx4waPvCtZvMw+b+imPnxH4Kcr14vH0=;
  b=Y2ehUGAk65EDysEEl++Zq+VfOmhkTmE/aChxRvS9YkD8yDVlnuoMyFMT
   LY4mQ3rTQ+AHwZhqNVhViCGfQjGEDIH+ddNbuKR0atXHw+i7WQtSh5VXu
   XLEPp0p72vADlYq4WSH+4G3WnAop80TFf2CaWdDho4OmjZghMZSKZSAqk
   TubQx/wDaJodfvUcUkiCctOl7juB/JvQg+ftblZMrp3P0ZSaGw0rER41V
   JDNXReeqyGx3flVin8WefveuwcNQvHhQTJs6lOASQMgjvWcZwoCVGXY3q
   VQkdSSqqSts5RMab8yctwbBjSdE6v6yGjPeLn82czWuAsPRXIsIaQuAal
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10926"; a="2239730"
X-IronPort-AV: E=Sophos;i="6.04,281,1695711600"; 
   d="scan'208";a="2239730"
Received: from orviesa001.jf.intel.com ([10.64.159.141])
  by fmvoesa103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Dec 2023 12:10:50 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.04,281,1695711600"; 
   d="scan'208";a="23232191"
Received: from lkp-server02.sh.intel.com (HELO b07ab15da5fe) ([10.239.97.151])
  by orviesa001.jf.intel.com with ESMTP; 16 Dec 2023 12:10:47 -0800
Received: from kbuild by b07ab15da5fe with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1rEazl-0002Ak-0E;
	Sat, 16 Dec 2023 20:10:45 +0000
Date: Sun, 17 Dec 2023 04:10:42 +0800
...
Subject: Re: [PATCH linux-next] mfd: wm8994: Switch to use dev_err_probe()
 helper
Message-ID: <202312170304.CFHNHgBa-lkp@intel.com>
...
config: i386-buildonly-randconfig-003-20231217 (https://download.01.org/0day-ci/archive/20231217/202312170304.CFHNHgBa-lkp@intel.com/config)
compiler: clang version 16.0.4 (https://github.com/llvm/llvm-project.git ae42196bc493ffe877a7e3dff8be32035dea4d07)
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231217/202312170304.CFHNHgBa-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202312170304.CFHNHgBa-lkp@intel.com/

Return-Path: <linux-kernel+bounces-60733-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C7D4850929
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 13:36:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id F3EFA28220B
	for <lists+linux-kernel@lfdr.de>; Sun, 11 Feb 2024 12:36:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B561A5FF18;
	Sun, 11 Feb 2024 12:30:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="iQ7hQk0/"
Received: from mail-lj1-f181.google.com (mail-lj1-f181.google.com [209.85.208.181])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9431D2FC29
	for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 12:30:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707654623; cv=none; b=WRcjtYRDflhy8FOzUuQs0YZBeCxPg24jsTozz7Moalg0PWxvsOagifMuymQIsQzeGV7mkmCUQJZ/E/SkOD8gnBDY47N9s7O4YRmAW1l2TLPPKPVvLEkClIiyZQwhlyGaQXDrhzJGhxAnHAD9xuAwcXQVGMTSHTFti6LdVcLZ/+Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707654623; c=relaxed/simple;
	bh=y/5CgEVQ78qLVmAF+hhDmyCLtbylC6/l+nTZhph7Uw4=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=Oc2DWQWgsIU52BNpngc5L/8LZdmbw6+/va+JKb2l9aisWbsDhBErbAuIXJ5isVu5yD/9EudkKLRiGXh231IokkPIuMW8geo55IIIvUyd1StQg03u9qXqvzp0j0a2hRGSE0v9ut/lksfGgHA2GO1puCglhYk+fSwChYHA5cc9w6E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=iQ7hQk0/; arc=none smtp.client-ip=209.85.208.181
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-lj1-f181.google.com with SMTP id 38308e7fff4ca-2d0e2c90f84so18622571fa.2
        for <linux-kernel@vger.kernel.org>; Sun, 11 Feb 2024 04:30:09 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707654607; x=1708259407; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:from:to:cc:subject:date:message-id:reply-to;
        bh=45j4kyB3wMcd9ZF5oz1l7TzY1lrYoxbutKXJRPNx2Ds=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=45j4kyB3wMcd9ZF5oz1l7TzY1lrYoxbutKXJRPNx2Ds=;
        b=
X-Gm-Message-State: AOJu0YzCjHR7meYLhgPLW5Pzg4/gGuNrJMvIP5yyHCIH6fVHrB/8Ev0c
	VDxntS/0gFFqblCWlG46qGvfRouumEGU2+66c9xsyzY/abrw8wGbODsYsjSOHG6fwX9j0zoIhsP
	E
X-Google-Smtp-Source: AGHT+IES8E5lACnKVwRNwpjt14lW2GYzMiqHP1Hwe/YdGwWLchRXoKskRA9/CSPoFx7Bue7/kIVa5g==
X-Received: by 2002:a2e:be9d:0:b0:2d0:f64c:b343 with SMTP id a29-20020a2ebe9d000000b002d0f64cb343mr748910ljr.47.1707654605768;
        Sun, 11 Feb 2024 04:30:05 -0800 (PST)
Received: from raven.intern.cm-ag (p200300dc6f267100023064fffe740809.dip0.t-ipconnect.de. [2003:dc:6f26:7100:230:64ff:fe74:809])
        by smtp.gmail.com with ESMTPSA id fj18-20020a0564022b9200b0056187ca4120sm1024611edb.10.2024.02.11.04.30.03
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 04:30:04 -0800 (PST)
From: Max Kellermann <max.kellermann@ionos.com>
To: linux-kernel@vger.kernel.org
Cc: Max Kellermann <max.kellermann@ionos.com>
Subject: [PATCH v3 00/35] Fast kernel headers: reduce header dependencies
Date: Sun, 11 Feb 2024 13:29:25 +0100
Message-Id: <20240211123000.3359365-1-max.kellermann@ionos.com>
...
Max Kellermann (35):
 ...
 virt/kvm/vfio.c                               |   1 +
 7553 files changed, 12614 insertions(+), 3217 deletions(-)

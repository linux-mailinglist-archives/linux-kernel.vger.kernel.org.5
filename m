Return-Path: <linux-kernel+bounces-46820-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id B6EEF8444BA
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 17:46:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 1D715B26926
	for <lists+linux-kernel@lfdr.de>; Wed, 31 Jan 2024 16:46:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 281B412C531;
	Wed, 31 Jan 2024 16:46:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.b="QBmufb1f"
Received: from out30-110.freemail.mail.aliyun.com (out30-110.freemail.mail.aliyun.com [115.124.30.110])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D80EE12BE8B
	for <linux-kernel@vger.kernel.org>; Wed, 31 Jan 2024 16:46:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=115.124.30.110
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706719566; cv=none; b=W0+W2r6WKDpzU12mOCOumVWBKjIgLSA2B5A0xfbO3qweYY7V1kZkuk2IU3mN5n78tdpE4ybT4wLDk1tozz+R4kDxd2us3zVfnyTQSc14ySxFP6Ca7sKMHr3jCMfYbsTAW193Rji/fxC4U5td37iMGzi2hI+4536es3NOkdVJw8c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706719566; c=relaxed/simple;
	bh=ZERrR/jagcs19h+q84yX1juxRf+2n4biJjEXB3tTOH0=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=lDXL+RfBxFY7FloTF5Ig5CGreslEHsN2HrNb5In8q90HoMxsmroJa/JE5vca0G1YZlQ97enofX4X5fFXNd/PcVRA++mwWaMeYVI6XaenShJjoJcvMfC176IlMBAh382PHJLhmokXSKCWUiFXujeEm0wC7Fu1txtXllrHnQs5TWw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com; spf=pass smtp.mailfrom=linux.alibaba.com; dkim=pass (1024-bit key) header.d=linux.alibaba.com header.i=@linux.alibaba.com header.b=QBmufb1f; arc=none smtp.client-ip=115.124.30.110
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.alibaba.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linux.alibaba.com
DKIM-Signature:v=1; a=rsa-sha256; c=relaxed/relaxed;
	d=linux.alibaba.com; s=default;
	t=1706719556; h=From:To:Subject:Date:Message-Id:MIME-Version;
	bh=DBBBMI6SNquV80nWljI+fqqwDAidWpYzA8zy+5stevY=;
	b=QBmufb1f6EbZRrMHwlil08yuvHehOCncx3P+ZM05nCuc4vsuYiT7LD4nS0MnbMtm2/2+BVtVHmv1LBhBUPba9HAgp67eIrPurVH+lQDTv8DU6AROo7mrrMDKPLjBbWg0TWwRbrVyNLlMeo5PG3F80fPLeM3G6895ecNpCjnrHlo=
X-Alimail-AntiSpam:AC=PASS;BC=-1|-1;BR=01201311R201e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018045168;MF=yaoma@linux.alibaba.com;NM=1;PH=DS;RN=6;SR=0;TI=SMTPD_---0W.k84OM_1706719553;
Received: from localhost.localdomain(mailfrom:yaoma@linux.alibaba.com fp:SMTPD_---0W.k84OM_1706719553)
          by smtp.aliyun-inc.com;
          Thu, 01 Feb 2024 00:45:55 +0800
...
Date: Thu,  1 Feb 2024 00:45:16 +0800
Message-Id: <20240131164516.34139-3-yaoma@linux.alibaba.com>
X-Mailer: git-send-email 2.37.1 (Apple Git-137.1)
In-Reply-To: <20240131164516.34139-1-yaoma@linux.alibaba.com>

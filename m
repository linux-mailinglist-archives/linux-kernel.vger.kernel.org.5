Return-Path: <linux-kernel+bounces-13059-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 91C8081FF1E
	for <lists+linux-kernel@lfdr.de>; Fri, 29 Dec 2023 12:21:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 48602282B2D
	for <lists+linux-kernel@lfdr.de>; Fri, 29 Dec 2023 11:21:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 07A4B11C99;
	Fri, 29 Dec 2023 11:20:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="JzTDlj3A"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 623DA11726
	for <linux-kernel@vger.kernel.org>; Fri, 29 Dec 2023 11:20:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703848841;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=3yP6nYwuylyO9U3jA/iHF6oUJjOOiuIY4CHVthtfbuI=;
	b=JzTDlj3AWFYDD9SjoELNQhIIwRh/KF+y3i9MPmuqrQAv94AtzQlFfpb9yBQqaS0ryygPFn
	DXog6+VEkNbS7nBO65HCS8Fmm/nW8c8la/J4gGD/MCgbP/pkYwuQ099rto/BYVi9p5VOl3
	D0Vt7ZTzX1y9c2E5k+BwnFLQlXQrdmA=
Received: from mail-wm1-f69.google.com (mail-wm1-f69.google.com
 [209.85.128.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-18-XHcO7iOdMGuSZUHvuJedLQ-1; Fri, 29 Dec 2023 06:20:39 -0500
X-MC-Unique: XHcO7iOdMGuSZUHvuJedLQ-1
Received: by mail-wm1-f69.google.com with SMTP id 5b1f17b1804b1-40d3f53ca2aso35088295e9.0
        for <linux-kernel@vger.kernel.org>; Fri, 29 Dec 2023 03:20:39 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=3yP6nYwuylyO9U3jA/iHF6oUJjOOiuIY4CHVthtfbuI=;
        b=
X-Gm-Message-State: AOJu0YxzcnFSJlnGn6wzkFP86PpyLax6WRUeHreZNA5fTXhmPXB67+me
	KIgBbzg8Yl7xKvRWIEJPY+6z1gMcgpJH/9cQlPOl/p1BqqMc7gIITiqqzrUf3cAL6zyQdL6co7h
	WhXL9VvatLWrhowf++9vT/nv+Kd04pjl4pg3g7rMwTDtytfXZlt2kITnQQzqHYv4+Qv8MUn/WEY
	1sco1wNzGxlnk+yN4=
X-Received: by 2002:a05:600c:5014:b0:40d:5ecd:8f6b with SMTP id n20-20020a05600c501400b0040d5ecd8f6bmr2001465wmr.177.1703848838022;
        Fri, 29 Dec 2023 03:20:38 -0800 (PST)
X-Google-Smtp-Source: AGHT+IFS3NC5WFCzl5h9MVmuuGL6iu2tYH+9q2M/VUmUjX5EvszuTCM2ClMp0Ll5WXG3b+VHRFwskw==
X-Received: by 2002:a05:600c:5014:b0:40d:5ecd:8f6b with SMTP id n20-20020a05600c501400b0040d5ecd8f6bmr2001446wmr.177.1703848837726;
        Fri, 29 Dec 2023 03:20:37 -0800 (PST)
Received: from localhost (205.pool92-176-231.dynamic.orange.es. [92.176.231.205])
        by smtp.gmail.com with ESMTPSA id v8-20020a05600c444800b0040c2c5f5844sm30444522wmn.21.2023.12.29.03.20.37
...
Subject: [PATCH v5 4/4] drm/ssd130x: Add support for the SSD133x OLED controller family

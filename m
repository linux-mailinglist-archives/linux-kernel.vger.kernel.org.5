...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7FCD179E6DF
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Sep 2023 13:34:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240491AbjIMLdw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Sep 2023 07:33:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49308 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240476AbjIMLdd (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Sep 2023 07:33:33 -0400
Received: from smtp75.iad3a.emailsrvr.com (smtp75.iad3a.emailsrvr.com [173.203.187.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4A8D21FC3
        for <linux-kernel@vger.kernel.org>; Wed, 13 Sep 2023 04:33:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mev.co.uk;
        s=20221208-6x11dpa4; t=1694604801;
        bh=ksLlkWZwHcv286ezdkSmNkFGXAPDZINrMsbQLaeKFwg=;
        h=From:To:Subject:Date:From;
        b=CysSO0/yfZIR3RYSURAAmveLFonc3+ZtUFkLcky19B3mL9yEdHOG96Wl8bAvsF8v6
         wfItTHT4hyVgxkj5OJgB2bGIPc3WwARtdtehlz00uncxi1mQKqeBNNeDyowyNIqnfe
         D3W2Xspx8CdxmjfxGZwaRt5a7H+p2bjaecgFDKsA=
X-Auth-ID: abbotti@mev.co.uk
Received: by smtp26.relay.iad3a.emailsrvr.com (Authenticated sender: abbotti-AT-mev.co.uk) with ESMTPSA id A5E39424A;
        Wed, 13 Sep 2023 07:33:20 -0400 (EDT)
...
Date:   Wed, 13 Sep 2023 12:32:45 +0100
Message-Id: <20230913113247.91749-12-abbotti@mev.co.uk>
X-Mailer: git-send-email 2.40.1
In-Reply-To: <20230913113247.91749-1-abbotti@mev.co.uk>
References: <20230913113247.91749-1-abbotti@mev.co.uk>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Classification-ID: 007ec4bd-2574-475a-9bbd-5a4f93b29aec-12-1
Precedence: bulk

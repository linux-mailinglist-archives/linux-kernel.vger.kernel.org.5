Return-Path: <linux-kernel+bounces-86065-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id F167086BF26
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 03:58:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A66202860BD
	for <lists+linux-kernel@lfdr.de>; Thu, 29 Feb 2024 02:58:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8F850376EB;
	Thu, 29 Feb 2024 02:58:14 +0000 (UTC)
...
Received: from mail-ot1-f49.google.com (mail-ot1-f49.google.com [209.85.210.49])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5436B374F7
	for <linux-kernel@vger.kernel.org>; Thu, 29 Feb 2024 02:58:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709175493; cv=none; b=svC6Cm3PM/+YX9+bqUecOnMZnoivUYRDthMHYt481JOe6Wt5LcED85HW8U6xhWDum9LuO9juhRZbalw3PE7iCk4gZ6sWtDulJrdtcB33d2WuuVjrRaBNxhiBiOv0Skn4oMWoc8jjlwn14YRAbUrSB6qzuffISFX6l/yQbzR/yzw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709175493; c=relaxed/simple;
	bh=4TOA+r5FgQu9r7XyUG+jnEXfKZGB1J0B4LAWQX2lpPQ=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=i6/6zvs4vRX/e5gxIW+Axuq5ogz8zcI3aEmSDSioGGiodfw1gtH8sTGYLzLED6Lb4N7NctUeGyEf2yN1awhhnqc9UosW86z43smOWXC5whOKbYYDQXr0hoXd9tVf/EnR51SFKNO0Rn5OF130NvtSIav5wrZZdki2sAp6NmjNtlw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org; spf=pass smtp.mailfrom=chromium.org; dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b=KgjD/AlN; arc=none smtp.client-ip=209.85.210.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=chromium.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=chromium.org
Received: by mail-ot1-f49.google.com with SMTP id 46e09a7af769-6e48153c13aso202777a34.3
        for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 18:58:12 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=h8gBHZBcb2YMWItHZ5v52k75LYEpNNA/oZohojyoTqA=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVc5EMq1DrLXss/WhWabAJdvbretz9pWzRrTfMpZBer3dWfQ/+QgbeKq+A6uVTk9qxNdjvWJQQmO0vMn+TbLUyQ0XECLC8VGzIhQ+hD
X-Gm-Message-State: AOJu0YwXQixYshK8e+zqd4UuCJ7LfCZG2GQU9Sk6cHTrcH5rxF86MxZE
	gRlpXJIRElSIi4XJpxIK9woh+heJyBUHlZprpZ7OjVEbUi5UVeJXo3N1bZk8mw==

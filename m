Return-Path: <linux-kernel+bounces-105009-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 22B3987D791
	for <lists+linux-kernel@lfdr.de>; Sat, 16 Mar 2024 01:25:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 944711F22DB2
	for <lists+linux-kernel@lfdr.de>; Sat, 16 Mar 2024 00:25:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 611BF184D;
	Sat, 16 Mar 2024 00:25:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="K4Sjn2ip"
Received: from out-170.mta0.migadu.com (out-170.mta0.migadu.com [91.218.175.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1DA83360
	for <linux-kernel@vger.kernel.org>; Sat, 16 Mar 2024 00:25:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710548716; cv=none; b=g3r1MXWCmX5zPPlWjLJJiov8wNc+hXn+MmO0BtRb0QDqRwFiqabiShcN5diokhj8YTAKNxdwAe7eVkOhTh7WBk9lmIZYqk+GnH0LliKFKFG3ZWXCTzGmfe/yiyOKTm/zX50Tt8iu/ZdeNTFSqx9dVqDVJkNoR/66LV3R/mvTa1Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710548716; c=relaxed/simple;
	bh=nvkb0nJYfnboMjaj3vhD7XClN0dbH8h/0TpD6qkFGRE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=JWBADF9v7cIMNaDWbmXmRzAOhyIBhrjxMv99pOYdWYuCm7dikYergUX+WrctiehWx9UVQ2TkqwVNYQzRDWpEeYUuIxvDhl8KV9JInBzLxHtuGGBFCqc632a8SAlogvqH9UdOG5Y/DcUPOm1LZgovVBN/oKUAetwasRWuN28mp9Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=K4Sjn2ip; arc=none smtp.client-ip=91.218.175.170

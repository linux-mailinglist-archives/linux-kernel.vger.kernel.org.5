...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7B07C7531BA
	for <lists+linux-kernel@lfdr.de>; Fri, 14 Jul 2023 08:06:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235058AbjGNGGZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 14 Jul 2023 02:06:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47256 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235006AbjGNGGV (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 14 Jul 2023 02:06:21 -0400
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A5B7E1BF6
        for <linux-kernel@vger.kernel.org>; Thu, 13 Jul 2023 23:06:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1689314774; x=1720850774;
  h=date:from:to:cc:subject:message-id:
   content-transfer-encoding:mime-version;
  bh=V3iMlsSwgtumQ4iZyK26LXKeyi3in916aXCY3+xpWZ4=;
  b=FhI1yT7cgWo0hwry1OORlMFoUOJBn5mnmWxQgNcGBQANFGBDGYNlvW5C
   5lBRMOeE80MoiP9NrgEmOg83wh+SVa/eDHLnK2JIfBMwYe5J3xk2oU1BI
   y8E5m2up/hrJeJtdoP7/DYgbCiFulLk1+6LFIrfgzxJ/CXPjbsUuR1iiF
   H5lAC2Oh8EsIS3VCxRMCalIX/RIvnZLEzYMQlnt3d52IhbyZAmWAQbwJ+
   FxiEiWv34gxLugieRpkxO5zFPweTddGrGw75E3jaey9pnr5EyHfsI2VYU
   6VaRgpfPWGo98NqLKz9KJq4NsGk1A1Ys8IIfmcH+OmlYoByxG4Xx0g+19
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10770"; a="368951018"
X-IronPort-AV: E=Sophos;i="6.01,204,1684825200"; 
   d="yaml'?scan'208";a="368951018"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jul 2023 23:06:07 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10770"; a="835912459"
X-IronPort-AV: E=Sophos;i="6.01,204,1684825200"; 
   d="yaml'?scan'208";a="835912459"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
  by fmsmga002.fm.intel.com with ESMTP; 13 Jul 2023 23:06:05 -0700
Received: from fmsmsx611.amr.corp.intel.com (10.18.126.91) by
 fmsmsx602.amr.corp.intel.com (10.18.126.82) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27; Thu, 13 Jul 2023 23:06:05 -0700
Received: from fmsmsx610.amr.corp.intel.com (10.18.126.90) by
 fmsmsx611.amr.corp.intel.com (10.18.126.91) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27; Thu, 13 Jul 2023 23:06:04 -0700
Received: from FMSEDG603.ED.cps.intel.com (10.1.192.133) by
 fmsmsx610.amr.corp.intel.com (10.18.126.90) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27 via Frontend Transport; Thu, 13 Jul 2023 23:06:04 -0700
Received: from NAM10-BN7-obe.outbound.protection.outlook.com (104.47.70.100)
 by edgegateway.intel.com (192.55.55.68) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.27; Thu, 13 Jul 2023 23:06:04 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=RJOx4cyYIMx7/P7FdHbi8YHSHPYRxyPXlO2ryNVgOww=;
 b=
...
Received: from PH8PR11MB6779.namprd11.prod.outlook.com
 ...
 ([fe80::35cf:8518:48ea:b10a%7]) with mapi id 15.20.6588.027; Fri, 14 Jul 2023
 06:06:01 +0000
Date:   Fri, 14 Jul 2023 14:05:42 +0800
...
CC:     <oe-lkp@lists.linux.dev>, <lkp@intel.com>,
        ...
        Zack Rusin <zackr@vmware.com>, <linux-mm@kvack.org>,
        <feng.tang@intel.com>, <fengwei.yin@intel.com>,
        <oliver.sang@intel.com>
Subject: [linus:master] [mm/memory]  3db82b9374:  vm-scalability.throughput
 39.9% improvement
Message-ID: <202307141335.ac9351d0-oliver.sang@intel.com>
Content-Type: multipart/mixed; boundary="khOm2cxixQAfQXR1"
...
X-MS-Office365-Filtering-Correlation-Id: 774e8b41-b093-4f41-09b5-08db84306585
X-LD-Processed: 46c98d88-e344-4ed4-8496-4ed7712e255d,ExtAddr
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH8PR11MB6779.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230028)(39860400002)(396003)(366004)(136003)(346002)(376002)(451199021)(966005)(6512007)(44144004)(6666004)(6486002)(83380400001)(186003)(21490400003)(2616005)(36756003)(38100700002)(86362001)(82960400001)(1076003)(26005)(6506007)(66476007)(4326008)(7416002)(66946007)(7406005)(66556008)(6916009)(19627235002)(41300700001)(54906003)(235185007)(5660300002)(8936002)(316002)(8676002)(2906002)(478600001)(30864003)(2700100001);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?RjGlNg86i7cLmH9VrqYH9B5cV6soAtABFh/XZPDQGsOKbFf5MfGT6LLKhr?=
 =?iso-8859-1?Q?CQVl44Poavk7uS5mTQWE3YU+RgovKXo/MQI9P9DhfO9JcL1kSspE2Nc7M5?=
 =?iso-8859-1?Q?WlanpxouXXCMGtObLMIQTNfSNKM3GEU9R5KqN2gfQXMDk5Rg7fO8pjlY++?=
 =?iso-8859-1?Q?SIbAWCZ0pWUDYil8+3CqQvhAjcnMuK9QzaylwR3O2EBZG5Fpf2VtLEwIYB?=
 =?iso-8859-1?Q?c3GCia50isNfnFK889DGvDjX54SAEVdtD1n9atZuSlkaUKYexIHSg2sVeR?=
 =?iso-8859-1?Q?XZGTcQILZeqZ0huc6KtdFkwAy9gvgJzvjwoilLXxjUqth9iyp/jUS61aV0?=
 =?iso-8859-1?Q?hFjPA9IQIE3H32Dj8+Ejwei0YGApvL9BYKY99djXTGrTmpb53doybABm19?=
 =?iso-8859-1?Q?YGJIdx5P6DskEpyqkubKmiGp85XGJZ451IK/Cnpw+ZOF/Qf1hXxyHxHkiN?=
 =?iso-8859-1?Q?EH4kwume/wOVaKFJ+T/aoQgy3l/qe83MBWG2YwBtvGt/gy8+WPo330rjKb?=
 =?iso-8859-1?Q?tTBtMw0Jpji0yPSGNKrv12k3Ma14VYOh35Moin1jg8wFhTHghp98RRFu3i?=
 =?iso-8859-1?Q?EODIi/GBteIIHaqpoQNmIC5Ze6vzPbaXlBXnzO1XlxpmYQ0/V3BkgjVKnX?=
 =?iso-8859-1?Q?IziM0qxdOq4LlXMSetEz/sPFWLw++TzmheRNI/ZWUAvA1aQP7bUnnFe7sM?=
 =?iso-8859-1?Q?DeKMbYKA88difTGEQPNOky/fsETtC1b0JbbW8/3iAPiA2BIikCEcngmkn+?=
 =?iso-8859-1?Q?CbOj5yCTK3YgK7f3AkkuSjcbBMIxaziXFxV/f3rwzYWCEqSwlFCeHJeG5Z?=
 =?iso-8859-1?Q?3MMkl08uZxHVmpwJDydA88kh3CdO1nMy1SN3mql/bgNxXAO0ExDgTS6Mm9?=
 =?iso-8859-1?Q?6YCZfF+n9CXV28ioGUEcoevXt4AE3/+Mn4fMXoHAGY/Acq4TKdlTmMFDLP?=
 =?iso-8859-1?Q?olUNgZ9IZLx9E28a5QKxUbPbVNEhHV3bHPosOAOgqrzdIawmTU4/tIQxvp?=
 =?iso-8859-1?Q?xMVVAVm8f0+jkoQ3y/EE37vDIFHyvrybTBHN5utIbySA8phm92IGCSmeWO?=
 =?iso-8859-1?Q?8gMeNTM6BeF5TJJHuktESAPkiUxb6u57OF4eNODYlwPHFJM41wb/Etxkcp?=
 =?iso-8859-1?Q?zVXoYpBZMjLMnWbvXxnUaq98E1xtgJBIgSmGPUIqzNZd+in3tmhElc2kQg?=
 =?iso-8859-1?Q?RoIdtdNxNZST5VSmqtOI7lyT+fFlqOeY+PiNpx+kwX29n4VATKTaaM1zTN?=
 =?iso-8859-1?Q?IeoKVM2C5YVHI9qRA87zYMkTK1G1mwdHllwvSpBMGQtLi+enNaQ0Jt021X?=
 =?iso-8859-1?Q?BoTLlYmFOov/ssoQOXABwfkALIRgO9maUJHIfSwhb9HwYvYFPmZc/eN4bz?=
 =?iso-8859-1?Q?Qheb75Uw7lbTR1j0P7niL7HGto9smd1k9YtnorYwh8LzQvllRVjufoRUVn?=
 =?iso-8859-1?Q?3RSUr8DtB5eOU1b8AWo2Z9ti+slwGQqySHjgrufE16meeLOMubHpa0hZIe?=
 =?iso-8859-1?Q?Okf5s3QOCtbQZtZpFN52lUBdIgRtOctyI7zo7V0To98qNulzbgabw4Z9G4?=
 =?iso-8859-1?Q?YHAOdpByRmX3zort1ofuCTqWS6qmWpSoQc+HkLgXiJr2CJ6eoyE81ABBbQ?=
 =?iso-8859-1?Q?YrDq4zsInBDAAAy45BEWdY2Dxur8HncF1gx+7xR4nn5kv+yD+4I+sJSA?=
 =?iso-8859-1?Q?=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 774e8b41-b093-4f41-09b5-08db84306585
X-MS-Exchange-CrossTenant-AuthSource: PH8PR11MB6779.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 14 Jul 2023 06:06:00.7133
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: tbudtHZd0ZoPD83H7mAhjwQHMB4at4/jIGBzyIrHeATeyQeLDMdhHqgSBi6RmmzyyRpSp6KhI+b/I8UcVy5ipA==
...
Content-Disposition: attachment;
	filename="config-6.4.0-rc4-00265-g3db82b9374ca"
...
kbuild_queue_analysis'
	...
	export submit_id='64b03a265a6af014515048fb'
	export job_file='/lkp/jobs/queued/validate/lkp-csl-2sp3/vm-scalability-performance-300s-8T-anon-cow-seq-mt-debian-11.1-x86_64-20220510.cgz-3db82b9374ca-20230714-5201-101dnu-5.yaml'
	export id='3fd27c69707fe7230645491bad75d9a70ab3ca81'
...
{"PREEMPT_RT"=>"n"}
BLK_DEV_LOOP'
	export commit='3db82b9374ca921b8b820a75e83809d5c4133d8f'
...
BLK_DEV_NVME'
	...
	export enqueue_time='2023-07-14 01:53:43 +0800'
	export _id='64b03a295a6af014515048fd'
	export _rt='/result/vm-scalability/performance-300s-8T-anon-cow-seq-mt/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f'
	export compiler='gcc-12'
	export head_commit='605a4c6c6d3521f6020e047bec5b1a81dc6b864f'
	export base_commit='06c2afb862f9da8dc5efa4b6076a0e48c3fbaaa5'
	export branch='linus/master'
	export rootfs='debian-11.1-x86_64-20220510.cgz'
	export user='lkp'
	export LKP_SERVER='internal-lkp-server'
	export scheduler_version='/lkp/lkp/.src-20230713-180520'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-11.1-x86_64-20220510.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/vm-scalability/performance-300s-8T-anon-cow-seq-mt/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/vmlinuz-6.4.0-rc4-00265-g3db82b9374ca
branch=linus/master
job=/lkp/jobs/scheduled/lkp-csl-2sp3/vm-scalability-performance-300s-8T-anon-cow-seq-mt-debian-11.1-x86_64-20220510.cgz-3db82b9374ca-20230714-5201-101dnu-5.yaml
user=lkp
ARCH=x86_64
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/modules.cgz'
	...
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp3/vm-scalability-performance-300s-8T-anon-cow-seq-mt-debian-11.1-x86_64-20220510.cgz-3db82b9374ca-20230714-5201-101dnu-5.cgz'
	export last_kernel='5.4.0-0.bpo.2-amd64'
	export repeat_to=6
	export kbuild_queue_analysis=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/vmlinuz-6.4.0-rc4-00265-g3db82b9374ca'
	export result_root='/result/vm-scalability/performance-300s-8T-anon-cow-seq-mt/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/3'
...
extract_stats()
{
	...
	env test='anon-cow-seq-mt' $LKP_SRC/stats/wrapper vm-scalability
...
submit_id: 64b029a05a6af0117793c878
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp3/vm-scalability-performance-300s-8T-anon-cow-seq-mt-debian-11.1-x86_64-20220510.cgz-3db82b9374ca-20230714-4471-52zk0n-0.yaml"
id: a9c2a0146e3f522c6d6ebfc080865b56d73e156f
...
#! /db/releases/20230711135438/lkp-src/include/vm-scalability
...
ucode: '0x4003303'
kconfig: x86_64-rhel-8.3
enqueue_time: 2023-07-14 00:43:12.977731096 +08:00
_id: 64b029a05a6af0117793c878
_rt: "/result/vm-scalability/performance-300s-8T-anon-cow-seq-mt/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f"
compiler: gcc-12
head_commit: 605a4c6c6d3521f6020e047bec5b1a81dc6b864f
base_commit: 06c2afb862f9da8dc5efa4b6076a0e48c3fbaaa5
branch: linux-devel/devel-hourly-20230712-214247
rootfs: debian-11.1-x86_64-20220510.cgz

#! schedule options
user: lkp
LKP_SERVER: internal-lkp-server
scheduler_version: "/lkp/lkp/.src-20230713-180520"
arch: x86_64
max_uptime: 2100
initrd: "/osimage/debian/debian-11.1-x86_64-20220510.cgz"
bootloader_append:
- root=/dev/ram0
- RESULT_ROOT=/result/vm-scalability/performance-300s-8T-anon-cow-seq-mt/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/0
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/vmlinuz-6.4.0-rc4-00265-g3db82b9374ca
- branch=linux-devel/devel-hourly-20230712-214247
- job=/lkp/jobs/scheduled/lkp-csl-2sp3/vm-scalability-performance-300s-8T-anon-cow-seq-mt-debian-11.1-x86_64-20220510.cgz-3db82b9374ca-20230714-4471-52zk0n-0.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=3db82b9374ca921b8b820a75e83809d5c4133d8f
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/modules.cgz"
...
#! /cephfs/db/releases/20230713011109/lkp-src/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:
watchdog:
job_initrd: "/lkp/jobs/scheduled/lkp-csl-2sp3/vm-scalability-performance-300s-8T-anon-cow-seq-mt-debian-11.1-x86_64-20220510.cgz-3db82b9374ca-20230714-4471-52zk0n-0.cgz"
last_kernel: 5.4.0-0.bpo.2-amd64
repeat_to: 3

#! user overrides
kbuild_queue_analysis: 1
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/vmlinuz-6.4.0-rc4-00265-g3db82b9374ca"
result_root: "/result/vm-scalability/performance-300s-8T-anon-cow-seq-mt/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/3db82b9374ca921b8b820a75e83809d5c4133d8f/0"

#! /cephfs/db/releases/20230713180309/lkp-src/include/site/inn
dequeue_time: 2023-07-14 01:11:50.402964291 +08:00
job_state: finished
loadavg: 68.87 56.76 25.79 1/914 12882
start_time: '1689268440'
end_time: '1689268742'
version: "/lkp/lkp/.src-20230713-180618:6410f88f58fb:9d108d0af935"
...
cd /lkp/benchmarks/vm-scalability
 ...
 truncate -s 134976569344 /tmp/vm-scalability-tmp/vm-scalability.img
 ...
 ./usemem --runtime 300 -t 96 --prealloc --prefault 33744142336

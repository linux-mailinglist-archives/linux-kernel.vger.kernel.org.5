Return-Path: <linux-kernel+bounces-129022-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 52448896350
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 05:59:08 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id D62B91F23F3E
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 03:59:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1860E405C7;
	Wed,  3 Apr 2024 03:59:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="GuzPmlVQ"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DFD763D76
	for <linux-kernel@vger.kernel.org>; Wed,  3 Apr 2024 03:58:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.12
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712116740; cv=none; b=tosrzRRkjdNB+IffAqbqONqhSnlfVIqo+Oa+KLuAsnN9VwIH8dYgO//R8zP7LXDDlj9ntSEBns2PsYqSfZPIwIqZwmkAEidLIxFFnmwE+iFWmyZZj79OS3X7YEbEWety+R/mEy9eE9jzAdV+EEvUQmewyyV5JbyH9OO/0hwGwQ8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712116740; c=relaxed/simple;
	bh=vSlJA2t8HpDVpA51uDVKS2MHo9tpsn0DeCPojB+/9Qo=;
	h=From:To:Cc:Subject:In-Reply-To:References:Date:Message-ID:
	 MIME-Version:Content-Type; b=Y1lqCRt0+KtmGyfCy+c/WEFGIUz8mN7TTaryirSKsqdi/zp+nMYtCI5UaTxA+ms1iAW4Jaz3wSZxYkYU+1qaA/z+93gpo9Ds+7ZT7ChLcbJa3loqSvWSnH1UJWk746t5As40qLhVcxhD4vmej95pVqdSgur18l34TV7/GZqqHuo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=GuzPmlVQ; arc=none smtp.client-ip=198.175.65.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1712116738; x=1743652738;
  h=from:to:cc:subject:in-reply-to:references:date:
   message-id:mime-version;
  bh=vSlJA2t8HpDVpA51uDVKS2MHo9tpsn0DeCPojB+/9Qo=;
  b=GuzPmlVQwK3BuY2uqkoj+SQzkKzmlMtSk+fIv5tDF7/o3tajGwR6K02a
   EqjbWPyel0jyABTEnZIm/E9QMABGErwSzzL4UN5lldOQMqvav7JgEUOUC
   r++JbINHWA1McnDefANtWYnJmLHZxU2+zXYJMVylvfIJyeGVKelKwk2xz
   op60CQTWKGvKHMtqCg2mqpP/+GjANUGxlqSk4bFFb3gdY0REqkA/Lcv93
   aV4qjnjQ9uyiou4MgNevf3m6D/4nOMqYZ9KVZzPLLcKDoEsvCwe4rJ+uC
   N1dczeW3zMMR9E0TizblHrENcJNq7B8qiRzNXQmymp/hZLIub+xznFBpB
   w==;
X-CSE-ConnectionGUID: dPiwEBH2TCmSHkDhll8lbw==
X-CSE-MsgGUID: epqmKqvkTWCNCwwbq4PFyA==
X-IronPort-AV: E=McAfee;i="6600,9927,11032"; a="18771890"
X-IronPort-AV: E=Sophos;i="6.07,176,1708416000"; 
   d="scan'208";a="18771890"
Received: from fmviesa004.fm.intel.com ([10.60.135.144])
  by orvoesa104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Apr 2024 20:58:57 -0700
X-CSE-ConnectionGUID: iK3UlzVaTJW+ToROFkbJ0Q==
X-CSE-MsgGUID: ti8AU+koS8qtCAH5k8RF2w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,176,1708416000"; 
   d="scan'208";a="22923795"
Received: from yhuang6-desk2.sh.intel.com (HELO yhuang6-desk2.ccr.corp.intel.com) ([10.238.208.55])
  by fmviesa004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Apr 2024 20:58:54 -0700
...
Subject: Re: [PATCH v5 2/6] mm: swap: free_swap_and_cache_nr() as batched
 free_swap_and_cache()
In-Reply-To: <921dfad3-4832-461c-a250-673dda81201e@arm.com> (Ryan Roberts's
	message of "Tue, 2 Apr 2024 12:15:21 +0100")
...
Date: Wed, 03 Apr 2024 11:57:00 +0800
Message-ID: <87y19vdroz.fsf@yhuang6-desk2.ccr.corp.intel.com>

Return-Path: <linux-kernel+bounces-121683-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id EAF8688EC61
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 18:19:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1A66B1C2F05A
	for <lists+linux-kernel@lfdr.de>; Wed, 27 Mar 2024 17:19:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1B1B614F117;
	Wed, 27 Mar 2024 17:18:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="O6Ld7mtL"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E09F914C5A4
	for <linux-kernel@vger.kernel.org>; Wed, 27 Mar 2024 17:18:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711559886; cv=none; b=FCgjNhp9owp0xWNkp1FAV9FdRdY9TjbJxp9pyZEAFCcwMQkAPqy8ArTR31LNsdQ1RDLcw1fwDX50TJT/47k0WKM4DRp+Mic4Pz6nhHJC38mfyGdOcjeFjzdFKiuK6OZ86mrFtj6i9sbbQXMShXybFxU2YSU96FpZxQIMmATe9lU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711559886; c=relaxed/simple;
	bh=fCPBqdb/94XOPUlqfbJ0TMJ1y8uN4lm1XSG1ZWVDSUA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=FQG6og6ZcqQdQP3/Sy0eEGhYzunM4t8CsJwt3q2j7liEajNO9jr5kM7pr7fpZ+z/VfZBBQ3oVAIx3yC8Uj6HQCiD07MXiYayYCUkGewUSgVflRDnP8kWq9H3TI6bc97smpWOZ76n6e3IkQYPR4jcY2N4GIcBk/XwIl1luHBQZHw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=O6Ld7mtL; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1711559883;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=BvzM0tI1442ad9elHAX827KhH0GuwUl4zhYChvz46rg=;
	b=O6Ld7mtLgpcPIbZcz3nSxTNESb4gvFnSKGLtY+LYHA6VXono84lXVltoEZDB0oX+mg25Oq
	0wh10jog5Fnb6/leH56GwcvKAq7M2/F3pm4Hw4Fao89cYI9E1lruFAIxUuOSxWCU6G2lCI
	MpXtPezlEZIvrTImfxP10pwzOrjzlcM=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 856457AD00E
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Sep 2023 08:21:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232209AbjIYGVh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 25 Sep 2023 02:21:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50206 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232137AbjIYGUh (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 25 Sep 2023 02:20:37 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3BC2ACE;
        Sun, 24 Sep 2023 23:20:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1695622811; x=1727158811;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=NdFNRv6E3hM4jMDlbYL4sowJjPuERR1hPGPq4pKMemc=;
  b=YeIlvh0vuZWMbOslRpugRTw3GECDkSTTBkK40IZi7jKvERcm1mIwutYk
   MDpKngk0aISuruRKPyvZWU/1JyssNH/xVmlwJel6rxwkBzlqMM0Uwkuxe
   FFPRjaP8FbJeL2nE6dC5Wb1V+XfO0BTgEih/IwjoaPqcIeXtHM7rxMBvE
   Vwp9mljbDJElmQysuIad3xrlyrwoBuyL7WxoTd9oKKhgcwpd5+wsvAZaC
   IHai3MdajYxf7hHUzN4NI15ACvFkR3b3ZCRthKh1XNdkTIZo7FG12V0OZ
   Zau3t2BuZ4uh0sgj9GS8Wejdq7Q5FMdwSmO509YSOvAQMLqG6V3lXwCbp
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="445279585"
X-IronPort-AV: E=Sophos;i="6.03,174,1694761200"; 
   d="scan'208";a="445279585"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Sep 2023 23:19:27 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="818494459"
X-IronPort-AV: E=Sophos;i="6.03,174,1694761200"; 
   d="scan'208";a="818494459"
Received: from b49691a75598.jf.intel.com ([10.54.34.22])
  by fmsmga004.fm.intel.com with ESMTP; 24 Sep 2023 23:19:26 -0700
...
Subject: [RFC PATCH 25/25] perf pmu-events: Add event counter data for Tigerlake
Date:   Sun, 24 Sep 2023 23:18:24 -0700
Message-Id: <20230925061824.3818631-26-weilin.wang@intel.com>

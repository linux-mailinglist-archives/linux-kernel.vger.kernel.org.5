...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C41227ACFF5
	for <lists+linux-kernel@lfdr.de>; Mon, 25 Sep 2023 08:19:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230093AbjIYGTx (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 25 Sep 2023 02:19:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37772 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232031AbjIYGTt (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 25 Sep 2023 02:19:49 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BA360199;
        Sun, 24 Sep 2023 23:19:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1695622760; x=1727158760;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=ccieYRO3uuEKh5PB1xUSUJ4mv2CwsCRi5oZ2Y7ddVDA=;
  b=mmL+0JMgmlZ/nXKByA346nekRBzXFuIZZZElxykRI6yH0Q1+ctINU4Sh
   V8BcfPWbBUFJhDvNkSjuSjXxu7mMhfbTrJ4Vyu+fm2FaO3RUyHBzBW1mL
   +wTokyyRQykbsiIwQOI2waQsHv1x68xL/Y+wNUVQCVKYTYJ0T4Wm+mYjV
   Y4ZOl/jJSqq7FkmcjFDP7f7Exm/1JTi8Lf3hwT0wNnh1FEcid84JGV5HP
   z8nASKhShb5JcbIMkM0TGcdzykmh9/sXRBFhTPF6JcgdMnLx+x59dA2R/
   eATjtRSkmVmoNAW+dkqVdwgfYyOXQ3fqWtNnkaXIhcfavVFHzcujqe3O+
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="445279391"
X-IronPort-AV: E=Sophos;i="6.03,174,1694761200"; 
   d="scan'208";a="445279391"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Sep 2023 23:19:11 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10843"; a="818494327"
X-IronPort-AV: E=Sophos;i="6.03,174,1694761200"; 
   d="scan'208";a="818494327"
Received: from b49691a75598.jf.intel.com ([10.54.34.22])
  by fmsmga004.fm.intel.com with ESMTP; 24 Sep 2023 23:19:10 -0700
...
Subject: [RFC PATCH 04/25] perf pmu-events: Add counter info into JSON files for SapphireRapids
Date:   Sun, 24 Sep 2023 23:18:03 -0700
Message-Id: <20230925061824.3818631-5-weilin.wang@intel.com>
...
---
 ...
 15 files changed, 2305 insertions(+), 17 deletions(-)
...
@@ -655,7 +655,7 @@ def preprocess_one_file(parents: Sequence[str], item: o=
s.DirEntry) -> None:
...
+      _bcs.add(event.build_c_string(metric=3DFalse, layout=3DTrue), metric=
=3DFalse)
=20

Return-Path: <linux-kernel+bounces-47749-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 338AC845253
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Feb 2024 09:06:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id C49451F259A8
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Feb 2024 08:06:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ADCD2158D78;
	Thu,  1 Feb 2024 08:06:01 +0000 (UTC)
...
Received: from mail-il1-f180.google.com (mail-il1-f180.google.com [209.85.166.180])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 393EE664BE
	for <linux-kernel@vger.kernel.org>; Thu,  1 Feb 2024 08:05:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.166.180
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706774760; cv=none; b=atU/l2TtZG8EnmU9fmd52OAMHtnsGA6LP0LuCfPp2iqCRac5/5+DDh0bZftXtR7dS9+3Z1Q0vNf6gp0csFy/uzeFsPkITvIsTHouDMUF259X3QiEABjyzgMska0cvqzNkEDzJ0fcjpMkZQF7J1k0qztR20uGgrRtIP+Jr6gNHCU=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=bytedance.com; spf=pass smtp.mailfrom=bytedance.com; dkim=pass (2048-bit key) header.d=bytedance.com header.i=@bytedance.com header.b=BZLJuWKx; arc=none smtp.client-ip=209.85.166.180
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=bytedance.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bytedance.com
Received: by mail-il1-f180.google.com with SMTP id e9e14a558f8ab-3639fac1d06so392985ab.1
        for <linux-kernel@vger.kernel.org>; Thu, 01 Feb 2024 00:05:57 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         ...
         :reply-to;
        bh=xUqkQTp/EejRMwYJr1zUIe1l3Bx/6LHMX3gDVJzEF5k=;
        b=
X-Forwarded-Encrypted: i=0; AJvYcCW/dl7lIka+R3BgcRgU5W/j+BaVZYzWhtoFJqitoI4pCvrRX1+AFUUZMynbtgoCo6aZqfjrYNLL0gm3FTrdWLmYZ/ySy5yYlVPREC0m
X-Gm-Message-State: AOJu0Yyp/F4MVu3+UeAbIMDTdjHn8m55NokMGNx90cuYCuxwsBnZLKzB
	Igqv4fuYG6i1T7a2mJcTjtggHLJkuh3A86WcizGI1YqPYvbo4mMLjqjAUexRfqY=

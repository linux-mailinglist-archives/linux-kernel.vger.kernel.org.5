Return-Path: <linux-kernel+bounces-26301-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E45B082DE46
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Jan 2024 18:14:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 97A5D283030
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Jan 2024 17:14:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AA95318056;
	Mon, 15 Jan 2024 17:14:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="K5R3vvli"
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3469018041
	for <linux-kernel@vger.kernel.org>; Mon, 15 Jan 2024 17:14:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1705338853; x=1736874853;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:content-transfer-encoding:mime-version;
  bh=yRMxCdjoqIkD75SEuJzObVSQ7nqozqsXnQwiAAoCr5k=;
  b=K5R3vvlivU+eZLYSGJgXAS2bJLVBam9IaEJGBLnggKDKBl3LLMMjB6dA
   yRF/AZexYcLifbu6C1ehq+3ONfhaXfVoEDLaUMZsVzxjYYY5oqgZJmouC
   TUZHtYBlKDjCupPfM1OlK7VPuMSAdnh/VFZGF/xFeg5OqRw5oyLVm5ttK
   w6HLqU3I5UpDHQUMVVn5hY3XyZ6cZa//WUnabLwOZ82vIgtLzKFIVOtCU
   7slqjZfbj6DcWGsnuXhf+PibqlED+KdaOakwoEv58R9DoGg+yyD4RZDH1
   tQZKNWpElWX2o4NqEyGdILEz+VrdJVC/tkfRsKufNhy6E4EjKSHqILdEV
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10954"; a="399336715"
X-IronPort-AV: E=Sophos;i="6.04,197,1695711600"; 
   d="scan'208";a="399336715"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Jan 2024 09:14:12 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.04,197,1695711600"; 
   d="scan'208";a="18189248"
Received: from orsmsx603.amr.corp.intel.com ([10.22.229.16])
  by fmviesa002.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 15 Jan 2024 09:14:11 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 15 Jan 2024 17:14:08.6374
 (UTC)

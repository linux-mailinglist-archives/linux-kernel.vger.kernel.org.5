Return-Path: <linux-kernel+bounces-29159-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 82DFD8309D2
	for <lists+linux-kernel@lfdr.de>; Wed, 17 Jan 2024 16:33:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id F421928477F
	for <lists+linux-kernel@lfdr.de>; Wed, 17 Jan 2024 15:33:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C9DC421A09;
	Wed, 17 Jan 2024 15:33:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b="TlJATVJh"
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [213.167.242.64])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B567C21A02
	for <linux-kernel@vger.kernel.org>; Wed, 17 Jan 2024 15:33:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.167.242.64
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705505585; cv=none; b=DJiPDewdGQ+nGsCyifDtBgRIAKtaV8wHqteJghaQKJ/K9hTRmMgRFSa7ZAsYwum5zv1vzO+1aNSFNX4a9+yXZp/FGTlrYGlhPdZjJ+5G6LTAQ7URArfvXlBQlQW2ZxQi+SO8gQEBQqRX1RpI6u48Cm+uoR2ciEUAe0/qNhirl3c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705505585; c=relaxed/simple;
	...
	h=Received:DKIM-Signature:Message-ID:Date:MIME-Version:User-Agent:
	 ...
	 Content-Type:Content-Transfer-Encoding; b=iEIqZjBjhcfbzlXWwyrVcsD4E2828qKQjUjzfFOvHYO3PszAZa+GEU8YPfFyUl/AVpU6BN9/k7E5CnmJoxEkTEgWhSPPFHEOnD9R/HXtTKAQLItAL71VBO4ChqIEfleHplD50npbpwGXjzZ1Rxhqp6TCb04qQnajyX20qxc3ff8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ideasonboard.com; spf=pass smtp.mailfrom=ideasonboard.com; dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b=TlJATVJh; arc=none smtp.client-ip=213.167.242.64

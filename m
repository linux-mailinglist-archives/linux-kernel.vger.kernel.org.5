Return-Path: <linux-kernel+bounces-79344-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 598BA86210B
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 01:12:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 7D54B1C21596
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 00:12:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A674E137E;
	Sat, 24 Feb 2024 00:12:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="RgviO6xw"
Received: from mail-pl1-f201.google.com (mail-pl1-f201.google.com [209.85.214.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7E580389
	for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 00:12:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708733526; cv=none; b=WuSTRdL1pS1OlVZEE/8IGI4Zop6sd0F9T7IHByl4XLjPkEpryJfnNVE+Nc4z42oUEkO+YIrcFbAp41gloYiBHGl91cG7DoAwMZ9r2J4e5cvxfMelzGpdja0UTxtyZm0hyVnauq1ovRvZbPIdLvjePiTIp7WhGzHtz/FCACAFrg0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708733526; c=relaxed/simple;
	bh=58DJLnjoiq2m43wgmF+F1x8qBHTDkkIj0MoqsjUepDc=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=D44zCKMlfMD1tgGc922xDTWNxOHXI5QrGOpmyH4zuT2HXoVFP2M1FV4xAa1veoVTGttHojYbEmbPunIAjB2yB1bkaYfLsFIO6iXHjsdss9jkekUGQP7y8BCgKJj1tkKIBV3965rwCE2SLjW3xn8BRCTC8b1fxkBo1CZ+Jgh8X/E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--jstultz.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=RgviO6xw; arc=none smtp.client-ip=209.85.214.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--jstultz.bounces.google.com
Received: by mail-pl1-f201.google.com with SMTP id d9443c01a7336-1dbe41ad98cso13522565ad.3
        for <linux-kernel@vger.kernel.org>; Fri, 23 Feb 2024 16:12:04 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1708733524; x=1709338324; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=hs1I9rbN5AcU1gAYTny4S8xetbtql9OHcOOsuaUqj6A=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1708733524; x=1709338324;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=hs1I9rbN5AcU1gAYTny4S8xetbtql9OHcOOsuaUqj6A=;
        b=
X-Gm-Message-State: AOJu0YxfAQu0yY0QzBoThEsxLH8Jrmf4r8cvtKr8KR1MNl6bgb52SKnh
	WMPR7F2uvGHSGnRtOyUrbTSE24FsQqi9eL4myQBFL1K6+Erk5xQs6i3z9deLpeeNJImwmkkkS2r
	qRLQxrpKnHEgFVZQf2O06TedMsO/d+z7awapnp758TfDQ7ZJcSW0hIgaVLGKTVneyNj8NMouCAA
	8XbrZ3ZAqCNIiiZh+O5RpPs+TphMP17U2hGzziAh8Sn2Ig
X-Google-Smtp-Source: AGHT+IHh3MQelIqkx2FcMiKSrIe0Xhd89k+GUYXiWMSMQxgBN8rzBPL6t+0gjM/RWp6T4mj+43wy+zIDnlR3
X-Received: from jstultz-noogler2.c.googlers.com ([fda3:e722:ac3:cc00:24:72f4:c0a8:600])
 (user=jstultz job=sendgmr) by 2002:a17:902:d4c3:b0:1dc:3273:7f75 with SMTP id
 o3-20020a170902d4c300b001dc32737f75mr44955plg.3.1708733523613; Fri, 23 Feb
 2024 16:12:03 -0800 (PST)
Date: Fri, 23 Feb 2024 16:11:41 -0800
...
Message-ID: <20240224001153.2584030-2-jstultz@google.com>
Subject: [RESEND][PATCH v8 1/7] locking/mutex: Remove wakeups from under mutex::wait_lock

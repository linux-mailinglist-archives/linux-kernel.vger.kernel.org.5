Return-Path: <linux-kernel+bounces-168162-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 71EA08BB481
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 22:09:11 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 956801C23393
	for <lists+linux-kernel@lfdr.de>; Fri,  3 May 2024 20:09:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C21CC158D76;
	Fri,  3 May 2024 20:09:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="aa5Jgs0c"
Received: from mail-qt1-f173.google.com (mail-qt1-f173.google.com [209.85.160.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4346C158861
	for <linux-kernel@vger.kernel.org>; Fri,  3 May 2024 20:09:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714766943; cv=none; b=fmN3Qw9sAvzN03PzfPifeGaOo7ROCCnuyLRC9UkoDtGAuh6ryqUW3oQS2pStN2iiT2ieHtIoghdNHiqFyINNHlA2hwcbeSn276kyhOa+a+YFdbn9FMmG73lLUJadrVcir9Lxd5JNXrUzX3Z0A+ci9uFaNktZZoOI4q8AR8fpL/U=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714766943; c=relaxed/simple;
	bh=0DK6wlPILIMZ+kiYLtmf+kbdNex3Nn8rNdaee8jatuk=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=FpJxA9D5wL6w7WdeD29ndWXYPEtY/lqE7Jv5shioM+cLPxbIXp5QpreoShxtSykEoq38yurvLxMnDC0iTIbdp/PD7ySvRBVH4KpjRGGxP91tesjV2EnZ+CnJrlLQfxQ8EAkNBn2THWqt7ooQLO2xlKJSfNY96pRAWvcGSPju6nk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com; spf=fail smtp.mailfrom=broadcom.com; dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b=aa5Jgs0c; arc=none smtp.client-ip=209.85.160.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-qt1-f173.google.com with SMTP id d75a77b69052e-43a14bce92dso213601cf.0
        for <linux-kernel@vger.kernel.org>; Fri, 03 May 2024 13:09:00 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1714766940; x=1715371740; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=X9HlYniNjVIJem7FfoP5M6LVvSy4KxUHqkwch5SQcDg=;
        b=aa5Jgs0cXObBV1yDy081CZGJEEyUG+PZujemPozjI1gJMAD96i1FDm6gZuwqUAshp+
         8QDP+AmczaMbSOAfcwXXj3h5sVo5eSmVrcqZDA88OLWx4HLtNgWVZoN3GFQCyJpgvGgZ
         PTlDgtUskgs3fuZ2qX5EMFCrPxHgWj242xjdg=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=X9HlYniNjVIJem7FfoP5M6LVvSy4KxUHqkwch5SQcDg=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWoPPW4ijwUOV2TE/ZktNbW8Hf1VyWYiISXorB8PsGoefKAN7lwODnz9sAwe7Wu3tSKa9TfAYoU1JaldtSqKE2vS1rrheWDY4M98GCM
X-Gm-Message-State: AOJu0YwwJ4SzE32kRn0pfP8fUyNuW1BowzI15ApAOslT9rl7gnYwZu8o
	ZhO2Rq+6zwmKdMtRUK/oJGDzMrAadE5OdfOEFjpyQQHxllC7ny59+H1y9BXo6g==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
	boundary="0000000000005b75bd0617924a77"

--0000000000005b75bd0617924a77

Return-Path: <linux-kernel+bounces-145339-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id EB9AD8A52FE
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 16:23:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 63CB41F21EC8
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Apr 2024 14:23:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6F0FC745C9;
	Mon, 15 Apr 2024 14:23:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="FenpOy4/"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 95A5C71B51
	for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 14:23:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713191021; cv=none; b=qcqMIHliEZUrhF8jo2cZe9zBnXzCg2Zxvg0fsEmiEubMrM83rYmuKaeaxfzBgYHQ/f0ofgGEYFWznPCM23/87M0ziaPLzQ0PdPwlWXvTpUoWfuSH4mQOkYv2g6E12AVZH1PSY24dU9zCk6CVLzFcqF3H9+Vf5qM31qZ4HYIIE0c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713191021; c=relaxed/simple;
	bh=USgx0DGgiso3REwchl5jBmBmUCNMcOa4HGZmhbhlIsw=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=AkAVIBcFYUJ0egvLtHo6uL4zXPfEK9zRNeFQCHlAeFIVHQExtDr1tYOtScBMNIh3YyF78wsjvxNo0Uzr1rPlE5diyOqPAvYfBdyNFrf9D1weKm2qb+slBw70C7cgma+KF+DgPWLawju6pW0ochcSyVKMgT19QVR3szqjfXSsh9I=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=FenpOy4/; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1713191018;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=5p4X8TlB75TnvO3RibSOsXw/5X59O6YcoiMO9nBnYR4=;
	b=FenpOy4/GSR00MSZSkhZDxHteNlxzkgX39/Mr0q+ZAoEs+F2z+YJWAZlI6rgcyZFfG95W0
	VusMYuYixilpiHpw3N7kiPjDrdHoyjrZDhlOmfDTj99pPc0TCI2KSsgA/f7oSgh2/Gx7Yh
	o1alv0xOaWvBYmLdYEn8gt0coses6bk=
Received: from mail-wr1-f71.google.com (mail-wr1-f71.google.com
 [209.85.221.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-416--LOXeUMsO8uoTzH-mRWD0g-1; Mon, 15 Apr 2024 10:23:36 -0400
X-MC-Unique: -LOXeUMsO8uoTzH-mRWD0g-1
Received: by mail-wr1-f71.google.com with SMTP id ffacd0b85a97d-34619c30076so2439261f8f.1
        for <linux-kernel@vger.kernel.org>; Mon, 15 Apr 2024 07:23:36 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1713191015; x=1713795815;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt
         :content-language:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:x-gm-message-state:from:to:cc:subject
         :date:message-id:reply-to;
        bh=5p4X8TlB75TnvO3RibSOsXw/5X59O6YcoiMO9nBnYR4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXzZ48bBgtQ+CWp6XacWv7j9ZxFn+zEU0WyLOslXwmlvMcCaXltjvu8FY5dKp/1EY0TZ7ILGnlJmXvZXJ+O1qAB03XSRmTf3Zeg2gcu
X-Gm-Message-State: AOJu0Yy+e1vqhEALu07yc4vN5Edv15VjxOS467+qsz5lzgfRlZ/bsctU
	Q4CjZIUf34QZdM+WxTX53L6/n+mYs9zW2fLssy7dfWM9lMkvW8jp0mJYHmKU0qGEkW+raBtbQMw
	LoTtkBXPvouE2Q/wnqw8JGGFVBe+7FG4bpj/j/mu1a3+ZI/B9J4W/8FlJkoKfJA==
X-Received: by 2002:a5d:6483:0:b0:347:9c4d:4e19 with SMTP id o3-20020a5d6483000000b003479c4d4e19mr3340523wri.70.1713191015600;
        Mon, 15 Apr 2024 07:23:35 -0700 (PDT)
X-Google-Smtp-Source: AGHT+IGdv3y/PhdD5Yg3ns0co0IgAUnnpXpzLbcZel9offBkrwayKEuZnoms+jFmCq+3MxHnsmSDIg==
X-Received: by 2002:a5d:6483:0:b0:347:9c4d:4e19 with SMTP id o3-20020a5d6483000000b003479c4d4e19mr3340496wri.70.1713191015134;
        Mon, 15 Apr 2024 07:23:35 -0700 (PDT)
Received: from ?IPV6:2003:cb:c706:d800:568a:6ea7:5272:797c? (p200300cbc706d800568a6ea75272797c.dip0.t-ipconnect.de. [2003:cb:c706:d800:568a:6ea7:5272:797c])
        by smtp.gmail.com with ESMTPSA id s11-20020a5d69cb000000b00346bf37c97bsm11826429wrw.63.2024.04.15.07.23.34
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Mon, 15 Apr 2024 07:23:34 -0700 (PDT)
Message-ID: <969dc6c3-2764-4a35-9fa6-7596832fb2a3@redhat.com>
Date: Mon, 15 Apr 2024 16:23:33 +0200
Precedence: bulk
...
In-Reply-To: <772de69a-27fa-4d39-a75d-54600d767ad1@arm.com>

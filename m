Return-Path: <linux-kernel+bounces-98980-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 92AD98781D6
	for <lists+linux-kernel@lfdr.de>; Mon, 11 Mar 2024 15:41:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 092C3B22C1F
	for <lists+linux-kernel@lfdr.de>; Mon, 11 Mar 2024 14:41:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 894CD40870;
	Mon, 11 Mar 2024 14:41:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Udbj26mp"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6D8C33FBAD
	for <linux-kernel@vger.kernel.org>; Mon, 11 Mar 2024 14:41:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710168069; cv=none; b=J+8QV26rm6OC3mJhy25NKn5wSDHhJ9sDIG0ZbvC9Zdp8T4lw5sejJw0GAD1wLB5vRHi9cEPbLy77ABCtDAMOi4XNDopiZ+p4mH+mIuZrA5qHxyD9DxT6GpIHmw+gTu6WUFwV8Uux3twdwQ2Lu1eDRbLi/UQFE6Brk5Rf4BFXENg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710168069; c=relaxed/simple;
	bh=yucr9s/lBBGdWtlJzYXkiwRLHLQBsa6ElDX2Jb0ofJs=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=P9dW7vGO4A7eDj+EEbQybUZ1ULii+egsw2mUQWJW/CfHUwbnsr7DXCS3MANrVb00Mc3F4NMYaytiFn2UjGRKQqBWDUMfn/YCQQGQIpAbfGtWoyIJsRwHrb6x5mM3A/B5qziBDA1h8D3pM+cCwztpDaBFWN8EatRse31WwEvCBvY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Udbj26mp; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1710168066;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=1Ln6DMStTH/dqt1H0TtHk7/u1gLfSe+VO2DEgx5urmQ=;
	b=Udbj26mpOt8rXUJzRfXjbiaz1wM26TjJP3+9kQC1D4UGBjhF/BiRZq66ejZDnV8MY0RYzb
	tObHARLDrQKpnWM8Q+krJKp0WxiL2J0rroDnAxJ7ThIF+4Q2zwHLTjIfoVizrKT8IxPPQT
	rYi5bQQ8VejkuDkDGb56wfoKcCx52kg=
Received: from mail-ej1-f71.google.com (mail-ej1-f71.google.com
 [209.85.218.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-630-aQd2lRzbP6K2hqPjnfNaDQ-1; Mon, 11 Mar 2024 10:41:03 -0400
X-MC-Unique: aQd2lRzbP6K2hqPjnfNaDQ-1
Received: by mail-ej1-f71.google.com with SMTP id a640c23a62f3a-a46309731b9so39390166b.1
        for <linux-kernel@vger.kernel.org>; Mon, 11 Mar 2024 07:41:03 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1Ln6DMStTH/dqt1H0TtHk7/u1gLfSe+VO2DEgx5urmQ=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWTqFx5f7Z9wDNXDOTYqxkWdX9cd0tPz7RfzGTlcnkAV9YTgu3L2I7nifYFlfdWoiUrcLeOlX6M5o+CnL5ahRc19GUKc/5aTxJi0+aN
X-Gm-Message-State: AOJu0YwMP1Fk8i16u05eTdrmiNSYBbpiwy6SUv0BtatcP/UpxtTH6vBr
	iT7s4KbFXph+9cVzeTQ/M/sRLkGD4x51uKwBDVgZz5XUNbgyol/Ky9jPfDHddPbalou2IDdbSAh
	ZyxoXSInnMZdcenr6DYDSBsEwLoWtTxtzo52Vt68i2LIKxjrDRWz7x8ec7rdn1w==
X-Received: by 2002:a17:907:a08f:b0:a46:130a:468 with SMTP id hu15-20020a170907a08f00b00a46130a0468mr5144859ejc.13.1710168062195;

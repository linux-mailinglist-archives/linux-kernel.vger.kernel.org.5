...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3893978586E
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Aug 2023 14:59:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235383AbjHWM7k (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 23 Aug 2023 08:59:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60434 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235359AbjHWM7h (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 23 Aug 2023 08:59:37 -0400
Received: from forwardcorp1b.mail.yandex.net (forwardcorp1b.mail.yandex.net [178.154.239.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 05F99E6A
...
Received: from mail-nwsmtp-smtp-corp-canary-81.sas.yp-c.yandex.net (mail-nwsmtp-smtp-corp-canary-81.sas.yp-c.yandex.net [IPv6:2a02:6b8:c08:ac00:0:640:e1b9:0])
        by forwardcorp1b.mail.yandex.net (Yandex) with ESMTP id D6DA462830;
        Wed, 23 Aug 2023 15:58:44 +0300 (MSK)
Received: from valesini-ubuntu.yandex-team.ru (unknown [2a02:6b8:b081:b70f::1:a])
        by mail-nwsmtp-smtp-corp-canary-81.sas.yp-c.yandex.net (smtpcorp/Yandex) with ESMTPSA id YwJHT20OemI0-reosNYHO;
        Wed, 23 Aug 2023 15:58:44 +0300
X-Yandex-Fwd: 1
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=yandex-team.ru; s=default;
        t=1692795524; bh=9ztoCmW5jfnEwJZ3e0u4VZYZ5UUE1/TVR5cHjNsf+lg=;
        h=Message-Id:Date:In-Reply-To:Cc:Subject:References:To:From;
        b=XsE/j5GqpOfH8lTNy38KjU2H7kLJft0mAFaXR10mG5v5YvSQ8+9L2F3opQYYwvHqJ
         sar0Ek5wQ4mKtHUR1AwwU8pQeBpa2yGpA21/RHMo5M5rRwMyoRW+QEoHCsoTGo33BW
         ceYYL0LKLxXhf3w05lGcNKUV7FkQehpX4lPR0NbE=
...
Subject: [PATCH v5 2/2] PCI: Implement custom llseek for sysfs resource entries
Date:   Wed, 23 Aug 2023 17:58:34 +0500
Message-Id: <20230823125834.492298-2-valesini@yandex-team.ru>

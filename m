Return-Path: <linux-kernel+bounces-79651-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A9A19862538
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 14:47:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id CCCC11C20F12
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 13:47:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6CBBB46450;
	Sat, 24 Feb 2024 13:47:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="PRi3Bq1B"
Received: from out-176.mta1.migadu.com (out-176.mta1.migadu.com [95.215.58.176])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E1BFF45030
	for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 13:47:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708782439; cv=none; b=uAJzSOJlkMBvPA0BrNiqgt9m1sSEpjzAC9dxC31J1X49DCSPLsATnm0XcJtswl6N6vSQzgaiPWx9HfxtSLIPtxNFUaVPIFI3UKI8eT6n1r5mWsd2nO1xOlEgmPOTj8pawZ3wZ1uT8ZnsXWzni1V2tqsvBXT07h3p3V7YbfZS/MM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708782439; c=relaxed/simple;
	bh=dfkuXdM1TfGRdOTvfYcpzHaUouxLyzj75vujnsQGm8I=;
	h=From:To:Cc:Subject:Date:Message-Id:MIME-Version; b=O1/68TkTUmT60IR8MLfcAEmSjUQBAVWnP4zJSB6elkOmc41DRzkeG8/K9mwOGuaFzO+iSyB8ofHARvRaha4VQhqw6V+3S4yrXkSASn6udYPU9gWj7+hwA4Qa6p1Zp+iIk2yeZwJc42TI/QSDciFEQ4G4ChAJ6+qoPTZla7+k9lY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=PRi3Bq1B; arc=none smtp.client-ip=95.215.58.176

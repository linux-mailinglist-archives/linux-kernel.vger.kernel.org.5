Return-Path: <linux-kernel+bounces-79530-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id BD4B58623B0
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 10:08:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D37F91C222C0
	for <lists+linux-kernel@lfdr.de>; Sat, 24 Feb 2024 09:08:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D790A18E28;
	Sat, 24 Feb 2024 09:05:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=arista.com header.i=@arista.com header.b="YVaBz+RL"
Received: from mail-wm1-f53.google.com (mail-wm1-f53.google.com [209.85.128.53])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B6E9343AC6
	for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 09:05:00 +0000 (UTC)
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=arista.com; spf=pass smtp.mailfrom=arista.com; dkim=pass (2048-bit key) header.d=arista.com header.i=@arista.com header.b=YVaBz+RL; arc=none smtp.client-ip=209.85.128.53
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=arista.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arista.com
Received: by mail-wm1-f53.google.com with SMTP id 5b1f17b1804b1-4129b4cef3aso1267265e9.1
        for <linux-kernel@vger.kernel.org>; Sat, 24 Feb 2024 01:05:00 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=IcJhh022VDfxpiDKm7FqqnzrMHW/udPkKTDf9bA9ocg=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVcilxawyVhaSGMkGlYi2pNF2g9p5Toh8PUwEn9xTc8xthL7LXMl6qhP8oBCfaYgZFwUIhhIA/HY95pDpqPTTItav+q+o7Lbu7HXapA
X-Gm-Message-State: AOJu0YxAaYh6/08KxtVpedADPwjgdEsE3SBHJcYBNz8YGWskqJHNldb9
	mUg5XW7pQIwHYshrAbJrp4jNsmB0N9XTUMSdNhY8bGnEgP19dgOdtOdGfGMvOQ==

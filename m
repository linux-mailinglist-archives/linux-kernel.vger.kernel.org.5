...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F3E627F97DC
	for <lists+linux-kernel@lfdr.de>; Mon, 27 Nov 2023 04:13:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231290AbjK0DNU (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 26 Nov 2023 22:13:20 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59252 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229379AbjK0DNS (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 26 Nov 2023 22:13:18 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A98B48F
        for <linux-kernel@vger.kernel.org>; Sun, 26 Nov 2023 19:13:23 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1701054803; x=1732590803;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=OemHky7XCOtLYE+9P6I0e0iUH/284TWGi4dgQPzqISI=;
  b=eVAPjeirb5KqvoPzlvByz7AJYdo/az2Q9s7lvwITklRjMNjbF4YLHIqs
   wMJxKSwHMKQEURROEy3V5mRfthWtJG/VrauMdeG5PDk60Mn2YQx2mwq+N
   DPev7B9Ro2/5tqVLoGGbGL1X8SDOc1vJ0LXu7ljtLnjsYX545MjMGMNNV
   Z3QQM/ck1inNFc9keUq5emfJ/aDeuYIEytLZ7tHPwMKE44hM0kr2nsuWY
   PaMUduzhSZdK3A319m96RcVLjhyNjTf4TCt8M8YGmll8+wDm6DrZGEuS7
   pW6atTPaIvt9zgndN4w0Hxa9ebtW92L9aC/FzY7xzuBA31H9yBG1Z7i1G
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10906"; a="371981194"
X-IronPort-AV: E=Sophos;i="6.04,229,1695711600"; 
   d="scan'208";a="371981194"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Nov 2023 19:13:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10906"; a="834196193"
X-IronPort-AV: E=Sophos;i="6.04,229,1695711600"; 
   d="scan'208";a="834196193"
Received: from lkp-server01.sh.intel.com (HELO d584ee6ebdcc) ([10.239.97.150])
  by fmsmga008.fm.intel.com with ESMTP; 26 Nov 2023 19:13:21 -0800
Received: from kbuild by d584ee6ebdcc with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1r7S3j-0005mc-1S;
        Mon, 27 Nov 2023 03:13:19 +0000
Date:   Mon, 27 Nov 2023 11:12:45 +0800
...
Message-ID: <202311271055.xSmddI7Q-lkp@intel.com>
MIME-Version: 1.0
...
date:   8 months ago
config: powerpc-randconfig-r131-20231127 (https://download.01.org/0day-ci/archive/20231127/202311271055.xSmddI7Q-lkp@intel.com/config)
compiler: clang version 17.0.0 (https://github.com/llvm/llvm-project.git 4a5ac14ee968ff0ad5d2cc1ffa0299048db4c88a)
reproduce: (https://download.01.org/0day-ci/archive/20231127/202311271055.xSmddI7Q-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202311271055.xSmddI7Q-lkp@intel.com/

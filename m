Return-Path: <linux-kernel+bounces-76497-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id B069985F7EB
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 13:19:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 0BCECB22AFE
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 12:19:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6E221612C2;
	Thu, 22 Feb 2024 12:19:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="StLUxsYE"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 772AD60DDB
	for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 12:19:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708604341; cv=none; b=C1/19mRgKZizrtVNEn/W2C5NytIvjD1SwE+d2ZC+NjlWR+aodE4OY7XcNlFwL45ySwTeubp6fiDIR8SYuDlP+nqiD4M1oimFM+tVQAQnC+q1CJxhwOSRP0aaIAeDLfi9BMKZejbeUcgOeIT0bJJKYG15arSxT9kDNPPLHlYNS40=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708604341; c=relaxed/simple;
	bh=JScqMUmhnumYR16/rHyzcKV1L1sOSHfgCbEcWtK9OnY=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=gsTVTfu8T6RGJ2Z9vCMs9Vhw/QgrDbXwhkcLVyCYpYy/UMsWZ3s4xXXxZHYN7JwK6T0vuu/hciqQqRJekeBqouTfDn07eOD6JqORa+SMPKPSC//Ao2gkezIvcVPkepSIPHAZSxQYGNO9eTjkVOcmTzMd8v9anJ+MKL0NxPbS9i0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=StLUxsYE; arc=none smtp.client-ip=10.30.226.201
...
Subject: [PATCH 3/4] f2fs: fix to handle segment allocation failure correctly

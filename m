Return-Path: <linux-kernel+bounces-94050-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 06468873919
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 15:29:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 29A4C1C20D9A
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 14:29:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6AB24132482;
	Wed,  6 Mar 2024 14:29:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="Ey11sAZF"
Received: from mail-pl1-f169.google.com (mail-pl1-f169.google.com [209.85.214.169])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AA5AB60895
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 14:29:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.169
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709735356; cv=none; b=IZNZTNKmY/HiOMpWFoNi2U1qd3/z+eJzBj+bKLwIlgz5rIerYuVVgzQEkg+pEBNzJywttM0OLgntHY1vkyDzXU9jGIIAPxZZhmzHl7MO+fG0IF6uKG/7FXLrn8Et2H1Be1Jj7S56sxTFCMUldO+XMFTM8N0V3Lu2i8rATQiYCg8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709735356; c=relaxed/simple;
	bh=uT00NDo0KQRsb1RnzKl3ySB/G+TfUQ9BWj1UTNYj4t8=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=MkA1GCpMku3bWVFWIdDcHw0YrEB727eG5ggAVOTacFjNRn3YwTMiwutaZlHdUvxGbs+g9qllDPWYY/9sWNJ2wgR32T9PpD2yfVPdJS2V9h4/ZS6qvKltG6Fn0f+++fNzQ8J4lkWQVE/5Avwnex4Vr8f/TZjnmz29PJUCOBdmka4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=Ey11sAZF; arc=none smtp.client-ip=209.85.214.169
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pl1-f169.google.com with SMTP id d9443c01a7336-1dc29f1956cso54212715ad.0
        for <linux-kernel@vger.kernel.org>; Wed, 06 Mar 2024 06:29:14 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1709735354; x=1710340154; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=6BJPk+nF2s8SJbHx5A0qKo3fTEzhCr5XKFS56tvgZrw=;
        b=
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=6BJPk+nF2s8SJbHx5A0qKo3fTEzhCr5XKFS56tvgZrw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUQkzCSkCAofTzgLfQ1QWM2Y1+LVJGbtaICokeGInays154NGPZw3PxyE+355gUVW5n/d2Rw7VFvmN6TEBPFg8AYN7GlN9hQp9DJZbk
X-Gm-Message-State: AOJu0YxA6+kotW8M5VCDA4vdW3lIpSP24uWo0pFcKu+YBvwaGOz20Skq
	Ya8uhLoxU8PfyXChp30zFTA0DFsub4kGDz/kyp/8wqone/Dvknf9LA4vGtk9iner2d98vVLPr//
	yWtDgkJThkM+KXCIGFuMhmuIX2ik=

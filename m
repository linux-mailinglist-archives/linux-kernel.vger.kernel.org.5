Return-Path: <linux-kernel+bounces-73942-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C99F85CDD7
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 03:18:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 27BB11F24BD1
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 02:18:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C692DF9E5;
	Wed, 21 Feb 2024 02:18:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="JyBhsuTC"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CD50F79FD
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 02:18:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708481898; cv=none; b=ajcjBygyD6fcw00k/qdV4SwQGdVtT+kO+Z39s+2jtFDBYy+D+ugb3g/iNDLmQuSGew/F8jW1AuouAwrXEA1mykmZN8Y80mhXSk/UvTDyyGn/axXmOkmJEVk+7c7Ev/o+4Z8gBt9G525MqOQ9VRZNQCksOFUcRX9o0IBWSkrGHvk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708481898; c=relaxed/simple;
	bh=1D9dtTOcqZTXQYey7nziqcMCVlOXbQ4clzR2SqIHDZQ=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=m1om9tmeK2bFScpdppP/IXNch+NWwNaQzij+v/OgNNpbRy0D44sMJWiOogIewwoHb0mF4Obx5QyBoD8nyyqy/nHMt5dUkmMjr8Bcn46LQ/6tXAT6VBW8DYCzfe3uxfuX96EeqNrw7iQLnya3nXREh4ATPZuGz/PeGGyxM+fIcyw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=JyBhsuTC; arc=none smtp.client-ip=10.30.226.201

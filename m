...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E1857807DD6
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Dec 2023 02:23:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1443039AbjLGBW4 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Dec 2023 20:22:56 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56708 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1443036AbjLGBW2 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Dec 2023 20:22:28 -0500
Received: from mail-yb1-xb4a.google.com (mail-yb1-xb4a.google.com [IPv6:2607:f8b0:4864:20::b4a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 38649210C
        for <linux-kernel@vger.kernel.org>; Wed,  6 Dec 2023 17:18:23 -0800 (PST)
Received: by mail-yb1-xb4a.google.com with SMTP id 3f1490d57ef6-db547281f5dso519423276.2
        for <linux-kernel@vger.kernel.org>; Wed, 06 Dec 2023 17:18:23 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1701911901; x=1702516701; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=xNHzIEuRc1o0L2ulzPpJbBt+Q1yOfxc+5YTltwLQprc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1701911901; x=1702516701;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=xNHzIEuRc1o0L2ulzPpJbBt+Q1yOfxc+5YTltwLQprc=;
        b=
X-Gm-Message-State: AOJu0YxPdfR5dHls5DF+gW3DtU3kBHXw5Gmzb7xe1WsDZCKg8riIXsXk
        fMaCwbMD8zhqaGrk51VqQLmgtJRzMahV
X-Google-Smtp-Source: AGHT+IHBunNZfewDZCjF8+Bu1Rtrcx1O/XoPnCi5PN4THAyeyjjwEmPyRVtOjggEy2EKWPJnJoLdAuzPNvy8
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:35bf:293e:7696:34e9])
 (user=irogers job=sendgmr) by 2002:a25:d212:0:b0:db7:e75c:38db with SMTP id
 j18-20020a25d212000000b00db7e75c38dbmr22456ybg.11.1701911900825; Wed, 06 Dec
 2023 17:18:20 -0800 (PST)
Date:   Wed,  6 Dec 2023 17:16:57 -0800
In-Reply-To: <20231207011722.1220634-1-irogers@google.com>
Message-Id: <20231207011722.1220634-24-irogers@google.com>
Mime-Version: 1.0
References: <20231207011722.1220634-1-irogers@google.com>
X-Mailer: git-send-email 2.43.0.rc2.451.g8631bc7472-goog
Subject: [PATCH v6 23/47] perf maps: Switch from rbtree to lazily sorted array
 for addresses

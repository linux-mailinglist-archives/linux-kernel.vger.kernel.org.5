Return-Path: <linux-kernel+bounces-119896-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FE5D88CE9A
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 21:28:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B7A46B2784C
	for <lists+linux-kernel@lfdr.de>; Tue, 26 Mar 2024 20:28:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AAECA13FD69;
...
Received: from mail-ej1-f53.google.com (mail-ej1-f53.google.com [209.85.218.53])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 34C7813F007
	for <linux-kernel@vger.kernel.org>; Tue, 26 Mar 2024 20:24:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.53
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711484666; cv=none; b=odqee4P38K/EdNOoy27OpM4L7mDYMfrUql5xAqBtAgHeJt75yksgSxamf9L6muriIL/M5T5pUewL1wVfxQavqsRtEhDuhfUCM1GrQO3uiJuX0i1t0OZUMStCYyPA8zSwEOv3G5TitE1FemCuV0fwXYatXJEyFtTRrPrGW2cnoSg=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=tMeEAvDE; arc=none smtp.client-ip=209.85.218.53
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-ej1-f53.google.com with SMTP id a640c23a62f3a-a46d0a8399aso30657666b.1
        for <linux-kernel@vger.kernel.org>; Tue, 26 Mar 2024 13:24:23 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=/Iv0AZfW3wpSqdU6En0pi+/4bLDyGY5/1naPQo6iA0g=;
        b=
X-Gm-Message-State: AOJu0YxSLCnMb4nrvMErUwq+AX1YiFJ5wLqPAPzOuDbTSokLo+ZjfCcW
	3iI8VkVPVk1KHvkTXuYBEOWidnJK4jxC3rVN2rCI78rznCo7XVJrEEH03JDVn70=

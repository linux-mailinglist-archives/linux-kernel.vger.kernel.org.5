...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1085379E6DA
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Sep 2023 13:33:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240298AbjIMLdS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Sep 2023 07:33:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36082 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240307AbjIMLdN (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Sep 2023 07:33:13 -0400
Received: from smtp79.iad3a.emailsrvr.com (smtp79.iad3a.emailsrvr.com [173.203.187.79])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F164019AF
        for <linux-kernel@vger.kernel.org>; Wed, 13 Sep 2023 04:33:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mev.co.uk;
        s=20221208-6x11dpa4; t=1694604789;
        bh=nqQvoe7SqSrpCEoqrow/X3Txdt2uLA568cRnHOMEY38=;
        h=From:To:Subject:Date:From;
        b=gdoHrepPw0/6pZCBA9R76heceq7J3b9KOApUtek16/q6kVV6Is6229hjIdqGkPIkW
         rEK9lZZ34xjQLCPVMTAmCh9ys899A3e7xHOYdP7IOUcBhzBPlxt0xvcCOa6Tqten+u
         uDpRzW/9D44W6v1ex066M/KPyxJKZl9A3lwh/xxw=
X-Auth-ID: abbotti@mev.co.uk
Received: by smtp26.relay.iad3a.emailsrvr.com (Authenticated sender: abbotti-AT-mev.co.uk) with ESMTPSA id 41FDE3FAE;
        Wed, 13 Sep 2023 07:33:08 -0400 (EDT)
...
Date:   Wed, 13 Sep 2023 12:32:36 +0100
Message-Id: <20230913113247.91749-3-abbotti@mev.co.uk>
X-Mailer: git-send-email 2.40.1
In-Reply-To: <20230913113247.91749-1-abbotti@mev.co.uk>
References: <20230913113247.91749-1-abbotti@mev.co.uk>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Classification-ID: 007ec4bd-2574-475a-9bbd-5a4f93b29aec-3-1
Precedence: bulk

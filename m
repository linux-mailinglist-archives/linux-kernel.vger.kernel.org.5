Return-Path: <linux-kernel+bounces-52147-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 3726C849498
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 08:35:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id DEA7F1F21913
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 07:35:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B2051125AB;
	Mon,  5 Feb 2024 07:35:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b="WSJRT/3S"
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [213.167.242.64])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 94116125A5
	for <linux-kernel@vger.kernel.org>; Mon,  5 Feb 2024 07:35:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.167.242.64
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707118524; cv=none; b=Or1P0Gvoda/FJFCP4QEeQWmuyf1XxHU9PN89IkvpcbyGq7UEc2YYEhGjDjwR4BDbjqauRrPvqLgggF6/V19sUiIBn6oYcz8TN6nF6yz0qZEWsI3WAjxEfURQXI2LQFBYlXsNs4GMRljPoM8+5zqxYXUbsYXuMCVjKPEdbXpfh7U=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707118524; c=relaxed/simple;
	bh=TPAhRfZNvGXB/DBnRhVN6DN8EMYWbqn2NG2XnBRmiZQ=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=aIgGzIODF3LSra8bJnFelW4pJgqH/P2wPU6yxSjBAeVERjBZu9w6qpFi/qt5I0D5cYI11fIVOLtON1cuFzZfe9qkyoOyK8zYBSZS/P1HU7uH0va/EBWEBTqqqynirIoQgXzXHxydu8pNqLQBA6k/39le2nMQVq7QDbk1cunOk1U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=ideasonboard.com; spf=pass smtp.mailfrom=ideasonboard.com; dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b=WSJRT/3S; arc=none smtp.client-ip=213.167.242.64

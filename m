...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5537E7DF960
	for <lists+linux-kernel@lfdr.de>; Thu,  2 Nov 2023 19:00:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1343712AbjKBR7t (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 2 Nov 2023 13:59:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60958 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377227AbjKBR7B (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 2 Nov 2023 13:59:01 -0400
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 86FF918B
        for <linux-kernel@vger.kernel.org>; Thu,  2 Nov 2023 10:58:38 -0700 (PDT)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-5a7cf717bacso17907437b3.1
        for <linux-kernel@vger.kernel.org>; Thu, 02 Nov 2023 10:58:38 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698947917; x=1699552717; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=+SB4q0qmZqGBp+gxWyM67EuwdlNHOmzZ0kr2u6dsUH0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698947917; x=1699552717;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=+SB4q0qmZqGBp+gxWyM67EuwdlNHOmzZ0kr2u6dsUH0=;
        b=
X-Gm-Message-State: AOJu0YwM6sMgppW19rTrQOFDL1eZWfo9n4czG7+ogIkzCZFztuspBjwD
        KwdYTtRbdlRA/A/M3A7w8B1mCgjGEwhr
X-Google-Smtp-Source: AGHT+IFow8pXzMvPMnXcj76eqvdACdTi/CNDQ1w4AhsMyVOMHFe7YYinjOHRhTchNKv+6OIZTSlATGLsCait
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:bb34:df9c:836c:afca])
 (user=irogers job=sendgmr) by 2002:a81:914a:0:b0:59f:77f6:6d12 with SMTP id
 i71-20020a81914a000000b0059f77f66d12mr9783ywg.0.1698947917600; Thu, 02 Nov
 2023 10:58:37 -0700 (PDT)
Date:   Thu,  2 Nov 2023 10:57:00 -0700
In-Reply-To: <20231102175735.2272696-1-irogers@google.com>
Message-Id: <20231102175735.2272696-19-irogers@google.com>
Mime-Version: 1.0
References: <20231102175735.2272696-1-irogers@google.com>
X-Mailer: git-send-email 2.42.0.869.gea05f2083d-goog
Subject: [PATCH v4 18/53] perf maps: Add maps__for_each_map to call a function
 on each entry

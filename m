Return-Path: <linux-kernel+bounces-108502-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E8D54880B63
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Mar 2024 07:41:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 60D9A1F230CC
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Mar 2024 06:41:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 213261E888;
	Wed, 20 Mar 2024 06:41:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b="EUttLcZF"
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E3DEE1EEF8
	for <linux-kernel@vger.kernel.org>; Wed, 20 Mar 2024 06:41:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.61.82.184
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710916865; cv=none; b=oMd4IKfFwzOPqx3jbytVtrdf3JjOn2OBc3N6gkdiQGnXMs9QSL9NKnU8uu2glVb9Li4FQlCbqk1llC3HHfAe9s8Zj09a3BLl3k6VE+cZ6vzeg96P1VDr/wEgay9wqRYBKtiJZpSfqnMHeaaExIpFS+6ZE5hNkeNns4iYoIXLvJg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710916865; c=relaxed/simple;
	bh=GllnkSNsflyAUhmHHEucsOEYEgUZeV5TLlP4+rlOxxE=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=RUOvHPpZslftcrFHFmHrtpX4DQ2oxngHWfd9zpvRrSdEgt7Ri+6iKX/4RxgDxalbi6Qnj44OZ4u6SIuoBrfJKdurUOPLCAVBHroP30T2OVkXled033dUqo2USvDWxV0gNVjf6LqAZcRWmMPUhmqvEnXK2LugatVuV1O3m2E6Dyw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com; spf=pass smtp.mailfrom=mediatek.com; dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b=EUttLcZF; arc=none smtp.client-ip=210.61.82.184
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mediatek.com
X-UUID: cdebafcce68411ee935d6952f98a51a9-20240320
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
	h=Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=zpWr3zRO3fclG03mBQt29jpLjsOvtGYpcOWaVg4uoAg=;
...
X-CID-O-INFO: VERSION:1.1.37,REQID:d518588b-a28d-42b5-8f49-6706a1b88ff6,IP:0,U
	RL:0,TC:0,Content:-5,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTION
	:release,TS:-5
X-CID-META: VersionHash:6f543d0,CLOUDID:a9dc1a00-c26b-4159-a099-3b9d0558e447,B
...
Subject: [PATCH 1/1] drm/mediatek: Add interface to allocate MediaTek GEM buffer.

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2B91A80A3DF
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Dec 2023 13:50:54 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1573784AbjLHMuh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Dec 2023 07:50:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34378 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1573766AbjLHMua (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Dec 2023 07:50:30 -0500
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 280011710
        for <linux-kernel@vger.kernel.org>; Fri,  8 Dec 2023 04:50:35 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702039835; x=1733575835;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=Bi+ZnzODHrRrVcV4yFd3OTPCDGr/A0SF2WED1UgJ4ME=;
  b=MvNPJDHa9mwmYT2P8ZhLvhKGFBlujGkckhQpaHCBxvQwc6UaGwOagRkJ
   zOCcavBIFlxIKdoIjsC0kjMm/rB57hgkft/eWBMl9romEudnYm9b/S8aQ
   aXEoZ7DMI6GZrznXcdSWgSbGMkJtLyqasZt+PLRhc6hgEPinJ4rgWj2wa
   khKr3ymusn0/U+Hq99n0xJAOtVHc0rQ7tFkjifnqouy9OJjZfXNW+jNFF
   94Qu+oyXIej6jdGw4VxjMI1IxbIAp4CBG7k+mLGq/KER29oR4PFT2tl63
   +oH4Nd0nHalspyGV0hN2UCmGxXfnU53kX4amD5GT3nG36PGBZGoznrGIx
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10917"; a="460877602"
X-IronPort-AV: E=Sophos;i="6.04,260,1695711600"; 
   d="scan'208";a="460877602"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Dec 2023 04:50:34 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10917"; a="801108361"
X-IronPort-AV: E=Sophos;i="6.04,260,1695711600"; 
   d="scan'208";a="801108361"
...
Date:   Fri, 8 Dec 2023 20:50:00 +0800
...
Message-ID: <202312082035.lfvrZNJp-lkp@intel.com>
MIME-Version: 1.0
...
config: powerpc-randconfig-r132-20231117 (https://download.01.org/0day-ci/archive/20231208/202312082035.lfvrZNJp-lkp@intel.com/config)
compiler: powerpc-linux-gcc (GCC) 13.2.0
reproduce: (https://download.01.org/0day-ci/archive/20231208/202312082035.lfvrZNJp-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202312082035.lfvrZNJp-lkp@intel.com/

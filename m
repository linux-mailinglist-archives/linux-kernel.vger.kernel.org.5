Return-Path: <linux-kernel+bounces-48596-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 832F2845E93
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Feb 2024 18:33:02 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A78481C27E24
	for <lists+linux-kernel@lfdr.de>; Thu,  1 Feb 2024 17:33:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 52BF784058;
	Thu,  1 Feb 2024 17:32:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="GKaN44fN"
Received: from relay5-d.mail.gandi.net (relay5-d.mail.gandi.net [217.70.183.197])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8401F84027
	for <linux-kernel@vger.kernel.org>; Thu,  1 Feb 2024 17:32:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.197
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706808743; cv=none; b=lr7MdsXgs1fhyp8Askak3iRU/mwYCDAPQPOpDfv8/5warS/CMLoDg9kHICScsnzjyRmQyaBqG6dC/0H1iateTspboPbIRO+oVIs6v9L2zeR+57qDJV+CSQASlSSjl3JSbKI/Tn7ktXWetAaWi0Yup78l0xGUvkuBxc0XDAx4oA8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706808743; c=relaxed/simple;
	bh=Lyvp37yqP/RKGqGObubMXl4szy7JAwmzZhexN7cT3RY=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=oaVqZYSmw+FeTSitJg3dT2U8yRATvn+Fmv9v+6ePOVhCzya80PZ1PMOJYAZE1akL3xsjuJc4P00BYjZxNchgdDBSgrR6f1/CxZ8fL83w0Lag4H3eZmKsJllivM0md+/UBXSMqOu2auhyIwj37FucGdOph+UgKwUGQyTbsLg9t3w=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=GKaN44fN; arc=none smtp.client-ip=217.70.183.197

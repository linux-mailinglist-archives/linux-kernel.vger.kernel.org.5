...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3C1867C9578
	for <lists+linux-kernel@lfdr.de>; Sat, 14 Oct 2023 18:49:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233305AbjJNQtx (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 14 Oct 2023 12:49:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51204 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230016AbjJNQtt (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 14 Oct 2023 12:49:49 -0400
Received: from mail-wr1-x429.google.com (mail-wr1-x429.google.com [IPv6:2a00:1450:4864:20::429])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 62B71B7
        for <linux-kernel@vger.kernel.org>; Sat, 14 Oct 2023 09:49:42 -0700 (PDT)
Received: by mail-wr1-x429.google.com with SMTP id ffacd0b85a97d-32da4180ca2so154000f8f.1
        for <linux-kernel@vger.kernel.org>; Sat, 14 Oct 2023 09:49:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1697302180; x=1697906980; darn=vger.kernel.org;
        h=content-disposition:mime-version:message-id:subject:cc:to:from:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=k0WHZ79xh6zdrqo5CzUu9PdR9G8/bW9Z0WAULeTSHHM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1697302180; x=1697906980;
        h=content-disposition:mime-version:message-id:subject:cc:to:from:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=k0WHZ79xh6zdrqo5CzUu9PdR9G8/bW9Z0WAULeTSHHM=;
        b=
X-Gm-Message-State: AOJu0YwesB0+nN3YDfkTkXAbgxMDEaV/DPPWa8Cq77Ao5mTAzSBiZVah
        I87PW7S2BfAMowY5I59JlPc=
X-Google-Smtp-Source: AGHT+IFWNVYHvi0KTGmWpx2H/lYB69SJff65eez5x8BfGKRmv/fuD1/63wHjJxREtoT4C4/B0/B6kA==
X-Received: by 2002:adf:ab49:0:b0:32d:974b:6dde with SMTP id r9-20020adfab49000000b0032d974b6ddemr4583473wrc.0.1697302177785;
        Sat, 14 Oct 2023 09:49:37 -0700 (PDT)
Received: from matrix-ESPRIMO-P710 (p579356c7.dip0.t-ipconnect.de. [87.147.86.199])
        by smtp.gmail.com with ESMTPSA id a13-20020a170906368d00b0099cf9bf4c98sm1134116ejc.8.2023.10.14.09.49.35
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 14 Oct 2023 09:49:36 -0700 (PDT)
Date:   Sat, 14 Oct 2023 18:49:34 +0200
From:   Philipp Hortmann <philipp.g.hortmann@gmail.com>
To:     Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        linux-staging@lists.linux.dev, linux-kernel@vger.kernel.org
Cc:     Arnd Bergmann <arnd@arndb.de>, Kalle Valo <kvalo@kernel.org>,
        Larry Finger <Larry.Finger@lwfinger.net>
Subject: [PATCH] staging: rtl8192u: Remove broken driver
Message-ID: <20231014164934.GA12750@matrix-ESPRIMO-P710>
MIME-Version: 1.0

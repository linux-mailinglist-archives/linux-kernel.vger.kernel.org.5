Return-Path: <linux-kernel+bounces-36351-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id BEFAB839F90
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 03:53:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 205F0B286D5
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 02:53:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D1C74E563;
	Wed, 24 Jan 2024 02:44:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="E/JaUjRW"
Received: from mail-oi1-f177.google.com (mail-oi1-f177.google.com [209.85.167.177])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5975CDDA6
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 02:44:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.177
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706064266; cv=none; b=UnIFjJhbRFSMWhlOEc7IWtIdb9O28bd55QB9htsj/ULJxts/KghXQFjT1UWSSs3wSIZfB7HJncF4D1z/vuw9zhVl+gtYSajS4DYWDR9oqkaOLMrEmdudsbGVnwJPe0+oDtr+NbQyDDLKqnU9rOOZ563s7iVPYbmL6udwJbc2FCM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706064266; c=relaxed/simple;
	bh=SCsRxbmHiu9dLmLfmEWPZCEhUGm/+oUifajPRLFjKz8=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=KWkXduA+l38DUzFwjoG106dKm5YIgAKnYxaeOTbxQbb7p9ufDpXJg75ZEK06ZtU3TZVLs2IhVaRN3wYrObtZaQj4WYLwRzPW2kmzUMMXkvkevDIvIBuGXU+Bd/+ei6jm1R1LJ2NXSYlNHW+LVlZPLvm0Zlvaz4nzCc44EPjpUts=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=roeck-us.net; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=E/JaUjRW; arc=none smtp.client-ip=209.85.167.177
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=roeck-us.net
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-oi1-f177.google.com with SMTP id 5614622812f47-3bd72353d9fso4084481b6e.3
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 18:44:23 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1706064262; x=1706669062; darn=vger.kernel.org;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:sender:from:to:cc:subject:date:message-id
         :reply-to;
        bh=YFgPhnTF8W5dG4npoJ4cbg+XO3taZQa1+TTSWsc+5bE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706064262; x=1706669062;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:sender:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=YFgPhnTF8W5dG4npoJ4cbg+XO3taZQa1+TTSWsc+5bE=;
        b=
X-Gm-Message-State: AOJu0YwOChKjmG5NA/chi+M9EsjOYnkCuH99WO8HrAvQAWVm9+meH9s8
	zMcb/6FYZN6A4oL4C++pyHbiF+ySz+vMAWkp9KR1LIEy3A2Gs4XOqI1E2Ez7
X-Google-Smtp-Source: AGHT+IEEW0cIXcZonwTyBVU5RncFn4KhMPRAZlgzuy95iyd1uCqtqd2qNGbFWNill6Vhmv3oxq8FiA==
X-Received: by 2002:a05:6808:1928:b0:3bd:631e:a0f9 with SMTP id bf40-20020a056808192800b003bd631ea0f9mr1125868oib.41.1706064261988;
        Tue, 23 Jan 2024 18:44:21 -0800 (PST)
Received: from server.roeck-us.net ([2600:1700:e321:62f0:329c:23ff:fee3:9d7c])
        by smtp.gmail.com with ESMTPSA id n31-20020a056a000d5f00b006dd87824c56sm555246pfv.112.2024.01.23.18.44.21
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 23 Jan 2024 18:44:21 -0800 (PST)
Sender: Guenter Roeck <groeck7@gmail.com>
Date: Tue, 23 Jan 2024 18:44:20 -0800
...
Message-ID: <df420d40-1426-4687-98e7-c59232a9cc55@roeck-us.net>
...
On Tue, Jan 23, 2024 at 04:38:43PM -0800, Charlie Jenkins wrote:

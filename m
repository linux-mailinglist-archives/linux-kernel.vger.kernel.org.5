Return-Path: <linux-kernel+bounces-12835-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 26B3781FAB6
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Dec 2023 20:26:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 7A9F2B23DB4
	for <lists+linux-kernel@lfdr.de>; Thu, 28 Dec 2023 19:26:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DA87D11709;
	Thu, 28 Dec 2023 19:24:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=broadcom.com header.i=@broadcom.com header.b="bz5uO94S"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-oa1-f43.google.com (mail-oa1-f43.google.com [209.85.160.43])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C0EBF111B7
	for <linux-kernel@vger.kernel.org>; Thu, 28 Dec 2023 19:24:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=broadcom.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=broadcom.com
Received: by mail-oa1-f43.google.com with SMTP id 586e51a60fabf-2043e721daaso4060418fac.2
        for <linux-kernel@vger.kernel.org>; Thu, 28 Dec 2023 11:24:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1703791487; x=1704396287; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=O9Dbt4U/NHONJYOO6LtAo8Oo/fKCNSARoDTA1T7Tz4I=;
        b=bz5uO94S6KUeTOHzoiO6JCcPPvUrbWfr+yLTxKCHcJqnQikpqI7Wfh3353mO1iFaWr
         OQ4yODmLnezvBvGfYHyE0xTx0iQITvuKMJ6pbbIIsERXhJvoDaBR5RkEOMZzfBpZmfU6
         4UOXVkDdjB+2gNttuAN+wLjftD/YO3SMFxfVQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703791487; x=1704396287;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=O9Dbt4U/NHONJYOO6LtAo8Oo/fKCNSARoDTA1T7Tz4I=;
        b=
X-Gm-Message-State: AOJu0YyfycCO5lF99N7Vxt/ifqFF32nARgaBz/22rNNwznb8RJqzfF59
	29Tbb+gni3QYOlAMDsOAucsHN5TXUaTlEWy+DEppCnzEQ3cRe+x3Uq0b45sXmAqV6VZX3lQOb14
	OhuOklik+zJxgO4ZZQ62QIuivx6rTQF17tZB0VsKtZnNtmEMuUye09q/8PXerjDpLXZHnSPSNac
	IuhjvW2fNAEpJte9PfOFecSAk=

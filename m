Return-Path: <linux-kernel+bounces-136693-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 8127E89D72C
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 12:41:21 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id ED12F1F23B2D
	for <lists+linux-kernel@lfdr.de>; Tue,  9 Apr 2024 10:41:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A645985928;
	Tue,  9 Apr 2024 10:41:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=wolfvision.net header.i=@wolfvision.net header.b="YrLyhQPt"
Received: from EUR02-VI1-obe.outbound.protection.outlook.com (mail-vi1eur02on2110.outbound.protection.outlook.com [40.107.241.110])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2464784D3A
	for <linux-kernel@vger.kernel.org>; Tue,  9 Apr 2024 10:41:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.241.110
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712659261; cv=fail; b=h8+6n9UWdGrCSSFF8S1ALMDNRqGLkAWOPCVWfXq7ysdbQ8dlKiYPmbonvCr+wILmpn1AXhjBXUJdfHKdy7wcfJpAXWiVdRY6ZjHgaysPbHv9QLn1F7pkHSpaMs4aVrCs1W5aiIqSluh3kjQGWUACCl8vIgwYP58bn4fZI6E+rcY=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712659261; c=relaxed/simple;
	bh=L75Ahzdg028IAtu+zqtyqJPYqEpvooArWModEJr1xcs=;
	h=From:Date:Subject:Content-Type:Message-Id:References:In-Reply-To:
	 To:Cc:MIME-Version; b=Zvuxz/L3jy+qjSu59dvvKOX4CAz0+ZCbF9RoeLRqsb0KnXnQbbP1J8a5qwkDj0oXzvqIk22coHDXUCCp5tF9EewLQzwkT+B11ax571r5btHfiSCasJhnt41NAwzBzHuw1E79s5a+L62qO5TB4sRoAICR9MbGIr2R5wG+WquqlHU=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=wolfvision.net; spf=pass smtp.mailfrom=wolfvision.net; dkim=pass (1024-bit key) header.d=wolfvision.net header.i=@wolfvision.net header.b=YrLyhQPt; arc=fail smtp.client-ip=40.107.241.110
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?YThqNThSTzN6WDRLUk1TQVdKeTVEakRsek9ub0huWHF2MmdLWlJ0bEdNckNY?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Apr 2024 10:40:51.7765
 (UTC)

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B510B76E104
	for <lists+linux-kernel@lfdr.de>; Thu,  3 Aug 2023 09:14:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233243AbjHCHOX (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 3 Aug 2023 03:14:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35556 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230096AbjHCHOU (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 3 Aug 2023 03:14:20 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 75183FF
        for <linux-kernel@vger.kernel.org>; Thu,  3 Aug 2023 00:14:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1691046855; x=1722582855;
  h=date:from:to:cc:subject:message-id:in-reply-to:
   mime-version;
  bh=65h4B5+zCFeS36ZAQugTnRBARobHwjyaiynA/wQunq0=;
  b=SHUYIckT1XOi0RwS5LJMsw50bUqfCPbO/7viv8glFogqjU8qPlsuruQW
   SCgRDn5DBiTs/LMfGvLhCn4twJjhO5TM9QD/jj2N/9p9GZjqXcTeT/quU
   Fu19qgePrGdizIGQCCP8K40pNV3Qn6sysfGavWGCwiinZhMqnhPko1y5O
   WeVRI/PU9Db6cLG2dEVI11lTa6JiytVjJQVFMRq9DkC7KURWArawmrRF6
   wRIcoQsPe280wP8g+JKQkhkHDxroSIsOBQklwDbiCamWhTDjwqqhRCIc+
   c3Ai6fU6+1jCCLBTznxe0S4mdEVYoQWN3rvGh4YndgUayhHFbC0GOkKA0
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10790"; a="368689522"
X-IronPort-AV: E=Sophos;i="6.01,251,1684825200"; 
   d="xz'341?scan'341,208,341";a="368689522"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Aug 2023 00:14:13 -0700
X-ExtLoop1: 1
...
CC:     <oe-lkp@lists.linux.dev>, <lkp@intel.com>,
        ...
        <daniel@ffwll.ch>, <jbaron@akamai.com>,
        <gregkh@linuxfoundation.org>, <linux-kernel@vger.kernel.org>,
        <amd-gfx@lists.freedesktop.org>,
        <intel-gvt-dev@lists.freedesktop.org>,
        <intel-gfx@lists.freedesktop.org>, <jani.nikula@intel.com>,
        <linux@rasmusvillemoes.dk>, Jim Cromie <jim.cromie@gmail.com>,
        <seanpaul@chromium.org>, <joe@perches.com>, <oliver.sang@intel.com>
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH8PR11MB6779.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230028)(396003)(376002)(346002)(136003)(366004)(39860400002)(451199021)(30864003)(41300700001)(316002)(4326008)(2906002)(6916009)(66556008)(66476007)(66946007)(235185007)(8676002)(8936002)(5660300002)(82960400001)(38100700002)(1076003)(26005)(6506007)(36756003)(186003)(86362001)(2616005)(83380400001)(6512007)(478600001)(45080400002)(44144004)(966005)(6486002)(6666004)(107886003)(7416002)(2700100001)(568244002);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 03 Aug 2023 07:14:08.7222
 (UTC)

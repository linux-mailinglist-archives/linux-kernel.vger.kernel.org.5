Return-Path: <linux-kernel+bounces-128804-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 57411895FC0
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Apr 2024 00:44:50 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 07D8F289999
	for <lists+linux-kernel@lfdr.de>; Tue,  2 Apr 2024 22:44:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9D89714AD2A;
	Tue,  2 Apr 2024 22:44:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=pm.me header.i=@pm.me header.b="F1Kn5C61"
Received: from mail-4316.protonmail.ch (mail-4316.protonmail.ch [185.70.43.16])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 786492E3FD
	for <linux-kernel@vger.kernel.org>; Tue,  2 Apr 2024 22:43:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.70.43.16
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712097839; cv=none; b=GvCjaBVsfnL9LhX9zppZMzmxAACkSdCrtnFLTWqlBwM5Z4/9P15IdCOOw32qvTtjVQbI7EKzVcVTMbzGzKKgwRWDTve9xlGmXYTzF8pWACI9MYn73WoVfXGBO5fELqVx4QXPvm95EUdYe3pmJD/eoRFt0rZNQ/sc4eqBBDSaRRU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712097839; c=relaxed/simple;
	bh=VMMobBmBY5nArtwLbAft9GhqPDspZoBmj/WlkpYe5+0=;
	h=Date:To:From:Cc:Subject:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=p18L6HSOE062TFKU7uD2fJw6RcYeLGfbAHchQWjPHkfuqKjQol503AMN1b3giKUlXyWoh3LR0gu8alL2rsunhptQyqOG8tDdVJBITyu+MNsA2nLuMmYvAiNaOX/WMcbxc1XLK515FFCWiHc25WhL0NnaFYFG6EzpuwM49S52UzE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=pm.me; spf=pass smtp.mailfrom=pm.me; dkim=pass (2048-bit key) header.d=pm.me header.i=@pm.me header.b=F1Kn5C61; arc=none smtp.client-ip=185.70.43.16

Return-Path: <linux-kernel+bounces-160965-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A69E38B4536
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 10:49:27 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id AE3121C2222F
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 08:49:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B156C4503B;
	Sat, 27 Apr 2024 08:49:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="fFEcwG+B"
Received: from mail-yw1-f174.google.com (mail-yw1-f174.google.com [209.85.128.174])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 63F604503C
	for <linux-kernel@vger.kernel.org>; Sat, 27 Apr 2024 08:49:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.174
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714207757; cv=none; b=lNqOy5ebKFIkIjktkoBU0Q3WgC2PP12PniV5oWfM2J4+KDI0zotUTONDeAHtRVB0gxDxiVZeKBEIksywGv0XSI6QSeuOwLlSiP6tt64wSUC9nY899bTkPheqOc86WAu7Rnw9PeZnl7K7WHAi1Vg4s2lgnYSjjcpcmT4O79SU8qg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714207757; c=relaxed/simple;
	bh=xHhL4VHs9CUyW6CkjaaAPkYlMr06WQFd7mJ3EFP6w48=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=AtaT6cgtcjNTqLbO+E0S9zv2T/7F9f0jAp8nssTctKNCQDhYBbB7criSQHZgiaHMZ1LJrutS4bI/dsvGjkJuqjXwdvbEalYMUws6JvcufOAB503pWzp0WUpyWGr1XN3YdWALEPNiSoPHzI6IuP0XScTClWnBGvR9JG6uOWFWtZI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=fFEcwG+B; arc=none smtp.client-ip=209.85.128.174
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-yw1-f174.google.com with SMTP id 00721157ae682-61bb219737dso14340177b3.2
        for <linux-kernel@vger.kernel.org>; Sat, 27 Apr 2024 01:49:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1714207751; x=1714812551; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=5wqZ0h8qfpRnSu0KopRWc19BdIDTZJOmBWktD/IWVYE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=5wqZ0h8qfpRnSu0KopRWc19BdIDTZJOmBWktD/IWVYE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUhtF8+LLgIGTRQNUpgEWmUT/2IYiH+n5ymrwuOENUS+qX+uhYR3EQ2q4MwjuvUvLoGKvmLwJ8H+tqn9678n0xHv5ZKTZ4LNnfUuaFS
X-Gm-Message-State: AOJu0YwXxbEyKKGyAjoBMsi1xmW0bojIpvSyhMZbLv9dBw+mAXJrCaD1
	6/Gy12cPuGSCGqPkgJ/OsztQ8cZmleMALAytEsYhXmGmYIAuA6hAH9vXpXGdOSWhk0gdVleCIys
	TDQZjErVUhif9dKrofH4b9/9IFntFr4jOOgvUMA==
...
MIME-Version: 1.0
References: <20240426235857.3870424-1-dianders@chromium.org> <20240426165839.v2.8.If6ac69b5ba71ca4445673b3bed6b76d43557dd44@changeid>
...
Subject: Re: [PATCH v2 8/8] drm/panel: boe-tv101wum-nl6: Convert hex to lowercase

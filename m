...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 109D67999E0
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Sep 2023 18:29:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235650AbjIIQ0g (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 9 Sep 2023 12:26:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50024 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S245314AbjIIPdK (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 9 Sep 2023 11:33:10 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 25C251B1
        for <linux-kernel@vger.kernel.org>; Sat,  9 Sep 2023 08:32:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1694273522;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=jy97Zm8O5jUoTHurzLr8Pi9ChNRT0Cs6TkosOA15it4=;
        b=M9aMsVoWEYQ1Xz/RZaDuhv+tNjev7afiOcjVZbSBjVFZZsPaPrBgek7a6XT+RvXWt0cbGz
        XcSfVynd4bNfU3Y+CknHwiRG0tCB7u7+WFV4gRNSlyPn93ediQUTj15ZMIJFUyIV7j9a+A
        WO0E8TkaOL9vJ+orasEfnTnVnBYc4P4=
Received: from mail-ed1-f71.google.com (mail-ed1-f71.google.com
 [209.85.208.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-442-VDsRsHZzMZO8T5FGro1DKw-1; Sat, 09 Sep 2023 11:31:58 -0400
X-MC-Unique: VDsRsHZzMZO8T5FGro1DKw-1
Received: by mail-ed1-f71.google.com with SMTP id 4fb4d7f45d1cf-521da4c99d4so2128879a12.1
        for <linux-kernel@vger.kernel.org>; Sat, 09 Sep 2023 08:31:58 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=jy97Zm8O5jUoTHurzLr8Pi9ChNRT0Cs6TkosOA15it4=;
        b=
X-Gm-Message-State: AOJu0YzhfFpZm4SAuUJ8NNRi5we6KjqqnMVSKDTWeIH4axfs4/mduuCT
        tb2xCupJKakbFXHB0CseP9FGo+AXvuVT1lZp/kd0FwDE9RdUrsREF3x4V2gvqZyX9ewvd1J6J4P
        I28nEIW8VxniQsCNSKtiiJ60y
X-Received: by 2002:aa7:c748:0:b0:526:9cfb:c12 with SMTP id c8-20020aa7c748000000b005269cfb0c12mr4260241eds.38.1694273517307;
...
X-Received: by 2002:aa7:c748:0:b0:526:9cfb:c12 with SMTP id c8-20020aa7c748000000b005269cfb0c12mr4260228eds.38.1694273516992;
        Sat, 09 Sep 2023 08:31:56 -0700 (PDT)
Received: from cassiopeiae.. ([2a02:810d:4b3f:de9c:642:1aff:fe31:a19f])
        by smtp.gmail.com with ESMTPSA id t11-20020aa7d70b000000b0052e901cef48sm2309820edq.48.2023.09.09.08.31.55
...
Subject: [PATCH drm-misc-next v3 7/7] drm/nouveau: GPUVM dma-resv/extobj handling, GEM validation

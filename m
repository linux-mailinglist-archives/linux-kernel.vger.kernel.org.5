...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 96D6B798174
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Sep 2023 07:14:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241833AbjIHFOa (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Sep 2023 01:14:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44016 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241153AbjIHFO1 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Sep 2023 01:14:27 -0400
Received: from mail-pl1-x633.google.com (mail-pl1-x633.google.com [IPv6:2607:f8b0:4864:20::633])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AA91D1997
        for <linux-kernel@vger.kernel.org>; Thu,  7 Sep 2023 22:14:21 -0700 (PDT)
Received: by mail-pl1-x633.google.com with SMTP id d9443c01a7336-1bf1935f6c2so11752195ad.1
        for <linux-kernel@vger.kernel.org>; Thu, 07 Sep 2023 22:14:21 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1694150061; x=1694754861; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=+CjISTzuvCMDkLQbL3HNJkgrADTF4I3Xcv5VI1bwwj8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1694150061; x=1694754861;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=+CjISTzuvCMDkLQbL3HNJkgrADTF4I3Xcv5VI1bwwj8=;
        b=
X-Gm-Message-State: AOJu0Yywh1CXK2ImmDXzctd/XT+aBUUyVY33LuN/ugIyEyumL7/KAMCZ
        yvWnaZIpTW/kCl7QnXRvJW+t0A==
X-Google-Smtp-Source: AGHT+IEsjsbgeAFRmu49bwYmzjgIqeHaoHYV7JdPO0NyCRf3e8nbNbHDRZCv4BQufzpKz6tM2c1lxw==
X-Received: by 2002:a17:902:e88b:b0:1bb:cd5a:ba53 with SMTP id w11-20020a170902e88b00b001bbcd5aba53mr6406946plg.14.1694150061078;
        Thu, 07 Sep 2023 22:14:21 -0700 (PDT)
Received: from charlie.ba.rivosinc.com ([66.220.2.162])
        by smtp.gmail.com with ESMTPSA id f5-20020a17090274c500b001a5fccab02dsm616482plt.177.2023.09.07.22.14.19
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 07 Sep 2023 22:14:20 -0700 (PDT)
From:   Charlie Jenkins <charlie@rivosinc.com>
Date:   Thu, 07 Sep 2023 22:14:08 -0700
Subject: [PATCH v3 5/5] riscv: Test checksum functions
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230907-optimize_checksum-v3-5-c502d34d9d73@rivosinc.com>

Return-Path: <linux-kernel+bounces-80950-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D7866866E5C
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 10:27:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8CA962864BF
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 09:27:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EFD525D73D;
	Mon, 26 Feb 2024 08:47:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="ULMut2Pg"
Received: from relay4-d.mail.gandi.net (relay4-d.mail.gandi.net [217.70.183.196])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9C6EF5C8F8
	for <linux-kernel@vger.kernel.org>; Mon, 26 Feb 2024 08:47:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.196
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708937275; cv=none; b=fnxMICmzFDkZwzfn2L+/OyEI+jR5uxh1fpcJNvYP1+064KXBVBBAgPmQ4twfcnfKHMIk9QbLqNJgjZWra71c1ndYoCio3v4Q6657rKGa88vp/yMWUbQiQZBtliewfSzgR/O4s3eaVJGOjcXdW3E3bTV5hoc2gDHKgjxOxkwA+Mo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708937275; c=relaxed/simple;
	bh=yMPzym00FB2Wc5Dwa8wI9RZQ3CPrFsUJyeXrOlw2Z28=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=aeoUQz49kHdqOQOaDOfenykitMAkFpOfJNkIzhzINRX41HyzV2r5l84QxYyJFMFgSg5jNRDSUi2jLXt9wC3kvnBA9SEdQqTSX59XEcmvDAEHb3MOMezWi1DUYcRq+YjABF5XZZsbiUCdUg7Sr3uAFJH98VhFhB3xjq8ijGY7B9s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=ULMut2Pg; arc=none smtp.client-ip=217.70.183.196

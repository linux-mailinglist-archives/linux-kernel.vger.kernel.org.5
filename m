Return-Path: <linux-kernel+bounces-44074-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id B7398841D02
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 08:52:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6F451287DF5
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 07:52:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BB0B353E29;
	Tue, 30 Jan 2024 07:52:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=samsung.com header.i=@samsung.com header.b="cPvp6T35"
Received: from mailout3.samsung.com (mailout3.samsung.com [203.254.224.33])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BA0A853E13
	for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 07:52:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=203.254.224.33
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706601159; cv=none; b=J/KMcepf/jeUzbCOGVw+yUjgSBTdAI8+grqeW3byXHafea5uTKsUid/9kQ+aLBod20JVbLHAy31u6VwO9PY9Nw3CuVV2Ap7r/TYgl/au4SZv/T5MEk1qM0XoQHpdH9qhpKqY+Zep+y5Wv2k9Rsp+yu5mlm74lxOCLWDpkH3v5G0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706601159; c=relaxed/simple;
	bh=0Q+E6kRva+/RjLoYooYJxbptgewzdyZaRx/rMpCfyB4=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:MIME-Version:
	 Content-Type:References; b=MXorRvhKOiHAfvEwu9ktOkxYWoJTQegmAep/CDcyA6y0i2U3jVAsgVbK9Uq63dBcPMtU/9O6mfrBRXaP0BWmEGWTed98IYPsmLGx9V6tH+ls5Ng4WZWJ2PXSxwdMmii8OeDsG8ngmgIXeLgrQ1DMtaVuxWo/CIeg5ezk5tTmnHs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com; spf=pass smtp.mailfrom=samsung.com; dkim=pass (1024-bit key) header.d=samsung.com header.i=@samsung.com header.b=cPvp6T35; arc=none smtp.client-ip=203.254.224.33
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=samsung.com
Received: from epcas5p2.samsung.com (unknown [182.195.41.40])
	by mailout3.samsung.com (KnoxPortal) with ESMTP id 20240130075229epoutp038070ee24f4a3f2a08ced65cf895a8f54~vELQJBp9c3152131521epoutp03L
	for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 07:52:29 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout3.samsung.com 20240130075229epoutp038070ee24f4a3f2a08ced65cf895a8f54~vELQJBp9c3152131521epoutp03L

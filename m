Return-Path: <linux-kernel+bounces-57307-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 98EF484D6D1
	for <lists+linux-kernel@lfdr.de>; Thu,  8 Feb 2024 00:58:57 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 016931F23DBE
	for <lists+linux-kernel@lfdr.de>; Wed,  7 Feb 2024 23:58:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9CF0C535CC;
...
Received: from out-170.mta1.migadu.com (out-170.mta1.migadu.com [95.215.58.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CD4EC535C5
	for <linux-kernel@vger.kernel.org>; Wed,  7 Feb 2024 23:58:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707350329; cv=none; b=pLZ3P6u8H+am37l27P2UZldaLGnX4LKxL8+7slJ8+ju7RmiIJRhji/RUFI7qk/+FgZakBCwklB9fNSLZ/0K/GggO0Y4dYXvBxZJfr6ZWkoxCeMzEUDo0Urgz4fCvsw47XNLN/WbZLoZU6YiioLvwm1EEkKa4k7GQepmD9hw5OZM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707350329; c=relaxed/simple;
	bh=R4QNkyQjSAfAfY7FrkR0iT+UnKekRPxtGiyIy+jBGc4=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=mdWv8jsTESPcN/ufWvzcihrLIAGqFlCGCor9y3yuee/chRllvAq3kHAbCxcX/GbCKyilDNySjff6AayJYooNVHhqE3cW5I3+oc1BY8ZfrKIJDjuULrRQW6PA5ic0oPOzoIQzV6wSVALr8kQ0qnrItfrt9IWOhrTkmhWeuWvskgE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=pIQbZVK9; arc=none smtp.client-ip=95.215.58.170

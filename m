Return-Path: <linux-kernel+bounces-163927-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 561DD8B7604
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 14:43:55 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 79144B21624
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 12:43:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4C38D171088;
...
Received: from mail-ej1-f51.google.com (mail-ej1-f51.google.com [209.85.218.51])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2E15813F43D
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 12:43:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714481025; cv=none; b=rnAo8jY7HJSePISJLjDsz5lUqO2hbCkxISOUfsr+mSO+M4c/5nEZTUU716uLOgLVaJDHzYqnak+6zGao/qimEPERZ1CRgQevD/MBCVNtej4wajE7L/ca5pxGEVYgNQYTwH2ScaVIdnPUfC8EBCQqfCsHZ+BB27GXu4pHsbLuMbo=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=zenRqpyt; arc=none smtp.client-ip=209.85.218.51
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-ej1-f51.google.com with SMTP id a640c23a62f3a-a55911bff66so691048766b.0
        for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 05:43:43 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Z2cfWtBAsXqglGUC0FXhyb0s4Cp7D8stHYMoBK9Lwj4=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCXtRBrBrAYi/8c10yNWye1AvTpQtCknFwZ3fQeicsma1hhBn4zRpvaa+jUMjjDgn7RWlPAhuxtTGiYly896VgC7cljCfab3SUzXvinK
X-Gm-Message-State: AOJu0Yz7TR36B0phLLi6nnd1BZxvjSM64XcP93cj0sTt1tXt/7ayEPhq
	dL5LXkvhxWSMsDCyCxyhi9Q9iQhXIFTLHZgLU82cTu0m1utJRctsoh2p0XflXWw=

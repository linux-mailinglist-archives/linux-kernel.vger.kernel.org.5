Return-Path: <linux-kernel+bounces-139956-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 469F18A0992
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 09:20:23 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 76FFC1F2516A
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 07:20:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4429513DDBF;
	Thu, 11 Apr 2024 07:20:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmx.de header.i=toralf.foerster@gmx.de header.b="c7W4trRN"
Received: from mout.gmx.net (mout.gmx.net [212.227.15.19])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 35E7813DDBB
	for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 07:20:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=212.227.15.19
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712820013; cv=none; b=dnGxioFfgAiuqTtpLDF4AJQkvXP0GeL3kfOTHUee/UgomPTkRFEuwe3rKtcRM+PD8th4MW7YE/294MZWrKJhgbeThaYazfsNXVGkLjHvkLKPBloN5VaoLSJY2ch1NDcWbS21hzDkma9dooeev1WReLQ6tGnLg6reoTYMgezi9mE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712820013; c=relaxed/simple;
	bh=FJLoYIaXnWpRhR/ROWeQnvkBUro7vXZUvVP2r5Io0b0=;
	h=Content-Type:Message-ID:Date:MIME-Version:To:From:Subject; b=oJPqCDAhJeMW7HyB19ClC71LOmbGLmQyEmFhjLOl63FYjp2t3Lp6FT9OS5iu9arJnTh/W1lMBAsrI7dufg/OUAUpMIW0fap+A6Ds8K1mh+JG5zUP4LHjO6QRJhlqHDLlfSnTp3V7LmfPdlCdtIo8irCJYwYroICzMacFuoIwu+M=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=gmx.de; spf=pass smtp.mailfrom=gmx.de; dkim=pass (2048-bit key) header.d=gmx.de header.i=toralf.foerster@gmx.de header.b=c7W4trRN; arc=none smtp.client-ip=212.227.15.19
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=gmx.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmx.de
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmx.de;
	s=s31663417; t=1712820008; x=1713424808; i=toralf.foerster@gmx.de;
	bh=jzT7K1wqzPbHlVRRSIgsJqaFExnvKH/tjNXYITYN84U=;
	h=X-UI-Sender-Class:Date:To:From:Subject;
	b=
X-UI-Sender-Class: 724b4f7f-cbec-4199-ad4e-598c01a50d3a
Received: from [192.168.178.33] ([77.6.56.137]) by mail.gmx.net (mrgmx004
 [212.227.17.190]) with ESMTPSA (Nemesis) id 1MgeoI-1sQaBA0bT2-00h7wH for
 <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 09:20:08 +0200
Content-Type: multipart/mixed; boundary="------------yM4hJ6hUG06vF6Yo3MEqkPsU"
Message-ID: <3c6e6172-cf64-4230-bcc5-7682b4d64a8a@gmx.de>
Date: Thu, 11 Apr 2024 09:20:07 +0200
Precedence: bulk
...
X-Provags-ID: V03:K1:mBlvZuF9LEn3h5Oz3dSCHoscH1YNa12bXIuOxsxmQvK6fyq31Mh
 g3RqjYHmLoM7sa9gztG3YecmNatclkbj4LLFlxjJuqS7TIZn/fvoz1cXFrCCoDP7JVgIeYj
 yP5twiiwoOpzwVULGvPiNjCkJ1nTWR2zB74B/+sLk3tBGQbAKhvus5/NFFSZWa5TpQtaUgG
 JTs8U4QK9xYNzQEG1NFEw==
X-Spam-Flag: NO
UI-OutboundReport: notjunk:1;M01:P0:LhGIbT55CRY=;Q22zG7I5xzk4M5+SA+xOw1/PSai
 

This is a multi-part message in MIME format.
--------------yM4hJ6hUG06vF6Yo3MEqkPsU
...
--------------yM4hJ6hUG06vF6Yo3MEqkPsU
Content-Type: application/x-troff-man; name="config-6.8.4"
Content-Disposition: attachment; filename="config-6.8.4"

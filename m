Return-Path: <linux-kernel+bounces-37687-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B47283B3D8
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 22:24:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id C78071F2745C
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 21:24:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 314F31353E8;
	Wed, 24 Jan 2024 21:24:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="TLXbmKp6"
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 06A731350F4
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 21:24:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.55.52.120
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706131465; cv=fail; b=Kp91tMZ5oEwBKxUvkV+rpG6DQ36VybcVh+1RXP5ZUKNx790X/U7fVckwZ00IUWw5cC3kjIeXaAEzrc7BRbwdLeXKh73Kp4TDdWsF6lmDiL3WvR/FEvQqQN5kVUZ3gM0+vDIUaO5MVm6sZRcLUqI87JkJni+h3slEjlHXefd3SM0=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706131465; c=relaxed/simple;
	bh=lSvD3t9W4jAlv/a0hDljTi6rHZKaqj1OCiOGk73e0Vg=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=tDyez0hMBRFXc5mghWAouOoHp6ohZE61nUMf83eI1x8pi6WJnaLIgS2Pv0+hDRwaR8/tftXsi88Tp8sSF1116bIO4oN4te3AbVccu3Co0Guss82mWADPfsnD+FVMmPn/hKcZZm73Uz3fraoLxWr9+iQ8M+LWqeNqNg3Mzt9wcE0=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=TLXbmKp6; arc=fail smtp.client-ip=192.55.52.120
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1706131462; x=1737667462;
  h=from:to:cc:subject:date:message-id:references:
   in-reply-to:content-transfer-encoding:mime-version;
  bh=lSvD3t9W4jAlv/a0hDljTi6rHZKaqj1OCiOGk73e0Vg=;
  b=TLXbmKp6TkSDHkheSL4wqm2ND2NAYnXum2GXNMIBpt6/XEufvA7rHyU9
   8Y2NPry9mM05Mdsd4PhL8Vfl1vItnpm/J4EEagfYIZ1xHl+DrG+Bhj8E1
   LcSvjPb/Ymbg7rQAZj+s0DTUlsTTi3JAks6v2PalFHQzRZUjoBDrU8zq5
   cpDSitzkTsh0s1iEMEeLhBgyNG9NhTauD9WMECY38aEQS/iTsDJNv1z9z
   /UL7qH8CJpV4gRD38XeOzhfuvUeduyKsx6h5pNWM4bE+GAXfxK4cNI+FA
   JvtTrLYmFFhdsQYzty5FWK/VY98oiBmpRtyw9Anx5B8Qd9DuPBObnUwnu
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10962"; a="400835107"
X-IronPort-AV: E=Sophos;i="6.05,216,1701158400"; 
   d="scan'208";a="400835107"
Received: from fmviesa001.fm.intel.com ([10.60.135.141])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Jan 2024 13:24:20 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,216,1701158400"; 
   d="scan'208";a="28531836"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
  by fmviesa001.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 24 Jan 2024 13:24:21 -0800
...
Thread-Topic: [PATCH RESEND] drm/virtio: set segment size for virtio_gpu
 device
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:IA0PR11MB7185.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(346002)(136003)(376002)(396003)(366004)(39860400002)(230173577357003)(230273577357003)(230922051799003)(64100799003)(1800799012)(186009)(451199024)(66446008)(82960400001)(66476007)(54906003)(316002)(110136005)(9686003)(122000001)(64756008)(66556008)(66946007)(478600001)(38100700002)(45080400002)(76116006)(55016003)(7696005)(6506007)(8676002)(8936002)(4326008)(52536014)(5660300002)(83380400001)(26005)(2906002)(86362001)(33656002)(71200400001)(41300700001)(38070700009);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 24 Jan 2024 21:24:17.3439
 (UTC)

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 134FB7DF974
	for <lists+linux-kernel@lfdr.de>; Thu,  2 Nov 2023 19:03:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235114AbjKBSDR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 2 Nov 2023 14:03:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56044 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234733AbjKBSDL (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 2 Nov 2023 14:03:11 -0400
Received: from mail-yw1-x1149.google.com (mail-yw1-x1149.google.com [IPv6:2607:f8b0:4864:20::1149])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 76BCB1BF9
        for <linux-kernel@vger.kernel.org>; Thu,  2 Nov 2023 10:59:24 -0700 (PDT)
Received: by mail-yw1-x1149.google.com with SMTP id 00721157ae682-5a7cf717bacso17917257b3.1
        for <linux-kernel@vger.kernel.org>; Thu, 02 Nov 2023 10:59:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1698947963; x=1699552763; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=r5bbudPScTlVOJAhUWDGnNzs86QSINLBeG8H7qNSglo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1698947963; x=1699552763;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=r5bbudPScTlVOJAhUWDGnNzs86QSINLBeG8H7qNSglo=;
        b=
X-Gm-Message-State: AOJu0YyyfgoeHUFGHyvMDeWLJUkiJM3qRKaR7XK76MrxQ6MI4orzXs3N
        V/qy/FzCpjoyvHPoIYCjk1FSvi1ZH9fl
X-Google-Smtp-Source: AGHT+IGqG4pBZ12lkZDyJrCW65Gxg0g2bqvcAdelOn4qlLzRQKhFGoldgwQXi1U4/JsjLW4nzKf+nf8MdPXu
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:bb34:df9c:836c:afca])
 (user=irogers job=sendgmr) by 2002:a0d:d9cc:0:b0:5a7:ba09:44b4 with SMTP id
 b195-20020a0dd9cc000000b005a7ba0944b4mr8819ywe.1.1698947963391; Thu, 02 Nov
 2023 10:59:23 -0700 (PDT)
Date:   Thu,  2 Nov 2023 10:57:20 -0700
In-Reply-To: <20231102175735.2272696-1-irogers@google.com>
Message-Id: <20231102175735.2272696-39-irogers@google.com>
Mime-Version: 1.0
References: <20231102175735.2272696-1-irogers@google.com>
X-Mailer: git-send-email 2.42.0.869.gea05f2083d-goog
Subject: [PATCH v4 38/53] perf threads: Move threads to its own files

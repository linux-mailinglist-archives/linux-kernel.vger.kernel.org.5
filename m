Return-Path: <linux-kernel+bounces-140468-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E30768A150C
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 14:50:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 972BC284317
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 12:50:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7D3C314D70C;
	Thu, 11 Apr 2024 12:48:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="PbU0hoag"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5BF20147C9D
	for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 12:48:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712839708; cv=none; b=jvLS1bDsCTE9tolOQ+ktZ+SKuQjTTSHkIL6YA8LutQYlgp1r8soB3VdYzXrey3GpuNJCuIfpFiEDijWlUTCy7YEHV09nRXTuxVq4gUtpSLmH0sIX/+uDQqfYbsUKvL+BGbDeGnDCp198n+0XdwZBuDvrp3K3Dv3MNDe90H9VG9M=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712839708; c=relaxed/simple;
	bh=WdDOMX9tnc1tmWwRoL7QOvCRxUbQx0s/YjWcKqoMOXI=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=acqquh2aTzOYzamEZtNbQMGLIHLNxugX35fT3/elFuAdg/z9Kqrf+zU1/NeZe1q3PXnB29dohmHzZtoeS61pPNEkfsM5nX6XIDtLHrtEwVgVDXKXum8km9KfWM7osf2Bu/ndA1Yn81eCOz59jmg+8a2b/lDkYVKZKKLmMbHzbXs=
...
Received: from mail-wr1-f72.google.com (mail-wr1-f72.google.com
 ...
 us-mta-683-cqtZTfUSOpu-utVjzKTywQ-1; Thu, 11 Apr 2024 08:48:22 -0400
X-MC-Unique: cqtZTfUSOpu-utVjzKTywQ-1
Received: by mail-wr1-f72.google.com with SMTP id ffacd0b85a97d-343e46df264so3455417f8f.1
        for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 05:48:22 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YGv0oxILWFs0mMfSSjVAs+Z0hudt/O6Xh0nJxcnvIcY=;
        b=
X-Gm-Message-State: AOJu0YyavL2TQCCqmaNrdmSI2EWOF28ctBzBmaFGyMlPsIOlCHmzP6jM
	jcfDJlxFiYhU8//33Kwvq3ze3VX1a47gPbElj+rxZH9bS0vWknOw+z1qBJE62Qfd65fCPkZKxHK
	bgM4cw/CgumoFrBC/HLzYWSho7DWFT9e8aN8P95iu1KpNzQ7El6jeTFlFWK2F0/BhPbqcWA==
X-Received: by 2002:adf:e259:0:b0:33e:cc16:387 with SMTP id bl25-20020adfe259000000b0033ecc160387mr3810159wrb.54.1712839701840;

Return-Path: <linux-kernel+bounces-37071-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 25C0683AB08
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 14:39:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D41B9287D56
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 13:39:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C1A8177F17;
	Wed, 24 Jan 2024 13:39:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="UJjmK1gS"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 83FA260BB3
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 13:39:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706103582; cv=none; b=Eg5kRNZ1bhFYQofja51yhCUo1syEouNCXbXeqS4PaNEvQzyAhFzTFUFYoh8rm9zabeOrggQ/dQFQ83ikfTGBbxnJJSNALngRMvpqNMv0rehl9Ljq7MUabqq+4p+EJFzxkvVx9pUTslV6c1Z6H1TYHjA5jxjPiQgsWp6MKNtY7es=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706103582; c=relaxed/simple;
	bh=npa0NVykoMEN5MSYcp671yDBaYHZIPWOdfRNArMuVbk=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=a3PsBvHGaTjCoRiI1TKgezlCSdSOARr+ECbwVtcTHmSYSqV+YgBZ8qo3tKacygFOS8zqFYs3j5UmSZT9x6aFKbRzOMelM3BioZ+Lzw5oGgUujKVfV8tM+hG8kaE7+I5P+qpD2HAYmYSvp/A6N8ifV3r0vS1R6LlMCoYwtxXs2BQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=UJjmK1gS; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1706103579;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=L2dSIR4rbvdDm+KCVPpjilkj3+2xgOobjinuJW9fE8M=;
	b=UJjmK1gS7rCVvzFojR5tOHV/E3zozGAPq9VCAzG0MLn3jqjakwsNCIBYfp/+ukq0QluAy7
	fyNyutgbN/s0ZX3DydeULShbgkb70vYB4ccdkY39q+nC1iOTO2aF9q9nurifDhWgPGudXo
	W6AdNuWdpXeZrudRbiyeKaYhIB3cPqQ=

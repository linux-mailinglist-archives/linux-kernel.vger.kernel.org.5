Return-Path: <linux-kernel+bounces-95077-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D48F68748F8
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 08:45:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C106F1C21ADB
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 07:45:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AE0F563401;
	Thu,  7 Mar 2024 07:45:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b="nH4oJzDk"
Received: from EUR04-VI1-obe.outbound.protection.outlook.com (mail-vi1eur04on2073.outbound.protection.outlook.com [40.107.8.73])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F38B263114;
	Thu,  7 Mar 2024 07:45:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.8.73
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709797522; cv=fail; b=b2FJLEo3wm9v0DNIQr1CZLcFmIto//o2Ij1rqzGkAPQBfAeTVP4jxIvYOZ3N0TatqFHq+Oh+0Q4xTCCTqLDdlsLhCN/aFA8Q2dFdLaRo0b51MdzsIOzEl0mu5ia+gulQyEd+bRuzRIgcS/MNJYucMvbCAeObLIP1RftaEhWZW4c=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709797522; c=relaxed/simple;
	bh=HBmrhhEuWxy3hoO5iNeDkh8W1qQNc1bOWF6AbhCMw/M=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 Content-Type:MIME-Version; b=PQRSC/4LpvxoPxnXIAdPvuWCIiJSzfCNF8M/3wIfVqhK0XvhDjgoLGhCLwxMaACiXT32QX3fXWMIvSYQvuDZ2gmKxXWYJfvZ3QgIIkLC94fRscckwVCZH4Bixjd1ARwggIKJnmOt70Nq00KJWibzohECwALKbXysulkHXypHNdw=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b=nH4oJzDk; arc=fail smtp.client-ip=40.107.8.73

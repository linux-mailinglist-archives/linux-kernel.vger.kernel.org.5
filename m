...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D7D1F778D46
	for <lists+linux-kernel@lfdr.de>; Fri, 11 Aug 2023 13:19:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236228AbjHKLTC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 11 Aug 2023 07:19:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58080 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230418AbjHKLTB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 11 Aug 2023 07:19:01 -0400
Received: from andre.telenet-ops.be (andre.telenet-ops.be [IPv6:2a02:1800:120:4::f00:15])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7C4D6C3
        for <linux-kernel@vger.kernel.org>; Fri, 11 Aug 2023 04:18:59 -0700 (PDT)
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed40:bda3:543d:ae72:2486])
        by andre.telenet-ops.be with bizsmtp
        id YBJw2A00E5E44PL01BJwUy; Fri, 11 Aug 2023 13:18:56 +0200
Received: from rox.of.borg ([192.168.97.57])
        by ramsan.of.borg with esmtp (Exim 4.95)
        (envelope-from <geert@linux-m68k.org>)
        id 1qUQAM-000Fob-HI
        for linux-kernel@vger.kernel.org;
        Fri, 11 Aug 2023 13:18:56 +0200
...
Subject: Build regressions/improvements in v6.5-rc4
Date:   Fri, 11 Aug 2023 13:18:56 +0200
Message-Id: <20230811111856.163569-1-geert@linux-m68k.org>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <CAHk-=wik9NO9Un-OU0rVeo1+dp=6vj=s=K0T=uBVEa+Aqkj66w@mail.gmail.com>
References: <CAHk-=wik9NO9Un-OU0rVeo1+dp=6vj=s=K0T=uBVEa+Aqkj66w@mail.gmail.com>
MIME-Version: 1.0
...
v6.5-rc4[1] compared to v6.4[2].

Summarized:
  - build errors: +6/-4
  - build warnings: +44/-19

JFYI, when comparing v6.5-rc4[1] to v6.5-rc3[3], the summaries are:
  - build errors: +0/-1
  - build warnings: +1/-0
...
[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/5d0c230f1de8c7515b6567d9afba1f196fb4e2f4/ (all 235 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/6995e2de6891c724bfeb2db33d7b87775f913ad1/ (160 out of 235 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/6eaae198076080886b9e7d57f4ae06fa782f90ef/ (all 235 configs)
...
44 warning regressions:
  ...
  + .config: warning: override: reassigning to symbol DEBUG_INFO_BTF: 3677 => 3687, 3680

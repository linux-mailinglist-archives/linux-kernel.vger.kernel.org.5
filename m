Return-Path: <linux-kernel+bounces-164467-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 244B68B7DEA
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 18:58:06 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id C18E1281028
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Apr 2024 16:58:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1467F20013E;
	Tue, 30 Apr 2024 16:51:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="YNF9fMiH"
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.19])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D0EAB1C68BF
	for <linux-kernel@vger.kernel.org>; Tue, 30 Apr 2024 16:51:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.19
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714495914; cv=none; b=YNzjaaHBPGVE8DVy+w2MMXlXihphHYLVQ5lVLhTLtMRYNXMhE3v2n8C80HWEmOP/obrLYVPP7ABMBRfzAiEt8WmHtI5n8yZj8q7rJwqUMBF9dS5qQFQcEFZ+cLfQFEtmFEdblgaNNvvzH2gL2y9YJf8kmzf66IJfEvIRiOwFZRc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714495914; c=relaxed/simple;
	bh=UCKckKaf+DcEOivednlx2AHS0yzAWKTc2jZ4Dmi/hSY=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=WsneJVpn3zaU0i4n3XQxSK/qLWpp2q2rJrcmmnilmpjn2giZ4Ea4HUI/UTlQ3WqOQRl30/3NHL43UeyB9fd5befGgrbPYDTyutJ2DC1KxQK8PjCmRpE+zT407/mxyBZbCTPEZ+t4LvkmL89r1M1bNyfP/zxVLGl0hAav72F4Lr4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=YNF9fMiH; arc=none smtp.client-ip=198.175.65.19
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=UCKckKaf+DcEOivednlx2AHS0yzAWKTc2jZ4Dmi/hSY=;
  b=YNF9fMiHGP0/OIb8qDPpq7PLogP163I2MEzTWA+VrYmEm9z2ekc92Npf
   vu0dz7jfk+u1FBfJSk+KwPP4QwoGEbcKMXBNDZN/WdUQ2XtH0Ldh59HA4
   ofYcELSIv/TWd4/o8GG0g9TCMjFK+dRbdDGBuwxY+nv+Wf3gdIKpSe5/Z
   jR+iyBnSEv3n82U11qQCil/62JPXACf8u7Kl080WDSLwdmmBvjQQ0/NNE
   iI/5Jo7XzdyJ+2kzefYfxRVhHAKueo1VJ4wxBxVEice8EwNk89b1aGQwa
   4JPMhD6injRX3I0FgXDFN/+OHWkrOt69t+oOlJ7AIEjp6BEc3zwur21Mn
   g==;
X-CSE-ConnectionGUID: Z70U7NRhQuiEIsTqVnfTUg==
X-CSE-MsgGUID: 2wsp7dQnTruXeK8SvostuQ==
X-IronPort-AV: E=McAfee;i="6600,9927,11060"; a="10075782"
X-IronPort-AV: E=Sophos;i="6.07,242,1708416000"; 
   d="scan'208";a="10075782"
Received: from fmviesa007.fm.intel.com ([10.60.135.147])
  by orvoesa111.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Apr 2024 09:51:23 -0700
X-CSE-ConnectionGUID: OQ41DDF5QEOY8syVOzhN1w==
X-CSE-MsgGUID: Zrnc/pNZSKqqGlIFzE3Mew==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.07,242,1708416000"; 
   d="scan'208";a="26515493"
...
Subject: [PATCH v5 29/47] perf/x86/intel: Switch to new Intel CPU model defines
Date: Tue, 30 Apr 2024 09:50:42 -0700
Message-ID: <20240430165100.73491-29-tony.luck@intel.com>

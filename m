Return-Path: <linux-kernel+bounces-4442-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 11102817D28
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 23:17:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 2E099B23EC2
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 22:17:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3159B7349B;
	Mon, 18 Dec 2023 22:17:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Pbm154nB"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5B3C95D746
	for <linux-kernel@vger.kernel.org>; Mon, 18 Dec 2023 22:17:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1702937843;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=ldUg8pAgYo3aX7Hruox1NGFG1r2oNkdJGYYX+0qC7TE=;
	b=Pbm154nBu6puoMVBfJgiyfBYtBiyfyeOGgIE/O7NdwqcqvGlN3r68gw2So2ZS8xQ9BhlbU
	NtjBZyjXt2vPbi/EaOk6eWXlTRvQkEkecIBO881eWx34TrDaqMCg/XuKbdt8cQQHGOLe8d
	lNhx9V38w217cAnj4bHamcrJytmnLcA=
Received: from mail-io1-f71.google.com (mail-io1-f71.google.com
 [209.85.166.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-694-JjzqgpdjP5CLcg5wviQzcg-1; Mon, 18 Dec 2023 17:17:21 -0500
X-MC-Unique: JjzqgpdjP5CLcg5wviQzcg-1
Received: by mail-io1-f71.google.com with SMTP id ca18e2360f4ac-7b7ccd6778fso217736339f.3
        for <linux-kernel@vger.kernel.org>; Mon, 18 Dec 2023 14:17:21 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1702937841; x=1703542641;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:subject:cc:to:from:date:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=ldUg8pAgYo3aX7Hruox1NGFG1r2oNkdJGYYX+0qC7TE=;
        b=
X-Gm-Message-State: AOJu0YyR7H1x5Ii9UXaw7Fk9w31v/TVf3WoZZ9xEfn/vP7KydCX07ZGK
	rfP3JVdspP/Rm4ZDinAwFekl0ALI5zCCrXKOv0kxDA7nZl1LnwTM9oj3XxoJxBqCxRnHJ13J9Uk
	jg7faaF/MbDeKlHhmjLM8SR2S
X-Received: by 2002:a05:6602:15d4:b0:7b7:19e3:a63a with SMTP id f20-20020a05660215d400b007b719e3a63amr16595159iow.20.1702937840252;

Return-Path: <linux-kernel+bounces-65952-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D11F855438
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Feb 2024 21:46:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 88039B278C8
	for <lists+linux-kernel@lfdr.de>; Wed, 14 Feb 2024 20:46:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E15CF1420A9;
	Wed, 14 Feb 2024 20:45:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="dWS7Tlj5"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8DCF21420A1
	for <linux-kernel@vger.kernel.org>; Wed, 14 Feb 2024 20:45:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707943512; cv=none; b=sd6W2XXyTpeOH1t9GXJAwcLymrLLHADPRmyUJ+xFhL3Gc/DRtCp5JcbAJCP9ONXLlBvIHfGr689+NqCauBQCI/LdPJv0E0RK2lpXijGXgMmIHRKCo0TuGghIv9ewh7z7YOmsSY9AwKVHICpsiNJooyXffrGRDzIS4uvS4ePquPY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707943512; c=relaxed/simple;
	bh=Ivx6k9RHC7xtfNym2WBe4tYwW7cQHPIIcIfbRJkpcmw=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=hnXWgi463pIarTZMxferUCsWERM9xLgxogsRLlv8BWQBilUPMBJ2w4xd4I0BuN04ZWcG0aBlzXVNIO86OKDbuzDLt9m+tkOEUJfqAE3JqyUuqkmEz34LIbCBAps6FSuzO5mePz5bM3lB0arIV4vwO+cXeRijquEwz7X/q70xGmM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=dWS7Tlj5; arc=none smtp.client-ip=170.10.133.124

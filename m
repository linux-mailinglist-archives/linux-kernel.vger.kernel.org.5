Return-Path: <linux-kernel+bounces-3311-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B137816AC8
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 11:17:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2FC811C22931
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 10:17:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E984E13FFB;
	Mon, 18 Dec 2023 10:17:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ZgjV86i4"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5AB14134DA
	for <linux-kernel@vger.kernel.org>; Mon, 18 Dec 2023 10:17:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1702894657;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=gH0iS7BjEOS5zAUICFnmkcxpbHOvpwgXq3uX0FBf858=;
	b=ZgjV86i4cBbzYNfGt17HK8O/2WQywvAN5b4dSQtbZYqhoMaZFYle7iBy5D1r/g7bnwpbTt
	Vp+y0T8mXJKrp76Ok70WFHxnQixc0IFEYtNpXzdcpM0gnF8VqPB8CKk1bU3ak7YHOi/AOt
	f/lfW8TiWFKzv9k7LcznHLh7gkuL4Pk=
Received: from mail-yb1-f200.google.com (mail-yb1-f200.google.com
 [209.85.219.200]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-655-OU-SKVeCPZCcJyX1B71G-Q-1; Mon, 18 Dec 2023 05:17:34 -0500
X-MC-Unique: OU-SKVeCPZCcJyX1B71G-Q-1
Received: by mail-yb1-f200.google.com with SMTP id 3f1490d57ef6-db402e6f61dso2730544276.3
        for <linux-kernel@vger.kernel.org>; Mon, 18 Dec 2023 02:17:33 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=gH0iS7BjEOS5zAUICFnmkcxpbHOvpwgXq3uX0FBf858=;
        b=
X-Gm-Message-State: AOJu0Yx4mZRlN2g/kEYYB4+igQ0nAoPwwIZGH527xqfeRPvBtUpm36/S
	NMkZH3XwyNCptzpmEKehA6PhXI66+LMQxSHORjq2znUch148ZvGHg87U8S1G2nYLZLKP1esr19Y
	ytz9me1UxMh9GsOWAYgwAHntvSOHxwLSWGRQd7RI1
X-Received: by 2002:a05:6902:2412:b0:dbd:13cc:530a with SMTP id dr18-20020a056902241200b00dbd13cc530amr897287ybb.117.1702894653359;

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4D82375F860
	for <lists+linux-kernel@lfdr.de>; Mon, 24 Jul 2023 15:36:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230027AbjGXNgi (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 24 Jul 2023 09:36:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37348 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231720AbjGXNfz (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 24 Jul 2023 09:35:55 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 74B9C26B0
        for <linux-kernel@vger.kernel.org>; Mon, 24 Jul 2023 06:35:19 -0700 (PDT)
Message-ID: <20230724132046.092912858@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1690205667;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=3wzkXh8ox2g+n/hDGbOA8stcRNol0QfZYe+X2pCSlC0=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1690205667;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=3wzkXh8ox2g+n/hDGbOA8stcRNol0QfZYe+X2pCSlC0=;
        b=DvR9KuVckkU/ThO9AxuF6m01QJ35DpXO02cjkDDZOnpscyq8r1MrcuzDkVPWzxOAvYvLl5
        L3zrLhri3d4o4pCA==
...
Subject: [patch V2 25/58] x86/apic/32: Decrapify the def_bigsmp mechanism
References: <20230724131206.500814398@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Mon, 24 Jul 2023 15:34:27 +0200 (CEST)

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 87AB8762F06
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Jul 2023 10:01:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232709AbjGZIBv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Jul 2023 04:01:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49106 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232461AbjGZIBL (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Jul 2023 04:01:11 -0400
Received: from mail-wm1-x32d.google.com (mail-wm1-x32d.google.com [IPv6:2a00:1450:4864:20::32d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6E2201BDA
        for <linux-kernel@vger.kernel.org>; Wed, 26 Jul 2023 00:53:06 -0700 (PDT)
Received: by mail-wm1-x32d.google.com with SMTP id 5b1f17b1804b1-3fd2f298712so31991835e9.2
        for <linux-kernel@vger.kernel.org>; Wed, 26 Jul 2023 00:53:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1690357985; x=1690962785;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Cj8cY1SI1enyH/g9otbhsUZx/MkOGaJGyjEXyWXo9z8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1690357985; x=1690962785;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Cj8cY1SI1enyH/g9otbhsUZx/MkOGaJGyjEXyWXo9z8=;
        b=
X-Gm-Message-State: ABy/qLZ1K2CKSPp4Y0bffIGiAwNMwUvpWxvIHff/Hxj9lAGf3bh+TRNK
        i3HmGkjtTnxyMYgPkzrsrWgZAA==
X-Google-Smtp-Source: APBJJlHtGjqyl3Xln3V8+PwWIwd2VfTzVDYe2q/Ua1Q7z75g4h5iGTPMNpMoSGYsLACUlqGASxmF2Q==
X-Received: by 2002:a05:600c:291:b0:3fb:ef86:e30 with SMTP id 17-20020a05600c029100b003fbef860e30mr681257wmk.10.1690357984650;
        Wed, 26 Jul 2023 00:53:04 -0700 (PDT)
Received: from 1.. ([79.115.63.48])
        by smtp.gmail.com with ESMTPSA id h14-20020a05600c260e00b003fbca942499sm1264346wma.14.2023.07.26.00.53.03
...
Message-Id: <20230726075257.12985-2-tudor.ambarus@linaro.org>

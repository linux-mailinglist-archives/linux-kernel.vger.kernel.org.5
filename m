...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5FC0977F2FB
	for <lists+linux-kernel@lfdr.de>; Thu, 17 Aug 2023 11:15:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1349392AbjHQJOg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 17 Aug 2023 05:14:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60012 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1349400AbjHQJOK (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 17 Aug 2023 05:14:10 -0400
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.153.233])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D76652D4A
        for <linux-kernel@vger.kernel.org>; Thu, 17 Aug 2023 02:14:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1692263644; x=1723799644;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=kJWNRXASirOru3xBnGIGNYJiw/cCo+69YDVan5lCSCQ=;
  b=A32wtU2qW22XFPY1ZERZ/D4skE2HwJV+3nGx520EdM8+loNihq6bJWrI
   Na+gA6YL2gK8Ql3Iz5/SFL6qTtmCqNzmRVrJOq5XAe7b8NuKIoBflJd7n
   xCdypVg+6fK57r/q5q1lnNzFm7sYNLrA7LAhkhIgiuO/RkgJEyIL4MB/G
   cOu8kNdo6iydrYI99wKcw2jpWZ9kQQ6kUskTSQYN44ZZBjMtGbsuWazKl
   12pwEy058uEtn59OoHtLHOpUlYDRyI3mxEzk3/zgIwjNtUiYnlNMN+36a
   X5YFz/pUOpz8m+qG+fm8Wnl9QTaYnMsOwaneDv19CqXbxNjjNn+bdlX8a
   A==;
X-IronPort-AV: E=Sophos;i="6.01,179,1684825200"; 
   d="scan'208";a="230284178"
X-Amp-Result: SKIPPED(no attachment in message)
Received: from unknown (HELO email.microchip.com) ([170.129.1.10])
  by esa5.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 17 Aug 2023 02:14:04 -0700
...
Subject: [PATCH v3 4/8] drm: atmel-hlcdc: Define SAM9X7 SoC XLCDC specific registers

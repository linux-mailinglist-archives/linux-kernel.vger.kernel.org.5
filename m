Return-Path: <linux-kernel+bounces-54046-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 1267284A9A6
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 23:57:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id BDBCD28E9F0
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Feb 2024 22:57:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5690A487BF;
	Mon,  5 Feb 2024 22:57:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="Tws+B1x0"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E4C844879D
	for <linux-kernel@vger.kernel.org>; Mon,  5 Feb 2024 22:57:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707173860; cv=none; b=VDwo04nQQt5q2BbUWs4A/WfNTkQM1kjKbmExgjHcUkZJ+cELgKoQ2T3zjQeEk6m7tBUwLKtxR+5ifmwKR4RpyQvdocPtGReN52qtEPAa44uyX1X0bT5l/fHhf27QjHfv7K4zC4wkQtxRuCSIttxQXHGLdvhinNALi2Z0CU1BoHw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707173860; c=relaxed/simple;
	bh=bXnYZQcrxZmTRPJkqwBciYDzSifGOcq4B8YAPUCoJYc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=b2D6Wz5s/H2fGywe6W9caZAfeXhkAHFlJTI1kaH88X0qI4gqXstSx3hMGOW/34iB3iHzCiFL11YB+PTupwgxQI8kICWqKysGb1TG/2YkEgI1jKoTbxII/2H4PUld1+/HG66nGmHj8RbRt68Tu7W42SpRaK2FA6OKZTV6JfHgTNc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=Tws+B1x0; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1707173856;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=MytHiOAGt39No+tBkso3SKMj9ST88QNnSyvPj08v1Cw=;
	b=Tws+B1x06LwD+Ic8K84LIDNMvvVKjHAstgDfAO/IX1nuM2jbTDLtGNfzGxKtwNIWpiap+4
	axIv6kcuOfctiQ2jQP/PiN5NbiXXpO5DYeG2SOLjlec8POlIftdtorED0RSvBqw4yVwUM2
	bBknW/Ffz3chIDHPcmiSGL11R58A9q8=

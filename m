Return-Path: <linux-kernel+bounces-3866-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 79B41817453
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 15:55:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 239BA28458B
	for <lists+linux-kernel@lfdr.de>; Mon, 18 Dec 2023 14:55:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D81723787E;
	Mon, 18 Dec 2023 14:55:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="TxA+Lcxz"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8CCDF101DB
	for <linux-kernel@vger.kernel.org>; Mon, 18 Dec 2023 14:55:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702911330; x=1734447330;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=PFZUAqqFldbFKyAdpyd8Ov4GX5ijOnxeOIa3fnQ5rp8=;
  b=TxA+LcxzZ10Q5ggYUR/sUWd2syComSs3m0SxTickcCopfZQLZse2PU1r
   qroYpNMghaItr7eQvpWAobgE7kiS2tVQDb3jRSXXnKk6zBtwsNQz9HbXW
   Dh5P1fehs5vCngBKkIe1J7P0sx75J/ycnRhIiV2ZSiJtBE0TPke17Kv6x
   yNZqrjYnYWgY4c7/pZ1P2Co1sJbMnQJ9ywldmDsqwiFmLrOqs8v/jmoj4
   3bPCpr591Ut6FXGKST2Nhy1hxoYjb1jrb0Z/RugBJq+/n65tZVyRV+3pD
   em0xRxbzX9yjkl48MvAxKhSkTOtuIqTDqY//cTOJjC2fo74Qj0WbyRkBB
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="399347449"
X-IronPort-AV: E=Sophos;i="6.04,285,1695711600"; 
   d="scan'208";a="399347449"
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Dec 2023 06:55:30 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10928"; a="768869223"
X-IronPort-AV: E=Sophos;i="6.04,285,1695711600"; 
   d="scan'208";a="768869223"
Received: from lkp-server02.sh.intel.com (HELO b07ab15da5fe) ([10.239.97.151])
  by orsmga007.jf.intel.com with ESMTP; 18 Dec 2023 06:55:28 -0800
Received: from kbuild by b07ab15da5fe with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1rFF1h-0004DJ-2L;
	Mon, 18 Dec 2023 14:55:25 +0000
Date: Mon, 18 Dec 2023 22:55:12 +0800
From: kernel test robot <lkp@intel.com>
To: Baoquan He <bhe@redhat.com>
Cc: oe-kbuild-all@lists.linux.dev, linux-kernel@vger.kernel.org,
	Andrew Morton <akpm@linux-foundation.org>,
	Linux Memory Management List <linux-mm@kvack.org>
Subject: arch/sh/kernel/relocate_kernel.S:38: Error: invalid operands for
 opcode
Message-ID: <202312182200.Ka7MzifQ-lkp@intel.com>
Precedence: bulk

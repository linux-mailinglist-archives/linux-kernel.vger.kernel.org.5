Return-Path: <linux-kernel+bounces-74365-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8974D85D31A
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 10:11:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 3846E28125F
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 09:11:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B471F47F6B;
	Wed, 21 Feb 2024 09:06:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="t5FfMKHA";
	dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b="I2lWB5O8"
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3DBEA3CF7C
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 09:06:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=193.142.43.55
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708506386; cv=none; b=I5g2Ru8xS2LCpxQLHqpn11UfpJfs4H0vd2G8nTi6+5dg9TKy6cY/Z0v9hV/t6mh/hjYo+t7IVwsaGPm8a+UVsl2eKJeo8fhaRbnWSDXkjfJVK00Q/hCqKWGgFrBQL3A2bJpYzUYTy3dmnA0x0+2vdXHx3aitufIhdQE0VY92c98=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708506386; c=relaxed/simple;
	bh=5J7zUY2aOAQ1QUycFDuGQIEAgCXCUDLUqfAeF5vZUAo=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=m6yZ2sMSozqTJYAUEbEQeWeOBI9ppPaWNuMFsjKzllgSv23RMw9D/cRdOyRHFMCu8XQTKFeenX+B0hkMGdFM9avy07+KoCHPkbLzXTaJOOsGrYUzD74QeHXDmDv1yDAzzNPGOElNVTkLt8hlkq4Hsb0YOGlKlLuEsGuo0vUrlcs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linutronix.de; spf=pass smtp.mailfrom=linutronix.de; dkim=pass (2048-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=t5FfMKHA; dkim=permerror (0-bit key) header.d=linutronix.de header.i=@linutronix.de header.b=I2lWB5O8; arc=none smtp.client-ip=193.142.43.55
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
	...
	bh=jfuPUgUV3mra9xtSojeJst/48ODepDXAMWIY43hz8AY=;
	b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
	...
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 ...
	 in-reply-to:in-reply-to:references:references;
	bh=jfuPUgUV3mra9xtSojeJst/48ODepDXAMWIY43hz8AY=;
	b=I2lWB5O8R0zGUKqR8qLEP443HYtiR2NZhMB7tX9QtS1DI+HSjF/k10QhExT8HD/JgtoYe6
	nbDO1pQ3PoYMD4Ag==
...
Subject: [PATCH v11 18/20] timers: Implement the hierarchical pull model
Date: Wed, 21 Feb 2024 10:05:46 +0100
Message-Id: <20240221090548.36600-19-anna-maria@linutronix.de>
...
index 000000000000..9d6d5e5def5b
--- /dev/null

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5F4C17EA4D5
	for <lists+linux-kernel@lfdr.de>; Mon, 13 Nov 2023 21:32:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229940AbjKMUcK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 13 Nov 2023 15:32:10 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50468 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229974AbjKMUcI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 13 Nov 2023 15:32:08 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 75B941B2
        for <linux-kernel@vger.kernel.org>; Mon, 13 Nov 2023 12:32:05 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=g6Ooo4Bi3J0g3yK7weQ3mI2UuJsyHkXtzjKz79kSxBvxlTry8wEL5HNp
   ...
   xOQgotcfjP1FHz/1dscZUjoLp7jKF1iimVGkU3Q98/zQl+sfFSO5BuEQW
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10893"; a="476724211"
X-IronPort-AV: E=Sophos;i="6.03,299,1694761200"; 
   d="scan'208";a="476724211"
Received: from fmviesa002.fm.intel.com ([10.60.135.142])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Nov 2023 12:32:05 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.03,299,1694761200"; 
   d="scan'208";a="5779285"
Received: from fmsmsx601.amr.corp.intel.com ([10.18.126.81])
  by fmviesa002.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 13 Nov 2023 12:32:05 -0800
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MN0PR11MB6059.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(376002)(396003)(366004)(136003)(346002)(39860400002)(230173577357003)(230273577357003)(230922051799003)(64100799003)(186009)(1800799009)(451199024)(66476007)(66946007)(66556008)(6916009)(316002)(38100700002)(26005)(86362001)(82960400001)(36756003)(6512007)(83380400001)(66574015)(6666004)(2616005)(6506007)(2906002)(478600001)(6486002)(5660300002)(7416002)(41300700001)(4326008)(44832011)(8676002)(8936002);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 13 Nov 2023 20:32:01.8855
 (UTC)

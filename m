...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E555B80AAE1
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Dec 2023 18:37:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232481AbjLHRgz (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Dec 2023 12:36:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44374 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229872AbjLHRgw (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Dec 2023 12:36:52 -0500
Received: from mail-oi1-x236.google.com (mail-oi1-x236.google.com [IPv6:2607:f8b0:4864:20::236])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 24292D54
        for <linux-kernel@vger.kernel.org>; Fri,  8 Dec 2023 09:36:59 -0800 (PST)
Received: by mail-oi1-x236.google.com with SMTP id 5614622812f47-3b9d8bfe845so1724046b6e.0
        for <linux-kernel@vger.kernel.org>; Fri, 08 Dec 2023 09:36:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=broadcom.com; s=google; t=1702057018; x=1702661818; darn=vger.kernel.org;
        h=in-reply-to:autocrypt:from:references:cc:to:subject:user-agent
         :mime-version:date:message-id:from:to:cc:subject:date:message-id
         :reply-to;
        bh=KpSS/y9l0VtS3avhlP1m+euJwylt4Rro0efO1k7nxdk=;
        b=EJRavbnqaaCgCivGQ+o8x+o/LpDH79KdQsUSIrJ+uI9DpqPSMtw+WhruaEMaRt9r+E
         6Q0jvxP1WnUfyuWAueFWThdMgDrhr+nkHxfUB6zS67z6X+mivjGxyDMhe1tP00z9FA3Y
         6O/PU4QaG5YcJxRRjvJJH+naSmrkAVJCxrpv8=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=KpSS/y9l0VtS3avhlP1m+euJwylt4Rro0efO1k7nxdk=;
        b=
X-Gm-Message-State: AOJu0YzzCQ7W9qfO3baBH7wj3ls8jInZO9AAhZ+IRdDVLcEiRdBD04P4
        KGLv1xmaR2oQej/Uqe59yV3WkQ==
...
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256;
        boundary="000000000000fc0201060c030720"

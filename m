Return-Path: <linux-kernel+bounces-20081-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id DD212827910
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Jan 2024 21:18:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 64B561F237D1
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Jan 2024 20:18:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CE34956B60;
	Mon,  8 Jan 2024 20:16:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amarulasolutions.com header.i=@amarulasolutions.com header.b="eg1wMDIe"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-ed1-f47.google.com (mail-ed1-f47.google.com [209.85.208.47])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 67F8756478
	for <linux-kernel@vger.kernel.org>; Mon,  8 Jan 2024 20:16:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=amarulasolutions.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=amarulasolutions.com
Received: by mail-ed1-f47.google.com with SMTP id 4fb4d7f45d1cf-555144cd330so2730142a12.2
        for <linux-kernel@vger.kernel.org>; Mon, 08 Jan 2024 12:16:34 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=amarulasolutions.com; s=google; t=1704744992; x=1705349792; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=wxbOc7HJLOzNjFhJ551uGCOZx0SfDNxkC+4qlsfj2LA=;
        b=eg1wMDIeK0586EhNHzQw228wVWwOSWrWR9WF/XVZE/mkjXD47flQDPvNX/wMamSYt3
         Z+aJSgoEEHgtIcoMe/HdBqS4CK66Lg+cOqfsR8CEcX26f/OlA61IjUFSrrnnfgcH+Oqi
         jsczIBZ69AP6djD6pfq1XoKAZpeD9Wrw4vsts=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=wxbOc7HJLOzNjFhJ551uGCOZx0SfDNxkC+4qlsfj2LA=;
        b=
X-Gm-Message-State: AOJu0YzPSE1nLR/SJhkFlchVsSauodrGQIFP4PWA+pgoWKFR5q0SNevF
	fygsmzZNJWv0zag3lSwYVDF0zKJSnpQNbWuIr2586hlzcm4=
X-Google-Smtp-Source: AGHT+IF97UfMF94TfUU0ZB+XVSP7K/1EYROwDALl+rfg46gF8NMz3brwGIPwLoEwAK0uKnQw23fZQg==
X-Received: by 2002:a50:d788:0:b0:557:17c4:6747 with SMTP id w8-20020a50d788000000b0055717c46747mr2104243edi.56.1704744992591;
...
Received: from dario-ThinkPad-T14s-Gen-2i.homenet.telecomitalia.it (host-87-2-38-81.retail.telecomitalia.it. [87.2.38.81])
        by smtp.gmail.com with ESMTPSA id by26-20020a0564021b1a00b00555fd008741sm173699edb.95.2024.01.08.12.16.30
...
Subject: [PATCH v5 7/8] drm/panel: nt35510: move hardwired parameters to configuration

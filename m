Return-Path: <linux-kernel+bounces-93688-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 561BA873358
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 11:00:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id A2FEAB25FF0
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 09:59:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 64D075F554;
	Wed,  6 Mar 2024 09:59:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="R5y+M/NN"
Received: from mail-pg1-f171.google.com (mail-pg1-f171.google.com [209.85.215.171])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6D99C5F543
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 09:59:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.215.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709719166; cv=none; b=ZjnRnkxNSAIY9YmAlopte41VHFBhXxos6kW3HE0Q0yE9KQjBf7DwXH8dttfxEQx+VH7iXDZitAK2YHDQN+P+a6L4i0T3Ti9JJNCztO1SZOBfjt90ZYxDyIPsr7KpHLqhYP/WnZwQZqbZNWSw8qd2TUBM71M+6JKZSIhMfcYNvJ8=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=R5y+M/NN; arc=none smtp.client-ip=209.85.215.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pg1-f171.google.com with SMTP id 41be03b00d2f7-5ce9555d42eso5700231a12.2
        for <linux-kernel@vger.kernel.org>; Wed, 06 Mar 2024 01:59:23 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         ...
         :reply-to;
        bh=AEi1Mb5V0I2YDh0yKJcX6D2UIVEJm/Y+pHd4v7WChg0=;
        b=
X-Gm-Message-State: AOJu0Yx8/IC7Fc4vfnI3SePnEGGT8kznQhNris6FKtjhIQxM4Xn8JBHE
	LfBnTshuTTZLAGu1R/UQpsqvIHVCmHNB9dtoRKIlY7R3mCkeNiaRl3Rw3EFrLelrS5aY6qPQLsf
	Z3Mj2BcaVo7DaWtSbVni5MikOz1naJUEgcRFeBA==

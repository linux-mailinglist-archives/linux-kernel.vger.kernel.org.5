...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D77E37BDD0C
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Oct 2023 15:03:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376637AbjJINDa (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 Oct 2023 09:03:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53712 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1376645AbjJINDU (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Oct 2023 09:03:20 -0400
Received: from mail.loongson.cn (mail.loongson.cn [114.242.206.163])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id CFF0A91
        for <linux-kernel@vger.kernel.org>; Mon,  9 Oct 2023 06:03:16 -0700 (PDT)
Received: from loongson.cn (unknown [113.200.148.30])
        by gateway (Coremail) with SMTP id _____8Bx5fAT+iNlIk4wAA--.27782S3;
        Mon, 09 Oct 2023 21:03:15 +0800 (CST)
Received: from linux.localdomain (unknown [113.200.148.30])
        by localhost.localdomain (Coremail) with SMTP id AQAAf8Cxzt4P+iNlksscAA--.62948S4;
        Mon, 09 Oct 2023 21:03:14 +0800 (CST)
...
Subject: [PATCH v2 2/8] objtool/LoongArch: Implement instruction decoder
Date:   Mon,  9 Oct 2023 21:03:04 +0800
Message-Id: <1696856590-30298-3-git-send-email-yangtiezhu@loongson.cn>
...
X-CM-TRANSID: AQAAf8Cxzt4P+iNlksscAA--.62948S4
X-CM-SenderInfo: p1dqw3xlh2x3gn0dqz5rrqw2lrqou0/
X-Coremail-Antispam: 1Uk129KBj9fXoWfJFykXw18AF1kGw1fCry3GFX_yoW8JFy8Co
        W8ta4DKw1rJrWUua1UJrn7JF47Zr1I9rW5A34SvrsYyF45Zw15WrZrCw43W3Wa9w48JrZr
...
---
 ...
 tools/objtool/arch/loongarch/decode.c   | 251 +++++++++++++++++++++++++++++++-
...
+#include <asm/inst.h>
 ...
 {
@@ -39,21 +41,266 @@ int arch_decode_hint_reg(u8 sp_reg, int *base)
 	return 0;
 }

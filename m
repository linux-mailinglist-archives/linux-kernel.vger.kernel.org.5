Return-Path: <linux-kernel+bounces-32431-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 15FD7835BBE
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 08:36:51 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 373E11C217BB
	for <lists+linux-kernel@lfdr.de>; Mon, 22 Jan 2024 07:36:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DF38A1BC49;
	Mon, 22 Jan 2024 07:36:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="FyDO6tXB"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CD58F18C38
	for <linux-kernel@vger.kernel.org>; Mon, 22 Jan 2024 07:36:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705908984; cv=none; b=UOwc5KQcqdrBMOQSWqHYtk7m3yfFOt1AERkBleED5PgGUyuzdCcwInkVYAPQKI9IbjHPmqccmw2KbzxgZYbaXNZon1baU5Ai974UvJUpj2oS2HGrCD1vM/ucEdrAZPNyJ40TnQ6rhNNXYP03cVDom211tQWcFQkHoFL5uvHt7aE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705908984; c=relaxed/simple;
	bh=Llzbm9oUkBIrng0jHN+0KXkIbMGgbqqoOcPr8oYO5Og=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=OIfkZM95/6BbQSIlR26BVxwpFE7XHUpqyQOhJsaBiQjeu4yDadLKfzWLK0UecUqHnioOEFvMyZhUmewe7+q4b6DhzRIRaFSfc/hccfrIItidFSq+zE/2Cu3+V46c+YBopO9LXf8DFGt+OV86N0COAZGt/1Bfl8Mgc4SEkxfFiVE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=FyDO6tXB; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1705908981;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=q7h2DVEhrlBFS3xqWaYiNz0NtwDtYA/pt6g+Gnzcrd4=;
	b=FyDO6tXB2JbgU831isYJreUgYBA7TaAuhFGwEXOFmH37yYac0ZM76OLGJcHU0vo7vLtfEs
	PYernhgWyBTmiYtLlL5ic38zTYU6chQd95drJ8yRIJaX7CGOKsYgRVda/3fyIQ+WrZpWOf
	xLMaKwu+8rUlNXbxnar/XPGs530WCyo=
Received: from mail-pg1-f200.google.com (mail-pg1-f200.google.com
 [209.85.215.200]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-189-ES3lxi4zOHq7g2VjVz37gA-1; Mon, 22 Jan 2024 02:36:20 -0500
X-MC-Unique: ES3lxi4zOHq7g2VjVz37gA-1
Received: by mail-pg1-f200.google.com with SMTP id 41be03b00d2f7-5c659339436so860134a12.2
        for <linux-kernel@vger.kernel.org>; Sun, 21 Jan 2024 23:36:20 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=q7h2DVEhrlBFS3xqWaYiNz0NtwDtYA/pt6g+Gnzcrd4=;
        b=
X-Gm-Message-State: AOJu0Yw+dy1Jm7UZNuBFrAisb3vJjimv/wLyVpcMdsvngY/flcNcWaOS
	7g7PRw9u9+EaLed6q6HrFe+GVj0SyE2XdElimYFcnpLjSP9zvx4x5z+YPunxfAXSESHNWzKbvj3
	z7WrTg5YnBF33HnUQ1AKXpcZ9AL4+d4mHElq7KHtr8y7vRDBnyW3HWNw0GaEuLg==
X-Received: by 2002:a17:90a:b903:b0:28e:88d9:c314 with SMTP id p3-20020a17090ab90300b0028e88d9c314mr1170546pjr.11.1705908672214;

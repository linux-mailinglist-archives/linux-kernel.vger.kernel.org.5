Return-Path: <linux-kernel+bounces-112473-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 58677887A46
	for <lists+linux-kernel@lfdr.de>; Sat, 23 Mar 2024 21:21:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id C7E2C1F21857
	for <lists+linux-kernel@lfdr.de>; Sat, 23 Mar 2024 20:21:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6F0E559B48;
	Sat, 23 Mar 2024 20:21:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="rxTaa99U"
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2078.outbound.protection.outlook.com [40.107.244.78])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 948584D9ED
	for <linux-kernel@vger.kernel.org>; Sat, 23 Mar 2024 20:21:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.244.78
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711225303; cv=fail; b=TDBY9qLxYfB5KPWIvEWaDUHRbgvxPCaB6V+5lW7sVH85q0sd+DteMqPZoJhQrzgg/pXJNCBzcwup9c/gg4oHfwoA0FDtB2g2gwtHdw9KCuHdRjF553Y75TnE0VSX45uvwT7+5khJ1EsNN+3oEycloQg9D6g/FLlJFM1KRoFb0MQ=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711225303; c=relaxed/simple;
	bh=6osULCkSogGc9lZ/YRxEN1glpF5uQkvA5FIjRHowWqw=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=ihem3NViOaVySdP+8P/dA1P2YMcwTHFcLRDoYFizLz7h5p1JnO8HmpYGLNwBCnsGvTcjxlqiIuNlHHqUP3d2k5ePAGb0dEehqqFr7gxg3jDPOjfLao2LzamB9zFNCiYivv/ZnBVgkFDF6iRdHC1oobXM2NI2HJBG/BSfI0kJu2U=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=rxTaa99U; arc=fail smtp.client-ip=40.107.244.78
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 23 Mar 2024 20:21:37.2873
 (UTC)

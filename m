Return-Path: <linux-kernel+bounces-36349-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 968D4839F8D
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 03:52:51 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id BC8F01C225F1
	for <lists+linux-kernel@lfdr.de>; Wed, 24 Jan 2024 02:52:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 147386FDD;
	Wed, 24 Jan 2024 02:43:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="cIK+L+HO"
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (mail-bn8nam12on2079.outbound.protection.outlook.com [40.107.237.79])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E86108C1C
	for <linux-kernel@vger.kernel.org>; Wed, 24 Jan 2024 02:43:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.237.79
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706064229; cv=fail; b=iybmFNfDxARgA0Ee1BHklTiR86BOgeZxg9jWL+eS7oaIrmgqH8d6RcgVg678SwqLF2pQBdJ4hyK+nqw72F60ReMweZNvAvG1jhHS95t8ZmBhG98EcXnQk9TR9vYmcHcv0PVYF30yeX087Qe7bQ0IKGbRb1yiqd+WewREnYAMnlE=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706064229; c=relaxed/simple;
	bh=pfN9/vgV7TpOm6WeAwpQM22PfTwpYGyFUGBN0F1+K7A=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=Uf98R1faQb/2X7GQ+AEtCL4K7C7XJp0edEVrKWEzhXjcrn35OvjQpuQXXyT+XDuC48I4eeLOmqlZa+w8R8UgaVdZBdx/6T3lwMEgPTLvQ7ti5HNAUuWWAUz+F4m34EE8XpJw14DLbNww4MxrI6FOzj/nKoxO+ua7c11QOZP0zEY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=cIK+L+HO; arc=fail smtp.client-ip=40.107.237.79
...
msip_labels:
 MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ActionId=0f91d601-e5ad-4120-a167-9f3505ce0489;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ContentBits=0;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Enabled=true;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Method=Standard;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Name=General;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SetDate=2024-01-24T02:32:28Z;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SiteId=3dd8961f-e488-4e60-8e11-a82d994e183d;
...
x-microsoft-antispam-message-info:
 
x-forefront-antispam-report:
 CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MN2PR12MB4302.namprd12.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(346002)(39860400002)(376002)(136003)(396003)(366004)(230922051799003)(1800799012)(451199024)(64100799003)(186009)(26005)(7416002)(122000001)(38070700009)(6506007)(7696005)(71200400001)(33656002)(41300700001)(9686003)(110136005)(54906003)(66556008)(76116006)(66446008)(64756008)(316002)(66946007)(5660300002)(30864003)(7406005)(8936002)(4326008)(8676002)(52536014)(478600001)(38100700002)(2906002)(86362001)(66476007)(83380400001)(55016003);DIR:OUT;SFP:1101;
x-ms-exchange-antispam-messagedata-chunkcount: 1
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?MWRUeDdVdlpUS3JySzJRZDltMGRHUEw5TnhSeWF1TFF3N3hoUXIrdFRXbnIz?=
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 24 Jan 2024 02:43:40.6212
 (UTC)

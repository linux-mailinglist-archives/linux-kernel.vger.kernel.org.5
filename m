Return-Path: <linux-kernel+bounces-95420-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 31449874D6F
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 12:32:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4D7111C21232
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 11:32:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B58D01292D0;
	Thu,  7 Mar 2024 11:32:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="FCieMp4S"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 87EA95FDD5
	for <linux-kernel@vger.kernel.org>; Thu,  7 Mar 2024 11:32:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709811125; cv=none; b=sAAKEnw1Dcq7MaVuB8XhluiclRvTNM50txUgWBuFagNNf5ORiouhwX/ZXCLWTv06RwG4gxEglmx5qqXcJd4ChCEXwv26Ghcbas0T56ryThPsudqgUXnGqeEvsyU3F+rX5+SjltMZbEIR9DHPbtO3KzAS0HFrmYGNafcuNH/NoXE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709811125; c=relaxed/simple;
	bh=i+lRq7pPRKWi3GogKlJEoYaNA7ztKiSnSWKlfNCRURY=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=OQoaDyLhUssYVkB7ikWu1XYSlh+50a969vpeFJ6Y3YW8EysSwOdXgF+eDufGwce5cU8++z+dpr15nkBechT9EzHJ37wWmjEgM7R8rpwIBUeQxHqgvEGVwX1MDXcj/Yv+zm4G/n21ZuTW/4v0XZ6ebRcWRksWgh3YHZYNLj1h8sk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=FCieMp4S; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709811122;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=14trI9ZLXeyf7QgR3TD5Ui/4tO+KAyu+0W5mZgTts0o=;
	b=FCieMp4SgJ1fOY7XxA44camPYBKErER+KnNQfdoorl2HUeA7zrMsxg1mKvkLrrJIa+UMgP
	lJEtkuh04N26I+SqDPFUZst909F8Tg4nUoVIT5BTe6MB34t4wY5ZqSvhLSzmclVvgvNqBr
	464ilLnvQx6GfVDwQ7Mgbo/nMhjSUbE=
Received: from mail-lj1-f200.google.com (mail-lj1-f200.google.com
 [209.85.208.200]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-323-pQQIuHE0ORetprQ_crZtfg-1; Thu, 07 Mar 2024 06:32:00 -0500
X-MC-Unique: pQQIuHE0ORetprQ_crZtfg-1
Received: by mail-lj1-f200.google.com with SMTP id 38308e7fff4ca-2d30bed153fso6141411fa.3
        for <linux-kernel@vger.kernel.org>; Thu, 07 Mar 2024 03:32:00 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1709811119; x=1710415919;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=14trI9ZLXeyf7QgR3TD5Ui/4tO+KAyu+0W5mZgTts0o=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUok+Z5U6lLy738XrIA7fK8Kr8iKTLRHnrWB30Gdg1vEpaRjBGtaOJU3Y4bf9Sutypfrl0+URLRuVDcxBFhBzN4ybRIyYcmfZHjP9QO
X-Gm-Message-State: AOJu0Yxrkam1DB3Tq9oC86FRq4I8rsvVXKbidYfz63s2Iq+FEruKZbmf
	dkGlK5JOCcb42CinSpqn7AgjOaiYWApVqkEJ86QhlZhL6BRWXtNfUZkdkrqB8W9MV2YPOobviao
	zUufShuAV+PdCcfQAzykF/Xhuv0uLkRrQEDP7i+Y4uc+X0RZ87z3JfiFpTYS+ww==
X-Received: by 2002:a19:e007:0:b0:513:3db6:43f6 with SMTP id x7-20020a19e007000000b005133db643f6mr1225831lfg.50.1709811119231;
        Thu, 07 Mar 2024 03:31:59 -0800 (PST)
X-Google-Smtp-Source: AGHT+IEvuh0Qd73+D2LXNPcnRztyg0Cl0rRyaTLipcVEcdm0OpNpkaiN9xJkY0CG2iIl0eQxW8WmHw==
X-Received: by 2002:a19:e007:0:b0:513:3db6:43f6 with SMTP id x7-20020a19e007000000b005133db643f6mr1225805lfg.50.1709811118748;
        Thu, 07 Mar 2024 03:31:58 -0800 (PST)
Received: from ?IPV6:2003:cb:c74d:6400:4867:4ed0:9726:a0c9? (p200300cbc74d640048674ed09726a0c9.dip0.t-ipconnect.de. [2003:cb:c74d:6400:4867:4ed0:9726:a0c9])
        by smtp.gmail.com with ESMTPSA id n9-20020a05600c3b8900b0041310142e37sm1894088wms.47.2024.03.07.03.31.57
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 07 Mar 2024 03:31:58 -0800 (PST)
Message-ID: <a07deb2c-49e1-4324-8e70-e897605faa9d@redhat.com>

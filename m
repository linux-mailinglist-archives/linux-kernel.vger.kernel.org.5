Return-Path: <linux-kernel+bounces-141345-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 12ECC8A1CE5
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 19:59:34 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 7F9331F22DF3
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Apr 2024 17:59:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 49C3E1BF6D7;
	Thu, 11 Apr 2024 16:45:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="bs/zDxaJ"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DC7E31401B
	for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 16:45:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712853903; cv=none; b=eEoXW7OgxxE9AQyOqYWX1Nc0z7d0vFwsy6GwTHyUNSGj4Jvms0Jf3D8ohyhUnm96ab3uFseZlFMZf7Q4FPuJFoyW0PJhmi1/0H37NwWZ4o6PndWe5jTuPhSTtrK4inxRsX6eeTymmkTTwl4HA8SvAm5RhUEj/eoZcgstVyHliuM=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=bs/zDxaJ; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1712853900;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=94L/JCISmahgDBDl2sXYWYZZ3cyyrK3rK/U7jZZ3W+E=;
	b=bs/zDxaJmTotDk+U5u/VA3X3yaEsu298e5k6BJ2oQqhSKH0X7/D9VPou6MC/qGwHO2vIn+
	vAoF7p7Fhw1qnYxIrDrYAtu1VfO6bdZuhuaOTzqzSLLtKq9Lvf27itlGmFKyzfZJ9ic5W2
	tLxJnySzt/roa0BBgcyR326hebtSdPg=
Received: from mail-vk1-f200.google.com (mail-vk1-f200.google.com
 [209.85.221.200]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-170-9leoPhofP4GHZeM4nCp5HQ-1; Thu, 11 Apr 2024 12:44:58 -0400
X-MC-Unique: 9leoPhofP4GHZeM4nCp5HQ-1
Received: by mail-vk1-f200.google.com with SMTP id 71dfb90a1353d-4dad4785131so53e0c.2
        for <linux-kernel@vger.kernel.org>; Thu, 11 Apr 2024 09:44:58 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=94L/JCISmahgDBDl2sXYWYZZ3cyyrK3rK/U7jZZ3W+E=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVrAZQKXv+eyUaSCqXthyknexoybt/SkSTgVf3G3pb84tx5BjotrfnCyv5EOZP8W9wJOsiBYZqkLrIkIbO2mk5iXI+2JvKfXAxCnSve
X-Gm-Message-State: AOJu0YyAlXFo1gfqASf6MfsANYGgkJTbp9Kt8pTQXGEquaZ3Cnu8UsQV
	Zu7lLpOPK1OGhQTkvIl1ZXeeMDtGERFFL5iAQ68ppFvqiOOxQiXFGtvmrxyjPpoTFUWuBdmJRis
	0ugYsqHuhjEc7tp92WsmkepuNvIVXbQTfVGYxPa8gJBhST0onshtEIhcvzS0YZhY8RGWfXj+5u0
	+g6TMieRNpmNuOvTuNykU4IkkXAKzzQTyJdqjuV1Qxdq2j/dk=
X-Received: by 2002:a05:6122:54b:b0:4d3:45a2:ae53 with SMTP id y11-20020a056122054b00b004d345a2ae53mr347666vko.16.1712853898275;

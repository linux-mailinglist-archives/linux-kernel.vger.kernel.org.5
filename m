...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 67B01758903
	for <lists+linux-kernel@lfdr.de>; Wed, 19 Jul 2023 01:20:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229937AbjGRXUd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 18 Jul 2023 19:20:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41794 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229485AbjGRXUb (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 18 Jul 2023 19:20:31 -0400
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2054.outbound.protection.outlook.com [40.107.244.54])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2CBE0EC
        for <linux-kernel@vger.kernel.org>; Tue, 18 Jul 2023 16:20:27 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=s1VkJnbw9coGFBvQXs4aYoh1T8JiyDyAki7DqkYSGpA=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=s1VkJnbw9coGFBvQXs4aYoh1T8JiyDyAki7DqkYSGpA=;
 b=mBLylR8e21lFR2xY2xb++WCvLRQCt/i/T6Rx/kmuyGQZNfuLZQK0k/FoU9hwX+/IG30AUAFG4k0hReK2JRajZkjgK/CmeJgwdbi59cioKy8DLr4k7oGxTI8KQud4BOkS1TPhVtmpyKBr3UlYIUR4RRuRdk9nF5h5YSP5pmrNsMA=
...
Received: from BN8NAM11FT047.eop-nam11.prod.protection.outlook.com
 (2603:10b6:408:e8:cafe::89) by BN0PR04CA0032.outlook.office365.com
 ...
 Transport; Tue, 18 Jul 2023 23:20:23 +0000
...
Received: from SATLEXMB04.amd.com (165.204.84.17) by
 ...
 15.20.6588.33 via Frontend Transport; Tue, 18 Jul 2023 23:20:23 +0000
...
Message-ID: <20230718231959.3163407-1-john.allen@amd.com>
...
X-MS-TrafficTypeDiagnostic: BN8NAM11FT047:EE_|IA1PR12MB8190:EE_
X-MS-Office365-Filtering-Correlation-Id: 3e5dd4fd-a687-4925-b4dd-08db87e59001
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:165.204.84.17;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:SATLEXMB04.amd.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230028)(4636009)(136003)(396003)(346002)(376002)(39860400002)(82310400008)(451199021)(36840700001)(46966006)(40470700004)(41300700001)(7696005)(8676002)(2906002)(70586007)(8936002)(70206006)(15650500001)(6666004)(54906003)(356005)(86362001)(4326008)(36860700001)(316002)(44832011)(81166007)(47076005)(36756003)(5660300002)(2616005)(30864003)(426003)(16526019)(40460700003)(83380400001)(1076003)(186003)(26005)(336012)(40480700001)(82740400003)(19627235002)(110136005)(478600001)(36900700001);DIR:OUT;SFP:1101;
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Jul 2023 23:20:23.5879
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 3e5dd4fd-a687-4925-b4dd-08db87e59001
...
index e53002fb..bab6cc9a 100644
--- a/WHENCE
+++ b/WHENCE

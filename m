Return-Path: <linux-kernel+bounces-154502-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 543538ADCD5
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Apr 2024 06:28:27 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6E67C1F22E8D
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Apr 2024 04:28:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8CB131F934;
	Tue, 23 Apr 2024 04:26:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="ZvlsPug9"
Received: from mail-yb1-f202.google.com (mail-yb1-f202.google.com [209.85.219.202])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6FFEE29410
	for <linux-kernel@vger.kernel.org>; Tue, 23 Apr 2024 04:26:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.219.202
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713846400; cv=none; b=hpkT9JLnW8pNmB+wemIIkNWeJjmLDelrxOf1DWx8SqLtsKhKMuTcC3KuLCSDuIMsocmjFV2MYDBlOzlHrN2MvxiwjYaAImYBhA00wqJvIqfGD7u7CV0CpSY7oli5+6QA+Z2tKeSpKxBjVhfzFNJh7b06ukZxnTUj0ztivJxNbCk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713846400; c=relaxed/simple;
	bh=yOo1CS5CN209XlMKdRu1mfO6h3mbxFyEZO1U6kbIFxs=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=b9l/XlVfpXNSTiYET9q5ab3am7kLUJIMqGza+l6/BjEO52wGhvgjoaU4tZvL8pQNtP5z9r5EfE8RCEgKeXiYeS+AwihU2aRnPUT3iyLYdn1+4yVNTOJlt3y0CFpFNEw1jVX4C2K0lK1LQJ/Fz6CYM0e8qG0fEAhvaSGim99Ib4E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=ZvlsPug9; arc=none smtp.client-ip=209.85.219.202
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yb1-f202.google.com with SMTP id 3f1490d57ef6-dc647f65573so11061099276.2
        for <linux-kernel@vger.kernel.org>; Mon, 22 Apr 2024 21:26:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1713846391; x=1714451191; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=o54V2qp+S+IaxDvrq9slzRtUV9ap1lHeG7G2xQTl6Xw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1713846391; x=1714451191;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=o54V2qp+S+IaxDvrq9slzRtUV9ap1lHeG7G2xQTl6Xw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWsWvQdlALvE6BybcVHRL9oE8WzkvvGTXGJyK3obmmGMgTGcDewNBew2VNypAEwUhrwqax5F9NqB94FGVibx/LK32sN7Zsw566pq2C0
X-Gm-Message-State: AOJu0YxPN7NWZPwQQjLrq6SWYuFLovXwMasYjHgJWe14BQ2CJVzWndEf
	jTe1F7btxcyILlV+YBtjsNuvg/PuBIkZnNV1bR0NbokHnkR0i68lbZ5/vMYGm7sF/FsY/tnsHEr
	a780rZA==
X-Google-Smtp-Source: AGHT+IEIdI3ydTNNjdsg/00BCY6w7DGwkTeSsjXQW2LTL3WBKnpDd6MDob6Xvufokv741tkyw0onkJBYiLCz
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:4ca4:4d48:a7fe:d70c])
 (user=irogers job=sendgmr) by 2002:a05:6902:1201:b0:de4:c54c:6754 with SMTP
 id s1-20020a056902120100b00de4c54c6754mr3263244ybu.3.1713846391369; Mon, 22
 Apr 2024 21:26:31 -0700 (PDT)
Date: Mon, 22 Apr 2024 21:25:59 -0700
In-Reply-To: <20240423042601.2009469-1-irogers@google.com>
Message-Id: <20240423042601.2009469-6-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v4 5/7] perf dso: Add reference count checking and accessor functions
...
---
 ...
 57 files changed, 1166 insertions(+), 736 deletions(-)

diff --git a/tools/perf/builtin-annotate.c b/tools/perf/builtin-annotate.c
index 6f7104f06c42..51088c6016ad 100644
...
index 12d5faff3b7a..2afb10f3da30 100644
--- a/tools/perf/util/annotate-data.c
+++ b/tools/perf/util/annotate-data.c
@@ -334,7 +334,7 @@ static struct annotated_data_type *dso__findnew_data_type(struct dso *dso,
...
+	node = rb_find(&key, dso__data_types(dso), data_type_cmp);
 	if (node) {
 		...
 		free(type_name);
@@ -355,7 +355,7 @@ static struct annotated_data_type *dso__findnew_data_type(struct dso *dso,
...
@@ -536,7 +536,7 @@ static struct global_var_entry *global_var__find(struct data_loc_info *dloc, u64
...
@@ -567,7 +567,7 @@ static bool global_var__add(struct data_loc_info *dloc, u64 addr,
 	gvar->end = addr + size;
...
@@ -836,7 +836,7 @@ static void update_insn_state_x86(struct type_state *state,
 			return;
...
+		if (dso__kernel(map__dso(dloc->ms->map)) &&
 			...
 			u64 var_addr;
@@ -1323,7 +1323,7 @@ static int check_matching_type(struct type_state *state,
 		return -1;
 	}
...
@@ -1670,7 +1670,7 @@ struct annotated_data_type *find_data_type(struct data_loc_info *dloc)
 	struct dso *dso = map__dso(dloc->ms->map);
 	Dwarf_Die type_die;
...
+	dloc->di = debuginfo__new(dso__long_name(dso));
 	if (dloc->di == NULL) {
 		...
 		return NULL;
@@ -1804,7 +1804,7 @@ static void print_annotated_data_header(struct hist_entry *he, struct evsel *evs
 	}
...
index dca2c08ab8c5..fea02199be99 100644
...
index 92937809be85..0a38de213eb3 100644
...
+	nsinfo__mountns_enter(dso__nsinfo(dso), &nsc);
 	...
 	nsinfo__mountns_exit(&nsc);
 	if (fd < 0)
@@ -1663,13 +1663,13 @@ int symbol__disassemble(struct symbol *sym, struct annotate_args *args)

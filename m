Return-Path: <linux-kernel+bounces-161910-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 430978B532F
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 10:31:27 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id E4479B21F74
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2024 08:31:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 20BAA1863E;
	Mon, 29 Apr 2024 08:31:05 +0000 (UTC)
Received: from baptiste.telenet-ops.be (baptiste.telenet-ops.be [195.130.132.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A64A1179AF
	for <linux-kernel@vger.kernel.org>; Mon, 29 Apr 2024 08:30:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.130.132.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714379457; cv=none; b=lNGcZO9aiGqf6Ehhz2ZZBeTeYZmvPHE1K27LjMzI4EnNGNE0Kbzcz53ZKvmQ9j4FqOPPsvGUTS6T2mQOHFQwcFxX9t+3yQj13/ORnuY8yWvabi61Xmwbi8mJxvhUbINNTTa6F/BJjYqLBnFU5EMOK88LfOtznjkZ8XSxaC1jvig=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714379457; c=relaxed/simple;
	bh=/XKWglUXRs+wgoq/QqX9GRAYW3wv8WGY7iEy4UmkgNo=;
	h=From:To:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=sE+/wXO8y9Dc8XQC6Y6uBk8aUIkhlpEtDpLZEN23sa1wexlwOh0sHzfjN1k6lT95cveVNiUMBQ7S6xVQEdQ7kAB/T8ZXPIKc/JiGXUjr7uv7ZVoKIVtZKh2zPgm93Pmq1j+2pISC1bBWUIH4hSruQAqfm3TmoutyTbk3ZGGRwvQ=
...
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed80:c638:ea8a:e2dc:eb6f])
	...
	id GwWg2C00B0BATYP01wWgqd; Mon, 29 Apr 2024 10:30:40 +0200
Received: from rox.of.borg ([192.168.97.57])
	by ramsan.of.borg with esmtp (Exim 4.95)
	(envelope-from <geert@linux-m68k.org>)
	id 1s1MOa-00GBa5-Q6
	for linux-kernel@vger.kernel.org;
	Mon, 29 Apr 2024 10:30:40 +0200
...
Subject: Build regressions/improvements in v6.9-rc6
Date: Mon, 29 Apr 2024 10:30:40 +0200
Message-Id: <20240429083040.4015092-1-geert@linux-m68k.org>
...
v6.9-rc6[1] compared to v6.8[2].

Summarized:
  - build errors: +14/-8
  - build warnings: +1477/-41

JFYI, when comparing v6.9-rc6[1] to v6.9-rc5[3], the summaries are:
  - build errors: +11/-7
  - build warnings: +1477/-2
...
14 error regressions:
  ...
  + error: arch/sparc/kernel/signal_32.o: relocation truncated to fit: R_SPARC_WDISP22 against `.text':  => (.fixup+0x0), (.fixup+0x18), (.fixup+0x10), (.fixup+0x8), (.fixup+0x20)
  ...
  + {standard input}: Error: displacement to undefined symbol .L96 overflows 12-bit field:  => 852, 943, 775, 696, 916, 791, 739, 716, 800
  + {standard input}: Error: displacement to undefined symbol .L96 overflows 8-bit field :  => 932, 870
  + {standard input}: Error: pcrel too far:  => 925, 557, 804, 843, 909, 806, 593, 550, 856, 559, 679, 568, 575, 779, 765, 858, 833, 595, 933, 720, 566, 828, 706, 577, 877, 878, 920, 586, 827, 584, 888, 884, 700, 548, 927, 844
...
8 error improvements:
  ...
  - {standard input}: Error: branch to a symbol in another ISA mode: 5011, 5016 => 
...
1477 warning regressions:
  ...
  + {standard input}: Warning: overflow in branch to .L103; converted into longer instruction sequence:  => 734

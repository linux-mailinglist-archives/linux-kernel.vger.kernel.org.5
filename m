Return-Path: <linux-kernel+bounces-166314-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C6388B98FE
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 12:39:19 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B4EE1B22DD5
	for <lists+linux-kernel@lfdr.de>; Thu,  2 May 2024 10:39:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 824F85FB8B;
	Thu,  2 May 2024 10:39:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b="m/izBzrM"
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3A1C757871
	for <linux-kernel@vger.kernel.org>; Thu,  2 May 2024 10:39:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.61.82.184
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714646343; cv=none; b=iZ7b2XBmE3CFyAvy8BfU4CsYoPJ4x85+PXOK6m7ig6T/tJKu2rXi1FcSQ2dgPuvFQpXljVjpk6fw6bENS2vq0vNQsO0mK95rLUfqso0JHDqCWN/R+g1bJPRnh7cA+BfXoTwt14oYgH2QgNGWIdGzCGbBr1bfT+/VUzuhGZl6Elk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714646343; c=relaxed/simple;
	bh=s+BJak8VQBmkbIU76xZRY+wRlrv1iuPqklHig3FLjQU=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=vDhLZ9ESNTUo1YbGWQdT8XZaTs7YC2kjX/Junj+WpP2BolopXdJ+WLH9jmqMUrbCh44gXTGWg9+1hPLpMlaYW0IIb2QEEFaFB+7ShZaK6Zc5iSSZ6CLQXcytoICvudqhXfuhvTYcn045Glx00jy8P3Dmn9lTSBN9EcZLA62d8YY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com; spf=pass smtp.mailfrom=mediatek.com; dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com header.b=m/izBzrM; arc=none smtp.client-ip=210.61.82.184
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=mediatek.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mediatek.com
X-UUID: 2e39be48087011ef8065b7b53f7091ad-20240502
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
	h=Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=HWKIlzx1/cJSQoVLkKMEH/Knq2h92AZ//vWfilvYpXQ=;
...
X-CID-O-INFO: VERSION:1.1.38,REQID:3cb77034-f23d-4f94-bd79-d95ce96574a1,IP:0,U
	RL:0,TC:0,Content:-5,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTION
	:release,TS:-5
X-CID-META: VersionHash:82c5f88,CLOUDID:aeaede86-8d4f-477b-89d2-1e3bdbef96d1,B
...
Subject: [PATCH v7 06/18] drm/mediatek: Turn off the layers with zero width or height

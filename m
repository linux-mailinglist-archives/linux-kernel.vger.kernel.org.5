...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B5F917E122E
	for <lists+linux-kernel@lfdr.de>; Sun,  5 Nov 2023 04:17:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229502AbjKEDRP (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 4 Nov 2023 23:17:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58148 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229445AbjKEDRN (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 4 Nov 2023 23:17:13 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 047A3D3
        for <linux-kernel@vger.kernel.org>; Sat,  4 Nov 2023 20:17:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1699154229; x=1730690229;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=Vx5d/7C+H0Op64eDsFChBe8LHoUe1Pt5ZCDFhHsw+ts=;
  b=jQSveIPGkki4GpKbOX9UMekoTWavQKEJHRDapOsN9zWNRXNvfkrU/Ipq
   FpymEo0eKLycMtneXfhgHKBQc+j/xAaVlWpw/G5H1OGxXY2AzVevKoazP
   k7AgX6Yfr4NP19t19TvHlnKx0DMnyt9B3vBlgbWOV4ZKtVCGqnv3tqIE0
   8xfhAjWYhyS7/Zs+o/NfhVnhiXphQuA2QKA+Jo+EWfDEVwnZXiuF+qnaJ
   MjJw9+Tb/CwerMkxEJyE9sX3P5X2qr0+DDEkMvdbbwdFwVzkhjWomgpRR
   sUxMRKlPn4tgqYfzPU36uBvqsK0UQXTfHzqTzssVosTb3tdoi4gaWOWBB
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10884"; a="374155268"
X-IronPort-AV: E=Sophos;i="6.03,278,1694761200"; 
   d="scan'208";a="374155268"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Nov 2023 20:17:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10884"; a="711890761"
X-IronPort-AV: E=Sophos;i="6.03,278,1694761200"; 
   d="scan'208";a="711890761"
Received: from lkp-server01.sh.intel.com (HELO 17d9e85e5079) ([10.239.97.150])
  by orsmga003.jf.intel.com with ESMTP; 04 Nov 2023 20:17:06 -0700
Received: from kbuild by 17d9e85e5079 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qzTdI-0004xk-0Q;
        Sun, 05 Nov 2023 03:17:04 +0000
Date:   Sun, 5 Nov 2023 11:16:02 +0800
...
Message-ID: <202311051152.W491nQsq-lkp@intel.com>
MIME-Version: 1.0
...
date:   10 months ago
config: x86_64-buildonly-randconfig-003-20231102 (https://download.01.org/0day-ci/archive/20231105/202311051152.W491nQsq-lkp@intel.com/config)
compiler: gcc-12 (Debian 12.2.0-14) 12.2.0
reproduce (this is a W=1 build): (https://download.01.org/0day-ci/archive/20231105/202311051152.W491nQsq-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202311051152.W491nQsq-lkp@intel.com/

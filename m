Return-Path: <linux-kernel+bounces-29859-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id C0C2A83149A
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 09:26:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 3C0AC1F21A6B
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 08:26:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4572828E0F;
	Thu, 18 Jan 2024 08:23:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="vF1VNTK5"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A7ED8125B3
	for <linux-kernel@vger.kernel.org>; Thu, 18 Jan 2024 08:22:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705566179; cv=none; b=CBA+5xQud71KrBSbgI3temSQJe8L9ASyljtuRxwZtgl8/ORLSH+9V+MQWYeZjyOxu+25iAM0GvuYmUF7DBj8nJMwKZi2LxEkIv/Q7DUjpVvPqjR6Yamwq5uIn7JoUROKqcYuKxLRl0SIPjEINNm1pvrN0Rd4zT4kam0LfxKhsZY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705566179; c=relaxed/simple;
	bh=gnchmnqjGy0hlN73MvOYmGIzF1fut94uVqiF3AadF3M=;
	h=Received:DKIM-Signature:Received:From:Date:Subject:MIME-Version:
	 Content-Type:Content-Transfer-Encoding:Message-Id:References:
	 In-Reply-To:To:Cc:X-Mailer:X-Developer-Signature:X-Developer-Key:
	 X-Endpoint-Received:X-Original-From:Reply-To; b=INWXt3T1p1qO/zjNyYonz9Jbk9ocmhtPtR7LH9G0hVBBmhgzMmWL0vjGn7hmKjmsQ95dfYmAmxOaC3O2mrHhjb4xVMyhuzicuL1YBD8bMlMxU/472m7fQ+5y07eZ0XBYW55r+CT0yIXM++jwIZFg4h/Gru2oaACzPj/bTxrpTQs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=vF1VNTK5; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id 084D7C4167D;
	Thu, 18 Jan 2024 08:22:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1705566179;
	bh=gnchmnqjGy0hlN73MvOYmGIzF1fut94uVqiF3AadF3M=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id E7980C47DA2;
	Thu, 18 Jan 2024 08:22:58 +0000 (UTC)
From:
 Nikita Shubin via B4 Relay <devnull+nikita.shubin.maquefel.me@kernel.org>
Date: Thu, 18 Jan 2024 11:20:51 +0300
Subject: [PATCH v7 08/39] soc: Add SoC driver for Cirrus ep93xx
Precedence: bulk
...
Message-Id: <20240118-ep93xx-v7-8-d953846ae771@maquefel.me>
...
To: Conor Dooley <conor.dooley@microchip.com>, 
 ...
 Linus Walleij <linus.walleij@linaro.org>, Wei Xu <xuwei5@hisilicon.com>, 
...
X-Developer-Signature: v=1; a=ed25519-sha256; t=1705566176; l=9408;
 i=nikita.shubin@maquefel.me; s=20230718; h=from:subject:message-id;
 bh=eQJ3h4imoKOv0G3MXlKJKrpWwx1X1s4wpcEnSI3mZos=; =?utf-8?q?b=3Dlps8Q4ID/7pI?=
 =?utf-8?q?Vv2MTpbBOPGP+dthKPZz3UJe/MgFrGAeCRQPy7x0n9Y/Qg+atp3ByNpCBv+FswHv?=
 Epo9aFOIB1eckLdgZxviGfZctO9BKgXjxk27pUgTbntUDXHu0+du
...
new file mode 100644
index 000000000000..3ddba43f8250
--- /dev/null

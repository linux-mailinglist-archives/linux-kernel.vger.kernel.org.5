Return-Path: <linux-kernel+bounces-59639-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id B205F84F9DC
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 17:44:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C7ECF1C247BF
	for <lists+linux-kernel@lfdr.de>; Fri,  9 Feb 2024 16:44:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 07EED7BB0E;
	Fri,  9 Feb 2024 16:41:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b="QaS9IX2L"
Received: from mail-ed1-f49.google.com (mail-ed1-f49.google.com [209.85.208.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C0087F49A
	for <linux-kernel@vger.kernel.org>; Fri,  9 Feb 2024 16:41:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.49
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707496870; cv=none; b=B91yn3pJo2m35g+1hmzitfkQ3ByUZIBzj0gvmcZmCQWiRyZKQVOVcrYsR3QKTb5fcuQnesLtwrU03oA5ZbGfu0GsiSHwijwx2G06SktZBROg7od6Zdb3hwRQLfltEUAJu5CVQtqtj+loaOaKjHSkvjxLAbcBjTY7eU70l1DYgmQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707496870; c=relaxed/simple;
	bh=CSNIblERm1yxs33BpBNqvZqzzZGqanuQHr+3GMXAUSE=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=M3F9vl+GhTyfXGWEnPnugaOr89QvMcO7FbpCTEkN/Fqa9zrh58SKscURzqh7NntauuESygrFKX/tzWx5PpabOSPXkg5x0LFdpCIrSf2HB8x7XtOqlw9Wk1LqlWx9DD8evevutyxlpCBiJXvWsm4urA32uRYHfkKmM3Dd8TwzUhc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com; spf=pass smtp.mailfrom=ionos.com; dkim=pass (2048-bit key) header.d=ionos.com header.i=@ionos.com header.b=QaS9IX2L; arc=none smtp.client-ip=209.85.208.49
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=ionos.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ionos.com
Received: by mail-ed1-f49.google.com with SMTP id 4fb4d7f45d1cf-55a5e7fa471so1495402a12.1
        for <linux-kernel@vger.kernel.org>; Fri, 09 Feb 2024 08:41:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ionos.com; s=google; t=1707496861; x=1708101661; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=XIIKfJfb/alfxcJ+K9HvYEzl+4nRPqDv1ffmhihDrcA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707496861; x=1708101661;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=XIIKfJfb/alfxcJ+K9HvYEzl+4nRPqDv1ffmhihDrcA=;
        b=
X-Gm-Message-State: AOJu0YyTvxSWKXuMVejSM6dRw8Uu4wZaXviLU3NNa90fkw/vk3ww2PxL
	PwCvi6EOnnPoF4a/5rIE0kl0zIqixSCZ/gpY6Wjx2LFnFeQwgCjcrQiFgAqVybUBmlxlLvJZn1E
	e
X-Google-Smtp-Source: AGHT+IHmvNufrnSYnMrr7Z8xO41KyaBTAfDI9zMul5mFPZuQCcYjmk6L37heUL/YpJBUd/O+OZjR+Q==
X-Received: by 2002:a17:906:b210:b0:a3b:fbc0:c6d6 with SMTP id p16-20020a170906b21000b00a3bfbc0c6d6mr1276932ejz.66.1707496860576;
...
Subject: [PATCH v2 16/35] device.h: move declarations to device_types.h
Date: Fri,  9 Feb 2024 17:40:08 +0100
Message-Id: <20240209164027.2582906-17-max.kellermann@ionos.com>
...
---
 ...
 52 files changed, 554 insertions(+), 501 deletions(-)

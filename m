Return-Path: <linux-kernel+bounces-134967-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BA78189B96B
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 09:56:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 70FB1280D0A
	for <lists+linux-kernel@lfdr.de>; Mon,  8 Apr 2024 07:56:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 49B1C657B7;
	Mon,  8 Apr 2024 07:50:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="ZASBQYId"
Received: from relay9-d.mail.gandi.net (relay9-d.mail.gandi.net [217.70.183.199])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 91C6950A73
	for <linux-kernel@vger.kernel.org>; Mon,  8 Apr 2024 07:50:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.199
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712562633; cv=none; b=ZlW8CNxcQm93nyjd93XSppdgYIzV5lsz4abHlSYG7FuF6mwRq73GZZprkkFIA5DRMq9+C/dEOMQQDiOlH3CMw3XG2b0RL0LK+MEJJqbDV8F4emgmlMFoBfTLqzCe1rCJLHRxp+LOuPjHznebuHOhjumYdxgBIQcr7zpa0ptoy2s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712562633; c=relaxed/simple;
	bh=zBUHAbIWHf0vDOtPNIBjIGUs1tMU8mFypQR702k9SPY=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=hjZYpYxFyffRF9OebU42WawL9KHUlAfnzK2mx8vsmrjwV1iPtkte9KCv28mOmFoMQX2nz80gxFxOPylNbquITFnLQHIikOgZMbrROfHsw3Dj8/FleUmzgiMrNV85KcfNRCCofgTAiK++lCVdG59+USz79AVmQW55Z+MDNPdgIBA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=ZASBQYId; arc=none smtp.client-ip=217.70.183.199

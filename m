...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1C3B5783B24
	for <lists+linux-kernel@lfdr.de>; Tue, 22 Aug 2023 09:51:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233530AbjHVHv3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 22 Aug 2023 03:51:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56600 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231375AbjHVHv1 (ORCPT
...
Received: from forwardcorp1c.mail.yandex.net (forwardcorp1c.mail.yandex.net [178.154.239.200])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 63661191
        for <linux-kernel@vger.kernel.org>; Tue, 22 Aug 2023 00:51:19 -0700 (PDT)
Received: from mail-nwsmtp-smtp-corp-main-26.myt.yp-c.yandex.net (mail-nwsmtp-smtp-corp-main-26.myt.yp-c.yandex.net [IPv6:2a02:6b8:c12:5429:0:640:6285:0])
        by forwardcorp1c.mail.yandex.net (Yandex) with ESMTP id 734D160801;
        Tue, 22 Aug 2023 10:51:16 +0300 (MSK)
Received: from valesini-ubuntu.yandex.net (unknown [2a02:6b8:82:604:8dca:a63b:d2a:5bd0])
        by mail-nwsmtp-smtp-corp-main-26.myt.yp-c.yandex.net (smtpcorp/Yandex) with ESMTPSA id 7pD3pL1Ol4Y0-QZCfLrY3;
        Tue, 22 Aug 2023 10:51:15 +0300
X-Yandex-Fwd: 1
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=yandex-team.ru; s=default;
        t=1692690675; bh=4uP5t5uZ1wgq6reQ2YHw+f1y61LFlJjvwxdmiWNpeNA=;
        h=Message-Id:Date:In-Reply-To:Cc:Subject:References:To:From;
        b=zir/TtvQb8mu/AIKYTPaxPxgzXsOJWIf8yLJdEVF4iFfuHwLKxdH5CC2u1Id/Aj6p
         AZ2OSM7S5SEpEA47ZT/OYPv00q7L6AVo1+YTdCh5/ZRhwMjkl2/L+96k6hn0068IYL
         ACUYz5i/NEcA2GXUASibnj4Ll30Lixe1PaEdsAIA=
...
Subject: [PATCH v3 1/2] kernfs: sysfs: support custom llseek method for sysfs entries
Date:   Tue, 22 Aug 2023 12:51:06 +0500
Message-Id: <20230822075107.224512-1-valesini@yandex-team.ru>

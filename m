Return-Path: <linux-kernel+bounces-92424-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id D4C18871FF5
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Mar 2024 14:20:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D0B471C21BBD
	for <lists+linux-kernel@lfdr.de>; Tue,  5 Mar 2024 13:20:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C3AF68593D;
	Tue,  5 Mar 2024 13:20:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="J+wy3xGh"
Received: from NAM12-BN8-obe.outbound.protection.outlook.com (mail-bn8nam12on2049.outbound.protection.outlook.com [40.107.237.49])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F3BB35381E
	for <linux-kernel@vger.kernel.org>; Tue,  5 Mar 2024 13:20:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.237.49
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709644846; cv=fail; b=Znzya9k3J+x68ISIX5y1Cy8L8mMwHulrbSDKifbJhxeTIcbfPC5VmubkAmCQ/xQJWMa1PcB48EKW8mWjAMpi90IRwdTmdOqA/JgbC5IxkG9cmhukV9OUNiThv7rAztFDw3bZT5d7KZAYjEe6bqjBRmo2vpxelCrahfog7hyBrGw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709644846; c=relaxed/simple;
	bh=H8Pc4z20pVxowT6ANFoPUatKXttMCj+P18XSrPaPaKw=;
	h=Message-ID:Date:Subject:To:Cc:References:From:In-Reply-To:
	 Content-Type:MIME-Version; b=FmZgnBK2hamYIRFAxG/W/tVcYqG8R3yyCML5R/cWoqhWIpfw4TR5BPxaX3NvL+kadDVjPu2iIw40Z51u5rZjcAJi0OvwPevPZu2C4Mafi3wYB3xlcCtsRK9xo5ZEPMsQROGPHKJwMau1Zv7rYO+JZYbFB4LTAATIC+d45uiy1KA=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=J+wy3xGh; arc=fail smtp.client-ip=40.107.237.49
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?TTVFYmFsK2duaG1UUkQvdWphZ0N4QThrVlNscmVIWG1PbllVcndlVFdyY3Fu?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 05 Mar 2024 13:20:41.1185
 (UTC)

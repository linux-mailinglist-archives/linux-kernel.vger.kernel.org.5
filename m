Return-Path: <linux-kernel+bounces-95079-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 11F478748FD
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 08:46:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 733E8B22FD3
	for <lists+linux-kernel@lfdr.de>; Thu,  7 Mar 2024 07:46:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 85564634FB;
	Thu,  7 Mar 2024 07:45:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b="ZJmkDjme"
Received: from EUR05-DB8-obe.outbound.protection.outlook.com (mail-db8eur05on2042.outbound.protection.outlook.com [40.107.20.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CCE1E634E9;
	Thu,  7 Mar 2024 07:45:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.20.42
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709797532; cv=fail; b=ZKIR4Lv8QvvW2klTtTx1RC95h5FGQ/6J77sgQKykJSPNhrGjNh4Bk52JLc3BX8E2mAt6XEy4qJfcrhi4I8i+p2BhPwKIsFKUM16n+BGccv5gh7u7exNUqD0DCsYhwLM81gnotNaC6QutMASLR0g+5dvwkgLrwvm+QZumx848juw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709797532; c=relaxed/simple;
	bh=ABObIBVV0pm33eBjssCezbbuagIOtvDFTS+Is3Z2YtU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 Content-Type:MIME-Version; b=BAAi/pTqLUeq9xn0u1JmXEjb47Q/SSINVchNseEWEjoS4JdDOJwLc6qepGr4qBX3uyfBnAXpXEcT+BB6gzpmMG/UJNVuo0tR677131DeY9DHjxHghLkXKwtCqhV823GsVEMxWmYKs7slFGnLa7E33XJE3IboCEtnyNiYtl/P9nU=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b=ZJmkDjme; arc=fail smtp.client-ip=40.107.20.42

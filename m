Return-Path: <linux-kernel+bounces-104982-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id D31C387D735
	for <lists+linux-kernel@lfdr.de>; Sat, 16 Mar 2024 00:10:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 88FC6284D31
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Mar 2024 23:10:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7BF145C5F7;
	Fri, 15 Mar 2024 23:09:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="BxTXyEDr"
Received: from out-184.mta1.migadu.com (out-184.mta1.migadu.com [95.215.58.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7D8B65B68D
	for <linux-kernel@vger.kernel.org>; Fri, 15 Mar 2024 23:09:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.184
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710544180; cv=none; b=JkNiBgoULya9jhiTy2+Ge8CyVOFuLc0uazndnNlCl5hG8MPQ3J83kMymtrUvv+MFO1V1L4Q0IhdJODriqL1wMVTJpd6gxWY0HaImPAn11/AXH/6kO9qVK10jMAH9BySwOVFyKOPzOTc2vaHX0g64CZWIFlOSPcwdVWTScwt473s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710544180; c=relaxed/simple;
	bh=gX2ZXaZHkPCE4Lbo82dnWxWzD26K6YRAFDZGIBwWj90=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=EdXlihcmQ7C/mWwQGD3Lod97UyA59bMKpV4vrlOYIyU8YtBfpbv6id9lE/qpcj7zHZKJTRu7xxmXc0lAvN1SVdiOSbgj26GfrmlIBnSqP2iHN8VQqId2V/DAKxF7FrQ++Uk6Ji1MuSGhifQvLH4/d44Yyyc6GdheXl64sWa1D2M=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=BxTXyEDr; arc=none smtp.client-ip=95.215.58.184

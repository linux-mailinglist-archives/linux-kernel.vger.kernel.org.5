Return-Path: <linux-kernel+bounces-31298-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 28C70832C19
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 16:07:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A01A9287239
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jan 2024 15:07:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9EDAD5466E;
	Fri, 19 Jan 2024 15:07:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="NYD65a4y"
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.115])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3A7D851039
	for <linux-kernel@vger.kernel.org>; Fri, 19 Jan 2024 15:07:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=192.55.52.115
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705676841; cv=fail; b=X6xhGHYrLkCw7ymApzLO5WWTOF6Jirr+l/6JrDFfrVBxun74C0o5CUGlEZV2X9LycBLILEI5zX/Yeh0EwiCf3zcWqMqpPsgrtK+PyD/7/2O404bf7/NbBorRtgbTtXU/yMkO/8Sv+Rre2YMVNC3t6md3czYqCkyryVMwM2+BbWE=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705676841; c=relaxed/simple;
	bh=II/LejzikZdDu1CkKKT4I8/NA012BwIkHSsSEQyvuK0=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=ion0IdJRD5U6ea75iUS8mwfxcf5EsDe3WO+ug5AtXaK/ha4/0JwxbSOARfj40qEG7IZ96TO9pMgLQ2RhTVmcdR73g4Dgh0Snk/eQjSdCj9JRS+glbYUBEWqZWdRyTuSB26wVyIJVbAsO3u4eB/1ouCQXgnxR5qXzF3zWlkzxtCU=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=NYD65a4y; arc=fail smtp.client-ip=192.55.52.115
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1705676839; x=1737212839;
  h=date:from:to:cc:subject:message-id:references:
   in-reply-to:mime-version;
  bh=II/LejzikZdDu1CkKKT4I8/NA012BwIkHSsSEQyvuK0=;
  b=NYD65a4ybyCxZOU4AIPONK34dLoffQ4cMthE2TUByu6sZs1GLwDqUJMm
   AeOG4XKPUA9tYP8097gAL6mIvH6WFPwCNaRUcN2kB3aHHO2CelJnfnz54
   G8EPngg/g0nvvJzEQTPVHJTiwslVYFYTmqzv6hQqAv1HOk9fuJps7GcFu
   Tfw5jZyJlzc33CAxi12/9NuXJQh+oGTXe0nd+NhRnQChZ1Ku8HqoxBpQZ
   kzn5suUhSAVwLLA9oGpm6X+CtvjGueBVCfRMYxM2aP/L6I84TxSq2J69y
   p10lS3l4ph4LfaO0bCZ/lieXSifrMzBA20UnQoySiFVzdyklqD2LTvUoN
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10957"; a="400419435"
X-IronPort-AV: E=Sophos;i="6.05,204,1701158400"; 
   d="scan'208";a="400419435"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Jan 2024 07:07:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,204,1701158400"; 
   d="scan'208";a="612575"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
  by orviesa005.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 19 Jan 2024 07:07:11 -0800
...
CC: Andy Shevchenko <andriy.shevchenko@linux.intel.com>,
	...
	<intel-xe@lists.freedesktop.org>, Thomas Gleixner <tglx@linutronix.de>, "Alex
 Deucher" <alexander.deucher@amd.com>, Andrew Morton
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 19 Jan 2024 15:07:04.2823
 (UTC)

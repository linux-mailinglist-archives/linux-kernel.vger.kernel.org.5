Return-Path: <linux-kernel+bounces-41648-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 264D283F5DB
	for <lists+linux-kernel@lfdr.de>; Sun, 28 Jan 2024 15:26:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 2F5EF1C225C1
	for <lists+linux-kernel@lfdr.de>; Sun, 28 Jan 2024 14:26:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1F3E02560C;
	Sun, 28 Jan 2024 14:26:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="YdM5Ktdj"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0484124B39
	for <linux-kernel@vger.kernel.org>; Sun, 28 Jan 2024 14:26:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706451998; cv=none; b=PIfqbRKowGLZ/+PTYJOjL8C0eeSekzBNbsFtgENBlA7hpJvFiMZUJracXZ1hqrjLdG40nUNo/d8qbxwFZ5DgTl6pZkDKowQBZKxJNXz/HI6eDmtPKozpKPsr1NiA7eoY9pd8FSHwFfVGVPXACC0NSkcNavnAbiX5qq/GiTVfjp0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706451998; c=relaxed/simple;
	bh=ap3jE6eJ5LumWLiuT4HUPdO0BOsdnouZYWjxGdamNxo=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=lPzLSK6ucUV4uQo+RSNWZ+jZHzYpdX3jI3ywCNF+5+y832RQCH04LpmO/XvcO1spk319vsRAGkszpnZ6tiO5UzYriX9MUy67uTbWHL0Gxj8TAKsDYUHw4BiIT6VuypCMB1AKBt4GajMfs6lGo1m7NV30/WYd+GKZ9HKnfiPaJOE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=YdM5Ktdj; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1706451994;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding;
	bh=+CMzCSV2vzJC7cGxMUfn3KLiYWQWO3h35bY6GJWrDzU=;
	b=YdM5Ktdj0lgYffjZ12NEK8sGpwRWNcGEONaDv5cI9b8s1RBDKUJ/vZD6cD/nq19azYvGGn
	wrdODxsJwjVVJMqEZry9J13QnUMQaYmbmkWoKzp5QPV9K/YuyXkJ8zv4HB3ArpaHrXcbpG
	Ed/f+NjkD1+K4CvUpqlNLzz02jXs6g4=

Return-Path: <linux-kernel+bounces-160942-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id B0CFA8B44E0
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 09:28:20 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 68094280A8D
	for <lists+linux-kernel@lfdr.de>; Sat, 27 Apr 2024 07:28:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 860B34EB39;
	Sat, 27 Apr 2024 07:26:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="EoDmsc1L"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 851164C627
	for <linux-kernel@vger.kernel.org>; Sat, 27 Apr 2024 07:26:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714202802; cv=none; b=V3nz9AE0TJqDFavEWaZq/ev0AixTBRPmV8V7jLcY6N4cYU91xV6Y2fe1T3eMyOxZX9BQGTuE6iYms/qHbX72OPcY/hfP9hM+Ld7VbnyAYpR04pOD1uGl1z8jKLIEZY/z+W+liTJeE1PqPXEqs5VRdLi2L3tW71uYWtrb8ITie4c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714202802; c=relaxed/simple;
	bh=zDTka2HBSj5iRU5xCfXL7P6ap79KI0OSlVMaZhMSARc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=ofEN3aCxlR7e14+GXx+7Mh8rvaz6f0tq4IR7BjgUnJe4p0R5yohriDeqBqdnhBVAmP4bwxJtZCawueM/aygUz8D8DDIwh2rhBu6pqLXwk9pUT934IPV9Echj086Ef9SV55GCB6IaHgzCArYXwGNkiyV5vW5YFNSFCXfJJazhzO8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=EoDmsc1L; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1714202799;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=iPop14PDJDqV12KyydXTX0sGAefyaIK7zjPIx4384QY=;
	b=EoDmsc1LFNAkyx2M1aoXmoFA6vL14BEej6b87XlJw4BmetT+AmkFuGnzuvcfnVOY67S0QV
	HkBcenQmrtrsTXz9lVivRv0RTaR90UltCThd6ApQ5Dn8RxcjM1ERADutfJyiCVNBNXFjAO
	79bi0W3y/k7ayjNWtozJyDLVAVFKo7E=

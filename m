Return-Path: <linux-kernel+bounces-1491-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 18871814F56
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Dec 2023 18:58:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3DA731C2459C
	for <lists+linux-kernel@lfdr.de>; Fri, 15 Dec 2023 17:58:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 62D705639C;
	Fri, 15 Dec 2023 17:54:58 +0000 (UTC)
X-Original-To: linux-kernel@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E48174AF98;
	Fri, 15 Dec 2023 17:54:57 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id BE4C0C433CC;
	Fri, 15 Dec 2023 17:54:57 +0000 (UTC)
Received: from rostedt by gandalf with local (Exim 4.97)
	(envelope-from <rostedt@goodmis.org>)
	id 1rECPb-00000002wUn-3QCg;
	Fri, 15 Dec 2023 12:55:47 -0500
Message-ID: <20231215175547.600666738@goodmis.org>
User-Agent: quilt/0.67
Date: Fri, 15 Dec 2023 12:55:17 -0500
...
Subject: [PATCH v4 15/15] tracing: Update subbuffer with kilobytes not page order
...
@@ -9435,7 +9447,7 @@ buffer_order_write(struct file *filp, const char __user *ubuf,
...
@@ -9467,10 +9479,10 @@ buffer_order_write(struct file *filp, const char __user *ubuf,
 	return cnt;
 }
...
@@ -9941,8 +9953,8 @@ init_tracer_tracefs(struct trace_array *tr, struct dentry *d_tracer)

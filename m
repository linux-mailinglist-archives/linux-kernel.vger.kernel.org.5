Return-Path: <linux-kernel+bounces-90239-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D1F286FC4D
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 09:50:49 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 1D83DB222A4
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Mar 2024 08:50:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ECB1B208D1;
	Mon,  4 Mar 2024 08:44:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="TSiyEfq2"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 489CF1AAD2
	for <linux-kernel@vger.kernel.org>; Mon,  4 Mar 2024 08:44:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709541860; cv=none; b=V7Sz+UvTpojxX91oxY4LLI4wMOovbqKQUoByBEldqA3RCMuhx809dOyar/K5eaXQ9AK1gPKO9rhkhw1vfyuVolVoi86CPUXO0buLEk4yFZ1F49Cd6AD4qDpGw6x44O7Jliv22uX3uJhz5fzR9S0FV3DMVvgeQ7Bso5+YDvxhb/Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709541860; c=relaxed/simple;
	bh=Hm+gxW/kHadxtc48yXaukCqMew6ym1016BnoNle9pNk=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=X7B22MWeTsEBFwaaBSRaQUduztsGq5ZSea4ZlEtsFUY6NEG/YYNb5vhRLwHMBtfQU120y7sCnTCuvqt7WBUmFzPKiBlcBeHw5GMzvmXhwiLrxIgiRh43PGfXaV+KvaX4J/UznblX/4ARGeeKT4xztg1P1vhZq5XnZjM2wpSQzdA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=TSiyEfq2; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=TSiyEfq2J76/wDNqUS3bKvbwdH8NTiA5UenEMPanyZhDHmt+GLIprmxRS5dSnam+sGFi6y
	c2gtv8P4Jy1BORUaNpmCnFSefIR6lTaGXSpqv4TGkozGQS4FLB638Pi217xqJ/qrcC/PIG
	yg0n3E7yVjD/D9TXA4pjfheWIfwXXzY=

Return-Path: <linux-kernel+bounces-15184-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 3216A822803
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 06:14:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2F75E1F23AFD
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jan 2024 05:14:38 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CD42E1BDFB;
	Wed,  3 Jan 2024 05:07:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="B9oE8ufl"
X-Original-To: linux-kernel@vger.kernel.org
Received: from mail-yw1-f201.google.com (mail-yw1-f201.google.com [209.85.128.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AD3F61B28E
	for <linux-kernel@vger.kernel.org>; Wed,  3 Jan 2024 05:07:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f201.google.com with SMTP id 00721157ae682-5ecfd153ccfso109911137b3.2
        for <linux-kernel@vger.kernel.org>; Tue, 02 Jan 2024 21:07:40 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1704258459; x=1704863259; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=Yqkhc2eE787os9e5mS7MWCgs9xLMMaFkL/BVKaKEMDc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704258459; x=1704863259;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=Yqkhc2eE787os9e5mS7MWCgs9xLMMaFkL/BVKaKEMDc=;
        b=
X-Gm-Message-State: AOJu0YybfNQ2gHCWU4mML1NJsRRfR5avYYoH1rGY1YtI1liqKRvzuc9C
	75EhtQwNFSVaPvrVIzVpgpFHV0htnAyJXkZyMoE=
X-Google-Smtp-Source: AGHT+IHRVXHpg6GNvFVL1iNDWNyCHd7/cr9KfuL9v+f7Sn6VgV+6k9YRX7Se2Q1MmC7b2exMstESuxuoSXJS
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:e2bd:f1f6:8ea6:8d6c])
 (user=irogers job=sendgmr) by 2002:a25:ef50:0:b0:da0:3da9:ce08 with SMTP id
 w16-20020a25ef50000000b00da03da9ce08mr7256575ybm.10.1704258459641; Tue, 02
 Jan 2024 21:07:39 -0800 (PST)
Date: Tue,  2 Jan 2024 21:06:33 -0800
In-Reply-To: <20240103050635.391888-1-irogers@google.com>
Message-Id: <20240103050635.391888-24-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v7 23/25] perf dso: Add reference count checking and accessor functions

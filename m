Return-Path: <linux-kernel+bounces-146511-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 92ACD8A665E
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 10:46:44 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id C6516B233E2
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 08:46:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DCFCBEEB7;
	Tue, 16 Apr 2024 08:46:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="C4jlf6u4"
Received: from mail-pl1-f173.google.com (mail-pl1-f173.google.com [209.85.214.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 699A0629
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 08:46:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713257193; cv=none; b=KEFHe1ubcU2vV953BrHtfcjyN8df1EZ/9lIMJraVSCQkvcwDQ64s9ovymjaL++NjZP09qedANgzhfiBdlRV4wEHuAzI03onQ2AX2ZcOj9CrFOI0nZsYFFWnFB57kdSjr09dbXjsh34+ySheubrRN7i9YfnUr6iaMLg0IZW7txlA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713257193; c=relaxed/simple;
	bh=wvlbCfxHSZpaqmi0913qTIrGU+Bv5x+PhfrqBSY9p8c=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=tYPx0rXv8Vr/AVaEF43r4oMx5HY2UIRoekqZahx250GciOJgUn6hiOTntkfCG6Gi8N4zLyjEt1tF6707qd3fI/VRDGAagFBd/3FRtnnBg9X0K6vk5SWcJcVjQVlD8jkGKe4lUFsIoFed9BoMtOKdIH6rVEyl8smClh3mD8CBgME=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=C4jlf6u4; arc=none smtp.client-ip=209.85.214.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-pl1-f173.google.com with SMTP id d9443c01a7336-1e44f82ff9cso92355ad.1
        for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 01:46:30 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=cdFARpeJLKEG6lkXysYKLQ1MgRKXAzEEOOq2GHR99oo=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVWdmzMn0uXoMLI2hUX1X4BvL/ES74ChDiSZ2FYcChJ/PTfWkxNua16BPqGmtYTP1v5ZjM8gJjWRY+XQhj3XvTN/z/CoXcOg7jXo+Je
X-Gm-Message-State: AOJu0YxaNCZtxHkvYb6XkXYa92EFfiVs7DeYCQY4LId2uDnM4a8gjkUp
	IM7rfgrtWPDIiISv8wc/cx3LcSuNIYKfANwm9sCvApDZVNMdfB4kHo8vahAsoNlNzQmBq/dtl0D
	u/nOdv4lxyZnQ/dLivQ2NP+/vGr/khm2WODus

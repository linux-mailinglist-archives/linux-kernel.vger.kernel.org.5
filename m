Return-Path: <linux-kernel+bounces-34693-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F284838635
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 05:00:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id CAF3B1C25109
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 04:00:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8B6BD1860;
...
Received: from out-187.mta1.migadu.com (out-187.mta1.migadu.com [95.215.58.187])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 01AAD15C6
	for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 04:00:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=95.215.58.187
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705982440; cv=none; b=ekrWEU9atC/FWTMM353kcNxRm36rZZEJHxoBR7hGOkGv/PYEFGqpVpCZRqUj0k5Nomfo59UsBUtL+Ohtj6GDHSz6mTuwoKp4ecTKNdQHFAzs/FAFiwBBv7m7OFIhDMzCleGrYxjB7xSIVz1qx/n4k52vJiO9fM0sxs4RtjdlZ5E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705982440; c=relaxed/simple;
	bh=HTux5BIIrgAHQKFYDFlexQlarUVDF1tSoVhHVafuXxk=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=XCNpNL2Qgq65chXiwg7dEyN9I1Md3VCqFzhY1Uu4XsD8fvjXuF0BYJq9wfrjsvWHNRvv8Zbu2OrG61SVpYKG50uWGYWcuBZiYjOhD7h4ZqEo6fjKB6QxXvAHYIyaQprF79qtVL62HupGiuWqKGPvpfeuNHYnbtkTpYqEQfHLZaA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=Bm1XLAAK; arc=none smtp.client-ip=95.215.58.187

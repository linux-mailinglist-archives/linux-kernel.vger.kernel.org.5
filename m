...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CE7A77B51F3
	for <lists+linux-kernel@lfdr.de>; Mon,  2 Oct 2023 14:00:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236697AbjJBMAJ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 2 Oct 2023 08:00:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52390 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236862AbjJBL7t (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 2 Oct 2023 07:59:49 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C8E3CC6
        for <linux-kernel@vger.kernel.org>; Mon,  2 Oct 2023 04:59:45 -0700 (PDT)
Message-ID: <20231002115902.505491309@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1696247984;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=hWimmhBWR+BZVXFP5DyDAkJLyIyydcdqq/jEuDzsXXE=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1696247984;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=hWimmhBWR+BZVXFP5DyDAkJLyIyydcdqq/jEuDzsXXE=;
        b=5JmYzRjZ9Uk8G1KZH5Im+FCLK4DDglUFfk8X/Izt/a2RagOGUVUCH4we7nalt14DEq9lkD
        kiWxrg4zyQ4R8yBg==
...
Subject: [patch V4 08/30] x86/microcode/intel: Save the microcode only after a
 successful late-load
References: <20231002115506.217091296@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Mon,  2 Oct 2023 13:59:44 +0200 (CEST)

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 55BF679347C
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Sep 2023 06:47:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239326AbjIFEr3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Sep 2023 00:47:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50254 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237710AbjIFErX (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Sep 2023 00:47:23 -0400
Received: from mail-pf1-x42d.google.com (mail-pf1-x42d.google.com [IPv6:2607:f8b0:4864:20::42d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D101BCF0
        for <linux-kernel@vger.kernel.org>; Tue,  5 Sep 2023 21:47:17 -0700 (PDT)
Received: by mail-pf1-x42d.google.com with SMTP id d2e1a72fcca58-68e29792976so818655b3a.2
        for <linux-kernel@vger.kernel.org>; Tue, 05 Sep 2023 21:47:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1693975637; x=1694580437; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=+CjISTzuvCMDkLQbL3HNJkgrADTF4I3Xcv5VI1bwwj8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1693975637; x=1694580437;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=+CjISTzuvCMDkLQbL3HNJkgrADTF4I3Xcv5VI1bwwj8=;
        b=
X-Gm-Message-State: AOJu0YxtXFaIdBwbGIZyqNi4kmKlzy+fyJPUtAPzIrzgLw20ZLHDuX+X
        l59pqkWZ6HMpzLRD5Vf+fZ2bCg==
X-Google-Smtp-Source: AGHT+IGaItEt92oiZp6isp6fCrbGySojFP/Q5lTX9T8e4mgr8g24clUXuyUXC7Zi8jSg4mKSVQZWpg==
X-Received: by 2002:a05:6a20:4295:b0:138:2fb8:6c48 with SMTP id o21-20020a056a20429500b001382fb86c48mr15542966pzj.8.1693975637262;
        Tue, 05 Sep 2023 21:47:17 -0700 (PDT)
Received: from charlie.ba.rivosinc.com ([66.220.2.162])
        by smtp.gmail.com with ESMTPSA id g11-20020a1709026b4b00b001bc56c1a384sm10087313plt.277.2023.09.05.21.47.16
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 05 Sep 2023 21:47:16 -0700 (PDT)
From:   Charlie Jenkins <charlie@rivosinc.com>
Date:   Tue, 05 Sep 2023 21:46:54 -0700
Subject: [PATCH v2 5/5] riscv: Test checksum functions
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230905-optimize_checksum-v2-5-ccd658db743b@rivosinc.com>

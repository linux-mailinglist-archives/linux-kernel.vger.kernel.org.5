Return-Path: <linux-kernel+bounces-147328-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id B06708A7294
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 19:44:18 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D410B1C2104A
	for <lists+linux-kernel@lfdr.de>; Tue, 16 Apr 2024 17:44:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 118FB13398E;
	Tue, 16 Apr 2024 17:44:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="WGSVTq7m"
Received: from mail-pj1-f46.google.com (mail-pj1-f46.google.com [209.85.216.46])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CD59813342A
	for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 17:44:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.216.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713289450; cv=none; b=Wq+9bV9ByU3nqfhtkU1wNdiQpRjlHUSXG9ARpYog2rUFVokH+cGZ9X3QdPOkTJDoEnkqpmLUhdWO+nWF0CKMidvPsJ48zYHv8zGHA/DDMMdzpMuvuogYWuaXimcSr0sEDnOhnBkdudxVGbZr5+I5fqFeC2bMHvebrkoirIrbS/Q=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=WGSVTq7m; arc=none smtp.client-ip=209.85.216.46
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-pj1-f46.google.com with SMTP id 98e67ed59e1d1-2a614b0391dso3208011a91.1
        for <linux-kernel@vger.kernel.org>; Tue, 16 Apr 2024 10:44:07 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=dCeTiIDGAFgOAkGMmaIvUFAzZFcccTha+TuzFNIo+Rc=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVvAfSsNlP2bI2YWFMsS+jEvT3ZLj/SY+a7JjnGCNZMPPUA+NCLeZw6nLIppkbcqUjK441Hg64T7Jqg1JGKm/X597rZDjgDKw6nhTTV
X-Gm-Message-State: AOJu0YwocfmqBMJ5PCbSrQM3bqMBc3hUNoVnW4qqhmCJ2c1BbPiatjES
	I8R3R7IDQ77CV/Y5rdBlD0fQucJlMbpf0TgHCt/gusSUxh41Sn4tw9JhoZQDqj8=

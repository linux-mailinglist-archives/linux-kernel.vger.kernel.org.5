...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C9D3F785322
	for <lists+linux-kernel@lfdr.de>; Wed, 23 Aug 2023 10:55:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233504AbjHWIzE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 23 Aug 2023 04:55:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53792 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234966AbjHWIqe (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 23 Aug 2023 04:46:34 -0400
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.220.28])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8EF0A2D76
        for <linux-kernel@vger.kernel.org>; Wed, 23 Aug 2023 01:43:54 -0700 (PDT)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out1.suse.de (Postfix) with ESMTPS id B497721F80;
        Wed, 23 Aug 2023 08:43:52 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1692780232; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=FEKHHWV28Zogs0QLs6RLtHrLwy8pbL3U3JdkOoYPrkw=;
        b=HobkP1SP81yBCuEW3H3jbsJtoYTFGVqmJZPueqgUmw3JkyFJsf/sqCfOf16DhGFsoetJo2
        5D1ZcEfCyoaI54NgQBe8xFm0nFP4L0AFaKyXNdA+wssRbOwoieuPDLI1kqrdwPT5Y86KOh
        AEKMb9N1lbCjGAD0yIRNObg9a0bJ8qw=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1692780232;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=FEKHHWV28Zogs0QLs6RLtHrLwy8pbL3U3JdkOoYPrkw=;
        b=j7PAhYmEQ+x260u0n6E7ZDoBX+Q3NELx58VcJ2hcMfyJ0haXpHG+q2BijuwtX0M7tNXWG4
        iNg8w/+cVoz5UOBg==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id 754DD13458;
        Wed, 23 Aug 2023 08:43:52 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id sJ2kG8jG5WQbZAAAMHmgww
        (envelope-from <tiwai@suse.de>); Wed, 23 Aug 2023 08:43:52 +0000
Date:   Wed, 23 Aug 2023 10:43:52 +0200
Message-ID: <87il96cfnb.wl-tiwai@suse.de>
...
In-Reply-To: <NN3UZR.VNYA824H66Q8@ljones.dev>
References: <20230823011008.13146-1-luke@ljones.dev>
        ...
        <NN3UZR.VNYA824H66Q8@ljones.dev>

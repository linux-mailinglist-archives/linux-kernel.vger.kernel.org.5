Return-Path: <linux-kernel+bounces-82706-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 57162868861
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 05:47:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 0D325288291
	for <lists+linux-kernel@lfdr.de>; Tue, 27 Feb 2024 04:47:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AD2715380F;
	Tue, 27 Feb 2024 04:44:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="5uGc5HrC"
Received: from NAM02-BN1-obe.outbound.protection.outlook.com (mail-bn1nam02on2051.outbound.protection.outlook.com [40.107.212.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D85475339F
...
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709009097; cv=fail; b=KEJ27mWhNduex7qfoeUOpb2eZGZ+qxitIqDmvqvZirncONEbDVa/qyjADky3/0rSw6QqDmdibe+k+wiUkSij05J2ZS9neS4fZU9eQfysh9n2V3Qrn9UFqpAvrsSUdDwjCsPHiHozz3n4TLnTmyPCPJ0qPHuVyEajDBzQipkRnSw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709009097; c=relaxed/simple;
	bh=/HOJExB0X9xPAY1sl1KSHTkeQLs/BhzpJSYXdmzFdjE=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-ID:References:
	 In-Reply-To:To:CC; b=Y9YBzt0PdK7BuhXUpuz+mujpa8SUl2Hp14J1sHvscyPpvnCMJKmAjlHXqjNf9t2vZEEaLt2nrVClwOzg+hBxH/cpRDmyW7zvA13ieJWdXN12T7fGvI3IJcIBKlRxrgqt+9C1uuwL5fRyKMui2ifxzN1NXyLkuULLrDK7WzGuE0c=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=5uGc5HrC; arc=fail smtp.client-ip=40.107.212.51
...
Received: from xsjanatoliy50.xilinx.com (10.180.168.240) by SATLEXMB04.amd.com
 ...
 Transport; Mon, 26 Feb 2024 22:44:49 -0600

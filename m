...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4D60580B2A5
	for <lists+linux-kernel@lfdr.de>; Sat,  9 Dec 2023 08:14:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234366AbjLIHHF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 9 Dec 2023 02:07:05 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45676 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230176AbjLIHHD (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 9 Dec 2023 02:07:03 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CC3AC10D2
        for <linux-kernel@vger.kernel.org>; Fri,  8 Dec 2023 23:07:06 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1702105626; x=1733641626;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=X7mEtNFXXUeP5J4/uAl71OBK2xvJ+gVj2sTJ0wsbIRM=;
  b=OAURYPMf5VIU/B9iUUNgVmi9N08FI97qSy/f5mAU+G+19+MUw91UiQtQ
   0GJXQzmPw+pXgK1dy8mebyCfwm8iZvaZzWiIKv/Om0cqalvJpM4/L+TyY
   S9LH1fq7Mit+DTODQtKAKQU7Tb87N/Zq9Kg7oIBEpGYsb6To5DnbeUq9g
   e/u/mXNPaD1rGo7rR/vQxPcyRpJdE7761UzApYetBUV4fI1BWT8cqRp70
   viB/zU3sYYoX0gDIXy7EG5t2iKc1XKE61dkw4L7h8a6faPXLqOHWwqEKp
   rAtA/TxqWiGjgaWO9cQbmbnyau/OhfnYUZqK9fWFu21u6PSJ3rb/ZJgtM
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10918"; a="391670617"
X-IronPort-AV: E=Sophos;i="6.04,262,1695711600"; 
   d="scan'208";a="391670617"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 Dec 2023 23:07:06 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10918"; a="806636372"
X-IronPort-AV: E=Sophos;i="6.04,262,1695711600"; 
   d="scan'208";a="806636372"
Received: from lkp-server02.sh.intel.com (HELO b07ab15da5fe) ([10.239.97.151])
  by orsmga001.jf.intel.com with ESMTP; 08 Dec 2023 23:07:03 -0800
Received: from kbuild by b07ab15da5fe with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1rBrPy-000ExB-2V;
        Sat, 09 Dec 2023 07:07:01 +0000
Date:   Sat, 9 Dec 2023 15:04:26 +0800
...
Message-ID: <202312091549.7M8wMLX0-lkp@intel.com>
MIME-Version: 1.0
...
date:   3 years ago
config: powerpc-randconfig-r121-20231107 (https://download.01.org/0day-ci/archive/20231209/202312091549.7M8wMLX0-lkp@intel.com/config)
compiler: powerpc-linux-gcc (GCC) 13.2.0
reproduce: (https://download.01.org/0day-ci/archive/20231209/202312091549.7M8wMLX0-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202312091549.7M8wMLX0-lkp@intel.com/

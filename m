...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B35917EF594
	for <lists+linux-kernel@lfdr.de>; Fri, 17 Nov 2023 16:46:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345930AbjKQPqv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 17 Nov 2023 10:46:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58206 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231470AbjKQPqt (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 17 Nov 2023 10:46:49 -0500
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.9])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 22DA4E1
        for <linux-kernel@vger.kernel.org>; Fri, 17 Nov 2023 07:46:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1700236002; x=1731772002;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=6CTPXyD6+oDIQIktwehhdwf7JNKQ+BScji7AdvlF5ZI=;
  b=SoPVl2qMNOPh3HudTQzGu6dZxoT1rDvU+dpaUDjOtWvNFRE5MHTJPKO9
   15HASK7BaKDujDRxUEqm49esmS3pAdg30Kf6dV3tMFtCNvGJiG8XifDUE
   W1k1tHjnycR6pHQB9aMqaUvbquIutXRV9gqgkHpNpCz4uSbPZK4/5StZe
   1sDyjT34MI490OI6ZA65pkSTyMfYC1swIb4cuS3+0md6c3c/1l3PXTTVi
   vvtb2Co/IKt9YI9Wx3Q45V2iwzTH5dBCMh1Hg2yQgouMIOZl3SaZH+hgP
   kKTaWQwCA7sNOsXxha/pwgy/JRBfVlCi8b6cWN+8LEcsSKDsyEV6mL0kE
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10897"; a="9979748"
X-IronPort-AV: E=Sophos;i="6.04,206,1695711600"; 
   d="scan'208";a="9979748"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orvoesa101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Nov 2023 07:46:41 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10897"; a="836094176"
X-IronPort-AV: E=Sophos;i="6.04,206,1695711600"; 
   d="scan'208";a="836094176"
Received: from fsforza-mobl1.ger.corp.intel.com (HELO box.shutemov.name) ([10.249.44.215])
  by fmsmga004-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Nov 2023 07:46:35 -0800
Received: by box.shutemov.name (Postfix, from userid 1000)
        id 632B510A32D; Fri, 17 Nov 2023 18:46:32 +0300 (+03)
Date:   Fri, 17 Nov 2023 18:46:32 +0300
...
Message-ID: <20231117154632.zvi6g6lblmtvikzt@box>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="k5jzzbaxjy5oxudf"
Content-Disposition: inline
In-Reply-To: <ZVeApN4lDqTLu7ma@MiWiFi-R3L-srv>
...
--k5jzzbaxjy5oxudf
Content-Type: text/plain; charset=us-ascii
Content-Disposition: attachment; filename="tdx-guest.config"

Return-Path: <linux-kernel+bounces-139346-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 33FEA8A01A6
	for <lists+linux-kernel@lfdr.de>; Wed, 10 Apr 2024 23:04:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 9FD271F238F6
	for <lists+linux-kernel@lfdr.de>; Wed, 10 Apr 2024 21:04:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C08AE181D1A;
	Wed, 10 Apr 2024 21:04:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="PMkbBJlk"
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 44C8F181BBF;
	Wed, 10 Apr 2024 21:04:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712783066; cv=none; b=lvRV0Ce1zjKKbhiuKFPic7oNrP/LEKiUqUv2b6CobBdO2rzKFZRaurpnU6WbdFw7DxAOO3EMxN7HuTHNofLlmQ+MCc8lKHjZSsElLoU2BtJHQtWwxrwlGCPoMman3RbSLUGBxOun2QyOp85VljKaLWVLGXeBJhFLXo6UGtvO+eg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712783066; c=relaxed/simple;
	bh=mo+OL5VNcpVBxNV/0Ig0b5hr3MjLsn8VPue7TyTg/rc=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=k+ZrYc1Wc4sVn+hQ33iLJfvjhdX9LxbCIA7Y3dclp/8PeJ28MZiNa1XAS4uXXIqbdLIIyW6SdpZDB9tWmStNsqTxbHjsTDRJEXVYtWetKIKyEjycP8AeabYsv6NbngQEzxOXPGfw2Cs5nU40iYWWQXVuEhOOEAegRQr8WTd9kqA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=PMkbBJlk; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id A10AFC433C7;
	Wed, 10 Apr 2024 21:04:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1712783066;
	bh=mo+OL5VNcpVBxNV/0Ig0b5hr3MjLsn8VPue7TyTg/rc=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=
Date: Wed, 10 Apr 2024 18:04:23 -0300
...
Message-ID: <Zhb-17CrgZt_PdUH@x1>

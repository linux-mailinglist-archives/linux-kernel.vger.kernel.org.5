...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 09F50802153
	for <lists+linux-kernel@lfdr.de>; Sun,  3 Dec 2023 07:34:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233436AbjLCGef (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 3 Dec 2023 01:34:35 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58634 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233337AbjLCGeM (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 3 Dec 2023 01:34:12 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5B7A5188
        for <linux-kernel@vger.kernel.org>; Sat,  2 Dec 2023 22:33:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1701585227; x=1733121227;
  h=date:from:to:cc:subject:message-id:mime-version;
  bh=tGauHqf2EeKX6zIgQrQqmW8SPC4trHKBEjMzfvhJguA=;
  b=JdqJOXG0EATkEfcE3i9NWmH+j/uHgvEPZhECsTp7NOOETyfb+q31233E
   6XUvyuta0K272FF9GhND1uS6uR5KtE9JIIOW7wZiW5K9upl0zDLndr2bH
   r7AfS1Blc/PUKvnBje636Mh+5t1013A/j+dn1Yv6xRaLt/qat8KQno/Qg
   Bze7pemczxkbVYFW3WUmv7RY5UoXbovH37yOAYMv7flAR54J+ms+W397e
   nev7w3hB/z3sIo+cHgwyVu28qy4kBH1IwOg+5sY5LyC6qbveLGaiGgMbL
   TKb24Ky0n/l6zLwp4FfrCxD3AVgv2Dt2uhMNHTrqc+QAP6LgaKiogJ91h
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10912"; a="6906534"
X-IronPort-AV: E=Sophos;i="6.04,246,1695711600"; 
   d="scan'208";a="6906534"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Dec 2023 22:32:49 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10912"; a="770191158"
X-IronPort-AV: E=Sophos;i="6.04,246,1695711600"; 
   d="scan'208";a="770191158"
...
Date:   Sun, 3 Dec 2023 14:31:47 +0800
...
Message-ID: <202312030446.CakiThw1-lkp@intel.com>
MIME-Version: 1.0
...
date:   4 months ago
config: powerpc-randconfig-r121-20231107 (https://download.01.org/0day-ci/archive/20231203/202312030446.CakiThw1-lkp@intel.com/config)
compiler: powerpc-linux-gcc (GCC) 13.2.0
reproduce: (https://download.01.org/0day-ci/archive/20231203/202312030446.CakiThw1-lkp@intel.com/reproduce)

If you fix the issue in a separate patch/commit (i.e. not just a new version of
the same patch/commit), kindly add following tags
| Reported-by: kernel test robot <lkp@intel.com>
| Closes: https://lore.kernel.org/oe-kbuild-all/202312030446.CakiThw1-lkp@intel.com/

Return-Path: <linux-kernel+bounces-74869-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BFCE85DDC8
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 15:12:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1C2811F21C78
	for <lists+linux-kernel@lfdr.de>; Wed, 21 Feb 2024 14:12:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 716757EEF0;
	Wed, 21 Feb 2024 14:07:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="qDCqwG+/"
Received: from NAM02-SN1-obe.outbound.protection.outlook.com (mail-sn1nam02on2072.outbound.protection.outlook.com [40.107.96.72])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7CEE778B7C
	for <linux-kernel@vger.kernel.org>; Wed, 21 Feb 2024 14:07:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.96.72
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708524454; cv=fail; b=Z2E6tLiAyE90sxPlQ67GRUf1lMrD5q6FKz7RLOiDsYdMtC8NnEjcx57GlD24qAbsGeOeiVDOkILRywpC4J8zNKu0m6gZ8+tL9jwzW0cUPPQ9qXrmHNRu1IcTPXnK6EZvpNJYbFLfmf4O3rHmxucHigHrLTjKXq3Kxb4j0kkwONM=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708524454; c=relaxed/simple;
	bh=pXLFdXnGjaxn0xmU4nDXv/y34CnzZEr8cJsaHsNmoe0=;
	h=Content-Type:Message-ID:Date:Subject:To:Cc:References:From:
	 In-Reply-To:MIME-Version; b=r4f6oOd5PZWqpYDeDUWfLfdIzHNdavNhHIOLftvpzFRr0POiAyUx5d281ATChT+oSkJl7o9BBjbqmadHb00heeVgFQ6e8skzLSPA4LCR2v8Go56AHTrYJ+TgHzXWI7eKYr3sfivmW4Tdbywe2RNIKrdH7RcmXgOyMH3AQvUtB9Y=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=qDCqwG+/; arc=fail smtp.client-ip=40.107.96.72
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?utf-8?B?VFV2bC9pRDRhZjhmdVlLMVdJY3BJVm1KQU14NlNNS2xuQXlKcmVzSXNJWVJu?=
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 21 Feb 2024 14:07:26.2543
 (UTC)

Return-Path: <linux-kernel+bounces-35023-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B2EB838ABA
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 10:47:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id BFE9728AAA5
	for <lists+linux-kernel@lfdr.de>; Tue, 23 Jan 2024 09:47:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E6D4B5A790;
	Tue, 23 Jan 2024 09:44:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="UOTs9jwk"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5BD6759B6C
	for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 09:44:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706003095; cv=none; b=bEiWTHIUaysqmD7lbQnJRMKx6MxrWkhtxpcaJHzbPFWOJWeDWlqQITpYvii2FuNgbhlX/hJdpCEMtjfREVlF+tl15yPX+XHBesaDGXuU9TMTY1Up+3Xp8OPTRlxfUbxOnJQe44hG1zkDpT+bTHczpuVlk5vYXlrO5I19R1waN2c=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=UOTs9jwk; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=UOTs9jwkyvTTpl1cLjnk92nvioUPSlpPgkaLaGzcOPcs81DcQnmPQ+PWspYwfYaZ+4FxzX
	Ttl+2cTlf59FlJ1vIikCXd3ljDnOuBeaxJS26A6GRGw6Ztl+877vagdna8pJylGxU2vy69
	RrnaS0ojlJI8HWFv3y2cfx8RxGLWAkY=
Received: from mail-vs1-f71.google.com (mail-vs1-f71.google.com
 [209.85.217.71]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-201-HZV03QwhOT2HOAYp98aeWg-1; Tue, 23 Jan 2024 04:44:50 -0500
X-MC-Unique: HZV03QwhOT2HOAYp98aeWg-1
Received: by mail-vs1-f71.google.com with SMTP id ada2fe7eead31-46a9d50a8b4so216814137.1
        for <linux-kernel@vger.kernel.org>; Tue, 23 Jan 2024 01:44:50 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DpxKmM3l8Vl7kV3GYXjRni+YGoQ2Eibk4E8EGJ3z2IA=;
        b=
X-Gm-Message-State: AOJu0YydMqop4x6T3pSnl0JCxIRJJb/SCpsDWH+06Zw3R4s0eShu02ar
	od80IHZHxxc98GbMAITVPL3V6EH4HFAHJqtGlbjXo4iW+hFNWyd2CBJcWwlSAud7m5f/zfeQ1vG
	p9fp5q4C0ON70YcUK85x7SFbVa6s9PvcWvS2SaKx6c1jO3maFzjDUMu8gn7QliA==
X-Received: by 2002:a05:6122:c94:b0:4b6:c04b:3a1e with SMTP id ba20-20020a0561220c9400b004b6c04b3a1emr5163538vkb.0.1706003089599;

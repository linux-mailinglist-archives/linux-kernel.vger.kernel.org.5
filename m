Return-Path: <linux-kernel+bounces-72635-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 00E7185B684
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 10:03:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A89EC285076
	for <lists+linux-kernel@lfdr.de>; Tue, 20 Feb 2024 09:03:27 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A7CC55F471;
	Tue, 20 Feb 2024 09:02:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b="jwvlKsNs"
Received: from FRA01-MR2-obe.outbound.protection.outlook.com (mail-mr2fra01on2100.outbound.protection.outlook.com [40.107.9.100])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A30995C8F6
	for <linux-kernel@vger.kernel.org>; Tue, 20 Feb 2024 09:02:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.9.100
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708419729; cv=fail; b=q3eTkfvPEwoC6brqAS4L94x3+/kT7ZgNYt8bZQcZ13JqIVGN2HrphMwiC4pD7rACrHpdJQw98k78/2PWYOrRyClLEpa2oTJbbXvFXighzod+MWIcbjdaknUVuasLrV28AzvI6Qo3FaQ/Ykfc1wMz8qcVYYw/8uIko0J6o3rczqs=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708419729; c=relaxed/simple;
	bh=Uu++52cts8NMNgUucE0wPJ4q6rv4jYjqnsRV/rrvm0M=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=G5C7RkaQ8+/SK8qkV68DZ9mHaadQeXDTwE/baB5apop6LFs1G/tSI654iGdlC80c/atNM24PWrGDmu5tfabvcdX0821EFxFYRaASshj1dp3mKyQ6voeKyZbzUAp+zoiUqUxEhobPbr2lZbTQFV9BmKvsdvcuTljHGmYV8yLe2zM=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=csgroup.eu; spf=pass smtp.mailfrom=csgroup.eu; dkim=pass (2048-bit key) header.d=csgroup.eu header.i=@csgroup.eu header.b=jwvlKsNs; arc=fail smtp.client-ip=40.107.9.100
...
CC: "shenghui.qu@shingroup.cn" <shenghui.qu@shingroup.cn>,
	"dawei.li@shingroup.cn" <dawei.li@shingroup.cn>, "ke.zhao@shingroup.cn"
	<ke.zhao@shingroup.cn>, "luming.yu@gmail.com" <luming.yu@gmail.com>
...
x-ms-exchange-antispam-messagedata-0:
 =?utf-8?B?aDJkaXB4MWtZZnI0T2JNWDZIRnEwcHR0MDRkdExua2tEQndWOUdac1RXTE9F?=

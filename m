...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BE6FD7FAD3F
	for <lists+linux-kernel@lfdr.de>; Mon, 27 Nov 2023 23:17:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233956AbjK0WR3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 27 Nov 2023 17:17:29 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59846 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233953AbjK0WRH (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 27 Nov 2023 17:17:07 -0500
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 12F503A88
        for <linux-kernel@vger.kernel.org>; Mon, 27 Nov 2023 14:11:12 -0800 (PST)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-5d10f5bf5d9so10708897b3.3
        for <linux-kernel@vger.kernel.org>; Mon, 27 Nov 2023 14:11:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1701123071; x=1701727871; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=5WC7vO5+D828hw0GcRHUZ0tR86g1mSv6t2NIIETnn0g=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1701123071; x=1701727871;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=5WC7vO5+D828hw0GcRHUZ0tR86g1mSv6t2NIIETnn0g=;
        b=
X-Gm-Message-State: AOJu0Yyk13SqzX6/Ih4jk2R6WOxuWiiIB/7mz5vh4e2GSspDwsZj2R/A
        WnHDU9j9JXubmWJGnelAUztLmQgehtR1
X-Google-Smtp-Source: AGHT+IGmt6l4UxwWP718fQfp+ddlZPbiHkkNHffaFvouym1IWJG3IadCrTsJ7IbrlzZr50PkAfIJ7aq25Sr+
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:829:6e77:9093:f39b])
 ...
 id dt13-20020a05690c250d00b005ce3dd9a380mr326548ywb.2.1701123071087; Mon, 27
 Nov 2023 14:11:11 -0800 (PST)
Date:   Mon, 27 Nov 2023 14:08:59 -0800
In-Reply-To: <20231127220902.1315692-1-irogers@google.com>
Message-Id: <20231127220902.1315692-48-irogers@google.com>
Mime-Version: 1.0
References: <20231127220902.1315692-1-irogers@google.com>
X-Mailer: git-send-email 2.43.0.rc1.413.gea7ed67945-goog
Subject: [PATCH v5 47/50] perf dso: Add reference count checking and accessor functions
...
index 3364edf30f50..02f435375281 100644
...
@@ -1823,20 +1823,20 @@ static int dso__disassemble_filename(struct dso *dso, char *filename, size_t fil
...
index 54f7b7ec9cdd..da4ddc4bdc84 100644
--- a/tools/perf/util/header.c
+++ b/tools/perf/util/header.c
@@ -2307,7 +2307,7 @@ static int __event_process_build_id(struct perf_record_header_build_id *bev,
...
@@ -2315,13 +2315,13 @@ static int __event_process_build_id(struct perf_record_header_build_id *bev,

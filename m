...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 03D3C79C9B6
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Sep 2023 10:21:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232583AbjILIVy (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Sep 2023 04:21:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39778 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232460AbjILIVr (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Sep 2023 04:21:47 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0F1FE10C7
        for <linux-kernel@vger.kernel.org>; Tue, 12 Sep 2023 01:21:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1694506904; x=1726042904;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=ti7/r9NO/pFnQ+XqmL1xuZSvG1Zs3AoM9xj6/TDWKZ8=;
  b=J006qmvEKigY3L+yl+CksY78jljPOyr2VMmgxKH45aPJXi2RrrhS1V0M
   bgGSQ6CkNuXinvFcST+CY263hDlIwgZS6FSkmBw3EsUcAmJgPUXc77eGM
   UXClBo6fHbjAAfYspSsezSnmQeri11AL4ZFNHrvAWkWKgIK71SYvjTJju
   YiRQ+A5YNK4xZx8lGxhQTEJRt2qd4NbBFUXITf9xNWKRGaI0H5Vep6vrH
   F3N3NeeuQT7aLq6UGYUfr+v1z6xYrW6MDXDCZu0ufNpHZs4aN8Tcy5uVc
   FUOUFb64Qb49437NN2I/tXHXuUSvYmOZNcHhYtE7gwvXOAUF3D69bkyh/
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10830"; a="442323043"
X-IronPort-AV: E=Sophos;i="6.02,245,1688454000"; 
   d="scan'208";a="442323043"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Sep 2023 01:21:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10830"; a="746787664"
X-IronPort-AV: E=Sophos;i="6.02,245,1688454000"; 
   d="scan'208";a="746787664"
Received: from shicha9x-mobl.ccr.corp.intel.com (HELO yhuang6-mobl2.ccr.corp.intel.com) ([10.255.28.213])
  by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Sep 2023 01:21:37 -0700
...
Subject: [PATCH -V3 3/4] acpi, hmat: calculate abstract distance with HMAT
Date:   Tue, 12 Sep 2023 16:21:00 +0800
Message-Id: <20230912082101.342002-4-ying.huang@intel.com>

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0CC5A7D8BB1
	for <lists+linux-kernel@lfdr.de>; Fri, 27 Oct 2023 00:29:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344764AbjJZW3v (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 26 Oct 2023 18:29:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37204 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229694AbjJZW3u (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 26 Oct 2023 18:29:50 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.8])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DE2B2CC
        for <linux-kernel@vger.kernel.org>; Thu, 26 Oct 2023 15:29:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1698359388; x=1729895388;
  h=date:from:to:cc:subject:message-id;
  bh=pVDGdsjtKu8OTR+y918SpJ6pXkEuy7i6fD7anDnca1o=;
  b=L/ah7xORelqozrWr9GZiTG+Nlv0mSorjCK/LTLK/RW5feh8YPef+owj9
   PNtbVHmViTs3UvAPYdx+IR6emhGBpYuG6ByXkAbK/W+6UMJZ3syHaTZrB
   Wopi3QRJVtSx29atMeS3rcoBUsHkISjqDYu6lsqm86eV71wiOi4Bo2vqA
   N/EPTXWONJwsvdxeuylehIrGsNunyJC7epM60p0OQ0VtVI1hHNLjryzsX
   MJjedsWJrHU377QZgqFxhkiYHNpHWia0DcqIz9oUe+9wJ32xrMcHAcBtn
   NhynfwS5ebaOe/HAeNRrIAmNiEjeIf2yjkAJ/hm3gamIQFIcsScYeYPN1
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10875"; a="458482"
X-IronPort-AV: E=Sophos;i="6.03,254,1694761200"; 
   d="scan'208";a="458482"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmvoesa102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Oct 2023 15:29:47 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10875"; a="794391127"
X-IronPort-AV: E=Sophos;i="6.03,254,1694761200"; 
   d="scan'208";a="794391127"
Received: from lkp-server01.sh.intel.com (HELO 8917679a5d3e) ([10.239.97.150])
  by orsmga001.jf.intel.com with ESMTP; 26 Oct 2023 15:29:46 -0700
Received: from kbuild by 8917679a5d3e with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1qw8rH-000ABF-2l;
        Thu, 26 Oct 2023 22:29:43 +0000
Date:   Fri, 27 Oct 2023 06:29:25 +0800
From:   kernel test robot <lkp@intel.com>
To:     "x86-ml" <x86@kernel.org>
Cc:     linux-kernel@vger.kernel.org
Subject: [tip:x86/microcode] BUILD SUCCESS
 cf5ab01c87030a085e211a0a327535932ec6f719
Message-ID: <202310270622.qcPOFyNX-lkp@intel.com>
...
branch HEAD: cf5ab01c87030a085e211a0a327535932ec6f719  x86/microcode/intel: Add a minimum required revision for late loading

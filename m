Return-Path: <linux-kernel+bounces-76511-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FB7A85F826
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 13:27:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id D7030B24283
	for <lists+linux-kernel@lfdr.de>; Thu, 22 Feb 2024 12:27:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 30CDB612C2;
...
Received: from mail-vk1-f176.google.com (mail-vk1-f176.google.com [209.85.221.176])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CC9905FBA5
	for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 12:27:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708604832; cv=none; b=nkAiLcjTvthwwHDmsjgATrEuTn7DjH+VgTQDiDGwrdT9DXXPjSI6Jt4NNzsbV6EhgLjDfckSgdlT/TdhdcRo1ejPgUGU/QtTHCMwkscjYbdj4dhKD80NpK2vMZmYY8cmAj4+cX3YguTn7dFAJCv4XzYjyYasmzMoGAzTXCFYV2s=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=bgdev.pl; spf=none smtp.mailfrom=bgdev.pl; dkim=pass (2048-bit key) header.d=bgdev-pl.20230601.gappssmtp.com header.i=@bgdev-pl.20230601.gappssmtp.com header.b=Y3oBOrKP; arc=none smtp.client-ip=209.85.221.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=bgdev.pl
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=bgdev.pl
Received: by mail-vk1-f176.google.com with SMTP id 71dfb90a1353d-4cdfcb24b79so754191e0c.3
        for <linux-kernel@vger.kernel.org>; Thu, 22 Feb 2024 04:27:10 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=jauQlDLtoDoTZv/wYHS4jaWj+p+OfLWIznwN3L3gztY=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCWOxm1rUmsa96zPBIja583f0KrJW9V7By99Qjpv3F2sQbFsGCIlWrRRy91K1TUWNQFldTir0pVTgSOAuKU7rREeD8w9DeNUUNWAlUWs
X-Gm-Message-State: AOJu0YximM4edPzuK+9fQSPNxd/gajoQ98ONrl8KQnWv0IyF8RS5izQb
	351WxCLCW2ZKSnbNRUIrZkdhJaV0FcbEkKYYYcAg0qU/FrUi5wE+GfbT5h7jeOndF9qBebNPOkr
	jFzZaFNqulQ7eELNmaQqgekBDUNNJ/dJ5hDhHGA==

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 10C55757F2A
	for <lists+linux-kernel@lfdr.de>; Tue, 18 Jul 2023 16:15:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233165AbjGROPH (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 18 Jul 2023 10:15:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41750 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230243AbjGROPE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 18 Jul 2023 10:15:04 -0400
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 919AA1702;
        Tue, 18 Jul 2023 07:14:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1689689693; x=1721225693;
  h=date:from:to:cc:subject:message-id:
   content-transfer-encoding:mime-version;
  bh=YVdaVBLVhuSNEv+no6l93Lb8tPH5xh085Fn6q5ILQKw=;
  b=V+lLV28RIB0i37b3l3poTouSXRaGtFE1Qqrbnm4+L2u/GP2posIF2tGp
   6dbr2Ef5APYgYioccG4uIuu0GQ+tvGdXfKf5bO8rnBeNyo8Ik63vjPR8w
   AhdqmhFAXtsZQFOaazZH6gcnkNhK4Qd2F37GDo1Jj40Ht8U+hKq3KF66h
   XGRWlUmx3gH5YvTj2HKBNCQtHFSZo76cLLPQeJahoN9ojqegB/6RbmI+m
   D/fhN8gmIqvo7fOOYElLoY8RBVi+zyvKh+Tv0mTrh0ZHCmiANl7iVWVwC
   /T9kLXHvFmAHYqH1L6T+JsZJkPDMOIWXxsDP08k3mCoEzSdGd5F0/HhiE
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="356160849"
X-IronPort-AV: E=Sophos;i="6.01,214,1684825200"; 
   d="yaml'?scan'208";a="356160849"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Jul 2023 07:14:51 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10775"; a="837295013"
X-IronPort-AV: E=Sophos;i="6.01,214,1684825200"; 
   d="yaml'?scan'208";a="837295013"
Received: from orsmsx603.amr.corp.intel.com ([10.22.229.16])
  by fmsmga002.fm.intel.com with ESMTP; 18 Jul 2023 07:14:50 -0700
Received: from orsmsx610.amr.corp.intel.com (10.22.229.23) by
 ORSMSX603.amr.corp.intel.com (10.22.229.16) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27; Tue, 18 Jul 2023 07:14:50 -0700
Received: from orsedg603.ED.cps.intel.com (10.7.248.4) by
 orsmsx610.amr.corp.intel.com (10.22.229.23) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.27 via Frontend Transport; Tue, 18 Jul 2023 07:14:50 -0700
Received: from NAM12-DM6-obe.outbound.protection.outlook.com (104.47.59.174)
 by edgegateway.intel.com (134.134.137.100) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.1.2507.27; Tue, 18 Jul 2023 07:14:49 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=Xavt+hDsNsQdM5OdhxOjUJu6hfm417Qws5rEBkVRkMI=;
 b=
...
Received: from PH8PR11MB6779.namprd11.prod.outlook.com
 ...
 14:14:44 +0000
Date:   Tue, 18 Jul 2023 22:14:34 +0800
From:   kernel test robot <oliver.sang@intel.com>
To:     Yu Kuai <yukuai3@huawei.com>
CC:     <oe-lkp@lists.linux.dev>, <lkp@intel.com>,
        <linux-kernel@vger.kernel.org>, Song Liu <song@kernel.org>,
        <linux-raid@vger.kernel.org>, <ying.huang@intel.com>,
        <feng.tang@intel.com>, <fengwei.yin@intel.com>,
        <oliver.sang@intel.com>
Subject: [linus:master] [md/raid1]  7db922bae3:  aim7.jobs-per-min 140.4%
 improvement
Message-ID: <202307182121.25a5fc0b-oliver.sang@intel.com>
Content-Type: multipart/mixed; boundary="1CB1Ni25yiDsj8eQ"
...
X-MS-TrafficTypeDiagnostic: PH8PR11MB6779:EE_|PH7PR11MB8599:EE_
X-MS-Office365-Filtering-Correlation-Id: 552bf26d-ec7f-4c9b-4db4-08db87995554
X-LD-Processed: 46c98d88-e344-4ed4-8496-4ed7712e255d,ExtAddr
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PH8PR11MB6779.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230028)(376002)(366004)(39860400002)(346002)(136003)(396003)(451199021)(2906002)(6512007)(38100700002)(966005)(2616005)(82960400001)(83380400001)(21490400003)(186003)(6506007)(26005)(107886003)(1076003)(5660300002)(86362001)(235185007)(36756003)(30864003)(8676002)(4326008)(478600001)(6486002)(44144004)(6666004)(316002)(6916009)(66946007)(8936002)(66476007)(41300700001)(66556008)(2700100001)(579004)(559001)(357404004);DIR:OUT;SFP:1102;
X-MS-Exchange-AntiSpam-MessageData-ChunkCount: 1
X-MS-Exchange-AntiSpam-MessageData-0: =?iso-8859-1?Q?Hb2bsHkAmHTpJuZY+G9PkXCWPg8NMPESUkb5G/5b+YNWLZahk1TuMNrvZQ?=
 =?iso-8859-1?Q?UpKZeyxCw7l2L9uzoGhsOfaFTPgLu/Cf+rXqUx/DqfkT4vfqTFWEdawFpc?=
 =?iso-8859-1?Q?P7IKmXF2kiAYM+qHhoRlf5T3w/+aAYAWIppLP/tl/CK2NtqxQsP93F16sx?=
 =?iso-8859-1?Q?/HWyje7XBtoq7C20020AqmX9W5ZEy9O1gFYV8hkOAYaPyyyRZ1wZvOap+X?=
 =?iso-8859-1?Q?PxAsqplOiy3R9ZWMHlqanIWrp+PgjMOCPPdxfrqD5x39m5SoaFwcehefEq?=
 =?iso-8859-1?Q?DGPRlXnmHq/utJL/z5smnIfzYsQhCnhVKzIFLZILIGJxwq7W3hfrjNGNgi?=
 =?iso-8859-1?Q?SNlXRaGH8Rum8AvSprClK1OH7mvq8BvVIjkCjomk0i/vXFudPlvukFdyup?=
 =?iso-8859-1?Q?C2Pj9nUmwZkeIYgJ1pQgxDHN7Tl5OOTNqLzG7R489tR0tRtz9J/NCTa8VZ?=
 =?iso-8859-1?Q?r02S9QBNChRCl7JPkXzkW4JpZUjppZeG/B9e0AidJVuMBuOt2vYI8JYEEO?=
 =?iso-8859-1?Q?Ydgkc14uAdezyJdG+yKmHcvIxTUCs8PAlEPDCc/1H4LpZ6jDATu6wUacW8?=
 =?iso-8859-1?Q?z6pckuM7HY8GlQV4Q13Fts3srad7bUAQsiOg3dziFXci7bul6I0aLveeXr?=
 =?iso-8859-1?Q?UgNDfJEDahWBHUz+Ei/zLtlX9W5ZGcBX9Q/DQw5cu4rMnhrYEvWJqkA0mQ?=
 =?iso-8859-1?Q?rewDZHENDtbmyWXj3ffQLY+VGMdIy/oftMOsymXZWqPGr8gCzIncwavF7q?=
 =?iso-8859-1?Q?KHYfRo2OHa+wqrLKneUfzP5lgz9z/OU3IJn+VRWQkLZBYV8nMXIFKa00Nq?=
 =?iso-8859-1?Q?Q66OShQHvMmnVHmyuB2LEE3y3cfGTWKxstowpSlDe7HbXAy5xdgQsR49JQ?=
 =?iso-8859-1?Q?fVVhm/pKf89/aZATU07nUvP52Tcmc6VAJkJlpfDpYzoHAii6xHZVCyBPHe?=
 =?iso-8859-1?Q?fqRMjbiOHjTVsa+IJ/1XDMik6GkVk14f6rZkib5YUVBDfnMgtQINKapmte?=
 =?iso-8859-1?Q?NFYPaVUgIU7TOMy54LDOMpD5rRrAE0U0/HV1sz0l1f8lhyLFKqIyGSlpfu?=
 =?iso-8859-1?Q?e6DOV6INkApJxnK0NWkO6PjWTaE9Mzv1JlrpCeSzNQEMz9Hxw+Nu20N5Hp?=
 =?iso-8859-1?Q?bO0y0NjK4gl4BQX2D0eVZ8KJIZ15McY0gqVEjRTHFOIkFjlIv6bFr5QXff?=
 =?iso-8859-1?Q?+MpKcSDe9B76V6sCaTAafJuKbWHWUhT40BDBmCRlAGhJN+Fw2cesaHodyx?=
 =?iso-8859-1?Q?RpnYMv9MU628KaGqfqyL1aMdrFJlctWwWdK1peipcdLZmwhVz5SnXUAKjg?=
 =?iso-8859-1?Q?bwq8/gi9qaw3X62wJ5pWbZio8TnFj2dExpqV8arafMgbHM/gr1LIemOK0j?=
 =?iso-8859-1?Q?gCNag0m7gkcFoWR/1SLnx9V5fMJT9daoJd1ga6n4qGxzIp6quNRc8qRZWZ?=
 =?iso-8859-1?Q?VcqcKUSOkCKAj3IHc1SPZAgnNk1Li9oAKwO5vCslkwnZev+sUe3efx04ip?=
 =?iso-8859-1?Q?bGsGaEe2F+lJlUplcOlmm8RJcgg0m76T0HBF9ShUPK1A0DMyhYzLCERwvS?=
 =?iso-8859-1?Q?yZ/QW0Qahad7GREQM7Rx1N/T008nGZNMRWnqKXnToXhWGBEWjQIMw2YJ10?=
 =?iso-8859-1?Q?CxGPGGLlILkv8yn2scqI1HiFW7QvI4fSF0/HWl//SCIDxei8xzuD+pQA?=
 =?iso-8859-1?Q?=3D=3D?=
X-MS-Exchange-CrossTenant-Network-Message-Id: 552bf26d-ec7f-4c9b-4db4-08db87995554
X-MS-Exchange-CrossTenant-AuthSource: PH8PR11MB6779.namprd11.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Jul 2023 14:14:44.2109
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 46c98d88-e344-4ed4-8496-4ed7712e255d
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: 92ciLPE7/xeKFPkMNwRBn+umBQvwit/3tl+gBKAReGtKEeo9rq1zpePXv6pe0dhgEH8o2Ik+FSNB/lKuvRL7Eg==
X-MS-Exchange-Transport-CrossTenantHeadersStamped: PH7PR11MB8599
X-OriginatorOrg: intel.com
X-Spam-Status: No, score=-2.1 required=5.0 tests=BAYES_00,DKIMWL_WL_HIGH,
        DKIM_SIGNED,DKIM_VALID,DKIM_VALID_AU,DKIM_VALID_EF,LOTS_OF_MONEY,
        RCVD_IN_DNSWL_BLOCKED,RCVD_IN_MSPIKE_H3,RCVD_IN_MSPIKE_WL,
        SPF_HELO_NONE,SPF_NONE,T_MONEY_PERCENT,T_SCC_BODY_TEXT_LINE,
...
Content-Disposition: attachment;
	filename="config-6.4.0-rc2-00229-g7db922bae3ab"
...
kbuild_queue_analysis'
	...
	export submit_id='64b5ff0d6f6005b85c86d98f'
	export job_file='/lkp/jobs/queued/validate/lkp-csl-2sp3/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-11.1-x86_64-20220510.cgz-7db922bae3ab-20230718-47196-1t1h9je-5.yaml'
	export id='4ce52271ea7641f6431373490d6a135a089be2d6'
...
MD_RAID1
XFS_FS'
	export commit='7db922bae3abdf0a1db81ef7228cc0b996a0c1e3'
...
BLK_DEV_NVME'
	...
	export enqueue_time='2023-07-18 10:55:09 +0800'
	export _id='64b5ff0e6f6005b85c86d991'
	export _rt='/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3'
	export compiler='gcc-12'
	export head_commit='9431b358cf8a54e7198e78bf1947f0d22f156b4e'
	export base_commit='06c2afb862f9da8dc5efa4b6076a0e48c3fbaaa5'
	export branch='linus/master'
	export rootfs='debian-11.1-x86_64-20220510.cgz'
	export user='lkp'
	export LKP_SERVER='internal-lkp-server'
	export scheduler_version='/lkp/lkp/.src-20230718-092136'
	export arch='x86_64'
	export max_uptime=2100
	export initrd='/osimage/debian/debian-11.1-x86_64-20220510.cgz'
	export bootloader_append='root=/dev/ram0
RESULT_ROOT=/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3/vmlinuz-6.4.0-rc2-00229-g7db922bae3ab
branch=linus/master
job=/lkp/jobs/scheduled/lkp-csl-2sp3/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-11.1-x86_64-20220510.cgz-7db922bae3ab-20230718-47196-1t1h9je-5.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=7db922bae3abdf0a1db81ef7228cc0b996a0c1e3
nmi_watchdog=0
...
submit_id: 64b5eddf6f6005b50906690d
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp3/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-11.1-x86_64-20220510.cgz-7db922bae3ab-20230718-46345-14y4ry1-1.yaml"
id: 4afd9ecc336e743aceb453efc535bc75c48db1e2
queuer_version: "/zday/lkp"

#! /db/releases/20230711135438/lkp-src/hosts/lkp-csl-2sp3
model: Cascade Lake
nr_node: 2
nr_cpu: 96
memory: 128G
...
#! /db/releases/20230711135438/lkp-src/include/testbox/lkp-csl-2sp3
need_kconfig_hw:
- PTP_1588_CLOCK: y
- IGB: y
- SATA_AHCI
...
#! /db/releases/20230711135438/lkp-src/include/disk/nr_brd

#! /db/releases/20230711135438/lkp-src/include/md/raid_level

#! /db/releases/20230711135438/lkp-src/include/fs/OTHERS
kconfig: x86_64-rhel-8.3
enqueue_time: 2023-07-18 09:41:51.902225844 +08:00
_id: 64b5f21c6f6005b50906690e
_rt: "/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3"
compiler: gcc-12
head_commit: 9431b358cf8a54e7198e78bf1947f0d22f156b4e
base_commit: 06c2afb862f9da8dc5efa4b6076a0e48c3fbaaa5
branch: linux-devel/devel-hourly-20230716-050441
rootfs: debian-11.1-x86_64-20220510.cgz

#! schedule options
user: lkp
LKP_SERVER: internal-lkp-server
scheduler_version: "/lkp/lkp/.src-20230718-092136"
arch: x86_64
max_uptime: 2100
initrd: "/osimage/debian/debian-11.1-x86_64-20220510.cgz"
bootloader_append:
- root=/dev/ram0
- RESULT_ROOT=/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3/0
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3/vmlinuz-6.4.0-rc2-00229-g7db922bae3ab
- branch=linux-devel/devel-hourly-20230716-050441
- job=/lkp/jobs/scheduled/lkp-csl-2sp3/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-11.1-x86_64-20220510.cgz-7db922bae3ab-20230718-46345-14y4ry1-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=7db922bae3abdf0a1db81ef7228cc0b996a0c1e3
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3/modules.cgz"
...
oom-killer:
watchdog:
job_initrd: "/lkp/jobs/scheduled/lkp-csl-2sp3/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-11.1-x86_64-20220510.cgz-7db922bae3ab-20230718-46345-14y4ry1-1.cgz"
last_kernel: 5.4.0-0.bpo.2-amd64
repeat_to: 3

#! user overrides
kbuild_queue_analysis: 1
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3/vmlinuz-6.4.0-rc2-00229-g7db922bae3ab"
result_root: "/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-csl-2sp3/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3/gcc-12/7db922bae3abdf0a1db81ef7228cc0b996a0c1e3/0"

#! /cephfs/db/releases/20230717104637/lkp-src/include/site/inn
dequeue_time: 2023-07-18 10:07:09.294305636 +08:00
job_state: finished
loadavg: 136.84 74.84 28.95 1/1278 9794
start_time: '1689646176'
end_time: '1689646281'
version: "/lkp/lkp/.src-20230718-092219:837c1a10c80e:17599cc1ddc0"

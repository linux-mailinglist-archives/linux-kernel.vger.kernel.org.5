Return-Path: <linux-kernel+bounces-132018-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 7A4AD898ECA
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 21:15:57 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A6DDF1C28DD3
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Apr 2024 19:15:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 438971332A5;
	Thu,  4 Apr 2024 19:15:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="ECTMIS3d"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 106E013119B
	for <linux-kernel@vger.kernel.org>; Thu,  4 Apr 2024 19:15:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712258148; cv=none; b=nc1RQN0p0IEZEolR1c2VzBSubatVU3OJ/HxVWAjlZZBfLgthp5EMNtdggC8nrNZc1hdf6NaKESDt1sTvXzSyxLgedFMhSTZyRW+DTfrVA+5WA6WsivhoDzdfKyMXWybOkJ6szk9EFAmU+XzAIQHj1YjbGPz1AKS0EfIAJyNGYio=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=ECTMIS3d; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1712258146;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=DCZG5ObzE9WUSY2qW3iWoIf9WaEiLX6H+jscUqcuG84=;
	b=ECTMIS3db//N+nm3ybMYYqpfqOZyT7fq8aV9ho8KbwAO119C9IjJD98iBug7311BR5gnby
	4UtmtZz2OsT2bTpqZhP5NqNmq+P6KO0TfymlpB8/HU8rpv3D4/ZFFaM0ID/K0dw3OqnuFF
	AdsojFh+9ElByjscJtzoY7CQ44Y5tjo=
Received: from mail-lj1-f199.google.com (mail-lj1-f199.google.com
 [209.85.208.199]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-649-4lC4zO4bMK2kt1jeReFHMw-1; Thu, 04 Apr 2024 15:15:44 -0400
X-MC-Unique: 4lC4zO4bMK2kt1jeReFHMw-1
Received: by mail-lj1-f199.google.com with SMTP id 38308e7fff4ca-2d486c08c6eso12915571fa.0
        for <linux-kernel@vger.kernel.org>; Thu, 04 Apr 2024 12:15:43 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DCZG5ObzE9WUSY2qW3iWoIf9WaEiLX6H+jscUqcuG84=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCV2fpOa/0CalXQQEMZWzjteC3NoZXNFJfY6zYLfXO8XM32xVqP2QVMEmF3BaK2zji76X+xvpjh7TAq70f2Fogz7R5qNw+GCHlFepTsp
X-Gm-Message-State: AOJu0Yxu0+PhPMgYyXsahO2/MyR9KiBJdFHQ/oRWUTxuqFWMRQJUdFvm
	rXYCh9VRpXIrE3W1tXLt2QhfY+fOz7FUELNF/N6uqivNaeDr2qiHwE111luARFIxmYfXoYZg+R1
	UWvWJ0wiFF173zUb/J050v8l6OyBOzvR39W3np2kIf6P+pkw5lelAxEJ3/Et27g==
X-Received: by 2002:a2e:86cc:0:b0:2d4:67d8:7bbf with SMTP id n12-20020a2e86cc000000b002d467d87bbfmr159063ljj.47.1712258142703;

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F40C77CEB7B
	for <lists+linux-kernel@lfdr.de>; Thu, 19 Oct 2023 00:51:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232082AbjJRWvL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 18 Oct 2023 18:51:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42920 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229924AbjJRWvI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 18 Oct 2023 18:51:08 -0400
Received: from mail-oo1-xc2c.google.com (mail-oo1-xc2c.google.com [IPv6:2607:f8b0:4864:20::c2c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1ECC3116
        for <linux-kernel@vger.kernel.org>; Wed, 18 Oct 2023 15:51:06 -0700 (PDT)
Received: by mail-oo1-xc2c.google.com with SMTP id 006d021491bc7-581fb6f53fcso575867eaf.2
        for <linux-kernel@vger.kernel.org>; Wed, 18 Oct 2023 15:51:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=rivosinc-com.20230601.gappssmtp.com; s=20230601; t=1697669465; x=1698274265; darn=vger.kernel.org;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=11HgkmJwUW4khfF5QifIk7vYcCQBT3/MHwOSE1WT73k=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1697669465; x=1698274265;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=11HgkmJwUW4khfF5QifIk7vYcCQBT3/MHwOSE1WT73k=;
        b=
X-Gm-Message-State: AOJu0Yyfx1QR4pAgZwuHpOWr8KsIC2l6YXSSBOTdJuZSx3HogO29KUAD
        57x+SGKSaLFBmZKeTnD+E8H/Rg==
X-Google-Smtp-Source: AGHT+IHtOQYS2QqSczOtKbP3AvdW10GZcd55pjsr0xvYcEdpuODA0HP9rHZl+9a7GcrYdsNIbBCSYg==
X-Received: by 2002:a05:6820:2007:b0:57b:7ac4:7a94 with SMTP id by7-20020a056820200700b0057b7ac47a94mr629139oob.2.1697669465396;
        Wed, 18 Oct 2023 15:51:05 -0700 (PDT)
Received: from charlie.ba.rivosinc.com ([64.71.180.162])
        by smtp.gmail.com with ESMTPSA id r195-20020a4a37cc000000b00581e7506f2fsm641134oor.9.2023.10.18.15.51.03
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 18 Oct 2023 15:51:04 -0700 (PDT)
From:   Charlie Jenkins <charlie@rivosinc.com>
Date:   Wed, 18 Oct 2023 15:51:01 -0700
Subject: [PATCH v5 1/3] riscv: Avoid unaligned access when relocating
 modules
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20231018-module_relocations-v5-1-dfee32d4dfc3@rivosinc.com>

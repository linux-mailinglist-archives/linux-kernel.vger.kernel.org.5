...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D2410812E26
	for <lists+linux-kernel@lfdr.de>; Thu, 14 Dec 2023 12:07:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1443995AbjLNLHR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 14 Dec 2023 06:07:17 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42766 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1443948AbjLNLHE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 14 Dec 2023 06:07:04 -0500
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E6DA5181
        for <linux-kernel@vger.kernel.org>; Thu, 14 Dec 2023 03:06:57 -0800 (PST)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-5caf86963ecso89074657b3.3
        for <linux-kernel@vger.kernel.org>; Thu, 14 Dec 2023 03:06:57 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1702552017; x=1703156817; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=ZQcjn3HKRIFjRjPtUqZGi0kpXnoJ+H0gJj/u7XtaxV0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1702552017; x=1703156817;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=ZQcjn3HKRIFjRjPtUqZGi0kpXnoJ+H0gJj/u7XtaxV0=;
        b=
X-Gm-Message-State: AOJu0YyYP8eqyJ70uTzwuPsPQw5ZgqIGN25W2eqPfedikCNIOkYpi/hg
        zyTc02JPxvivEZv/6dtFGgJ2nObifNk=
X-Google-Smtp-Source: AGHT+IHZUxlk2ydWjkVM3eEnz5UgSsZtEHF9ttwaUfzN+X+521ZJ4sG4g8taV4ZW5sGtfxhkEsk7VUFm2Qs=
X-Received: from glider.muc.corp.google.com ([2a00:79e0:9c:201:8447:3e89:1f77:ff8a])
 ...
 ci1-20020a05690c0a8100b005df4a9bfb6cmr109547ywb.3.1702552017196; Thu, 14 Dec
 2023 03:06:57 -0800 (PST)
Date:   Thu, 14 Dec 2023 12:06:36 +0100
In-Reply-To: <20231214110639.2294687-1-glider@google.com>
Mime-Version: 1.0
References: <20231214110639.2294687-1-glider@google.com>
X-Mailer: git-send-email 2.43.0.472.g3155946c3a-goog
Message-ID: <20231214110639.2294687-5-glider@google.com>
Subject: [PATCH v10-mte 4/7] arm64: mte: implement CONFIG_ARM64_MTE_COMP

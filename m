Return-Path: <linux-kernel+bounces-85001-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id F40E686AEF5
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 13:18:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id AA59A285728
	for <lists+linux-kernel@lfdr.de>; Wed, 28 Feb 2024 12:18:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 97C8C3BBD0;
	Wed, 28 Feb 2024 12:18:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="RlmCzf5e"
Received: from mail-vk1-f180.google.com (mail-vk1-f180.google.com [209.85.221.180])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E24107353F
	for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 12:18:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.221.180
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709122714; cv=none; b=rz/EOkaIlkoQp/1kfaJxQq2JIMGDGPQVkBdk9wxdwYVLUFN2Vtye8KvZ5HrJlI91pTY5mVNAr+rqfUGHn36Ii2tXFB0fJo7ip/7IbWLP5y4718UvX3v0ElltUxPVZiAk63U3cYR4V2L81akbH2L+PFKnCRS+wB9yfujLZDH3d/s=
...
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org; spf=pass smtp.mailfrom=linaro.org; dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b=RlmCzf5e; arc=none smtp.client-ip=209.85.221.180
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linaro.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linaro.org
Received: by mail-vk1-f180.google.com with SMTP id 71dfb90a1353d-4cba3807eedso448741e0c.0
        for <linux-kernel@vger.kernel.org>; Wed, 28 Feb 2024 04:18:32 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YlskfN1DI9w+4vTieSyWqmbDOGNXlKANaEiK2f9kMpk=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU6Cj92X7MA01+UgdEOUNaVoQjlxpzHYbv5QblX0AjFX6fmN0OHvn1ILjm6IGjsLAtybNfykkYOiMtgBkrej+pkWawvh5Tw5yKBw0cE
X-Gm-Message-State: AOJu0Yzvpnp8D24LK+OfHFgyAhgNHG7/73AMZQtOGXij4aAb8Ej0HXqE
	YU+n6vZPb0qz9OgIKUr9sMQxAhrOnffRMAW9PF5EyUG3wh9+ao7LcV+Dm8v8m4Y=

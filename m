Return-Path: <linux-kernel+bounces-44913-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A747842901
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 17:22:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 1061728480B
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jan 2024 16:22:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F19441272BA;
	Tue, 30 Jan 2024 16:22:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="xXbj6kk5"
Received: from mail-wm1-f50.google.com (mail-wm1-f50.google.com [209.85.128.50])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C255586AEC
	for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 16:22:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.50
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706631735; cv=none; b=F+Y8Ou1/OCINVgTRQF+LkEp8Ar81DEJxmw4vEXA2k0kjbmfM1+MycvaQSlT9/ohc4lnXrZ6WgJ1AKF3T1X2djqrruyJqYeEgoPAE0u8e9u8uCkh4/vtrLBEUVbMuoHVQ4hKiC8Nk8nNoEuJBjVY4hVvUeEkllpFn/8RG+BPh8Cc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706631735; c=relaxed/simple;
	bh=23d9Jk79FUYOsMzaTSvIET6y9QKX2F5rPhNS+3vO9f0=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=Mq5CU/kvX0kFHR1NStEC7LYhwOGeniFkYRWb9F6BGVXa2rbjh3N0IUocgt81qkQeU6LPFOrd6JZ847bUH92ls+uEy9uNfS+tKmUg9JbQaEu9cG71EhZ/NdW5rENTBZhKO4hGvTRJ2pLrnSzrRFq7BX7gkSyiMi3P6bc+aDxYbfw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=xXbj6kk5; arc=none smtp.client-ip=209.85.128.50
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=google.com
Received: by mail-wm1-f50.google.com with SMTP id 5b1f17b1804b1-40e76626170so45612945e9.2
        for <linux-kernel@vger.kernel.org>; Tue, 30 Jan 2024 08:22:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1706631731; x=1707236531; darn=vger.kernel.org;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
        bh=Xi81N63fN6oM3d4JV9/CJyrJqsEWdLtHeD0rXmz99AA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706631731; x=1707236531;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Xi81N63fN6oM3d4JV9/CJyrJqsEWdLtHeD0rXmz99AA=;
        b=
X-Gm-Message-State: AOJu0YzBOC/JDgli+nSJOFEMpTNnpncHp0keA9ulODzCyxxsV72CShYe
	bjsn6J0vyr4Drhv7AS1SS9nq+3PLcItDwP0CCjS6sIkPGEr60H7u5YhLrl5bOA==
X-Google-Smtp-Source: AGHT+IEJTPKDlkRG92zVhrBD8rZwt1TMztInSMqO1j7bC+v1zH762Kajh3reNyydhpLCtrXmz7Slow==
X-Received: by 2002:a05:600c:3514:b0:40e:fc29:f527 with SMTP id h20-20020a05600c351400b0040efc29f527mr2556232wmq.31.1706631730765;
        Tue, 30 Jan 2024 08:22:10 -0800 (PST)
Received: from google.com (185.83.140.34.bc.googleusercontent.com. [34.140.83.185])
        by smtp.gmail.com with ESMTPSA id b6-20020a05600003c600b0033aed4e3b55sm6015779wrg.102.2024.01.30.08.22.10
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 30 Jan 2024 08:22:10 -0800 (PST)
Date: Tue, 30 Jan 2024 16:22:06 +0000
From: Vincent Donnefort <vdonnefort@google.com>
To: Masami Hiramatsu <mhiramat@kernel.org>, g@google.com
Cc: rostedt@goodmis.org, linux-kernel@vger.kernel.org,
	linux-trace-kernel@vger.kernel.org, mathieu.desnoyers@efficios.com,
	kernel-team@android.com
Subject: Re: [PATCH v13 2/6] ring-buffer: Introducing ring-buffer mapping
 functions
Message-ID: <ZbkiLjUKmgg6oXR5@google.com>
...
In-Reply-To: <20240130235510.c92a31ee6998697dd49d2600@kernel.org>

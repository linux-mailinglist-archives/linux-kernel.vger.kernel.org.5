Return-Path: <linux-kernel+bounces-82182-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 8B54E86805D
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 20:04:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A5F5F1C25A48
	for <lists+linux-kernel@lfdr.de>; Mon, 26 Feb 2024 19:04:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 08B03130AD5;
	Mon, 26 Feb 2024 19:03:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="EzQdKeVr"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CB15012F583
	for <linux-kernel@vger.kernel.org>; Mon, 26 Feb 2024 19:03:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708974232; cv=none; b=CvPAl0iUEKTcXHER7yt/Ea/BXVoRIA5s31pj7nD7KlP6nqsMTyaEUodTSV8LpXbcz++AQBPVY6Ch+IIgVj/8WdO4jSy9cBa/yBiQevbLnXFxsLvovQNz6v0S3ulz40LeiXJ2CIIOj4yCB2fwsM6OywUV+wbm08OSpX7cTpGwTD0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708974232; c=relaxed/simple;
	bh=JP2AhCp0qhW1Bb/uQ0B1c8bqZUtYcKr6siTzy/oGLZg=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version:Content-Type; b=h2lZiVzEQG4crTk1yrt4oFBo4xeMIa9XceBueqlq/y2s7NbhE9zAPBbxaobug1QtvsMEibwdQuwki5hQOvJ92D8veDujAkpRqFV+2CD3Wz3KLUFH+oRzQ6NiBezFeP3w3Bi6U9rPc5P+QqGEVgSWBTHTQl/p3kUaQwpn1FDBcts=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=EzQdKeVr; arc=none smtp.client-ip=170.10.129.124
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	b=EzQdKeVrgoMr+Gckaf6xVbPKwA37YilCOE4AsCq1EEoA5AsZgobVNRaoF/dBHW4CJ3N3AW
	MEBvWIRfIXb/0UEdpE69rMHNO0UTOg4bjT7bhbkKELKTgjit490IoWD0aa/Yj1j1A/jtD3
	JZW8GuLnEB/gIHtaAZA0Rk4IQkt6WpA=

...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7F60A7EBB9D
	for <lists+linux-kernel@lfdr.de>; Wed, 15 Nov 2023 04:14:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234342AbjKODOd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 14 Nov 2023 22:14:33 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38224 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229572AbjKODOb (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 14 Nov 2023 22:14:31 -0500
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0AD80A7
        for <linux-kernel@vger.kernel.org>; Tue, 14 Nov 2023 19:14:28 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1700018068; x=1731554068;
  h=date:from:to:cc:subject:message-id:references:
   in-reply-to:mime-version;
  bh=l/dRyEOVygp1kxZBnb43VWa24kgynI7fdjJzB0pMGXM=;
  b=cUJ+61KJ0rhMA2/R714Ir/oIKZa1m7pH3AIGNrzgtXzkFlOfnibaQ/kK
   PXuKm8ta1VxtyO+UWpNYlccOJixBHDcex+BV1yqzwK9lXCI5lqy3zyUiM
   oDSWJ26khdVmCkUj20D7nO+6F7EKy1mnIiGzUswph633C+xmYXtvRfvuB
   gECh5qTlHiJKiOxaLkwdigvHQgyNFPAgcbDj61BnBxot3Zqhr8aVyrMQs
   o7rqygmjSrn33eSkXrsO+3yS4tURnCZG+54/MTp3t2QxefT3YHElDF1xQ
   D5hdMmtGqX2cmcl8pAK7YKZPe3yMpPOM8/PABW/AkwdSZrYLLONl8kxy1
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10894"; a="389652780"
X-IronPort-AV: E=Sophos;i="6.03,303,1694761200"; 
   d="scan'208";a="389652780"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Nov 2023 19:14:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10894"; a="830822485"
X-IronPort-AV: E=Sophos;i="6.03,303,1694761200"; 
   d="scan'208";a="830822485"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
  by fmsmga008.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 14 Nov 2023 19:14:13 -0800
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MN0PR11MB6059.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(39860400002)(396003)(366004)(346002)(136003)(376002)(230922051799003)(186009)(451199024)(1800799009)(64100799003)(36756003)(86362001)(82960400001)(83380400001)(38100700002)(107886003)(26005)(6512007)(478600001)(6666004)(6486002)(2616005)(6506007)(54906003)(4326008)(6916009)(8936002)(66946007)(66476007)(66556008)(316002)(7416002)(8676002)(41300700001)(5660300002)(44832011)(2906002);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 15 Nov 2023 03:14:04.8184
 (UTC)

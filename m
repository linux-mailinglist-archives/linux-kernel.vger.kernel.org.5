Return-Path: <linux-kernel+bounces-102294-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2EEBF87B042
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 19:48:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CF73328D8E8
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Mar 2024 18:48:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BBD98664DD;
	Wed, 13 Mar 2024 17:45:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b="SY2r2Hz9"
Received: from relay2-d.mail.gandi.net (relay2-d.mail.gandi.net [217.70.183.194])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EA05F664B7
	for <linux-kernel@vger.kernel.org>; Wed, 13 Mar 2024 17:45:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.194
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710351938; cv=none; b=QlTc9satkvAgI0nBrGfs68r3hGRT3lNGKIVl7D3r9SYSeIsEzUcIkoFwJbhOskZo4QMZEtqBNS8Fyt8JKzVbCWmhs8xSg7ky2ds4q0ZjnEY/C0swe1uWAqC2pPKoGNdC4IjouFjoCiHY+gm/G6+IXYyIekFDTgmxpkRChGLyZmQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710351938; c=relaxed/simple;
	bh=SrBB5KXz1QL9eQ48nY2Dv3KvNWc0/mA4SAe3dTkfyww=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=BMtYf9NTvpkpD5mmqsSb4b/xzV4sZr1J5aXJwO4l6Vz51qCxbXExzALKqEyD53rWDbOPmuERPxkQGOjeDcZYlK2YCe7NiGkkYR5TRH8Zkub0sptp9EbXfqxN9nWdfy4pBehU48uz2tDauyz73ESFQfuMRi+HxuIRQvw25EZ1N8A=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=bootlin.com; spf=pass smtp.mailfrom=bootlin.com; dkim=pass (2048-bit key) header.d=bootlin.com header.i=@bootlin.com header.b=SY2r2Hz9; arc=none smtp.client-ip=217.70.183.194

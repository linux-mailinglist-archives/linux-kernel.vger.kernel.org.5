Return-Path: <linux-kernel+bounces-93455-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B1AF873011
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 08:57:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 8CD221F24C80
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 07:57:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C008F5D46F;
	Wed,  6 Mar 2024 07:56:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b="aQpmH65o"
Received: from EUR05-VI1-obe.outbound.protection.outlook.com (mail-vi1eur05on2074.outbound.protection.outlook.com [40.107.21.74])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DE8265D8FB;
	Wed,  6 Mar 2024 07:56:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.21.74
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709711791; cv=fail; b=GXKLD2fz/quQz+pWSSRB6y20n3Ryf+TLBe6YM7FxO1afCHproS9Ztzb1V1p+jarBVcENrBMGN8G3cc6CdRdzYIfixNxH5KaJbkNHvCSZVarEcTB/npePS8Pe3M8QVVvrfEMvG23CEDjej4fmakXE0MZhI4ahmxZeblP5KT4NjVU=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709711791; c=relaxed/simple;
	bh=xX5NUeP9+fwEJxl+VNwTwWVDv1TtsGNieqfcR6+rZTo=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 Content-Type:MIME-Version; b=umGsD+PfpyzJ35ItKza9glH5kt8FDxgFyakRpaRxi0QRkGHPq79LRDX8hA5OElXQKTuTHJegZbm54ISfNsWe8EVCt2Jh9qZ7Ycq6yDlNnBk4rU3Pt6WqNj8YxlheT/khV1ElOsAeRkVOY7bEwsx2m55dmEbtIOh+q1D8N17nkk0=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com; spf=pass smtp.mailfrom=nxp.com; dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b=aQpmH65o; arc=fail smtp.client-ip=40.107.21.74

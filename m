...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E98C277B4BD
	for <lists+linux-kernel@lfdr.de>; Mon, 14 Aug 2023 10:54:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235186AbjHNIy0 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Aug 2023 04:54:26 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58320 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234576AbjHNIxp (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Aug 2023 04:53:45 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [193.142.43.55])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ABF9B91
        for <linux-kernel@vger.kernel.org>; Mon, 14 Aug 2023 01:53:43 -0700 (PDT)
Message-ID: <20230814085112.329006989@linutronix.de>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020; t=1692003222;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=52X33TUdbJY3w3NYjSien2DrY3Pjfc5G/xtc8uHKfJ0=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1692003222;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         references:references; bh=52X33TUdbJY3w3NYjSien2DrY3Pjfc5G/xtc8uHKfJ0=;
        b=dZIPJhRvvDbV/tXNsWnopDpKWyR2KbzIINFWy17fx35MlDn3HLs9VLYU/hkSebI7xtEWcK
        sTbJFPu2cDOPViBw==
...
Subject: [patch V4 05/41] x86/cpu: Move phys_proc_id into topology info
References: <20230814085006.593997112@linutronix.de>
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8
Date:   Mon, 14 Aug 2023 10:53:41 +0200 (CEST)
...
@@ -456,9 +456,9 @@ static void amd_detect_cmp(struct cpuinf
...
@@ -122,9 +122,9 @@ static void hygon_detect_cmp(struct cpui
 	/* Low order bits define the core id (index of core in socket) */
 	c->cpu_core_id = c->topo.initial_apicid & ((1 << bits)-1);
 	/* Convert the initial APIC ID into the socket ID */
-	c->phys_proc_id = c->topo.initial_apicid >> bits;

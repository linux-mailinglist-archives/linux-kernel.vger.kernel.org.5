...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1D42D7888C1
	for <lists+linux-kernel@lfdr.de>; Fri, 25 Aug 2023 15:34:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245239AbjHYNeC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 25 Aug 2023 09:34:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58120 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S245152AbjHYNd0 (ORCPT
...
Received: from icts-p-cavuit-1.kulnet.kuleuven.be (icts-p-cavuit-1.kulnet.kuleuven.be [IPv6:2a02:2c40:0:c0::25:132])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F0247E6F;
        Fri, 25 Aug 2023 06:33:24 -0700 (PDT)
X-KULeuven-Envelope-From: jo.vanbulck@cs.kuleuven.be
X-Spam-Status: No, score=-2.0 required=5.0 tests=BAYES_00,DKIM_SIGNED,
        DKIM_VALID,DKIM_VALID_AU,RCVD_IN_DNSWL_BLOCKED,SPF_HELO_NONE,SPF_PASS
        autolearn=ham autolearn_force=no version=3.4.6
X-KULeuven-Scanned: Found to be clean
X-KULeuven-ID: 32B7F2020B.A2BA0
...
Received: from icts-p-ceifnet-smtps-0.kuleuven.be (icts-p-ceifnet-smtps.service.icts.svcd [IPv6:2a02:2c40:0:51:144:242:ac11:2f])
        by icts-p-cavuit-1.kulnet.kuleuven.be (Postfix) with ESMTP id 32B7F2020B;
        Fri, 25 Aug 2023 15:33:21 +0200 (CEST)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=cs.kuleuven.be;
        ...
        b=ZZ+bnnv4WacoQmK+UBl1y3xZusulyHs0hYkARbAISZBNNMxcbxVbtPEJ2GllJqxqT
         n4wBVGFRT50svdkgUDtZv7BUyQ2ePuzVOH+BVZKoo8gVmHVdjDuezY3rX2XYYpU1Qt
         /RTDfKdOog+DaSFn+/U566H2HAKzLltXofL4SAFg=
Received: from localhost.localdomain (ptr-82s0fs8e775rpuqrs36.18120a2.ip6.access.telenet.be [IPv6:2a02:1811:d31:8b00:b56b:371:2317:a8f2])
        ...
        by icts-p-ceifnet-smtps-0.kuleuven.be (Postfix) with ESMTPSA id EC51ED4EBACBB;
        Fri, 25 Aug 2023 15:33:20 +0200 (CEST)
...
Subject: [PATCH v4 13/13] selftests/sgx: Remove incomplete ABI sanitization code in test enclave
Date:   Fri, 25 Aug 2023 15:32:52 +0200
Message-Id: <20230825133252.9056-14-jo.vanbulck@cs.kuleuven.be>

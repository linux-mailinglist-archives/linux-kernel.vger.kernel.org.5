Return-Path: <linux-kernel+bounces-30562-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id B5D2483208D
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 21:42:35 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 31B671F248E4
	for <lists+linux-kernel@lfdr.de>; Thu, 18 Jan 2024 20:42:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 76CF42E855;
	Thu, 18 Jan 2024 20:42:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="HvL8zan9"
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.100])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 956742E64E
	for <linux-kernel@vger.kernel.org>; Thu, 18 Jan 2024 20:42:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=134.134.136.100
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705610540; cv=fail; b=ItP5M/EWxSrD6pomRzneMu49YgRFK4aM5YhzoNIyV8xjjEdpPSZRfd4wUAVXs1G2PqYb6CqGN6ZUH/+e9ynHwV4lcFd7nQfNuieyoiXOpNlVokFsFmYkHTTYY6dfhPzevCcbyUZ5gSjB1dgDxPN2Jt0r7V6L7UV3qLqVwFijJkc=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705610540; c=relaxed/simple;
	bh=aFBnduirpltcw5DP+wUw92+EaR5az9SPmErGJy5crDg=;
	h=Date:From:To:CC:Subject:Message-ID:References:Content-Type:
	 Content-Disposition:In-Reply-To:MIME-Version; b=r91lreWSek9VcWnUrM4KJ5gR8Ji6pP0fHM/UabK9MStE94gOkogd4Dfu5kQvj7LB9X9ZPZhRccLt0YLsP+Tv2w9lMYyTeDKnk5HIieCXwJMF6z0yAGFq+y/Q5ioxPP1TETxXZAnOqbGca3ampHB3crfC1CYdoImN+OEC0AYNmOg=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=HvL8zan9; arc=fail smtp.client-ip=134.134.136.100
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=HvL8zan9yR0AbuxRauNfrXTfGEvsM1423C4iSxz4/cuMmjdJD39YKKPB
   ...
   TUhUdAg+Xef5FhaaxtldWKRqDUEQVBf1v9ytI96zma6h2FIgWjlInn/Tr
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10956"; a="466946577"
X-IronPort-AV: E=Sophos;i="6.05,203,1701158400"; 
   d="scan'208";a="466946577"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Jan 2024 12:42:17 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10956"; a="875193211"
X-IronPort-AV: E=Sophos;i="6.05,203,1701158400"; 
   d="scan'208";a="875193211"
Received: from fmsmsx602.amr.corp.intel.com ([10.18.126.82])
  by FMSMGA003.fm.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 18 Jan 2024 12:42:17 -0800
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 18 Jan 2024 20:42:15.1226
 (UTC)

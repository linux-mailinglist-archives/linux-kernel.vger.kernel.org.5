...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 010D7806D72
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Dec 2023 12:09:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377961AbjLFLJK (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 6 Dec 2023 06:09:10 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33002 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377955AbjLFLJI (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 6 Dec 2023 06:09:08 -0500
Received: from mail.alien8.de (mail.alien8.de [65.109.113.108])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D784610C3
        for <linux-kernel@vger.kernel.org>; Wed,  6 Dec 2023 03:09:02 -0800 (PST)
Received: from localhost (localhost.localdomain [127.0.0.1])
        by mail.alien8.de (SuperMail on ZX Spectrum 128k) with ESMTP id D878140E00C7;
        Wed,  6 Dec 2023 11:09:00 +0000 (UTC)
X-Virus-Scanned: Debian amavisd-new at mail.alien8.de
Authentication-Results: mail.alien8.de (amavisd-new); dkim=pass (4096-bit key)
        header.d=alien8.de
Received: from mail.alien8.de ([127.0.0.1])
        by localhost (mail.alien8.de [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id JlBg3gUAzyM6; Wed,  6 Dec 2023 11:08:57 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=alien8.de; s=alien8;
        t=1701860936; bh=sO44FhpHY4UuthJa7xcnB2pfceSk9aPZ+iWSx96nGj4=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Received: from zn.tnic (pd95304da.dip0.t-ipconnect.de [217.83.4.218])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature ECDSA (P-256) server-digest SHA256)
        (No client certificate requested)
        by mail.alien8.de (SuperMail on ZX Spectrum 128k) with ESMTPSA id 5011F40E00A9;
...
Message-ID: <20231206110843.GCZXBWO12KW2aDq+MO@fat_crate.local>
References: <20231129133332.31043-1-jgross@suse.com>
 <20231129133332.31043-5-jgross@suse.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="gBl60Bdm75FHP3bE"
Content-Disposition: inline
In-Reply-To: <20231129133332.31043-5-jgross@suse.com>

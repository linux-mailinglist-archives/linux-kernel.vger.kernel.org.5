Return-Path: <linux-kernel+bounces-49240-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 64D798467D3
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 07:16:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 78EAA1F24AD7
	for <lists+linux-kernel@lfdr.de>; Fri,  2 Feb 2024 06:16:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C1A7417758;
	Fri,  2 Feb 2024 06:15:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="WKnFunaR"
Received: from mail-yw1-f201.google.com (mail-yw1-f201.google.com [209.85.128.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BDD8A17546
	for <linux-kernel@vger.kernel.org>; Fri,  2 Feb 2024 06:15:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706854552; cv=none; b=KmaUjibykgyDOT+OXKwZfx2AHCh8GGbB162VeD4xwI7Ac25v7saXitHaSp8Relhb00hgxosDBXItIkt7BkHxMjMCWxGDKLWjJVSbiotiBuvguN30p26za9fhUcNZBPsL7tsfM6Ij7tbIZ6Z0drYigPt+imKaNKPrTb7El6PqpJw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706854552; c=relaxed/simple;
	bh=VvfUnjvvMGtqdKBjmWO/YOIN3l52rWg4a87QEEVMLiA=;
	h=Date:In-Reply-To:Message-Id:Mime-Version:References:Subject:From:
	 To:Content-Type; b=TG3sIV+aQx9Vu6UUlVJAHb0lh+kPRnJgwlgMdCrqaXvTN9MLffguW+wWglvzKEfZHzh6vDf42iWgnAB+q2v/ODDDizqQPE4SVAXM8jxPY9LENnxaWvGcJjvamIXRGQSQaEsDfOoOkktWJ+LecHg9QVKuqsswhflzGHKnMUItEYs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=WKnFunaR; arc=none smtp.client-ip=209.85.128.201
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--irogers.bounces.google.com
Received: by mail-yw1-f201.google.com with SMTP id 00721157ae682-60405c0c9b0so40892307b3.1
        for <linux-kernel@vger.kernel.org>; Thu, 01 Feb 2024 22:15:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1706854549; x=1707459349; darn=vger.kernel.org;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=uOveehfWxcCj+86z5DWsT8T4x04wQ6gdOGLTWd0QSpU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1706854549; x=1707459349;
        h=to:from:subject:references:mime-version:message-id:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=uOveehfWxcCj+86z5DWsT8T4x04wQ6gdOGLTWd0QSpU=;
        b=
X-Gm-Message-State: AOJu0YzxTCuRuaejntJCrsxyDruq0Dlu5Dup6KXmkoytsZar2fCf9hbj
	GxK8nywdWttiBCzHamdJmrn/Om2VTmBzzXz6WaagZFi21mTg/pzxrkBwanaxUxvYMmxnCWrnrEg
	+C+n3Gg==
X-Google-Smtp-Source: AGHT+IFgmSGytIAfPqpnEdwhIl9pzR5hKhkxMPAv04xo0PUbOQ/QpIf7y70MXzXNA09N5Gw6kLiMxkuNWuBv
X-Received: from irogers.svl.corp.google.com ([2620:15c:2a3:200:a85f:db1d:a66b:7f53])
 (user=irogers job=sendgmr) by 2002:a05:6902:1605:b0:dc2:4d91:fb4b with SMTP
 id bw5-20020a056902160500b00dc24d91fb4bmr354033ybb.9.1706854548777; Thu, 01
 Feb 2024 22:15:48 -0800 (PST)
Date: Thu,  1 Feb 2024 22:15:08 -0800
In-Reply-To: <20240202061532.1939474-1-irogers@google.com>
Message-Id: <20240202061532.1939474-2-irogers@google.com>
Precedence: bulk
...
Subject: [PATCH v8 01/25] perf maps: Switch from rbtree to lazily sorted array
 for addresses
...
index 0334fc18d9c6..2fd81e2d622e 100644

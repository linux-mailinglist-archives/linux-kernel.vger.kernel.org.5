Return-Path: <linux-kernel+bounces-68993-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id AD3C785831A
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 17:55:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B62EAB22947
	for <lists+linux-kernel@lfdr.de>; Fri, 16 Feb 2024 16:55:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3482F130E24;
	Fri, 16 Feb 2024 16:55:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="kuoDW8ER"
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2057.outbound.protection.outlook.com [40.107.244.57])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B16C7130AF6
	for <linux-kernel@vger.kernel.org>; Fri, 16 Feb 2024 16:55:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.244.57
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708102506; cv=fail; b=g0uk8khjtmYfANjrxraZD6Lji7mBwzFhAVyUYHWlXWgu4rN+lsFiXFEGA9ErUbXFQV/2T93IwYZ+g01oaKhx6ztih6VUixiJRyAubwFeVkZFPE0XfRsNDjiMOCV99acurmpktppcm4NSRIJaUIRrdzsPbqjNrlWxgUccMta6mkA=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708102506; c=relaxed/simple;
	bh=LoI7oM5aqJQXj3fPQfBcthkVRp/X5fdnK9AseyA/rh0=;
	h=From:To:CC:Subject:Date:Message-ID:References:In-Reply-To:
	 Content-Type:MIME-Version; b=nEY3kCyFORFjvQhtv6DuCmgPk1rbKnbt1uUz51qrLeOy/Fkocvu3xA8C6sqS8xP376e1d/q3hDtPweCzKraJizdDg5GF+b9dgrPu3lpn3U8S7IcJ/VytsWA+jNbuTpcTshv7xQdBAOExEyiHiw5BxxFQmlN3kDYQ1jhjULusCTw=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=kuoDW8ER; arc=fail smtp.client-ip=40.107.244.57
...
msip_labels:
 MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ActionId=08ed79fb-0270-4135-92c6-c1deabc478ea;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_ContentBits=0;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Enabled=true;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Method=Standard;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_Name=General;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SetDate=2024-02-16T16:49:02Z;MSIP_Label_4342314e-0df4-4b58-84bf-38bed6170a0f_SiteId=3dd8961f-e488-4e60-8e11-a82d994e183d;
...
x-microsoft-antispam-message-info:
 
x-forefront-antispam-report:
 CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BL1PR12MB5969.namprd12.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(346002)(39860400002)(366004)(376002)(396003)(136003)(230922051799003)(186009)(451199024)(1800799012)(64100799003)(83380400001)(122000001)(316002)(110136005)(71200400001)(38100700002)(7416002)(52536014)(5660300002)(66946007)(66556008)(66476007)(66446008)(64756008)(8676002)(4326008)(76116006)(8936002)(9686003)(26005)(2906002)(478600001)(7696005)(6506007)(921011)(53546011)(38070700009)(86362001)(33656002)(41300700001)(55016003);DIR:OUT;SFP:1101;
x-ms-exchange-antispam-messagedata-chunkcount: 1
x-ms-exchange-antispam-messagedata-0:
 =?us-ascii?Q?TC/utbBRaEAVXY3bcrzg2y7XFbtGWMSHzXlRkqtrZDuT0lPUQMTlRPzaGTLW?=
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 16 Feb 2024 16:55:02.2380
 (UTC)

Return-Path: <linux-kernel+bounces-6855-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E09BE819E8A
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 12:58:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 517341F276B9
	for <lists+linux-kernel@lfdr.de>; Wed, 20 Dec 2023 11:58:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 62F8824A00;
	Wed, 20 Dec 2023 11:58:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="LUl4GT0S"
X-Original-To: linux-kernel@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C02CD249EC
	for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 11:58:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1703073485;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
	bh=DnGL1STtx+BSHdq/9TXDzeerzsjJ6ycbdT17juEpfRE=;
	b=LUl4GT0S3GRm/U3ptKkRpaKUPYtXXQtwp5w+5oV/c6q98+m5UPCSZa0imjE3dQdQncj9bb
	XEvW8dGN1hqfXM2ny8IyZrn2LjRU2DJrUOgsjUFarmRxhnkcZ35JVjwPNIveI/ekTObJT7
	Q+wq7SskJINeGdTyD1ZAdqVHB1peHXE=
Received: from mail-wm1-f69.google.com (mail-wm1-f69.google.com
 [209.85.128.69]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-79-LAYvY-elN26iGTv8ErotaA-1; Wed, 20 Dec 2023 06:58:04 -0500
X-MC-Unique: LAYvY-elN26iGTv8ErotaA-1
Received: by mail-wm1-f69.google.com with SMTP id 5b1f17b1804b1-40d1ffbc3b8so14825635e9.0
        for <linux-kernel@vger.kernel.org>; Wed, 20 Dec 2023 03:58:03 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1703073483; x=1703678283;
        h=content-transfer-encoding:in-reply-to:organization:autocrypt:from
         :references:cc:to:content-language:subject:user-agent:mime-version
         :date:message-id:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=DnGL1STtx+BSHdq/9TXDzeerzsjJ6ycbdT17juEpfRE=;
        b=
X-Gm-Message-State: AOJu0Yy8UNgGBZvGOYLmmxaKfGsWUbwsQrTRyEI2lgFAgdMzh483p1Ss
	zv3p0cIm6TgZLgB4wJpvXv8PDsApycjrk+gRmaoyOLJxGGdqR3b2Bl8ZKd/VB9yZBT1g0dBRrlG
	zHw6gP4lGGnjmO1LNijJv5pxU
X-Received: by 2002:a05:600c:1688:b0:40c:3663:e0e3 with SMTP id k8-20020a05600c168800b0040c3663e0e3mr5126593wmn.128.1703073482929;
        Wed, 20 Dec 2023 03:58:02 -0800 (PST)
X-Google-Smtp-Source: AGHT+IGCa37CH9OZ8YkI2OMTpRmUYhB1TfrUxja9IMKW7KhpbAegkvAgdZhwsAV4J6FyP4Y5A+H5fg==
X-Received: by 2002:a05:600c:1688:b0:40c:3663:e0e3 with SMTP id k8-20020a05600c168800b0040c3663e0e3mr5126584wmn.128.1703073482443;
        Wed, 20 Dec 2023 03:58:02 -0800 (PST)
Received: from ?IPV6:2003:cb:c73b:eb00:8e25:6953:927:1802? (p200300cbc73beb008e25695309271802.dip0.t-ipconnect.de. [2003:cb:c73b:eb00:8e25:6953:927:1802])
        by smtp.gmail.com with ESMTPSA id bg5-20020a05600c3c8500b0040c4c9c52a3sm7159022wmb.12.2023.12.20.03.58.00
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 20 Dec 2023 03:58:02 -0800 (PST)
Message-ID: <3194b8a5-3f72-4d9e-a267-fbdad32ad864@redhat.com>
Date: Wed, 20 Dec 2023 12:58:00 +0100
Precedence: bulk
...
In-Reply-To: <ade26f27-03af-4ad7-ad81-38b482f7572c@arm.com>

Return-Path: <linux-kernel+bounces-94669-lists+linux-kernel=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-kernel@lfdr.de
Delivered-To: lists+linux-kernel@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B15F8742E3
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 23:40:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 8EC6F1C23196
	for <lists+linux-kernel@lfdr.de>; Wed,  6 Mar 2024 22:40:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2DF921CABA;
	Wed,  6 Mar 2024 22:39:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="OWDNcUt9"
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 39F981C2B3
	for <linux-kernel@vger.kernel.org>; Wed,  6 Mar 2024 22:39:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709764786; cv=none; b=JxkwI8NKYQzSC81/WsuxeHWVYpXRO67wB8Snz2MpemawNm95qB4oI+S8li2hzS23BWGuA1eoQdKbtWj3i8jPKzKLEfa8PtsBGGoTVFhS0s0hRpEMp38t9J/PZV2tQVObFY17rojxM7M5eNorv7diRiSr3I1NBFsWe9Fw76RJetw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709764786; c=relaxed/simple;
	bh=qufHCtFusJJJxZd4PbPONLjM4Ikhqt19eKZn1UE7gb8=;
	h=From:To:cc:Subject:MIME-Version:Content-Type:Date:Message-ID; b=N3xIHQRO8OkJgTnTY68X/VBKW7tI+TGxmatO9droqZz4YgbmfYt+wnxm1XYlpT/KFdl8VpfCsEuLndSbDirFGgXYo/Gab9eNQpDBV65uzI3mSRXF1a0jWQOms0wg25bJppW5iG2RUhHTFrrSLVegZh9T5T/bodJu2b1pCsvTu38=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=OWDNcUt9; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1709764783;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding;
	bh=IDP3EJMVLQHfCuzda2hObBpANfqkgEpN6vZzonFm8bY=;
	b=OWDNcUt9TvyS0D0hpB3/zaFEfjmctOrdrprWcCrrGY/9TKJQYkpZ2MrjdHnTk8DzKLnRtX
	Dzgm7wBggBHIqIjvEcOER3Hi7kSPciM72L+ydLP4+pMzlJ/ydy7Ryy161uSmmUSWs35hpz
	2JMNHhNau4lpgZWR8LoDp4OpCypI7wM=
